...
class DocumentField(Model):
    ...
    def __init__(self, number_value: float=None, photo_value: List[DocumentFieldCreatePhotoValue]=None, string_value: str=None, value_type: str=None, label: str=None, value: ERRORUNKNOWN=None):  # noqa: E501
        """DocumentField - a model defined in Swagger
    ...
    @value.setter
    def value(self, value: ERRORUNKNOWN):
