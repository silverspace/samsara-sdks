...
class DispatchRoute(Model):
    ...
    @property
    def dispatch_jobs(self) -> List[DispatchJob]:
    ...
    def dispatch_jobs(self, dispatch_jobs: List[DispatchJob]):
