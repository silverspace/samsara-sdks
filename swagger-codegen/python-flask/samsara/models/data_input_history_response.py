...
class DataInputHistoryResponse(Model):
    ...
    def __init__(self, id: int=None, name: str=None, points: List[DataInputHistoryResponsePoints]=None):  # noqa: E501
        """DataInputHistoryResponse - a model defined in Swagger
    ...
    @property
    def points(self) -> List[DataInputHistoryResponsePoints]:
    ...
    @points.setter
    def points(self, points: List[DataInputHistoryResponsePoints]):
