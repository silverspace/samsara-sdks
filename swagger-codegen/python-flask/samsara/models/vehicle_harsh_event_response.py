...
class VehicleHarshEventResponse(Model):
    ...
    def __init__(self, download_forward_video_url: str=None, download_inward_video_url: str=None, download_tracked_inward_video_url: str=None, harsh_event_type: str=None, incident_report_url: str=None, is_distracted: bool=None, location: VehicleHarshEventResponseLocation=None):  # noqa: E501
        """VehicleHarshEventResponse - a model defined in Swagger
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'VehicleHarshEventResponse':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The VehicleHarshEventResponse of this VehicleHarshEventResponse.  # noqa: E501
        :rtype: VehicleHarshEventResponse
        """
        return util.deserialize_model(dikt, cls)

    @property
    def download_forward_video_url(self) -> str:
    ...
    def download_forward_video_url(self, download_forward_video_url: str):
    ...
    @property
    def download_inward_video_url(self) -> str:
    ...
    def download_inward_video_url(self, download_inward_video_url: str):
    ...
    @property
    def download_tracked_inward_video_url(self) -> str:
    ...
    def download_tracked_inward_video_url(self, download_tracked_inward_video_url: str):
    ...
    @property
    def incident_report_url(self) -> str:
    ...
    def incident_report_url(self, incident_report_url: str):
    ...
    def is_distracted(self, is_distracted: bool):
    ...
    @property
    def location(self) -> VehicleHarshEventResponseLocation:
    ...
    @location.setter
    def location(self, location: VehicleHarshEventResponseLocation):
