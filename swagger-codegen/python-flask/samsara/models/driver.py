...
class Driver(Model):
    ...
    def __init__(self, eld_adverse_weather_exemption_enabled: bool=None, eld_big_day_exemption_enabled: bool=None, eld_day_start_hour: int=None, eld_exempt: bool=None, eld_exempt_reason: str=None, eld_pc_enabled: bool=False, eld_ym_enabled: bool=False, external_ids: Dict[str, str]=None, group_id: int=None, license_number: str=None, license_state: str=None, name: str=None, notes: str=None, phone: str=None, username: str=None, vehicle_id: int=None, current_vehicle_id: int=None):  # noqa: E501
    ...
    @property
    def current_vehicle_id(self) -> int:
        """Gets the current_vehicle_id of this Driver.
        ...
        :return: The current_vehicle_id of this Driver.
        :rtype: int
        """
        return self._current_vehicle_id

    @current_vehicle_id.setter
    def current_vehicle_id(self, current_vehicle_id: int):
        """Sets the current_vehicle_id of this Driver.

        ID of the vehicle that this driver is currently assigned to. Omitted if there is no current vehicle assignment for this driver.  # noqa: E501

        :param current_vehicle_id: The current_vehicle_id of this Driver.
        :type current_vehicle_id: int
        """
