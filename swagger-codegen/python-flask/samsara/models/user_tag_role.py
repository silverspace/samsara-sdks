...
class UserTagRole(Model):
    ...
    def __init__(self, role: str=None, role_id: str=None, tag: UserTagRoleTag=None):  # noqa: E501
        """UserTagRole - a model defined in Swagger
    ...
    @tag.setter
    def tag(self, tag: UserTagRoleTag):
