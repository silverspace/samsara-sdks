...
class DispatchJob(Model):
    ...
    def __init__(self, destination_address: str=None, destination_address_id: int=None, destination_lat: float=None, destination_lng: float=None, destination_name: str=None, notes: str=None, scheduled_arrival_time_ms: int=None, scheduled_departure_time_ms: int=None, arrived_at_ms: int=None, completed_at_ms: int=None, dispatch_route_id: int=None, driver_id: int=None, en_route_at_ms: int=None, estimated_arrival_ms: int=None, fleet_viewer_url: str=None, group_id: int=None, id: int=None, job_state: JobStatus=None, skipped_at_ms: int=None, vehicle_id: int=None):  # noqa: E501
        """DispatchJob - a model defined in Swagger
    ...
    def arrived_at_ms(self, arrived_at_ms: int):
    ...
    def completed_at_ms(self, completed_at_ms: int):
    ...
    @property
    def dispatch_route_id(self) -> int:
    ...
    def dispatch_route_id(self, dispatch_route_id: int):
    ...
    def en_route_at_ms(self, en_route_at_ms: int):
    ...
    @property
    def estimated_arrival_ms(self) -> int:
    ...
    def estimated_arrival_ms(self, estimated_arrival_ms: int):
    ...
    def fleet_viewer_url(self, fleet_viewer_url: str):
    ...
    def skipped_at_ms(self, skipped_at_ms: int):
