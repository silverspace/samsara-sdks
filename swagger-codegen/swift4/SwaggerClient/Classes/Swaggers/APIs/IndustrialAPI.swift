...
open class IndustrialAPI {
     ...
     */
    open class func getAllDataInputs(accessToken: String, groupId: Int64? = nil, startMs: Int64? = nil, endMs: Int64? = nil, completion: @escaping ((_ data: InlineResponse2006?,_ error: Error?) -> Void)) {
  ...
  "dataInputs" : [ {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getDataInput(accessToken: String, dataInputId: Int64, startMs: Int64? = nil, endMs: Int64? = nil, completion: @escaping ((_ data: DataInputHistoryResponse?,_ error: Error?) -> Void)) {
  ...
  "points" : [ {
    ...
    open class func getDataInputWithRequestBuilder(accessToken: String, dataInputId: Int64, startMs: Int64? = nil, endMs: Int64? = nil) -> RequestBuilder<DataInputHistoryResponse> {
        ...
        let requestBuilder: RequestBuilder<DataInputHistoryResponse>.Type = SwaggerClientAPI.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getMachines(accessToken: String, groupParam: GroupParam, completion: @escaping ((_ data: InlineResponse2007?,_ error: Error?) -> Void)) {
  ...
  "machines" : [ {
     ...
     */
    open class func getMachinesWithRequestBuilder(accessToken: String, groupParam: GroupParam) -> RequestBuilder<InlineResponse2007> {
    ...
    /**
     ...
     - parameter accessToken: (query) Samsara API access token. 
     - parameter historyParam: (body) Group ID and time range to query for events 
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getMachinesHistory(accessToken: String, historyParam: HistoryParam, completion: @escaping ((_ data: MachineHistoryResponse?,_ error: Error?) -> Void)) {
  ...
  "machines" : [ {
     ...
     */
    open class func getMachinesHistoryWithRequestBuilder(accessToken: String, historyParam: HistoryParam) -> RequestBuilder<MachineHistoryResponse> {
        ...
        let requestBuilder: RequestBuilder<MachineHistoryResponse>.Type = SwaggerClientAPI.requestBuilderFactory.getBuilder()
