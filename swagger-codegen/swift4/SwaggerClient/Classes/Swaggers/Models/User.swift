...
public struct User: Codable {
    ...
    public init(authType: AuthType, email: String, name: String?, organizationRoleId: String?, _id: Int64?, organizationRole: String?, tagRoles: [UserTagRole]?) {
