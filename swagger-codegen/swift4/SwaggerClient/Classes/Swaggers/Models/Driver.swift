...
public struct Driver: Codable {
    ...
    public var currentVehicleId: Int64?

    public init(eldAdverseWeatherExemptionEnabled: Bool?, eldBigDayExemptionEnabled: Bool?, eldDayStartHour: Int?, eldExempt: Bool?, eldExemptReason: String?, eldPcEnabled: Bool?, eldYmEnabled: Bool?, externalIds: [String:String]?, groupId: Int64?, licenseNumber: String?, licenseState: String?, name: String, notes: String?, phone: String?, username: String?, vehicleId: Int64?, currentVehicleId: Int64?) {
