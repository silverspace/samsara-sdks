...
@interface SWGIndustrialApi: NSObject <SWGApi>

extern NSString* kSWGIndustrialApiErrorDomain;
extern NSInteger kSWGIndustrialApiMissingParamErrorCode;
...
/// 
///  code:200 message:"List of data inputs.",
...
/// @param endMs Timestamp in unix milliseconds representing the end of the period to fetch, inclusive. Used in combination with startMs. Defaults to nowMs. (optional)
/// 
///  code:200 message:"Returns datapoints for the given data input",
///  code:0 message:"Unexpected error."
///
/// @return SWGDataInputHistoryResponse*
...
/// 
///  code:200 message:"List of machine objects.",
///  code:0 message:"Unexpected error."
///
...
/// 
///  code:200 message:"List of machine results objects, each containing a time and a datapoint.",
///  code:0 message:"Unexpected error."
///
/// @return SWGMachineHistoryResponse*
