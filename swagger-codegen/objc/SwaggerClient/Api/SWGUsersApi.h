...
/// 
///  code:200 message:"The user was successfully removed.",
...
/// @param accessToken Samsara API access token.
/// 
///  code:200 message:"List of user roles.",
///  code:0 message:"Unexpected error."
///
/// @return NSArray<SWGUserRole>*
