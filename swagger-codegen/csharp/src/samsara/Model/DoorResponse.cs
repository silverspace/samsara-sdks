...
namespace samsara.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DoorResponse :  IEquatable<DoorResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DoorResponse" /> class.
        /// </summary>
        /// <param name="groupId">groupId.</param>
        /// <param name="sensors">sensors.</param>
        public DoorResponse(long? groupId = default(long?), List<DoorResponseSensors> sensors = default(List<DoorResponseSensors>))
        {
        ...
        {
            return this.Equals(input as DoorResponse);
        }

        /// <summary>
        /// Returns true if DoorResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of DoorResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DoorResponse input)
        {
            if (input == null)
                return false;
