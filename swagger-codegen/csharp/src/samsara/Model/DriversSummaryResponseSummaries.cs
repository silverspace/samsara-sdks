...
namespace samsara.Model
{
    ...
    public partial class DriversSummaryResponseSummaries :  IEquatable<DriversSummaryResponseSummaries>, IValidatableObject
    {
        ...
        public DriversSummaryResponseSummaries(long? activeMs = default(long?), double? distanceMiles = default(double?), long? driveMs = default(long?), long? driverId = default(long?), string driverName = default(string), string driverUsername = default(string), long? groupId = default(long?), long? onDutyMs = default(long?))
        {
