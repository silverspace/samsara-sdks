...
namespace samsara.Model
{
    ...
    public partial class DocumentType :  IEquatable<DocumentType>, IValidatableObject
    {
        ...
        public DocumentType(List<DocumentFieldTypes> fieldTypes = default(List<DocumentFieldTypes>), string name = default(string), long? orgId = default(long?), string uuid = default(string))
        {
