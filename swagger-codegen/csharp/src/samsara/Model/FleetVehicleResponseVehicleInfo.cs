...
namespace samsara.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FleetVehicleResponseVehicleInfo :  IEquatable<FleetVehicleResponseVehicleInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FleetVehicleResponseVehicleInfo" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as FleetVehicleResponseVehicleInfo);
        }

        /// <summary>
        /// Returns true if FleetVehicleResponseVehicleInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of FleetVehicleResponseVehicleInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FleetVehicleResponseVehicleInfo input)
        {
            if (input == null)
                return false;
