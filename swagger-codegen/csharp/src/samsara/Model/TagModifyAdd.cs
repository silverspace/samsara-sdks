...
namespace samsara.Model
{
    ...
    public partial class TagModifyAdd :  IEquatable<TagModifyAdd>, IValidatableObject
    {
        ...
        public TagModifyAdd(List<TaggedAssetBase> assets = default(List<TaggedAssetBase>), List<TaggedDriverBase> drivers = default(List<TaggedDriverBase>), List<TaggedMachineBase> machines = default(List<TaggedMachineBase>), List<TaggedSensorBase> sensors = default(List<TaggedSensorBase>), List<TaggedVehicleBase> vehicles = default(List<TaggedVehicleBase>))
        {
            this.Assets = assets;
