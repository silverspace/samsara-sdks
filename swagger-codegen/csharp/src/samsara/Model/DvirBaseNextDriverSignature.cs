...
namespace samsara.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DvirBaseNextDriverSignature :  IEquatable<DvirBaseNextDriverSignature>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DvirBaseNextDriverSignature" /> class.
        /// </summary>
        /// <param name="driverId">ID of the driver who signed the DVIR.</param>
        /// <param name="email">Email of the  driver who signed the next DVIR on this vehicle..</param>
        /// <param name="name">The name of the driver who signed the next DVIR on this vehicle..</param>
        /// <param name="signedAt">The time in millis when the next driver signed the DVIR on this vehicle..</param>
        /// <param name="type">Type corresponds to driver..</param>
        /// <param name="username">Username of the  driver who signed the next DVIR on this vehicle..</param>
        ...
        {
            return this.Equals(input as DvirBaseNextDriverSignature);
        }

        /// <summary>
        /// Returns true if DvirBaseNextDriverSignature instances are equal
        /// </summary>
        /// <param name="input">Instance of DvirBaseNextDriverSignature to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DvirBaseNextDriverSignature input)
        {
            if (input == null)
                return false;
