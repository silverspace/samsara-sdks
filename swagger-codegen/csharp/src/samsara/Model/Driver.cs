...
namespace samsara.Model
{
    ...
    public partial class Driver :  IEquatable<Driver>, IValidatableObject
    {
        ...
        /// <param name="currentVehicleId">ID of the vehicle that this driver is currently assigned to. Omitted if there is no current vehicle assignment for this driver..</param>
        public Driver(bool? eldAdverseWeatherExemptionEnabled = default(bool?), bool? eldBigDayExemptionEnabled = default(bool?), int? eldDayStartHour = default(int?), bool? eldExempt = default(bool?), string eldExemptReason = default(string), bool? eldPcEnabled = false, bool? eldYmEnabled = false, Dictionary<string, string> externalIds = default(Dictionary<string, string>), long? groupId = default(long?), string licenseNumber = default(string), string licenseState = default(string), string name = default(string), string notes = default(string), string phone = default(string), string username = default(string), long? vehicleId = default(long?), long? currentVehicleId = default(long?))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for Driver and cannot be null");
            }
            else
            {
                this.Name = name;
        ...
        /// </summary>
        /// <value>ID of the vehicle that this driver is currently assigned to. Omitted if there is no current vehicle assignment for this driver.</value>
        [DataMember(Name="currentVehicleId", EmitDefaultValue=false)]
        ...
        public bool Equals(Driver input)
        {
            ...
            return 
                ...
                (
                    this.CurrentVehicleId == input.CurrentVehicleId ||
                    (this.CurrentVehicleId != null &&
                    this.CurrentVehicleId.Equals(input.CurrentVehicleId))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CurrentVehicleId != null)
                    hashCode = hashCode * 59 + this.CurrentVehicleId.GetHashCode();
                return hashCode;
            }
        }
