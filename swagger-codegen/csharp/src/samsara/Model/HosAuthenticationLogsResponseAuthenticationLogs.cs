...
namespace samsara.Model
{
    ...
    public partial class HosAuthenticationLogsResponseAuthenticationLogs :  IEquatable<HosAuthenticationLogsResponseAuthenticationLogs>, IValidatableObject
    {
        ...
        public HosAuthenticationLogsResponseAuthenticationLogs(string actionType = default(string), string address = default(string), string addressName = default(string), string city = default(string), long? happenedAtMs = default(long?), string state = default(string))
        {
