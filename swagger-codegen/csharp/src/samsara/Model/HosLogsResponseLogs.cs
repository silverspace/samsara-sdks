...
namespace samsara.Model
{
    ...
    public partial class HosLogsResponseLogs :  IEquatable<HosLogsResponseLogs>, IValidatableObject
    {
        ...
        public HosLogsResponseLogs(List<long?> codriverIds = default(List<long?>), long? driverId = default(long?), long? groupId = default(long?), string locCity = default(string), double? locLat = default(double?), double? locLng = default(double?), string locName = default(string), string locState = default(string), long? logStartMs = default(long?), string remark = default(string), string statusType = default(string), long? vehicleId = default(long?))
        {
