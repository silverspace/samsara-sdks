...
namespace samsara.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SensorHistoryResponseResults :  IEquatable<SensorHistoryResponseResults>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SensorHistoryResponseResults" /> class.
        /// </summary>
        /// <param name="series">List of datapoints, one for each requested (sensor, field) pair..</param>
        /// <param name="timeMs">Timestamp in UNIX milliseconds..</param>
        public SensorHistoryResponseResults(List<long?> series = default(List<long?>), int? timeMs = default(int?))
        {
            this.Series = series;
            this.TimeMs = timeMs;
        }
        ...
        {
            return this.Equals(input as SensorHistoryResponseResults);
        }

        /// <summary>
        /// Returns true if SensorHistoryResponseResults instances are equal
        /// </summary>
        /// <param name="input">Instance of SensorHistoryResponseResults to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SensorHistoryResponseResults input)
        {
            if (input == null)
                return false;
