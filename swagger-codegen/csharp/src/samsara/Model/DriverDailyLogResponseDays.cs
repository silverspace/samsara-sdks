...
namespace samsara.Model
{
    ...
    public partial class DriverDailyLogResponseDays :  IEquatable<DriverDailyLogResponseDays>, IValidatableObject
    {
        ...
        public DriverDailyLogResponseDays(double? activeHours = default(double?), long? activeMs = default(long?), bool? certified = default(bool?), long? certifiedAtMs = default(long?), double? distanceMiles = default(double?), int? endMs = default(int?), int? startMs = default(int?), Object trailerIds = default(Object), Object vehicleIds = default(Object))
        {
