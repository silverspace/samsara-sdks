...
namespace samsara.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AssetLocationResponseInner :  IEquatable<AssetLocationResponseInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AssetLocationResponseInner" /> class.
        /// </summary>
        /// <param name="latitude">The latitude of the location in degrees..</param>
        /// <param name="location">The best effort (street,city,state) for the latitude and longitude..</param>
        /// <param name="longitude">The longitude of the location in degrees..</param>
        /// <param name="speedMilesPerHour">The speed calculated from GPS that the asset was traveling at in miles per hour..</param>
        /// <param name="time">Time in Unix milliseconds since epoch when the asset was at the location..</param>
        public AssetLocationResponseInner(double? latitude = default(double?), string location = default(string), double? longitude = default(double?), double? speedMilesPerHour = default(double?), decimal? time = default(decimal?))
        {
        ...
        {
            return this.Equals(input as AssetLocationResponseInner);
        }

        /// <summary>
        /// Returns true if AssetLocationResponseInner instances are equal
        /// </summary>
        /// <param name="input">Instance of AssetLocationResponseInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AssetLocationResponseInner input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.SpeedMilesPerHour == input.SpeedMilesPerHour ||
                    (this.SpeedMilesPerHour != null &&
                    this.SpeedMilesPerHour.Equals(input.SpeedMilesPerHour))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SpeedMilesPerHour != null)
                    hashCode = hashCode * 59 + this.SpeedMilesPerHour.GetHashCode();
                if (this.Time != null)
