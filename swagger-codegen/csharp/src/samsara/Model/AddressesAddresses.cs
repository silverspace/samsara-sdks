...
namespace samsara.Model
{
    ...
    public partial class AddressesAddresses :  IEquatable<AddressesAddresses>, IValidatableObject
    {
        ...
        public AddressesAddresses(ContactIds contactIds = default(ContactIds), string formattedAddress = default(string), AddressGeofence geofence = default(AddressGeofence), string name = default(string), AddressNotes notes = default(AddressNotes), TagIds tagIds = default(TagIds))
        {
