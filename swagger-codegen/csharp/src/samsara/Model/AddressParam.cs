...
namespace samsara.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AddressParam :  IEquatable<AddressParam>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddressParam" /> class.
        /// </summary>
        ...
        public AddressParam(string address = default(string), long? groupId = default(long?), string name = default(string), int? radius = default(int?))
        {
            // to ensure "address" is required (not null)
            if (address == null)
            {
                throw new InvalidDataException("address is a required property for AddressParam and cannot be null");
            }
            else
            {
            ...
            if (groupId == null)
            {
                throw new InvalidDataException("groupId is a required property for AddressParam and cannot be null");
            }
            else
            {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for AddressParam and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (radius == null)
            {
                throw new InvalidDataException("radius is a required property for AddressParam and cannot be null");
            }
            else
            {
                this.Radius = radius;
        ...
        {
            return this.Equals(input as AddressParam);
        }

        /// <summary>
        /// Returns true if AddressParam instances are equal
        /// </summary>
        /// <param name="input">Instance of AddressParam to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddressParam input)
        {
            if (input == null)
                return false;
