...
namespace samsara.Model
{
    ...
    public partial class TripResponseTrips :  IEquatable<TripResponseTrips>, IValidatableObject
    {
        ...
        public TripResponseTrips(int? distanceMeters = default(int?), int? driverId = default(int?), string endAddress = default(string), TripResponseEndCoordinates endCoordinates = default(TripResponseEndCoordinates), string endLocation = default(string), int? endMs = default(int?), int? endOdometer = default(int?), int? fuelConsumedMl = default(int?), string startAddress = default(string), TripResponseStartCoordinates startCoordinates = default(TripResponseStartCoordinates), string startLocation = default(string), int? startMs = default(int?), int? startOdometer = default(int?), int? tollMeters = default(int?))
        {
