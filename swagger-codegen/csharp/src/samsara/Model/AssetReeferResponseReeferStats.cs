...
namespace samsara.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AssetReeferResponseReeferStats :  IEquatable<AssetReeferResponseReeferStats>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AssetReeferResponseReeferStats" /> class.
        /// </summary>
        ...
        /// <param name="returnAirTemp">Return air temperature of the reefer.</param>
        /// <param name="setPoint">Set point temperature of the reefer.</param>
        public AssetReeferResponseReeferStats(List<AssetReeferResponseReeferStatsAlarms1> alarms = default(List<AssetReeferResponseReeferStatsAlarms1>), List<AssetReeferResponseReeferStatsEngineHours> engineHours = default(List<AssetReeferResponseReeferStatsEngineHours>), List<AssetReeferResponseReeferStatsFuelPercentage> fuelPercentage = default(List<AssetReeferResponseReeferStatsFuelPercentage>), List<AssetReeferResponseReeferStatsPowerStatus> powerStatus = default(List<AssetReeferResponseReeferStatsPowerStatus>), List<AssetReeferResponseReeferStatsReturnAirTemp> returnAirTemp = default(List<AssetReeferResponseReeferStatsReturnAirTemp>), List<AssetReeferResponseReeferStatsSetPoint> setPoint = default(List<AssetReeferResponseReeferStatsSetPoint>))
        {
            this.Alarms = alarms;
        ...
        {
            return this.Equals(input as AssetReeferResponseReeferStats);
        }

        /// <summary>
        /// Returns true if AssetReeferResponseReeferStats instances are equal
        /// </summary>
        /// <param name="input">Instance of AssetReeferResponseReeferStats to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AssetReeferResponseReeferStats input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    ...
                    this.EngineHours.SequenceEqual(input.EngineHours)
                ) && 
                (
                    this.FuelPercentage == input.FuelPercentage ||
                    this.FuelPercentage != null &&
                    this.FuelPercentage.SequenceEqual(input.FuelPercentage)
                ) && 
                (
                    this.PowerStatus == input.PowerStatus ||
                    this.PowerStatus != null &&
                    this.PowerStatus.SequenceEqual(input.PowerStatus)
                ) && 
                (
                    this.ReturnAirTemp == input.ReturnAirTemp ||
                    this.ReturnAirTemp != null &&
                    this.ReturnAirTemp.SequenceEqual(input.ReturnAirTemp)
                ) && 
                (
                    this.SetPoint == input.SetPoint ||
                    this.SetPoint != null &&
                    this.SetPoint.SequenceEqual(input.SetPoint)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.FuelPercentage != null)
                    hashCode = hashCode * 59 + this.FuelPercentage.GetHashCode();
                if (this.PowerStatus != null)
                    hashCode = hashCode * 59 + this.PowerStatus.GetHashCode();
                if (this.ReturnAirTemp != null)
                    hashCode = hashCode * 59 + this.ReturnAirTemp.GetHashCode();
