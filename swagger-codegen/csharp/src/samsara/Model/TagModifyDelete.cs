...
namespace samsara.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TagModifyDelete :  IEquatable<TagModifyDelete>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TagModifyDelete" /> class.
        /// </summary>
        /// <param name="assets">The assets to be removed from this tag..</param>
        /// <param name="drivers">The drivers to be removed from this tag..</param>
        /// <param name="machines">The machines to be removed from this tag..</param>
        /// <param name="sensors">The sensors to be removed from this tag..</param>
        /// <param name="vehicles">The vehicles to be removed from this tag..</param>
        public TagModifyDelete(List<TaggedAssetBase> assets = default(List<TaggedAssetBase>), List<TaggedDriverBase> drivers = default(List<TaggedDriverBase>), List<TaggedMachineBase> machines = default(List<TaggedMachineBase>), List<TaggedSensorBase> sensors = default(List<TaggedSensorBase>), List<TaggedVehicleBase> vehicles = default(List<TaggedVehicleBase>))
        {
            this.Assets = assets;
        ...
        /// </summary>
        /// <value>The assets to be removed from this tag.</value>
        ...
        /// </summary>
        /// <value>The drivers to be removed from this tag.</value>
        ...
        /// </summary>
        /// <value>The machines to be removed from this tag.</value>
        ...
        /// </summary>
        /// <value>The sensors to be removed from this tag.</value>
        ...
        /// </summary>
        /// <value>The vehicles to be removed from this tag.</value>
        ...
        {
            return this.Equals(input as TagModifyDelete);
        }

        /// <summary>
        /// Returns true if TagModifyDelete instances are equal
        /// </summary>
        /// <param name="input">Instance of TagModifyDelete to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TagModifyDelete input)
        {
            if (input == null)
                return false;
