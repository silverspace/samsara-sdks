...
namespace samsara.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TagUpdate :  IEquatable<TagUpdate>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TagUpdate" /> class.
        /// </summary>
        /// <param name="assets">The assets that belong to this tag..</param>
        /// <param name="drivers">The drivers that belong to this tag..</param>
        /// <param name="machines">The machines that belong to this tag..</param>
        /// <param name="name">Updated name of this tag..</param>
        /// <param name="parentTagId">If this tag is part a hierarchical tag tree as a child tag, the parentTagId is the ID of this tag&#39;s parent tag..</param>
        /// <param name="sensors">The sensors that belong to this tag..</param>
        /// <param name="vehicles">The vehicles that belong to this tag..</param>
        public TagUpdate(List<TaggedAssetBase> assets = default(List<TaggedAssetBase>), List<TaggedDriverBase> drivers = default(List<TaggedDriverBase>), List<TaggedMachineBase> machines = default(List<TaggedMachineBase>), string name = default(string), long? parentTagId = default(long?), List<TaggedSensorBase> sensors = default(List<TaggedSensorBase>), List<TaggedVehicleBase> vehicles = default(List<TaggedVehicleBase>))
        {
            this.Assets = assets;
        ...
        {
            return this.Equals(input as TagUpdate);
        }

        /// <summary>
        /// Returns true if TagUpdate instances are equal
        /// </summary>
        /// <param name="input">Instance of TagUpdate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TagUpdate input)
        {
            if (input == null)
                return false;
