...
namespace samsara.Model
{
    ...
    public partial class Address :  IEquatable<Address>, IValidatableObject
    {
        ...
        /// <param name="formattedAddress">The full address associated with this address/geofence, as it might be recognized by maps.google.com.</param>
        ...
        public Address(ContactIds contactIds = default(ContactIds), string formattedAddress = default(string), AddressGeofence geofence = default(AddressGeofence), string name = default(string), AddressNotes notes = default(AddressNotes), TagIds tagIds = default(TagIds))
        {
        ...
        public bool Equals(Address input)
        {
            ...
            return 
                (
                    ...
                    this.ContactIds.Equals(input.ContactIds))
                ) && 
                (
