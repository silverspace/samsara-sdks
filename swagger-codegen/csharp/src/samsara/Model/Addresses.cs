...
namespace samsara.Model
{
    ...
    public partial class Addresses :  IEquatable<Addresses>, IValidatableObject
    {
        ...
        public Addresses(List<AddressesAddresses> addresses = default(List<AddressesAddresses>))
        {
            // to ensure "addresses" is required (not null)
            if (addresses == null)
            {
                throw new InvalidDataException("addresses is a required property for Addresses and cannot be null");
            }
            else
            {
        ...
        public List<AddressesAddresses> _Addresses { get; set; }
