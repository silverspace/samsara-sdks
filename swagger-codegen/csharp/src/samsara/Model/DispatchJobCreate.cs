...
namespace samsara.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DispatchJobCreate :  IEquatable<DispatchJobCreate>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DispatchJobCreate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DispatchJobCreate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DispatchJobCreate" /> class.
        /// </summary>
        ...
        public DispatchJobCreate(string destinationAddress = default(string), long? destinationAddressId = default(long?), double? destinationLat = default(double?), double? destinationLng = default(double?), string destinationName = default(string), string notes = default(string), long? scheduledArrivalTimeMs = default(long?), long? scheduledDepartureTimeMs = default(long?))
        {
            // to ensure "scheduledArrivalTimeMs" is required (not null)
            if (scheduledArrivalTimeMs == null)
            {
                throw new InvalidDataException("scheduledArrivalTimeMs is a required property for DispatchJobCreate and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as DispatchJobCreate);
        }

        /// <summary>
        /// Returns true if DispatchJobCreate instances are equal
        /// </summary>
        /// <param name="input">Instance of DispatchJobCreate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DispatchJobCreate input)
        {
            if (input == null)
                return false;
