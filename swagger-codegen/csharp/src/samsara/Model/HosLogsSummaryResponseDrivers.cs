...
namespace samsara.Model
{
    ...
    public partial class HosLogsSummaryResponseDrivers :  IEquatable<HosLogsSummaryResponseDrivers>, IValidatableObject
    {
        ...
        public HosLogsSummaryResponseDrivers(long? cycleRemaining = default(long?), long? cycleTomorrow = default(long?), long? driverId = default(long?), string driverName = default(string), long? drivingInViolationCycle = default(long?), long? drivingInViolationToday = default(long?), string dutyStatus = default(string), long? shiftDriveRemaining = default(long?), long? shiftRemaining = default(long?), long? timeInCurrentStatus = default(long?), long? timeUntilBreak = default(long?), string vehicleName = default(string))
        {
