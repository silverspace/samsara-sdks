...
namespace samsara.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateDvirParam :  IEquatable<CreateDvirParam>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateDvirParam" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateDvirParam() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateDvirParam" /> class.
        /// </summary>
        ...
        public CreateDvirParam(InspectionTypeEnum inspectionType = default(InspectionTypeEnum), string mechanicNotes = default(string), int? odometerMiles = default(int?), bool? previousDefectsCorrected = default(bool?), bool? previousDefectsIgnored = default(bool?), SafeEnum safe = default(SafeEnum), int? trailerId = default(int?), string userEmail = default(string), int? vehicleId = default(int?))
        {
            ...
            if (safe == null)
            {
                throw new InvalidDataException("safe is a required property for CreateDvirParam and cannot be null");
            }
            else
            {
                this.Safe = safe;
            ...
            if (userEmail == null)
            {
                throw new InvalidDataException("userEmail is a required property for CreateDvirParam and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as CreateDvirParam);
        }

        /// <summary>
        /// Returns true if CreateDvirParam instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateDvirParam to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateDvirParam input)
        {
            if (input == null)
                return false;
