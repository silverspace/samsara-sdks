...
namespace samsara.Api
{
    ...
    public interface IFleetApi : IApiAccessor
    {
        ...
        ApiResponse<Object> AddFleetAddressWithHttpInfo (string accessToken, AddressParam addressParam);
        /// <summary>
        /// /addresses
        /// </summary>
        /// <remarks>
        ...
        ApiResponse<List<Address>> AddOrganizationAddressesWithHttpInfo (string accessToken, Addresses addresses);
        /// <summary>
        ...
        ApiResponse<DvirBase> CreateDvirWithHttpInfo (string accessToken, CreateDvirParam createDvirParam);
        /// <summary>
        ...
        /// <param name="endTime">Time in unix milliseconds that represents the oldest routes to return. Used in combination with duration. Defaults to now. (optional)</param>
        /// <param name="duration">Time in milliseconds that represents the duration before end_time to query. Defaults to 24 hours. (optional)</param>
        /// <returns>ApiResponse of DispatchRoutes</returns>
        ApiResponse<DispatchRoutes> FetchAllDispatchRoutesWithHttpInfo (string accessToken, long? groupId = null, long? endTime = null, long? duration = null);
        /// <summary>
        ...
        /// <param name="duration">Time in milliseconds that represents the duration before end_time to query. Defaults to 24 hours. (optional)</param>
        /// <returns>ApiResponse of DispatchRoutes</returns>
        ApiResponse<DispatchRoutes> GetDispatchRoutesByDriverIdWithHttpInfo (string accessToken, long? driverId, long? endTime = null, long? duration = null);
        /// <summary>
        /// /fleet/vehicles/{vehicle_id:[0-9]+}/dispatch/routes
        /// </summary>
        /// <remarks>
        ...
        /// <param name="duration">Time in milliseconds that represents the duration before end_time to query. Defaults to 24 hours. (optional)</param>
        /// <returns>ApiResponse of DispatchRoutes</returns>
        ApiResponse<DispatchRoutes> GetDispatchRoutesByVehicleIdWithHttpInfo (string accessToken, long? vehicleId, long? endTime = null, long? duration = null);
        /// <summary>
        /// /fleet/drivers/{driver_id:[0-9]+ | external_id:[a-zA-Z0-9]+}
        /// </summary>
        /// <remarks>
        ...
        /// <param name="accessToken">Samsara API access token.</param>
        /// <param name="driverIdOrExternalId">ID of the driver.  This must be either the numeric ID generated by Samsara or the external ID of the driver.  External IDs are customer specified key-value pairs.</param>
        /// <returns>ApiResponse of CurrentDriver</returns>
        ApiResponse<CurrentDriver> GetDriverByIdWithHttpInfo (string accessToken, string driverIdOrExternalId);
        /// <summary>
        ...
        /// </remarks>
        /// <exception cref="samsara.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of DocumentTypes</returns>
        ApiResponse<DocumentTypes> GetDriverDocumentTypesByOrgIdWithHttpInfo ();
        /// <summary>
        ...
        ApiResponse<Documents> GetDriverDocumentsByOrgIdWithHttpInfo (string accessToken, long? endMs = null, long? durationMs = null);
        /// <summary>
        ...
        ApiResponse<DriversResponse> GetFleetDriversWithHttpInfo (string accessToken, GroupDriversParam groupDriversParam);
        /// <summary>
        ...
        ApiResponse<DriverDailyLogResponse> GetFleetDriversHosDailyLogsWithHttpInfo (string accessToken, long? driverId, HosLogsParam hosLogsParam);
        /// <summary>
        ...
        ApiResponse<DriversSummaryResponse> GetFleetDriversSummaryWithHttpInfo (string accessToken, DriversSummaryParam driversSummaryParam, bool? snapToDayBounds = null);
        /// <summary>
        ...
        ApiResponse<HosAuthenticationLogsResponse> GetFleetHosAuthenticationLogsWithHttpInfo (string accessToken, HosAuthenticationLogsParam hosAuthenticationLogsParam);
        /// <summary>
        /// /fleet/hos_logs
        /// </summary>
        /// <remarks>
        ...
        ApiResponse<HosLogsResponse> GetFleetHosLogsWithHttpInfo (string accessToken, HosLogsParam1 hosLogsParam);
        /// <summary>
        ...
        ApiResponse<HosLogsSummaryResponse> GetFleetHosLogsSummaryWithHttpInfo (string accessToken, HosLogsParam2 hosLogsParam);
        /// <summary>
        /// /fleet/locations
        /// </summary>
        /// <remarks>
        ...
        ApiResponse<InlineResponse2003> GetFleetLocationsWithHttpInfo (string accessToken, GroupParam groupParam);
        /// <summary>
        ...
        ApiResponse<InlineResponse2004> GetFleetMaintenanceListWithHttpInfo (string accessToken, GroupParam groupParam);
        /// <summary>
        /// /fleet/trips
        /// </summary>
        /// <remarks>
        ...
        ApiResponse<TripResponse> GetFleetTripsWithHttpInfo (string accessToken, TripsParam tripsParam);
        /// <summary>
        ...
        /// <param name="startMs">Time in Unix epoch milliseconds for the start of the query (cannot exceed 1 hour)</param>
        /// <param name="endMs">Time in Unix epoch milliseconds for the end of the query (cannot exceed 1 hour)</param>
        /// <returns>ApiResponse of FleetVehicleLocations</returns>
        ApiResponse<FleetVehicleLocations> GetVehicleLocationsWithHttpInfo (string accessToken, long? vehicleId, long? startMs, long? endMs);
        /// <summary>
        ...
        /// <param name="startMs">Time in Unix epoch milliseconds for the start of the query (cannot exceed 30 minutes)</param>
        /// <param name="endMs">Time in Unix epoch milliseconds for the end of the query (cannot exceed 30 minutes)</param>
        /// <returns>ApiResponse of FleetVehiclesLocations</returns>
        ApiResponse<FleetVehiclesLocations> GetVehiclesLocationsWithHttpInfo (string accessToken, int? startMs, int? endMs);
        /// <summary>
        /// /contacts
        /// </summary>
        /// <remarks>
        ...
        ApiResponse<InlineResponse2002> ListFleetWithHttpInfo (string accessToken, GroupParam groupParam, string startingAfter = null, string endingBefore = null, long? limit = null);
        /// <summary>
        /// /fleet/vehicles/{vehicle_id:[0-9]+ | external_id:[a-zA-Z0-9]+}
        /// </summary>
        /// <remarks>
        ...
        /// <param name="data"></param>
        /// <returns>ApiResponse of FleetVehicleResponse</returns>
        ApiResponse<FleetVehicleResponse> PatchFleetVehicleWithHttpInfo (string accessToken, string vehicleIdOrExternalId, Data data);
        /// <summary>
        /// /fleet/drivers/inactive/{driver_id:[0-9]+ | external_id:[a-zA-Z0-9]+}
        /// </summary>
        /// <remarks>
        ...
        /// <param name="reactivateDriverParam">Driver reactivation body</param>
        /// <returns>ApiResponse of CurrentDriver</returns>
        ApiResponse<CurrentDriver> ReactivateDriverByIdWithHttpInfo (string accessToken, string driverIdOrExternalId, ReactivateDriverParam reactivateDriverParam);
        /// <summary>
        /// /fleet/dispatch/routes/{route_id:[0-9]+}/
        /// </summary>
        /// <remarks>
        ...
        /// <param name="addressId">ID of the address/geofence</param>
        /// <returns>ApiResponse of Object(void)</returns>
        ApiResponse<Object> UpdateOrganizationAddressWithHttpInfo (string accessToken, Address address, long? addressId);
        /// <summary>
        /// /fleet/set_data
        /// </summary>
        /// <remarks>
        ...
        /// <param name="vehicleUpdateParam"></param>
        /// <returns>ApiResponse of Object(void)</returns>
        ApiResponse<Object> UpdateVehiclesWithHttpInfo (string accessToken, VehicleUpdateParam vehicleUpdateParam);
        ...
        System.Threading.Tasks.Task AddFleetAddressAsync (string accessToken, AddressParam addressParam);
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> AddFleetAddressAsyncWithHttpInfo (string accessToken, AddressParam addressParam);
        /// <summary>
        /// /addresses
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<List<Address>> AddOrganizationAddressesAsync (string accessToken, Addresses addresses);
        ...
        System.Threading.Tasks.Task<ApiResponse<List<Address>>> AddOrganizationAddressesAsyncWithHttpInfo (string accessToken, Addresses addresses);
        /// <summary>
        /// /fleet/dispatch/routes
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<DvirBase> CreateDvirAsync (string accessToken, CreateDvirParam createDvirParam);
        ...
        System.Threading.Tasks.Task<ApiResponse<DvirBase>> CreateDvirAsyncWithHttpInfo (string accessToken, CreateDvirParam createDvirParam);
        /// <summary>
        /// /fleet/vehicles/{vehicle_id:[0-9]+}/dispatch/routes
        /// </summary>
        /// <remarks>
        ...
        /// <param name="endTime">Time in unix milliseconds that represents the oldest routes to return. Used in combination with duration. Defaults to now. (optional)</param>
        /// <param name="duration">Time in milliseconds that represents the duration before end_time to query. Defaults to 24 hours. (optional)</param>
        /// <returns>Task of DispatchRoutes</returns>
        System.Threading.Tasks.Task<DispatchRoutes> FetchAllDispatchRoutesAsync (string accessToken, long? groupId = null, long? endTime = null, long? duration = null);
        ...
        /// <param name="endTime">Time in unix milliseconds that represents the oldest routes to return. Used in combination with duration. Defaults to now. (optional)</param>
        /// <param name="duration">Time in milliseconds that represents the duration before end_time to query. Defaults to 24 hours. (optional)</param>
        /// <returns>Task of ApiResponse (DispatchRoutes)</returns>
        System.Threading.Tasks.Task<ApiResponse<DispatchRoutes>> FetchAllDispatchRoutesAsyncWithHttpInfo (string accessToken, long? groupId = null, long? endTime = null, long? duration = null);
        /// <summary>
        /// /fleet/dispatch/routes/job_updates
        /// </summary>
        /// <remarks>
        ...
        /// <param name="duration">Time in milliseconds that represents the duration before end_time to query. Defaults to 24 hours. (optional)</param>
        /// <returns>Task of DispatchRoutes</returns>
        System.Threading.Tasks.Task<DispatchRoutes> GetDispatchRoutesByDriverIdAsync (string accessToken, long? driverId, long? endTime = null, long? duration = null);
        ...
        /// <param name="duration">Time in milliseconds that represents the duration before end_time to query. Defaults to 24 hours. (optional)</param>
        /// <returns>Task of ApiResponse (DispatchRoutes)</returns>
        System.Threading.Tasks.Task<ApiResponse<DispatchRoutes>> GetDispatchRoutesByDriverIdAsyncWithHttpInfo (string accessToken, long? driverId, long? endTime = null, long? duration = null);
        /// <summary>
        /// /fleet/vehicles/{vehicle_id:[0-9]+}/dispatch/routes
        /// </summary>
        /// <remarks>
        ...
        /// <param name="duration">Time in milliseconds that represents the duration before end_time to query. Defaults to 24 hours. (optional)</param>
        /// <returns>Task of DispatchRoutes</returns>
        System.Threading.Tasks.Task<DispatchRoutes> GetDispatchRoutesByVehicleIdAsync (string accessToken, long? vehicleId, long? endTime = null, long? duration = null);
        ...
        /// <param name="duration">Time in milliseconds that represents the duration before end_time to query. Defaults to 24 hours. (optional)</param>
        /// <returns>Task of ApiResponse (DispatchRoutes)</returns>
        System.Threading.Tasks.Task<ApiResponse<DispatchRoutes>> GetDispatchRoutesByVehicleIdAsyncWithHttpInfo (string accessToken, long? vehicleId, long? endTime = null, long? duration = null);
        /// <summary>
        /// /fleet/drivers/{driver_id:[0-9]+ | external_id:[a-zA-Z0-9]+}
        /// </summary>
        /// <remarks>
        ...
        /// <param name="accessToken">Samsara API access token.</param>
        /// <param name="driverIdOrExternalId">ID of the driver.  This must be either the numeric ID generated by Samsara or the external ID of the driver.  External IDs are customer specified key-value pairs.</param>
        /// <returns>Task of CurrentDriver</returns>
        System.Threading.Tasks.Task<CurrentDriver> GetDriverByIdAsync (string accessToken, string driverIdOrExternalId);
        ...
        /// <param name="accessToken">Samsara API access token.</param>
        /// <param name="driverIdOrExternalId">ID of the driver.  This must be either the numeric ID generated by Samsara or the external ID of the driver.  External IDs are customer specified key-value pairs.</param>
        /// <returns>Task of ApiResponse (CurrentDriver)</returns>
        System.Threading.Tasks.Task<ApiResponse<CurrentDriver>> GetDriverByIdAsyncWithHttpInfo (string accessToken, string driverIdOrExternalId);
        /// <summary>
        /// /fleet/drivers/document_types
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        /// <exception cref="samsara.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of DocumentTypes</returns>
        System.Threading.Tasks.Task<DocumentTypes> GetDriverDocumentTypesByOrgIdAsync ();
        ...
        /// </remarks>
        /// <exception cref="samsara.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ApiResponse (DocumentTypes)</returns>
        System.Threading.Tasks.Task<ApiResponse<DocumentTypes>> GetDriverDocumentTypesByOrgIdAsyncWithHttpInfo ();
        /// <summary>
        /// /fleet/drivers/documents
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<Documents> GetDriverDocumentsByOrgIdAsync (string accessToken, long? endMs = null, long? durationMs = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<Documents>> GetDriverDocumentsByOrgIdAsyncWithHttpInfo (string accessToken, long? endMs = null, long? durationMs = null);
        /// <summary>
        /// /fleet/drivers/{driverId:[0-9]+}/safety/score
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<DriversResponse> GetFleetDriversAsync (string accessToken, GroupDriversParam groupDriversParam);
        ...
        System.Threading.Tasks.Task<ApiResponse<DriversResponse>> GetFleetDriversAsyncWithHttpInfo (string accessToken, GroupDriversParam groupDriversParam);
        /// <summary>
        /// /fleet/drivers/{driver_id:[0-9]+}/hos_daily_logs
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<DriverDailyLogResponse> GetFleetDriversHosDailyLogsAsync (string accessToken, long? driverId, HosLogsParam hosLogsParam);
        ...
        System.Threading.Tasks.Task<ApiResponse<DriverDailyLogResponse>> GetFleetDriversHosDailyLogsAsyncWithHttpInfo (string accessToken, long? driverId, HosLogsParam hosLogsParam);
        /// <summary>
        /// /fleet/drivers/summary
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<DriversSummaryResponse> GetFleetDriversSummaryAsync (string accessToken, DriversSummaryParam driversSummaryParam, bool? snapToDayBounds = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<DriversSummaryResponse>> GetFleetDriversSummaryAsyncWithHttpInfo (string accessToken, DriversSummaryParam driversSummaryParam, bool? snapToDayBounds = null);
        /// <summary>
        /// /fleet/hos_authentication_logs
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<HosAuthenticationLogsResponse> GetFleetHosAuthenticationLogsAsync (string accessToken, HosAuthenticationLogsParam hosAuthenticationLogsParam);
        ...
        System.Threading.Tasks.Task<ApiResponse<HosAuthenticationLogsResponse>> GetFleetHosAuthenticationLogsAsyncWithHttpInfo (string accessToken, HosAuthenticationLogsParam hosAuthenticationLogsParam);
        /// <summary>
        /// /fleet/hos_logs
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<HosLogsResponse> GetFleetHosLogsAsync (string accessToken, HosLogsParam1 hosLogsParam);
        ...
        System.Threading.Tasks.Task<ApiResponse<HosLogsResponse>> GetFleetHosLogsAsyncWithHttpInfo (string accessToken, HosLogsParam1 hosLogsParam);
        /// <summary>
        /// /fleet/hos_logs_summary
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<HosLogsSummaryResponse> GetFleetHosLogsSummaryAsync (string accessToken, HosLogsParam2 hosLogsParam);
        ...
        System.Threading.Tasks.Task<ApiResponse<HosLogsSummaryResponse>> GetFleetHosLogsSummaryAsyncWithHttpInfo (string accessToken, HosLogsParam2 hosLogsParam);
        /// <summary>
        /// /fleet/locations
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<InlineResponse2003> GetFleetLocationsAsync (string accessToken, GroupParam groupParam);
        ...
        System.Threading.Tasks.Task<ApiResponse<InlineResponse2003>> GetFleetLocationsAsyncWithHttpInfo (string accessToken, GroupParam groupParam);
        /// <summary>
        /// /fleet/maintenance/list
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<InlineResponse2004> GetFleetMaintenanceListAsync (string accessToken, GroupParam groupParam);
        ...
        System.Threading.Tasks.Task<ApiResponse<InlineResponse2004>> GetFleetMaintenanceListAsyncWithHttpInfo (string accessToken, GroupParam groupParam);
        /// <summary>
        /// /fleet/trips
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<TripResponse> GetFleetTripsAsync (string accessToken, TripsParam tripsParam);
        ...
        System.Threading.Tasks.Task<ApiResponse<TripResponse>> GetFleetTripsAsyncWithHttpInfo (string accessToken, TripsParam tripsParam);
        /// <summary>
        /// /fleet/vehicles/{vehicle_id:[0-9]+ | external_id:[a-zA-Z0-9]+}
        /// </summary>
        /// <remarks>
        ...
        /// <param name="startMs">Time in Unix epoch milliseconds for the start of the query (cannot exceed 1 hour)</param>
        /// <param name="endMs">Time in Unix epoch milliseconds for the end of the query (cannot exceed 1 hour)</param>
        /// <returns>Task of FleetVehicleLocations</returns>
        System.Threading.Tasks.Task<FleetVehicleLocations> GetVehicleLocationsAsync (string accessToken, long? vehicleId, long? startMs, long? endMs);
        ...
        /// <param name="startMs">Time in Unix epoch milliseconds for the start of the query (cannot exceed 1 hour)</param>
        /// <param name="endMs">Time in Unix epoch milliseconds for the end of the query (cannot exceed 1 hour)</param>
        /// <returns>Task of ApiResponse (FleetVehicleLocations)</returns>
        System.Threading.Tasks.Task<ApiResponse<FleetVehicleLocations>> GetVehicleLocationsAsyncWithHttpInfo (string accessToken, long? vehicleId, long? startMs, long? endMs);
        /// <summary>
        /// /fleet/vehicles/{vehicleId:[0-9]+}/safety/score
        /// </summary>
        /// <remarks>
        ...
        /// <param name="startMs">Time in Unix epoch milliseconds for the start of the query (cannot exceed 30 minutes)</param>
        /// <param name="endMs">Time in Unix epoch milliseconds for the end of the query (cannot exceed 30 minutes)</param>
        /// <returns>Task of FleetVehiclesLocations</returns>
        System.Threading.Tasks.Task<FleetVehiclesLocations> GetVehiclesLocationsAsync (string accessToken, int? startMs, int? endMs);
        ...
        /// <param name="startMs">Time in Unix epoch milliseconds for the start of the query (cannot exceed 30 minutes)</param>
        /// <param name="endMs">Time in Unix epoch milliseconds for the end of the query (cannot exceed 30 minutes)</param>
        /// <returns>Task of ApiResponse (FleetVehiclesLocations)</returns>
        System.Threading.Tasks.Task<ApiResponse<FleetVehiclesLocations>> GetVehiclesLocationsAsyncWithHttpInfo (string accessToken, int? startMs, int? endMs);
        /// <summary>
        /// /contacts
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<InlineResponse2002> ListFleetAsync (string accessToken, GroupParam groupParam, string startingAfter = null, string endingBefore = null, long? limit = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<InlineResponse2002>> ListFleetAsyncWithHttpInfo (string accessToken, GroupParam groupParam, string startingAfter = null, string endingBefore = null, long? limit = null);
        /// <summary>
        /// /fleet/vehicles/{vehicle_id:[0-9]+ | external_id:[a-zA-Z0-9]+}
        /// </summary>
        /// <remarks>
        ...
        /// <param name="data"></param>
        /// <returns>Task of FleetVehicleResponse</returns>
        System.Threading.Tasks.Task<FleetVehicleResponse> PatchFleetVehicleAsync (string accessToken, string vehicleIdOrExternalId, Data data);
        ...
        /// <param name="data"></param>
        /// <returns>Task of ApiResponse (FleetVehicleResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<FleetVehicleResponse>> PatchFleetVehicleAsyncWithHttpInfo (string accessToken, string vehicleIdOrExternalId, Data data);
        /// <summary>
        /// /fleet/drivers/inactive/{driver_id:[0-9]+ | external_id:[a-zA-Z0-9]+}
        /// </summary>
        /// <remarks>
        ...
        /// <param name="reactivateDriverParam">Driver reactivation body</param>
        /// <returns>Task of CurrentDriver</returns>
        System.Threading.Tasks.Task<CurrentDriver> ReactivateDriverByIdAsync (string accessToken, string driverIdOrExternalId, ReactivateDriverParam reactivateDriverParam);
        ...
        /// <param name="reactivateDriverParam">Driver reactivation body</param>
        /// <returns>Task of ApiResponse (CurrentDriver)</returns>
        System.Threading.Tasks.Task<ApiResponse<CurrentDriver>> ReactivateDriverByIdAsyncWithHttpInfo (string accessToken, string driverIdOrExternalId, ReactivateDriverParam reactivateDriverParam);
        /// <summary>
        /// /fleet/dispatch/routes/{route_id:[0-9]+}/
        /// </summary>
        /// <remarks>
        ...
        /// <param name="addressId">ID of the address/geofence</param>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task UpdateOrganizationAddressAsync (string accessToken, Address address, long? addressId);
        ...
        /// <param name="addressId">ID of the address/geofence</param>
        /// <returns>Task of ApiResponse</returns>
        System.Threading.Tasks.Task<ApiResponse<Object>> UpdateOrganizationAddressAsyncWithHttpInfo (string accessToken, Address address, long? addressId);
        /// <summary>
        /// /fleet/set_data
        /// </summary>
        /// <remarks>
        ...
        /// <param name="vehicleUpdateParam"></param>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task UpdateVehiclesAsync (string accessToken, VehicleUpdateParam vehicleUpdateParam);
        ...
        /// <param name="vehicleUpdateParam"></param>
        /// <returns>Task of ApiResponse</returns>
        System.Threading.Tasks.Task<ApiResponse<Object>> UpdateVehiclesAsyncWithHttpInfo (string accessToken, VehicleUpdateParam vehicleUpdateParam);
    ...
    public partial class FleetApi : IFleetApi
    {
        ...
        /// <returns></returns>
        public FleetApi(samsara.Client.Configuration configuration = null)
        {
        ...
        /// <param name="addressParam"></param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> AddFleetAddressWithHttpInfo (string accessToken, AddressParam addressParam)
        {
        ...
        /// <param name="addressParam"></param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task AddFleetAddressAsync (string accessToken, AddressParam addressParam)
        {
        ...
        /// <param name="addressParam"></param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> AddFleetAddressAsyncWithHttpInfo (string accessToken, AddressParam addressParam)
        {
            // verify the required parameter 'accessToken' is set
            if (accessToken == null)
                throw new ApiException(400, "Missing required parameter 'accessToken' when calling FleetApi->AddFleetAddress");
        ...
        /// <param name="addresses">List of addresses/geofences to add. Geofences can be circular or a polygon.  For each address, only one of &#39;circle&#39; or &#39;polygon&#39; should be provided. If both are provided, the geofence will be saved as a polygon.</param>
        /// <returns>ApiResponse of List&lt;Address&gt;</returns>
        public ApiResponse< List<Address> > AddOrganizationAddressesWithHttpInfo (string accessToken, Addresses addresses)
        {
            // verify the required parameter 'accessToken' is set
            if (accessToken == null)
        ...
        /// <param name="addresses">List of addresses/geofences to add. Geofences can be circular or a polygon.  For each address, only one of &#39;circle&#39; or &#39;polygon&#39; should be provided. If both are provided, the geofence will be saved as a polygon.</param>
        /// <returns>Task of List&lt;Address&gt;</returns>
        public async System.Threading.Tasks.Task<List<Address>> AddOrganizationAddressesAsync (string accessToken, Addresses addresses)
        {
        ...
        /// <param name="addresses">List of addresses/geofences to add. Geofences can be circular or a polygon.  For each address, only one of &#39;circle&#39; or &#39;polygon&#39; should be provided. If both are provided, the geofence will be saved as a polygon.</param>
        /// <returns>Task of ApiResponse (List&lt;Address&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<Address>>> AddOrganizationAddressesAsyncWithHttpInfo (string accessToken, Addresses addresses)
        {
            // verify the required parameter 'accessToken' is set
            if (accessToken == null)
                throw new ApiException(400, "Missing required parameter 'accessToken' when calling FleetApi->AddOrganizationAddresses");
        ...
        /// <param name="createDvirParam">DVIR creation body</param>
        /// <returns>ApiResponse of DvirBase</returns>
        public ApiResponse< DvirBase > CreateDvirWithHttpInfo (string accessToken, CreateDvirParam createDvirParam)
        {
            // verify the required parameter 'accessToken' is set
            if (accessToken == null)
        ...
        /// <param name="createDvirParam">DVIR creation body</param>
        /// <returns>Task of DvirBase</returns>
        public async System.Threading.Tasks.Task<DvirBase> CreateDvirAsync (string accessToken, CreateDvirParam createDvirParam)
        {
        ...
        /// <param name="createDvirParam">DVIR creation body</param>
        /// <returns>Task of ApiResponse (DvirBase)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<DvirBase>> CreateDvirAsyncWithHttpInfo (string accessToken, CreateDvirParam createDvirParam)
        {
            // verify the required parameter 'accessToken' is set
            if (accessToken == null)
                throw new ApiException(400, "Missing required parameter 'accessToken' when calling FleetApi->CreateDvir");
        ...
        /// <param name="duration">Time in milliseconds that represents the duration before end_time to query. Defaults to 24 hours. (optional)</param>
        /// <returns>DispatchRoutes</returns>
        public DispatchRoutes FetchAllDispatchRoutes (string accessToken, long? groupId = null, long? endTime = null, long? duration = null)
        {
             ApiResponse<DispatchRoutes> localVarResponse = FetchAllDispatchRoutesWithHttpInfo(accessToken, groupId, endTime, duration);
             return localVarResponse.Data;
        }
        ...
        /// <param name="duration">Time in milliseconds that represents the duration before end_time to query. Defaults to 24 hours. (optional)</param>
        /// <returns>ApiResponse of DispatchRoutes</returns>
        public ApiResponse< DispatchRoutes > FetchAllDispatchRoutesWithHttpInfo (string accessToken, long? groupId = null, long? endTime = null, long? duration = null)
        {
            // verify the required parameter 'accessToken' is set
            if (accessToken == null)
            ...
            return new ApiResponse<DispatchRoutes>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (DispatchRoutes) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(DispatchRoutes)));
        }
        ...
        /// <param name="duration">Time in milliseconds that represents the duration before end_time to query. Defaults to 24 hours. (optional)</param>
        /// <returns>Task of DispatchRoutes</returns>
        public async System.Threading.Tasks.Task<DispatchRoutes> FetchAllDispatchRoutesAsync (string accessToken, long? groupId = null, long? endTime = null, long? duration = null)
        {
             ApiResponse<DispatchRoutes> localVarResponse = await FetchAllDispatchRoutesAsyncWithHttpInfo(accessToken, groupId, endTime, duration);
             return localVarResponse.Data;
        ...
        /// <param name="duration">Time in milliseconds that represents the duration before end_time to query. Defaults to 24 hours. (optional)</param>
        /// <returns>Task of ApiResponse (DispatchRoutes)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<DispatchRoutes>> FetchAllDispatchRoutesAsyncWithHttpInfo (string accessToken, long? groupId = null, long? endTime = null, long? duration = null)
        {
            // verify the required parameter 'accessToken' is set
            if (accessToken == null)
                throw new ApiException(400, "Missing required parameter 'accessToken' when calling FleetApi->FetchAllDispatchRoutes");
        ...
        /// <param name="duration">Time in milliseconds that represents the duration before end_time to query. Defaults to 24 hours. (optional)</param>
        /// <returns>DispatchRoutes</returns>
        public DispatchRoutes GetDispatchRoutesByDriverId (string accessToken, long? driverId, long? endTime = null, long? duration = null)
        {
             ApiResponse<DispatchRoutes> localVarResponse = GetDispatchRoutesByDriverIdWithHttpInfo(accessToken, driverId, endTime, duration);
             return localVarResponse.Data;
        }
        ...
        /// <param name="duration">Time in milliseconds that represents the duration before end_time to query. Defaults to 24 hours. (optional)</param>
        /// <returns>ApiResponse of DispatchRoutes</returns>
        public ApiResponse< DispatchRoutes > GetDispatchRoutesByDriverIdWithHttpInfo (string accessToken, long? driverId, long? endTime = null, long? duration = null)
        {
            // verify the required parameter 'accessToken' is set
            if (accessToken == null)
        ...
        /// <param name="duration">Time in milliseconds that represents the duration before end_time to query. Defaults to 24 hours. (optional)</param>
        /// <returns>Task of DispatchRoutes</returns>
        public async System.Threading.Tasks.Task<DispatchRoutes> GetDispatchRoutesByDriverIdAsync (string accessToken, long? driverId, long? endTime = null, long? duration = null)
        {
             ApiResponse<DispatchRoutes> localVarResponse = await GetDispatchRoutesByDriverIdAsyncWithHttpInfo(accessToken, driverId, endTime, duration);
             return localVarResponse.Data;
        ...
        /// <param name="duration">Time in milliseconds that represents the duration before end_time to query. Defaults to 24 hours. (optional)</param>
        /// <returns>Task of ApiResponse (DispatchRoutes)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<DispatchRoutes>> GetDispatchRoutesByDriverIdAsyncWithHttpInfo (string accessToken, long? driverId, long? endTime = null, long? duration = null)
        {
            // verify the required parameter 'accessToken' is set
            if (accessToken == null)
                throw new ApiException(400, "Missing required parameter 'accessToken' when calling FleetApi->GetDispatchRoutesByDriverId");
        ...
        /// <param name="duration">Time in milliseconds that represents the duration before end_time to query. Defaults to 24 hours. (optional)</param>
        /// <returns>DispatchRoutes</returns>
        public DispatchRoutes GetDispatchRoutesByVehicleId (string accessToken, long? vehicleId, long? endTime = null, long? duration = null)
        {
             ApiResponse<DispatchRoutes> localVarResponse = GetDispatchRoutesByVehicleIdWithHttpInfo(accessToken, vehicleId, endTime, duration);
             return localVarResponse.Data;
        }
        ...
        /// <param name="duration">Time in milliseconds that represents the duration before end_time to query. Defaults to 24 hours. (optional)</param>
        /// <returns>ApiResponse of DispatchRoutes</returns>
        public ApiResponse< DispatchRoutes > GetDispatchRoutesByVehicleIdWithHttpInfo (string accessToken, long? vehicleId, long? endTime = null, long? duration = null)
        {
            // verify the required parameter 'accessToken' is set
            if (accessToken == null)
        ...
        /// <param name="duration">Time in milliseconds that represents the duration before end_time to query. Defaults to 24 hours. (optional)</param>
        /// <returns>Task of DispatchRoutes</returns>
        public async System.Threading.Tasks.Task<DispatchRoutes> GetDispatchRoutesByVehicleIdAsync (string accessToken, long? vehicleId, long? endTime = null, long? duration = null)
        {
             ApiResponse<DispatchRoutes> localVarResponse = await GetDispatchRoutesByVehicleIdAsyncWithHttpInfo(accessToken, vehicleId, endTime, duration);
             return localVarResponse.Data;
        ...
        /// <param name="duration">Time in milliseconds that represents the duration before end_time to query. Defaults to 24 hours. (optional)</param>
        /// <returns>Task of ApiResponse (DispatchRoutes)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<DispatchRoutes>> GetDispatchRoutesByVehicleIdAsyncWithHttpInfo (string accessToken, long? vehicleId, long? endTime = null, long? duration = null)
        {
            // verify the required parameter 'accessToken' is set
            if (accessToken == null)
                throw new ApiException(400, "Missing required parameter 'accessToken' when calling FleetApi->GetDispatchRoutesByVehicleId");
        ...
        {
             ApiResponse<CurrentDriver> localVarResponse = GetDriverByIdWithHttpInfo(accessToken, driverIdOrExternalId);
             return localVarResponse.Data;
        }
        ...
        /// <param name="driverIdOrExternalId">ID of the driver.  This must be either the numeric ID generated by Samsara or the external ID of the driver.  External IDs are customer specified key-value pairs.</param>
        /// <returns>ApiResponse of CurrentDriver</returns>
        public ApiResponse< CurrentDriver > GetDriverByIdWithHttpInfo (string accessToken, string driverIdOrExternalId)
        {
            // verify the required parameter 'accessToken' is set
            if (accessToken == null)
            ...
            return new ApiResponse<CurrentDriver>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (CurrentDriver) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(CurrentDriver)));
        }
        ...
        /// <param name="driverIdOrExternalId">ID of the driver.  This must be either the numeric ID generated by Samsara or the external ID of the driver.  External IDs are customer specified key-value pairs.</param>
        /// <returns>Task of CurrentDriver</returns>
        public async System.Threading.Tasks.Task<CurrentDriver> GetDriverByIdAsync (string accessToken, string driverIdOrExternalId)
        {
             ApiResponse<CurrentDriver> localVarResponse = await GetDriverByIdAsyncWithHttpInfo(accessToken, driverIdOrExternalId);
             return localVarResponse.Data;
        ...
        /// <param name="driverIdOrExternalId">ID of the driver.  This must be either the numeric ID generated by Samsara or the external ID of the driver.  External IDs are customer specified key-value pairs.</param>
        /// <returns>Task of ApiResponse (CurrentDriver)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<CurrentDriver>> GetDriverByIdAsyncWithHttpInfo (string accessToken, string driverIdOrExternalId)
        {
            // verify the required parameter 'accessToken' is set
            if (accessToken == null)
                throw new ApiException(400, "Missing required parameter 'accessToken' when calling FleetApi->GetDriverById");
        ...
        {
             ApiResponse<DocumentTypes> localVarResponse = GetDriverDocumentTypesByOrgIdWithHttpInfo();
             return localVarResponse.Data;
        }
        ...
        /// <exception cref="samsara.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of DocumentTypes</returns>
        public ApiResponse< DocumentTypes > GetDriverDocumentTypesByOrgIdWithHttpInfo ()
        {
            ...
            return new ApiResponse<DocumentTypes>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (DocumentTypes) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(DocumentTypes)));
        }
        ...
        /// <exception cref="samsara.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of DocumentTypes</returns>
        public async System.Threading.Tasks.Task<DocumentTypes> GetDriverDocumentTypesByOrgIdAsync ()
        {
             ApiResponse<DocumentTypes> localVarResponse = await GetDriverDocumentTypesByOrgIdAsyncWithHttpInfo();
             return localVarResponse.Data;
        ...
        /// <exception cref="samsara.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ApiResponse (DocumentTypes)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<DocumentTypes>> GetDriverDocumentTypesByOrgIdAsyncWithHttpInfo ()
        {
        ...
        /// <param name="durationMs">Time in milliseconds that represents the duration before endMs to query. Defaults to 24 hours. (optional)</param>
        /// <returns>Documents</returns>
        public Documents GetDriverDocumentsByOrgId (string accessToken, long? endMs = null, long? durationMs = null)
        {
             ApiResponse<Documents> localVarResponse = GetDriverDocumentsByOrgIdWithHttpInfo(accessToken, endMs, durationMs);
             return localVarResponse.Data;
        }
        ...
        /// <param name="durationMs">Time in milliseconds that represents the duration before endMs to query. Defaults to 24 hours. (optional)</param>
        /// <returns>ApiResponse of Documents</returns>
        public ApiResponse< Documents > GetDriverDocumentsByOrgIdWithHttpInfo (string accessToken, long? endMs = null, long? durationMs = null)
        {
            // verify the required parameter 'accessToken' is set
            if (accessToken == null)
        ...
        /// <param name="durationMs">Time in milliseconds that represents the duration before endMs to query. Defaults to 24 hours. (optional)</param>
        /// <returns>Task of Documents</returns>
        public async System.Threading.Tasks.Task<Documents> GetDriverDocumentsByOrgIdAsync (string accessToken, long? endMs = null, long? durationMs = null)
        {
             ApiResponse<Documents> localVarResponse = await GetDriverDocumentsByOrgIdAsyncWithHttpInfo(accessToken, endMs, durationMs);
             return localVarResponse.Data;
        ...
        /// <param name="durationMs">Time in milliseconds that represents the duration before endMs to query. Defaults to 24 hours. (optional)</param>
        /// <returns>Task of ApiResponse (Documents)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Documents>> GetDriverDocumentsByOrgIdAsyncWithHttpInfo (string accessToken, long? endMs = null, long? durationMs = null)
        {
            // verify the required parameter 'accessToken' is set
            if (accessToken == null)
                throw new ApiException(400, "Missing required parameter 'accessToken' when calling FleetApi->GetDriverDocumentsByOrgId");
        ...
        /// <param name="groupDriversParam"></param>
        /// <returns>ApiResponse of DriversResponse</returns>
        public ApiResponse< DriversResponse > GetFleetDriversWithHttpInfo (string accessToken, GroupDriversParam groupDriversParam)
        {
            // verify the required parameter 'accessToken' is set
            if (accessToken == null)
        ...
        /// <param name="groupDriversParam"></param>
        /// <returns>Task of DriversResponse</returns>
        public async System.Threading.Tasks.Task<DriversResponse> GetFleetDriversAsync (string accessToken, GroupDriversParam groupDriversParam)
        {
        ...
        /// <param name="groupDriversParam"></param>
        /// <returns>Task of ApiResponse (DriversResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<DriversResponse>> GetFleetDriversAsyncWithHttpInfo (string accessToken, GroupDriversParam groupDriversParam)
        {
            // verify the required parameter 'accessToken' is set
            if (accessToken == null)
                throw new ApiException(400, "Missing required parameter 'accessToken' when calling FleetApi->GetFleetDrivers");
        ...
        /// <param name="hosLogsParam"></param>
        /// <returns>ApiResponse of DriverDailyLogResponse</returns>
        public ApiResponse< DriverDailyLogResponse > GetFleetDriversHosDailyLogsWithHttpInfo (string accessToken, long? driverId, HosLogsParam hosLogsParam)
        {
            // verify the required parameter 'accessToken' is set
            if (accessToken == null)
        ...
        /// <param name="hosLogsParam"></param>
        /// <returns>Task of DriverDailyLogResponse</returns>
        public async System.Threading.Tasks.Task<DriverDailyLogResponse> GetFleetDriversHosDailyLogsAsync (string accessToken, long? driverId, HosLogsParam hosLogsParam)
        {
        ...
        /// <param name="hosLogsParam"></param>
        /// <returns>Task of ApiResponse (DriverDailyLogResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<DriverDailyLogResponse>> GetFleetDriversHosDailyLogsAsyncWithHttpInfo (string accessToken, long? driverId, HosLogsParam hosLogsParam)
        {
            // verify the required parameter 'accessToken' is set
            if (accessToken == null)
                throw new ApiException(400, "Missing required parameter 'accessToken' when calling FleetApi->GetFleetDriversHosDailyLogs");
        ...
        /// <param name="snapToDayBounds">Snap query result to HOS day boundaries. (optional)</param>
        /// <returns>DriversSummaryResponse</returns>
        public DriversSummaryResponse GetFleetDriversSummary (string accessToken, DriversSummaryParam driversSummaryParam, bool? snapToDayBounds = null)
        {
        ...
        /// <param name="snapToDayBounds">Snap query result to HOS day boundaries. (optional)</param>
        /// <returns>ApiResponse of DriversSummaryResponse</returns>
        public ApiResponse< DriversSummaryResponse > GetFleetDriversSummaryWithHttpInfo (string accessToken, DriversSummaryParam driversSummaryParam, bool? snapToDayBounds = null)
        {
            // verify the required parameter 'accessToken' is set
            if (accessToken == null)
        ...
        /// <param name="snapToDayBounds">Snap query result to HOS day boundaries. (optional)</param>
        /// <returns>Task of DriversSummaryResponse</returns>
        public async System.Threading.Tasks.Task<DriversSummaryResponse> GetFleetDriversSummaryAsync (string accessToken, DriversSummaryParam driversSummaryParam, bool? snapToDayBounds = null)
        {
        ...
        /// <param name="snapToDayBounds">Snap query result to HOS day boundaries. (optional)</param>
        /// <returns>Task of ApiResponse (DriversSummaryResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<DriversSummaryResponse>> GetFleetDriversSummaryAsyncWithHttpInfo (string accessToken, DriversSummaryParam driversSummaryParam, bool? snapToDayBounds = null)
        {
            // verify the required parameter 'accessToken' is set
            if (accessToken == null)
                throw new ApiException(400, "Missing required parameter 'accessToken' when calling FleetApi->GetFleetDriversSummary");
        ...
        /// <param name="hosAuthenticationLogsParam"></param>
        /// <returns>ApiResponse of HosAuthenticationLogsResponse</returns>
        public ApiResponse< HosAuthenticationLogsResponse > GetFleetHosAuthenticationLogsWithHttpInfo (string accessToken, HosAuthenticationLogsParam hosAuthenticationLogsParam)
        {
            // verify the required parameter 'accessToken' is set
            if (accessToken == null)
        ...
        /// <param name="hosAuthenticationLogsParam"></param>
        /// <returns>Task of HosAuthenticationLogsResponse</returns>
        public async System.Threading.Tasks.Task<HosAuthenticationLogsResponse> GetFleetHosAuthenticationLogsAsync (string accessToken, HosAuthenticationLogsParam hosAuthenticationLogsParam)
        {
        ...
        /// <param name="hosAuthenticationLogsParam"></param>
        /// <returns>Task of ApiResponse (HosAuthenticationLogsResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<HosAuthenticationLogsResponse>> GetFleetHosAuthenticationLogsAsyncWithHttpInfo (string accessToken, HosAuthenticationLogsParam hosAuthenticationLogsParam)
        {
            // verify the required parameter 'accessToken' is set
            if (accessToken == null)
                throw new ApiException(400, "Missing required parameter 'accessToken' when calling FleetApi->GetFleetHosAuthenticationLogs");
        ...
        /// <param name="hosLogsParam"></param>
        /// <returns>ApiResponse of HosLogsResponse</returns>
        public ApiResponse< HosLogsResponse > GetFleetHosLogsWithHttpInfo (string accessToken, HosLogsParam1 hosLogsParam)
        {
            // verify the required parameter 'accessToken' is set
            if (accessToken == null)
        ...
        /// <param name="hosLogsParam"></param>
        /// <returns>Task of HosLogsResponse</returns>
        public async System.Threading.Tasks.Task<HosLogsResponse> GetFleetHosLogsAsync (string accessToken, HosLogsParam1 hosLogsParam)
        {
        ...
        /// <param name="hosLogsParam"></param>
        /// <returns>Task of ApiResponse (HosLogsResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<HosLogsResponse>> GetFleetHosLogsAsyncWithHttpInfo (string accessToken, HosLogsParam1 hosLogsParam)
        {
            // verify the required parameter 'accessToken' is set
            if (accessToken == null)
                throw new ApiException(400, "Missing required parameter 'accessToken' when calling FleetApi->GetFleetHosLogs");
        ...
        /// <param name="hosLogsParam"></param>
        /// <returns>ApiResponse of HosLogsSummaryResponse</returns>
        public ApiResponse< HosLogsSummaryResponse > GetFleetHosLogsSummaryWithHttpInfo (string accessToken, HosLogsParam2 hosLogsParam)
        {
            // verify the required parameter 'accessToken' is set
            if (accessToken == null)
        ...
        /// <param name="hosLogsParam"></param>
        /// <returns>Task of HosLogsSummaryResponse</returns>
        public async System.Threading.Tasks.Task<HosLogsSummaryResponse> GetFleetHosLogsSummaryAsync (string accessToken, HosLogsParam2 hosLogsParam)
        {
        ...
        /// <param name="hosLogsParam"></param>
        /// <returns>Task of ApiResponse (HosLogsSummaryResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<HosLogsSummaryResponse>> GetFleetHosLogsSummaryAsyncWithHttpInfo (string accessToken, HosLogsParam2 hosLogsParam)
        {
            // verify the required parameter 'accessToken' is set
            if (accessToken == null)
                throw new ApiException(400, "Missing required parameter 'accessToken' when calling FleetApi->GetFleetHosLogsSummary");
        ...
        /// <param name="groupParam">Group ID to query.</param>
        /// <returns>ApiResponse of InlineResponse2003</returns>
        public ApiResponse< InlineResponse2003 > GetFleetLocationsWithHttpInfo (string accessToken, GroupParam groupParam)
        {
            // verify the required parameter 'accessToken' is set
            if (accessToken == null)
        ...
        /// <param name="groupParam">Group ID to query.</param>
        /// <returns>Task of InlineResponse2003</returns>
        public async System.Threading.Tasks.Task<InlineResponse2003> GetFleetLocationsAsync (string accessToken, GroupParam groupParam)
        {
        ...
        /// <param name="groupParam">Group ID to query.</param>
        /// <returns>Task of ApiResponse (InlineResponse2003)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<InlineResponse2003>> GetFleetLocationsAsyncWithHttpInfo (string accessToken, GroupParam groupParam)
        {
            // verify the required parameter 'accessToken' is set
            if (accessToken == null)
                throw new ApiException(400, "Missing required parameter 'accessToken' when calling FleetApi->GetFleetLocations");
        ...
        /// <param name="groupParam">Group ID to query.</param>
        /// <returns>ApiResponse of InlineResponse2004</returns>
        public ApiResponse< InlineResponse2004 > GetFleetMaintenanceListWithHttpInfo (string accessToken, GroupParam groupParam)
        {
            // verify the required parameter 'accessToken' is set
            if (accessToken == null)
        ...
        /// <param name="groupParam">Group ID to query.</param>
        /// <returns>Task of InlineResponse2004</returns>
        public async System.Threading.Tasks.Task<InlineResponse2004> GetFleetMaintenanceListAsync (string accessToken, GroupParam groupParam)
        {
        ...
        /// <param name="groupParam">Group ID to query.</param>
        /// <returns>Task of ApiResponse (InlineResponse2004)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<InlineResponse2004>> GetFleetMaintenanceListAsyncWithHttpInfo (string accessToken, GroupParam groupParam)
        {
            // verify the required parameter 'accessToken' is set
            if (accessToken == null)
                throw new ApiException(400, "Missing required parameter 'accessToken' when calling FleetApi->GetFleetMaintenanceList");
        ...
        /// <param name="tripsParam">Group ID, vehicle ID and time range to query.</param>
        /// <returns>ApiResponse of TripResponse</returns>
        public ApiResponse< TripResponse > GetFleetTripsWithHttpInfo (string accessToken, TripsParam tripsParam)
        {
            // verify the required parameter 'accessToken' is set
            if (accessToken == null)
        ...
        /// <param name="tripsParam">Group ID, vehicle ID and time range to query.</param>
        /// <returns>Task of TripResponse</returns>
        public async System.Threading.Tasks.Task<TripResponse> GetFleetTripsAsync (string accessToken, TripsParam tripsParam)
        {
        ...
        /// <param name="tripsParam">Group ID, vehicle ID and time range to query.</param>
        /// <returns>Task of ApiResponse (TripResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<TripResponse>> GetFleetTripsAsyncWithHttpInfo (string accessToken, TripsParam tripsParam)
        {
            // verify the required parameter 'accessToken' is set
            if (accessToken == null)
                throw new ApiException(400, "Missing required parameter 'accessToken' when calling FleetApi->GetFleetTrips");
        ...
        {
             ApiResponse<FleetVehicleLocations> localVarResponse = GetVehicleLocationsWithHttpInfo(accessToken, vehicleId, startMs, endMs);
             return localVarResponse.Data;
        }
        ...
        /// <param name="endMs">Time in Unix epoch milliseconds for the end of the query (cannot exceed 1 hour)</param>
        /// <returns>ApiResponse of FleetVehicleLocations</returns>
        public ApiResponse< FleetVehicleLocations > GetVehicleLocationsWithHttpInfo (string accessToken, long? vehicleId, long? startMs, long? endMs)
        {
            // verify the required parameter 'accessToken' is set
            if (accessToken == null)
            ...
            return new ApiResponse<FleetVehicleLocations>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (FleetVehicleLocations) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(FleetVehicleLocations)));
        }
        ...
        /// <param name="endMs">Time in Unix epoch milliseconds for the end of the query (cannot exceed 1 hour)</param>
        /// <returns>Task of FleetVehicleLocations</returns>
        public async System.Threading.Tasks.Task<FleetVehicleLocations> GetVehicleLocationsAsync (string accessToken, long? vehicleId, long? startMs, long? endMs)
        {
             ApiResponse<FleetVehicleLocations> localVarResponse = await GetVehicleLocationsAsyncWithHttpInfo(accessToken, vehicleId, startMs, endMs);
             return localVarResponse.Data;
        ...
        /// <param name="endMs">Time in Unix epoch milliseconds for the end of the query (cannot exceed 1 hour)</param>
        /// <returns>Task of ApiResponse (FleetVehicleLocations)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<FleetVehicleLocations>> GetVehicleLocationsAsyncWithHttpInfo (string accessToken, long? vehicleId, long? startMs, long? endMs)
        {
            // verify the required parameter 'accessToken' is set
            if (accessToken == null)
                throw new ApiException(400, "Missing required parameter 'accessToken' when calling FleetApi->GetVehicleLocations");
        ...
        {
             ApiResponse<FleetVehiclesLocations> localVarResponse = GetVehiclesLocationsWithHttpInfo(accessToken, startMs, endMs);
             return localVarResponse.Data;
        }
        ...
        /// <param name="endMs">Time in Unix epoch milliseconds for the end of the query (cannot exceed 30 minutes)</param>
        /// <returns>ApiResponse of FleetVehiclesLocations</returns>
        public ApiResponse< FleetVehiclesLocations > GetVehiclesLocationsWithHttpInfo (string accessToken, int? startMs, int? endMs)
        {
            // verify the required parameter 'accessToken' is set
            if (accessToken == null)
            ...
            return new ApiResponse<FleetVehiclesLocations>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (FleetVehiclesLocations) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(FleetVehiclesLocations)));
        }
        ...
        /// <param name="endMs">Time in Unix epoch milliseconds for the end of the query (cannot exceed 30 minutes)</param>
        /// <returns>Task of FleetVehiclesLocations</returns>
        public async System.Threading.Tasks.Task<FleetVehiclesLocations> GetVehiclesLocationsAsync (string accessToken, int? startMs, int? endMs)
        {
             ApiResponse<FleetVehiclesLocations> localVarResponse = await GetVehiclesLocationsAsyncWithHttpInfo(accessToken, startMs, endMs);
             return localVarResponse.Data;
        ...
        /// <param name="endMs">Time in Unix epoch milliseconds for the end of the query (cannot exceed 30 minutes)</param>
        /// <returns>Task of ApiResponse (FleetVehiclesLocations)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<FleetVehiclesLocations>> GetVehiclesLocationsAsyncWithHttpInfo (string accessToken, int? startMs, int? endMs)
        {
            // verify the required parameter 'accessToken' is set
            if (accessToken == null)
                throw new ApiException(400, "Missing required parameter 'accessToken' when calling FleetApi->GetVehiclesLocations");
        ...
        /// <param name="limit">Pagination parameter indicating the number of results to return in this request. Used in conjunction with either &#39;startingAfter&#39; or &#39;endingBefore&#39;. (optional)</param>
        /// <returns>InlineResponse2002</returns>
        public InlineResponse2002 ListFleet (string accessToken, GroupParam groupParam, string startingAfter = null, string endingBefore = null, long? limit = null)
        {
        ...
        /// <param name="limit">Pagination parameter indicating the number of results to return in this request. Used in conjunction with either &#39;startingAfter&#39; or &#39;endingBefore&#39;. (optional)</param>
        /// <returns>ApiResponse of InlineResponse2002</returns>
        public ApiResponse< InlineResponse2002 > ListFleetWithHttpInfo (string accessToken, GroupParam groupParam, string startingAfter = null, string endingBefore = null, long? limit = null)
        {
            // verify the required parameter 'accessToken' is set
            if (accessToken == null)
        ...
        /// <param name="limit">Pagination parameter indicating the number of results to return in this request. Used in conjunction with either &#39;startingAfter&#39; or &#39;endingBefore&#39;. (optional)</param>
        /// <returns>Task of InlineResponse2002</returns>
        public async System.Threading.Tasks.Task<InlineResponse2002> ListFleetAsync (string accessToken, GroupParam groupParam, string startingAfter = null, string endingBefore = null, long? limit = null)
        {
        ...
        /// <param name="limit">Pagination parameter indicating the number of results to return in this request. Used in conjunction with either &#39;startingAfter&#39; or &#39;endingBefore&#39;. (optional)</param>
        /// <returns>Task of ApiResponse (InlineResponse2002)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<InlineResponse2002>> ListFleetAsyncWithHttpInfo (string accessToken, GroupParam groupParam, string startingAfter = null, string endingBefore = null, long? limit = null)
        {
            // verify the required parameter 'accessToken' is set
            if (accessToken == null)
                throw new ApiException(400, "Missing required parameter 'accessToken' when calling FleetApi->ListFleet");
        ...
        /// <param name="data"></param>
        /// <returns>ApiResponse of FleetVehicleResponse</returns>
        public ApiResponse< FleetVehicleResponse > PatchFleetVehicleWithHttpInfo (string accessToken, string vehicleIdOrExternalId, Data data)
        {
            // verify the required parameter 'accessToken' is set
            if (accessToken == null)
        ...
        /// <param name="data"></param>
        /// <returns>Task of FleetVehicleResponse</returns>
        public async System.Threading.Tasks.Task<FleetVehicleResponse> PatchFleetVehicleAsync (string accessToken, string vehicleIdOrExternalId, Data data)
        {
        ...
        /// <param name="data"></param>
        /// <returns>Task of ApiResponse (FleetVehicleResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<FleetVehicleResponse>> PatchFleetVehicleAsyncWithHttpInfo (string accessToken, string vehicleIdOrExternalId, Data data)
        {
            // verify the required parameter 'accessToken' is set
            if (accessToken == null)
                throw new ApiException(400, "Missing required parameter 'accessToken' when calling FleetApi->PatchFleetVehicle");
        ...
        {
             ApiResponse<CurrentDriver> localVarResponse = ReactivateDriverByIdWithHttpInfo(accessToken, driverIdOrExternalId, reactivateDriverParam);
             return localVarResponse.Data;
        }
        ...
        /// <param name="reactivateDriverParam">Driver reactivation body</param>
        /// <returns>ApiResponse of CurrentDriver</returns>
        public ApiResponse< CurrentDriver > ReactivateDriverByIdWithHttpInfo (string accessToken, string driverIdOrExternalId, ReactivateDriverParam reactivateDriverParam)
        {
            // verify the required parameter 'accessToken' is set
            if (accessToken == null)
        ...
        /// <param name="reactivateDriverParam">Driver reactivation body</param>
        /// <returns>Task of CurrentDriver</returns>
        public async System.Threading.Tasks.Task<CurrentDriver> ReactivateDriverByIdAsync (string accessToken, string driverIdOrExternalId, ReactivateDriverParam reactivateDriverParam)
        {
             ApiResponse<CurrentDriver> localVarResponse = await ReactivateDriverByIdAsyncWithHttpInfo(accessToken, driverIdOrExternalId, reactivateDriverParam);
             return localVarResponse.Data;
        ...
        /// <param name="reactivateDriverParam">Driver reactivation body</param>
        /// <returns>Task of ApiResponse (CurrentDriver)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<CurrentDriver>> ReactivateDriverByIdAsyncWithHttpInfo (string accessToken, string driverIdOrExternalId, ReactivateDriverParam reactivateDriverParam)
        {
            // verify the required parameter 'accessToken' is set
            if (accessToken == null)
                throw new ApiException(400, "Missing required parameter 'accessToken' when calling FleetApi->ReactivateDriverById");
        ...
        /// <param name="addressId">ID of the address/geofence</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> UpdateOrganizationAddressWithHttpInfo (string accessToken, Address address, long? addressId)
        {
            // verify the required parameter 'accessToken' is set
            if (accessToken == null)
        ...
        /// <param name="addressId">ID of the address/geofence</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task UpdateOrganizationAddressAsync (string accessToken, Address address, long? addressId)
        {
             await UpdateOrganizationAddressAsyncWithHttpInfo(accessToken, address, addressId);
        ...
        /// <param name="addressId">ID of the address/geofence</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> UpdateOrganizationAddressAsyncWithHttpInfo (string accessToken, Address address, long? addressId)
        {
            // verify the required parameter 'accessToken' is set
            if (accessToken == null)
                throw new ApiException(400, "Missing required parameter 'accessToken' when calling FleetApi->UpdateOrganizationAddress");
        ...
        /// <param name="vehicleUpdateParam"></param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> UpdateVehiclesWithHttpInfo (string accessToken, VehicleUpdateParam vehicleUpdateParam)
        {
            // verify the required parameter 'accessToken' is set
            if (accessToken == null)
        ...
        /// <param name="vehicleUpdateParam"></param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task UpdateVehiclesAsync (string accessToken, VehicleUpdateParam vehicleUpdateParam)
        {
        ...
        /// <param name="vehicleUpdateParam"></param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> UpdateVehiclesAsyncWithHttpInfo (string accessToken, VehicleUpdateParam vehicleUpdateParam)
        {
            // verify the required parameter 'accessToken' is set
            if (accessToken == null)
                throw new ApiException(400, "Missing required parameter 'accessToken' when calling FleetApi->UpdateVehicles");
