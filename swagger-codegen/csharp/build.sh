...
${nuget_cmd} install src/samsara/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/samsara.dll"
...
then
  ...
  echo "[INFO] bin/samsara.dll was created successfully"
fi
