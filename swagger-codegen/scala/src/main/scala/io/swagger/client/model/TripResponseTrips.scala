...
case class TripResponseTrips (
  ...
  distanceMeters: Option[Integer] = None,
  // ID of the driver.
  ...
  endCoordinates: Option[TripResponseEndCoordinates] = None,
  ...
  endMs: Option[Integer] = None,
  // Odometer reading at the end of the trip.
  endOdometer: Option[Integer] = None,
  // Amount in milliliters of fuel consumed on this trip.
  fuelConsumedMl: Option[Integer] = None,
