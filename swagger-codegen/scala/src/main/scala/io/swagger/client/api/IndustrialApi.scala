...
class IndustrialApi(
   ...
   */
  def getMachines(accessToken: String, groupParam: GroupParam): Option[InlineResponse2007] = {
   ...
   */
  def getMachinesAsync(accessToken: String, groupParam: GroupParam): Future[InlineResponse2007] = {
   ...
   */
  def getMachinesHistory(accessToken: String, historyParam: HistoryParam): Option[MachineHistoryResponse] = {
   ...
   */
  def getMachinesHistoryAsync(accessToken: String, historyParam: HistoryParam): Future[MachineHistoryResponse] = {
...
class IndustrialApiAsyncHelper(client: TransportClient, config: SwaggerConfig) extends ApiClient(client, config) {
  ...
  def getMachines(accessToken: String,
    groupParam: GroupParam)(implicit reader: ClientResponseReader[InlineResponse2007], writer: RequestWriter[GroupParam]): Future[InlineResponse2007] = {
    // create path and map variables
  ...
  def getMachinesHistory(accessToken: String,
    historyParam: HistoryParam)(implicit reader: ClientResponseReader[MachineHistoryResponse], writer: RequestWriter[HistoryParam]): Future[MachineHistoryResponse] = {
    // create path and map variables
