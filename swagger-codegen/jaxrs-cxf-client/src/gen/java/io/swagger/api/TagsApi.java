...
public interface TagsApi  {
    ...
    @ApiOperation(value = "/tags", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Newly created tag object, including the new tag ID.", response = Tag.class),
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public Tag createTag(@QueryParam("access_token")String accessToken, TagCreate tagCreateParams);
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "/tags/{tag_id:[0-9]+}", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Successfully deleted the tag. No response body is returned."),
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public void deleteTagById(@QueryParam("access_token")String accessToken, @PathParam("tag_id") Long tagId);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public InlineResponse2009 getAllTags(@QueryParam("access_token")String accessToken, @QueryParam("group_id")Long groupId);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public Tag getTagById(@QueryParam("access_token")String accessToken, @PathParam("tag_id") Long tagId);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public Tag modifyTagById(@QueryParam("access_token")String accessToken, @PathParam("tag_id") Long tagId, TagModify tagModifyParams);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "The updated tag data.", response = Tag.class),
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public Tag updateTagById(@QueryParam("access_token")String accessToken, @PathParam("tag_id") Long tagId, TagUpdate updateTagParams);
}
