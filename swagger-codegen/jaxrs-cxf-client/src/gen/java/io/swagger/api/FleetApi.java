...
public interface FleetApi  {
    ...
    public void addFleetAddress(@QueryParam("access_token")String accessToken, AddressParam addressParam);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public List<Address> addOrganizationAddresses(@QueryParam("access_token")String accessToken, Addresses addresses);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public DvirBase createDvir(@QueryParam("access_token")String accessToken, CreateDvirParam createDvirParam);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public AssetLocationResponse getAssetLocation(@QueryParam("access_token")String accessToken, @PathParam("asset_id") Long assetId, @QueryParam("startMs")Long startMs, @QueryParam("endMs")Long endMs);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public CurrentDriver getDriverById(@QueryParam("access_token")String accessToken, @PathParam("driver_id_or_external_id") String driverIdOrExternalId);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public Documents getDriverDocumentsByOrgId(@QueryParam("access_token")String accessToken, @QueryParam("endMs")Long endMs, @QueryParam("durationMs")Long durationMs);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public DriversResponse getFleetDrivers(@QueryParam("access_token")String accessToken, GroupDriversParam groupDriversParam);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public DriverDailyLogResponse getFleetDriversHosDailyLogs(@QueryParam("access_token")String accessToken, @PathParam("driver_id") Long driverId, HosLogsParam hosLogsParam);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public DriversSummaryResponse getFleetDriversSummary(@QueryParam("access_token")String accessToken, DriversSummaryParam driversSummaryParam, @QueryParam("snap_to_day_bounds")Boolean snapToDayBounds);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public HosAuthenticationLogsResponse getFleetHosAuthenticationLogs(@QueryParam("access_token")String accessToken, HosAuthenticationLogsParam hosAuthenticationLogsParam);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public HosLogsResponse getFleetHosLogs(@QueryParam("access_token")String accessToken, HosLogsParam1 hosLogsParam);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public HosLogsSummaryResponse getFleetHosLogsSummary(@QueryParam("access_token")String accessToken, HosLogsParam2 hosLogsParam);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public InlineResponse2003 getFleetLocations(@QueryParam("access_token")String accessToken, GroupParam groupParam);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public InlineResponse2004 getFleetMaintenanceList(@QueryParam("access_token")String accessToken, GroupParam groupParam);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public TripResponse getFleetTrips(@QueryParam("access_token")String accessToken, TripsParam tripsParam);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public FleetVehicleLocations getVehicleLocations(@QueryParam("access_token")String accessToken, @PathParam("vehicle_id") Long vehicleId, @QueryParam("startMs")Long startMs, @QueryParam("endMs")Long endMs);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public FleetVehiclesLocations getVehiclesLocations(@QueryParam("access_token")String accessToken, @QueryParam("startMs")Integer startMs, @QueryParam("endMs")Integer endMs);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public InlineResponse2002 listFleet(@QueryParam("access_token")String accessToken, GroupParam groupParam, @QueryParam("startingAfter")String startingAfter, @QueryParam("endingBefore")String endingBefore, @QueryParam("limit")Long limit);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public FleetVehicleResponse patchFleetVehicle(@QueryParam("access_token")String accessToken, @PathParam("vehicle_id_or_external_id") String vehicleIdOrExternalId, Data data);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public CurrentDriver reactivateDriverById(@QueryParam("access_token")String accessToken, @PathParam("driver_id_or_external_id") String driverIdOrExternalId, ReactivateDriverParam reactivateDriverParam);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public void updateOrganizationAddress(@QueryParam("access_token")String accessToken, Address address, @PathParam("addressId") Long addressId);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public void updateVehicles(@QueryParam("access_token")String accessToken, VehicleUpdateParam vehicleUpdateParam);
}
