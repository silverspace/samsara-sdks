...
public interface IndustrialApi  {
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public InlineResponse2007 getMachines(@QueryParam("access_token")String accessToken, GroupParam groupParam);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public MachineHistoryResponse getMachinesHistory(@QueryParam("access_token")String accessToken, HistoryParam historyParam);
}
