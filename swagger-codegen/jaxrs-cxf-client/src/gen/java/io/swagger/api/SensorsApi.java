...
public interface SensorsApi  {
    ...
    public InlineResponse2008 getSensors(@QueryParam("access_token")String accessToken, GroupParam groupParam);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public CargoResponse getSensorsCargo(@QueryParam("access_token")String accessToken, SensorParam sensorParam);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public DoorResponse getSensorsDoor(@QueryParam("access_token")String accessToken, SensorParam sensorParam);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public SensorHistoryResponse getSensorsHistory(@QueryParam("access_token")String accessToken, HistoryParam1 historyParam);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public HumidityResponse getSensorsHumidity(@QueryParam("access_token")String accessToken, SensorParam sensorParam);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public TemperatureResponse getSensorsTemperature(@QueryParam("access_token")String accessToken, SensorParam sensorParam);
}
