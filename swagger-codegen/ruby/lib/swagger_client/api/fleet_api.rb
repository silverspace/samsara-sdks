...
module SwaggerClient
  class FleetApi
    ...
    # Fetch all of the document types.
    # @param [Hash] opts the optional parameters
    # @return [Array<(DocumentTypes, Fixnum, Hash)>] DocumentTypes data, response status code and response headers
    ...
    # @param end_ms Time in Unix epoch milliseconds for the end of the query (cannot exceed 1 hour)
    # @param [Hash] opts the optional parameters
    # @return [Array<(FleetVehicleLocations, Fixnum, Hash)>] FleetVehicleLocations data, response status code and response headers
    def get_vehicle_locations_with_http_info(access_token, vehicle_id, start_ms, end_ms, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'FleetVehicleLocations')
      if @api_client.config.debugging
    ...
    def get_vehicle_stats_with_http_info(access_token, start_ms, end_ms, opts = {})
      ...
      if @api_client.config.client_side_validation && opts[:'series'] && !['engineState', 'auxInput1', 'auxInput2'].include?(opts[:'series'])
        fail ArgumentError, 'invalid value for "series", must be one of engineState, auxInput1, auxInput2'
      end
      # resource path
    ...
    # @param end_ms Time in Unix epoch milliseconds for the end of the query (cannot exceed 30 minutes)
    # @param [Hash] opts the optional parameters
    # @return [Array<(FleetVehiclesLocations, Fixnum, Hash)>] FleetVehiclesLocations data, response status code and response headers
    def get_vehicles_locations_with_http_info(access_token, start_ms, end_ms, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'FleetVehiclesLocations')
      if @api_client.config.debugging
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def update_organization_address(access_token, address, address_id, opts = {})
      update_organization_address_with_http_info(access_token, address, address_id, opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Fixnum, Hash)>] nil, response status code and response headers
    def update_organization_address_with_http_info(access_token, address, address_id, opts = {})
      if @api_client.config.debugging
