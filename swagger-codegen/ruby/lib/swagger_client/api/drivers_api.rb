  ...
  class DriversApi
    ...
    def create_driver_with_http_info(access_token, create_driver_param, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DriversApi.create_driver ...'
      end
      # verify the required parameter 'access_token' is set
      if @api_client.config.client_side_validation && access_token.nil?
        fail ArgumentError, "Missing the required parameter 'access_token' when calling DriversApi.create_driver"
      end
      ...
      if @api_client.config.client_side_validation && create_driver_param.nil?
        fail ArgumentError, "Missing the required parameter 'create_driver_param' when calling DriversApi.create_driver"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'Driver')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DriversApi#create_driver\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def deactivate_driver_with_http_info(access_token, driver_id_or_external_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DriversApi.deactivate_driver ...'
      end
      # verify the required parameter 'access_token' is set
      if @api_client.config.client_side_validation && access_token.nil?
        fail ArgumentError, "Missing the required parameter 'access_token' when calling DriversApi.deactivate_driver"
      end
      ...
      if @api_client.config.client_side_validation && driver_id_or_external_id.nil?
        fail ArgumentError, "Missing the required parameter 'driver_id_or_external_id' when calling DriversApi.deactivate_driver"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path,
        ...
        :auth_names => auth_names)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DriversApi#deactivate_driver\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_all_deactivated_drivers_with_http_info(access_token, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DriversApi.get_all_deactivated_drivers ...'
      end
      # verify the required parameter 'access_token' is set
      if @api_client.config.client_side_validation && access_token.nil?
        fail ArgumentError, "Missing the required parameter 'access_token' when calling DriversApi.get_all_deactivated_drivers"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DriversApi#get_all_deactivated_drivers\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_deactivated_driver_by_id_with_http_info(access_token, driver_id_or_external_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DriversApi.get_deactivated_driver_by_id ...'
      end
      # verify the required parameter 'access_token' is set
      if @api_client.config.client_side_validation && access_token.nil?
        fail ArgumentError, "Missing the required parameter 'access_token' when calling DriversApi.get_deactivated_driver_by_id"
      end
      # verify the required parameter 'driver_id_or_external_id' is set
      if @api_client.config.client_side_validation && driver_id_or_external_id.nil?
        fail ArgumentError, "Missing the required parameter 'driver_id_or_external_id' when calling DriversApi.get_deactivated_driver_by_id"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'Driver')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DriversApi#get_deactivated_driver_by_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # /fleet/drivers/{driver_id:[0-9]+ | external_id:[a-zA-Z0-9]+}
    ...
    # @param driver_id_or_external_id ID of the driver.  This must be either the numeric ID generated by Samsara or the external ID of the driver.  External IDs are customer specified key-value pairs.
    # @param [Hash] opts the optional parameters
    # @return [Array<(CurrentDriver, Fixnum, Hash)>] CurrentDriver data, response status code and response headers
    def get_driver_by_id_with_http_info(access_token, driver_id_or_external_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DriversApi.get_driver_by_id ...'
      end
      # verify the required parameter 'access_token' is set
      if @api_client.config.client_side_validation && access_token.nil?
        fail ArgumentError, "Missing the required parameter 'access_token' when calling DriversApi.get_driver_by_id"
      end
      # verify the required parameter 'driver_id_or_external_id' is set
      if @api_client.config.client_side_validation && driver_id_or_external_id.nil?
        fail ArgumentError, "Missing the required parameter 'driver_id_or_external_id' when calling DriversApi.get_driver_by_id"
      end
      # resource path
      local_var_path = '/fleet/drivers/{driver_id_or_external_id}'.sub('{' + 'driver_id_or_external_id' + '}', driver_id_or_external_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'CurrentDriver')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DriversApi#get_driver_by_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # /fleet/drivers/inactive/{driver_id:[0-9]+ | external_id:[a-zA-Z0-9]+}
    ...
    def reactivate_driver_by_id_with_http_info(access_token, driver_id_or_external_id, reactivate_driver_param, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DriversApi.reactivate_driver_by_id ...'
      end
      # verify the required parameter 'access_token' is set
      if @api_client.config.client_side_validation && access_token.nil?
        fail ArgumentError, "Missing the required parameter 'access_token' when calling DriversApi.reactivate_driver_by_id"
      end
      # verify the required parameter 'driver_id_or_external_id' is set
      if @api_client.config.client_side_validation && driver_id_or_external_id.nil?
        fail ArgumentError, "Missing the required parameter 'driver_id_or_external_id' when calling DriversApi.reactivate_driver_by_id"
      end
      ...
      if @api_client.config.client_side_validation && reactivate_driver_param.nil?
        fail ArgumentError, "Missing the required parameter 'reactivate_driver_param' when calling DriversApi.reactivate_driver_by_id"
      end
      # resource path
      local_var_path = '/fleet/drivers/inactive/{driver_id_or_external_id}'.sub('{' + 'driver_id_or_external_id' + '}', driver_id_or_external_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'CurrentDriver')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DriversApi#reactivate_driver_by_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
