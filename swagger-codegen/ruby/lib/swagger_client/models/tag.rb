...
module SwaggerClient
  class Tag
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'machines')
      ...
      if attributes.has_key?(:'parentTagId')
        self.parent_tag_id = attributes[:'parentTagId']
      end

      if attributes.has_key?(:'sensors')
    ...
    def hash
      [addresses, assets, drivers, group_id, id, machines, name, parent_tag_id, sensors, vehicles].hash
    end
