...
module SwaggerClient
  class DriversSummaryResponseSummaries
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'driveMs')
        self.drive_ms = attributes[:'driveMs']
      end
      ...
      if attributes.has_key?(:'driverUsername')
        self.driver_username = attributes[:'driverUsername']
      end
      ...
      if attributes.has_key?(:'onDutyMs')
        self.on_duty_ms = attributes[:'onDutyMs']
      end
    end
    ...
    def hash
      [active_ms, distance_miles, drive_ms, driver_id, driver_name, driver_username, group_id, on_duty_ms].hash
    end
