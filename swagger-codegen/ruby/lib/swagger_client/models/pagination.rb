...
module SwaggerClient
  class Pagination
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'hasNextPage')
        self.has_next_page = attributes[:'hasNextPage']
      end

      if attributes.has_key?(:'hasPrevPage')
        self.has_prev_page = attributes[:'hasPrevPage']
      end

      if attributes.has_key?(:'startCursor')
        self.start_cursor = attributes[:'startCursor']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @end_cursor.nil?
        invalid_properties.push('invalid value for "end_cursor", end_cursor cannot be nil.')
      end
      ...
      if @has_prev_page.nil?
        invalid_properties.push('invalid value for "has_prev_page", has_prev_page cannot be nil.')
      end

      if @start_cursor.nil?
        invalid_properties.push('invalid value for "start_cursor", start_cursor cannot be nil.')
      end
    ...
    def valid?
      return false if @end_cursor.nil?
      return false if @has_next_page.nil?
      return false if @has_prev_page.nil?
      return false if @start_cursor.nil?
      true
    end
    ...
    def hash
      [end_cursor, has_next_page, has_prev_page, start_cursor].hash
    end
