...
module SwaggerClient
  class Driver
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'currentVehicleId')
        self.current_vehicle_id = attributes[:'currentVehicleId']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          current_vehicle_id == o.current_vehicle_id
    end
    ...
    def hash
      [eld_adverse_weather_exemption_enabled, eld_big_day_exemption_enabled, eld_day_start_hour, eld_exempt, eld_exempt_reason, eld_pc_enabled, eld_ym_enabled, external_ids, group_id, license_number, license_state, name, notes, phone, username, vehicle_id, current_vehicle_id].hash
    end
