...
module SwaggerClient
  ...
  class DvirBaseMechanicOrAgentSignature
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'mechanicUserId')
        self.mechanic_user_id = attributes[:'mechanicUserId']
      end
      ...
      if attributes.has_key?(:'signedAt')
        self.signed_at = attributes[:'signedAt']
      end
    ...
    def hash
      [driver_id, email, mechanic_user_id, name, signed_at, type, username].hash
    end
