...
module SwaggerClient
  class DriverDailyLogResponseDays
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'activeHours')
        self.active_hours = attributes[:'activeHours']
      end

      if attributes.has_key?(:'activeMs')
        self.active_ms = attributes[:'activeMs']
      end

      if attributes.has_key?(:'certified')
        self.certified = attributes[:'certified']
      end

      if attributes.has_key?(:'certifiedAtMs')
        self.certified_at_ms = attributes[:'certifiedAtMs']
      end

      if attributes.has_key?(:'distanceMiles')
        self.distance_miles = attributes[:'distanceMiles']
      end
      ...
      if attributes.has_key?(:'trailerIds')
        self.trailer_ids = attributes[:'trailerIds']
      end

      if attributes.has_key?(:'vehicleIds')
        self.vehicle_ids = attributes[:'vehicleIds']
      end
    end
    ...
    def hash
      [active_hours, active_ms, certified, certified_at_ms, distance_miles, end_ms, start_ms, trailer_ids, vehicle_ids].hash
    end
