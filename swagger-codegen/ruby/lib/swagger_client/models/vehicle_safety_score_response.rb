...
module SwaggerClient
  ...
  class VehicleSafetyScoreResponse
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'crashCount')
        self.crash_count = attributes[:'crashCount']
      end

      if attributes.has_key?(:'harshAccelCount')
        self.harsh_accel_count = attributes[:'harshAccelCount']
      end

      if attributes.has_key?(:'harshBrakingCount')
        self.harsh_braking_count = attributes[:'harshBrakingCount']
      end

      if attributes.has_key?(:'harshEvents')
        if (value = attributes[:'harshEvents']).is_a?(Array)
          self.harsh_events = value
        end
      end

      if attributes.has_key?(:'harshTurningCount')
        self.harsh_turning_count = attributes[:'harshTurningCount']
      end

      if attributes.has_key?(:'safetyScore')
        self.safety_score = attributes[:'safetyScore']
      end

      if attributes.has_key?(:'safetyScoreRank')
        self.safety_score_rank = attributes[:'safetyScoreRank']
      end

      if attributes.has_key?(:'timeOverSpeedLimitMs')
        self.time_over_speed_limit_ms = attributes[:'timeOverSpeedLimitMs']
      end

      if attributes.has_key?(:'totalDistanceDrivenMeters')
        self.total_distance_driven_meters = attributes[:'totalDistanceDrivenMeters']
      end

      if attributes.has_key?(:'totalHarshEventCount')
        self.total_harsh_event_count = attributes[:'totalHarshEventCount']
      end

      if attributes.has_key?(:'totalTimeDrivenMs')
        self.total_time_driven_ms = attributes[:'totalTimeDrivenMs']
      end
    ...
    def hash
      [crash_count, harsh_accel_count, harsh_braking_count, harsh_events, harsh_turning_count, safety_score, safety_score_rank, time_over_speed_limit_ms, total_distance_driven_meters, total_harsh_event_count, total_time_driven_ms, vehicle_id].hash
    end
