...
module SwaggerClient
  class HosLogsResponseLogs
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'codriverIds')
        if (value = attributes[:'codriverIds']).is_a?(Array)
      ...
      if attributes.has_key?(:'locCity')
        self.loc_city = attributes[:'locCity']
      end

      if attributes.has_key?(:'locLat')
        self.loc_lat = attributes[:'locLat']
      end

      if attributes.has_key?(:'locLng')
        self.loc_lng = attributes[:'locLng']
      end

      if attributes.has_key?(:'locName')
        self.loc_name = attributes[:'locName']
      end

      if attributes.has_key?(:'locState')
        self.loc_state = attributes[:'locState']
      end

      if attributes.has_key?(:'logStartMs')
        self.log_start_ms = attributes[:'logStartMs']
      end
      ...
      if attributes.has_key?(:'statusType')
        self.status_type = attributes[:'statusType']
      end
    ...
    def hash
      [codriver_ids, driver_id, group_id, loc_city, loc_lat, loc_lng, loc_name, loc_state, log_start_ms, remark, status_type, vehicle_id].hash
    end
