...
module SwaggerClient
  ...
  class FleetVehicleResponse
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'harshAccelSetting')
        self.harsh_accel_setting = attributes[:'harshAccelSetting']
      end
      ...
      if attributes.has_key?(:'vehicleInfo')
        self.vehicle_info = attributes[:'vehicleInfo']
      end
    end
