...
module SwaggerClient
  class DispatchJob
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'destination_address_id')
        self.destination_address_id = attributes[:'destination_address_id']
      end

      if attributes.has_key?(:'destination_lat')
        self.destination_lat = attributes[:'destination_lat']
      end

      if attributes.has_key?(:'destination_lng')
      ...
      if attributes.has_key?(:'en_route_at_ms')
        self.en_route_at_ms = attributes[:'en_route_at_ms']
      end

      if attributes.has_key?(:'estimated_arrival_ms')
        self.estimated_arrival_ms = attributes[:'estimated_arrival_ms']
      end

      if attributes.has_key?(:'fleet_viewer_url')
      ...
      if attributes.has_key?(:'job_state')
        self.job_state = attributes[:'job_state']
      end

      if attributes.has_key?(:'skipped_at_ms')
