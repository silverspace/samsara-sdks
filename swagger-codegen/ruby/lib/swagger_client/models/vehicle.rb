  ...
  class Vehicle
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'engineHours')
        self.engine_hours = attributes[:'engineHours']
      end

      if attributes.has_key?(:'fuelLevelPercent')
        self.fuel_level_percent = attributes[:'fuelLevelPercent']
      end
      ...
      if attributes.has_key?(:'odometerMeters')
        self.odometer_meters = attributes[:'odometerMeters']
      end
