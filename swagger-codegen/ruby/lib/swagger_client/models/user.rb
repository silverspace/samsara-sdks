...
module SwaggerClient
  class User
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'organizationRoleId')
        self.organization_role_id = attributes[:'organizationRoleId']
      end
      ...
      if attributes.has_key?(:'tagRoles')
        if (value = attributes[:'tagRoles']).is_a?(Array)
          self.tag_roles = value
        end
      end
    end
    ...
    def valid?
      ...
      auth_type_validator = EnumAttributeValidator.new('String', ['default', 'saml'])
    ...
    def auth_type=(auth_type)
      validator = EnumAttributeValidator.new('String', ['default', 'saml'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          email == o.email &&
          name == o.name &&
          organization_role_id == o.organization_role_id &&
          id == o.id &&
          organization_role == o.organization_role &&
          tag_roles == o.tag_roles
    end
    ...
    def hash
      [auth_type, email, name, organization_role_id, id, organization_role, tag_roles].hash
    end
