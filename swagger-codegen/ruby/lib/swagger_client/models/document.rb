...
module SwaggerClient
  class Document
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'dispatchJobId')
        self.dispatch_job_id = attributes[:'dispatchJobId']
      end
      ...
      if attributes.has_key?(:'driverCreatedAtMs')
        self.driver_created_at_ms = attributes[:'driverCreatedAtMs']
      end
