...
# Unit tests for SwaggerClient::IndustrialApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IndustrialApi' do
  before do
    # run before each test
    @instance = SwaggerClient::IndustrialApi.new
  end
  ...
  describe 'test an instance of IndustrialApi' do
    it 'should create an instance of IndustrialApi' do
      expect(@instance).to be_instance_of(SwaggerClient::IndustrialApi)
    end
  end

  # unit tests for get_all_data_inputs
  # /industrial/data
  ...
  describe 'get_all_data_inputs test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_data_input
  ...
  describe 'get_data_input test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_machines
  # /machines/list
  ...
  describe 'get_machines test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_machines_history
  # /machines/history
  ...
  describe 'get_machines_history test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
