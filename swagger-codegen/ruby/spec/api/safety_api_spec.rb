...
# Unit tests for SwaggerClient::SafetyApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SafetyApi' do
  before do
    # run before each test
    @instance = SwaggerClient::SafetyApi.new
  end
  ...
  describe 'test an instance of SafetyApi' do
    it 'should create an instance of SafetyApi' do
      expect(@instance).to be_instance_of(SwaggerClient::SafetyApi)
    end
  end
