...
# Unit tests for SwaggerClient::DocumentType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DocumentType' do
  before do
    # run before each test
    @instance = SwaggerClient::DocumentType.new
  end
  ...
  describe 'test an instance of DocumentType' do
    it 'should create an instance of DocumentType' do
      expect(@instance).to be_instance_of(SwaggerClient::DocumentType)
    end
  end
  describe 'test attribute "field_types"' do
    it 'should work' do
