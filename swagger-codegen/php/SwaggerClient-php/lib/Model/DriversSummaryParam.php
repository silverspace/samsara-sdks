...
/**
 * DriversSummaryParam Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DriversSummaryParam implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'driversSummaryParam';
     ...
     * Sets end_ms
     *
     * @param int $end_ms End time (ms) of queried time period.
     *
     * @return $this
     */
     ...
     * Sets org_id
     *
     * @param int $org_id Org ID to query.
     *
     * @return $this
     */
     ...
     * Sets start_ms
     *
     * @param int $start_ms Start time (ms) of queried time period.
     *
     * @return $this
     */
