...
class Driver implements ModelInterface, ArrayAccess
{
     ...
     * Sets external_ids
     *
     * @param map[string,string] $external_ids Dictionary of external IDs (string key-value pairs)
     *
     * @return $this
     */
     ...
     * Sets phone
     *
     * @param string $phone Driver's phone number. Please include only digits, ex. 4157771234
     *
     * @return $this
     */
     ...
     *
     * @param int $current_vehicle_id ID of the vehicle that this driver is currently assigned to. Omitted if there is no current vehicle assignment for this driver.
     *
     * @return $this
     */
