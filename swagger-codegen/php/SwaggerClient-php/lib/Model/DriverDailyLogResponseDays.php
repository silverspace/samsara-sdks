...
class DriverDailyLogResponseDays implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DriverDailyLogResponse_days';
     ...
     *
     * @param int $certified_at_ms Unix epoch time (in ms) of time when this chart was certified. If this chart is uncertified, 0.
     *
     * @return $this
     */
