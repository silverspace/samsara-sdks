...
class DispatchJob implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DispatchJob';
    ...
    protected static $swaggerTypes = [
        ...
        'group_id' => 'int',
        'id' => 'int',
        'job_state' => '\Swagger\Client\Model\JobStatus',
        'skipped_at_ms' => 'int',
        'vehicle_id' => 'int'
    ];
     ...
     * Sets arrived_at_ms
     *
     * @param int $arrived_at_ms The time at which the driver arrived at the job destination.
     *
     * @return $this
     */
     ...
     *
     * @param int $completed_at_ms The time at which the job was marked complete (e.g. started driving to the next destination).
     *
     * @return $this
     */
     ...
     * Sets driver_id
     *
     * @param int $driver_id ID of the driver assigned to the dispatch job.
     *
     * @return $this
     */
     ...
     * Sets en_route_at_ms
     *
     * @param int $en_route_at_ms The time at which the assigned driver started fulfilling the job (e.g. started driving to the destination).
     *
     * @return $this
     */
     ...
     *
     * @param int $estimated_arrival_ms The time at which the assigned driver is estimated to arrive at the job destination. Only valid for en-route jobs.
     *
     * @return $this
     */
     ...
     *
     * @param string $fleet_viewer_url Fleet viewer url of the dispatch job.
     *
     * @return $this
     */
     ...
     * Sets job_state
     *
     * @param \Swagger\Client\Model\JobStatus $job_state job_state
     *
     * @return $this
     */
     ...
     * Sets skipped_at_ms
     *
     * @param int $skipped_at_ms The time at which the job was marked skipped.
     *
     * @return $this
     */
     ...
     * Sets vehicle_id
     *
     * @param int $vehicle_id ID of the vehicle used for the dispatch job.
     *
     * @return $this
     */
