 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TripsParam implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'tripsParam';
     ...
     * Sets start_ms
     *
     * @param int $start_ms Beginning of the time range, specified in milliseconds UNIX time. Limited to a 90 day window with respect to startMs and endMs
     *
     * @return $this
     */
     ...
     * Sets vehicle_id
     *
     * @param int $vehicle_id Vehicle ID to query.
     *
     * @return $this
     */
