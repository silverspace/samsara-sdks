...
class SafetyReportHarshEvent implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SafetyReportHarshEvent';
     ...
     *
     * @param string $harsh_event_type Type of the harsh event
     *
     * @return $this
     */
     ...
     * Sets timestamp_ms
     *
     * @param int $timestamp_ms Timestamp that the harsh event occurred in Unix milliseconds since epoch
     *
     * @return $this
     */
     ...
     * Sets vehicle_id
     *
     * @param int $vehicle_id Vehicle associated with the harsh event
     *
     * @return $this
     */
