...
class FleetApi
{
     ...
     *
     * @param  string $access_token Samsara API access token. (required)
     * @param  \Swagger\Client\Model\Addresses $addresses List of addresses/geofences to add. Geofences can be circular or a polygon.  For each address, only one of &#39;circle&#39; or &#39;polygon&#39; should be provided. If both are provided, the geofence will be saved as a polygon. (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param  string $access_token Samsara API access token. (required)
     * @param  \Swagger\Client\Model\CreateDvirParam $create_dvir_param DVIR creation body (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\DvirBase
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\DvirBase, HTTP status code, HTTP response headers (array of strings)
     */
    public function createDvirWithHttpInfo($access_token, $create_dvir_param)
    {
        $returnType = '\Swagger\Client\Model\DvirBase';
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\AllRouteJobUpdates
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\AllRouteJobUpdates, HTTP status code, HTTP response headers (array of strings)
     */
    public function fetchAllRouteJobUpdatesWithHttpInfo($access_token, $group_id = null, $sequence_id = null, $include = null)
    {
        $returnType = '\Swagger\Client\Model\AllRouteJobUpdates';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\AllRouteJobUpdates',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\CurrentDriver
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\CurrentDriver, HTTP status code, HTTP response headers (array of strings)
     */
    public function getDriverByIdWithHttpInfo($access_token, $driver_id_or_external_id)
    {
        $returnType = '\Swagger\Client\Model\CurrentDriver';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\CurrentDriver',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\DocumentTypes
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\DocumentTypes, HTTP status code, HTTP response headers (array of strings)
     */
    public function getDriverDocumentTypesByOrgIdWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Model\DocumentTypes';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\DocumentTypes',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\DriversResponse
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\DriversResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getFleetDriversWithHttpInfo($access_token, $group_drivers_param)
    {
        $returnType = '\Swagger\Client\Model\DriversResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\DriversResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\FleetVehicleResponse
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\FleetVehicleResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getFleetVehicleWithHttpInfo($access_token, $vehicle_id_or_external_id)
    {
        $returnType = '\Swagger\Client\Model\FleetVehicleResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\FleetVehicleResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\FleetVehicleLocations
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\FleetVehicleLocations, HTTP status code, HTTP response headers (array of strings)
     */
    public function getVehicleLocationsWithHttpInfo($access_token, $vehicle_id, $start_ms, $end_ms)
    {
        $returnType = '\Swagger\Client\Model\FleetVehicleLocations';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\FleetVehicleLocations',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\FleetVehiclesLocations
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\FleetVehiclesLocations, HTTP status code, HTTP response headers (array of strings)
     */
    public function getVehiclesLocationsWithHttpInfo($access_token, $start_ms, $end_ms)
    {
        $returnType = '\Swagger\Client\Model\FleetVehiclesLocations';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\FleetVehiclesLocations',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $access_token Samsara API access token. (required)
     * @param  \Swagger\Client\Model\Address $address Update parts of an address&#39;s value. If the geofence &#39;circle&#39; or &#39;polygon&#39; key is specified, the update will change the type of geofence accordingly. (required)
     * @param  int $address_id ID of the address/geofence (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function updateOrganizationAddress($access_token, $address, $address_id)
    {
        $this->updateOrganizationAddressWithHttpInfo($access_token, $address, $address_id);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateOrganizationAddressWithHttpInfo($access_token, $address, $address_id)
    {
        $returnType = '';
        $request = $this->updateOrganizationAddressRequest($access_token, $address, $address_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateOrganizationAddressAsync($access_token, $address, $address_id)
    {
        return $this->updateOrganizationAddressAsyncWithHttpInfo($access_token, $address, $address_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateOrganizationAddressAsyncWithHttpInfo($access_token, $address, $address_id)
    {
        $returnType = '';
        $request = $this->updateOrganizationAddressRequest($access_token, $address, $address_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateOrganizationAddressRequest($access_token, $address, $address_id)
    {
        // verify the required parameter 'access_token' is set
        if ($access_token === null || (is_array($access_token) && count($access_token) === 0)) {
            throw new \InvalidArgumentException(
