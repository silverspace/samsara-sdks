...
type DvirBase struct {
	AuthorSignature *DvirBaseAuthorSignature `json:"authorSignature,omitempty"`
	...
	TrailerDefects []DvirBaseTrailerDefects `json:"trailerDefects,omitempty"`
	...
	VehicleDefects []DvirBaseTrailerDefects `json:"vehicleDefects,omitempty"`
}
