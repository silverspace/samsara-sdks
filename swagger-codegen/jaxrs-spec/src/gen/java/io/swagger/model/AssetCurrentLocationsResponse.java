...
public class AssetCurrentLocationsResponse   {
  ...
  private @Valid List<AssetCable> cable = new ArrayList<AssetCable>();
  private @Valid Integer engineHours = null;
  private @Valid Long id = null;
  private @Valid List<AssetCurrentLocation> location = new ArrayList<AssetCurrentLocation>();
