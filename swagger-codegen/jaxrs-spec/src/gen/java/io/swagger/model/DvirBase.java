...
public class DvirBase   {
  ...
  private @Valid DvirBaseAuthorSignature authorSignature = null;
  private @Valid Boolean defectsCorrected = null;
  private @Valid Boolean defectsNeedNotBeCorrected = null;
  private @Valid Long id = null;
  private @Valid String inspectionType = null;
  private @Valid String mechanicNotes = null;
  private @Valid DvirBaseMechanicOrAgentSignature mechanicOrAgentSignature = null;
  private @Valid DvirBaseNextDriverSignature nextDriverSignature = null;
  private @Valid Long odometerMiles = null;
  private @Valid Long timeMs = null;
  private @Valid List<DvirBaseTrailerDefects> trailerDefects = new ArrayList<DvirBaseTrailerDefects>();
  private @Valid Integer trailerId = null;
  private @Valid String trailerName = null;
  private @Valid DvirBaseVehicle vehicle = null;
  private @Valid String vehicleCondition = null;
  private @Valid List<DvirBaseTrailerDefects> vehicleDefects = new ArrayList<DvirBaseTrailerDefects>();
