...
public enum AuthTypeEnum {
    ...
    DEFAULT(String.valueOf("default")), SAML(String.valueOf("saml"));
  ...
  private @Valid AuthTypeEnum authType = null;
  private @Valid String email = null;
  private @Valid String name = null;
  private @Valid String organizationRoleId = null;
  private @Valid Long id = null;
  private @Valid String organizationRole = null;
  private @Valid List<UserTagRole> tagRoles = new ArrayList<UserTagRole>();
