...
print_getAllAssetCurrentLocations_help() {
    ...
    echo -e "  * ${GREEN}access_token${OFF} ${BLUE}[string]${OFF} ${RED}(required)${OFF}${OFF} - Samsara API access token.${YELLOW} Specify as: access_token=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e "  * ${GREEN}group_id${OFF} ${BLUE}[integer]${OFF}${OFF} - Optional group ID if the organization has multiple groups (uncommon).${YELLOW} Specify as: group_id=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo ""
...
print_getAssetLocation_help() {
    ...
    echo -e "  * ${GREEN}access_token${OFF} ${BLUE}[string]${OFF} ${RED}(required)${OFF}${OFF} - Samsara API access token.${YELLOW} Specify as: access_token=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e "  * ${GREEN}asset_id${OFF} ${BLUE}[integer]${OFF} ${RED}(required)${OFF}${OFF} - ID of the asset ${YELLOW}Specify as: asset_id=value${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e "  * ${GREEN}startMs${OFF} ${BLUE}[integer]${OFF} ${RED}(required)${OFF}${OFF} - Timestamp in milliseconds representing the start of the period to fetch, inclusive. Used in combination with endMs.${YELLOW} Specify as: startMs=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e "  * ${GREEN}endMs${OFF} ${BLUE}[integer]${OFF} ${RED}(required)${OFF}${OFF} - Timestamp in milliseconds representing the end of the period to fetch, inclusive. Used in combination with startMs.${YELLOW} Specify as: endMs=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo ""
    echo -e "${BOLD}${WHITE}Responses${OFF}"
    code=200
...
print_reactivateDriverById_help() {
    ...
    echo -e "  * ${GREEN}access_token${OFF} ${BLUE}[string]${OFF} ${RED}(required)${OFF}${OFF} - Samsara API access token.${YELLOW} Specify as: access_token=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e "  * ${GREEN}driver_id_or_external_id${OFF} ${BLUE}[string]${OFF} ${RED}(required)${OFF}${OFF} - ID of the driver.  This must be either the numeric ID generated by Samsara or the external ID of the driver.  External IDs are customer specified key-value pairs. ${YELLOW}Specify as: driver_id_or_external_id=value${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e "  * ${GREEN}body${OFF} ${BLUE}[application/json]${OFF} ${RED}(required)${OFF}${OFF} - Driver reactivation body" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
    echo ""
    echo -e "${BOLD}${WHITE}Responses${OFF}"
    code=200
...
print_addOrganizationAddresses_help() {
    ...
    echo -e "  * ${GREEN}access_token${OFF} ${BLUE}[string]${OFF} ${RED}(required)${OFF}${OFF} - Samsara API access token.${YELLOW} Specify as: access_token=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e "  * ${GREEN}body${OFF} ${BLUE}[application/json]${OFF} ${RED}(required)${OFF}${OFF} - List of addresses/geofences to add. Geofences can be circular or a polygon. 
For each address, only one of 'circle' or 'polygon' should be provided. If both are provided, the geofence will be saved as a polygon." | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
    echo ""
    echo -e "${BOLD}${WHITE}Responses${OFF}"
    code=200
...
print_createDriverDispatchRoute_help() {
    ...
    echo -e "  * ${GREEN}access_token${OFF} ${BLUE}[string]${OFF} ${RED}(required)${OFF}${OFF} - Samsara API access token.${YELLOW} Specify as: access_token=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e "  * ${GREEN}driver_id${OFF} ${BLUE}[integer]${OFF} ${RED}(required)${OFF}${OFF} - ID of the driver with the associated routes. ${YELLOW}Specify as: driver_id=value${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e "  * ${GREEN}body${OFF} ${BLUE}[application/json]${OFF} ${RED}(required)${OFF}${OFF} - " | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
    echo ""
    echo -e "${BOLD}${WHITE}Responses${OFF}"
...
print_createDriverDocument_help() {
    ...
    echo -e "  * ${GREEN}access_token${OFF} ${BLUE}[string]${OFF} ${RED}(required)${OFF}${OFF} - Samsara API access token.${YELLOW} Specify as: access_token=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e "  * ${GREEN}driver_id${OFF} ${BLUE}[integer]${OFF} ${RED}(required)${OFF}${OFF} - ID of the driver for whom the document is created. ${YELLOW}Specify as: driver_id=value${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
...
print_createDvir_help() {
    ...
    echo -e "  * ${GREEN}access_token${OFF} ${BLUE}[string]${OFF} ${RED}(required)${OFF}${OFF} - Samsara API access token.${YELLOW} Specify as: access_token=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e "  * ${GREEN}body${OFF} ${BLUE}[application/json]${OFF} ${RED}(required)${OFF}${OFF} - DVIR creation body" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
    echo ""
    echo -e "${BOLD}${WHITE}Responses${OFF}"
    code=200
...
print_createVehicleDispatchRoute_help() {
    ...
    echo -e "  * ${GREEN}access_token${OFF} ${BLUE}[string]${OFF} ${RED}(required)${OFF}${OFF} - Samsara API access token.${YELLOW} Specify as: access_token=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e "  * ${GREEN}vehicle_id${OFF} ${BLUE}[integer]${OFF} ${RED}(required)${OFF}${OFF} - ID of the vehicle with the associated routes. ${YELLOW}Specify as: vehicle_id=value${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e "  * ${GREEN}body${OFF} ${BLUE}[application/json]${OFF} ${RED}(required)${OFF}${OFF} - " | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
    echo ""
    echo -e "${BOLD}${WHITE}Responses${OFF}"
...
print_deleteDispatchRouteById_help() {
    ...
    echo -e "  * ${GREEN}access_token${OFF} ${BLUE}[string]${OFF} ${RED}(required)${OFF}${OFF} - Samsara API access token.${YELLOW} Specify as: access_token=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e "  * ${GREEN}route_id${OFF} ${BLUE}[integer]${OFF} ${RED}(required)${OFF}${OFF} - ID of the dispatch route. ${YELLOW}Specify as: route_id=value${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo ""
    echo -e "${BOLD}${WHITE}Responses${OFF}"
    code=200
...
print_deleteOrganizationAddress_help() {
    ...
    echo -e "  * ${GREEN}access_token${OFF} ${BLUE}[string]${OFF} ${RED}(required)${OFF}${OFF} - Samsara API access token.${YELLOW} Specify as: access_token=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e "  * ${GREEN}addressId${OFF} ${BLUE}[integer]${OFF} ${RED}(required)${OFF}${OFF} - ID of the address/geofence ${YELLOW}Specify as: addressId=value${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo ""
    echo -e "${BOLD}${WHITE}Responses${OFF}"
    code=200
...
print_fetchAllDispatchRoutes_help() {
    ...
    echo -e "  * ${GREEN}group_id${OFF} ${BLUE}[integer]${OFF}${OFF} - Optional group ID if the organization has multiple groups (uncommon).${YELLOW} Specify as: group_id=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e "  * ${GREEN}end_time${OFF} ${BLUE}[integer]${OFF}${OFF} - Time in unix milliseconds that represents the oldest routes to return. Used in combination with duration. Defaults to now.${YELLOW} Specify as: end_time=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e "  * ${GREEN}duration${OFF} ${BLUE}[integer]${OFF}${OFF} - Time in milliseconds that represents the duration before end_time to query. Defaults to 24 hours.${YELLOW} Specify as: duration=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo ""
    echo -e "${BOLD}${WHITE}Responses${OFF}"
    code=200
...
print_fetchAllRouteJobUpdates_help() {
    ...
    echo -e "  * ${GREEN}group_id${OFF} ${BLUE}[integer]${OFF}${OFF} - Optional group ID if the organization has multiple groups (uncommon).${YELLOW} Specify as: group_id=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e "  * ${GREEN}sequence_id${OFF} ${BLUE}[string]${OFF}${OFF} - Sequence ID from the response payload of the last request. Defaults to fetching updates from last 24 hours.${YELLOW} Specify as: sequence_id=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e "  * ${GREEN}include${OFF} ${BLUE}[string]${OFF}${OFF} - Optionally set include=route to include route object in response payload.${YELLOW} Specify as: include=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo ""
    echo -e "${BOLD}${WHITE}Responses${OFF}"
    code=200
...
print_getDispatchRouteHistory_help() {
    ...
    echo -e "  * ${GREEN}access_token${OFF} ${BLUE}[string]${OFF} ${RED}(required)${OFF}${OFF} - Samsara API access token.${YELLOW} Specify as: access_token=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e "  * ${GREEN}route_id${OFF} ${BLUE}[integer]${OFF} ${RED}(required)${OFF}${OFF} - ID of the route with history. ${YELLOW}Specify as: route_id=value${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e "  * ${GREEN}start_time${OFF} ${BLUE}[integer]${OFF}${OFF} - Timestamp representing the start of the period to fetch, inclusive. Used in combination with end_time. Defaults to 0.${YELLOW} Specify as: start_time=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e "  * ${GREEN}end_time${OFF} ${BLUE}[integer]${OFF}${OFF} - Timestamp representing the end of the period to fetch, inclusive. Used in combination with start_time. Defaults to nowMs.${YELLOW} Specify as: end_time=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo ""
    echo -e "${BOLD}${WHITE}Responses${OFF}"
    code=200
...
print_getDriverDocumentsByOrgId_help() {
    ...
    echo -e "  * ${GREEN}access_token${OFF} ${BLUE}[string]${OFF} ${RED}(required)${OFF}${OFF} - Samsara API access token.${YELLOW} Specify as: access_token=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e "  * ${GREEN}endMs${OFF} ${BLUE}[integer]${OFF}${OFF} - Time in unix milliseconds that represents the oldest documents to return. Used in combination with durationMs. Defaults to now.${YELLOW} Specify as: endMs=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e "  * ${GREEN}durationMs${OFF} ${BLUE}[integer]${OFF}${OFF} - Time in milliseconds that represents the duration before endMs to query. Defaults to 24 hours.${YELLOW} Specify as: durationMs=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo ""
    echo -e "${BOLD}${WHITE}Responses${OFF}"
    code=200
...
print_getDriverSafetyScore_help() {
    ...
    echo -e ""
    echo -e "${BOLD}${WHITE}Parameters${OFF}"
    echo -e "  * ${GREEN}driverId${OFF} ${BLUE}[integer]${OFF} ${RED}(required)${OFF}${OFF} - ID of the driver ${YELLOW}Specify as: driverId=value${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e "  * ${GREEN}access_token${OFF} ${BLUE}[string]${OFF} ${RED}(required)${OFF}${OFF} - Samsara API access token.${YELLOW} Specify as: access_token=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e "  * ${GREEN}startMs${OFF} ${BLUE}[integer]${OFF} ${RED}(required)${OFF}${OFF} - Timestamp in milliseconds representing the start of the period to fetch, inclusive. Used in combination with endMs.${YELLOW} Specify as: startMs=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
...
print_getDvirs_help() {
    ...
    echo -e "  * ${GREEN}access_token${OFF} ${BLUE}[string]${OFF} ${RED}(required)${OFF}${OFF} - Samsara API access token.${YELLOW} Specify as: access_token=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e "  * ${GREEN}end_ms${OFF} ${BLUE}[integer]${OFF} ${RED}(required)${OFF}${OFF} - time in millis until the last dvir log.${YELLOW} Specify as: end_ms=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e "  * ${GREEN}duration_ms${OFF} ${BLUE}[integer]${OFF} ${RED}(required)${OFF}${OFF} - time in millis which corresponds to the duration before the end_ms.${YELLOW} Specify as: duration_ms=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e "  * ${GREEN}group_id${OFF} ${BLUE}[integer]${OFF}${OFF} - Group ID to query.${YELLOW} Specify as: group_id=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo ""
    echo -e "${BOLD}${WHITE}Responses${OFF}"
    code=200
...
print_getFleetDriversHosDailyLogs_help() {
    ...
    echo -e "  * ${GREEN}access_token${OFF} ${BLUE}[string]${OFF} ${RED}(required)${OFF}${OFF} - Samsara API access token.${YELLOW} Specify as: access_token=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e "  * ${GREEN}driver_id${OFF} ${BLUE}[integer]${OFF} ${RED}(required)${OFF}${OFF} - ID of the driver with HOS logs. ${YELLOW}Specify as: driver_id=value${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e "  * ${GREEN}body${OFF} ${BLUE}[application/json]${OFF} ${RED}(required)${OFF}${OFF} - " | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
    echo ""
    echo -e "${BOLD}${WHITE}Responses${OFF}"
...
print_getFleetDriversSummary_help() {
    ...
    echo -e "  * ${GREEN}access_token${OFF} ${BLUE}[string]${OFF} ${RED}(required)${OFF}${OFF} - Samsara API access token.${YELLOW} Specify as: access_token=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e "  * ${GREEN}snap_to_day_bounds${OFF} ${BLUE}[boolean]${OFF}${OFF} - Snap query result to HOS day boundaries.${YELLOW} Specify as: snap_to_day_bounds=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e "  * ${GREEN}body${OFF} ${BLUE}[application/json]${OFF} ${RED}(required)${OFF}${OFF} - Org ID and time range to query." | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
    echo ""
    echo -e "${BOLD}${WHITE}Responses${OFF}"
    code=200
...
print_getFleetLocations_help() {
    ...
    echo -e "  * ${GREEN}access_token${OFF} ${BLUE}[string]${OFF} ${RED}(required)${OFF}${OFF} - Samsara API access token.${YELLOW} Specify as: access_token=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e "  * ${GREEN}body${OFF} ${BLUE}[application/json]${OFF} ${RED}(required)${OFF}${OFF} - Group ID to query." | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
    echo ""
    echo -e "${BOLD}${WHITE}Responses${OFF}"
    code=200
...
print_getFleetTrips_help() {
    ...
    echo -e "  * ${GREEN}access_token${OFF} ${BLUE}[string]${OFF} ${RED}(required)${OFF}${OFF} - Samsara API access token.${YELLOW} Specify as: access_token=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e "  * ${GREEN}body${OFF} ${BLUE}[application/json]${OFF} ${RED}(required)${OFF}${OFF} - Group ID, vehicle ID and time range to query." | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
    echo ""
    echo -e "${BOLD}${WHITE}Responses${OFF}"
    code=200
...
print_getOrganizationContact_help() {
    ...
    echo -e "  * ${GREEN}access_token${OFF} ${BLUE}[string]${OFF} ${RED}(required)${OFF}${OFF} - Samsara API access token.${YELLOW} Specify as: access_token=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e "  * ${GREEN}contact_id${OFF} ${BLUE}[integer]${OFF} ${RED}(required)${OFF}${OFF} - ID of the contact ${YELLOW}Specify as: contact_id=value${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo ""
    echo -e "${BOLD}${WHITE}Responses${OFF}"
    code=200
...
print_getVehicleHarshEvent_help() {
    ...
    echo -e ""
    echo -e "${BOLD}${WHITE}Parameters${OFF}"
    echo -e "  * ${GREEN}vehicleId${OFF} ${BLUE}[integer]${OFF} ${RED}(required)${OFF}${OFF} - ID of the vehicle ${YELLOW}Specify as: vehicleId=value${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e "  * ${GREEN}access_token${OFF} ${BLUE}[string]${OFF} ${RED}(required)${OFF}${OFF} - Samsara API access token.${YELLOW} Specify as: access_token=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e "  * ${GREEN}timestamp${OFF} ${BLUE}[integer]${OFF} ${RED}(required)${OFF}${OFF} - Timestamp in milliseconds representing the timestamp of a harsh event.${YELLOW} Specify as: timestamp=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo ""
    echo -e "${BOLD}${WHITE}Responses${OFF}"
    code=200
...
print_getVehicleLocations_help() {
    ...
    echo -e "  * ${GREEN}access_token${OFF} ${BLUE}[string]${OFF} ${RED}(required)${OFF}${OFF} - Samsara API access token.${YELLOW} Specify as: access_token=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e "  * ${GREEN}vehicle_id${OFF} ${BLUE}[integer]${OFF} ${RED}(required)${OFF}${OFF} - ID of the vehicle with the associated routes. ${YELLOW}Specify as: vehicle_id=value${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e "  * ${GREEN}startMs${OFF} ${BLUE}[integer]${OFF} ${RED}(required)${OFF}${OFF} - Time in Unix epoch milliseconds for the start of the query (cannot exceed 1 hour)${YELLOW} Specify as: startMs=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e "  * ${GREEN}endMs${OFF} ${BLUE}[integer]${OFF} ${RED}(required)${OFF}${OFF} - Time in Unix epoch milliseconds for the end of the query (cannot exceed 1 hour)${YELLOW} Specify as: endMs=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo ""
    echo -e "${BOLD}${WHITE}Responses${OFF}"
    code=200
...
print_getVehicleStats_help() {
    ...
    echo -e "  * ${GREEN}access_token${OFF} ${BLUE}[string]${OFF} ${RED}(required)${OFF}${OFF} - Samsara API access token.${YELLOW} Specify as: access_token=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e "  * ${GREEN}startMs${OFF} ${BLUE}[integer]${OFF} ${RED}(required)${OFF}${OFF} - Time in Unix epoch milliseconds for the start of the query.${YELLOW} Specify as: startMs=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e "  * ${GREEN}endMs${OFF} ${BLUE}[integer]${OFF} ${RED}(required)${OFF}${OFF} - Time in Unix epoch milliseconds for the end of the query.${YELLOW} Specify as: endMs=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e "  * ${GREEN}series${OFF} ${BLUE}[string]${OFF}${OFF} - Comma-separated list of stat types. Options are engineState, auxInput1, and auxInput2. If this parameter is excluded, all 3 stat types will be returned. Example: series=engineState,auxInput2${YELLOW} Specify as: series=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e "  * ${GREEN}tagIds${OFF} ${BLUE}[string]${OFF}${OFF} - Comma-separated list of tag ids. Example: tagIds=1,2,3${YELLOW} Specify as: tagIds=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e "  * ${GREEN}startingAfter${OFF} ${BLUE}[string]${OFF}${OFF} - Pagination parameter indicating the cursor position to continue returning results after. Used in conjunction with the 'limit' parameter. Mutually exclusive with 'endingBefore' parameter.${YELLOW} Specify as: startingAfter=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e "  * ${GREEN}endingBefore${OFF} ${BLUE}[string]${OFF}${OFF} - Pagination parameter indicating the cursor position to return results before. Used in conjunction with the 'limit' parameter. Mutually exclusive with 'startingAfter' parameter.${YELLOW} Specify as: endingBefore=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e "  * ${GREEN}limit${OFF} ${BLUE}[integer]${OFF}${OFF} - Pagination parameter indicating the number of results to return in this request. Used in conjunction with either 'startingAfter' or 'endingBefore'.${YELLOW} Specify as: limit=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo ""
    echo -e "${BOLD}${WHITE}Responses${OFF}"
    code=200
...
print_getVehiclesLocations_help() {
    ...
    echo -e "  * ${GREEN}access_token${OFF} ${BLUE}[string]${OFF} ${RED}(required)${OFF}${OFF} - Samsara API access token.${YELLOW} Specify as: access_token=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e "  * ${GREEN}startMs${OFF} ${BLUE}[integer]${OFF} ${RED}(required)${OFF}${OFF} - Time in Unix epoch milliseconds for the start of the query (cannot exceed 30 minutes)${YELLOW} Specify as: startMs=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e "  * ${GREEN}endMs${OFF} ${BLUE}[integer]${OFF} ${RED}(required)${OFF}${OFF} - Time in Unix epoch milliseconds for the end of the query (cannot exceed 30 minutes)${YELLOW} Specify as: endMs=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo ""
    echo -e "${BOLD}${WHITE}Responses${OFF}"
    code=200
...
print_updateOrganizationAddress_help() {
    ...
    echo -e "  * ${GREEN}access_token${OFF} ${BLUE}[string]${OFF} ${RED}(required)${OFF}${OFF} - Samsara API access token.${YELLOW} Specify as: access_token=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e "  * ${GREEN}addressId${OFF} ${BLUE}[integer]${OFF} ${RED}(required)${OFF}${OFF} - ID of the address/geofence ${YELLOW}Specify as: addressId=value${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e "  * ${GREEN}body${OFF} ${BLUE}[application/json]${OFF} ${RED}(required)${OFF}${OFF} - Update parts of an address's value. If the geofence 'circle' or 'polygon' key is specified, the update will change the type of geofence accordingly." | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
    echo ""
    echo -e "${BOLD}${WHITE}Responses${OFF}"
    code=200
...
print_getAllDataInputs_help() {
    ...
    echo -e "  * ${GREEN}group_id${OFF} ${BLUE}[integer]${OFF}${OFF} - Optional group ID if the organization has multiple groups (uncommon).${YELLOW} Specify as: group_id=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e "  * ${GREEN}startMs${OFF} ${BLUE}[integer]${OFF}${OFF} - Timestamp in unix milliseconds representing the start of the period to fetch, inclusive. Used in combination with endMs. defaults to nowMs.${YELLOW} Specify as: startMs=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e "  * ${GREEN}endMs${OFF} ${BLUE}[integer]${OFF}${OFF} - Timestamp in unix milliseconds representing the end of the period to fetch, inclusive. Used in combination with startMs. Defaults to nowMs.${YELLOW} Specify as: endMs=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo ""
    echo -e "${BOLD}${WHITE}Responses${OFF}"
    code=200
...
print_getDataInput_help() {
    ...
    echo -e "  * ${GREEN}access_token${OFF} ${BLUE}[string]${OFF} ${RED}(required)${OFF}${OFF} - Samsara API access token.${YELLOW} Specify as: access_token=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e "  * ${GREEN}data_input_id${OFF} ${BLUE}[integer]${OFF} ${RED}(required)${OFF}${OFF} - ID of the data input ${YELLOW}Specify as: data_input_id=value${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e "  * ${GREEN}startMs${OFF} ${BLUE}[integer]${OFF}${OFF} - Timestamp in unix milliseconds representing the start of the period to fetch, inclusive. Used in combination with endMs. defaults to nowMs.${YELLOW} Specify as: startMs=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e "  * ${GREEN}endMs${OFF} ${BLUE}[integer]${OFF}${OFF} - Timestamp in unix milliseconds representing the end of the period to fetch, inclusive. Used in combination with startMs. Defaults to nowMs.${YELLOW} Specify as: endMs=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
...
print_getMachinesHistory_help() {
    ...
    echo -e "  * ${GREEN}access_token${OFF} ${BLUE}[string]${OFF} ${RED}(required)${OFF}${OFF} - Samsara API access token.${YELLOW} Specify as: access_token=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e "  * ${GREEN}body${OFF} ${BLUE}[application/json]${OFF} ${RED}(required)${OFF}${OFF} - Group ID and time range to query for events" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
    echo ""
    echo -e "${BOLD}${WHITE}Responses${OFF}"
    code=200
...
print_getSensorsCargo_help() {
    ...
    echo -e "  * ${GREEN}access_token${OFF} ${BLUE}[string]${OFF} ${RED}(required)${OFF}${OFF} - Samsara API access token.${YELLOW} Specify as: access_token=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e "  * ${GREEN}body${OFF} ${BLUE}[application/json]${OFF} ${RED}(required)${OFF}${OFF} - Group ID and list of sensor IDs to query." | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
    echo ""
    echo -e "${BOLD}${WHITE}Responses${OFF}"
    code=200
...
print_getSensorsHistory_help() {
    ...
    echo -e "  * ${GREEN}access_token${OFF} ${BLUE}[string]${OFF} ${RED}(required)${OFF}${OFF} - Samsara API access token.${YELLOW} Specify as: access_token=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e "  * ${GREEN}body${OFF} ${BLUE}[application/json]${OFF} ${RED}(required)${OFF}${OFF} - Group ID, time range and resolution, and list of sensor ID, field pairs to query." | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
    echo ""
    echo -e "${BOLD}${WHITE}Responses${OFF}"
    code=200
...
print_deleteTagById_help() {
    ...
    echo -e "  * ${GREEN}access_token${OFF} ${BLUE}[string]${OFF} ${RED}(required)${OFF}${OFF} - Samsara API access token.${YELLOW} Specify as: access_token=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e "  * ${GREEN}tag_id${OFF} ${BLUE}[integer]${OFF} ${RED}(required)${OFF}${OFF} - ID of the tag. ${YELLOW}Specify as: tag_id=value${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo ""
    echo -e "${BOLD}${WHITE}Responses${OFF}"
    code=200
...
print_deleteUserById_help() {
    ...
    echo -e "  * ${GREEN}access_token${OFF} ${BLUE}[string]${OFF} ${RED}(required)${OFF}${OFF} - Samsara API access token.${YELLOW} Specify as: access_token=value${OFF}" \
        | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e "  * ${GREEN}userId${OFF} ${BLUE}[integer]${OFF} ${RED}(required)${OFF}${OFF} - ID of the user. ${YELLOW}Specify as: userId=value${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo ""
    echo -e "${BOLD}${WHITE}Responses${OFF}"
    code=200
