...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class UserTagRole : IEquatable<UserTagRole>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((UserTagRole)obj);
        }

        /// <summary>
        /// Returns true if UserTagRole instances are equal
        /// </summary>
        /// <param name="other">Instance of UserTagRole to be compared</param>
        /// <returns>Boolean</returns>
