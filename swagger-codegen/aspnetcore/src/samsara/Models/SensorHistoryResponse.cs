...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class SensorHistoryResponse : IEquatable<SensorHistoryResponse>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((SensorHistoryResponse)obj);
        }

        /// <summary>
        /// Returns true if SensorHistoryResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of SensorHistoryResponse to be compared</param>
        /// <returns>Boolean</returns>
