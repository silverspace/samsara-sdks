...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class VehicleLocation : IEquatable<VehicleLocation>
    { 
        /// <summary>
        /// Heading in degrees.
        /// </summary>
        ...
        /// </summary>
        /// <param name="other">Instance of VehicleLocation to be compared</param>
        /// <returns>Boolean</returns>
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (OnTrip != null)
                    hashCode = hashCode * 59 + OnTrip.GetHashCode();
                    if (Speed != null)
