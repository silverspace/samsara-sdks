...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class HumidityResponse : IEquatable<HumidityResponse>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((HumidityResponse)obj);
        }

        /// <summary>
        /// Returns true if HumidityResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of HumidityResponse to be compared</param>
        /// <returns>Boolean</returns>
