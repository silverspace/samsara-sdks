...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class HistoryParam1 : IEquatable<HistoryParam1>
    { 
        /// <summary>
        ...
        public enum FillMissingEnum
        {
            ...
            /// <summary>
            /// Enum WithNullEnum for withNull
            /// </summary>
            [EnumMember(Value = "withNull")]
            WithNullEnum = 1,
            
            /// <summary>
            /// Enum WithPreviousEnum for withPrevious
            /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((HistoryParam1)obj);
        }

        /// <summary>
        /// Returns true if HistoryParam1 instances are equal
        /// </summary>
        /// <param name="other">Instance of HistoryParam1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HistoryParam1 other)
        {
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (FillMissing != null)
                    hashCode = hashCode * 59 + FillMissing.GetHashCode();
                    if (GroupId != null)
                    ...
                    if (StepMs != null)
                    hashCode = hashCode * 59 + StepMs.GetHashCode();
                return hashCode;
            }
        }
        ...
        public static bool operator ==(HistoryParam1 left, HistoryParam1 right)
        {
