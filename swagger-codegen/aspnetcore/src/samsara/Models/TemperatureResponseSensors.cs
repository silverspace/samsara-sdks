...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class TemperatureResponseSensors : IEquatable<TemperatureResponseSensors>
    { 
        /// <summary>
        ...
        [DataMember(Name="ambientTemperature")]
        ...
        [DataMember(Name="probeTemperature")]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((TemperatureResponseSensors)obj);
        }

        /// <summary>
        /// Returns true if TemperatureResponseSensors instances are equal
        /// </summary>
        /// <param name="other">Instance of TemperatureResponseSensors to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TemperatureResponseSensors other)
        {
            ...
            return 
                (
                    ...
                    AmbientTemperature.Equals(other.AmbientTemperature)
                ) && 
                (
                    Id == other.Id ||
                    Id != null &&
                ...
                (
                    ProbeTemperature == other.ProbeTemperature ||
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + AmbientTemperature.GetHashCode();
                    if (Id != null)
                    hashCode = hashCode * 59 + Id.GetHashCode();
                    if (Name != null)
                    hashCode = hashCode * 59 + Name.GetHashCode();
                    if (ProbeTemperature != null)
                    hashCode = hashCode * 59 + ProbeTemperature.GetHashCode();
                return hashCode;
            }
        }
