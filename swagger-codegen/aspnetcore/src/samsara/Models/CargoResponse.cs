...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class CargoResponse : IEquatable<CargoResponse>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((CargoResponse)obj);
        }

        /// <summary>
        /// Returns true if CargoResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of CargoResponse to be compared</param>
        /// <returns>Boolean</returns>
