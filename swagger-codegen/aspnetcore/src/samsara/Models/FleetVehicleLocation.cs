...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class FleetVehicleLocation : IEquatable<FleetVehicleLocation>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((FleetVehicleLocation)obj);
        }

        /// <summary>
        /// Returns true if FleetVehicleLocation instances are equal
        /// </summary>
        /// <param name="other">Instance of FleetVehicleLocation to be compared</param>
        /// <returns>Boolean</returns>
