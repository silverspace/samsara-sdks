...
{ 
    ...
    { 
        ...
        [Required]
        [DataMember(Name="documentTypeUuid")]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((DocumentCreate)obj);
        }

        /// <summary>
        /// Returns true if DocumentCreate instances are equal
        /// </summary>
        /// <param name="other">Instance of DocumentCreate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DocumentCreate other)
        {
            ...
            return 
                (
                    DispatchJobId == other.DispatchJobId ||
                    DispatchJobId != null &&
                    DispatchJobId.Equals(other.DispatchJobId)
                ) && 
                (
                    Notes == other.Notes ||
                    Notes != null &&
                ...
                (
                    DocumentTypeUuid == other.DocumentTypeUuid ||
                    DocumentTypeUuid != null &&
                    DocumentTypeUuid.Equals(other.DocumentTypeUuid)
                ) && 
                (
                    Fields == other.Fields ||
                    Fields != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + DispatchJobId.GetHashCode();
                    if (Notes != null)
                    hashCode = hashCode * 59 + Notes.GetHashCode();
                    if (DocumentTypeUuid != null)
                    hashCode = hashCode * 59 + DocumentTypeUuid.GetHashCode();
                    if (Fields != null)
