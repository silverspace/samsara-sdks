...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class TagModifyDelete : IEquatable<TagModifyDelete>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((TagModifyDelete)obj);
        }

        /// <summary>
        /// Returns true if TagModifyDelete instances are equal
        /// </summary>
        /// <param name="other">Instance of TagModifyDelete to be compared</param>
        /// <returns>Boolean</returns>
