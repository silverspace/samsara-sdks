...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class UserTagRoleTag : IEquatable<UserTagRoleTag>
    { 
        /// <summary>
        /// The ID of this tag.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((UserTagRoleTag)obj);
        }

        /// <summary>
        /// Returns true if UserTagRoleTag instances are equal
        /// </summary>
        /// <param name="other">Instance of UserTagRoleTag to be compared</param>
        /// <returns>Boolean</returns>
