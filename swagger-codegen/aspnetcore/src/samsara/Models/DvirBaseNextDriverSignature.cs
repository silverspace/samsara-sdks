...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class DvirBaseNextDriverSignature : IEquatable<DvirBaseNextDriverSignature>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((DvirBaseNextDriverSignature)obj);
        }

        /// <summary>
        /// Returns true if DvirBaseNextDriverSignature instances are equal
        /// </summary>
        /// <param name="other">Instance of DvirBaseNextDriverSignature to be compared</param>
        /// <returns>Boolean</returns>
