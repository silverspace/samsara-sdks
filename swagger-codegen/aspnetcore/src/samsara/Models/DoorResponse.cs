...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class DoorResponse : IEquatable<DoorResponse>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((DoorResponse)obj);
        }

        /// <summary>
        /// Returns true if DoorResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of DoorResponse to be compared</param>
        /// <returns>Boolean</returns>
