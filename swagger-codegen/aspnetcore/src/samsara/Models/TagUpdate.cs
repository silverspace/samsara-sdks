...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class TagUpdate : IEquatable<TagUpdate>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((TagUpdate)obj);
        }

        /// <summary>
        /// Returns true if TagUpdate instances are equal
        /// </summary>
        /// <param name="other">Instance of TagUpdate to be compared</param>
        /// <returns>Boolean</returns>
