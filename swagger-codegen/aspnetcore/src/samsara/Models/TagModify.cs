...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class TagModify : IEquatable<TagModify>
    { 
        /// <summary>
        /// Gets or Sets Add
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((TagModify)obj);
        }

        /// <summary>
        /// Returns true if TagModify instances are equal
        /// </summary>
        /// <param name="other">Instance of TagModify to be compared</param>
        /// <returns>Boolean</returns>
