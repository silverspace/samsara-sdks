...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class HosLogsParam : IEquatable<HosLogsParam>
    { 
        /// <summary>
        /// Driver ID to query.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((HosLogsParam)obj);
        }

        /// <summary>
        /// Returns true if HosLogsParam instances are equal
        /// </summary>
        /// <param name="other">Instance of HosLogsParam to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HosLogsParam other)
        {
        ...
        public static bool operator ==(HosLogsParam left, HosLogsParam right)
        {
