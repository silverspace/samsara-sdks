...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class HosLogsParam1 : IEquatable<HosLogsParam1>
    { 
        /// <summary>
        /// Driver ID to query.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((HosLogsParam1)obj);
        }

        /// <summary>
        /// Returns true if HosLogsParam1 instances are equal
        /// </summary>
        /// <param name="other">Instance of HosLogsParam1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HosLogsParam1 other)
        {
        ...
        public static bool operator ==(HosLogsParam1 left, HosLogsParam1 right)
        {
