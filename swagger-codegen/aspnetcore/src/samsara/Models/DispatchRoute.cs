...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class DispatchRoute : IEquatable<DispatchRoute>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((DispatchRoute)obj);
        }

        /// <summary>
        /// Returns true if DispatchRoute instances are equal
        /// </summary>
        /// <param name="other">Instance of DispatchRoute to be compared</param>
        /// <returns>Boolean</returns>
