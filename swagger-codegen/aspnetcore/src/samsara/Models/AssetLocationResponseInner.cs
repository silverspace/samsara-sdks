...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class AssetLocationResponseInner : IEquatable<AssetLocationResponseInner>
    { 
        /// <summary>
        ...
        [DataMember(Name="speedMilesPerHour")]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((AssetLocationResponseInner)obj);
        }

        /// <summary>
        /// Returns true if AssetLocationResponseInner instances are equal
        /// </summary>
        /// <param name="other">Instance of AssetLocationResponseInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AssetLocationResponseInner other)
        {
            ...
            return 
                ...
                (
                    SpeedMilesPerHour == other.SpeedMilesPerHour ||
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + SpeedMilesPerHour.GetHashCode();
                    if (Time != null)
        ...
        public static bool operator ==(AssetLocationResponseInner left, AssetLocationResponseInner right)
        {
