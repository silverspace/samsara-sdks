...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class AddressGeofenceCircle : IEquatable<AddressGeofenceCircle>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((AddressGeofenceCircle)obj);
        }

        /// <summary>
        /// Returns true if AddressGeofenceCircle instances are equal
        /// </summary>
        /// <param name="other">Instance of AddressGeofenceCircle to be compared</param>
        /// <returns>Boolean</returns>
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + RadiusMeters.GetHashCode();
                return hashCode;
            }
        }
