...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class TripsParam : IEquatable<TripsParam>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((TripsParam)obj);
        }

        /// <summary>
        /// Returns true if TripsParam instances are equal
        /// </summary>
        /// <param name="other">Instance of TripsParam to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TripsParam other)
        {
        ...
        public static bool operator ==(TripsParam left, TripsParam right)
        {
