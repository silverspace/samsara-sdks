...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class AddressGeofencePolygon : IEquatable<AddressGeofencePolygon>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((AddressGeofencePolygon)obj);
        }

        /// <summary>
        /// Returns true if AddressGeofencePolygon instances are equal
        /// </summary>
        /// <param name="other">Instance of AddressGeofencePolygon to be compared</param>
        /// <returns>Boolean</returns>
