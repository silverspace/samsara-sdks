...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class DriverDailyLogResponseDays : IEquatable<DriverDailyLogResponseDays>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((DriverDailyLogResponseDays)obj);
        }

        /// <summary>
        /// Returns true if DriverDailyLogResponseDays instances are equal
        /// </summary>
        /// <param name="other">Instance of DriverDailyLogResponseDays to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DriverDailyLogResponseDays other)
        {
            ...
            return 
                (
                    ...
                    ActiveHours != null &&
                    ActiveHours.Equals(other.ActiveHours)
                ) && 
                (
                ...
                (
                    ...
                    Certified != null &&
                    Certified.Equals(other.Certified)
                ) && 
                (
                    CertifiedAtMs == other.CertifiedAtMs ||
                    CertifiedAtMs != null &&
                    CertifiedAtMs.Equals(other.CertifiedAtMs)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    if (ActiveHours != null)
                    hashCode = hashCode * 59 + ActiveHours.GetHashCode();
                    if (ActiveMs != null)
                    hashCode = hashCode * 59 + ActiveMs.GetHashCode();
                    if (Certified != null)
                    hashCode = hashCode * 59 + Certified.GetHashCode();
                    if (CertifiedAtMs != null)
                    hashCode = hashCode * 59 + CertifiedAtMs.GetHashCode();
                    ...
                    if (TrailerIds != null)
                    hashCode = hashCode * 59 + TrailerIds.GetHashCode();
                    if (VehicleIds != null)
                    hashCode = hashCode * 59 + VehicleIds.GetHashCode();
                return hashCode;
            }
        }
