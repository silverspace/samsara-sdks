...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class AssetReeferResponse : IEquatable<AssetReeferResponse>
    { 
        /// <summary>
        /// Asset type
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((AssetReeferResponse)obj);
        }

        /// <summary>
        /// Returns true if AssetReeferResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of AssetReeferResponse to be compared</param>
        /// <returns>Boolean</returns>
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (ReeferStats != null)
                    hashCode = hashCode * 59 + ReeferStats.GetHashCode();
                return hashCode;
            }
        }
