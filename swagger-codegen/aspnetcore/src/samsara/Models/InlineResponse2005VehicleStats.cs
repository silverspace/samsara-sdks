...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse2005VehicleStats : IEquatable<InlineResponse2005VehicleStats>
    { 
        /// <summary>
        /// Gets or Sets AuxInput1
        /// </summary>
        [DataMember(Name="auxInput1")]
        public AuxInputSeries AuxInput1 { get; set; }

        /// <summary>
        /// Gets or Sets AuxInput2
        /// </summary>
        [DataMember(Name="auxInput2")]
        public AuxInputSeries AuxInput2 { get; set; }

        /// <summary>
        /// Gets or Sets EngineState
        /// </summary>
        [DataMember(Name="engineState")]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((InlineResponse2005VehicleStats)obj);
        }

        /// <summary>
        /// Returns true if InlineResponse2005VehicleStats instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse2005VehicleStats to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2005VehicleStats other)
        {
            ...
            return 
                (
                    AuxInput1 == other.AuxInput1 ||
                    AuxInput1 != null &&
                    AuxInput1.Equals(other.AuxInput1)
                ) && 
                (
                    AuxInput2 == other.AuxInput2 ||
                    AuxInput2 != null &&
                ...
                (
                    ...
                    EngineState != null &&
                    EngineState.SequenceEqual(other.EngineState)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    if (AuxInput1 != null)
                    hashCode = hashCode * 59 + AuxInput1.GetHashCode();
                    if (AuxInput2 != null)
                    hashCode = hashCode * 59 + AuxInput2.GetHashCode();
                    if (EngineState != null)
                    hashCode = hashCode * 59 + EngineState.GetHashCode();
                    if (VehicleId != null)
