...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class AddressParam : IEquatable<AddressParam>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((AddressParam)obj);
        }

        /// <summary>
        /// Returns true if AddressParam instances are equal
        /// </summary>
        /// <param name="other">Instance of AddressParam to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddressParam other)
        {
        ...
        public static bool operator ==(AddressParam left, AddressParam right)
        {
