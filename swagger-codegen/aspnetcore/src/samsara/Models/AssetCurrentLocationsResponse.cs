...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class AssetCurrentLocationsResponse : IEquatable<AssetCurrentLocationsResponse>
    { 
        /// <summary>
        /// The cable connected to the asset
        /// </summary>
        /// <value>The cable connected to the asset</value>
        [DataMember(Name="cable")]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((AssetCurrentLocationsResponse)obj);
        }

        /// <summary>
        /// Returns true if AssetCurrentLocationsResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of AssetCurrentLocationsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AssetCurrentLocationsResponse other)
        {
            ...
            return 
                (
                    Cable == other.Cable ||
                    Cable != null &&
                    Cable.SequenceEqual(other.Cable)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    if (Cable != null)
                    hashCode = hashCode * 59 + Cable.GetHashCode();
                    if (EngineHours != null)
