...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class DataInputHistoryResponse : IEquatable<DataInputHistoryResponse>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((DataInputHistoryResponse)obj);
        }

        /// <summary>
        /// Returns true if DataInputHistoryResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of DataInputHistoryResponse to be compared</param>
        /// <returns>Boolean</returns>
