...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class AllRouteJobUpdates : IEquatable<AllRouteJobUpdates>
    { 
        /// <summary>
        /// Gets or Sets JobUpdates
        /// </summary>
        [DataMember(Name="job_updates")]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((AllRouteJobUpdates)obj);
        }

        /// <summary>
        /// Returns true if AllRouteJobUpdates instances are equal
        /// </summary>
        /// <param name="other">Instance of AllRouteJobUpdates to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AllRouteJobUpdates other)
        {
            ...
            return 
                (
                    ...
                    JobUpdates != null &&
                    JobUpdates.SequenceEqual(other.JobUpdates)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    if (JobUpdates != null)
                    hashCode = hashCode * 59 + JobUpdates.GetHashCode();
                    if (SequenceId != null)
