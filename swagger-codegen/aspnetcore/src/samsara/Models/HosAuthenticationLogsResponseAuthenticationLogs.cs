...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class HosAuthenticationLogsResponseAuthenticationLogs : IEquatable<HosAuthenticationLogsResponseAuthenticationLogs>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((HosAuthenticationLogsResponseAuthenticationLogs)obj);
        }

        /// <summary>
        /// Returns true if HosAuthenticationLogsResponseAuthenticationLogs instances are equal
        /// </summary>
        /// <param name="other">Instance of HosAuthenticationLogsResponseAuthenticationLogs to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HosAuthenticationLogsResponseAuthenticationLogs other)
        {
            ...
            return 
                ...
                (
                    HappenedAtMs == other.HappenedAtMs ||
                    HappenedAtMs != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (AddressName != null)
                    hashCode = hashCode * 59 + AddressName.GetHashCode();
                    if (City != null)
                    hashCode = hashCode * 59 + City.GetHashCode();
                    if (HappenedAtMs != null)
                    hashCode = hashCode * 59 + HappenedAtMs.GetHashCode();
                    if (State != null)
