...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class DriverBase : IEquatable<DriverBase>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((DriverBase)obj);
        }

        /// <summary>
        /// Returns true if DriverBase instances are equal
        /// </summary>
        /// <param name="other">Instance of DriverBase to be compared</param>
        /// <returns>Boolean</returns>
