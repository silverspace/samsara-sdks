...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class DriverForCreate : IEquatable<DriverForCreate>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((DriverForCreate)obj);
        }

        /// <summary>
        /// Returns true if DriverForCreate instances are equal
        /// </summary>
        /// <param name="other">Instance of DriverForCreate to be compared</param>
        /// <returns>Boolean</returns>
