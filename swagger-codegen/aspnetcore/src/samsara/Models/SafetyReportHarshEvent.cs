...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class SafetyReportHarshEvent : IEquatable<SafetyReportHarshEvent>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((SafetyReportHarshEvent)obj);
        }

        /// <summary>
        /// Returns true if SafetyReportHarshEvent instances are equal
        /// </summary>
        /// <param name="other">Instance of SafetyReportHarshEvent to be compared</param>
        /// <returns>Boolean</returns>
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (TimestampMs != null)
                    hashCode = hashCode * 59 + TimestampMs.GetHashCode();
                    if (VehicleId != null)
