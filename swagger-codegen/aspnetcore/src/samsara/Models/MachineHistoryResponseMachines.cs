...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class MachineHistoryResponseMachines : IEquatable<MachineHistoryResponseMachines>
    { 
        /// <summary>
        /// Machine ID
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((MachineHistoryResponseMachines)obj);
        }

        /// <summary>
        /// Returns true if MachineHistoryResponseMachines instances are equal
        /// </summary>
        /// <param name="other">Instance of MachineHistoryResponseMachines to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MachineHistoryResponseMachines other)
        {
            ...
            return 
                ...
                (
                    ...
                    Vibrations != null &&
                    Vibrations.SequenceEqual(other.Vibrations)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (Vibrations != null)
                    hashCode = hashCode * 59 + Vibrations.GetHashCode();
                return hashCode;
            }
        }
