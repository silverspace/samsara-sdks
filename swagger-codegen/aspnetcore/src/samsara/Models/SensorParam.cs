...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class SensorParam : IEquatable<SensorParam>
    { 
        /// <summary>
        /// Group ID to query.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((SensorParam)obj);
        }

        /// <summary>
        /// Returns true if SensorParam instances are equal
        /// </summary>
        /// <param name="other">Instance of SensorParam to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SensorParam other)
        {
        ...
        public static bool operator ==(SensorParam left, SensorParam right)
        {
