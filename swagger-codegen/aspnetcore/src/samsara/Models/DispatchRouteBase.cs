...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class DispatchRouteBase : IEquatable<DispatchRouteBase>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((DispatchRouteBase)obj);
        }

        /// <summary>
        /// Returns true if DispatchRouteBase instances are equal
        /// </summary>
        /// <param name="other">Instance of DispatchRouteBase to be compared</param>
        /// <returns>Boolean</returns>
