...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class TemperatureResponse : IEquatable<TemperatureResponse>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((TemperatureResponse)obj);
        }

        /// <summary>
        /// Returns true if TemperatureResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of TemperatureResponse to be compared</param>
        /// <returns>Boolean</returns>
