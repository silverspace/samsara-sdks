...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class SensorHistoryResponseResults : IEquatable<SensorHistoryResponseResults>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((SensorHistoryResponseResults)obj);
        }

        /// <summary>
        /// Returns true if SensorHistoryResponseResults instances are equal
        /// </summary>
        /// <param name="other">Instance of SensorHistoryResponseResults to be compared</param>
        /// <returns>Boolean</returns>
