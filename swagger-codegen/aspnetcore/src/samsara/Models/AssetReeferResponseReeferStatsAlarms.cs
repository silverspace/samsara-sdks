...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class AssetReeferResponseReeferStatsAlarms : IEquatable<AssetReeferResponseReeferStatsAlarms>
    { 
        /// <summary>
        /// ID of the alarm
        /// </summary>
        /// <value>ID of the alarm</value>
        [DataMember(Name="alarmCode")]
        ...
        [DataMember(Name="operatorAction")]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((AssetReeferResponseReeferStatsAlarms)obj);
        }

        /// <summary>
        /// Returns true if AssetReeferResponseReeferStatsAlarms instances are equal
        /// </summary>
        /// <param name="other">Instance of AssetReeferResponseReeferStatsAlarms to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AssetReeferResponseReeferStatsAlarms other)
        {
            ...
            return 
                ...
                (
                    OperatorAction == other.OperatorAction ||
                    OperatorAction != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    if (AlarmCode != null)
                    hashCode = hashCode * 59 + AlarmCode.GetHashCode();
                    if (Description != null)
                    hashCode = hashCode * 59 + Description.GetHashCode();
                    if (OperatorAction != null)
                    hashCode = hashCode * 59 + OperatorAction.GetHashCode();
                    if (Severity != null)
