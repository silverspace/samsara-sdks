...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class HumidityResponseSensors : IEquatable<HumidityResponseSensors>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((HumidityResponseSensors)obj);
        }

        /// <summary>
        /// Returns true if HumidityResponseSensors instances are equal
        /// </summary>
        /// <param name="other">Instance of HumidityResponseSensors to be compared</param>
        /// <returns>Boolean</returns>
