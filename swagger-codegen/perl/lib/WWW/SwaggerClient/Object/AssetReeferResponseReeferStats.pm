...
#
package WWW::SwaggerClient::Object::AssetReeferResponseReeferStats;
...
__PACKAGE__->method_documentation({
    'alarms' => {
    	datatype => 'ARRAY[AssetReeferResponseReeferStatsAlarms1]',
    	base_name => 'alarms',
    ...
    'engine_hours' => {
    	datatype => 'ARRAY[AssetReeferResponseReeferStatsEngineHours]',
    	base_name => 'engineHours',
    	description => 'Engine hours of the reefer',
    	format => '',
    	read_only => '',
    		},
    'fuel_percentage' => {
    	datatype => 'ARRAY[AssetReeferResponseReeferStatsFuelPercentage]',
    	base_name => 'fuelPercentage',
    	description => 'Fuel percentage of the reefer',
    	format => '',
    	read_only => '',
    		},
    'power_status' => {
    	datatype => 'ARRAY[AssetReeferResponseReeferStatsPowerStatus]',
    	base_name => 'powerStatus',
    	description => 'Power status of the reefer',
    	format => '',
    	read_only => '',
    		},
    'return_air_temp' => {
    	datatype => 'ARRAY[AssetReeferResponseReeferStatsReturnAirTemp]',
    	base_name => 'returnAirTemp',
    	description => 'Return air temperature of the reefer',
    	format => '',
    	read_only => '',
    		},
    'set_point' => {
    	datatype => 'ARRAY[AssetReeferResponseReeferStatsSetPoint]',
    	base_name => 'setPoint',
