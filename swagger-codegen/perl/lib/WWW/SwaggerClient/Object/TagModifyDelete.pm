...
#
package WWW::SwaggerClient::Object::TagModifyDelete;
...
__PACKAGE__->class_documentation({description => 'Specify devices, etc. that should be removed from the tag.',
...
__PACKAGE__->method_documentation({
    'assets' => {
    	datatype => 'ARRAY[TaggedAssetBase]',
    	base_name => 'assets',
    ...
    'drivers' => {
    	datatype => 'ARRAY[TaggedDriverBase]',
    	base_name => 'drivers',
    ...
    'machines' => {
    	datatype => 'ARRAY[TaggedMachineBase]',
    	base_name => 'machines',
    ...
    'sensors' => {
    	datatype => 'ARRAY[TaggedSensorBase]',
    	base_name => 'sensors',
    ...
    'vehicles' => {
    	datatype => 'ARRAY[TaggedVehicleBase]',
    	base_name => 'vehicles',
