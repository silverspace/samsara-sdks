...
#
package WWW::SwaggerClient::Object::VehicleHarshEventResponse;
...
__PACKAGE__->class_documentation({description => 'Harsh event details for a vehicle',
...
__PACKAGE__->method_documentation({
    'download_forward_video_url' => {
    	datatype => 'string',
    	base_name => 'downloadForwardVideoUrl',
    ...
    'download_inward_video_url' => {
    	datatype => 'string',
    	base_name => 'downloadInwardVideoUrl',
    ...
    'download_tracked_inward_video_url' => {
    	datatype => 'string',
    	base_name => 'downloadTrackedInwardVideoUrl',
