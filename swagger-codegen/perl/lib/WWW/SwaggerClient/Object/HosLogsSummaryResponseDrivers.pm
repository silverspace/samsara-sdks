...
#
package WWW::SwaggerClient::Object::HosLogsSummaryResponseDrivers;
...
__PACKAGE__->method_documentation({
    ...
    'driving_in_violation_cycle' => {
    	datatype => 'int',
    	base_name => 'drivingInViolationCycle',
    ...
    'driving_in_violation_today' => {
    	datatype => 'int',
    	base_name => 'drivingInViolationToday',
