...
#
package WWW::SwaggerClient::Object::AssetCurrentLocationsResponse;
...
__PACKAGE__->class_documentation({description => 'Basic information of an asset',
...
__PACKAGE__->method_documentation({
    ...
    'location' => {
    	datatype => 'ARRAY[AssetCurrentLocation]',
    	base_name => 'location',
