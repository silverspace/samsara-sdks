...
#
package WWW::SwaggerClient::Object::AddressGeofencePolygon;
...
__PACKAGE__->class_documentation({description => 'Information about a polygon geofence. This field is only populated if the geofence is a polygon.',
...
__PACKAGE__->method_documentation({
    'vertices' => {
    	datatype => 'ARRAY[AddressGeofencePolygonVertices]',
    	base_name => 'vertices',
