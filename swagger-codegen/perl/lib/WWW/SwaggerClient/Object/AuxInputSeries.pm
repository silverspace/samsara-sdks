...
#
package WWW::SwaggerClient::Object::AuxInputSeries;
...
__PACKAGE__->class_documentation({description => 'A list of aux input values over a timerange.',
