...
class TripResponseTrips(object):
    ...
    def __init__(self, distance_meters=None, driver_id=None, end_address=None, end_coordinates=None, end_location=None, end_ms=None, end_odometer=None, fuel_consumed_ml=None, start_address=None, start_coordinates=None, start_location=None, start_ms=None, start_odometer=None, toll_meters=None):  # noqa: E501
        """TripResponseTrips - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TripResponseTrips, dict):
