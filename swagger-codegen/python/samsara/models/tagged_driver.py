...
class TaggedDriver(object):
    ...
    def __init__(self, id=None, name=None):  # noqa: E501
        """TaggedDriver - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def id(self):
        """Gets the id of this TaggedDriver.  # noqa: E501

        The ID of the Driver being tagged.  # noqa: E501

        :return: The id of this TaggedDriver.  # noqa: E501
        :rtype: int
        """
        return self._id
    ...
    @property
    def name(self):
        """Gets the name of this TaggedDriver.  # noqa: E501

        Name of the Driver being tagged.  # noqa: E501

        :return: The name of this TaggedDriver.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TaggedDriver, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TaggedDriver):
            return False
