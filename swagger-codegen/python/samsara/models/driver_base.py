...
class DriverBase(object):
    ...
    def __init__(self, eld_adverse_weather_exemption_enabled=None, eld_big_day_exemption_enabled=None, eld_day_start_hour=None, eld_exempt=None, eld_exempt_reason=None, eld_pc_enabled=False, eld_ym_enabled=False, external_ids=None, group_id=None, license_number=None, license_state=None, name=None, notes=None, phone=None, username=None, vehicle_id=None):  # noqa: E501
        """DriverBase - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def group_id(self):
        """Gets the group_id of this DriverBase.  # noqa: E501

        ID of the group if the organization has multiple groups (uncommon).  # noqa: E501

        :return: The group_id of this DriverBase.  # noqa: E501
        :rtype: int
        """
    ...
    @property
    def vehicle_id(self):
        """Gets the vehicle_id of this DriverBase.  # noqa: E501

        ID of the vehicle assigned to the driver for static vehicle assignments. (uncommon).  # noqa: E501

        :return: The vehicle_id of this DriverBase.  # noqa: E501
        :rtype: int
        """
