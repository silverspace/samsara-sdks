...
class HosLogsSummaryResponse(object):
    ...
    def __init__(self, drivers=None):  # noqa: E501
        """HosLogsSummaryResponse - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def drivers(self):
        """Gets the drivers of this HosLogsSummaryResponse.  # noqa: E501


        :return: The drivers of this HosLogsSummaryResponse.  # noqa: E501
    ...
    def drivers(self, drivers):
        ...
        :type: list[HosLogsSummaryResponseDrivers]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(HosLogsSummaryResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, HosLogsSummaryResponse):
            return False
