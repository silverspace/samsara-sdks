...
class Driver(object):
    ...
    def __init__(self, eld_adverse_weather_exemption_enabled=None, eld_big_day_exemption_enabled=None, eld_day_start_hour=None, eld_exempt=None, eld_exempt_reason=None, eld_pc_enabled=False, eld_ym_enabled=False, external_ids=None, group_id=None, license_number=None, license_state=None, name=None, notes=None, phone=None, username=None, vehicle_id=None, current_vehicle_id=None):  # noqa: E501
    ...
    @property
    def group_id(self):
        """Gets the group_id of this Driver.  # noqa: E501

        ID of the group if the organization has multiple groups (uncommon).  # noqa: E501

        :return: The group_id of this Driver.  # noqa: E501
        :rtype: int
        """
    ...
    @property
    def vehicle_id(self):
        """Gets the vehicle_id of this Driver.  # noqa: E501

        ID of the vehicle assigned to the driver for static vehicle assignments. (uncommon).  # noqa: E501

        :return: The vehicle_id of this Driver.  # noqa: E501
        :rtype: int
        """
    ...
    def current_vehicle_id(self):
        """Gets the current_vehicle_id of this Driver.  # noqa: E501

        ID of the vehicle that this driver is currently assigned to. Omitted if there is no current vehicle assignment for this driver.  # noqa: E501

        :return: The current_vehicle_id of this Driver.  # noqa: E501
        :rtype: int
        """
    ...
    def current_vehicle_id(self, current_vehicle_id):
        """Sets the current_vehicle_id of this Driver.

        ID of the vehicle that this driver is currently assigned to. Omitted if there is no current vehicle assignment for this driver.  # noqa: E501

        :param current_vehicle_id: The current_vehicle_id of this Driver.  # noqa: E501
        :type: int
        """
