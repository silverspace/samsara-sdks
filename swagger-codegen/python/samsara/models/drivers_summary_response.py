...
class DriversSummaryResponse(object):
    ...
    def __init__(self, summaries=None):  # noqa: E501
        """DriversSummaryResponse - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def summaries(self):
        """Gets the summaries of this DriversSummaryResponse.  # noqa: E501


        :return: The summaries of this DriversSummaryResponse.  # noqa: E501
    ...
    def summaries(self, summaries):
        ...
        :type: list[DriversSummaryResponseSummaries]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DriversSummaryResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DriversSummaryResponse):
            return False
