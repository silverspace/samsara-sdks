...
class InlineResponse2005VehicleStats(object):
    ...
    def __init__(self, aux_input1=None, aux_input2=None, engine_state=None, vehicle_id=None):  # noqa: E501
        """InlineResponse2005VehicleStats - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(InlineResponse2005VehicleStats, dict):
