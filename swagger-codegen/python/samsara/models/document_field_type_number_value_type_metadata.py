...
class DocumentFieldTypeNumberValueTypeMetadata(object):
    ...
    def __init__(self, num_decimal_places=None):  # noqa: E501
        """DocumentFieldTypeNumberValueTypeMetadata - a model defined in Swagger"""  # noqa: E501
    ...
    def num_decimal_places(self):
        """Gets the num_decimal_places of this DocumentFieldTypeNumberValueTypeMetadata.  # noqa: E501

        Number of decimal places that values for this field type can have.  # noqa: E501

        :return: The num_decimal_places of this DocumentFieldTypeNumberValueTypeMetadata.  # noqa: E501
        :rtype: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DocumentFieldTypeNumberValueTypeMetadata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DocumentFieldTypeNumberValueTypeMetadata):
            return False
