...
class FleetApi(object):
    ...
    def create_driver_document_with_http_info(self, access_token, driver_id, create_document_params, **kwargs):  # noqa: E501
        ...
        if ('create_document_params' not in params or
                params['create_document_params'] is None):
        ...
        body_params = None
        if 'create_document_params' in params:
            body_params = params['create_document_params']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
    ...
    def create_dvir_with_http_info(self, access_token, create_dvir_param, **kwargs):  # noqa: E501
        ...
        if ('create_dvir_param' not in params or
                params['create_dvir_param'] is None):
        ...
        body_params = None
        if 'create_dvir_param' in params:
            body_params = params['create_dvir_param']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
    ...
    def get_asset_location_with_http_info(self, access_token, asset_id, start_ms, end_ms, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='AssetLocationResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_dvirs_with_http_info(self, access_token, end_ms, duration_ms, **kwargs):  # noqa: E501
        ...
        if 'access_token' in params:
            query_params.append(('access_token', params['access_token']))  # noqa: E501
        if 'end_ms' in params:
            query_params.append(('end_ms', params['end_ms']))  # noqa: E501
        if 'duration_ms' in params:
            query_params.append(('duration_ms', params['duration_ms']))  # noqa: E501
        if 'group_id' in params:
            query_params.append(('group_id', params['group_id']))  # noqa: E501
    ...
    def get_fleet_drivers_with_http_info(self, access_token, group_drivers_param, **kwargs):  # noqa: E501
        ...
        if ('group_drivers_param' not in params or
                params['group_drivers_param'] is None):
    ...
    def get_fleet_drivers_hos_daily_logs_with_http_info(self, access_token, driver_id, hos_logs_param, **kwargs):  # noqa: E501
        ...
        if ('hos_logs_param' not in params or
                params['hos_logs_param'] is None):
    ...
    def get_fleet_drivers_summary_with_http_info(self, access_token, drivers_summary_param, **kwargs):  # noqa: E501
        ...
        if ('drivers_summary_param' not in params or
                params['drivers_summary_param'] is None):
        ...
        if 'access_token' in params:
            query_params.append(('access_token', params['access_token']))  # noqa: E501
        if 'snap_to_day_bounds' in params:
            query_params.append(('snap_to_day_bounds', params['snap_to_day_bounds']))  # noqa: E501
    ...
    def get_fleet_hos_authentication_logs_with_http_info(self, access_token, hos_authentication_logs_param, **kwargs):  # noqa: E501
        ...
        if ('hos_authentication_logs_param' not in params or
                params['hos_authentication_logs_param'] is None):
    ...
    def get_fleet_locations_with_http_info(self, access_token, group_param, **kwargs):  # noqa: E501
        ...
        if ('group_param' not in params or
                params['group_param'] is None):
    ...
    def get_fleet_trips_with_http_info(self, access_token, trips_param, **kwargs):  # noqa: E501
        ...
        if ('trips_param' not in params or
                params['trips_param'] is None):
    ...
    def get_fleet_vehicle_with_http_info(self, access_token, vehicle_id_or_external_id, **kwargs):  # noqa: E501
        ...
        if ('vehicle_id_or_external_id' not in params or
                params['vehicle_id_or_external_id'] is None):
            raise ValueError("Missing the required parameter `vehicle_id_or_external_id` when calling `get_fleet_vehicle`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'vehicle_id_or_external_id' in params:
            path_params['vehicle_id_or_external_id'] = params['vehicle_id_or_external_id']  # noqa: E501
    ...
    def get_vehicle_locations_with_http_info(self, access_token, vehicle_id, start_ms, end_ms, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='FleetVehicleLocations',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_vehicles_locations_with_http_info(self, access_token, start_ms, end_ms, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='FleetVehiclesLocations',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def update_organization_address(self, access_token, address, address_id, **kwargs):  # noqa: E501
        """/addresses/{addressId}  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_organization_address(access_token, address, address_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_organization_address_with_http_info(access_token, address, address_id, **kwargs)  # noqa: E501
        else:
            (data) = self.update_organization_address_with_http_info(access_token, address, address_id, **kwargs)  # noqa: E501
            return data

    def update_organization_address_with_http_info(self, access_token, address, address_id, **kwargs):  # noqa: E501
        """/addresses/{addressId}  # noqa: E501

        Update the name, formatted address, geofence, notes, or tag and contact Ids for an address. The set of tags or contacts associated with this address will be updated to exactly match the list of IDs passed in. To remove all tags or contacts from an address, pass an empty list; to remove notes, pass an empty string.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_organization_address_with_http_info(access_token, address, address_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['access_token', 'address', 'address_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def update_vehicles_with_http_info(self, access_token, vehicle_update_param, **kwargs):  # noqa: E501
        ...
        if ('vehicle_update_param' not in params or
                params['vehicle_update_param'] is None):
