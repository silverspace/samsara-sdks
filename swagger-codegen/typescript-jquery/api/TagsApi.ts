...
export class TagsApi {
     ...
     */
    public createTag(accessToken: string, tagCreateParams: models.TagCreate, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body: models.Tag;  }> {
        let localVarPath = this.basePath + '/tags';
        ...
        requestOptions.data = JSON.stringify(tagCreateParams);
        ...
        $.ajax(requestOptions).then(
            (data: models.Tag, textStatus: string, jqXHR: JQueryXHR) =>
     ...
     */
    public deleteTagById(accessToken: string, tagId: number, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body?: any;  }> {
        let localVarPath = this.basePath + '/tags/{tag_id}'.replace('{' + 'tag_id' + '}', encodeURIComponent(String(tagId)));
     ...
     */
    public getAllTags(accessToken: string, groupId?: number, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body: models.InlineResponse2009;  }> {
        let localVarPath = this.basePath + '/tags';
        ...
        let dfd = $.Deferred();
        $.ajax(requestOptions).then(
            (data: models.InlineResponse2009, textStatus: string, jqXHR: JQueryXHR) =>
                dfd.resolve(jqXHR, data),
            (xhr: JQueryXHR, textStatus: string, errorThrown: string) =>
                dfd.reject(xhr, errorThrown)
        );
     ...
     * @param tagId ID of the tag.
     */
    public getTagById(accessToken: string, tagId: number, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body: models.Tag;  }> {
        let localVarPath = this.basePath + '/tags/{tag_id}'.replace('{' + 'tag_id' + '}', encodeURIComponent(String(tagId)));
     ...
     */
    public modifyTagById(accessToken: string, tagId: number, tagModifyParams: models.TagModify, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body: models.Tag;  }> {
        let localVarPath = this.basePath + '/tags/{tag_id}'.replace('{' + 'tag_id' + '}', encodeURIComponent(String(tagId)));
        ...
        requestOptions.data = JSON.stringify(tagModifyParams);
        if (headerParams['Content-Type']) {
            requestOptions.contentType = headerParams['Content-Type'];
        }
     ...
     */
    public updateTagById(accessToken: string, tagId: number, updateTagParams: models.TagUpdate, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body: models.Tag;  }> {
        let localVarPath = this.basePath + '/tags/{tag_id}'.replace('{' + 'tag_id' + '}', encodeURIComponent(String(tagId)));
        ...
        requestOptions.data = JSON.stringify(updateTagParams);
        if (headerParams['Content-Type']) {
            requestOptions.contentType = headerParams['Content-Type'];
        }
