...
export class SensorsApi {
     ...
     */
    public getSensors(accessToken: string, groupParam: models.GroupParam, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body: models.InlineResponse2008;  }> {
     ...
     */
    public getSensorsCargo(accessToken: string, sensorParam: models.SensorParam, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body: models.CargoResponse;  }> {
     ...
     * @param sensorParam Group ID and list of sensor IDs to query.
     */
    public getSensorsDoor(accessToken: string, sensorParam: models.SensorParam, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body: models.DoorResponse;  }> {
     ...
     */
    public getSensorsHistory(accessToken: string, historyParam: models.HistoryParam1, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body: models.SensorHistoryResponse;  }> {
     ...
     * @param sensorParam Group ID and list of sensor IDs to query.
     */
    public getSensorsHumidity(accessToken: string, sensorParam: models.SensorParam, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body: models.HumidityResponse;  }> {
     ...
     * @param sensorParam Group ID and list of sensor IDs to query.
     */
    public getSensorsTemperature(accessToken: string, sensorParam: models.SensorParam, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body: models.TemperatureResponse;  }> {
