...
export class IndustrialApi {
     ...
     */
    public getAllDataInputs(accessToken: string, groupId?: number, startMs?: number, endMs?: number, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body: models.InlineResponse2006;  }> {
     ...
     * @param endMs Timestamp in unix milliseconds representing the end of the period to fetch, inclusive. Used in combination with startMs. Defaults to nowMs.
     */
    public getDataInput(accessToken: string, dataInputId: number, startMs?: number, endMs?: number, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body: models.DataInputHistoryResponse;  }> {
     ...
     */
    public getMachines(accessToken: string, groupParam: models.GroupParam, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body: models.InlineResponse2007;  }> {
     ...
     */
    public getMachinesHistory(accessToken: string, historyParam: models.HistoryParam, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body: models.MachineHistoryResponse;  }> {
