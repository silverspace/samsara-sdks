...
export class FleetApi {
     ...
     * @param addressParam 
     */
    public addFleetAddress(accessToken: string, addressParam: models.AddressParam, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body?: any;  }> {
     ...
     */
    public addOrganizationAddresses(accessToken: string, addresses: models.Addresses, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body: Array<models.Address>;  }> {
     ...
     */
    public createDispatchRoute(accessToken: string, createDispatchRouteParams: models.DispatchRouteCreate, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body: models.DispatchRoute;  }> {
     ...
     * @param createDispatchRouteParams 
     */
    public createDriverDispatchRoute(accessToken: string, driverId: number, createDispatchRouteParams: models.DispatchRouteCreate, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body: models.DispatchRoute;  }> {
     ...
     */
    public createDriverDocument(accessToken: string, driverId: number, createDocumentParams: models.DocumentCreate, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body: models.Document;  }> {
     ...
     */
    public createDvir(accessToken: string, createDvirParam: models.CreateDvirParam, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body: models.DvirBase;  }> {
     ...
     * @param createDispatchRouteParams 
     */
    public createVehicleDispatchRoute(accessToken: string, vehicleId: number, createDispatchRouteParams: models.DispatchRouteCreate, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body: models.DispatchRoute;  }> {
     ...
     */
    public deleteDispatchRouteById(accessToken: string, routeId: number, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body?: any;  }> {
     ...
     */
    public deleteOrganizationAddress(accessToken: string, addressId: number, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body?: any;  }> {
     ...
     */
    public fetchAllDispatchRoutes(accessToken: string, groupId?: number, endTime?: number, duration?: number, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body: models.DispatchRoutes;  }> {
        let localVarPath = this.basePath + '/fleet/dispatch/routes';
        ...
        let dfd = $.Deferred();
        $.ajax(requestOptions).then(
            (data: models.DispatchRoutes, textStatus: string, jqXHR: JQueryXHR) =>
                dfd.resolve(jqXHR, data),
            (xhr: JQueryXHR, textStatus: string, errorThrown: string) =>
                dfd.reject(xhr, errorThrown)
        );
     ...
     */
    public fetchAllRouteJobUpdates(accessToken: string, groupId?: number, sequenceId?: string, include?: string, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body: models.AllRouteJobUpdates;  }> {
     ...
     * @param groupId Optional group ID if the organization has multiple groups (uncommon).
     */
    public getAllAssetCurrentLocations(accessToken: string, groupId?: number, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body: models.InlineResponse2001;  }> {
     ...
     * @param groupId Optional group ID if the organization has multiple groups (uncommon).
     */
    public getAllAssets(accessToken: string, groupId?: number, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body: models.InlineResponse200;  }> {
     ...
     */
    public getAssetLocation(accessToken: string, assetId: number, startMs: number, endMs: number, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body: models.AssetLocationResponse;  }> {
        ...
        let dfd = $.Deferred();
        $.ajax(requestOptions).then(
            (data: models.AssetLocationResponse, textStatus: string, jqXHR: JQueryXHR) =>
                dfd.resolve(jqXHR, data),
            (xhr: JQueryXHR, textStatus: string, errorThrown: string) =>
                dfd.reject(xhr, errorThrown)
        );
     ...
     * @param endMs Timestamp in milliseconds representing the end of the period to fetch, inclusive. Used in combination with startMs.
     */
    public getAssetReefer(accessToken: string, assetId: number, startMs: number, endMs: number, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body: models.AssetReeferResponse;  }> {
     ...
     * @param routeId ID of the dispatch route.
     */
    public getDispatchRouteById(accessToken: string, routeId: number, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body: models.DispatchRoute;  }> {
        let localVarPath = this.basePath + '/fleet/dispatch/routes/{route_id}'.replace('{' + 'route_id' + '}', encodeURIComponent(String(routeId)));
     ...
     */
    public getDispatchRouteHistory(accessToken: string, routeId: number, startTime?: number, endTime?: number, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body: models.DispatchRouteHistory;  }> {
     ...
     * @param duration Time in milliseconds that represents the duration before end_time to query. Defaults to 24 hours.
     */
    public getDispatchRoutesByDriverId(accessToken: string, driverId: number, endTime?: number, duration?: number, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body: models.DispatchRoutes;  }> {
        let localVarPath = this.basePath + '/fleet/drivers/{driver_id}/dispatch/routes'.replace('{' + 'driver_id' + '}', encodeURIComponent(String(driverId)));
     ...
     * @param duration Time in milliseconds that represents the duration before end_time to query. Defaults to 24 hours.
     */
    public getDispatchRoutesByVehicleId(accessToken: string, vehicleId: number, endTime?: number, duration?: number, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body: models.DispatchRoutes;  }> {
        let localVarPath = this.basePath + '/fleet/vehicles/{vehicle_id}/dispatch/routes'.replace('{' + 'vehicle_id' + '}', encodeURIComponent(String(vehicleId)));
     ...
     */
    public getDriverDocumentTypesByOrgId(extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body: models.DocumentTypes;  }> {
        ...
        let dfd = $.Deferred();
        $.ajax(requestOptions).then(
            (data: models.DocumentTypes, textStatus: string, jqXHR: JQueryXHR) =>
                dfd.resolve(jqXHR, data),
            (xhr: JQueryXHR, textStatus: string, errorThrown: string) =>
                dfd.reject(xhr, errorThrown)
        );
     ...
     */
    public getDriverDocumentsByOrgId(accessToken: string, endMs?: number, durationMs?: number, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body: models.Documents;  }> {
        ...
        let dfd = $.Deferred();
        $.ajax(requestOptions).then(
            (data: models.Documents, textStatus: string, jqXHR: JQueryXHR) =>
                dfd.resolve(jqXHR, data),
            (xhr: JQueryXHR, textStatus: string, errorThrown: string) =>
                dfd.reject(xhr, errorThrown)
        );
     ...
     * @param endMs Timestamp in milliseconds representing the end of the period to fetch, inclusive. Used in combination with startMs.
     */
    public getDriverSafetyScore(driverId: number, accessToken: string, startMs: number, endMs: number, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body: models.DriverSafetyScoreResponse;  }> {
     ...
     */
    public getDvirs(accessToken: string, endMs: number, durationMs: number, groupId?: number, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body: models.DvirListResponse;  }> {
        let localVarPath = this.basePath + '/fleet/maintenance/dvirs';
     ...
     */
    public getFleetDrivers(accessToken: string, groupDriversParam: models.GroupDriversParam, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body: models.DriversResponse;  }> {
     ...
     * @param hosLogsParam 
     */
    public getFleetDriversHosDailyLogs(accessToken: string, driverId: number, hosLogsParam: models.HosLogsParam, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body: models.DriverDailyLogResponse;  }> {
     ...
     */
    public getFleetDriversSummary(accessToken: string, driversSummaryParam: models.DriversSummaryParam, snapToDayBounds?: boolean, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body: models.DriversSummaryResponse;  }> {
     ...
     */
    public getFleetHosAuthenticationLogs(accessToken: string, hosAuthenticationLogsParam: models.HosAuthenticationLogsParam, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body: models.HosAuthenticationLogsResponse;  }> {
     ...
     * @param hosLogsParam 
     */
    public getFleetHosLogs(accessToken: string, hosLogsParam: models.HosLogsParam1, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body: models.HosLogsResponse;  }> {
     ...
     * @param hosLogsParam 
     */
    public getFleetHosLogsSummary(accessToken: string, hosLogsParam: models.HosLogsParam2, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body: models.HosLogsSummaryResponse;  }> {
     ...
     */
    public getFleetLocations(accessToken: string, groupParam: models.GroupParam, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body: models.InlineResponse2003;  }> {
     ...
     * @param groupParam Group ID to query.
     */
    public getFleetMaintenanceList(accessToken: string, groupParam: models.GroupParam, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body: models.InlineResponse2004;  }> {
     ...
     */
    public getFleetTrips(accessToken: string, tripsParam: models.TripsParam, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body: models.TripResponse;  }> {
     ...
     */
    public getFleetVehicle(accessToken: string, vehicleIdOrExternalId: string, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body: models.FleetVehicleResponse;  }> {
     ...
     * @param addressId ID of the address/geofence
     */
    public getOrganizationAddress(accessToken: string, addressId: number, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body: models.Address;  }> {
        let localVarPath = this.basePath + '/addresses/{addressId}'.replace('{' + 'addressId' + '}', encodeURIComponent(String(addressId)));
     ...
     * @param accessToken Samsara API access token.
     */
    public getOrganizationAddresses(accessToken: string, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body: Array<models.Address>;  }> {
        let localVarPath = this.basePath + '/addresses';
     ...
     */
    public getOrganizationContact(accessToken: string, contactId: number, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body: models.Contact;  }> {
     ...
     */
    public getVehicleHarshEvent(vehicleId: number, accessToken: string, timestamp: number, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body: models.VehicleHarshEventResponse;  }> {
     ...
     */
    public getVehicleLocations(accessToken: string, vehicleId: number, startMs: number, endMs: number, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body: models.FleetVehicleLocations;  }> {
        ...
        let dfd = $.Deferred();
        $.ajax(requestOptions).then(
            (data: models.FleetVehicleLocations, textStatus: string, jqXHR: JQueryXHR) =>
                dfd.resolve(jqXHR, data),
            (xhr: JQueryXHR, textStatus: string, errorThrown: string) =>
                dfd.reject(xhr, errorThrown)
        );
     ...
     * @param endMs Timestamp in milliseconds representing the end of the period to fetch, inclusive. Used in combination with startMs.
     */
    public getVehicleSafetyScore(vehicleId: number, accessToken: string, startMs: number, endMs: number, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body: models.VehicleSafetyScoreResponse;  }> {
     ...
     */
    public getVehicleStats(accessToken: string, startMs: number, endMs: number, series?: 'engineState' | 'auxInput1' | 'auxInput2', tagIds?: string, startingAfter?: string, endingBefore?: string, limit?: number, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body: models.InlineResponse2005;  }> {
     ...
     */
    public getVehiclesLocations(accessToken: string, startMs: number, endMs: number, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body: models.FleetVehiclesLocations;  }> {
        ...
        let dfd = $.Deferred();
        $.ajax(requestOptions).then(
            (data: models.FleetVehiclesLocations, textStatus: string, jqXHR: JQueryXHR) =>
                dfd.resolve(jqXHR, data),
            (xhr: JQueryXHR, textStatus: string, errorThrown: string) =>
                dfd.reject(xhr, errorThrown)
        );
     ...
     * @param accessToken Samsara API access token.
     */
    public listContacts(accessToken: string, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body: Array<models.Contact>;  }> {
     ...
     * @param limit Pagination parameter indicating the number of results to return in this request. Used in conjunction with either &#39;startingAfter&#39; or &#39;endingBefore&#39;.
     */
    public listFleet(accessToken: string, groupParam: models.GroupParam, startingAfter?: string, endingBefore?: string, limit?: number, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body: models.InlineResponse2002;  }> {
     ...
     * @param data 
     */
    public patchFleetVehicle(accessToken: string, vehicleIdOrExternalId: string, data: models.Data, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body: models.FleetVehicleResponse;  }> {
        let localVarPath = this.basePath + '/fleet/vehicles/{vehicle_id_or_external_id}'.replace('{' + 'vehicle_id_or_external_id' + '}', encodeURIComponent(String(vehicleIdOrExternalId)));
     ...
     */
    public updateDispatchRouteById(accessToken: string, routeId: number, updateDispatchRouteParams: models.DispatchRoute, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body: models.DispatchRoute;  }> {
        let localVarPath = this.basePath + '/fleet/dispatch/routes/{route_id}'.replace('{' + 'route_id' + '}', encodeURIComponent(String(routeId)));
     ...
     * @param addressId ID of the address/geofence
     */
    public updateOrganizationAddress(accessToken: string, address: models.Address, addressId: number, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body?: any;  }> {
        let localVarPath = this.basePath + '/addresses/{addressId}'.replace('{' + 'addressId' + '}', encodeURIComponent(String(addressId)));
     ...
     */
    public updateVehicles(accessToken: string, vehicleUpdateParam: models.VehicleUpdateParam, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body?: any;  }> {
