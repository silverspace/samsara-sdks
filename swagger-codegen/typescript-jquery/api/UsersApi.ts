...
export class UsersApi {
     ...
     */
    public deleteUserById(accessToken: string, userId: number, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body?: any;  }> {
     ...
     * @param userId ID of the user.
     */
    public getUserById(accessToken: string, userId: number, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body: models.User;  }> {
        let localVarPath = this.basePath + '/users/{userId}'.replace('{' + 'userId' + '}', encodeURIComponent(String(userId)));
     ...
     * @param accessToken Samsara API access token.
     */
    public listUserRoles(accessToken: string, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body: Array<models.UserRole>;  }> {
        let localVarPath = this.basePath + '/user_roles';
        ...
        let dfd = $.Deferred();
        $.ajax(requestOptions).then(
            (data: Array<models.UserRole>, textStatus: string, jqXHR: JQueryXHR) =>
                dfd.resolve(jqXHR, data),
            (xhr: JQueryXHR, textStatus: string, errorThrown: string) =>
                dfd.reject(xhr, errorThrown)
        );
     ...
     * @param accessToken Samsara API access token.
     */
    public listUsers(accessToken: string, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body: Array<models.User>;  }> {
        ...
        let dfd = $.Deferred();
        $.ajax(requestOptions).then(
            (data: Array<models.User>, textStatus: string, jqXHR: JQueryXHR) =>
                dfd.resolve(jqXHR, data),
            (xhr: JQueryXHR, textStatus: string, errorThrown: string) =>
                dfd.reject(xhr, errorThrown)
        );
