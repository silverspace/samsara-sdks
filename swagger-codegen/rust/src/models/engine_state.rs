...
impl EngineState {
  ...
  pub fn new(time_ms: f32, value: String) -> EngineState {
    EngineState {
      time_ms: time_ms,
      value: value
    }
  ...
  pub fn with_time_ms(mut self, time_ms: f32) -> EngineState {
    self.time_ms = time_ms;
    self
  }
  ...
  pub fn with_value(mut self, value: String) -> EngineState {
    self.value = value;
    self
  }
