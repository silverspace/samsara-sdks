...
impl DocumentFieldCreate {
  ...
  pub fn with_number_value(mut self, number_value: f64) -> DocumentFieldCreate {
    self.number_value = Some(number_value);
    self
  }
  ...
  pub fn with_photo_value(mut self, photo_value: Vec<::models::DocumentFieldCreatePhotoValue>) -> DocumentFieldCreate {
    self.photo_value = Some(photo_value);
    self
  }
  ...
  pub fn with_string_value(mut self, string_value: String) -> DocumentFieldCreate {
    self.string_value = Some(string_value);
    self
  }
  ...
  pub fn with_value_type(mut self, value_type: String) -> DocumentFieldCreate {
    self.value_type = value_type;
    self
  }
