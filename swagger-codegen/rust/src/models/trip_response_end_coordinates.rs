...
/// TripResponseEndCoordinates : End (latitude, longitude) in decimal degrees.
...
impl TripResponseEndCoordinates {
  ...
  pub fn with_latitude(mut self, latitude: f64) -> TripResponseEndCoordinates {
    self.latitude = Some(latitude);
    self
  }
  ...
  pub fn with_longitude(mut self, longitude: f64) -> TripResponseEndCoordinates {
    self.longitude = Some(longitude);
    self
  }
