...
pub struct DocumentType {
  ...
  field_types: Option<Vec<::models::DocumentFieldTypes>>,
...
impl DocumentType {
  ...
  pub fn set_field_types(&mut self, field_types: Vec<::models::DocumentFieldTypes>) {
    self.field_types = Some(field_types);
  }

  pub fn with_field_types(mut self, field_types: Vec<::models::DocumentFieldTypes>) -> DocumentType {
    self.field_types = Some(field_types);
    self
  }

  pub fn field_types(&self) -> Option<&Vec<::models::DocumentFieldTypes>> {
    self.field_types.as_ref()
  }

  pub fn reset_field_types(&mut self) {
  ...
  pub fn with_name(mut self, name: String) -> DocumentType {
    self.name = name;
    self
  }
  ...
  pub fn with_org_id(mut self, org_id: i64) -> DocumentType {
    self.org_id = org_id;
    self
  }
  ...
  pub fn with_uuid(mut self, uuid: String) -> DocumentType {
    self.uuid = uuid;
    self
  }
