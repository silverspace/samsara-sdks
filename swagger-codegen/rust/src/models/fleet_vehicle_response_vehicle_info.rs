...
impl FleetVehicleResponseVehicleInfo {
  ...
  pub fn with_make(mut self, make: String) -> FleetVehicleResponseVehicleInfo {
    self.make = Some(make);
    self
  }
  ...
  pub fn with_model(mut self, model: String) -> FleetVehicleResponseVehicleInfo {
    self.model = Some(model);
    self
  }
  ...
  pub fn with_vin(mut self, vin: String) -> FleetVehicleResponseVehicleInfo {
    self.vin = Some(vin);
    self
  }
  ...
  pub fn with_year(mut self, year: i64) -> FleetVehicleResponseVehicleInfo {
    self.year = Some(year);
    self
  }
