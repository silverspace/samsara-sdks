...
/// DvirBaseMechanicOrAgentSignature : The mechanic's or agent's signature for the DVIR.
...
impl DvirBaseMechanicOrAgentSignature {
  ...
  pub fn with_driver_id(mut self, driver_id: i64) -> DvirBaseMechanicOrAgentSignature {
    self.driver_id = Some(driver_id);
    self
  }
  ...
  pub fn with_email(mut self, email: String) -> DvirBaseMechanicOrAgentSignature {
    self.email = Some(email);
    self
  }
  ...
  pub fn set_mechanic_user_id(&mut self, mechanic_user_id: i64) {
    self.mechanic_user_id = Some(mechanic_user_id);
  }

  pub fn with_mechanic_user_id(mut self, mechanic_user_id: i64) -> DvirBaseMechanicOrAgentSignature {
    self.mechanic_user_id = Some(mechanic_user_id);
    self
  }

  pub fn mechanic_user_id(&self) -> Option<&i64> {
    self.mechanic_user_id.as_ref()
  }

  pub fn reset_mechanic_user_id(&mut self) {
  ...
  pub fn with_name(mut self, name: String) -> DvirBaseMechanicOrAgentSignature {
    self.name = Some(name);
    self
  }
  ...
  pub fn set_signed_at(&mut self, signed_at: i64) {
    self.signed_at = Some(signed_at);
  }

  pub fn with_signed_at(mut self, signed_at: i64) -> DvirBaseMechanicOrAgentSignature {
    self.signed_at = Some(signed_at);
    self
  }

  pub fn signed_at(&self) -> Option<&i64> {
    self.signed_at.as_ref()
  }

  pub fn reset_signed_at(&mut self) {
    self.signed_at = None;
  }
  ...
  pub fn with__type(mut self, _type: String) -> DvirBaseMechanicOrAgentSignature {
    self._type = Some(_type);
    self
  }
  ...
  pub fn with_username(mut self, username: String) -> DvirBaseMechanicOrAgentSignature {
    self.username = Some(username);
    self
  }
