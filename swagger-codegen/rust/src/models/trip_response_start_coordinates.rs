...
/// TripResponseStartCoordinates : Start (latitude, longitude) in decimal degrees.
...
impl TripResponseStartCoordinates {
  ...
  pub fn with_latitude(mut self, latitude: f64) -> TripResponseStartCoordinates {
    self.latitude = Some(latitude);
    self
  }
  ...
  pub fn with_longitude(mut self, longitude: f64) -> TripResponseStartCoordinates {
    self.longitude = Some(longitude);
    self
  }
