...
/// DvirBaseNextDriverSignature : The next driver signature for the DVIR.
...
impl DvirBaseNextDriverSignature {
  ...
  pub fn with_driver_id(mut self, driver_id: i64) -> DvirBaseNextDriverSignature {
    self.driver_id = Some(driver_id);
    self
  }
  ...
  pub fn with_email(mut self, email: String) -> DvirBaseNextDriverSignature {
    self.email = Some(email);
    self
  }
  ...
  pub fn with_name(mut self, name: String) -> DvirBaseNextDriverSignature {
    self.name = Some(name);
    self
  }
  ...
  pub fn with_signed_at(mut self, signed_at: i64) -> DvirBaseNextDriverSignature {
    self.signed_at = Some(signed_at);
    self
  }
  ...
  pub fn with__type(mut self, _type: String) -> DvirBaseNextDriverSignature {
    self._type = Some(_type);
    self
  }
  ...
  pub fn with_username(mut self, username: String) -> DvirBaseNextDriverSignature {
    self.username = Some(username);
    self
  }
