...
impl DriverBase {
  ...
  pub fn with_eld_adverse_weather_exemption_enabled(mut self, eld_adverse_weather_exemption_enabled: bool) -> DriverBase {
    self.eld_adverse_weather_exemption_enabled = Some(eld_adverse_weather_exemption_enabled);
    self
  }
  ...
  pub fn with_eld_big_day_exemption_enabled(mut self, eld_big_day_exemption_enabled: bool) -> DriverBase {
    self.eld_big_day_exemption_enabled = Some(eld_big_day_exemption_enabled);
    self
  }
  ...
  pub fn with_eld_day_start_hour(mut self, eld_day_start_hour: i32) -> DriverBase {
    self.eld_day_start_hour = Some(eld_day_start_hour);
    self
  }
  ...
  pub fn with_eld_exempt(mut self, eld_exempt: bool) -> DriverBase {
    self.eld_exempt = Some(eld_exempt);
    self
  }
  ...
  pub fn with_eld_exempt_reason(mut self, eld_exempt_reason: String) -> DriverBase {
    self.eld_exempt_reason = Some(eld_exempt_reason);
    self
  }
  ...
  pub fn with_eld_pc_enabled(mut self, eld_pc_enabled: bool) -> DriverBase {
    self.eld_pc_enabled = Some(eld_pc_enabled);
    self
  }
  ...
  pub fn with_eld_ym_enabled(mut self, eld_ym_enabled: bool) -> DriverBase {
    self.eld_ym_enabled = Some(eld_ym_enabled);
    self
  }
  ...
  pub fn with_external_ids(mut self, external_ids: ::std::collections::HashMap<String, String>) -> DriverBase {
    self.external_ids = Some(external_ids);
    self
  }
  ...
  pub fn with_group_id(mut self, group_id: i64) -> DriverBase {
    self.group_id = Some(group_id);
    self
  }
  ...
  pub fn with_license_number(mut self, license_number: String) -> DriverBase {
    self.license_number = Some(license_number);
    self
  }
  ...
  pub fn with_license_state(mut self, license_state: String) -> DriverBase {
    self.license_state = Some(license_state);
    self
  }
  ...
  pub fn with_name(mut self, name: String) -> DriverBase {
    self.name = name;
    self
  }
  ...
  pub fn with_notes(mut self, notes: String) -> DriverBase {
    self.notes = Some(notes);
    self
  }
  ...
  pub fn with_phone(mut self, phone: String) -> DriverBase {
    self.phone = Some(phone);
    self
  }
  ...
  pub fn with_username(mut self, username: String) -> DriverBase {
    self.username = Some(username);
    self
  }
  ...
  pub fn with_vehicle_id(mut self, vehicle_id: i64) -> DriverBase {
    self.vehicle_id = Some(vehicle_id);
    self
  }
