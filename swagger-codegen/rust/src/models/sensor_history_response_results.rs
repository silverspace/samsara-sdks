...
impl SensorHistoryResponseResults {
  ...
  pub fn set_series(&mut self, series: Vec<i64>) {
    self.series = Some(series);
  }

  pub fn with_series(mut self, series: Vec<i64>) -> SensorHistoryResponseResults {
    self.series = Some(series);
    self
  }

  pub fn series(&self) -> Option<&Vec<i64>> {
    self.series.as_ref()
  }
  ...
  pub fn set_time_ms(&mut self, time_ms: i32) {
    self.time_ms = Some(time_ms);
  }

  pub fn with_time_ms(mut self, time_ms: i32) -> SensorHistoryResponseResults {
    self.time_ms = Some(time_ms);
    self
  }

  pub fn time_ms(&self) -> Option<&i32> {
    self.time_ms.as_ref()
  }
