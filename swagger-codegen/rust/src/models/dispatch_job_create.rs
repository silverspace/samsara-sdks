...
impl DispatchJobCreate {
  ...
  pub fn with_destination_address(mut self, destination_address: String) -> DispatchJobCreate {
    self.destination_address = Some(destination_address);
    self
  }
  ...
  pub fn with_destination_address_id(mut self, destination_address_id: i64) -> DispatchJobCreate {
    self.destination_address_id = Some(destination_address_id);
    self
  }
  ...
  pub fn with_destination_lat(mut self, destination_lat: f64) -> DispatchJobCreate {
    self.destination_lat = Some(destination_lat);
    self
  }
  ...
  pub fn with_destination_lng(mut self, destination_lng: f64) -> DispatchJobCreate {
    self.destination_lng = Some(destination_lng);
    self
  }
  ...
  pub fn with_destination_name(mut self, destination_name: String) -> DispatchJobCreate {
    self.destination_name = Some(destination_name);
    self
  }
  ...
  pub fn with_notes(mut self, notes: String) -> DispatchJobCreate {
    self.notes = Some(notes);
    self
  }
  ...
  pub fn with_scheduled_arrival_time_ms(mut self, scheduled_arrival_time_ms: i64) -> DispatchJobCreate {
    self.scheduled_arrival_time_ms = scheduled_arrival_time_ms;
    self
  }
  ...
  pub fn with_scheduled_departure_time_ms(mut self, scheduled_departure_time_ms: i64) -> DispatchJobCreate {
    self.scheduled_departure_time_ms = Some(scheduled_departure_time_ms);
    self
  }
