...
pub struct DispatchRouteCreate {
  ...
  dispatch_jobs: Vec<::models::DispatchJobCreate>
}
...
impl DispatchRouteCreate {
  ...
  pub fn with_actual_end_ms(mut self, actual_end_ms: i64) -> DispatchRouteCreate {
    self.actual_end_ms = Some(actual_end_ms);
    self
  }
  ...
  pub fn with_actual_start_ms(mut self, actual_start_ms: i64) -> DispatchRouteCreate {
    self.actual_start_ms = Some(actual_start_ms);
    self
  }
  ...
  pub fn with_driver_id(mut self, driver_id: i64) -> DispatchRouteCreate {
    self.driver_id = Some(driver_id);
    self
  }
  ...
  pub fn with_group_id(mut self, group_id: i64) -> DispatchRouteCreate {
    self.group_id = Some(group_id);
    self
  }
  ...
  pub fn with_name(mut self, name: String) -> DispatchRouteCreate {
    self.name = name;
    self
  }
  ...
  pub fn with_scheduled_end_ms(mut self, scheduled_end_ms: i64) -> DispatchRouteCreate {
    self.scheduled_end_ms = scheduled_end_ms;
    self
  }
  ...
  pub fn with_scheduled_meters(mut self, scheduled_meters: i64) -> DispatchRouteCreate {
    self.scheduled_meters = Some(scheduled_meters);
    self
  }
  ...
  pub fn with_scheduled_start_ms(mut self, scheduled_start_ms: i64) -> DispatchRouteCreate {
    self.scheduled_start_ms = scheduled_start_ms;
    self
  }
  ...
  pub fn with_start_location_address(mut self, start_location_address: String) -> DispatchRouteCreate {
    self.start_location_address = Some(start_location_address);
    self
  }
  ...
  pub fn with_start_location_address_id(mut self, start_location_address_id: i64) -> DispatchRouteCreate {
    self.start_location_address_id = Some(start_location_address_id);
    self
  }
  ...
  pub fn with_start_location_lat(mut self, start_location_lat: f64) -> DispatchRouteCreate {
    self.start_location_lat = Some(start_location_lat);
    self
  }
  ...
  pub fn with_start_location_lng(mut self, start_location_lng: f64) -> DispatchRouteCreate {
    self.start_location_lng = Some(start_location_lng);
    self
  }
  ...
  pub fn with_start_location_name(mut self, start_location_name: String) -> DispatchRouteCreate {
    self.start_location_name = Some(start_location_name);
    self
  }
  ...
  pub fn with_trailer_id(mut self, trailer_id: i64) -> DispatchRouteCreate {
    self.trailer_id = Some(trailer_id);
    self
  }
  ...
  pub fn with_vehicle_id(mut self, vehicle_id: i64) -> DispatchRouteCreate {
    self.vehicle_id = Some(vehicle_id);
    self
  }
  ...
  pub fn set_dispatch_jobs(&mut self, dispatch_jobs: Vec<::models::DispatchJobCreate>) {
    self.dispatch_jobs = dispatch_jobs;
  }

  pub fn with_dispatch_jobs(mut self, dispatch_jobs: Vec<::models::DispatchJobCreate>) -> DispatchRouteCreate {
    self.dispatch_jobs = dispatch_jobs;
    self
  }

  pub fn dispatch_jobs(&self) -> &Vec<::models::DispatchJobCreate> {
    &self.dispatch_jobs
  }
