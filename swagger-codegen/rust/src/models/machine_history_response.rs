...
pub struct MachineHistoryResponse {
  ...
  machines: Option<Vec<::models::MachineHistoryResponseMachines>>
}
...
impl MachineHistoryResponse {
  ...
  pub fn set_machines(&mut self, machines: Vec<::models::MachineHistoryResponseMachines>) {
    self.machines = Some(machines);
  }

  pub fn with_machines(mut self, machines: Vec<::models::MachineHistoryResponseMachines>) -> MachineHistoryResponse {
    self.machines = Some(machines);
    self
  }

  pub fn machines(&self) -> Option<&Vec<::models::MachineHistoryResponseMachines>> {
