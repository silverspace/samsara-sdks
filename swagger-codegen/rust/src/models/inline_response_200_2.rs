...
impl InlineResponse2002 {
  ...
  pub fn with_group_id(mut self, group_id: i64) -> InlineResponse2002 {
    self.group_id = Some(group_id);
    self
  }
  ...
  pub fn with_pagination(mut self, pagination: ::models::Pagination) -> InlineResponse2002 {
    self.pagination = Some(pagination);
    self
  }
  ...
  pub fn with_vehicles(mut self, vehicles: Vec<::models::Vehicle>) -> InlineResponse2002 {
    self.vehicles = Some(vehicles);
    self
  }
