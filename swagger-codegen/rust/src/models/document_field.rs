...
pub struct DocumentField {
  ...
  photo_value: Option<Vec<::models::DocumentFieldCreatePhotoValue>>,
  ...
  #[serde(rename = "value")]
  value: Option<::models::ErrorUnknown>
}
...
impl DocumentField {
  ...
  pub fn with_number_value(mut self, number_value: f64) -> DocumentField {
    self.number_value = Some(number_value);
    self
  }
  ...
  pub fn reset_number_value(&mut self) {
    self.number_value = None;
  }

  pub fn set_photo_value(&mut self, photo_value: Vec<::models::DocumentFieldCreatePhotoValue>) {
    self.photo_value = Some(photo_value);
  }

  pub fn with_photo_value(mut self, photo_value: Vec<::models::DocumentFieldCreatePhotoValue>) -> DocumentField {
    self.photo_value = Some(photo_value);
    self
  }

  pub fn photo_value(&self) -> Option<&Vec<::models::DocumentFieldCreatePhotoValue>> {
    self.photo_value.as_ref()
  }

  pub fn reset_photo_value(&mut self) {
  ...
  pub fn with_string_value(mut self, string_value: String) -> DocumentField {
    self.string_value = Some(string_value);
    self
  }
  ...
  pub fn reset_string_value(&mut self) {
  ...
  pub fn with_value_type(mut self, value_type: String) -> DocumentField {
    self.value_type = value_type;
    self
  }
  ...
  pub fn with_label(mut self, label: String) -> DocumentField {
    self.label = label;
    self
  }
  ...
  pub fn set_value(&mut self, value: ::models::ErrorUnknown) {
    self.value = Some(value);
  }

  pub fn with_value(mut self, value: ::models::ErrorUnknown) -> DocumentField {
    self.value = Some(value);
    self
  }

  pub fn value(&self) -> Option<&::models::ErrorUnknown> {
    self.value.as_ref()
  }
