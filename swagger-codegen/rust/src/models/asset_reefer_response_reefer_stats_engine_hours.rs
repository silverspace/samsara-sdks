...
impl AssetReeferResponseReeferStatsEngineHours {
  ...
  pub fn with_changed_at_ms(mut self, changed_at_ms: i64) -> AssetReeferResponseReeferStatsEngineHours {
    self.changed_at_ms = Some(changed_at_ms);
    self
  }
  ...
  pub fn with_engine_hours(mut self, engine_hours: i64) -> AssetReeferResponseReeferStatsEngineHours {
    self.engine_hours = Some(engine_hours);
    self
  }
