...
/// AddressGeofenceCircle : Information about a circular geofence. This field is only populated if the geofence is a circle.
...
impl AddressGeofenceCircle {
  ...
  pub fn with_latitude(mut self, latitude: f64) -> AddressGeofenceCircle {
    self.latitude = Some(latitude);
    self
  }
  ...
  pub fn with_longitude(mut self, longitude: f64) -> AddressGeofenceCircle {
    self.longitude = Some(longitude);
    self
  }
  ...
  pub fn set_radius_meters(&mut self, radius_meters: i64) {
    self.radius_meters = Some(radius_meters);
  }

  pub fn with_radius_meters(mut self, radius_meters: i64) -> AddressGeofenceCircle {
    self.radius_meters = Some(radius_meters);
    self
  }

  pub fn radius_meters(&self) -> Option<&i64> {
    self.radius_meters.as_ref()
  }

  pub fn reset_radius_meters(&mut self) {
