...
impl AssetCurrentLocation {
  ...
  pub fn with_latitude(mut self, latitude: f64) -> AssetCurrentLocation {
    self.latitude = Some(latitude);
    self
  }
  ...
  pub fn with_location(mut self, location: String) -> AssetCurrentLocation {
    self.location = Some(location);
    self
  }
  ...
  pub fn with_longitude(mut self, longitude: f64) -> AssetCurrentLocation {
    self.longitude = Some(longitude);
    self
  }
  ...
  pub fn with_speed_miles_per_hour(mut self, speed_miles_per_hour: f64) -> AssetCurrentLocation {
    self.speed_miles_per_hour = Some(speed_miles_per_hour);
    self
  }
  ...
  pub fn with_time_ms(mut self, time_ms: i64) -> AssetCurrentLocation {
    self.time_ms = Some(time_ms);
    self
  }
