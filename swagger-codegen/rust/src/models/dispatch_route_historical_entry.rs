...
impl DispatchRouteHistoricalEntry {
  ...
  pub fn with_changed_at_ms(mut self, changed_at_ms: i64) -> DispatchRouteHistoricalEntry {
    self.changed_at_ms = Some(changed_at_ms);
    self
  }
  ...
  pub fn with_route(mut self, route: ::models::DispatchRoute) -> DispatchRouteHistoricalEntry {
    self.route = Some(route);
    self
  }
