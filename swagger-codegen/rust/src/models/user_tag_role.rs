...
impl UserTagRole {
  ...
  pub fn with_role(mut self, role: String) -> UserTagRole {
    self.role = Some(role);
    self
  }
  ...
  pub fn with_role_id(mut self, role_id: String) -> UserTagRole {
    self.role_id = role_id;
    self
  }
  ...
  pub fn set_tag(&mut self, tag: ::models::UserTagRoleTag) {
    self.tag = tag;
  }

  pub fn with_tag(mut self, tag: ::models::UserTagRoleTag) -> UserTagRole {
    self.tag = tag;
    self
  }

  pub fn tag(&self) -> &::models::UserTagRoleTag {
    &self.tag
  }
