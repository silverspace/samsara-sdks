...
impl AddressParam {
  pub fn new(address: String, group_id: i64, name: String, radius: i32) -> AddressParam {
    AddressParam {
      address: address,
      group_id: group_id,
      name: name,
  ...
  pub fn with_address(mut self, address: String) -> AddressParam {
    self.address = address;
    self
  }
  ...
  pub fn with_group_id(mut self, group_id: i64) -> AddressParam {
    self.group_id = group_id;
    self
  }
  ...
  pub fn with_name(mut self, name: String) -> AddressParam {
    self.name = name;
    self
  }
  ...
  pub fn with_radius(mut self, radius: i32) -> AddressParam {
    self.radius = radius;
    self
  }
