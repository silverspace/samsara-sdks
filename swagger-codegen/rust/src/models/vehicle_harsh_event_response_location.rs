...
impl VehicleHarshEventResponseLocation {
  ...
  pub fn with_address(mut self, address: String) -> VehicleHarshEventResponseLocation {
    self.address = Some(address);
    self
  }
  ...
  pub fn with_latitude(mut self, latitude: String) -> VehicleHarshEventResponseLocation {
    self.latitude = Some(latitude);
    self
  }
  ...
  pub fn with_longitude(mut self, longitude: String) -> VehicleHarshEventResponseLocation {
    self.longitude = Some(longitude);
    self
  }
