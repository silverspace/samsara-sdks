...
/// VehicleMaintenancePassengerCheckEngineLight : Passenger vehicle check engine light.
...
impl VehicleMaintenancePassengerCheckEngineLight {
  ...
  pub fn with_is_on(mut self, is_on: bool) -> VehicleMaintenancePassengerCheckEngineLight {
    self.is_on = Some(is_on);
    self
  }
