...
impl AssetReeferResponseReeferStatsReturnAirTemp {
  ...
  pub fn with_changed_at_ms(mut self, changed_at_ms: i64) -> AssetReeferResponseReeferStatsReturnAirTemp {
    self.changed_at_ms = Some(changed_at_ms);
    self
  }
  ...
  pub fn set_temp_in_milli_c(&mut self, temp_in_milli_c: i64) {
    self.temp_in_milli_c = Some(temp_in_milli_c);
  }

  pub fn with_temp_in_milli_c(mut self, temp_in_milli_c: i64) -> AssetReeferResponseReeferStatsReturnAirTemp {
    self.temp_in_milli_c = Some(temp_in_milli_c);
    self
  }

  pub fn temp_in_milli_c(&self) -> Option<&i64> {
    self.temp_in_milli_c.as_ref()
  }

  pub fn reset_temp_in_milli_c(&mut self) {
    self.temp_in_milli_c = None;
  }
