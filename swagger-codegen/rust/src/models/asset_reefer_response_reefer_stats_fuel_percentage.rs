...
impl AssetReeferResponseReeferStatsFuelPercentage {
  ...
  pub fn with_changed_at_ms(mut self, changed_at_ms: i64) -> AssetReeferResponseReeferStatsFuelPercentage {
    self.changed_at_ms = Some(changed_at_ms);
    self
  }
  ...
  pub fn set_fuel_percentage(&mut self, fuel_percentage: i64) {
    self.fuel_percentage = Some(fuel_percentage);
  }

  pub fn with_fuel_percentage(mut self, fuel_percentage: i64) -> AssetReeferResponseReeferStatsFuelPercentage {
    self.fuel_percentage = Some(fuel_percentage);
    self
  }

  pub fn fuel_percentage(&self) -> Option<&i64> {
