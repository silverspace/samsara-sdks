...
/// DvirBaseAuthorSignature : The authors signature for the DVIR.
...
impl DvirBaseAuthorSignature {
  ...
  pub fn with_driver_id(mut self, driver_id: i64) -> DvirBaseAuthorSignature {
    self.driver_id = Some(driver_id);
    self
  }
  ...
  pub fn with_email(mut self, email: String) -> DvirBaseAuthorSignature {
    self.email = Some(email);
    self
  }
  ...
  pub fn with_mechanic_user_id(mut self, mechanic_user_id: i64) -> DvirBaseAuthorSignature {
    self.mechanic_user_id = Some(mechanic_user_id);
    self
  }
  ...
  pub fn with_name(mut self, name: String) -> DvirBaseAuthorSignature {
    self.name = Some(name);
    self
  }
  ...
  pub fn with_signed_at(mut self, signed_at: i64) -> DvirBaseAuthorSignature {
    self.signed_at = Some(signed_at);
    self
  }
  ...
  pub fn with__type(mut self, _type: String) -> DvirBaseAuthorSignature {
    self._type = Some(_type);
    self
  }
  ...
  pub fn with_username(mut self, username: String) -> DvirBaseAuthorSignature {
    self.username = Some(username);
    self
  }
