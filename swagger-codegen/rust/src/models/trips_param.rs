...
impl TripsParam {
  pub fn new(end_ms: i32, group_id: i64, start_ms: i32, vehicle_id: i64) -> TripsParam {
    TripsParam {
      end_ms: end_ms,
      group_id: group_id,
      start_ms: start_ms,
  ...
  pub fn with_end_ms(mut self, end_ms: i32) -> TripsParam {
    self.end_ms = end_ms;
    self
  }
  ...
  pub fn with_group_id(mut self, group_id: i64) -> TripsParam {
    self.group_id = group_id;
    self
  }
  ...
  pub fn with_start_ms(mut self, start_ms: i32) -> TripsParam {
    self.start_ms = start_ms;
    self
  }
  ...
  pub fn with_vehicle_id(mut self, vehicle_id: i64) -> TripsParam {
    self.vehicle_id = vehicle_id;
    self
  }
