...
impl AssetReeferResponseReeferStatsSetPoint {
  ...
  pub fn with_changed_at_ms(mut self, changed_at_ms: i64) -> AssetReeferResponseReeferStatsSetPoint {
    self.changed_at_ms = Some(changed_at_ms);
    self
  }
  ...
  pub fn with_temp_in_milli_c(mut self, temp_in_milli_c: i64) -> AssetReeferResponseReeferStatsSetPoint {
    self.temp_in_milli_c = Some(temp_in_milli_c);
    self
  }
