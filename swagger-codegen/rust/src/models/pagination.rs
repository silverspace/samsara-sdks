...
impl Pagination {
  ...
  pub fn set_end_cursor(&mut self, end_cursor: String) {
    self.end_cursor = end_cursor;
  }

  pub fn with_end_cursor(mut self, end_cursor: String) -> Pagination {
    self.end_cursor = end_cursor;
    self
  }

  pub fn end_cursor(&self) -> &String {
    &self.end_cursor
  }


  pub fn set_has_next_page(&mut self, has_next_page: bool) {
    self.has_next_page = has_next_page;
  }

  pub fn with_has_next_page(mut self, has_next_page: bool) -> Pagination {
    self.has_next_page = has_next_page;
    self
  }
  ...
  pub fn set_has_prev_page(&mut self, has_prev_page: bool) {
    self.has_prev_page = has_prev_page;
  }

  pub fn with_has_prev_page(mut self, has_prev_page: bool) -> Pagination {
    self.has_prev_page = has_prev_page;
    self
  }
  ...
  pub fn set_start_cursor(&mut self, start_cursor: String) {
    self.start_cursor = start_cursor;
  }

  pub fn with_start_cursor(mut self, start_cursor: String) -> Pagination {
    self.start_cursor = start_cursor;
    self
  }

  pub fn start_cursor(&self) -> &String {
    &self.start_cursor
  }
