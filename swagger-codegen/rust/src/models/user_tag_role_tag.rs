...
impl UserTagRoleTag {
  pub fn new(id: i64, name: String) -> UserTagRoleTag {
    UserTagRoleTag {
      id: id,
      name: name,
      parent_tag_id: None
  ...
  pub fn with_id(mut self, id: i64) -> UserTagRoleTag {
    self.id = id;
    self
  }
  ...
  pub fn with_name(mut self, name: String) -> UserTagRoleTag {
    self.name = name;
    self
  }
  ...
  pub fn with_parent_tag_id(mut self, parent_tag_id: i64) -> UserTagRoleTag {
    self.parent_tag_id = Some(parent_tag_id);
    self
  }
