...
pub struct SensorHistoryResponse {
  ...
  results: Option<Vec<::models::SensorHistoryResponseResults>>
}
...
impl SensorHistoryResponse {
  ...
  pub fn set_results(&mut self, results: Vec<::models::SensorHistoryResponseResults>) {
    self.results = Some(results);
  }

  pub fn with_results(mut self, results: Vec<::models::SensorHistoryResponseResults>) -> SensorHistoryResponse {
    self.results = Some(results);
    self
  }

  pub fn results(&self) -> Option<&Vec<::models::SensorHistoryResponseResults>> {
    self.results.as_ref()
  }
