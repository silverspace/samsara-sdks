...
pub struct TripResponse {
  #[serde(rename = "trips")]
  trips: Option<Vec<::models::TripResponseTrips>>
}
...
impl TripResponse {
  ...
  pub fn set_trips(&mut self, trips: Vec<::models::TripResponseTrips>) {
    self.trips = Some(trips);
  }

  pub fn with_trips(mut self, trips: Vec<::models::TripResponseTrips>) -> TripResponse {
    self.trips = Some(trips);
    self
  }

  pub fn trips(&self) -> Option<&Vec<::models::TripResponseTrips>> {
    self.trips.as_ref()
  }
