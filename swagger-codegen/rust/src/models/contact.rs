...
impl Contact {
  ...
  pub fn with_first_name(mut self, first_name: String) -> Contact {
    self.first_name = Some(first_name);
    self
  }
  ...
  pub fn with_id(mut self, id: i64) -> Contact {
    self.id = Some(id);
    self
  }
  ...
  pub fn with_last_name(mut self, last_name: String) -> Contact {
    self.last_name = Some(last_name);
    self
  }
