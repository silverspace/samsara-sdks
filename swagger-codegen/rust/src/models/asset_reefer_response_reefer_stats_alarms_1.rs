...
pub struct AssetReeferResponseReeferStatsAlarms1 {
  #[serde(rename = "alarms")]
  alarms: Option<Vec<::models::AssetReeferResponseReeferStatsAlarms>>,
...
impl AssetReeferResponseReeferStatsAlarms1 {
  ...
  pub fn set_alarms(&mut self, alarms: Vec<::models::AssetReeferResponseReeferStatsAlarms>) {
    self.alarms = Some(alarms);
  }

  pub fn with_alarms(mut self, alarms: Vec<::models::AssetReeferResponseReeferStatsAlarms>) -> AssetReeferResponseReeferStatsAlarms1 {
    self.alarms = Some(alarms);
    self
  }

  pub fn alarms(&self) -> Option<&Vec<::models::AssetReeferResponseReeferStatsAlarms>> {
    self.alarms.as_ref()
  }
  ...
  pub fn with_changed_at_ms(mut self, changed_at_ms: i64) -> AssetReeferResponseReeferStatsAlarms1 {
    self.changed_at_ms = Some(changed_at_ms);
    self
  }
