...
impl AssetReeferResponseReeferStatsPowerStatus {
  ...
  pub fn with_changed_at_ms(mut self, changed_at_ms: i64) -> AssetReeferResponseReeferStatsPowerStatus {
    self.changed_at_ms = Some(changed_at_ms);
    self
  }
  ...
  pub fn with_status(mut self, status: String) -> AssetReeferResponseReeferStatsPowerStatus {
    self.status = Some(status);
    self
  }
