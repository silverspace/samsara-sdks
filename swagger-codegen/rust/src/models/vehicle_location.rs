...
impl VehicleLocation {
  ...
  pub fn with_heading(mut self, heading: f64) -> VehicleLocation {
    self.heading = Some(heading);
    self
  }
  ...
  pub fn with_id(mut self, id: i64) -> VehicleLocation {
    self.id = id;
    self
  }
  ...
  pub fn with_latitude(mut self, latitude: f64) -> VehicleLocation {
    self.latitude = Some(latitude);
    self
  }
  ...
  pub fn with_location(mut self, location: String) -> VehicleLocation {
    self.location = Some(location);
    self
  }
  ...
  pub fn with_longitude(mut self, longitude: f64) -> VehicleLocation {
    self.longitude = Some(longitude);
    self
  }
  ...
  pub fn with_name(mut self, name: String) -> VehicleLocation {
    self.name = Some(name);
    self
  }
  ...
  pub fn with_odometer_meters(mut self, odometer_meters: i64) -> VehicleLocation {
    self.odometer_meters = Some(odometer_meters);
    self
  }
  ...
  pub fn set_on_trip(&mut self, on_trip: bool) {
    self.on_trip = Some(on_trip);
  }

  pub fn with_on_trip(mut self, on_trip: bool) -> VehicleLocation {
    self.on_trip = Some(on_trip);
    self
  }

  pub fn on_trip(&self) -> Option<&bool> {
    self.on_trip.as_ref()
  }

  pub fn reset_on_trip(&mut self) {
    self.on_trip = None;
  }
  ...
  pub fn with_speed(mut self, speed: f64) -> VehicleLocation {
    self.speed = Some(speed);
    self
  }
  ...
  pub fn with_time(mut self, time: i32) -> VehicleLocation {
    self.time = Some(time);
    self
  }
  ...
  pub fn with_vin(mut self, vin: String) -> VehicleLocation {
    self.vin = Some(vin);
    self
  }
