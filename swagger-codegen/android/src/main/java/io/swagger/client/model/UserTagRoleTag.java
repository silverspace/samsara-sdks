...
public class UserTagRoleTag {
   ...
   * The ID of this tag.
   **/
  @ApiModelProperty(value = "The ID of this tag.")
  ...
  public boolean equals(Object o) {
    ...
    return (this.id == null ? userTagRoleTag.id == null : this.id.equals(userTagRoleTag.id)) &&
        (this.name == null ? userTagRoleTag.name == null : this.name.equals(userTagRoleTag.name)) &&
        (this.parentTagId == null ? userTagRoleTag.parentTagId == null : this.parentTagId.equals(userTagRoleTag.parentTagId));
  }
