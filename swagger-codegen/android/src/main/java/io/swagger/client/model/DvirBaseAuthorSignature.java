...
public class DvirBaseAuthorSignature {
  ...
  public boolean equals(Object o) {
    ...
    return (this.driverId == null ? dvirBaseAuthorSignature.driverId == null : this.driverId.equals(dvirBaseAuthorSignature.driverId)) &&
        (this.email == null ? dvirBaseAuthorSignature.email == null : this.email.equals(dvirBaseAuthorSignature.email)) &&
        (this.mechanicUserId == null ? dvirBaseAuthorSignature.mechanicUserId == null : this.mechanicUserId.equals(dvirBaseAuthorSignature.mechanicUserId)) &&
