...
import io.swagger.client.model.FleetVehicleResponseVehicleInfo;
import java.util.*;
...
public class FleetVehicleResponse {
   ...
   **/
  @ApiModelProperty(value = "Harsh event detection setting.")
   ...
   * Name of the vehicle.
   **/
  @ApiModelProperty(required = true, value = "Name of the vehicle.")
  ...
  public boolean equals(Object o) {
    ...
    return (this.externalIds == null ? fleetVehicleResponse.externalIds == null : this.externalIds.equals(fleetVehicleResponse.externalIds)) &&
        (this.harshAccelSetting == null ? fleetVehicleResponse.harshAccelSetting == null : this.harshAccelSetting.equals(fleetVehicleResponse.harshAccelSetting)) &&
        (this.id == null ? fleetVehicleResponse.id == null : this.id.equals(fleetVehicleResponse.id)) &&
        (this.name == null ? fleetVehicleResponse.name == null : this.name.equals(fleetVehicleResponse.name)) &&
        (this.vehicleInfo == null ? fleetVehicleResponse.vehicleInfo == null : this.vehicleInfo.equals(fleetVehicleResponse.vehicleInfo));
  }
  ...
  public int hashCode() {
    ...
    result = 31 * result + (this.harshAccelSetting == null ? 0: this.harshAccelSetting.hashCode());
