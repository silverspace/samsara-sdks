...
import io.swagger.client.model.DocumentFieldTypeNumberValueTypeMetadata;
...
public class DocumentFieldType {
   ...
   **/
  @ApiModelProperty(required = true, value = "Descriptive name of this field type.")
   ...
   **/
  @ApiModelProperty(required = true, value = "The kind of value that can be submitted for this fieldType. It should be either ValueType_Number, ValueType_String, or ValueType_Photo.")
  ...
  public boolean equals(Object o) {
    ...
    return (this.label == null ? documentFieldType.label == null : this.label.equals(documentFieldType.label)) &&
        (this.numberValueTypeMetadata == null ? documentFieldType.numberValueTypeMetadata == null : this.numberValueTypeMetadata.equals(documentFieldType.numberValueTypeMetadata)) &&
        (this.valueType == null ? documentFieldType.valueType == null : this.valueType.equals(documentFieldType.valueType));
  }
  ...
  public int hashCode() {
    ...
    result = 31 * result + (this.numberValueTypeMetadata == null ? 0: this.numberValueTypeMetadata.hashCode());
