...
public class IndustrialApi {
  ...
  */
  public InlineResponse2007 getMachines (String accessToken, GroupParam groupParam) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
  ...
  */
  public void getMachines (String accessToken, GroupParam groupParam, final Response.Listener<InlineResponse2007> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = groupParam;
  ...
  */
  public MachineHistoryResponse getMachinesHistory (String accessToken, HistoryParam historyParam) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
   ...
   * /machines/history
   * Get historical data for machine objects. This method returns a set of historical data for all machines in a group
   * @param accessToken Samsara API access token.   * @param historyParam Group ID and time range to query for events
  */
  public void getMachinesHistory (String accessToken, HistoryParam historyParam, final Response.Listener<MachineHistoryResponse> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = historyParam;
