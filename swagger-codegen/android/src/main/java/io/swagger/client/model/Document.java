...
public class Document {
   ...
   **/
  @ApiModelProperty(required = true, value = "Descriptive name of this type of document.")
   ...
   **/
  @ApiModelProperty(required = true, value = "The time in Unix epoch milliseconds that the document is created.")
   ...
   **/
  @ApiModelProperty(required = true, value = "ID of the driver for whom the document is submitted")
   ...
   **/
  @ApiModelProperty(required = true, value = "The fields associated with this document.")
   ...
   **/
  @ApiModelProperty(value = "VehicleID of the driver at document creation.")
  ...
  public boolean equals(Object o) {
    ...
    return (this.dispatchJobId == null ? document.dispatchJobId == null : this.dispatchJobId.equals(document.dispatchJobId)) &&
        (this.notes == null ? document.notes == null : this.notes.equals(document.notes)) &&
        (this.documentType == null ? document.documentType == null : this.documentType.equals(document.documentType)) &&
        (this.driverCreatedAtMs == null ? document.driverCreatedAtMs == null : this.driverCreatedAtMs.equals(document.driverCreatedAtMs)) &&
        (this.driverId == null ? document.driverId == null : this.driverId.equals(document.driverId)) &&
        (this.fields == null ? document.fields == null : this.fields.equals(document.fields)) &&
        (this.vehicleId == null ? document.vehicleId == null : this.vehicleId.equals(document.vehicleId));
  }
  ...
  public int hashCode() {
    ...
    result = 31 * result + (this.driverCreatedAtMs == null ? 0: this.driverCreatedAtMs.hashCode());
