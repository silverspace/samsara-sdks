...
public class JobUpdateObject {
   ...
   **/
  @ApiModelProperty(value = "Timestamp that this event was updated, represented as Unix milliseconds since epoch.")
   ...
   **/
  @ApiModelProperty(value = "ID of the Samsara job.")
   ...
   **/
  @ApiModelProperty(value = "ID of the Samsara dispatch route.")
  ...
  public boolean equals(Object o) {
    ...
    return (this.changedAtMs == null ? jobUpdateObject.changedAtMs == null : this.changedAtMs.equals(jobUpdateObject.changedAtMs)) &&
        (this.jobId == null ? jobUpdateObject.jobId == null : this.jobId.equals(jobUpdateObject.jobId)) &&
        (this.jobState == null ? jobUpdateObject.jobState == null : this.jobState.equals(jobUpdateObject.jobState)) &&
        (this.prevJobState == null ? jobUpdateObject.prevJobState == null : this.prevJobState.equals(jobUpdateObject.prevJobState)) &&
        (this.route == null ? jobUpdateObject.route == null : this.route.equals(jobUpdateObject.route)) &&
        (this.routeId == null ? jobUpdateObject.routeId == null : this.routeId.equals(jobUpdateObject.routeId));
  }

  @Override
  public int hashCode() {
    int result = 17;
    result = 31 * result + (this.changedAtMs == null ? 0: this.changedAtMs.hashCode());
    result = 31 * result + (this.jobId == null ? 0: this.jobId.hashCode());
    result = 31 * result + (this.jobState == null ? 0: this.jobState.hashCode());
    result = 31 * result + (this.prevJobState == null ? 0: this.prevJobState.hashCode());
