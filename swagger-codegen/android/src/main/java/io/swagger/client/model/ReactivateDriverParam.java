...
public class ReactivateDriverParam {
  ...
  public boolean equals(Object o) {
    ...
    return (this.reactivate == null ? reactivateDriverParam.reactivate == null : this.reactivate.equals(reactivateDriverParam.reactivate));
  }

  @Override
  public int hashCode() {
    int result = 17;
    result = 31 * result + (this.reactivate == null ? 0: this.reactivate.hashCode());
    return result;
  }
