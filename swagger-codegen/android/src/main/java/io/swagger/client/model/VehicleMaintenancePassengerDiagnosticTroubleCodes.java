...
public class VehicleMaintenancePassengerDiagnosticTroubleCodes {
  ...
  public boolean equals(Object o) {
    ...
    return (this.dtcDescription == null ? vehicleMaintenancePassengerDiagnosticTroubleCodes.dtcDescription == null : this.dtcDescription.equals(vehicleMaintenancePassengerDiagnosticTroubleCodes.dtcDescription)) &&
        (this.dtcId == null ? vehicleMaintenancePassengerDiagnosticTroubleCodes.dtcId == null : this.dtcId.equals(vehicleMaintenancePassengerDiagnosticTroubleCodes.dtcId)) &&
        (this.dtcShortCode == null ? vehicleMaintenancePassengerDiagnosticTroubleCodes.dtcShortCode == null : this.dtcShortCode.equals(vehicleMaintenancePassengerDiagnosticTroubleCodes.dtcShortCode));
  }

  @Override
  public int hashCode() {
    int result = 17;
    result = 31 * result + (this.dtcDescription == null ? 0: this.dtcDescription.hashCode());
    result = 31 * result + (this.dtcId == null ? 0: this.dtcId.hashCode());
    result = 31 * result + (this.dtcShortCode == null ? 0: this.dtcShortCode.hashCode());
    return result;
  }
