...
import io.swagger.client.model.JobUpdateObject;
import java.util.*;
...
public class AllRouteJobUpdates {
   ...
   **/
  @ApiModelProperty(value = "Sequence ID of the last update returned in the response")
  ...
  public boolean equals(Object o) {
    ...
    return (this.jobUpdates == null ? allRouteJobUpdates.jobUpdates == null : this.jobUpdates.equals(allRouteJobUpdates.jobUpdates)) &&
        (this.sequenceId == null ? allRouteJobUpdates.sequenceId == null : this.sequenceId.equals(allRouteJobUpdates.sequenceId));
  }

  @Override
  public int hashCode() {
    int result = 17;
    result = 31 * result + (this.jobUpdates == null ? 0: this.jobUpdates.hashCode());
