...
public class Driver {
   ...
   **/
  @ApiModelProperty(value = "ID of the vehicle that this driver is currently assigned to. Omitted if there is no current vehicle assignment for this driver.")
  ...
  public boolean equals(Object o) {
    ...
    return (this.eldAdverseWeatherExemptionEnabled == null ? driver.eldAdverseWeatherExemptionEnabled == null : this.eldAdverseWeatherExemptionEnabled.equals(driver.eldAdverseWeatherExemptionEnabled)) &&
        (this.eldBigDayExemptionEnabled == null ? driver.eldBigDayExemptionEnabled == null : this.eldBigDayExemptionEnabled.equals(driver.eldBigDayExemptionEnabled)) &&
        (this.eldDayStartHour == null ? driver.eldDayStartHour == null : this.eldDayStartHour.equals(driver.eldDayStartHour)) &&
        (this.eldExempt == null ? driver.eldExempt == null : this.eldExempt.equals(driver.eldExempt)) &&
        (this.eldExemptReason == null ? driver.eldExemptReason == null : this.eldExemptReason.equals(driver.eldExemptReason)) &&
        (this.eldPcEnabled == null ? driver.eldPcEnabled == null : this.eldPcEnabled.equals(driver.eldPcEnabled)) &&
        (this.eldYmEnabled == null ? driver.eldYmEnabled == null : this.eldYmEnabled.equals(driver.eldYmEnabled)) &&
        (this.externalIds == null ? driver.externalIds == null : this.externalIds.equals(driver.externalIds)) &&
        (this.groupId == null ? driver.groupId == null : this.groupId.equals(driver.groupId)) &&
        (this.licenseNumber == null ? driver.licenseNumber == null : this.licenseNumber.equals(driver.licenseNumber)) &&
        (this.licenseState == null ? driver.licenseState == null : this.licenseState.equals(driver.licenseState)) &&
        (this.name == null ? driver.name == null : this.name.equals(driver.name)) &&
        (this.notes == null ? driver.notes == null : this.notes.equals(driver.notes)) &&
        (this.phone == null ? driver.phone == null : this.phone.equals(driver.phone)) &&
        (this.username == null ? driver.username == null : this.username.equals(driver.username)) &&
        (this.vehicleId == null ? driver.vehicleId == null : this.vehicleId.equals(driver.vehicleId)) &&
        (this.currentVehicleId == null ? driver.currentVehicleId == null : this.currentVehicleId.equals(driver.currentVehicleId));
  }
  ...
  public int hashCode() {
    ...
    result = 31 * result + (this.currentVehicleId == null ? 0: this.currentVehicleId.hashCode());
    return result;
  }
  ...
  public String toString()  {
    ...
    sb.append("  currentVehicleId: ").append(currentVehicleId).append("\n");
    sb.append("}\n");
    return sb.toString();
  }
}
