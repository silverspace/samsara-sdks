...
public class HosAuthenticationLogsParam {
   ...
   * Driver ID to query.
   **/
  @ApiModelProperty(required = true, value = "Driver ID to query.")
  ...
  public boolean equals(Object o) {
    ...
    return (this.driverId == null ? hosAuthenticationLogsParam.driverId == null : this.driverId.equals(hosAuthenticationLogsParam.driverId)) &&
        (this.endMs == null ? hosAuthenticationLogsParam.endMs == null : this.endMs.equals(hosAuthenticationLogsParam.endMs)) &&
        (this.groupId == null ? hosAuthenticationLogsParam.groupId == null : this.groupId.equals(hosAuthenticationLogsParam.groupId)) &&
        (this.startMs == null ? hosAuthenticationLogsParam.startMs == null : this.startMs.equals(hosAuthenticationLogsParam.startMs));
  }
