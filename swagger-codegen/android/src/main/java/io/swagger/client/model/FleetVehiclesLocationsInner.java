...
public class FleetVehiclesLocationsInner {
  ...
  public boolean equals(Object o) {
    ...
    return (this.id == null ? fleetVehiclesLocationsInner.id == null : this.id.equals(fleetVehiclesLocationsInner.id)) &&
        (this.locations == null ? fleetVehiclesLocationsInner.locations == null : this.locations.equals(fleetVehiclesLocationsInner.locations)) &&
        (this.name == null ? fleetVehiclesLocationsInner.name == null : this.name.equals(fleetVehiclesLocationsInner.name));
  }
