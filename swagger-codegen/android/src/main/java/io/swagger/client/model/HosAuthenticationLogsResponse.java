...
import io.swagger.client.model.HosAuthenticationLogsResponseAuthenticationLogs;
import java.util.*;
...
public class HosAuthenticationLogsResponse {
  ...
  public boolean equals(Object o) {
    ...
    return (this.authenticationLogs == null ? hosAuthenticationLogsResponse.authenticationLogs == null : this.authenticationLogs.equals(hosAuthenticationLogsResponse.authenticationLogs));
  }

  @Override
  public int hashCode() {
    int result = 17;
    result = 31 * result + (this.authenticationLogs == null ? 0: this.authenticationLogs.hashCode());
    return result;
  }
