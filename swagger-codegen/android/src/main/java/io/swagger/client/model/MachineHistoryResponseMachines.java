...
import io.swagger.client.model.MachineHistoryResponseVibrations;
import java.util.*;
...
public class MachineHistoryResponseMachines {
  ...
  public boolean equals(Object o) {
    ...
    return (this.id == null ? machineHistoryResponseMachines.id == null : this.id.equals(machineHistoryResponseMachines.id)) &&
        (this.name == null ? machineHistoryResponseMachines.name == null : this.name.equals(machineHistoryResponseMachines.name)) &&
        (this.vibrations == null ? machineHistoryResponseMachines.vibrations == null : this.vibrations.equals(machineHistoryResponseMachines.vibrations));
  }
  ...
  public int hashCode() {
    ...
    result = 31 * result + (this.vibrations == null ? 0: this.vibrations.hashCode());
    return result;
  }
