...
public class DocumentFieldTypeNumberValueTypeMetadata {
   ...
   **/
  @ApiModelProperty(value = "Number of decimal places that values for this field type can have.")
  ...
  public boolean equals(Object o) {
    ...
    return (this.numDecimalPlaces == null ? documentFieldTypeNumberValueTypeMetadata.numDecimalPlaces == null : this.numDecimalPlaces.equals(documentFieldTypeNumberValueTypeMetadata.numDecimalPlaces));
  }

  @Override
  public int hashCode() {
    int result = 17;
    result = 31 * result + (this.numDecimalPlaces == null ? 0: this.numDecimalPlaces.hashCode());
    return result;
  }
