...
public class DriversSummaryParam {
   ...
   **/
  @ApiModelProperty(required = true, value = "End time (ms) of queried time period.")
   ...
   * Org ID to query.
   **/
  @ApiModelProperty(required = true, value = "Org ID to query.")
   ...
   **/
  @ApiModelProperty(required = true, value = "Start time (ms) of queried time period.")
  ...
  public boolean equals(Object o) {
    ...
    return (this.endMs == null ? driversSummaryParam.endMs == null : this.endMs.equals(driversSummaryParam.endMs)) &&
        (this.orgId == null ? driversSummaryParam.orgId == null : this.orgId.equals(driversSummaryParam.orgId)) &&
        (this.startMs == null ? driversSummaryParam.startMs == null : this.startMs.equals(driversSummaryParam.startMs));
  }
