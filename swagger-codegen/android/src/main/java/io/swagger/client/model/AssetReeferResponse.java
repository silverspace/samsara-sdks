...
import io.swagger.client.model.AssetReeferResponseReeferStats;
...
public class AssetReeferResponse {
   ...
   * Asset type
   **/
  @ApiModelProperty(value = "Asset type")
  ...
  public boolean equals(Object o) {
    ...
    return (this.assetType == null ? assetReeferResponse.assetType == null : this.assetType.equals(assetReeferResponse.assetType)) &&
        (this.id == null ? assetReeferResponse.id == null : this.id.equals(assetReeferResponse.id)) &&
        (this.name == null ? assetReeferResponse.name == null : this.name.equals(assetReeferResponse.name)) &&
        (this.reeferStats == null ? assetReeferResponse.reeferStats == null : this.reeferStats.equals(assetReeferResponse.reeferStats));
  }
  ...
  public int hashCode() {
    ...
    result = 31 * result + (this.reeferStats == null ? 0: this.reeferStats.hashCode());
    return result;
  }
