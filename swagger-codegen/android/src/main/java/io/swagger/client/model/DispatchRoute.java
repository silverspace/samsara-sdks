...
public class DispatchRoute {
   ...
   **/
  @ApiModelProperty(required = true, value = "ID of the Samsara dispatch route.")
  public Long getId() {
    return id;
  }
  ...
  public boolean equals(Object o) {
    ...
    return (this.actualEndMs == null ? dispatchRoute.actualEndMs == null : this.actualEndMs.equals(dispatchRoute.actualEndMs)) &&
        (this.actualStartMs == null ? dispatchRoute.actualStartMs == null : this.actualStartMs.equals(dispatchRoute.actualStartMs)) &&
        (this.driverId == null ? dispatchRoute.driverId == null : this.driverId.equals(dispatchRoute.driverId)) &&
        (this.groupId == null ? dispatchRoute.groupId == null : this.groupId.equals(dispatchRoute.groupId)) &&
        (this.name == null ? dispatchRoute.name == null : this.name.equals(dispatchRoute.name)) &&
        (this.scheduledEndMs == null ? dispatchRoute.scheduledEndMs == null : this.scheduledEndMs.equals(dispatchRoute.scheduledEndMs)) &&
        (this.scheduledMeters == null ? dispatchRoute.scheduledMeters == null : this.scheduledMeters.equals(dispatchRoute.scheduledMeters)) &&
        (this.scheduledStartMs == null ? dispatchRoute.scheduledStartMs == null : this.scheduledStartMs.equals(dispatchRoute.scheduledStartMs)) &&
        (this.startLocationAddress == null ? dispatchRoute.startLocationAddress == null : this.startLocationAddress.equals(dispatchRoute.startLocationAddress)) &&
        (this.startLocationAddressId == null ? dispatchRoute.startLocationAddressId == null : this.startLocationAddressId.equals(dispatchRoute.startLocationAddressId)) &&
        (this.startLocationLat == null ? dispatchRoute.startLocationLat == null : this.startLocationLat.equals(dispatchRoute.startLocationLat)) &&
        (this.startLocationLng == null ? dispatchRoute.startLocationLng == null : this.startLocationLng.equals(dispatchRoute.startLocationLng)) &&
        (this.startLocationName == null ? dispatchRoute.startLocationName == null : this.startLocationName.equals(dispatchRoute.startLocationName)) &&
        (this.trailerId == null ? dispatchRoute.trailerId == null : this.trailerId.equals(dispatchRoute.trailerId)) &&
        (this.vehicleId == null ? dispatchRoute.vehicleId == null : this.vehicleId.equals(dispatchRoute.vehicleId)) &&
        (this.dispatchJobs == null ? dispatchRoute.dispatchJobs == null : this.dispatchJobs.equals(dispatchRoute.dispatchJobs)) &&
        (this.id == null ? dispatchRoute.id == null : this.id.equals(dispatchRoute.id));
  }
