...
public class DriverSafetyScoreResponse {
  ...
  public boolean equals(Object o) {
    ...
    return (this.crashCount == null ? driverSafetyScoreResponse.crashCount == null : this.crashCount.equals(driverSafetyScoreResponse.crashCount)) &&
        (this.driverId == null ? driverSafetyScoreResponse.driverId == null : this.driverId.equals(driverSafetyScoreResponse.driverId)) &&
        (this.harshAccelCount == null ? driverSafetyScoreResponse.harshAccelCount == null : this.harshAccelCount.equals(driverSafetyScoreResponse.harshAccelCount)) &&
        (this.harshBrakingCount == null ? driverSafetyScoreResponse.harshBrakingCount == null : this.harshBrakingCount.equals(driverSafetyScoreResponse.harshBrakingCount)) &&
        (this.harshEvents == null ? driverSafetyScoreResponse.harshEvents == null : this.harshEvents.equals(driverSafetyScoreResponse.harshEvents)) &&
        (this.harshTurningCount == null ? driverSafetyScoreResponse.harshTurningCount == null : this.harshTurningCount.equals(driverSafetyScoreResponse.harshTurningCount)) &&
        (this.safetyScore == null ? driverSafetyScoreResponse.safetyScore == null : this.safetyScore.equals(driverSafetyScoreResponse.safetyScore)) &&
        (this.safetyScoreRank == null ? driverSafetyScoreResponse.safetyScoreRank == null : this.safetyScoreRank.equals(driverSafetyScoreResponse.safetyScoreRank)) &&
        (this.timeOverSpeedLimitMs == null ? driverSafetyScoreResponse.timeOverSpeedLimitMs == null : this.timeOverSpeedLimitMs.equals(driverSafetyScoreResponse.timeOverSpeedLimitMs)) &&
        (this.totalDistanceDrivenMeters == null ? driverSafetyScoreResponse.totalDistanceDrivenMeters == null : this.totalDistanceDrivenMeters.equals(driverSafetyScoreResponse.totalDistanceDrivenMeters)) &&
        (this.totalHarshEventCount == null ? driverSafetyScoreResponse.totalHarshEventCount == null : this.totalHarshEventCount.equals(driverSafetyScoreResponse.totalHarshEventCount)) &&
        (this.totalTimeDrivenMs == null ? driverSafetyScoreResponse.totalTimeDrivenMs == null : this.totalTimeDrivenMs.equals(driverSafetyScoreResponse.totalTimeDrivenMs));
  }
