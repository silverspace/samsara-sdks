...
public class DriverForCreate {
  ...
  private Boolean eldPcEnabled = null;
  @SerializedName("eldYmEnabled")
  private Boolean eldYmEnabled = null;
   ...
   **/
  @ApiModelProperty(required = true, value = "Driver's password for the driver app.")
  ...
  public boolean equals(Object o) {
    ...
    return (this.eldAdverseWeatherExemptionEnabled == null ? driverForCreate.eldAdverseWeatherExemptionEnabled == null : this.eldAdverseWeatherExemptionEnabled.equals(driverForCreate.eldAdverseWeatherExemptionEnabled)) &&
        (this.eldBigDayExemptionEnabled == null ? driverForCreate.eldBigDayExemptionEnabled == null : this.eldBigDayExemptionEnabled.equals(driverForCreate.eldBigDayExemptionEnabled)) &&
        (this.eldDayStartHour == null ? driverForCreate.eldDayStartHour == null : this.eldDayStartHour.equals(driverForCreate.eldDayStartHour)) &&
        (this.eldExempt == null ? driverForCreate.eldExempt == null : this.eldExempt.equals(driverForCreate.eldExempt)) &&
        (this.eldExemptReason == null ? driverForCreate.eldExemptReason == null : this.eldExemptReason.equals(driverForCreate.eldExemptReason)) &&
        (this.eldPcEnabled == null ? driverForCreate.eldPcEnabled == null : this.eldPcEnabled.equals(driverForCreate.eldPcEnabled)) &&
        (this.eldYmEnabled == null ? driverForCreate.eldYmEnabled == null : this.eldYmEnabled.equals(driverForCreate.eldYmEnabled)) &&
        (this.externalIds == null ? driverForCreate.externalIds == null : this.externalIds.equals(driverForCreate.externalIds)) &&
        (this.groupId == null ? driverForCreate.groupId == null : this.groupId.equals(driverForCreate.groupId)) &&
        (this.licenseNumber == null ? driverForCreate.licenseNumber == null : this.licenseNumber.equals(driverForCreate.licenseNumber)) &&
        (this.licenseState == null ? driverForCreate.licenseState == null : this.licenseState.equals(driverForCreate.licenseState)) &&
        (this.name == null ? driverForCreate.name == null : this.name.equals(driverForCreate.name)) &&
        (this.notes == null ? driverForCreate.notes == null : this.notes.equals(driverForCreate.notes)) &&
        (this.phone == null ? driverForCreate.phone == null : this.phone.equals(driverForCreate.phone)) &&
        (this.username == null ? driverForCreate.username == null : this.username.equals(driverForCreate.username)) &&
        (this.vehicleId == null ? driverForCreate.vehicleId == null : this.vehicleId.equals(driverForCreate.vehicleId)) &&
        (this.password == null ? driverForCreate.password == null : this.password.equals(driverForCreate.password)) &&
        (this.tagIds == null ? driverForCreate.tagIds == null : this.tagIds.equals(driverForCreate.tagIds));
  }
