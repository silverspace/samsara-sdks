...
import io.swagger.client.model.DocumentFieldTypes;
import java.util.*;
...
public class DocumentType {
   ...
   **/
  @ApiModelProperty(required = true, value = "Name of the document type.")
   ...
   **/
  @ApiModelProperty(required = true, value = "ID for the organization this document belongs to.")
   ...
   **/
  @ApiModelProperty(required = true, value = "Universally unique identifier for the document type. Can be passed in as a documentTypeUuid when creating a document for this document type.")
  ...
  public boolean equals(Object o) {
    ...
    return (this.fieldTypes == null ? documentType.fieldTypes == null : this.fieldTypes.equals(documentType.fieldTypes)) &&
        (this.name == null ? documentType.name == null : this.name.equals(documentType.name)) &&
        (this.orgId == null ? documentType.orgId == null : this.orgId.equals(documentType.orgId)) &&
        (this.uuid == null ? documentType.uuid == null : this.uuid.equals(documentType.uuid));
  }
