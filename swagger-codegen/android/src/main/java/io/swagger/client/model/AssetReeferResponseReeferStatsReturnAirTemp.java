...
public class AssetReeferResponseReeferStatsReturnAirTemp {
   ...
   **/
  @ApiModelProperty(value = "Timestamp in Unix milliseconds since epoch.")
   ...
   **/
  @ApiModelProperty(value = "Return air temperature in millidegree Celsius.")
  ...
  public boolean equals(Object o) {
    ...
    return (this.changedAtMs == null ? assetReeferResponseReeferStatsReturnAirTemp.changedAtMs == null : this.changedAtMs.equals(assetReeferResponseReeferStatsReturnAirTemp.changedAtMs)) &&
        (this.tempInMilliC == null ? assetReeferResponseReeferStatsReturnAirTemp.tempInMilliC == null : this.tempInMilliC.equals(assetReeferResponseReeferStatsReturnAirTemp.tempInMilliC));
  }
  ...
  public int hashCode() {
    ...
    result = 31 * result + (this.tempInMilliC == null ? 0: this.tempInMilliC.hashCode());
    return result;
  }
