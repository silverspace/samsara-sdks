...
import io.swagger.client.model.AssetCurrentLocation;
import java.util.*;
...
public class AssetCurrentLocationsResponse {
  ...
  public boolean equals(Object o) {
    ...
    return (this.cable == null ? assetCurrentLocationsResponse.cable == null : this.cable.equals(assetCurrentLocationsResponse.cable)) &&
        (this.engineHours == null ? assetCurrentLocationsResponse.engineHours == null : this.engineHours.equals(assetCurrentLocationsResponse.engineHours)) &&
        (this.id == null ? assetCurrentLocationsResponse.id == null : this.id.equals(assetCurrentLocationsResponse.id)) &&
        (this.location == null ? assetCurrentLocationsResponse.location == null : this.location.equals(assetCurrentLocationsResponse.location)) &&
        (this.name == null ? assetCurrentLocationsResponse.name == null : this.name.equals(assetCurrentLocationsResponse.name));
  }
