...
import io.swagger.client.model.VehicleMaintenancePassengerCheckEngineLight;
import io.swagger.client.model.VehicleMaintenancePassengerDiagnosticTroubleCodes;
import java.util.*;
...
public class VehicleMaintenancePassenger {
  ...
  public boolean equals(Object o) {
    ...
    return (this.checkEngineLight == null ? vehicleMaintenancePassenger.checkEngineLight == null : this.checkEngineLight.equals(vehicleMaintenancePassenger.checkEngineLight)) &&
        (this.diagnosticTroubleCodes == null ? vehicleMaintenancePassenger.diagnosticTroubleCodes == null : this.diagnosticTroubleCodes.equals(vehicleMaintenancePassenger.diagnosticTroubleCodes));
  }

  @Override
  public int hashCode() {
    int result = 17;
    result = 31 * result + (this.checkEngineLight == null ? 0: this.checkEngineLight.hashCode());
    result = 31 * result + (this.diagnosticTroubleCodes == null ? 0: this.diagnosticTroubleCodes.hashCode());
    return result;
  }
