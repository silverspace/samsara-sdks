...
public class Data {
  ...
  public boolean equals(Object o) {
    ...
    Data data = (Data) o;
    return (this.externalIds == null ? data.externalIds == null : this.externalIds.equals(data.externalIds)) &&
        (this.harshAccelSetting == null ? data.harshAccelSetting == null : this.harshAccelSetting.equals(data.harshAccelSetting)) &&
        (this.name == null ? data.name == null : this.name.equals(data.name));
  }
