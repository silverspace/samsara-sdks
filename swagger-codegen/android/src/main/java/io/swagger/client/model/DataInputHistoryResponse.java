...
import io.swagger.client.model.DataInputHistoryResponsePoints;
import java.util.*;
...
public class DataInputHistoryResponse {
   ...
   **/
  @ApiModelProperty(value = "The ID of this data input")
  public Long getId() {
    return id;
  }
   ...
   **/
  @ApiModelProperty(required = true, value = "Name of this data input")
  ...
  public boolean equals(Object o) {
    ...
    return (this.id == null ? dataInputHistoryResponse.id == null : this.id.equals(dataInputHistoryResponse.id)) &&
        (this.name == null ? dataInputHistoryResponse.name == null : this.name.equals(dataInputHistoryResponse.name)) &&
        (this.points == null ? dataInputHistoryResponse.points == null : this.points.equals(dataInputHistoryResponse.points));
  }
