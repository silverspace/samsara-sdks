...
public class DvirBaseMechanicOrAgentSignature {
   ...
   **/
  @ApiModelProperty(value = "Email of the  agent|mechanic who signed the DVIR.")
   ...
   **/
  @ApiModelProperty(value = "The name of the agent or mechanic who signed the DVIR.")
   ...
   **/
  @ApiModelProperty(value = "Username of the  agent|mechanic who signed the DVIR.")
  ...
  public boolean equals(Object o) {
    ...
    return (this.driverId == null ? dvirBaseMechanicOrAgentSignature.driverId == null : this.driverId.equals(dvirBaseMechanicOrAgentSignature.driverId)) &&
        (this.email == null ? dvirBaseMechanicOrAgentSignature.email == null : this.email.equals(dvirBaseMechanicOrAgentSignature.email)) &&
        (this.mechanicUserId == null ? dvirBaseMechanicOrAgentSignature.mechanicUserId == null : this.mechanicUserId.equals(dvirBaseMechanicOrAgentSignature.mechanicUserId)) &&
        (this.name == null ? dvirBaseMechanicOrAgentSignature.name == null : this.name.equals(dvirBaseMechanicOrAgentSignature.name)) &&
        (this.signedAt == null ? dvirBaseMechanicOrAgentSignature.signedAt == null : this.signedAt.equals(dvirBaseMechanicOrAgentSignature.signedAt)) &&
        (this.type == null ? dvirBaseMechanicOrAgentSignature.type == null : this.type.equals(dvirBaseMechanicOrAgentSignature.type)) &&
        (this.username == null ? dvirBaseMechanicOrAgentSignature.username == null : this.username.equals(dvirBaseMechanicOrAgentSignature.username));
  }
