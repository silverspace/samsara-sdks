...
public class VehicleMaintenanceJ1939CheckEngineLight {
  ...
  public boolean equals(Object o) {
    ...
    return (this.emissionsIsOn == null ? vehicleMaintenanceJ1939CheckEngineLight.emissionsIsOn == null : this.emissionsIsOn.equals(vehicleMaintenanceJ1939CheckEngineLight.emissionsIsOn)) &&
        (this.protectIsOn == null ? vehicleMaintenanceJ1939CheckEngineLight.protectIsOn == null : this.protectIsOn.equals(vehicleMaintenanceJ1939CheckEngineLight.protectIsOn)) &&
        (this.stopIsOn == null ? vehicleMaintenanceJ1939CheckEngineLight.stopIsOn == null : this.stopIsOn.equals(vehicleMaintenanceJ1939CheckEngineLight.stopIsOn)) &&
        (this.warningIsOn == null ? vehicleMaintenanceJ1939CheckEngineLight.warningIsOn == null : this.warningIsOn.equals(vehicleMaintenanceJ1939CheckEngineLight.warningIsOn));
  }

  @Override
  public int hashCode() {
    int result = 17;
    result = 31 * result + (this.emissionsIsOn == null ? 0: this.emissionsIsOn.hashCode());
    result = 31 * result + (this.protectIsOn == null ? 0: this.protectIsOn.hashCode());
    result = 31 * result + (this.stopIsOn == null ? 0: this.stopIsOn.hashCode());
    result = 31 * result + (this.warningIsOn == null ? 0: this.warningIsOn.hashCode());
    return result;
  }
