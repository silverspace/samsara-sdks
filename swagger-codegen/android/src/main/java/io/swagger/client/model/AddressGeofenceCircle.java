...
public class AddressGeofenceCircle {
   ...
   **/
  @ApiModelProperty(value = "The latitude of the center of the circular geofence")
   ...
   **/
  @ApiModelProperty(value = "The longitude of the center of the circular geofence")
   ...
   **/
  @ApiModelProperty(value = "The radius of the circular geofence")
  ...
  public boolean equals(Object o) {
    ...
    return (this.latitude == null ? addressGeofenceCircle.latitude == null : this.latitude.equals(addressGeofenceCircle.latitude)) &&
        (this.longitude == null ? addressGeofenceCircle.longitude == null : this.longitude.equals(addressGeofenceCircle.longitude)) &&
        (this.radiusMeters == null ? addressGeofenceCircle.radiusMeters == null : this.radiusMeters.equals(addressGeofenceCircle.radiusMeters));
  }
  ...
  public int hashCode() {
    ...
    result = 31 * result + (this.radiusMeters == null ? 0: this.radiusMeters.hashCode());
    return result;
  }
