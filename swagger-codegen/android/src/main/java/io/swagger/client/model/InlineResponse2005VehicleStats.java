...
import io.swagger.client.model.AuxInputSeries;
import io.swagger.client.model.EngineState;
import java.util.*;
...
public class InlineResponse2005VehicleStats {
  ...
  public boolean equals(Object o) {
    ...
    return (this.auxInput1 == null ? inlineResponse2005VehicleStats.auxInput1 == null : this.auxInput1.equals(inlineResponse2005VehicleStats.auxInput1)) &&
        (this.auxInput2 == null ? inlineResponse2005VehicleStats.auxInput2 == null : this.auxInput2.equals(inlineResponse2005VehicleStats.auxInput2)) &&
        (this.engineState == null ? inlineResponse2005VehicleStats.engineState == null : this.engineState.equals(inlineResponse2005VehicleStats.engineState)) &&
        (this.vehicleId == null ? inlineResponse2005VehicleStats.vehicleId == null : this.vehicleId.equals(inlineResponse2005VehicleStats.vehicleId));
  }

  @Override
  public int hashCode() {
    int result = 17;
    result = 31 * result + (this.auxInput1 == null ? 0: this.auxInput1.hashCode());
    result = 31 * result + (this.auxInput2 == null ? 0: this.auxInput2.hashCode());
    result = 31 * result + (this.engineState == null ? 0: this.engineState.hashCode());
