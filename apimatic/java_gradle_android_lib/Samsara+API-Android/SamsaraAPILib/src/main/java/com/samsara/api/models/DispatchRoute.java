...
public class DispatchRoute 
    ...
    private static final long serialVersionUID = 7519498719300544717L;
    private List<DispatchJob> dispatchJobs;
    private long id;
    ...
    public void setDispatchJobs (List<DispatchJob> value) { 
