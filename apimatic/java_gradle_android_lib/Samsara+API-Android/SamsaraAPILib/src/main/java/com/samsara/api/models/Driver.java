...
public class Driver 
    ...
    private static final long serialVersionUID = 8901379828176728513L;
    private long id;
     ...
     * True if the driver account has been deactivated.
     */
    @JsonSetter("isDeactivated")
    public void setIsDeactivated (Boolean value) { 
        this.isDeactivated = value;
        notifyObservers(this.isDeactivated);
    }
     ...
     * ID of the vehicle that this driver is currently assigned to. Omitted if there is no current vehicle assignment for this driver.
     */
    @JsonSetter("currentVehicleId")
    public void setCurrentVehicleId (Long value) { 
        this.currentVehicleId = value;
        notifyObservers(this.currentVehicleId);
    }
