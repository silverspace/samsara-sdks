...
public class UsersController extends BaseController {
    ...
    public void deleteUserById(
        ...
        deleteUserByIdAsync(accessToken, userId, callback);
    ...
    public User getUserById(
        ...
        getUserByIdAsync(accessToken, userId, callback);
        if(!callback.isSuccess())
            throw callback.getError();
     ...
     * @param    accessToken    Required parameter: Samsara API access token.
     * @return    Returns the List<User> response from the API call 
     */
    public List<User> listUsers(
                final String accessToken
    ) throws Throwable {
        APICallBackCatcher<List<User>> callback = new APICallBackCatcher<List<User>>();
        listUsersAsync(accessToken, callback);
        if(!callback.isSuccess())
            throw callback.getError();
        return callback.getResult();
    }
     ...
     * @param    accessToken    Required parameter: Samsara API access token.
     * @return    Returns the List<UserRole> response from the API call 
     */
    public List<UserRole> listUserRoles(
                final String accessToken
    ) throws Throwable {
        APICallBackCatcher<List<UserRole>> callback = new APICallBackCatcher<List<UserRole>>();
        listUserRolesAsync(accessToken, callback);
        if(!callback.isSuccess())
            throw callback.getError();
        return callback.getResult();
    }
