...
module SamsaraApi
  ...
  class Driver < BaseModel
    ...
    # ID of the vehicle that this driver is currently assigned to. Omitted if
    # there is no current vehicle assignment for this driver.
    # @return [Long]
    ...
    def self.names
      @_hash = {} if @_hash.nil?
      @_hash['id'] = 'id'
      @_hash['is_deactivated'] = 'isDeactivated'
      @_hash['tags'] = 'tags'
      @_hash['current_vehicle_id'] = 'currentVehicleId'
    ...
    def self.from_hash(hash)
      ...
      id = hash['id']
      name = hash['name']
      is_deactivated = hash['isDeactivated']
      ...
      current_vehicle_id = hash['currentVehicleId']
      eld_adverse_weather_exemption_enabled =
