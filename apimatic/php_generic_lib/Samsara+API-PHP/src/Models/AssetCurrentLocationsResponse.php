 ...
 */
class AssetCurrentLocationsResponse implements JsonSerializable
{
    /**
     ...
     * @var \SamsaraAPILib\Models\AssetCurrentLocation[]|null $location public property
     */
    public $location;
     ...
     * @param array   $location    Initialization value for $this->location
     * @param string  $name        Initialization value for $this->name
     */
    public function __construct()
    {
        if (5 == func_num_args()) {
            $this->cable       = func_get_arg(0);
