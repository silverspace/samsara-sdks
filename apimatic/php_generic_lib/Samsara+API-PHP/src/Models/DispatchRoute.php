 ...
 */
class DispatchRoute implements JsonSerializable
{
    /**
     * The dispatch jobs associated with this route.
     * @required
     * @maps dispatch_jobs
     * @var \SamsaraAPILib\Models\DispatchJob[] $dispatchJobs public property
     */
    public $dispatchJobs;
     ...
     * @param array   $dispatchJobs           Initialization value for $this->dispatchJobs
    ...
    {
        if (17 == func_num_args()) {
            $this->dispatchJobs           = func_get_arg(0);
            $this->id                     = func_get_arg(1);
            $this->actualEndMs            = func_get_arg(2);
            $this->actualStartMs          = func_get_arg(3);
            $this->driverId               = func_get_arg(4);
            $this->groupId                = func_get_arg(5);
            $this->name                   = func_get_arg(6);
            $this->scheduledEndMs         = func_get_arg(7);
            $this->scheduledMeters        = func_get_arg(8);
            $this->scheduledStartMs       = func_get_arg(9);
            $this->startLocationAddress   = func_get_arg(10);
            $this->startLocationAddressId = func_get_arg(11);
            $this->startLocationLat       = func_get_arg(12);
            $this->startLocationLng       = func_get_arg(13);
            $this->startLocationName      = func_get_arg(14);
            $this->trailerId              = func_get_arg(15);
            $this->vehicleId              = func_get_arg(16);
        }
    }
    ...
    {
        $json = array();
        $json['dispatch_jobs']             = $this->dispatchJobs;
        $json['id']                        = $this->id;
