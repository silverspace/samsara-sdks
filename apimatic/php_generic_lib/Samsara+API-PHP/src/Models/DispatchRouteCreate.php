 ...
 */
class DispatchRouteCreate implements JsonSerializable
{
    /**
     * The dispatch jobs to create for this route.
     * @required
     * @maps dispatch_jobs
     * @var \SamsaraAPILib\Models\DispatchJobCreate[] $dispatchJobs public property
     */
    public $dispatchJobs;
    ...
    public function __construct()
    {
        if (16 == func_num_args()) {
            ...
            $this->actualEndMs            = func_get_arg(1);
            $this->actualStartMs          = func_get_arg(2);
            $this->driverId               = func_get_arg(3);
            $this->groupId                = func_get_arg(4);
            $this->name                   = func_get_arg(5);
            $this->scheduledEndMs         = func_get_arg(6);
            $this->scheduledMeters        = func_get_arg(7);
            $this->scheduledStartMs       = func_get_arg(8);
            $this->startLocationAddress   = func_get_arg(9);
            $this->startLocationAddressId = func_get_arg(10);
            $this->startLocationLat       = func_get_arg(11);
            $this->startLocationLng       = func_get_arg(12);
            $this->startLocationName      = func_get_arg(13);
            $this->trailerId              = func_get_arg(14);
