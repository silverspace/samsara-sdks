...
/**
 * Creates an instance of DispatchRouteCreate
 */
class DispatchRouteCreate extends BaseModel {
    /**
     * @constructor
    ...
    constructor(obj) {
        ...
        this.dispatchJobs = this.constructor.getValue(obj.dispatchJobs || obj.dispatch_jobs);
    ...
    static mappingInfo() {
        return super.mappingInfo().concat([
            {
                name: 'dispatchJobs',
                realName: 'dispatch_jobs',
                array: true,
                type: 'DispatchJobCreate',
            },
