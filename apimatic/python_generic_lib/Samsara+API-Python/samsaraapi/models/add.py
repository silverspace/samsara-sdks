...
class Add(object):
    ...
    """Implementation of the 'Add' model.

    Specify devices, etc. that should be added to the tag.

    Attributes:
        assets (list of TaggedAssetBase): The assets to be added to this tag.
        drivers (list of TaggedDriverBase): The drivers to be added to this
            tag.
        machines (list of TaggedMachineBase): The machines to be added to this
            tag.
        sensors (list of TaggedSensorBase): The sensors to be added to this
            tag.
        vehicles (list of TaggedVehicleBase): The vehicles to be added to this
            tag.
