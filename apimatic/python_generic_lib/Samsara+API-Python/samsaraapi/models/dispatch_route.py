...
import samsaraapi.models.dispatch_job

class DispatchRoute(object):

    """Implementation of the 'DispatchRoute' model.

    TODO: type model description here.

    Attributes:
        dispatch_jobs (list of DispatchJob): The dispatch jobs associated with
            this route.
        id (long|int): ID of the Samsara dispatch route.
    ...
    def __init__(self,
                 ...
                 trailer_id=None,
                 vehicle_id=None):
        """Constructor for the DispatchRoute class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('dispatch_jobs') != None:
            ...
            for structure in dictionary.get('dispatch_jobs'):
                dispatch_jobs.append(samsaraapi.models.dispatch_job.DispatchJob.from_dictionary(structure))
