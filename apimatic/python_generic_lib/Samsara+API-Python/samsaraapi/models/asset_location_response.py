...
class AssetLocationResponse(object):
    ...
    """Implementation of the 'AssetLocationResponse' model.
    ...
    Attributes:
        ...
        time (float): Time in Unix milliseconds since epoch when the asset was
            at the location.
    ...
    def __init__(self,
                 ...
                 time=None):
        """Constructor for the AssetLocationResponse class"""
