...
class FleetVehicleLocation(object):
    ...
    """Implementation of the 'FleetVehicleLocation' model.
    ...
    Attributes:
        ...
        time_ms (long|int): Time in Unix milliseconds since epoch when the
    ...
    def __init__(self,
                 ...
                 time_ms=None):
        """Constructor for the FleetVehicleLocation class"""
