...
class DriversSummaryResponseSummaries(Model):
    ...
    def __init__(self, driver_id: int=None, distance_miles: float=None, drive_ms: int=None, active_ms: int=None, driver_username: str=None, group_id: int=None, driver_name: str=None, on_duty_ms: int=None):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DriversSummaryResponseSummaries':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The DriversSummaryResponse_Summaries of this DriversSummaryResponseSummaries.
        """
