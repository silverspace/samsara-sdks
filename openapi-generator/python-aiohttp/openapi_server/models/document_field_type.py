...
class DocumentFieldType(Model):
    ...
    def __init__(self, label: str=None, number_value_type_metadata: DocumentFieldTypeNumberValueTypeMetadata=None, value_type: str=None):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DocumentFieldType':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The DocumentFieldType of this DocumentFieldType.
        """
