...
class InlineResponse2005VehicleStats(Model):
    ...
    def __init__(self, engine_state: List[EngineState]=None, aux_input2: AuxInputSeries=None, vehicle_id: int=None, aux_input1: AuxInputSeries=None):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'InlineResponse2005VehicleStats':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The inline_response_200_5_vehicleStats of this InlineResponse2005VehicleStats.
        """
