...
class AssetReeferResponseReeferStats(Model):
    ...
    def __init__(self, fuel_percentage: List[AssetReeferResponseReeferStatsFuelPercentage]=None, power_status: List[AssetReeferResponseReeferStatsPowerStatus]=None, engine_hours: List[AssetReeferResponseReeferStatsEngineHours]=None, set_point: List[AssetReeferResponseReeferStatsSetPoint]=None, return_air_temp: List[AssetReeferResponseReeferStatsReturnAirTemp]=None, alarms: List[AssetReeferResponseReeferStatsAlarms1]=None):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'AssetReeferResponseReeferStats':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The AssetReeferResponse_reeferStats of this AssetReeferResponseReeferStats.
        """
