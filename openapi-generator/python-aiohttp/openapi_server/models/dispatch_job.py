...
class DispatchJob(Model):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DispatchJob':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The DispatchJob of this DispatchJob.
        """
    ...
    def dispatch_route_id(self, dispatch_route_id):
        ...
        if dispatch_route_id is None:
            raise ValueError("Invalid value for `dispatch_route_id`, must not be `None`")
    ...
    def job_state(self, job_state):
        ...
        if job_state is None:
            raise ValueError("Invalid value for `job_state`, must not be `None`")
