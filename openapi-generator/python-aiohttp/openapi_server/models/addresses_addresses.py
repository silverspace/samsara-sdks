...
class AddressesAddresses(Model):
    ...
    def __init__(self, notes: str=None, formatted_address: str=None, geofence: AddressGeofence=None, tag_ids: List[int]=None, name: str=None, contact_ids: List[int]=None):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'AddressesAddresses':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The _addresses_addresses of this AddressesAddresses.
        """
    ...
    def geofence(self, geofence):
        ...
        """
        if geofence is None:
            raise ValueError("Invalid value for `geofence`, must not be `None`")
