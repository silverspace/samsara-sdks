...
class DriverBase(Model):
    ...
    def __init__(self, eld_adverse_weather_exemption_enabled: bool=None, eld_big_day_exemption_enabled: bool=None, eld_day_start_hour: int=None, eld_exempt: bool=None, eld_exempt_reason: str=None, eld_pc_enabled: bool=False, eld_ym_enabled: bool=False, external_ids: Dict[str, str]=None, group_id: int=None, license_number: str=None, license_state: str=None, name: str=None, notes: str=None, phone: str=None, username: str=None, vehicle_id: int=None):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DriverBase':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The DriverBase of this DriverBase.
        """
