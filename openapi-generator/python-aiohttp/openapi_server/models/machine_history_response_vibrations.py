...
class MachineHistoryResponseVibrations(Model):
    ...
    def __init__(self, x: float=None, y: float=None, z: float=None, time: int=None):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'MachineHistoryResponseVibrations':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The MachineHistoryResponse_vibrations of this MachineHistoryResponseVibrations.
        """
