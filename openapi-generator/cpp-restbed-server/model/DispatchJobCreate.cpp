...
std::string DispatchJobCreate::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void DispatchJobCreate::fromJsonString(std::string const& jsonString)
{
...
void DispatchJobCreate::setDestinationAddress(std::string value)
{
...
void DispatchJobCreate::setDestinationName(std::string value)
{
...
void DispatchJobCreate::setNotes(std::string value)
{
    m_Notes = value;
}
