...
#ifndef DocumentType_H_
#define DocumentType_H_
...
public:
    ...
    /// </summary>
    std::vector<std::shared_ptr<std::vector>> getFieldTypes() const;
    void setFieldTypes(std::vector<std::shared_ptr<std::vector>> value);
    /// <summary>
...
protected:
    std::vector<std::shared_ptr<std::vector>> m_FieldTypes;
    std::string m_Name;
    int64_t m_OrgId;
    std::string m_Uuid;
};
