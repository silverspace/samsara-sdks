...
std::string DriverForCreate::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void DriverForCreate::fromJsonString(std::string const& jsonString)
{
...
void DriverForCreate::setEldExemptReason(std::string value)
{
...
std::map<std::string, std::string> DriverForCreate::getExternalIds() const
{
    return m_ExternalIds;
}
void DriverForCreate::setExternalIds(std::map<std::string, std::string> value)
{
    m_ExternalIds = value;
}
...
void DriverForCreate::setLicenseNumber(std::string value)
{
...
void DriverForCreate::setLicenseState(std::string value)
{
...
void DriverForCreate::setName(std::string value)
{
    m_Name = value;
}
...
void DriverForCreate::setNotes(std::string value)
{
    m_Notes = value;
}
...
void DriverForCreate::setPhone(std::string value)
{
    m_Phone = value;
}
...
void DriverForCreate::setUsername(std::string value)
{
    m_Username = value;
}
...
void DriverForCreate::setPassword(std::string value)
{
    m_Password = value;
}
std::vector<int64_t> DriverForCreate::getTagIds() const
{
    return m_TagIds;
}
