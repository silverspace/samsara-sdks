...
std::string HosAuthenticationLogsResponse_authenticationLogs::toJsonString()
{
	std::stringstream ss;
	ptree pt;
	pt.put("ActionType", m_ActionType);
	pt.put("Address", m_Address);
	pt.put("City", m_City);
	pt.put("HappenedAtMs", m_HappenedAtMs);
	pt.put("AddressName", m_AddressName);
	pt.put("State", m_State);
	write_json(ss, pt, false);
	return ss.str();
}

void HosAuthenticationLogsResponse_authenticationLogs::fromJsonString(std::string const& jsonString)
{
	std::stringstream ss(jsonString);
	ptree pt;
	read_json(ss,pt);
	m_ActionType = pt.get("ActionType", "");
	m_Address = pt.get("Address", "");
	m_City = pt.get("City", "");
	m_HappenedAtMs = pt.get("HappenedAtMs", 0L);
	m_AddressName = pt.get("AddressName", "");
...
void HosAuthenticationLogsResponse_authenticationLogs::setActionType(std::string value)
{
    m_ActionType = value;
}
...
void HosAuthenticationLogsResponse_authenticationLogs::setAddress(std::string value)
{
    m_Address = value;
}
...
void HosAuthenticationLogsResponse_authenticationLogs::setCity(std::string value)
{
    m_City = value;
}
...
void HosAuthenticationLogsResponse_authenticationLogs::setAddressName(std::string value)
{
    m_AddressName = value;
}
...
void HosAuthenticationLogsResponse_authenticationLogs::setState(std::string value)
{
    m_State = value;
}
