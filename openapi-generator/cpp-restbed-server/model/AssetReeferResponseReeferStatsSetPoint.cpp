...
std::string AssetReeferResponse_reeferStats_setPoint::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void AssetReeferResponse_reeferStats_setPoint::fromJsonString(std::string const& jsonString)
{
