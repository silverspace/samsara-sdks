...
std::string HosLogsResponse_logs::toJsonString()
{
	std::stringstream ss;
	ptree pt;
	pt.put("LocLng", m_LocLng);
	pt.put("LogStartMs", m_LogStartMs);
	pt.put("DriverId", m_DriverId);
	pt.put("StatusType", m_StatusType);
	pt.put("LocCity", m_LocCity);
	pt.put("GroupId", m_GroupId);
	pt.put("LocName", m_LocName);
	pt.put("LocLat", m_LocLat);
	pt.put("Remark", m_Remark);
	pt.put("LocState", m_LocState);
	pt.put("VehicleId", m_VehicleId);
	write_json(ss, pt, false);
	return ss.str();
}

void HosLogsResponse_logs::fromJsonString(std::string const& jsonString)
{
	std::stringstream ss(jsonString);
	ptree pt;
	read_json(ss,pt);
	m_LocLng = pt.get("LocLng", 0.0);
	m_LogStartMs = pt.get("LogStartMs", 0L);
	m_DriverId = pt.get("DriverId", 0L);
	m_StatusType = pt.get("StatusType", "");
	m_LocCity = pt.get("LocCity", "");
	m_GroupId = pt.get("GroupId", 0L);
	m_LocName = pt.get("LocName", "");
	m_LocLat = pt.get("LocLat", 0.0);
	m_Remark = pt.get("Remark", "");
	m_LocState = pt.get("LocState", "");
...
void HosLogsResponse_logs::setStatusType(std::string value)
{
    m_StatusType = value;
}
...
void HosLogsResponse_logs::setLocCity(std::string value)
{
    m_LocCity = value;
}
...
void HosLogsResponse_logs::setLocName(std::string value)
{
    m_LocName = value;
}
...
void HosLogsResponse_logs::setRemark(std::string value)
{
    m_Remark = value;
}
...
void HosLogsResponse_logs::setLocState(std::string value)
{
    m_LocState = value;
}
...
std::vector<int64_t> HosLogsResponse_logs::getCodriverIds() const
{
