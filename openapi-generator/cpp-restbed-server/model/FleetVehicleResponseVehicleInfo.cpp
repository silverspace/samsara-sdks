...
std::string FleetVehicleResponse_vehicleInfo::toJsonString()
{
	std::stringstream ss;
	ptree pt;
	pt.put("Year", m_Year);
...
void FleetVehicleResponse_vehicleInfo::fromJsonString(std::string const& jsonString)
{
	std::stringstream ss(jsonString);
	ptree pt;
	read_json(ss,pt);
	m_Year = pt.get("Year", 0L);
...
void FleetVehicleResponse_vehicleInfo::setModel(std::string value)
{
    m_Model = value;
}
...
void FleetVehicleResponse_vehicleInfo::setVin(std::string value)
{
    m_Vin = value;
}
...
void FleetVehicleResponse_vehicleInfo::setMake(std::string value)
{
    m_Make = value;
}
