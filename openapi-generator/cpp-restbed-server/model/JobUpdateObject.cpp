...
std::string JobUpdateObject::toJsonString()
{
	std::stringstream ss;
	ptree pt;
	pt.put("Changed_at_ms", m_Changed_at_ms);
	pt.put("Job_id", m_Job_id);
	pt.put("Route_id", m_Route_id);
	write_json(ss, pt, false);
	return ss.str();
}

void JobUpdateObject::fromJsonString(std::string const& jsonString)
{
	std::stringstream ss(jsonString);
	ptree pt;
	read_json(ss,pt);
	m_Changed_at_ms = pt.get("Changed_at_ms", 0L);
	m_Job_id = pt.get("Job_id", 0L);
	m_Route_id = pt.get("Route_id", 0L);
}
...
void JobUpdateObject::setJobState(std::shared_ptr<JobStatus> value)
{
    m_Job_state = value;
}
...
void JobUpdateObject::setPrevJobState(std::shared_ptr<PrevJobStatus> value)
{
...
void JobUpdateObject::setRoute(std::shared_ptr<DispatchRoute> value)
{
    m_Route = value;
}
