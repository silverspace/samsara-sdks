...
std::string DispatchRoute::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void DispatchRoute::fromJsonString(std::string const& jsonString)
{
...
void DispatchRoute::setName(std::string value)
{
    m_Name = value;
}
...
void DispatchRoute::setStartLocationAddress(std::string value)
{
...
void DispatchRoute::setStartLocationName(std::string value)
{
...
std::vector<std::shared_ptr<DispatchJob>> DispatchRoute::getDispatchJobs() const
{
    return m_Dispatch_jobs;
}
void DispatchRoute::setDispatchJobs(std::vector<std::shared_ptr<DispatchJob>> value)
{
