...
std::string Driver::toJsonString()
{
	std::stringstream ss;
	ptree pt;
	...
	pt.put("Id", m_Id);
	pt.put("IsDeactivated", m_IsDeactivated);
	write_json(ss, pt, false);
	return ss.str();
}

void Driver::fromJsonString(std::string const& jsonString)
{
	...
	m_Id = pt.get("Id", 0L);
	m_IsDeactivated = pt.get("IsDeactivated", false);
}
...
void Driver::setEldExemptReason(std::string value)
{
...
std::map<std::string, std::string> Driver::getExternalIds() const
{
    return m_ExternalIds;
}
void Driver::setExternalIds(std::map<std::string, std::string> value)
{
    m_ExternalIds = value;
}
...
void Driver::setLicenseNumber(std::string value)
{
...
void Driver::setLicenseState(std::string value)
{
...
void Driver::setName(std::string value)
{
    m_Name = value;
}
...
void Driver::setNotes(std::string value)
{
    m_Notes = value;
}
...
void Driver::setPhone(std::string value)
{
    m_Phone = value;
}
...
void Driver::setUsername(std::string value)
{
    m_Username = value;
}
...
std::vector<std::shared_ptr<TagMetadata>> Driver::getTags() const
{
    return m_Tags;
}
void Driver::setTags(std::vector<std::shared_ptr<TagMetadata>> value)
{
    m_Tags = value;
}
