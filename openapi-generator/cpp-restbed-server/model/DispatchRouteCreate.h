...
public:
    ...
    void setStartLocationAddress(std::string value);
    /// <summary>
    ...
    void setStartLocationName(std::string value);
    /// <summary>
    ...
    /// </summary>
    std::vector<std::shared_ptr<DispatchJobCreate>> getDispatchJobs() const;
    void setDispatchJobs(std::vector<std::shared_ptr<DispatchJobCreate>> value);
