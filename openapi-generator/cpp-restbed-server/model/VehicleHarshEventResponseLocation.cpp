...
std::string VehicleHarshEventResponse_location::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void VehicleHarshEventResponse_location::fromJsonString(std::string const& jsonString)
{
	std::stringstream ss(jsonString);
	ptree pt;
	read_json(ss,pt);
	m_Address = pt.get("Address", "");
	m_Latitude = pt.get("Latitude", "");
	m_Longitude = pt.get("Longitude", "");
}
...
void VehicleHarshEventResponse_location::setAddress(std::string value)
{
    m_Address = value;
}
...
void VehicleHarshEventResponse_location::setLatitude(std::string value)
{
    m_Latitude = value;
}
...
void VehicleHarshEventResponse_location::setLongitude(std::string value)
{
    m_Longitude = value;
}
