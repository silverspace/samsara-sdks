...
public:
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<SafetyReportHarshEvent>> getHarshEvents() const;
    void setHarshEvents(std::vector<std::shared_ptr<SafetyReportHarshEvent>> value);
    /// <summary>
    ...
    void setSafetyScoreRank(std::string value);
    /// <summary>
