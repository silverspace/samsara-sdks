...
#ifndef DispatchRoute_H_
#define DispatchRoute_H_
...
public:
    ...
    /// </summary>
    std::vector<std::shared_ptr<DispatchJob>> getDispatchJobs() const;
    void setDispatchJobs(std::vector<std::shared_ptr<DispatchJob>> value);
    /// <summary>
