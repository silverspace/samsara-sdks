...
public:
    ...
    void setOrganizationRoleId(std::string value);
    /// <summary>
    ...
    void setOrganizationRole(std::string value);
    /// <summary>
    /// The specific tags this user has access to. This will be blank for users that have full access to the organization.
    /// </summary>
    std::vector<std::shared_ptr<UserTagRole>> getTagRoles() const;
    void setTagRoles(std::vector<std::shared_ptr<UserTagRole>> value);
