...
std::string VehicleLocation::toJsonString()
{
	std::stringstream ss;
	ptree pt;
	pt.put("Heading", m_Heading);
	pt.put("Id", m_Id);
...
void VehicleLocation::fromJsonString(std::string const& jsonString)
{
	std::stringstream ss(jsonString);
	ptree pt;
	read_json(ss,pt);
	m_Heading = pt.get("Heading", 0.0);
	m_Id = pt.get("Id", 0L);
	...
	m_OnTrip = pt.get("OnTrip", false);
	m_Speed = pt.get("Speed", 0.0);
	m_Time = pt.get("Time", 0);
	m_Vin = pt.get("Vin", "");
}
...
void VehicleLocation::setLocation(std::string value)
{
    m_Location = value;
}
...
void VehicleLocation::setName(std::string value)
{
    m_Name = value;
}
...
void VehicleLocation::setVin(std::string value)
{
    m_Vin = value;
}
