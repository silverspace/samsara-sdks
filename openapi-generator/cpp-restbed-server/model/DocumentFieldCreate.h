...
public:
    ...
    /// </summary>
    std::vector<std::shared_ptr<DocumentFieldCreate_photoValue>> getPhotoValue() const;
    void setPhotoValue(std::vector<std::shared_ptr<DocumentFieldCreate_photoValue>> value);
    /// <summary>
