...
std::string Inline_object_12::toJsonString()
{
	std::stringstream ss;
	ptree pt;
	...
	pt.put("PreviousDefectsCorrected", m_PreviousDefectsCorrected);
	pt.put("PreviousDefectsIgnored", m_PreviousDefectsIgnored);
	pt.put("Safe", m_Safe);
	pt.put("TrailerId", m_TrailerId);
	pt.put("UserEmail", m_UserEmail);
	pt.put("VehicleId", m_VehicleId);
	write_json(ss, pt, false);
	return ss.str();
}

void Inline_object_12::fromJsonString(std::string const& jsonString)
{
	...
	m_OdometerMiles = pt.get("OdometerMiles", 0);
	m_PreviousDefectsCorrected = pt.get("PreviousDefectsCorrected", false);
	m_PreviousDefectsIgnored = pt.get("PreviousDefectsIgnored", false);
	m_Safe = pt.get("Safe", "");
	m_TrailerId = pt.get("TrailerId", 0);
	m_UserEmail = pt.get("UserEmail", "");
	m_VehicleId = pt.get("VehicleId", 0);
}
...
void Inline_object_12::setInspectionType(std::string value)
{
...
void Inline_object_12::setMechanicNotes(std::string value)
{
...
void Inline_object_12::setSafe(std::string value)
{
    m_Safe = value;
}
...
void Inline_object_12::setUserEmail(std::string value)
{
    m_UserEmail = value;
}
