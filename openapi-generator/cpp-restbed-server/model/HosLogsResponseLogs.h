...
public:
    ...
    void setStatusType(std::string value);
    /// <summary>
    /// City in which the log was recorded.
    /// </summary>
    std::string getLocCity() const;
    void setLocCity(std::string value);
    /// <summary>
    /// ID of the group.
    /// </summary>
    ...
    void setLocName(std::string value);
    /// <summary>
    ...
    void setRemark(std::string value);
    /// <summary>
    /// State in which the log was recorded.
    /// </summary>
    std::string getLocState() const;
    void setLocState(std::string value);
    /// <summary>
    /// ID of the vehicle.
    /// </summary>
    ...
    /// 
    /// </summary>
    std::vector<int64_t> getCodriverIds() const;
