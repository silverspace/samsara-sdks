...
std::string FleetVehicleLocation::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void FleetVehicleLocation::fromJsonString(std::string const& jsonString)
{
...
void FleetVehicleLocation::setLocation(std::string value)
{
    m_Location = value;
}
