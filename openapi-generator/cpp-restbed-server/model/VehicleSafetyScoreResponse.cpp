...
std::string VehicleSafetyScoreResponse::toJsonString()
{
	std::stringstream ss;
	ptree pt;
...
void VehicleSafetyScoreResponse::fromJsonString(std::string const& jsonString)
{
...
std::vector<std::shared_ptr<SafetyReportHarshEvent>> VehicleSafetyScoreResponse::getHarshEvents() const
{
    return m_HarshEvents;
}
void VehicleSafetyScoreResponse::setHarshEvents(std::vector<std::shared_ptr<SafetyReportHarshEvent>> value)
{
    m_HarshEvents = value;
}
...
void VehicleSafetyScoreResponse::setSafetyScoreRank(std::string value)
{
