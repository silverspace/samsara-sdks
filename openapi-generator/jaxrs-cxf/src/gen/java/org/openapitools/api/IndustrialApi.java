...
public interface IndustrialApi  {
    ...
    @ApiOperation(value = "/industrial/data", tags={ "Industrial",  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "List of data inputs.", response = InlineResponse2006.class),
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public InlineResponse2006 getAllDataInputs(@QueryParam("access_token") @NotNull  String accessToken, @QueryParam("group_id")  Long groupId, @QueryParam("startMs")  Long startMs, @QueryParam("endMs")  Long endMs);
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "/industrial/data/{data_input_id:[0-9]+}", tags={ "Industrial",  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Returns datapoints for the given data input", response = DataInputHistoryResponse.class),
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public DataInputHistoryResponse getDataInput(@QueryParam("access_token") @NotNull  String accessToken, @PathParam("data_input_id") Long dataInputId, @QueryParam("startMs")  Long startMs, @QueryParam("endMs")  Long endMs);
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "/machines/list", tags={ "Industrial",  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "List of machine objects.", response = InlineResponse2007.class),
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public InlineResponse2007 getMachines(@QueryParam("access_token") @NotNull  String accessToken, @Valid InlineObject18 groupParam);
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "/machines/history", tags={ "Industrial" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public MachineHistoryResponse getMachinesHistory(@QueryParam("access_token") @NotNull  String accessToken, @Valid InlineObject17 historyParam);
}
