...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AddressGeofence :  IEquatable<AddressGeofence>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddressGeofence" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as AddressGeofence);
        }

        /// <summary>
        /// Returns true if AddressGeofence instances are equal
        /// </summary>
        /// <param name="input">Instance of AddressGeofence to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddressGeofence input)
        {
            if (input == null)
                return false;
