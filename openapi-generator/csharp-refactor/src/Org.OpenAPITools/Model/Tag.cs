...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Tag :  IEquatable<Tag>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="Tag" /> class.
        /// </summary>
        /// <param name="addresses">The addresses that belong to this tag..</param>
        ...
        /// <param name="id">The ID of this tag. (required).</param>
        /// <param name="machines">The machines that belong to this tag..</param>
        /// <param name="name">Name of this tag. (required).</param>
        ...
        public Tag(List<TaggedAddress> addresses = default(List<TaggedAddress>), List<TaggedAsset> assets = default(List<TaggedAsset>), List<TaggedDriver> drivers = default(List<TaggedDriver>), long groupId = default(long), long id = default(long), List<TaggedMachine> machines = default(List<TaggedMachine>), string name = default(string), long parentTagId = default(long), List<TaggedSensor> sensors = default(List<TaggedSensor>), List<TaggedVehicle> vehicles = default(List<TaggedVehicle>))
        {
