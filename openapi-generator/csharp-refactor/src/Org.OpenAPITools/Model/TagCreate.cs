...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class TagCreate :  IEquatable<TagCreate>, IValidatableObject
    {
        ...
        public TagCreate(List<TaggedAssetBase> assets = default(List<TaggedAssetBase>), List<TaggedDriverBase> drivers = default(List<TaggedDriverBase>), List<TaggedMachineBase> machines = default(List<TaggedMachineBase>), string name = default(string), long parentTagId = default(long), List<TaggedSensorBase> sensors = default(List<TaggedSensorBase>), List<TaggedVehicleBase> vehicles = default(List<TaggedVehicleBase>))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for TagCreate and cannot be null");
            }
            else
            {
                this.Name = name;
