...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class DocumentField :  IEquatable<DocumentField>, IValidatableObject
    {
        ...
        public DocumentField(double numberValue = default(double), List<DocumentFieldCreatePhotoValue> photoValue = default(List<DocumentFieldCreatePhotoValue>), string stringValue = default(string), string valueType = default(string), string label = default(string), Object value = default(Object))
        {
