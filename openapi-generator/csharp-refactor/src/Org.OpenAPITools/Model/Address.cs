...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Address :  IEquatable<Address>, IValidatableObject
    {
        ...
        public Address(List<Contact> contacts = default(List<Contact>), string formattedAddress = default(string), AddressGeofence geofence = default(AddressGeofence), long id = default(long), string name = default(string), string notes = default(string), List<TagMetadata> tags = default(List<TagMetadata>))
        {
