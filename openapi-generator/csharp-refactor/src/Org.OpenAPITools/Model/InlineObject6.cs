...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class InlineObject6 :  IEquatable<InlineObject6>, IValidatableObject
    {
        ...
        public InlineObject6(long driverId = default(long), int endMs = default(int), long groupId = default(long), int startMs = default(int))
        {
            // to ensure "driverId" is required (not null)
            if (driverId == null)
            {
                throw new InvalidDataException("driverId is a required property for InlineObject6 and cannot be null");
            }
            else
            {
            ...
            if (endMs == null)
            {
                throw new InvalidDataException("endMs is a required property for InlineObject6 and cannot be null");
            }
            else
            {
                this.EndMs = endMs;
            ...
            if (groupId == null)
            {
                throw new InvalidDataException("groupId is a required property for InlineObject6 and cannot be null");
            }
            else
            {
            ...
            if (startMs == null)
            {
                throw new InvalidDataException("startMs is a required property for InlineObject6 and cannot be null");
            }
            else
            {
