...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class InlineObject22 :  IEquatable<InlineObject22>, IValidatableObject
    {
        ...
        public InlineObject22(long groupId = default(long), List<long> sensors = default(List<long>))
        {
            // to ensure "groupId" is required (not null)
            if (groupId == null)
            {
                throw new InvalidDataException("groupId is a required property for InlineObject22 and cannot be null");
            }
            else
            {
            ...
            if (sensors == null)
            {
                throw new InvalidDataException("sensors is a required property for InlineObject22 and cannot be null");
            }
            else
            {
