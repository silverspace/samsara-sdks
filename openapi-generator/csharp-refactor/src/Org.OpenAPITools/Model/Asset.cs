...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Asset :  IEquatable<Asset>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="Asset" /> class.
        /// </summary>
        /// <param name="assetSerialNumber">Serial number of the host asset.</param>
        ...
        public Asset(string assetSerialNumber = default(string), List<AssetCable> cable = default(List<AssetCable>), int engineHours = default(int), long id = default(long), string name = default(string))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for Asset and cannot be null");
            }
            else
            {
                this.Id = id;
        ...
        public bool Equals(Asset input)
        {
            ...
            return 
                (
                    this.AssetSerialNumber == input.AssetSerialNumber ||
                    (this.AssetSerialNumber != null &&
                    this.AssetSerialNumber.Equals(input.AssetSerialNumber))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AssetSerialNumber != null)
                    hashCode = hashCode * 59 + this.AssetSerialNumber.GetHashCode();
                if (this.Cable != null)
