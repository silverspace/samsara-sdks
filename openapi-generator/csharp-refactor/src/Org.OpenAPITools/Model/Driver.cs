...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Driver :  IEquatable<Driver>, IValidatableObject
    {
        ...
        /// <param name="id">ID of the driver. (required).</param>
        /// <param name="isDeactivated">True if the driver account has been deactivated..</param>
        /// <param name="tags">tags.</param>
        public Driver(bool eldAdverseWeatherExemptionEnabled = default(bool), bool eldBigDayExemptionEnabled = default(bool), int eldDayStartHour = default(int), bool eldExempt = default(bool), string eldExemptReason = default(string), bool eldPcEnabled = false, bool eldYmEnabled = false, Dictionary<string, string> externalIds = default(Dictionary<string, string>), long groupId = default(long), string licenseNumber = default(string), string licenseState = default(string), string name = default(string), string notes = default(string), string phone = default(string), string username = default(string), long vehicleId = default(long), long id = default(long), bool isDeactivated = default(bool), List<TagMetadata> tags = default(List<TagMetadata>))
        {
            ...
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for Driver and cannot be null");
            }
            else
            {
                this.Id = id;
        ...
        public bool Equals(Driver input)
        {
            ...
            return 
                ...
                (
                    this.IsDeactivated == input.IsDeactivated ||
                    (this.IsDeactivated != null &&
                    this.IsDeactivated.Equals(input.IsDeactivated))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.IsDeactivated != null)
                    hashCode = hashCode * 59 + this.IsDeactivated.GetHashCode();
                if (this.Tags != null)
