...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TagModify :  IEquatable<TagModify>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TagModify" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as TagModify);
        }

        /// <summary>
        /// Returns true if TagModify instances are equal
        /// </summary>
        /// <param name="input">Instance of TagModify to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TagModify input)
        {
            if (input == null)
                return false;
