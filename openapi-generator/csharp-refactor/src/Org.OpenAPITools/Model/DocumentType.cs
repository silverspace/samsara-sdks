...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class DocumentType :  IEquatable<DocumentType>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="DocumentType" /> class.
        /// </summary>
        /// <param name="fieldTypes">The field types determine the names of fields for this document type. They also determine the types of values a document submitted for this document type can have..</param>
        /// <param name="name">Name of the document type. (required).</param>
        /// <param name="orgId">ID for the organization this document belongs to. (required).</param>
        /// <param name="uuid">Universally unique identifier for the document type. Can be passed in as a documentTypeUuid when creating a document for this document type. (required).</param>
        public DocumentType(List<List> fieldTypes = default(List<List>), string name = default(string), long orgId = default(long), string uuid = default(string))
        {
            ...
            if (orgId == null)
            {
                throw new InvalidDataException("orgId is a required property for DocumentType and cannot be null");
            }
            else
            {
                this.OrgId = orgId;
            ...
            if (uuid == null)
            {
                throw new InvalidDataException("uuid is a required property for DocumentType and cannot be null");
            }
            else
            {
                this.Uuid = uuid;
        ...
        public List<List> FieldTypes { get; set; }
