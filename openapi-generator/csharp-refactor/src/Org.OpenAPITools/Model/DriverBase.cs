...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DriverBase :  IEquatable<DriverBase>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DriverBase" /> class.
        /// </summary>
        ...
        public DriverBase(bool eldAdverseWeatherExemptionEnabled = default(bool), bool eldBigDayExemptionEnabled = default(bool), int eldDayStartHour = default(int), bool eldExempt = default(bool), string eldExemptReason = default(string), bool eldPcEnabled = false, bool eldYmEnabled = false, Dictionary<string, string> externalIds = default(Dictionary<string, string>), long groupId = default(long), string licenseNumber = default(string), string licenseState = default(string), string name = default(string), string notes = default(string), string phone = default(string), string username = default(string), long vehicleId = default(long))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for DriverBase and cannot be null");
            }
            else
            {
                this.Name = name;
        ...
        {
            return this.Equals(input as DriverBase);
        }

        /// <summary>
        /// Returns true if DriverBase instances are equal
        /// </summary>
        /// <param name="input">Instance of DriverBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DriverBase input)
        {
            if (input == null)
                return false;
