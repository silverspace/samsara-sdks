...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DocumentFieldCreate :  IEquatable<DocumentFieldCreate>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DocumentFieldCreate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DocumentFieldCreate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DocumentFieldCreate" /> class.
        /// </summary>
        ...
        public DocumentFieldCreate(double numberValue = default(double), List<DocumentFieldCreatePhotoValue> photoValue = default(List<DocumentFieldCreatePhotoValue>), string stringValue = default(string), string valueType = default(string))
        {
            // to ensure "valueType" is required (not null)
            if (valueType == null)
            {
                throw new InvalidDataException("valueType is a required property for DocumentFieldCreate and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as DocumentFieldCreate);
        }

        /// <summary>
        /// Returns true if DocumentFieldCreate instances are equal
        /// </summary>
        /// <param name="input">Instance of DocumentFieldCreate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DocumentFieldCreate input)
        {
            if (input == null)
                return false;
