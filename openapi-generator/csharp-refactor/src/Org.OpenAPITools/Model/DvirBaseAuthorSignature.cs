...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DvirBaseAuthorSignature :  IEquatable<DvirBaseAuthorSignature>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DvirBaseAuthorSignature" /> class.
        /// </summary>
        ...
        /// <param name="name">The name of the driver or mechanic who signed the DVIR..</param>
        ...
        /// <param name="email">Email of the  driver|mechanic who signed the DVIR..</param>
        /// <param name="username">Username of the  driver|mechanic who signed the DVIR..</param>
        public DvirBaseAuthorSignature(long mechanicUserId = default(long), long driverId = default(long), string name = default(string), long signedAt = default(long), string type = default(string), string email = default(string), string username = default(string))
        {
        ...
        {
            return this.Equals(input as DvirBaseAuthorSignature);
        }

        /// <summary>
        /// Returns true if DvirBaseAuthorSignature instances are equal
        /// </summary>
        /// <param name="input">Instance of DvirBaseAuthorSignature to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DvirBaseAuthorSignature input)
        {
            if (input == null)
                return false;
