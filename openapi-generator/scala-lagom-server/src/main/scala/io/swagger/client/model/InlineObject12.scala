...
case class InlineObject12 (
                  inspectionType:  Option[InlineObject12InspectionTypeEnum.InlineObject12InspectionTypeEnum],
            ...
            /* Whether any previous defects were ignored. If this vehicle or trailer was previously marked unsafe, and this DVIR marks it as safe, either previousDefectsCorrected or previousDefectsIgnored must be true. */
                  ...
                  safe:  Option[InlineObject12SafeEnum.InlineObject12SafeEnum],
...
implicit val format: Format[InlineObject12] = Json.format
}

object InlineObject12InspectionTypeEnum extends Enumeration {
  val   mechanic = Value
  type InlineObject12InspectionTypeEnum = Value
  implicit val format: Format[Value] = Format(Reads.enumNameReads(this), Writes.enumNameWrites[InlineObject12InspectionTypeEnum.type])
}
object InlineObject12SafeEnum extends Enumeration {
  val   safe, unsafe = Value
  type InlineObject12SafeEnum = Value
  implicit val format: Format[Value] = Format(Reads.enumNameReads(this), Writes.enumNameWrites[InlineObject12SafeEnum.type])
}
