...
public class FleetApi  {
   private final FleetApiService delegate = FleetApiServiceFactory.getFleetApi();
...
,@ApiParam(value = "" ,required=true) InlineObject2 addressParam
)
    throws NotFoundException {
        return delegate.addFleetAddress(accessToken,addressParam);
    }
    @POST
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 200, message = "Unexpected error.", response = DispatchRoute.class) })
...
,@ApiParam(value = "" ,required=true) DispatchRouteCreate createDispatchRouteParams
    ...
    throws NotFoundException {
        return delegate.createDispatchRoute(accessToken,createDispatchRouteParams);
    }
    @POST
    @Path("/drivers/create")
    @Consumes({ "application/json" })
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 200, message = "Unexpected error.", response = Driver.class) })
...
,@ApiParam(value = "Driver creation body" ,required=true) DriverForCreate createDriverParam
    ...
    throws NotFoundException {
        return delegate.createDriver(accessToken,createDriverParam);
    }
    @POST
...
,@ApiParam(value = "" ,required=true) DispatchRouteCreate createDispatchRouteParams
    ...
    throws NotFoundException {
        return delegate.createDriverDispatchRoute(accessToken,driverId,createDispatchRouteParams);
    }
    @POST
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 200, message = "Unexpected error.", response = Document.class) })
...
,@ApiParam(value = "To create a document for a given document type, the document type's uuid needs to be passed in to documentTypeUuid. The list of fields passed in should match the document type’s list of field types in the correct order. In other words, a field's valueType and value (i.e. only one of: stringValue, numberValue, or photoValue) at index _i_ should match with the document field type’s valueType at index _i_." ,required=true) DocumentCreate createDocumentParams
    ...
    throws NotFoundException {
        return delegate.createDriverDocument(accessToken,driverId,createDocumentParams);
    }
    @POST
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 200, message = "Unexpected error.", response = DvirBase.class) })
...
,@ApiParam(value = "" ,required=true) InlineObject12 createDvirParam
)
    throws NotFoundException {
        return delegate.createDvir(accessToken,createDvirParam);
    }
    @POST
...
,@ApiParam(value = "" ,required=true) DispatchRouteCreate createDispatchRouteParams
    ...
    throws NotFoundException {
        return delegate.createVehicleDispatchRoute(accessToken,vehicleId,createDispatchRouteParams);
    }
    @DELETE
...
,@ApiParam(value = "ID of the driver.  This must be either the numeric ID generated by Samsara or the external ID of the driver.  External IDs are customer specified key-value pairs.",required=true) @PathParam("driver_id_or_external_id") String driverIdOrExternalId
    ...
    throws NotFoundException {
        return delegate.deactivateDriver(accessToken,driverIdOrExternalId);
    }
    @DELETE
...
,@ApiParam(value = "ID of the dispatch route.",required=true) @PathParam("route_id") Long routeId
    ...
    throws NotFoundException {
        return delegate.deleteDispatchRouteById(accessToken,routeId);
    }
    @GET
    @Path("/dispatch/routes")
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 200, message = "Unexpected error.", response = DispatchRoute.class, responseContainer = "List") })
...
,@ApiParam(value = "Time in milliseconds that represents the duration before end_time to query. Defaults to 24 hours.") @QueryParam("duration") Long duration
    ...
    throws NotFoundException {
        return delegate.fetchAllDispatchRoutes(accessToken,groupId,endTime,duration);
    }
    @GET
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 200, message = "Unexpected error.", response = AllRouteJobUpdates.class) })
...
,@ApiParam(value = "Optionally set include=route to include route object in response payload.") @QueryParam("include") String include
    ...
    throws NotFoundException {
        return delegate.fetchAllRouteJobUpdates(accessToken,groupId,sequenceId,include);
    }
    @GET
...
,@ApiParam(value = "Optional group ID if the organization has multiple groups (uncommon).") @QueryParam("group_id") Long groupId
    ...
    throws NotFoundException {
        return delegate.getAllAssetCurrentLocations(accessToken,groupId);
    }
    @GET
    @Path("/assets")
...
,@ApiParam(value = "Optional group ID if the organization has multiple groups (uncommon).") @QueryParam("group_id") Long groupId
    ...
    throws NotFoundException {
        return delegate.getAllAssets(accessToken,groupId);
    }
    @GET
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 200, message = "Unexpected error.", response = Driver.class, responseContainer = "List") })
...
,@ApiParam(value = "Optional group ID if the organization has multiple groups (uncommon).") @QueryParam("group_id") Long groupId
    ...
    throws NotFoundException {
        return delegate.getAllDeactivatedDrivers(accessToken,groupId);
    }
    @GET
...
,@ApiParam(value = "Timestamp in milliseconds representing the end of the period to fetch, inclusive. Used in combination with startMs.",required=true) @QueryParam("endMs") Long endMs
    ...
    throws NotFoundException {
        return delegate.getAssetLocation(accessToken,assetId,startMs,endMs);
    }
    @GET
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 200, message = "Unexpected error.", response = AssetReeferResponse.class) })
...
,@ApiParam(value = "Timestamp in milliseconds representing the end of the period to fetch, inclusive. Used in combination with startMs.",required=true) @QueryParam("endMs") Long endMs
    ...
    throws NotFoundException {
        return delegate.getAssetReefer(accessToken,assetId,startMs,endMs);
    }
    @GET
...
,@ApiParam(value = "ID of the driver.  This must be either the numeric ID generated by Samsara or the external ID of the driver.  External IDs are customer specified key-value pairs.",required=true) @PathParam("driver_id_or_external_id") String driverIdOrExternalId
    ...
    throws NotFoundException {
        return delegate.getDeactivatedDriverById(accessToken,driverIdOrExternalId);
    }
    @GET
    @Path("/dispatch/routes/{route_id}")
...
,@ApiParam(value = "ID of the dispatch route.",required=true) @PathParam("route_id") Long routeId
    ...
    throws NotFoundException {
        return delegate.getDispatchRouteById(accessToken,routeId);
    }
    @GET
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 200, message = "Unexpected error.", response = DispatchRouteHistory.class) })
...
,@ApiParam(value = "Timestamp representing the end of the period to fetch, inclusive. Used in combination with start_time. Defaults to nowMs.") @QueryParam("end_time") Long endTime
    ...
    throws NotFoundException {
        return delegate.getDispatchRouteHistory(accessToken,routeId,startTime,endTime);
    }
    @GET
    @Path("/drivers/{driver_id}/dispatch/routes")
...
,@ApiParam(value = "Time in milliseconds that represents the duration before end_time to query. Defaults to 24 hours.") @QueryParam("duration") Long duration
    ...
    throws NotFoundException {
        return delegate.getDispatchRoutesByDriverId(accessToken,driverId,endTime,duration);
    }
    @GET
    @Path("/vehicles/{vehicle_id}/dispatch/routes")
...
,@ApiParam(value = "Time in milliseconds that represents the duration before end_time to query. Defaults to 24 hours.") @QueryParam("duration") Long duration
    ...
    throws NotFoundException {
        return delegate.getDispatchRoutesByVehicleId(accessToken,vehicleId,endTime,duration);
    }
    @GET
    @Path("/drivers/{driver_id_or_external_id}")
...
,@ApiParam(value = "ID of the driver.  This must be either the numeric ID generated by Samsara or the external ID of the driver.  External IDs are customer specified key-value pairs.",required=true) @PathParam("driver_id_or_external_id") String driverIdOrExternalId
    ...
    throws NotFoundException {
        return delegate.getDriverById(accessToken,driverIdOrExternalId);
    }
    @GET
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 200, message = "Unexpected error.", response = DocumentType.class, responseContainer = "List") })
    public Response getDriverDocumentTypesByOrgId()
    throws NotFoundException {
        return delegate.getDriverDocumentTypesByOrgId();
    }
    @GET
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 200, message = "Unexpected error.", response = Document.class, responseContainer = "List") })
...
,@ApiParam(value = "Time in milliseconds that represents the duration before endMs to query. Defaults to 24 hours.") @QueryParam("durationMs") Long durationMs
    ...
    throws NotFoundException {
        return delegate.getDriverDocumentsByOrgId(accessToken,endMs,durationMs);
    }
    @GET
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 200, message = "Unexpected error.", response = DriverSafetyScoreResponse.class) })
...
,@ApiParam(value = "Timestamp in milliseconds representing the end of the period to fetch, inclusive. Used in combination with startMs.",required=true) @QueryParam("endMs") Long endMs
    ...
    throws NotFoundException {
        return delegate.getDriverSafetyScore(driverId,accessToken,startMs,endMs);
    }
    @GET
    @Path("/maintenance/dvirs")
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 200, message = "Unexpected error.", response = DvirListResponse.class) })
...
,@ApiParam(value = "Group ID to query.") @QueryParam("group_id") Integer groupId
    ...
    throws NotFoundException {
        return delegate.getDvirs(accessToken,endMs,durationMs,groupId);
    }
    @POST
    @Path("/drivers")
    @Consumes({ "application/json" })
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 200, message = "Unexpected error.", response = DriversResponse.class) })
...
,@ApiParam(value = "" ,required=true) InlineObject3 groupDriversParam
)
    throws NotFoundException {
        return delegate.getFleetDrivers(accessToken,groupDriversParam);
    }
    @POST
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 200, message = "Unexpected error.", response = DriverDailyLogResponse.class) })
...
,@ApiParam(value = "" ,required=true) InlineObject6 hosLogsParam
)
    throws NotFoundException {
        return delegate.getFleetDriversHosDailyLogs(accessToken,driverId,hosLogsParam);
    }
    @POST
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 200, message = "Unexpected error.", response = DriversSummaryResponse.class) })
...
,@ApiParam(value = "" ,required=true) InlineObject5 driversSummaryParam
,@ApiParam(value = "Snap query result to HOS day boundaries.") @QueryParam("snap_to_day_bounds") Boolean snapToDayBounds
)
    throws NotFoundException {
        return delegate.getFleetDriversSummary(accessToken,driversSummaryParam,snapToDayBounds);
    }
    @POST
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 200, message = "Unexpected error.", response = HosAuthenticationLogsResponse.class) })
...
,@ApiParam(value = "" ,required=true) InlineObject7 hosAuthenticationLogsParam
)
    throws NotFoundException {
        return delegate.getFleetHosAuthenticationLogs(accessToken,hosAuthenticationLogsParam);
    }
    @POST
    @Path("/hos_logs")
    @Consumes({ "application/json" })
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 200, message = "Unexpected error.", response = HosLogsResponse.class) })
...
,@ApiParam(value = "" ,required=true) InlineObject8 hosLogsParam
)
    throws NotFoundException {
        return delegate.getFleetHosLogs(accessToken,hosLogsParam);
    }
    @POST
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 200, message = "Unexpected error.", response = HosLogsSummaryResponse.class) })
...
,@ApiParam(value = "" ,required=true) InlineObject9 hosLogsParam
)
    throws NotFoundException {
        return delegate.getFleetHosLogsSummary(accessToken,hosLogsParam);
    }
    @POST
    @Path("/locations")
    @Consumes({ "application/json" })
...
,@ApiParam(value = "" ,required=true) InlineObject11 groupParam
)
    throws NotFoundException {
        return delegate.getFleetLocations(accessToken,groupParam);
    }
    @POST
...
,@ApiParam(value = "" ,required=true) InlineObject13 groupParam
)
    throws NotFoundException {
        return delegate.getFleetMaintenanceList(accessToken,groupParam);
    }
    @POST
    @Path("/trips")
    @Consumes({ "application/json" })
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 200, message = "Unexpected error.", response = TripResponse.class) })
...
,@ApiParam(value = "" ,required=true) InlineObject15 tripsParam
)
    throws NotFoundException {
        return delegate.getFleetTrips(accessToken,tripsParam);
    }
    @GET
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 200, message = "Unexpected error.", response = FleetVehicleResponse.class) })
...
,@ApiParam(value = "ID of the vehicle.  This must be either the numeric ID generated by Samsara or the external ID of the vehicle.  External IDs are customer specified key-value pairs.",required=true) @PathParam("vehicle_id_or_external_id") String vehicleIdOrExternalId
    ...
    throws NotFoundException {
        return delegate.getFleetVehicle(accessToken,vehicleIdOrExternalId);
    }
    @GET
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 200, message = "Unexpected error.", response = VehicleHarshEventResponse.class) })
...
,@ApiParam(value = "Timestamp in milliseconds representing the timestamp of a harsh event.",required=true) @QueryParam("timestamp") Long timestamp
    ...
    throws NotFoundException {
        return delegate.getVehicleHarshEvent(vehicleId,accessToken,timestamp);
    }
    @GET
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 200, message = "Unexpected error.", response = FleetVehicleLocation.class, responseContainer = "List") })
...
,@ApiParam(value = "Time in Unix epoch milliseconds for the end of the query (cannot exceed 1 hour)",required=true) @QueryParam("endMs") Long endMs
    ...
    throws NotFoundException {
        return delegate.getVehicleLocations(accessToken,vehicleId,startMs,endMs);
    }
    @GET
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 200, message = "Unexpected error.", response = VehicleSafetyScoreResponse.class) })
...
,@ApiParam(value = "Timestamp in milliseconds representing the end of the period to fetch, inclusive. Used in combination with startMs.",required=true) @QueryParam("endMs") Long endMs
    ...
    throws NotFoundException {
        return delegate.getVehicleSafetyScore(vehicleId,accessToken,startMs,endMs);
    }
    @GET
    @Path("/vehicles/stats")
...
,@ApiParam(value = "Pagination parameter indicating the number of results to return in this request. Used in conjunction with either 'startingAfter' or 'endingBefore'.") @QueryParam("limit") Long limit
    ...
    throws NotFoundException {
        return delegate.getVehicleStats(accessToken,startMs,endMs,series,tagIds,startingAfter,endingBefore,limit);
    }
    @GET
...
,@ApiParam(value = "Time in Unix epoch milliseconds for the end of the query (cannot exceed 30 minutes)",required=true) @QueryParam("endMs") Integer endMs
    ...
    throws NotFoundException {
        return delegate.getVehiclesLocations(accessToken,startMs,endMs);
    }
    @POST
    @Path("/list")
    @Consumes({ "application/json" })
...
,@ApiParam(value = "" ,required=true) InlineObject10 groupParam
,@ApiParam(value = "Pagination parameter indicating the cursor position to continue returning results after. Used in conjunction with the 'limit' parameter. Mutually exclusive with 'endingBefore' parameter.") @QueryParam("startingAfter") String startingAfter
,@ApiParam(value = "Pagination parameter indicating the cursor position to return results before. Used in conjunction with the 'limit' parameter. Mutually exclusive with 'startingAfter' parameter.") @QueryParam("endingBefore") String endingBefore
,@ApiParam(value = "Pagination parameter indicating the number of results to return in this request. Used in conjunction with either 'startingAfter' or 'endingBefore'.") @QueryParam("limit") Long limit
)
    throws NotFoundException {
        return delegate.listFleet(accessToken,groupParam,startingAfter,endingBefore,limit);
    }
    @PATCH
    @Path("/vehicles/{vehicle_id_or_external_id}")
...
,@ApiParam(value = "ID of the vehicle.  This must be either the numeric ID generated by Samsara or the external ID of the vehicle.  External IDs are customer specified key-value pairs.",required=true) @PathParam("vehicle_id_or_external_id") String vehicleIdOrExternalId
,@ApiParam(value = "" ,required=true) InlineObject16 data
)
    throws NotFoundException {
        return delegate.patchFleetVehicle(accessToken,vehicleIdOrExternalId,data);
    }
    @PUT
    @Path("/drivers/inactive/{driver_id_or_external_id}")
    @Consumes({ "application/json" })
...
,@ApiParam(value = "ID of the driver.  This must be either the numeric ID generated by Samsara or the external ID of the driver.  External IDs are customer specified key-value pairs.",required=true) @PathParam("driver_id_or_external_id") String driverIdOrExternalId
,@ApiParam(value = "" ,required=true) InlineObject4 reactivateDriverParam
)
    throws NotFoundException {
        return delegate.reactivateDriverById(accessToken,driverIdOrExternalId,reactivateDriverParam);
    }
    @PUT
    @Path("/dispatch/routes/{route_id}")
    @Consumes({ "application/json" })
...
,@ApiParam(value = "" ,required=true) DispatchRoute updateDispatchRouteParams
    ...
    throws NotFoundException {
        return delegate.updateDispatchRouteById(accessToken,routeId,updateDispatchRouteParams);
    }
    @POST
    @Path("/set_data")
    @Consumes({ "application/json" })
...
,@ApiParam(value = "" ,required=true) InlineObject14 vehicleUpdateParam
)
    throws NotFoundException {
        return delegate.updateVehicles(accessToken,vehicleUpdateParam);
    }
}
