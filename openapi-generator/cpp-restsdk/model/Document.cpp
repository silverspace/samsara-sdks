...
web::json::value Document::toJson() const
{
    ...
    val[utility::conversions::to_string_t("documentType")] = ModelBase::toJson(m_DocumentType);
    val[utility::conversions::to_string_t("driverCreatedAtMs")] = ModelBase::toJson(m_DriverCreatedAtMs);
...
void Document::fromJson(const web::json::value& val)
{
    ...
    setDocumentType(ModelBase::stringFromJson(val.at(utility::conversions::to_string_t("documentType"))));
    setDriverCreatedAtMs(ModelBase::int64_tFromJson(val.at(utility::conversions::to_string_t("driverCreatedAtMs"))));
    setDriverId(ModelBase::int64_tFromJson(val.at(utility::conversions::to_string_t("driverId"))));
    {
        m_Fields.clear();
        std::vector<web::json::value> jsonArray;
...
void Document::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t("documentType"), m_DocumentType));
    multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t("driverCreatedAtMs"), m_DriverCreatedAtMs));
...
void Document::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    setDocumentType(ModelBase::stringFromHttpContent(multipart->getContent(utility::conversions::to_string_t("documentType"))));
    setDriverCreatedAtMs(ModelBase::int64_tFromHttpContent(multipart->getContent(utility::conversions::to_string_t("driverCreatedAtMs"))));
...
void Document::setDispatchJobId(int64_t value)
{
...
utility::string_t Document::getNotes() const
{
    return m_Notes;
}

void Document::setNotes(const utility::string_t& value)
{
    m_Notes = value;
    m_NotesIsSet = true;
}
...
utility::string_t Document::getDocumentType() const
{
    return m_DocumentType;
}

void Document::setDocumentType(const utility::string_t& value)
{
...
void Document::setDriverCreatedAtMs(int64_t value)
{
...
void Document::setDriverId(int64_t value)
{
    m_DriverId = value;
    
}

std::vector<std::shared_ptr<DocumentField>>& Document::getFields()
{
    return m_Fields;
}

void Document::setFields(const std::vector<std::shared_ptr<DocumentField>>& value)
{
    m_Fields = value;
...
void Document::setVehicleId(int64_t value)
{
    m_VehicleId = value;
