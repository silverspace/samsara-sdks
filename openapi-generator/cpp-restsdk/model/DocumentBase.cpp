...
void DocumentBase::validate()
{
    // TODO: implement validation
}

web::json::value DocumentBase::toJson() const
{
...
void DocumentBase::fromJson(const web::json::value& val)
{
...
void DocumentBase::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void DocumentBase::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
int64_t DocumentBase::getDispatchJobId() const
{
    return m_DispatchJobId;
}

void DocumentBase::setDispatchJobId(int64_t value)
{
    m_DispatchJobId = value;
    m_DispatchJobIdIsSet = true;
}

bool DocumentBase::dispatchJobIdIsSet() const
{
    return m_DispatchJobIdIsSet;
}

void DocumentBase::unsetDispatchJobId()
{
    m_DispatchJobIdIsSet = false;
}

utility::string_t DocumentBase::getNotes() const
{
    return m_Notes;
}

void DocumentBase::setNotes(const utility::string_t& value)
{
    m_Notes = value;
    m_NotesIsSet = true;
}

bool DocumentBase::notesIsSet() const
{
    return m_NotesIsSet;
}

void DocumentBase::unsetNotes()
{
    m_NotesIsSet = false;
}
