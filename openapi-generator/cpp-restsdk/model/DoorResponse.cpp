...
void DoorResponse::validate()
{
    // TODO: implement validation
}

web::json::value DoorResponse::toJson() const
{
...
void DoorResponse::fromJson(const web::json::value& val)
{
    ...
    }
    {
        ...
        for( auto& item : val.at(utility::conversions::to_string_t("sensors")).as_array() )
        {
            if(item.is_null())
            {
                m_Sensors.push_back( std::shared_ptr<DoorResponse_sensors>(nullptr) );
            }
            else
            {
                std::shared_ptr<DoorResponse_sensors> newItem(new DoorResponse_sensors());
...
void DoorResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void DoorResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
int64_t DoorResponse::getGroupId() const
{
    return m_GroupId;
}

void DoorResponse::setGroupId(int64_t value)
{
    m_GroupId = value;
    m_GroupIdIsSet = true;
}

bool DoorResponse::groupIdIsSet() const
{
    return m_GroupIdIsSet;
}

void DoorResponse::unsetGroupId()
{
    m_GroupIdIsSet = false;
}

std::vector<std::shared_ptr<DoorResponse_sensors>>& DoorResponse::getSensors()
{
    return m_Sensors;
}

void DoorResponse::setSensors(const std::vector<std::shared_ptr<DoorResponse_sensors>>& value)
{
    m_Sensors = value;
    m_SensorsIsSet = true;
}

bool DoorResponse::sensorsIsSet() const
{
    return m_SensorsIsSet;
}

void DoorResponse::unsetSensors()
{
    m_SensorsIsSet = false;
}
