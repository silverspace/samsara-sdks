...
void Inline_response_200_4::fromJson(const web::json::value& val)
{
    {
        m_Vehicles.clear();
        std::vector<web::json::value> jsonArray;
        ...
        for( auto& item : val.at(utility::conversions::to_string_t("vehicles")).as_array() )
        {
            if(item.is_null())
            {
                m_Vehicles.push_back( std::shared_ptr<VehicleMaintenance>(nullptr) );
            }
            else
            {
                std::shared_ptr<VehicleMaintenance> newItem(new VehicleMaintenance());
...
std::vector<std::shared_ptr<VehicleMaintenance>>& Inline_response_200_4::getVehicles()
{
    return m_Vehicles;
}

void Inline_response_200_4::setVehicles(const std::vector<std::shared_ptr<VehicleMaintenance>>& value)
{
    m_Vehicles = value;
    m_VehiclesIsSet = true;
}

bool Inline_response_200_4::vehiclesIsSet() const
{
    return m_VehiclesIsSet;
}

void Inline_response_200_4::unsetVehicles()
{
    m_VehiclesIsSet = false;
}
