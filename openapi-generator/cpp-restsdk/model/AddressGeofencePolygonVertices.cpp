...
void AddressGeofence_polygon_vertices::validate()
{
    // TODO: implement validation
}

web::json::value AddressGeofence_polygon_vertices::toJson() const
{
...
void AddressGeofence_polygon_vertices::fromJson(const web::json::value& val)
{
...
void AddressGeofence_polygon_vertices::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void AddressGeofence_polygon_vertices::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
double AddressGeofence_polygon_vertices::getLatitude() const
{
    return m_Latitude;
}

void AddressGeofence_polygon_vertices::setLatitude(double value)
{
    m_Latitude = value;
    m_LatitudeIsSet = true;
}

bool AddressGeofence_polygon_vertices::latitudeIsSet() const
{
    return m_LatitudeIsSet;
}

void AddressGeofence_polygon_vertices::unsetLatitude()
{
    m_LatitudeIsSet = false;
}

double AddressGeofence_polygon_vertices::getLongitude() const
{
    return m_Longitude;
}

void AddressGeofence_polygon_vertices::setLongitude(double value)
{
    m_Longitude = value;
    m_LongitudeIsSet = true;
}

bool AddressGeofence_polygon_vertices::longitudeIsSet() const
{
    return m_LongitudeIsSet;
}

void AddressGeofence_polygon_vertices::unsetLongitude()
{
    m_LongitudeIsSet = false;
}
