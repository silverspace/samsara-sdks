...
web::json::value TripResponse_endCoordinates::toJson() const
{
...
void TripResponse_endCoordinates::fromJson(const web::json::value& val)
{
...
void TripResponse_endCoordinates::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void TripResponse_endCoordinates::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
void TripResponse_endCoordinates::setLatitude(double value)
{
    m_Latitude = value;
...
void TripResponse_endCoordinates::setLongitude(double value)
{
    m_Longitude = value;
