...
web::json::value DriverForCreate::toJson() const
{
...
void DriverForCreate::fromJson(const web::json::value& val)
{
...
void DriverForCreate::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void DriverForCreate::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
void DriverForCreate::setEldAdverseWeatherExemptionEnabled(bool value)
{
...
void DriverForCreate::setEldBigDayExemptionEnabled(bool value)
{
...
void DriverForCreate::setEldDayStartHour(int32_t value)
{
...
void DriverForCreate::setEldExempt(bool value)
{
    m_EldExempt = value;
...
utility::string_t DriverForCreate::getEldExemptReason() const
{
    return m_EldExemptReason;
}

void DriverForCreate::setEldExemptReason(const utility::string_t& value)
{
...
void DriverForCreate::setEldPcEnabled(bool value)
{
...
void DriverForCreate::setEldYmEnabled(bool value)
{
...
std::map<utility::string_t, utility::string_t>& DriverForCreate::getExternalIds()
{
    return m_ExternalIds;
}

void DriverForCreate::setExternalIds(const std::map<utility::string_t, utility::string_t>& value)
{
    m_ExternalIds = value;
...
void DriverForCreate::setGroupId(int64_t value)
{
    m_GroupId = value;
    m_GroupIdIsSet = true;
}
...
utility::string_t DriverForCreate::getLicenseNumber() const
{
    return m_LicenseNumber;
}

void DriverForCreate::setLicenseNumber(const utility::string_t& value)
{
...
utility::string_t DriverForCreate::getLicenseState() const
{
    return m_LicenseState;
}

void DriverForCreate::setLicenseState(const utility::string_t& value)
{
...
utility::string_t DriverForCreate::getName() const
{
    return m_Name;
}

void DriverForCreate::setName(const utility::string_t& value)
{
    m_Name = value;
    
}

utility::string_t DriverForCreate::getNotes() const
{
    return m_Notes;
}

void DriverForCreate::setNotes(const utility::string_t& value)
{
    m_Notes = value;
    m_NotesIsSet = true;
}
...
utility::string_t DriverForCreate::getPhone() const
{
    return m_Phone;
}

void DriverForCreate::setPhone(const utility::string_t& value)
{
    m_Phone = value;
    m_PhoneIsSet = true;
}
...
utility::string_t DriverForCreate::getUsername() const
{
    return m_Username;
}

void DriverForCreate::setUsername(const utility::string_t& value)
{
    m_Username = value;
...
void DriverForCreate::setVehicleId(int64_t value)
{
    m_VehicleId = value;
...
utility::string_t DriverForCreate::getPassword() const
{
    return m_Password;
}

void DriverForCreate::setPassword(const utility::string_t& value)
{
    m_Password = value;
...
void DriverForCreate::setTagIds(std::vector<int64_t> value)
{
    m_TagIds = value;
    m_TagIdsIsSet = true;
}
