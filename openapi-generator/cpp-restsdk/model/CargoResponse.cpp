...
void CargoResponse::validate()
{
    // TODO: implement validation
}

web::json::value CargoResponse::toJson() const
{
...
void CargoResponse::fromJson(const web::json::value& val)
{
    ...
    }
    {
        ...
        for( auto& item : val.at(utility::conversions::to_string_t("sensors")).as_array() )
        {
            if(item.is_null())
            {
                m_Sensors.push_back( std::shared_ptr<CargoResponse_sensors>(nullptr) );
            }
            else
            {
                std::shared_ptr<CargoResponse_sensors> newItem(new CargoResponse_sensors());
...
void CargoResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void CargoResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
int64_t CargoResponse::getGroupId() const
{
    return m_GroupId;
}

void CargoResponse::setGroupId(int64_t value)
{
    m_GroupId = value;
    m_GroupIdIsSet = true;
}

bool CargoResponse::groupIdIsSet() const
{
    return m_GroupIdIsSet;
}

void CargoResponse::unsetGroupId()
{
    m_GroupIdIsSet = false;
}

std::vector<std::shared_ptr<CargoResponse_sensors>>& CargoResponse::getSensors()
{
    return m_Sensors;
}

void CargoResponse::setSensors(const std::vector<std::shared_ptr<CargoResponse_sensors>>& value)
{
    m_Sensors = value;
    m_SensorsIsSet = true;
}

bool CargoResponse::sensorsIsSet() const
{
    return m_SensorsIsSet;
}

void CargoResponse::unsetSensors()
{
    m_SensorsIsSet = false;
}
