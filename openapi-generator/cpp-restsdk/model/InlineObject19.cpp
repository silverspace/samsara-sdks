...
Inline_object_19::Inline_object_19()
{
    m_GroupId = 0L;
}
...
void Inline_object_19::validate()
{
    // TODO: implement validation
}

web::json::value Inline_object_19::toJson() const
{
...
void Inline_object_19::fromJson(const web::json::value& val)
{
...
void Inline_object_19::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void Inline_object_19::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
int64_t Inline_object_19::getGroupId() const
{
    return m_GroupId;
}

void Inline_object_19::setGroupId(int64_t value)
{
    m_GroupId = value;
    
}

std::vector<int64_t>& Inline_object_19::getSensors()
{
    return m_Sensors;
}

void Inline_object_19::setSensors(std::vector<int64_t> value)
{
    m_Sensors = value;
