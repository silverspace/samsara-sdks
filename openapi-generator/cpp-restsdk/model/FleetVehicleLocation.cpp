...
web::json::value FleetVehicleLocation::toJson() const
{
...
void FleetVehicleLocation::fromJson(const web::json::value& val)
{
...
void FleetVehicleLocation::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void FleetVehicleLocation::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
void FleetVehicleLocation::setLatitude(double value)
{
    m_Latitude = value;
...
utility::string_t FleetVehicleLocation::getLocation() const
{
    return m_Location;
}

void FleetVehicleLocation::setLocation(const utility::string_t& value)
{
    m_Location = value;
...
void FleetVehicleLocation::setLongitude(double value)
{
    m_Longitude = value;
...
void FleetVehicleLocation::setSpeedMilesPerHour(double value)
{
...
void FleetVehicleLocation::setTimeMs(int64_t value)
{
    m_TimeMs = value;
    m_TimeMsIsSet = true;
}
