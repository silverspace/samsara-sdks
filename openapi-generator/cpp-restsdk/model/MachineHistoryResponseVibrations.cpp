...
void MachineHistoryResponse_vibrations::validate()
{
    // TODO: implement validation
}

web::json::value MachineHistoryResponse_vibrations::toJson() const
{
...
void MachineHistoryResponse_vibrations::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("time")))
    {
        ...
        if(!fieldValue.is_null())
        {
            setTime(ModelBase::int64_tFromJson(fieldValue));
        }
    }
}

void MachineHistoryResponse_vibrations::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void MachineHistoryResponse_vibrations::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
    ...
    {
        setTime(ModelBase::int64_tFromHttpContent(multipart->getContent(utility::conversions::to_string_t("time"))));
    }
}

double MachineHistoryResponse_vibrations::getX() const
{
    return m_X;
}

void MachineHistoryResponse_vibrations::setX(double value)
{
    m_X = value;
    m_XIsSet = true;
}

bool MachineHistoryResponse_vibrations::XIsSet() const
{
    return m_XIsSet;
}

void MachineHistoryResponse_vibrations::unsetX()
{
    m_XIsSet = false;
}

double MachineHistoryResponse_vibrations::getY() const
{
    return m_Y;
}

void MachineHistoryResponse_vibrations::setY(double value)
{
    m_Y = value;
    m_YIsSet = true;
}

bool MachineHistoryResponse_vibrations::YIsSet() const
{
    return m_YIsSet;
}

void MachineHistoryResponse_vibrations::unsetY()
{
    m_YIsSet = false;
}

double MachineHistoryResponse_vibrations::getZ() const
{
    return m_Z;
}

void MachineHistoryResponse_vibrations::setZ(double value)
{
    m_Z = value;
    m_ZIsSet = true;
}

bool MachineHistoryResponse_vibrations::ZIsSet() const
{
    return m_ZIsSet;
}

void MachineHistoryResponse_vibrations::unsetZ()
{
    m_ZIsSet = false;
}

int64_t MachineHistoryResponse_vibrations::getTime() const
{
    return m_Time;
}

void MachineHistoryResponse_vibrations::setTime(int64_t value)
{
    m_Time = value;
    m_TimeIsSet = true;
}

bool MachineHistoryResponse_vibrations::timeIsSet() const
{
    return m_TimeIsSet;
}

void MachineHistoryResponse_vibrations::unsetTime()
{
    m_TimeIsSet = false;
}
