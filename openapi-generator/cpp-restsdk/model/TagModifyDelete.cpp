...
TagModify_delete::TagModify_delete()
{
    m_AssetsIsSet = false;
...
void TagModify_delete::validate()
{
    // TODO: implement validation
}

web::json::value TagModify_delete::toJson() const
{
...
void TagModify_delete::fromJson(const web::json::value& val)
{
    {
        m_Assets.clear();
        std::vector<web::json::value> jsonArray;
...
void TagModify_delete::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void TagModify_delete::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
std::vector<std::shared_ptr<TaggedAssetBase>>& TagModify_delete::getAssets()
{
    return m_Assets;
}

void TagModify_delete::setAssets(const std::vector<std::shared_ptr<TaggedAssetBase>>& value)
{
    m_Assets = value;
    m_AssetsIsSet = true;
}

bool TagModify_delete::assetsIsSet() const
{
    return m_AssetsIsSet;
}

void TagModify_delete::unsetAssets()
{
    m_AssetsIsSet = false;
}

std::vector<std::shared_ptr<TaggedSensorBase>>& TagModify_delete::getSensors()
{
    return m_Sensors;
}

void TagModify_delete::setSensors(const std::vector<std::shared_ptr<TaggedSensorBase>>& value)
{
    m_Sensors = value;
    m_SensorsIsSet = true;
}

bool TagModify_delete::sensorsIsSet() const
{
    return m_SensorsIsSet;
}

void TagModify_delete::unsetSensors()
{
    m_SensorsIsSet = false;
}

std::vector<std::shared_ptr<TaggedVehicleBase>>& TagModify_delete::getVehicles()
{
    return m_Vehicles;
}

void TagModify_delete::setVehicles(const std::vector<std::shared_ptr<TaggedVehicleBase>>& value)
{
    m_Vehicles = value;
    m_VehiclesIsSet = true;
}

bool TagModify_delete::vehiclesIsSet() const
{
    return m_VehiclesIsSet;
}

void TagModify_delete::unsetVehicles()
{
    m_VehiclesIsSet = false;
}

std::vector<std::shared_ptr<TaggedMachineBase>>& TagModify_delete::getMachines()
{
    return m_Machines;
}

void TagModify_delete::setMachines(const std::vector<std::shared_ptr<TaggedMachineBase>>& value)
{
    m_Machines = value;
    m_MachinesIsSet = true;
}

bool TagModify_delete::machinesIsSet() const
{
    return m_MachinesIsSet;
}

void TagModify_delete::unsetMachines()
{
    m_MachinesIsSet = false;
}

std::vector<std::shared_ptr<TaggedDriverBase>>& TagModify_delete::getDrivers()
{
    return m_Drivers;
}

void TagModify_delete::setDrivers(const std::vector<std::shared_ptr<TaggedDriverBase>>& value)
{
    m_Drivers = value;
    m_DriversIsSet = true;
}

bool TagModify_delete::driversIsSet() const
{
    return m_DriversIsSet;
}

void TagModify_delete::unsetDrivers()
{
    m_DriversIsSet = false;
}
