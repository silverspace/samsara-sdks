...
void TemperatureResponse::validate()
{
    // TODO: implement validation
}

web::json::value TemperatureResponse::toJson() const
{
...
void TemperatureResponse::fromJson(const web::json::value& val)
{
    ...
    }
    {
        ...
        for( auto& item : val.at(utility::conversions::to_string_t("sensors")).as_array() )
        {
            if(item.is_null())
            {
                m_Sensors.push_back( std::shared_ptr<TemperatureResponse_sensors>(nullptr) );
            }
            else
            {
                std::shared_ptr<TemperatureResponse_sensors> newItem(new TemperatureResponse_sensors());
...
void TemperatureResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void TemperatureResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
int64_t TemperatureResponse::getGroupId() const
{
    return m_GroupId;
}

void TemperatureResponse::setGroupId(int64_t value)
{
    m_GroupId = value;
    m_GroupIdIsSet = true;
}

bool TemperatureResponse::groupIdIsSet() const
{
    return m_GroupIdIsSet;
}

void TemperatureResponse::unsetGroupId()
{
    m_GroupIdIsSet = false;
}

std::vector<std::shared_ptr<TemperatureResponse_sensors>>& TemperatureResponse::getSensors()
{
    return m_Sensors;
}

void TemperatureResponse::setSensors(const std::vector<std::shared_ptr<TemperatureResponse_sensors>>& value)
{
    m_Sensors = value;
    m_SensorsIsSet = true;
}

bool TemperatureResponse::sensorsIsSet() const
{
    return m_SensorsIsSet;
}

void TemperatureResponse::unsetSensors()
{
    m_SensorsIsSet = false;
}
