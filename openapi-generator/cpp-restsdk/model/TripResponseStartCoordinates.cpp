...
void TripResponse_startCoordinates::validate()
{
    // TODO: implement validation
}

web::json::value TripResponse_startCoordinates::toJson() const
{
...
void TripResponse_startCoordinates::fromJson(const web::json::value& val)
{
...
void TripResponse_startCoordinates::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void TripResponse_startCoordinates::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
double TripResponse_startCoordinates::getLatitude() const
{
    return m_Latitude;
}

void TripResponse_startCoordinates::setLatitude(double value)
{
    m_Latitude = value;
    m_LatitudeIsSet = true;
}

bool TripResponse_startCoordinates::latitudeIsSet() const
{
    return m_LatitudeIsSet;
}

void TripResponse_startCoordinates::unsetLatitude()
{
    m_LatitudeIsSet = false;
}

double TripResponse_startCoordinates::getLongitude() const
{
    return m_Longitude;
}

void TripResponse_startCoordinates::setLongitude(double value)
{
    m_Longitude = value;
    m_LongitudeIsSet = true;
}

bool TripResponse_startCoordinates::longitudeIsSet() const
{
    return m_LongitudeIsSet;
}

void TripResponse_startCoordinates::unsetLongitude()
{
    m_LongitudeIsSet = false;
}
