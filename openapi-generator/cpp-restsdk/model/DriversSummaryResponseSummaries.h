...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_DriversSummaryResponse_Summaries_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_DriversSummaryResponse_Summaries_H_
...
/// 
/// </summary>
class  DriversSummaryResponse_Summaries
    : public ModelBase
{
public:
    ...
    /////////////////////////////////////////////
    /// DriversSummaryResponse_Summaries members
    ...
    /// </summary>
    int64_t getDriveMs() const;
    bool driveMsIsSet() const;
    void unsetDriveMs();

    void setDriveMs(int64_t value);
    ...
    /// </summary>
    utility::string_t getDriverUsername() const;
    bool driverUsernameIsSet() const;
    void unsetDriverUsername();

    void setDriverUsername(const utility::string_t& value);
    ...
    /// </summary>
    int64_t getOnDutyMs() const;
    bool onDutyMsIsSet() const;
    void unsetOnDutyMs();

    void setOnDutyMs(int64_t value);
...
protected:
    ...
    utility::string_t m_DriverUsername;
    bool m_DriverUsernameIsSet;
    int64_t m_GroupId;
    bool m_GroupIdIsSet;
    utility::string_t m_DriverName;
    bool m_DriverNameIsSet;
    int64_t m_OnDutyMs;
    bool m_OnDutyMsIsSet;
};
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_DriversSummaryResponse_Summaries_H_ */
