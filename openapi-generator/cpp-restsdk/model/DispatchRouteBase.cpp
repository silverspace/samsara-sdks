...
void DispatchRouteBase::validate()
{
    // TODO: implement validation
}

web::json::value DispatchRouteBase::toJson() const
{
...
void DispatchRouteBase::fromJson(const web::json::value& val)
{
...
void DispatchRouteBase::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void DispatchRouteBase::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
int64_t DispatchRouteBase::getActualEndMs() const
{
    return m_Actual_end_ms;
}

void DispatchRouteBase::setActualEndMs(int64_t value)
{
    m_Actual_end_ms = value;
    m_Actual_end_msIsSet = true;
}

bool DispatchRouteBase::actualEndMsIsSet() const
{
    return m_Actual_end_msIsSet;
}

void DispatchRouteBase::unsetActual_end_ms()
{
    m_Actual_end_msIsSet = false;
}

int64_t DispatchRouteBase::getActualStartMs() const
{
    return m_Actual_start_ms;
}

void DispatchRouteBase::setActualStartMs(int64_t value)
{
    m_Actual_start_ms = value;
    m_Actual_start_msIsSet = true;
}

bool DispatchRouteBase::actualStartMsIsSet() const
{
    return m_Actual_start_msIsSet;
}

void DispatchRouteBase::unsetActual_start_ms()
{
    m_Actual_start_msIsSet = false;
}

int64_t DispatchRouteBase::getDriverId() const
{
    return m_Driver_id;
}

void DispatchRouteBase::setDriverId(int64_t value)
{
    m_Driver_id = value;
    m_Driver_idIsSet = true;
}

bool DispatchRouteBase::driverIdIsSet() const
{
    return m_Driver_idIsSet;
}

void DispatchRouteBase::unsetDriver_id()
{
    m_Driver_idIsSet = false;
}

int64_t DispatchRouteBase::getGroupId() const
{
    return m_Group_id;
}

void DispatchRouteBase::setGroupId(int64_t value)
{
    m_Group_id = value;
    m_Group_idIsSet = true;
}

bool DispatchRouteBase::groupIdIsSet() const
{
    return m_Group_idIsSet;
}

void DispatchRouteBase::unsetGroup_id()
{
    m_Group_idIsSet = false;
}

utility::string_t DispatchRouteBase::getName() const
{
    return m_Name;
}

void DispatchRouteBase::setName(const utility::string_t& value)
{
    m_Name = value;
    
}

int64_t DispatchRouteBase::getScheduledEndMs() const
{
    return m_Scheduled_end_ms;
}

void DispatchRouteBase::setScheduledEndMs(int64_t value)
{
    m_Scheduled_end_ms = value;
    
}

int64_t DispatchRouteBase::getScheduledMeters() const
{
    return m_Scheduled_meters;
}

void DispatchRouteBase::setScheduledMeters(int64_t value)
{
    m_Scheduled_meters = value;
    m_Scheduled_metersIsSet = true;
}

bool DispatchRouteBase::scheduledMetersIsSet() const
{
    return m_Scheduled_metersIsSet;
}

void DispatchRouteBase::unsetScheduled_meters()
{
    m_Scheduled_metersIsSet = false;
}

int64_t DispatchRouteBase::getScheduledStartMs() const
{
    return m_Scheduled_start_ms;
}

void DispatchRouteBase::setScheduledStartMs(int64_t value)
{
    m_Scheduled_start_ms = value;
    
}

utility::string_t DispatchRouteBase::getStartLocationAddress() const
{
    return m_Start_location_address;
}

void DispatchRouteBase::setStartLocationAddress(const utility::string_t& value)
{
    m_Start_location_address = value;
    m_Start_location_addressIsSet = true;
}

bool DispatchRouteBase::startLocationAddressIsSet() const
{
    return m_Start_location_addressIsSet;
}

void DispatchRouteBase::unsetStart_location_address()
{
    m_Start_location_addressIsSet = false;
}

int64_t DispatchRouteBase::getStartLocationAddressId() const
{
    return m_Start_location_address_id;
}

void DispatchRouteBase::setStartLocationAddressId(int64_t value)
{
    m_Start_location_address_id = value;
    m_Start_location_address_idIsSet = true;
}

bool DispatchRouteBase::startLocationAddressIdIsSet() const
{
    return m_Start_location_address_idIsSet;
}

void DispatchRouteBase::unsetStart_location_address_id()
{
    m_Start_location_address_idIsSet = false;
}

double DispatchRouteBase::getStartLocationLat() const
{
    return m_Start_location_lat;
}

void DispatchRouteBase::setStartLocationLat(double value)
{
    m_Start_location_lat = value;
    m_Start_location_latIsSet = true;
}

bool DispatchRouteBase::startLocationLatIsSet() const
{
    return m_Start_location_latIsSet;
}

void DispatchRouteBase::unsetStart_location_lat()
{
    m_Start_location_latIsSet = false;
}

double DispatchRouteBase::getStartLocationLng() const
{
    return m_Start_location_lng;
}

void DispatchRouteBase::setStartLocationLng(double value)
{
    m_Start_location_lng = value;
    m_Start_location_lngIsSet = true;
}

bool DispatchRouteBase::startLocationLngIsSet() const
{
    return m_Start_location_lngIsSet;
}

void DispatchRouteBase::unsetStart_location_lng()
{
    m_Start_location_lngIsSet = false;
}

utility::string_t DispatchRouteBase::getStartLocationName() const
{
    return m_Start_location_name;
}

void DispatchRouteBase::setStartLocationName(const utility::string_t& value)
{
    m_Start_location_name = value;
    m_Start_location_nameIsSet = true;
}

bool DispatchRouteBase::startLocationNameIsSet() const
{
    return m_Start_location_nameIsSet;
}

void DispatchRouteBase::unsetStart_location_name()
{
    m_Start_location_nameIsSet = false;
}

int64_t DispatchRouteBase::getTrailerId() const
{
    return m_Trailer_id;
}

void DispatchRouteBase::setTrailerId(int64_t value)
{
    m_Trailer_id = value;
    m_Trailer_idIsSet = true;
}

bool DispatchRouteBase::trailerIdIsSet() const
{
    return m_Trailer_idIsSet;
}

void DispatchRouteBase::unsetTrailer_id()
{
    m_Trailer_idIsSet = false;
}

int64_t DispatchRouteBase::getVehicleId() const
{
    return m_Vehicle_id;
}

void DispatchRouteBase::setVehicleId(int64_t value)
{
    m_Vehicle_id = value;
    m_Vehicle_idIsSet = true;
}

bool DispatchRouteBase::vehicleIdIsSet() const
{
    return m_Vehicle_idIsSet;
}

void DispatchRouteBase::unsetVehicle_id()
{
    m_Vehicle_idIsSet = false;
}
