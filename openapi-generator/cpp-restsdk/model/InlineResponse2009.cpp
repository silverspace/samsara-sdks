...
web::json::value Inline_response_200_9::toJson() const
{
...
void Inline_response_200_9::fromJson(const web::json::value& val)
{
    {
        m_Tags.clear();
        std::vector<web::json::value> jsonArray;
...
void Inline_response_200_9::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void Inline_response_200_9::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
std::vector<std::shared_ptr<Tag>>& Inline_response_200_9::getTags()
{
    return m_Tags;
}

void Inline_response_200_9::setTags(const std::vector<std::shared_ptr<Tag>>& value)
{
    m_Tags = value;
    m_TagsIsSet = true;
}

bool Inline_response_200_9::tagsIsSet() const
{
    return m_TagsIsSet;
}

void Inline_response_200_9::unsetTags()
{
    m_TagsIsSet = false;
}
