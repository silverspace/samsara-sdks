...
void Inline_object_22::validate()
{
    // TODO: implement validation
}

web::json::value Inline_object_22::toJson() const
{
...
void Inline_object_22::fromJson(const web::json::value& val)
{
...
void Inline_object_22::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void Inline_object_22::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
int64_t Inline_object_22::getGroupId() const
{
    return m_GroupId;
}

void Inline_object_22::setGroupId(int64_t value)
{
    m_GroupId = value;
    
}

std::vector<int64_t>& Inline_object_22::getSensors()
{
    return m_Sensors;
}

void Inline_object_22::setSensors(std::vector<int64_t> value)
{
    m_Sensors = value;
