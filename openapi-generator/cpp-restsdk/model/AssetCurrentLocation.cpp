...
void AssetCurrentLocation::validate()
{
    // TODO: implement validation
}

web::json::value AssetCurrentLocation::toJson() const
{
    ...
    {
        val[utility::conversions::to_string_t("speedMilesPerHour")] = ModelBase::toJson(m_SpeedMilesPerHour);
    }
    if(m_TimeMsIsSet)
    {
...
void AssetCurrentLocation::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("speedMilesPerHour")))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t("speedMilesPerHour"));
        if(!fieldValue.is_null())
        {
            setSpeedMilesPerHour(ModelBase::doubleFromJson(fieldValue));
        }
    }
...
void AssetCurrentLocation::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_SpeedMilesPerHourIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t("speedMilesPerHour"), m_SpeedMilesPerHour));
    }
    if(m_TimeMsIsSet)
    {
...
void AssetCurrentLocation::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
    ...
    if(multipart->hasContent(utility::conversions::to_string_t("speedMilesPerHour")))
    {
        setSpeedMilesPerHour(ModelBase::doubleFromHttpContent(multipart->getContent(utility::conversions::to_string_t("speedMilesPerHour"))));
    }
...
double AssetCurrentLocation::getLatitude() const
{
    return m_Latitude;
}

void AssetCurrentLocation::setLatitude(double value)
{
    m_Latitude = value;
    m_LatitudeIsSet = true;
}

bool AssetCurrentLocation::latitudeIsSet() const
{
    return m_LatitudeIsSet;
}

void AssetCurrentLocation::unsetLatitude()
{
    m_LatitudeIsSet = false;
}

utility::string_t AssetCurrentLocation::getLocation() const
{
    return m_Location;
}

void AssetCurrentLocation::setLocation(const utility::string_t& value)
{
    m_Location = value;
    m_LocationIsSet = true;
}

bool AssetCurrentLocation::locationIsSet() const
{
    return m_LocationIsSet;
}

void AssetCurrentLocation::unsetLocation()
{
    m_LocationIsSet = false;
}

double AssetCurrentLocation::getLongitude() const
{
    return m_Longitude;
}

void AssetCurrentLocation::setLongitude(double value)
{
    m_Longitude = value;
    m_LongitudeIsSet = true;
}

bool AssetCurrentLocation::longitudeIsSet() const
{
    return m_LongitudeIsSet;
}

void AssetCurrentLocation::unsetLongitude()
{
    m_LongitudeIsSet = false;
}

double AssetCurrentLocation::getSpeedMilesPerHour() const
{
    return m_SpeedMilesPerHour;
}

void AssetCurrentLocation::setSpeedMilesPerHour(double value)
{
    m_SpeedMilesPerHour = value;
    m_SpeedMilesPerHourIsSet = true;
}

bool AssetCurrentLocation::speedMilesPerHourIsSet() const
{
    return m_SpeedMilesPerHourIsSet;
}

void AssetCurrentLocation::unsetSpeedMilesPerHour()
{
    m_SpeedMilesPerHourIsSet = false;
}

int64_t AssetCurrentLocation::getTimeMs() const
{
    return m_TimeMs;
}

void AssetCurrentLocation::setTimeMs(int64_t value)
{
    m_TimeMs = value;
    m_TimeMsIsSet = true;
}

bool AssetCurrentLocation::timeMsIsSet() const
{
    return m_TimeMsIsSet;
}

void AssetCurrentLocation::unsetTimeMs()
{
    m_TimeMsIsSet = false;
}
