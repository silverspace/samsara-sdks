...
void TagUpdate::validate()
{
    // TODO: implement validation
}

web::json::value TagUpdate::toJson() const
{
...
void TagUpdate::fromJson(const web::json::value& val)
{
    {
        m_Assets.clear();
        std::vector<web::json::value> jsonArray;
...
void TagUpdate::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void TagUpdate::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
std::vector<std::shared_ptr<TaggedAssetBase>>& TagUpdate::getAssets()
{
    return m_Assets;
}

void TagUpdate::setAssets(const std::vector<std::shared_ptr<TaggedAssetBase>>& value)
{
    m_Assets = value;
    m_AssetsIsSet = true;
}

bool TagUpdate::assetsIsSet() const
{
    return m_AssetsIsSet;
}

void TagUpdate::unsetAssets()
{
    m_AssetsIsSet = false;
}

std::vector<std::shared_ptr<TaggedDriverBase>>& TagUpdate::getDrivers()
{
    return m_Drivers;
}

void TagUpdate::setDrivers(const std::vector<std::shared_ptr<TaggedDriverBase>>& value)
{
    m_Drivers = value;
    m_DriversIsSet = true;
}

bool TagUpdate::driversIsSet() const
{
    return m_DriversIsSet;
}

void TagUpdate::unsetDrivers()
{
    m_DriversIsSet = false;
}

std::vector<std::shared_ptr<TaggedMachineBase>>& TagUpdate::getMachines()
{
    return m_Machines;
}

void TagUpdate::setMachines(const std::vector<std::shared_ptr<TaggedMachineBase>>& value)
{
    m_Machines = value;
    m_MachinesIsSet = true;
}

bool TagUpdate::machinesIsSet() const
{
    return m_MachinesIsSet;
}

void TagUpdate::unsetMachines()
{
    m_MachinesIsSet = false;
}

utility::string_t TagUpdate::getName() const
{
    return m_Name;
}

void TagUpdate::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool TagUpdate::nameIsSet() const
{
    return m_NameIsSet;
}

void TagUpdate::unsetName()
{
    m_NameIsSet = false;
}

int64_t TagUpdate::getParentTagId() const
{
    return m_ParentTagId;
}

void TagUpdate::setParentTagId(int64_t value)
{
    m_ParentTagId = value;
    m_ParentTagIdIsSet = true;
}

bool TagUpdate::parentTagIdIsSet() const
{
    return m_ParentTagIdIsSet;
}

void TagUpdate::unsetParentTagId()
{
    m_ParentTagIdIsSet = false;
}

std::vector<std::shared_ptr<TaggedSensorBase>>& TagUpdate::getSensors()
{
    return m_Sensors;
}

void TagUpdate::setSensors(const std::vector<std::shared_ptr<TaggedSensorBase>>& value)
{
    m_Sensors = value;
    m_SensorsIsSet = true;
}

bool TagUpdate::sensorsIsSet() const
{
    return m_SensorsIsSet;
}

void TagUpdate::unsetSensors()
{
    m_SensorsIsSet = false;
}

std::vector<std::shared_ptr<TaggedVehicleBase>>& TagUpdate::getVehicles()
{
    return m_Vehicles;
}

void TagUpdate::setVehicles(const std::vector<std::shared_ptr<TaggedVehicleBase>>& value)
{
    m_Vehicles = value;
    m_VehiclesIsSet = true;
}

bool TagUpdate::vehiclesIsSet() const
{
    return m_VehiclesIsSet;
}

void TagUpdate::unsetVehicles()
{
    m_VehiclesIsSet = false;
}
