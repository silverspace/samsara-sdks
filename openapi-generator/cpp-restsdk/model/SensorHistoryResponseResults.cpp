...
void SensorHistoryResponse_results::validate()
{
    // TODO: implement validation
}

web::json::value SensorHistoryResponse_results::toJson() const
{
...
void SensorHistoryResponse_results::fromJson(const web::json::value& val)
{
    {
        m_Series.clear();
        std::vector<web::json::value> jsonArray;
        ...
        {
            m_Series.push_back(ModelBase::int64_tFromJson(item));
        }
        }
    }
    if(val.has_field(utility::conversions::to_string_t("timeMs")))
    {
        ...
        {
            setTimeMs(ModelBase::int32_tFromJson(fieldValue));
        }
    }
}

void SensorHistoryResponse_results::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void SensorHistoryResponse_results::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
    ...
    {
        setTimeMs(ModelBase::int32_tFromHttpContent(multipart->getContent(utility::conversions::to_string_t("timeMs"))));
    }
}

std::vector<int64_t>& SensorHistoryResponse_results::getSeries()
{
    return m_Series;
}

void SensorHistoryResponse_results::setSeries(std::vector<int64_t> value)
{
    m_Series = value;
    m_SeriesIsSet = true;
}

bool SensorHistoryResponse_results::seriesIsSet() const
{
    return m_SeriesIsSet;
}

void SensorHistoryResponse_results::unsetSeries()
{
    m_SeriesIsSet = false;
}

int32_t SensorHistoryResponse_results::getTimeMs() const
{
    return m_TimeMs;
}

void SensorHistoryResponse_results::setTimeMs(int32_t value)
{
    m_TimeMs = value;
    m_TimeMsIsSet = true;
}

bool SensorHistoryResponse_results::timeMsIsSet() const
{
    return m_TimeMsIsSet;
}

void SensorHistoryResponse_results::unsetTimeMs()
{
    m_TimeMsIsSet = false;
}
