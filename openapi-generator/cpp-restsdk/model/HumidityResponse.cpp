...
void HumidityResponse::validate()
{
    // TODO: implement validation
}

web::json::value HumidityResponse::toJson() const
{
...
void HumidityResponse::fromJson(const web::json::value& val)
{
    ...
    }
    {
        ...
        for( auto& item : val.at(utility::conversions::to_string_t("sensors")).as_array() )
        {
            if(item.is_null())
            {
                m_Sensors.push_back( std::shared_ptr<HumidityResponse_sensors>(nullptr) );
            }
            else
            {
                std::shared_ptr<HumidityResponse_sensors> newItem(new HumidityResponse_sensors());
...
void HumidityResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void HumidityResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
int64_t HumidityResponse::getGroupId() const
{
    return m_GroupId;
}

void HumidityResponse::setGroupId(int64_t value)
{
    m_GroupId = value;
    m_GroupIdIsSet = true;
}

bool HumidityResponse::groupIdIsSet() const
{
    return m_GroupIdIsSet;
}

void HumidityResponse::unsetGroupId()
{
    m_GroupIdIsSet = false;
}

std::vector<std::shared_ptr<HumidityResponse_sensors>>& HumidityResponse::getSensors()
{
    return m_Sensors;
}

void HumidityResponse::setSensors(const std::vector<std::shared_ptr<HumidityResponse_sensors>>& value)
{
    m_Sensors = value;
    m_SensorsIsSet = true;
}

bool HumidityResponse::sensorsIsSet() const
{
    return m_SensorsIsSet;
}

void HumidityResponse::unsetSensors()
{
    m_SensorsIsSet = false;
}
