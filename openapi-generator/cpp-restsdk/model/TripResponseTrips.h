...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_TripResponse_trips_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_TripResponse_trips_H_
...
public:
    ...
    /// </summary>
    utility::string_t getStartAddress() const;
    bool startAddressIsSet() const;
    void unsetStartAddress();

    void setStartAddress(const utility::string_t& value);
    ...
    void setStartCoordinates(const std::shared_ptr<TripResponse_startCoordinates>& value);
    ...
    void setEndCoordinates(const std::shared_ptr<TripResponse_endCoordinates>& value);
    ...
    /// </summary>
    utility::string_t getStartLocation() const;
    bool startLocationIsSet() const;
    void unsetStartLocation();

    void setStartLocation(const utility::string_t& value);
    ...
    /// </summary>
    utility::string_t getEndAddress() const;
    bool endAddressIsSet() const;
    void unsetEndAddress();

    void setEndAddress(const utility::string_t& value);

    /// <summary>
    /// Geocoded street address of start (latitude, longitude) coordinates.
    /// </summary>
    utility::string_t getEndLocation() const;
    bool endLocationIsSet() const;
    void unsetEndLocation();

    void setEndLocation(const utility::string_t& value);
...
protected:
    ...
    utility::string_t m_StartAddress;
    ...
    utility::string_t m_StartLocation;
    bool m_StartLocationIsSet;
    int32_t m_TollMeters;
    bool m_TollMetersIsSet;
    utility::string_t m_EndAddress;
    bool m_EndAddressIsSet;
    utility::string_t m_EndLocation;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_TripResponse_trips_H_ */
