...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_VehicleLocation_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_VehicleLocation_H_
...
public:
    ...
    /// </summary>
    bool isOnTrip() const;
    bool onTripIsSet() const;
    void unsetOnTrip();

    void setOnTrip(bool value);
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_VehicleLocation_H_ */
