...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_Document_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_Document_H_
...
public:
    ...
    /// </summary>
    int64_t getDriverCreatedAtMs() const;
    
    void setDriverCreatedAtMs(int64_t value);
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_Document_H_ */
