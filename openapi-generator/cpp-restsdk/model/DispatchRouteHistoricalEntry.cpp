...
void DispatchRouteHistoricalEntry::validate()
{
    // TODO: implement validation
}

web::json::value DispatchRouteHistoricalEntry::toJson() const
{
...
void DispatchRouteHistoricalEntry::fromJson(const web::json::value& val)
{
...
void DispatchRouteHistoricalEntry::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void DispatchRouteHistoricalEntry::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
int64_t DispatchRouteHistoricalEntry::getChangedAtMs() const
{
    return m_Changed_at_ms;
}

void DispatchRouteHistoricalEntry::setChangedAtMs(int64_t value)
{
    m_Changed_at_ms = value;
    m_Changed_at_msIsSet = true;
}

bool DispatchRouteHistoricalEntry::changedAtMsIsSet() const
{
    return m_Changed_at_msIsSet;
}

void DispatchRouteHistoricalEntry::unsetChanged_at_ms()
{
    m_Changed_at_msIsSet = false;
}

std::shared_ptr<DispatchRoute> DispatchRouteHistoricalEntry::getRoute() const
{
    return m_Route;
}

void DispatchRouteHistoricalEntry::setRoute(const std::shared_ptr<DispatchRoute>& value)
{
    m_Route = value;
    m_RouteIsSet = true;
}

bool DispatchRouteHistoricalEntry::routeIsSet() const
{
    return m_RouteIsSet;
}

void DispatchRouteHistoricalEntry::unsetRoute()
{
    m_RouteIsSet = false;
}
