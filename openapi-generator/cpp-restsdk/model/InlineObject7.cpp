...
web::json::value Inline_object_7::toJson() const
{
...
void Inline_object_7::fromJson(const web::json::value& val)
{
...
void Inline_object_7::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void Inline_object_7::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
int64_t Inline_object_7::getDriverId() const
{
    return m_DriverId;
}

void Inline_object_7::setDriverId(int64_t value)
{
    m_DriverId = value;
    
}

int32_t Inline_object_7::getEndMs() const
{
    return m_EndMs;
}

void Inline_object_7::setEndMs(int32_t value)
{
    m_EndMs = value;
    
}

int64_t Inline_object_7::getGroupId() const
{
    return m_GroupId;
}

void Inline_object_7::setGroupId(int64_t value)
{
    m_GroupId = value;
    
}

int32_t Inline_object_7::getStartMs() const
{
    return m_StartMs;
}

void Inline_object_7::setStartMs(int32_t value)
{
    m_StartMs = value;
