...
web::json::value Pagination::toJson() const
{
    ...
    val[utility::conversions::to_string_t("hasPrevPage")] = ModelBase::toJson(m_HasPrevPage);
    val[utility::conversions::to_string_t("startCursor")] = ModelBase::toJson(m_StartCursor);

    return val;
}

void Pagination::fromJson(const web::json::value& val)
{
    setEndCursor(ModelBase::stringFromJson(val.at(utility::conversions::to_string_t("endCursor"))));
    setHasNextPage(ModelBase::boolFromJson(val.at(utility::conversions::to_string_t("hasNextPage"))));
    setHasPrevPage(ModelBase::boolFromJson(val.at(utility::conversions::to_string_t("hasPrevPage"))));
    setStartCursor(ModelBase::stringFromJson(val.at(utility::conversions::to_string_t("startCursor"))));
}
...
void Pagination::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t("hasPrevPage"), m_HasPrevPage));
...
void Pagination::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    setHasPrevPage(ModelBase::boolFromHttpContent(multipart->getContent(utility::conversions::to_string_t("hasPrevPage"))));
    setStartCursor(ModelBase::stringFromHttpContent(multipart->getContent(utility::conversions::to_string_t("startCursor"))));
}

utility::string_t Pagination::getEndCursor() const
{
    return m_EndCursor;
}

void Pagination::setEndCursor(const utility::string_t& value)
{
    m_EndCursor = value;
    
}

bool Pagination::isHasNextPage() const
{
    return m_HasNextPage;
}

void Pagination::setHasNextPage(bool value)
{
    m_HasNextPage = value;
    
}

bool Pagination::isHasPrevPage() const
{
    return m_HasPrevPage;
}

void Pagination::setHasPrevPage(bool value)
{
    m_HasPrevPage = value;
    
}

utility::string_t Pagination::getStartCursor() const
{
    return m_StartCursor;
}

void Pagination::setStartCursor(const utility::string_t& value)
{
    m_StartCursor = value;
