...
void Machine::fromJson(const web::json::value& val)
{
...
void Machine::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
int64_t Machine::getId() const
{
    return m_Id;
}

void Machine::setId(int64_t value)
{
    m_Id = value;
...
utility::string_t Machine::getNotes() const
{
    return m_Notes;
}

void Machine::setNotes(const utility::string_t& value)
{
    m_Notes = value;
    m_NotesIsSet = true;
}

bool Machine::notesIsSet() const
{
    return m_NotesIsSet;
}

void Machine::unsetNotes()
{
    m_NotesIsSet = false;
}
