...
void Asset_cable::validate()
{
    // TODO: implement validation
}

web::json::value Asset_cable::toJson() const
{
...
void Asset_cable::fromJson(const web::json::value& val)
{
...
void Asset_cable::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void Asset_cable::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t Asset_cable::getAssetType() const
{
    return m_AssetType;
}

void Asset_cable::setAssetType(const utility::string_t& value)
{
    m_AssetType = value;
    m_AssetTypeIsSet = true;
}

bool Asset_cable::assetTypeIsSet() const
{
    return m_AssetTypeIsSet;
}

void Asset_cable::unsetAssetType()
{
    m_AssetTypeIsSet = false;
}
