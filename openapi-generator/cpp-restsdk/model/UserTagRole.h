...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_UserTagRole_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_UserTagRole_H_
...
public:
    ...
    /// 
    /// </summary>
    std::shared_ptr<UserTagRole_tag> getTag() const;
    
    void setTag(const std::shared_ptr<UserTagRole_tag>& value);
...
protected:
    ...
    utility::string_t m_RoleId;
        std::shared_ptr<UserTagRole_tag> m_Tag;
    };
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_UserTagRole_H_ */
