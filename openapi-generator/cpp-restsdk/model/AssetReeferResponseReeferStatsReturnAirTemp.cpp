...
void AssetReeferResponse_reeferStats_returnAirTemp::validate()
{
    // TODO: implement validation
}

web::json::value AssetReeferResponse_reeferStats_returnAirTemp::toJson() const
{
...
void AssetReeferResponse_reeferStats_returnAirTemp::fromJson(const web::json::value& val)
{
...
void AssetReeferResponse_reeferStats_returnAirTemp::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void AssetReeferResponse_reeferStats_returnAirTemp::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
int64_t AssetReeferResponse_reeferStats_returnAirTemp::getTempInMilliC() const
{
    return m_TempInMilliC;
}

void AssetReeferResponse_reeferStats_returnAirTemp::setTempInMilliC(int64_t value)
{
    m_TempInMilliC = value;
    m_TempInMilliCIsSet = true;
}

bool AssetReeferResponse_reeferStats_returnAirTemp::tempInMilliCIsSet() const
{
    return m_TempInMilliCIsSet;
}

void AssetReeferResponse_reeferStats_returnAirTemp::unsetTempInMilliC()
{
    m_TempInMilliCIsSet = false;
}

int64_t AssetReeferResponse_reeferStats_returnAirTemp::getChangedAtMs() const
{
    return m_ChangedAtMs;
}

void AssetReeferResponse_reeferStats_returnAirTemp::setChangedAtMs(int64_t value)
{
    m_ChangedAtMs = value;
    m_ChangedAtMsIsSet = true;
}

bool AssetReeferResponse_reeferStats_returnAirTemp::changedAtMsIsSet() const
{
    return m_ChangedAtMsIsSet;
}

void AssetReeferResponse_reeferStats_returnAirTemp::unsetChangedAtMs()
{
    m_ChangedAtMsIsSet = false;
}
