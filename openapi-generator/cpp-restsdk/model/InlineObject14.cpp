...
web::json::value Inline_object_14::toJson() const
{
...
void Inline_object_14::fromJson(const web::json::value& val)
{
...
void Inline_object_14::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void Inline_object_14::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
int64_t Inline_object_14::getGroupId() const
{
    return m_GroupId;
}

void Inline_object_14::setGroupId(int64_t value)
{
    m_GroupId = value;
    
}

std::vector<std::shared_ptr<Vehicle>>& Inline_object_14::getVehicles()
{
    return m_Vehicles;
}

void Inline_object_14::setVehicles(const std::vector<std::shared_ptr<Vehicle>>& value)
{
    m_Vehicles = value;
