...
void TagCreate::fromJson(const web::json::value& val)
{
    {
        m_Assets.clear();
        std::vector<web::json::value> jsonArray;
...
void TagCreate::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void TagCreate::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
std::vector<std::shared_ptr<TaggedAssetBase>>& TagCreate::getAssets()
{
    return m_Assets;
}

void TagCreate::setAssets(const std::vector<std::shared_ptr<TaggedAssetBase>>& value)
{
    m_Assets = value;
    m_AssetsIsSet = true;
}
...
std::vector<std::shared_ptr<TaggedDriverBase>>& TagCreate::getDrivers()
{
    return m_Drivers;
}

void TagCreate::setDrivers(const std::vector<std::shared_ptr<TaggedDriverBase>>& value)
{
    m_Drivers = value;
    m_DriversIsSet = true;
}
...
std::vector<std::shared_ptr<TaggedMachineBase>>& TagCreate::getMachines()
{
    return m_Machines;
}

void TagCreate::setMachines(const std::vector<std::shared_ptr<TaggedMachineBase>>& value)
{
    m_Machines = value;
...
utility::string_t TagCreate::getName() const
{
    return m_Name;
}

void TagCreate::setName(const utility::string_t& value)
{
    m_Name = value;
...
void TagCreate::setParentTagId(int64_t value)
{
    m_ParentTagId = value;
...
std::vector<std::shared_ptr<TaggedSensorBase>>& TagCreate::getSensors()
{
    return m_Sensors;
}

void TagCreate::setSensors(const std::vector<std::shared_ptr<TaggedSensorBase>>& value)
{
    m_Sensors = value;
    m_SensorsIsSet = true;
}
...
std::vector<std::shared_ptr<TaggedVehicleBase>>& TagCreate::getVehicles()
{
    return m_Vehicles;
}

void TagCreate::setVehicles(const std::vector<std::shared_ptr<TaggedVehicleBase>>& value)
{
    m_Vehicles = value;
