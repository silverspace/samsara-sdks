...
void Inline_response_200_3::fromJson(const web::json::value& val)
{
    ...
    }
    {
        ...
        for( auto& item : val.at(utility::conversions::to_string_t("vehicles")).as_array() )
        {
            if(item.is_null())
            {
                m_Vehicles.push_back( std::shared_ptr<VehicleLocation>(nullptr) );
            }
            else
            {
                std::shared_ptr<VehicleLocation> newItem(new VehicleLocation());
...
int64_t Inline_response_200_3::getGroupId() const
{
    return m_GroupId;
}

void Inline_response_200_3::setGroupId(int64_t value)
{
    m_GroupId = value;
    m_GroupIdIsSet = true;
}

bool Inline_response_200_3::groupIdIsSet() const
{
    return m_GroupIdIsSet;
}

void Inline_response_200_3::unsetGroupId()
{
    m_GroupIdIsSet = false;
}

std::vector<std::shared_ptr<VehicleLocation>>& Inline_response_200_3::getVehicles()
{
    return m_Vehicles;
}

void Inline_response_200_3::setVehicles(const std::vector<std::shared_ptr<VehicleLocation>>& value)
{
    m_Vehicles = value;
    m_VehiclesIsSet = true;
}

bool Inline_response_200_3::vehiclesIsSet() const
{
    return m_VehiclesIsSet;
}

void Inline_response_200_3::unsetVehicles()
{
    m_VehiclesIsSet = false;
}
