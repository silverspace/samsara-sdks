...
DvirBase_nextDriverSignature::DvirBase_nextDriverSignature()
{
    m_DriverId = 0L;
...
void DvirBase_nextDriverSignature::validate()
{
    // TODO: implement validation
}

web::json::value DvirBase_nextDriverSignature::toJson() const
{
...
void DvirBase_nextDriverSignature::fromJson(const web::json::value& val)
{
...
void DvirBase_nextDriverSignature::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void DvirBase_nextDriverSignature::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
int64_t DvirBase_nextDriverSignature::getDriverId() const
{
    return m_DriverId;
}

void DvirBase_nextDriverSignature::setDriverId(int64_t value)
{
    m_DriverId = value;
    m_DriverIdIsSet = true;
}

bool DvirBase_nextDriverSignature::driverIdIsSet() const
{
    return m_DriverIdIsSet;
}

void DvirBase_nextDriverSignature::unsetDriverId()
{
    m_DriverIdIsSet = false;
}

utility::string_t DvirBase_nextDriverSignature::getName() const
{
    return m_Name;
}

void DvirBase_nextDriverSignature::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool DvirBase_nextDriverSignature::nameIsSet() const
{
    return m_NameIsSet;
}

void DvirBase_nextDriverSignature::unsetName()
{
    m_NameIsSet = false;
}

int64_t DvirBase_nextDriverSignature::getSignedAt() const
{
    return m_SignedAt;
}

void DvirBase_nextDriverSignature::setSignedAt(int64_t value)
{
    m_SignedAt = value;
    m_SignedAtIsSet = true;
}

bool DvirBase_nextDriverSignature::signedAtIsSet() const
{
    return m_SignedAtIsSet;
}

void DvirBase_nextDriverSignature::unsetSignedAt()
{
    m_SignedAtIsSet = false;
}

utility::string_t DvirBase_nextDriverSignature::getType() const
{
    return m_Type;
}

void DvirBase_nextDriverSignature::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool DvirBase_nextDriverSignature::typeIsSet() const
{
    return m_TypeIsSet;
}

void DvirBase_nextDriverSignature::unsetType()
{
    m_TypeIsSet = false;
}

utility::string_t DvirBase_nextDriverSignature::getEmail() const
{
    return m_Email;
}

void DvirBase_nextDriverSignature::setEmail(const utility::string_t& value)
{
    m_Email = value;
    m_EmailIsSet = true;
}

bool DvirBase_nextDriverSignature::emailIsSet() const
{
    return m_EmailIsSet;
}

void DvirBase_nextDriverSignature::unsetEmail()
{
    m_EmailIsSet = false;
}

utility::string_t DvirBase_nextDriverSignature::getUsername() const
{
    return m_Username;
}

void DvirBase_nextDriverSignature::setUsername(const utility::string_t& value)
{
    m_Username = value;
    m_UsernameIsSet = true;
}

bool DvirBase_nextDriverSignature::usernameIsSet() const
{
    return m_UsernameIsSet;
}

void DvirBase_nextDriverSignature::unsetUsername()
{
    m_UsernameIsSet = false;
}
