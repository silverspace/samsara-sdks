...
web::json::value DvirBase_authorSignature::toJson() const
{
...
void DvirBase_authorSignature::fromJson(const web::json::value& val)
{
...
void DvirBase_authorSignature::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void DvirBase_authorSignature::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
void DvirBase_authorSignature::setMechanicUserId(int64_t value)
{
...
void DvirBase_authorSignature::setDriverId(int64_t value)
{
    m_DriverId = value;
...
utility::string_t DvirBase_authorSignature::getName() const
{
    return m_Name;
}

void DvirBase_authorSignature::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}
...
void DvirBase_authorSignature::setSignedAt(int64_t value)
{
    m_SignedAt = value;
...
utility::string_t DvirBase_authorSignature::getType() const
{
    return m_Type;
}

void DvirBase_authorSignature::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}
...
utility::string_t DvirBase_authorSignature::getEmail() const
{
    return m_Email;
}

void DvirBase_authorSignature::setEmail(const utility::string_t& value)
{
    m_Email = value;
    m_EmailIsSet = true;
}
...
utility::string_t DvirBase_authorSignature::getUsername() const
{
    return m_Username;
}

void DvirBase_authorSignature::setUsername(const utility::string_t& value)
{
    m_Username = value;
