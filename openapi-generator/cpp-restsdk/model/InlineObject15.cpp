...
web::json::value Inline_object_15::toJson() const
{
...
void Inline_object_15::fromJson(const web::json::value& val)
{
...
void Inline_object_15::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void Inline_object_15::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
int32_t Inline_object_15::getEndMs() const
{
    return m_EndMs;
}

void Inline_object_15::setEndMs(int32_t value)
{
    m_EndMs = value;
    
}

int64_t Inline_object_15::getGroupId() const
{
    return m_GroupId;
}

void Inline_object_15::setGroupId(int64_t value)
{
    m_GroupId = value;
    
}

int32_t Inline_object_15::getStartMs() const
{
    return m_StartMs;
}

void Inline_object_15::setStartMs(int32_t value)
{
    m_StartMs = value;
    
}

int64_t Inline_object_15::getVehicleId() const
{
    return m_VehicleId;
}

void Inline_object_15::setVehicleId(int64_t value)
{
    m_VehicleId = value;
