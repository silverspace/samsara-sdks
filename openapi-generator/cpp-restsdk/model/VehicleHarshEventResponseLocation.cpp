...
web::json::value VehicleHarshEventResponse_location::toJson() const
{
...
void VehicleHarshEventResponse_location::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("latitude")))
    {
        ...
        if(!fieldValue.is_null())
        {
            setLatitude(ModelBase::stringFromJson(fieldValue));
        }
    }
    if(val.has_field(utility::conversions::to_string_t("longitude")))
    {
        ...
        if(!fieldValue.is_null())
        {
            setLongitude(ModelBase::stringFromJson(fieldValue));
        }
    }
}

void VehicleHarshEventResponse_location::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void VehicleHarshEventResponse_location::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t VehicleHarshEventResponse_location::getAddress() const
{
    return m_Address;
}

void VehicleHarshEventResponse_location::setAddress(const utility::string_t& value)
{
    m_Address = value;
    m_AddressIsSet = true;
}
...
utility::string_t VehicleHarshEventResponse_location::getLatitude() const
{
    return m_Latitude;
}

void VehicleHarshEventResponse_location::setLatitude(const utility::string_t& value)
{
    m_Latitude = value;
...
utility::string_t VehicleHarshEventResponse_location::getLongitude() const
{
    return m_Longitude;
}

void VehicleHarshEventResponse_location::setLongitude(const utility::string_t& value)
{
    m_Longitude = value;
