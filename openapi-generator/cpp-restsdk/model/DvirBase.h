...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_DvirBase_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_DvirBase_H_
...
public:
    ...
    /// 
    /// </summary>
    std::shared_ptr<DvirBase_authorSignature> getAuthorSignature() const;
    bool authorSignatureIsSet() const;
    void unsetAuthorSignature();

    void setAuthorSignature(const std::shared_ptr<DvirBase_authorSignature>& value);
    ...
    void setDefectsCorrected(bool value);
    ...
    void setDefectsNeedNotBeCorrected(bool value);
    ...
    /// </summary>
    utility::string_t getInspectionType() const;
    bool inspectionTypeIsSet() const;
    void unsetInspectionType();

    void setInspectionType(const utility::string_t& value);

    /// <summary>
    /// The mechanics notes on the DVIR.
    /// </summary>
    utility::string_t getMechanicNotes() const;
    bool mechanicNotesIsSet() const;
    void unsetMechanicNotes();

    void setMechanicNotes(const utility::string_t& value);

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<DvirBase_mechanicOrAgentSignature> getMechanicOrAgentSignature() const;
    bool mechanicOrAgentSignatureIsSet() const;
    void unsetMechanicOrAgentSignature();

    void setMechanicOrAgentSignature(const std::shared_ptr<DvirBase_mechanicOrAgentSignature>& value);

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<DvirBase_nextDriverSignature> getNextDriverSignature() const;
    bool nextDriverSignatureIsSet() const;
    void unsetNextDriverSignature();

    void setNextDriverSignature(const std::shared_ptr<DvirBase_nextDriverSignature>& value);
    ...
    void setOdometerMiles(int64_t value);
    ...
    /// </summary>
    std::vector<std::shared_ptr<DvirBase_trailerDefects>>& getTrailerDefects();
    bool trailerDefectsIsSet() const;
    void unsetTrailerDefects();

    void setTrailerDefects(const std::vector<std::shared_ptr<DvirBase_trailerDefects>>& value);
    ...
    void setTrailerId(int32_t value);

    /// <summary>
    /// The name of the trailer which was part of the DVIR.
    /// </summary>
    utility::string_t getTrailerName() const;
    bool trailerNameIsSet() const;
    void unsetTrailerName();

    void setTrailerName(const utility::string_t& value);

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<DvirBase_vehicle> getVehicle() const;
    bool vehicleIsSet() const;
    void unsetVehicle();

    void setVehicle(const std::shared_ptr<DvirBase_vehicle>& value);

    /// <summary>
    /// The condition of vechile on which DVIR was done.
    /// </summary>
    utility::string_t getVehicleCondition() const;
    bool vehicleConditionIsSet() const;
    void unsetVehicleCondition();

    void setVehicleCondition(const utility::string_t& value);

    /// <summary>
    /// Defects registered for the vehicle which was part of the DVIR.
    /// </summary>
    std::vector<std::shared_ptr<DvirBase_trailerDefects>>& getVehicleDefects();
    bool vehicleDefectsIsSet() const;
    void unsetVehicleDefects();

    void setVehicleDefects(const std::vector<std::shared_ptr<DvirBase_trailerDefects>>& value);


protected:
    std::shared_ptr<DvirBase_authorSignature> m_AuthorSignature;
    ...
    int64_t m_Id;
    bool m_IdIsSet;
    utility::string_t m_InspectionType;
    bool m_InspectionTypeIsSet;
    utility::string_t m_MechanicNotes;
    bool m_MechanicNotesIsSet;
    std::shared_ptr<DvirBase_mechanicOrAgentSignature> m_MechanicOrAgentSignature;
    bool m_MechanicOrAgentSignatureIsSet;
    std::shared_ptr<DvirBase_nextDriverSignature> m_NextDriverSignature;
    bool m_NextDriverSignatureIsSet;
    int64_t m_OdometerMiles;
    bool m_OdometerMilesIsSet;
    int64_t m_TimeMs;
    bool m_TimeMsIsSet;
    std::vector<std::shared_ptr<DvirBase_trailerDefects>> m_TrailerDefects;
    bool m_TrailerDefectsIsSet;
    int32_t m_TrailerId;
    bool m_TrailerIdIsSet;
    utility::string_t m_TrailerName;
    bool m_TrailerNameIsSet;
    std::shared_ptr<DvirBase_vehicle> m_Vehicle;
    bool m_VehicleIsSet;
    utility::string_t m_VehicleCondition;
    bool m_VehicleConditionIsSet;
    std::vector<std::shared_ptr<DvirBase_trailerDefects>> m_VehicleDefects;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_DvirBase_H_ */
