...
void Inline_object_3::fromJson(const web::json::value& val)
{
...
void Inline_object_3::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
int64_t Inline_object_3::getGroupId() const
{
    return m_GroupId;
}

void Inline_object_3::setGroupId(int64_t value)
{
    m_GroupId = value;
