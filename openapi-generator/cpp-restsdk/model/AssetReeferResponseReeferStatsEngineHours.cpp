...
void AssetReeferResponse_reeferStats_engineHours::validate()
{
    // TODO: implement validation
}

web::json::value AssetReeferResponse_reeferStats_engineHours::toJson() const
{
...
void AssetReeferResponse_reeferStats_engineHours::fromJson(const web::json::value& val)
{
...
void AssetReeferResponse_reeferStats_engineHours::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void AssetReeferResponse_reeferStats_engineHours::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
int64_t AssetReeferResponse_reeferStats_engineHours::getEngineHours() const
{
    return m_EngineHours;
}

void AssetReeferResponse_reeferStats_engineHours::setEngineHours(int64_t value)
{
    m_EngineHours = value;
    m_EngineHoursIsSet = true;
}

bool AssetReeferResponse_reeferStats_engineHours::engineHoursIsSet() const
{
    return m_EngineHoursIsSet;
}

void AssetReeferResponse_reeferStats_engineHours::unsetEngineHours()
{
    m_EngineHoursIsSet = false;
}

int64_t AssetReeferResponse_reeferStats_engineHours::getChangedAtMs() const
{
    return m_ChangedAtMs;
}

void AssetReeferResponse_reeferStats_engineHours::setChangedAtMs(int64_t value)
{
    m_ChangedAtMs = value;
    m_ChangedAtMsIsSet = true;
}

bool AssetReeferResponse_reeferStats_engineHours::changedAtMsIsSet() const
{
    return m_ChangedAtMsIsSet;
}

void AssetReeferResponse_reeferStats_engineHours::unsetChangedAtMs()
{
    m_ChangedAtMsIsSet = false;
}
