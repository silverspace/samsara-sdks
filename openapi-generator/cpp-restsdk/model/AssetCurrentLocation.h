...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_AssetCurrentLocation_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_AssetCurrentLocation_H_
...
public:
    ...
    bool speedMilesPerHourIsSet() const;
    void unsetSpeedMilesPerHour();

    void setSpeedMilesPerHour(double value);
...
protected:
    ...
    double m_SpeedMilesPerHour;
    bool m_SpeedMilesPerHourIsSet;
    int64_t m_TimeMs;
    bool m_TimeMsIsSet;
};
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_AssetCurrentLocation_H_ */
