...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_DispatchRouteCreate_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_DispatchRouteCreate_H_
...
public:
    ...
    /// </summary>
    std::vector<std::shared_ptr<DispatchJobCreate>>& getDispatchJobs();
    
    void setDispatchJobs(const std::vector<std::shared_ptr<DispatchJobCreate>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<DispatchJobCreate>> m_Dispatch_jobs;
    };
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_DispatchRouteCreate_H_ */
