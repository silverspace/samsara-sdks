...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_HosAuthenticationLogsResponse_authenticationLogs_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_HosAuthenticationLogsResponse_authenticationLogs_H_
...
/// 
/// </summary>
class  HosAuthenticationLogsResponse_authenticationLogs
    : public ModelBase
{
public:
    ...
    /////////////////////////////////////////////
    /// HosAuthenticationLogsResponse_authenticationLogs members
    ...
    /// </summary>
    int64_t getHappenedAtMs() const;
    bool happenedAtMsIsSet() const;
    void unsetHappenedAtMs();

    void setHappenedAtMs(int64_t value);
    ...
    void setAddressName(const utility::string_t& value);
...
protected:
    ...
    bool m_CityIsSet;
    int64_t m_HappenedAtMs;
    bool m_HappenedAtMsIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_HosAuthenticationLogsResponse_authenticationLogs_H_ */
