...
void Inline_object_2::fromJson(const web::json::value& val)
{
    ...
    setRadius(ModelBase::int32_tFromJson(val.at(utility::conversions::to_string_t("radius"))));
}
...
void Inline_object_2::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
    ...
    setRadius(ModelBase::int32_tFromHttpContent(multipart->getContent(utility::conversions::to_string_t("radius"))));
}

utility::string_t Inline_object_2::getAddress() const
{
    return m_Address;
}

void Inline_object_2::setAddress(const utility::string_t& value)
{
    m_Address = value;
    
}

int64_t Inline_object_2::getGroupId() const
{
    return m_GroupId;
}

void Inline_object_2::setGroupId(int64_t value)
{
    m_GroupId = value;
    
}

utility::string_t Inline_object_2::getName() const
{
    return m_Name;
}

void Inline_object_2::setName(const utility::string_t& value)
{
    m_Name = value;
    
}

int32_t Inline_object_2::getRadius() const
{
    return m_Radius;
}

void Inline_object_2::setRadius(int32_t value)
{
    m_Radius = value;
