...
Inline_object_24::Inline_object_24()
{
    m_GroupId = 0L;
}
...
void Inline_object_24::validate()
{
    // TODO: implement validation
}

web::json::value Inline_object_24::toJson() const
{
...
void Inline_object_24::fromJson(const web::json::value& val)
{
    setGroupId(ModelBase::int64_tFromJson(val.at(utility::conversions::to_string_t("groupId"))));
    {
        ...
        {
            m_Sensors.push_back(ModelBase::int64_tFromJson(item));
        }
    }
}

void Inline_object_24::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void Inline_object_24::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
int64_t Inline_object_24::getGroupId() const
{
    return m_GroupId;
}

void Inline_object_24::setGroupId(int64_t value)
{
    m_GroupId = value;
    
}

std::vector<int64_t>& Inline_object_24::getSensors()
{
    return m_Sensors;
}

void Inline_object_24::setSensors(std::vector<int64_t> value)
{
    m_Sensors = value;
