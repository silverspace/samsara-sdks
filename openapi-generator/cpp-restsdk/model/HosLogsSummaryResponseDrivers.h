...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_HosLogsSummaryResponse_drivers_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_HosLogsSummaryResponse_drivers_H_
...
public:
    ...
    void setTimeUntilBreak(int64_t value);

    /// <summary>
    /// Name of the vehicle.
    /// </summary>
    utility::string_t getVehicleName() const;
    bool vehicleNameIsSet() const;
    void unsetVehicleName();

    void setVehicleName(const utility::string_t& value);
    ...
    void setDrivingInViolationToday(int64_t value);
    ...
    void setCycleRemaining(int64_t value);
    ...
    /// </summary>
    utility::string_t getDutyStatus() const;
    bool dutyStatusIsSet() const;
    void unsetDutyStatus();

    void setDutyStatus(const utility::string_t& value);
    ...
    void setCycleTomorrow(int64_t value);
    ...
    void setShiftDriveRemaining(int64_t value);
    ...
    void setTimeInCurrentStatus(int64_t value);
    ...
    void setDrivingInViolationCycle(int64_t value);
    ...
    void setShiftRemaining(int64_t value);


protected:
    int64_t m_TimeUntilBreak;
    bool m_TimeUntilBreakIsSet;
    utility::string_t m_VehicleName;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_HosLogsSummaryResponse_drivers_H_ */
