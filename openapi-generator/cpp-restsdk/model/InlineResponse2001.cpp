...
void Inline_response_200_1::fromJson(const web::json::value& val)
{
    {
        m_Assets.clear();
        std::vector<web::json::value> jsonArray;
        ...
        for( auto& item : val.at(utility::conversions::to_string_t("assets")).as_array() )
        {
            if(item.is_null())
            {
                m_Assets.push_back( std::shared_ptr<AssetCurrentLocationsResponse>(nullptr) );
            }
            else
            {
                std::shared_ptr<AssetCurrentLocationsResponse> newItem(new AssetCurrentLocationsResponse());
...
std::vector<std::shared_ptr<AssetCurrentLocationsResponse>>& Inline_response_200_1::getAssets()
{
    return m_Assets;
}

void Inline_response_200_1::setAssets(const std::vector<std::shared_ptr<AssetCurrentLocationsResponse>>& value)
{
    m_Assets = value;
    m_AssetsIsSet = true;
}

bool Inline_response_200_1::assetsIsSet() const
{
    return m_AssetsIsSet;
}

void Inline_response_200_1::unsetAssets()
{
    m_AssetsIsSet = false;
}
