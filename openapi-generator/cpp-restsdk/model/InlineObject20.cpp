...
Inline_object_20::Inline_object_20()
{
    m_GroupId = 0L;
}
...
void Inline_object_20::validate()
{
    // TODO: implement validation
}

web::json::value Inline_object_20::toJson() const
{
...
void Inline_object_20::fromJson(const web::json::value& val)
{
...
void Inline_object_20::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void Inline_object_20::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
int64_t Inline_object_20::getGroupId() const
{
    return m_GroupId;
}

void Inline_object_20::setGroupId(int64_t value)
{
    m_GroupId = value;
    
}

std::vector<int64_t>& Inline_object_20::getSensors()
{
    return m_Sensors;
}

void Inline_object_20::setSensors(std::vector<int64_t> value)
{
    m_Sensors = value;
