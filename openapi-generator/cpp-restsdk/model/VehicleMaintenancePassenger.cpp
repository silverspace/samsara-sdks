...
void VehicleMaintenance_passenger::validate()
{
    // TODO: implement validation
}

web::json::value VehicleMaintenance_passenger::toJson() const
{
...
void VehicleMaintenance_passenger::fromJson(const web::json::value& val)
{
    if(val.has_field(utility::conversions::to_string_t("checkEngineLight")))
    {
        ...
        {
            std::shared_ptr<VehicleMaintenance_passenger_checkEngineLight> newItem(new VehicleMaintenance_passenger_checkEngineLight());
    ...
    }
    {
        ...
        for( auto& item : val.at(utility::conversions::to_string_t("diagnosticTroubleCodes")).as_array() )
        {
            if(item.is_null())
            {
                m_DiagnosticTroubleCodes.push_back( std::shared_ptr<VehicleMaintenance_passenger_diagnosticTroubleCodes>(nullptr) );
            }
            else
            {
                std::shared_ptr<VehicleMaintenance_passenger_diagnosticTroubleCodes> newItem(new VehicleMaintenance_passenger_diagnosticTroubleCodes());
...
void VehicleMaintenance_passenger::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void VehicleMaintenance_passenger::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
std::shared_ptr<VehicleMaintenance_passenger_checkEngineLight> VehicleMaintenance_passenger::getCheckEngineLight() const
{
    return m_CheckEngineLight;
}

void VehicleMaintenance_passenger::setCheckEngineLight(const std::shared_ptr<VehicleMaintenance_passenger_checkEngineLight>& value)
{
    m_CheckEngineLight = value;
    m_CheckEngineLightIsSet = true;
}

bool VehicleMaintenance_passenger::checkEngineLightIsSet() const
{
    return m_CheckEngineLightIsSet;
}

void VehicleMaintenance_passenger::unsetCheckEngineLight()
{
    m_CheckEngineLightIsSet = false;
}

std::vector<std::shared_ptr<VehicleMaintenance_passenger_diagnosticTroubleCodes>>& VehicleMaintenance_passenger::getDiagnosticTroubleCodes()
{
    return m_DiagnosticTroubleCodes;
}

void VehicleMaintenance_passenger::setDiagnosticTroubleCodes(const std::vector<std::shared_ptr<VehicleMaintenance_passenger_diagnosticTroubleCodes>>& value)
{
    m_DiagnosticTroubleCodes = value;
    m_DiagnosticTroubleCodesIsSet = true;
}

bool VehicleMaintenance_passenger::diagnosticTroubleCodesIsSet() const
{
    return m_DiagnosticTroubleCodesIsSet;
}

void VehicleMaintenance_passenger::unsetDiagnosticTroubleCodes()
{
    m_DiagnosticTroubleCodesIsSet = false;
}
