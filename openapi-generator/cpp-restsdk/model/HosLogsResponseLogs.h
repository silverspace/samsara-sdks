...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_HosLogsResponse_logs_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_HosLogsResponse_logs_H_
...
public:
    ...
    void setLogStartMs(int64_t value);
    ...
    /// </summary>
    utility::string_t getStatusType() const;
    bool statusTypeIsSet() const;
    void unsetStatusType();

    void setStatusType(const utility::string_t& value);

    /// <summary>
    /// City in which the log was recorded.
    /// </summary>
    utility::string_t getLocCity() const;
    bool locCityIsSet() const;
    void unsetLocCity();

    void setLocCity(const utility::string_t& value);
    ...
    /// </summary>
    utility::string_t getLocName() const;
    bool locNameIsSet() const;
    void unsetLocName();

    void setLocName(const utility::string_t& value);
    ...
    /// </summary>
    utility::string_t getLocState() const;
    bool locStateIsSet() const;
    void unsetLocState();

    void setLocState(const utility::string_t& value);
    ...
    void setCodriverIds(std::vector<int64_t> value);
...
protected:
    ...
    utility::string_t m_StatusType;
    bool m_StatusTypeIsSet;
    utility::string_t m_LocCity;
    bool m_LocCityIsSet;
    int64_t m_GroupId;
    bool m_GroupIdIsSet;
    utility::string_t m_LocName;
    bool m_LocNameIsSet;
    double m_LocLat;
    bool m_LocLatIsSet;
    utility::string_t m_Remark;
    bool m_RemarkIsSet;
    utility::string_t m_LocState;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_HosLogsResponse_logs_H_ */
