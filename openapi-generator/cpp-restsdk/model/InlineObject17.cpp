...
void Inline_object_17::validate()
{
    // TODO: implement validation
}

web::json::value Inline_object_17::toJson() const
{
...
void Inline_object_17::fromJson(const web::json::value& val)
{
...
void Inline_object_17::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void Inline_object_17::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
int32_t Inline_object_17::getEndMs() const
{
    return m_EndMs;
}

void Inline_object_17::setEndMs(int32_t value)
{
    m_EndMs = value;
    
}

int64_t Inline_object_17::getGroupId() const
{
    return m_GroupId;
}

void Inline_object_17::setGroupId(int64_t value)
{
    m_GroupId = value;
    
}

int32_t Inline_object_17::getStartMs() const
{
    return m_StartMs;
}

void Inline_object_17::setStartMs(int32_t value)
{
    m_StartMs = value;
