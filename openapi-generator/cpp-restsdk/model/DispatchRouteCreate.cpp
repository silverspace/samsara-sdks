...
web::json::value DispatchRouteCreate::toJson() const
{
...
void DispatchRouteCreate::fromJson(const web::json::value& val)
{
    ...
    }
    {
        ...
        for( auto& item : val.at(utility::conversions::to_string_t("dispatch_jobs")).as_array() )
        {
            if(item.is_null())
            {
                m_Dispatch_jobs.push_back( std::shared_ptr<DispatchJobCreate>(nullptr) );
            }
            else
            {
                std::shared_ptr<DispatchJobCreate> newItem(new DispatchJobCreate());
...
void DispatchRouteCreate::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void DispatchRouteCreate::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t DispatchRouteCreate::getName() const
{
    return m_Name;
}

void DispatchRouteCreate::setName(const utility::string_t& value)
{
    m_Name = value;
...
utility::string_t DispatchRouteCreate::getStartLocationAddress() const
{
    return m_Start_location_address;
}

void DispatchRouteCreate::setStartLocationAddress(const utility::string_t& value)
{
...
utility::string_t DispatchRouteCreate::getStartLocationName() const
{
    return m_Start_location_name;
}

void DispatchRouteCreate::setStartLocationName(const utility::string_t& value)
{
...
std::vector<std::shared_ptr<DispatchJobCreate>>& DispatchRouteCreate::getDispatchJobs()
{
    return m_Dispatch_jobs;
}

void DispatchRouteCreate::setDispatchJobs(const std::vector<std::shared_ptr<DispatchJobCreate>>& value)
{
