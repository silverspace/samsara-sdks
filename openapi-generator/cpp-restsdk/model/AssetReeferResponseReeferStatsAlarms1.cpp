...
void AssetReeferResponse_reeferStats_alarms_1::validate()
{
    // TODO: implement validation
}

web::json::value AssetReeferResponse_reeferStats_alarms_1::toJson() const
{
...
void AssetReeferResponse_reeferStats_alarms_1::fromJson(const web::json::value& val)
{
    {
        m_Alarms.clear();
        std::vector<web::json::value> jsonArray;
        ...
        for( auto& item : val.at(utility::conversions::to_string_t("alarms")).as_array() )
        {
            if(item.is_null())
            {
                m_Alarms.push_back( std::shared_ptr<AssetReeferResponse_reeferStats_alarms>(nullptr) );
            }
            else
            {
                std::shared_ptr<AssetReeferResponse_reeferStats_alarms> newItem(new AssetReeferResponse_reeferStats_alarms());
...
void AssetReeferResponse_reeferStats_alarms_1::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void AssetReeferResponse_reeferStats_alarms_1::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
std::vector<std::shared_ptr<AssetReeferResponse_reeferStats_alarms>>& AssetReeferResponse_reeferStats_alarms_1::getAlarms()
{
    return m_Alarms;
}

void AssetReeferResponse_reeferStats_alarms_1::setAlarms(const std::vector<std::shared_ptr<AssetReeferResponse_reeferStats_alarms>>& value)
{
    m_Alarms = value;
    m_AlarmsIsSet = true;
}

bool AssetReeferResponse_reeferStats_alarms_1::alarmsIsSet() const
{
    return m_AlarmsIsSet;
}

void AssetReeferResponse_reeferStats_alarms_1::unsetAlarms()
{
    m_AlarmsIsSet = false;
}

int64_t AssetReeferResponse_reeferStats_alarms_1::getChangedAtMs() const
{
    return m_ChangedAtMs;
}

void AssetReeferResponse_reeferStats_alarms_1::setChangedAtMs(int64_t value)
{
    m_ChangedAtMs = value;
    m_ChangedAtMsIsSet = true;
}

bool AssetReeferResponse_reeferStats_alarms_1::changedAtMsIsSet() const
{
    return m_ChangedAtMsIsSet;
}

void AssetReeferResponse_reeferStats_alarms_1::unsetChangedAtMs()
{
    m_ChangedAtMsIsSet = false;
}
