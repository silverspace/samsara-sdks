...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_Inline_object_12_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_Inline_object_12_H_
...
public:
    ...
    /// </summary>
    int32_t getOdometerMiles() const;
    bool odometerMilesIsSet() const;
    void unsetOdometerMiles();

    void setOdometerMiles(int32_t value);
    ...
    /// </summary>
    bool isPreviousDefectsCorrected() const;
    bool previousDefectsCorrectedIsSet() const;
    void unsetPreviousDefectsCorrected();

    void setPreviousDefectsCorrected(bool value);
    ...
    /// </summary>
    bool isPreviousDefectsIgnored() const;
    bool previousDefectsIgnoredIsSet() const;
    void unsetPreviousDefectsIgnored();

    void setPreviousDefectsIgnored(bool value);

    /// <summary>
    /// Whether or not this vehicle or trailer is safe to drive.
    /// </summary>
    utility::string_t getSafe() const;
    
    void setSafe(const utility::string_t& value);
...
protected:
    ...
    int32_t m_OdometerMiles;
    bool m_OdometerMilesIsSet;
    bool m_PreviousDefectsCorrected;
    bool m_PreviousDefectsCorrectedIsSet;
    bool m_PreviousDefectsIgnored;
    bool m_PreviousDefectsIgnoredIsSet;
    utility::string_t m_Safe;
        int32_t m_TrailerId;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_Inline_object_12_H_ */
