...
void UserTagRole_tag::validate()
{
    // TODO: implement validation
}

web::json::value UserTagRole_tag::toJson() const
{
...
void UserTagRole_tag::fromJson(const web::json::value& val)
{
...
void UserTagRole_tag::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void UserTagRole_tag::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
int64_t UserTagRole_tag::getParentTagId() const
{
    return m_ParentTagId;
}

void UserTagRole_tag::setParentTagId(int64_t value)
{
    m_ParentTagId = value;
    m_ParentTagIdIsSet = true;
}

bool UserTagRole_tag::parentTagIdIsSet() const
{
    return m_ParentTagIdIsSet;
}

void UserTagRole_tag::unsetParentTagId()
{
    m_ParentTagIdIsSet = false;
}

utility::string_t UserTagRole_tag::getName() const
{
    return m_Name;
}

void UserTagRole_tag::setName(const utility::string_t& value)
{
    m_Name = value;
    
}

int64_t UserTagRole_tag::getId() const
{
    return m_Id;
}

void UserTagRole_tag::setId(int64_t value)
{
    m_Id = value;
