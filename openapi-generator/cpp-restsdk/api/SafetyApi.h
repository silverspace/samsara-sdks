...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_SafetyApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_SafetyApi_H_
...
public:
    ...
    explicit SafetyApi( std::shared_ptr<ApiClient> apiClient );
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_SafetyApi_H_ */
