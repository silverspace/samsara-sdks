...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_DriversApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_DriversApi_H_
...
public:
    ...
    explicit DriversApi( std::shared_ptr<ApiClient> apiClient );
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_DriversApi_H_ */
