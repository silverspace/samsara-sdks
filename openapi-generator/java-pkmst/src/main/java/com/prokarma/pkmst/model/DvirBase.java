...
import com.prokarma.pkmst.model.DvirBaseAuthorSignature;
import com.prokarma.pkmst.model.DvirBaseMechanicOrAgentSignature;
import com.prokarma.pkmst.model.DvirBaseNextDriverSignature;
import com.prokarma.pkmst.model.DvirBaseTrailerDefects;
import com.prokarma.pkmst.model.DvirBaseVehicle;
  ...
  **/
  ...
  public DvirBase addTrailerDefectsItem(DvirBaseTrailerDefects trailerDefectsItem) {
    if (this.trailerDefects == null) {
      this.trailerDefects = new ArrayList<>();
    }
  ...
  **/
  ...
  public DvirBase addVehicleDefectsItem(DvirBaseTrailerDefects vehicleDefectsItem) {
    if (this.vehicleDefects == null) {
      this.vehicleDefects = new ArrayList<>();
    }
