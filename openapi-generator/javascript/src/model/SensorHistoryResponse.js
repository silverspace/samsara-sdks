...
class SensorHistoryResponse {
    ...
    constructor() { 
        ...
        SensorHistoryResponse.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SensorHistoryResponse();
 ...
 */
SensorHistoryResponse.prototype['results'] = undefined;
...
export default SensorHistoryResponse;
