...
class Pagination {
     ...
     * @param endCursor {String} Cursor identifier representing the last element in the response. This value should be used in conjunction with a subsequent request's 'starting_after' query parameter.
     * @param hasNextPage {Boolean} True if there are more pages of results after this response.
     * @param hasPrevPage {Boolean} True if there are more pages of results before this response.
     * @param startCursor {String} Cursor identifier representing the first element in the response. This value should be used in conjunction with a subsequent request's 'ending_before' query parameter.
     */
    constructor(endCursor, hasNextPage, hasPrevPage, startCursor) { 
        
        Pagination.initialize(this, endCursor, hasNextPage, hasPrevPage, startCursor);
    }
     ...
     */
    static initialize(obj, endCursor, hasNextPage, hasPrevPage, startCursor) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('hasPrevPage')) {
                obj['hasPrevPage'] = ApiClient.convertToType(data['hasPrevPage'], 'Boolean');
            }
            if (data.hasOwnProperty('startCursor')) {
                obj['startCursor'] = ApiClient.convertToType(data['startCursor'], 'String');
            }
        }
        return obj;
    }
 ...
 */
Pagination.prototype['endCursor'] = undefined;

/**
 * True if there are more pages of results after this response.
 * @member {Boolean} hasNextPage
 */
Pagination.prototype['hasNextPage'] = undefined;

/**
 * True if there are more pages of results before this response.
 * @member {Boolean} hasPrevPage
 */
Pagination.prototype['hasPrevPage'] = undefined;
 ...
 */
Pagination.prototype['startCursor'] = undefined;
