...
class Asset {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('assetSerialNumber')) {
                obj['assetSerialNumber'] = ApiClient.convertToType(data['assetSerialNumber'], 'String');
            }
 ...
 * @member {String} assetSerialNumber
 */
Asset.prototype['assetSerialNumber'] = undefined;

/**
 * The cable connected to the asset
 * @member {Array.<module:model/AssetCable>} cable
 */
Asset.prototype['cable'] = undefined;

/**
 * Engine hours
 * @member {Number} engineHours
 */
Asset.prototype['engineHours'] = undefined;
