...
class InlineObject5 {
     ...
     */
    constructor(endMs, orgId, startMs) { 
        
        InlineObject5.initialize(this, endMs, orgId, startMs);
    }
     ...
     */
    static initialize(obj, endMs, orgId, startMs) { 
        obj['endMs'] = endMs;
        obj['orgId'] = orgId;
        obj['startMs'] = startMs;
    }
 ...
 * @member {Number} endMs
 */
InlineObject5.prototype['endMs'] = undefined;

/**
 * Org ID to query.
 * @member {Number} orgId
 */
InlineObject5.prototype['orgId'] = undefined;

/**
 * Start time (ms) of queried time period.
 * @member {Number} startMs
 */
InlineObject5.prototype['startMs'] = undefined;
