...
class TripResponseTrips {
    ...
    constructor() { 
        ...
        TripResponseTrips.initialize(this);
    }
 ...
 */
TripResponseTrips.prototype['endOdometer'] = undefined;

/**
 * Length of the trip in meters.
 * @member {Number} distanceMeters
 */
TripResponseTrips.prototype['distanceMeters'] = undefined;

/**
 * End of the trip in UNIX milliseconds.
 * @member {Number} endMs
 */
TripResponseTrips.prototype['endMs'] = undefined;

/**
 * Beginning of the trip in UNIX milliseconds.
 * @member {Number} startMs
 */
TripResponseTrips.prototype['startMs'] = undefined;

/**
 * Amount in milliliters of fuel consumed on this trip.
 * @member {Number} fuelConsumedMl
 */
TripResponseTrips.prototype['fuelConsumedMl'] = undefined;
...
export default TripResponseTrips;
