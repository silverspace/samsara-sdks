...
/**
 * The VehicleSafetyScoreResponse model module.
 * @module model/VehicleSafetyScoreResponse
 * @version 1.0.0
 */
class VehicleSafetyScoreResponse {
    /**
     * Constructs a new <code>VehicleSafetyScoreResponse</code>.
     * Safety score details for a vehicle
     * @alias module:model/VehicleSafetyScoreResponse
     */
    constructor() { 
        
        VehicleSafetyScoreResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>VehicleSafetyScoreResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/VehicleSafetyScoreResponse} obj Optional instance to populate.
     * @return {module:model/VehicleSafetyScoreResponse} The populated <code>VehicleSafetyScoreResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VehicleSafetyScoreResponse();
 ...
 */
VehicleSafetyScoreResponse.prototype['crashCount'] = undefined;

/**
 * Harsh acceleration event count
 * @member {Number} harshAccelCount
 */
VehicleSafetyScoreResponse.prototype['harshAccelCount'] = undefined;

/**
 * Harsh braking event count
 * @member {Number} harshBrakingCount
 */
VehicleSafetyScoreResponse.prototype['harshBrakingCount'] = undefined;

/**
 * @member {Array.<module:model/SafetyReportHarshEvent>} harshEvents
 */
VehicleSafetyScoreResponse.prototype['harshEvents'] = undefined;

/**
 * Harsh turning event count
 * @member {Number} harshTurningCount
 */
VehicleSafetyScoreResponse.prototype['harshTurningCount'] = undefined;

/**
 * Safety Score
 * @member {Number} safetyScore
 */
VehicleSafetyScoreResponse.prototype['safetyScore'] = undefined;

/**
 * Safety Score Rank
 * @member {String} safetyScoreRank
 */
VehicleSafetyScoreResponse.prototype['safetyScoreRank'] = undefined;

/**
 * Amount of time driven over the speed limit in milliseconds
 * @member {Number} timeOverSpeedLimitMs
 */
VehicleSafetyScoreResponse.prototype['timeOverSpeedLimitMs'] = undefined;

/**
 * Total distance driven in meters
 * @member {Number} totalDistanceDrivenMeters
 */
VehicleSafetyScoreResponse.prototype['totalDistanceDrivenMeters'] = undefined;

/**
 * Total harsh event count
 * @member {Number} totalHarshEventCount
 */
VehicleSafetyScoreResponse.prototype['totalHarshEventCount'] = undefined;

/**
 * Amount of time driven in milliseconds
 * @member {Number} totalTimeDrivenMs
 */
VehicleSafetyScoreResponse.prototype['totalTimeDrivenMs'] = undefined;

/**
 * Vehicle ID
 * @member {Number} vehicleId
 */
VehicleSafetyScoreResponse.prototype['vehicleId'] = undefined;
...
export default VehicleSafetyScoreResponse;
