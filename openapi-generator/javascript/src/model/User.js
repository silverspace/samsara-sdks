...
class User {
     ...
     */
    constructor() { 
        UserBase.initialize(this, authType, email);
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('organizationRoleId')) {
                obj['organizationRoleId'] = ApiClient.convertToType(data['organizationRoleId'], 'String');
            }
            if (data.hasOwnProperty('id')) {
                obj['id'] = ApiClient.convertToType(data['id'], 'Number');
            }
            if (data.hasOwnProperty('organizationRole')) {
                obj['organizationRole'] = ApiClient.convertToType(data['organizationRole'], 'String');
            }
            if (data.hasOwnProperty('tagRoles')) {
                obj['tagRoles'] = ApiClient.convertToType(data['tagRoles'], [UserTagRole]);
            }
        }
        return obj;
    }
 ...
 * @member {module:model/User.AuthTypeEnum} authType
 */
 ...
 * @member {String} organizationRoleId
 */
User.prototype['organizationRoleId'] = undefined;
 ...
 * @member {String} organizationRole
 */
User.prototype['organizationRole'] = undefined;

/**
 * The specific tags this user has access to. This will be blank for users that have full access to the organization.
 * @member {Array.<module:model/UserTagRole>} tagRoles
 */
User.prototype['tagRoles'] = undefined;


// Implement UserBase interface:
/**
 * The authentication type the user uses to authenticate. To use SAML this organization must have a configured SAML integration.
 * @member {module:model/UserBase.AuthTypeEnum} authType
 */
UserBase.prototype['authType'] = undefined;
/**
 * The email address of this user.
 * @member {String} email
 */
 ...
 * @member {String} organizationRoleId
 */
UserBase.prototype['organizationRoleId'] = undefined;
