...
class Vehicle {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('fuelLevelPercent')) {
                obj['fuelLevelPercent'] = ApiClient.convertToType(data['fuelLevelPercent'], 'Number');
            }
 ...
 */
Vehicle.prototype['engineHours'] = undefined;

/**
 * The fuel level of the vehicle as a percentage. (0.0 to 1.0)
 * @member {Number} fuelLevelPercent
 */
Vehicle.prototype['fuelLevelPercent'] = undefined;
 ...
 */
Vehicle.prototype['odometerMeters'] = undefined;
