...
class DriverForCreate {
     ...
     * @param password {String} Driver's password for the driver app.
     */
    constructor(password) { 
        DriverBase.initialize(this, name);
        DriverForCreate.initialize(this, password);
    }
 ...
 */
DriverForCreate.prototype['eldAdverseWeatherExemptionEnabled'] = undefined;

/**
 * Flag indicating this driver may use Big Day excemptions in ELD logs.
 * @member {Boolean} eldBigDayExemptionEnabled
 */
DriverForCreate.prototype['eldBigDayExemptionEnabled'] = undefined;

/**
 * 0 indicating midnight-to-midnight ELD driving hours, 12 to indicate noon-to-noon driving hours.
 * @member {Number} eldDayStartHour
 */
DriverForCreate.prototype['eldDayStartHour'] = undefined;

/**
 * Flag indicating this driver is exempt from the Electronic Logging Mandate.
 * @member {Boolean} eldExempt
 */
DriverForCreate.prototype['eldExempt'] = undefined;

/**
 * Reason that this driver is exempt from the Electronic Logging Mandate (see eldExempt).
 * @member {String} eldExemptReason
 */
DriverForCreate.prototype['eldExemptReason'] = undefined;
 ...
 * @default false
 */
DriverForCreate.prototype['eldPcEnabled'] = false;
 ...
 * @default false
 */
DriverForCreate.prototype['eldYmEnabled'] = false;

/**
 * Dictionary of external IDs (string key-value pairs)
 * @member {Object.<String, String>} externalIds
 */
DriverForCreate.prototype['externalIds'] = undefined;

/**
 * ID of the group if the organization has multiple groups (uncommon).
 * @member {Number} groupId
 */
DriverForCreate.prototype['groupId'] = undefined;

/**
 * Driver's state issued license number.
 * @member {String} licenseNumber
 */
DriverForCreate.prototype['licenseNumber'] = undefined;

/**
 * Abbreviation of state that issued driver's license.
 * @member {String} licenseState
 */
DriverForCreate.prototype['licenseState'] = undefined;

/**
 * Driver's name.
 * @member {String} name
 */
DriverForCreate.prototype['name'] = undefined;

/**
 * Notes about the driver.
 * @member {String} notes
 */
DriverForCreate.prototype['notes'] = undefined;

/**
 * Driver's phone number. Please include only digits, ex. 4157771234
 * @member {String} phone
 */
DriverForCreate.prototype['phone'] = undefined;

/**
 * Driver's login username into the driver app.
 * @member {String} username
 */
DriverForCreate.prototype['username'] = undefined;

/**
 * ID of the vehicle assigned to the driver for static vehicle assignments. (uncommon).
 * @member {Number} vehicleId
 */
DriverForCreate.prototype['vehicleId'] = undefined;

/**
 * Driver's password for the driver app.
 * @member {String} password
 */
DriverForCreate.prototype['password'] = undefined;

/**
 * A list of tag IDs.
 * @member {Array.<Number>} tagIds
 */
DriverForCreate.prototype['tagIds'] = undefined;
...
export default DriverForCreate;
