...
class InlineObject {
     ...
     * @param addresses {Array.<module:model/AddressesAddresses>} 
     */
    constructor(addresses) { 
        
        InlineObject.initialize(this, addresses);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('addresses')) {
                obj['addresses'] = ApiClient.convertToType(data['addresses'], [AddressesAddresses]);
            }
        }
        return obj;
    }
...
/**
 * @member {Array.<module:model/AddressesAddresses>} addresses
 */
InlineObject.prototype['addresses'] = undefined;
