...
/**
 * The DocumentFieldCreate model module.
 * @module model/DocumentFieldCreate
 * @version 1.0.0
 */
class DocumentFieldCreate {
    /**
     * Constructs a new <code>DocumentFieldCreate</code>.
     * @alias module:model/DocumentFieldCreate
     * @param valueType {String} Determines the type of this field and what type of value this field has. It should be either ValueType_Number, ValueType_String, or ValueType_Photo.
     */
    ...
    /**
     * Constructs a <code>DocumentFieldCreate</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DocumentFieldCreate} obj Optional instance to populate.
     * @return {module:model/DocumentFieldCreate} The populated <code>DocumentFieldCreate</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DocumentFieldCreate();
