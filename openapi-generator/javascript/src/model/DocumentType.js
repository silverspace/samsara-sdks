...
class DocumentType {
     ...
     * @param name {String} Name of the document type.
     * @param orgId {Number} ID for the organization this document belongs to.
     * @param uuid {String} Universally unique identifier for the document type. Can be passed in as a documentTypeUuid when creating a document for this document type.
     */
    constructor(name, orgId, uuid) { 
        
        DocumentType.initialize(this, name, orgId, uuid);
    }
     ...
     */
    static initialize(obj, name, orgId, uuid) { 
        obj['name'] = name;
        obj['orgId'] = orgId;
        obj['uuid'] = uuid;
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('fieldTypes')) {
                obj['fieldTypes'] = ApiClient.convertToType(data['fieldTypes'], [Array]);
            }
 ...
 * @member {Array.<Array.<module:model/DocumentFieldType>>} fieldTypes
 */
DocumentType.prototype['fieldTypes'] = undefined;
 ...
 * @member {Number} orgId
 */
DocumentType.prototype['orgId'] = undefined;
 ...
 * @member {String} uuid
 */
DocumentType.prototype['uuid'] = undefined;
