...
class DocumentCreate {
     ...
     * @param documentTypeUuid {String} Universally unique identifier for the document type this document is being created for.
     * @param fields {Array.<module:model/DocumentField>} List of fields should match the document type’s list of field types in the correct order. In other words, a field's valueType and value (i.e. only one of: stringValue, numberValue, or photoValue) at index _i_ should match with the document field type’s valueType at index _i_.
     */
    constructor(documentTypeUuid, fields) { 
        DocumentBase.initialize(this);
        DocumentCreate.initialize(this, documentTypeUuid, fields);
    }
     ...
     */
    static initialize(obj, documentTypeUuid, fields) { 
        obj['documentTypeUuid'] = documentTypeUuid;
        obj['fields'] = fields;
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('documentTypeUuid')) {
                obj['documentTypeUuid'] = ApiClient.convertToType(data['documentTypeUuid'], 'String');
            }
 ...
 */
DocumentCreate.prototype['dispatchJobId'] = undefined;

/**
 * Notes submitted with this document.
 * @member {String} notes
 */
DocumentCreate.prototype['notes'] = undefined;

/**
 * Universally unique identifier for the document type this document is being created for.
 * @member {String} documentTypeUuid
 */
DocumentCreate.prototype['documentTypeUuid'] = undefined;
 ...
 */
DocumentCreate.prototype['fields'] = undefined;
