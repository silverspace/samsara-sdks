...
class UserBase {
     ...
     * @param authType {module:model/UserBase.AuthTypeEnum} The authentication type the user uses to authenticate. To use SAML this organization must have a configured SAML integration.
     * @param email {String} The email address of this user.
     */
    constructor(authType, email) { 
     ...
     */
    static initialize(obj, authType, email) { 
