...
class InlineObject2 {
     ...
     */
    constructor(address, groupId, name, radius) { 
        
        InlineObject2.initialize(this, address, groupId, name, radius);
    }
     ...
     */
    static initialize(obj, address, groupId, name, radius) { 
        obj['address'] = address;
        obj['groupId'] = groupId;
        obj['name'] = name;
        obj['radius'] = radius;
 ...
 */
InlineObject2.prototype['address'] = undefined;

/**
 * Group ID to query.
 * @member {Number} groupId
 */
InlineObject2.prototype['groupId'] = undefined;
 ...
 */
InlineObject2.prototype['radius'] = undefined;
