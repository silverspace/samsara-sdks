...
class HosLogsResponseLogs {
    ...
    constructor() { 
        ...
        HosLogsResponseLogs.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new HosLogsResponseLogs();
            ...
            if (data.hasOwnProperty('codriverIds')) {
                obj['codriverIds'] = ApiClient.convertToType(data['codriverIds'], ['Number']);
            }
        }
        return obj;
    }
 ...
 */
HosLogsResponseLogs.prototype['locLng'] = undefined;

/**
 * The time at which the log/HOS status started in UNIX milliseconds.
 * @member {Number} logStartMs
 */
HosLogsResponseLogs.prototype['logStartMs'] = undefined;

/**
 * ID of the driver.
 * @member {Number} driverId
 */
HosLogsResponseLogs.prototype['driverId'] = undefined;

/**
 * The Hours of Service status type. One of `OFF_DUTY`, `SLEEPER_BED`, `DRIVING`, `ON_DUTY`, `YARD_MOVE`, `PERSONAL_CONVEYANCE`.
 * @member {String} statusType
 */
HosLogsResponseLogs.prototype['statusType'] = undefined;

/**
 * City in which the log was recorded.
 * @member {String} locCity
 */
HosLogsResponseLogs.prototype['locCity'] = undefined;

/**
 * ID of the group.
 * @member {Number} groupId
 */
HosLogsResponseLogs.prototype['groupId'] = undefined;

/**
 * Name of location at which the log was recorded.
 * @member {String} locName
 */
HosLogsResponseLogs.prototype['locName'] = undefined;

/**
 * Latitude at which the log was recorded.
 * @member {Number} locLat
 */
HosLogsResponseLogs.prototype['locLat'] = undefined;

/**
 * Remark associated with the log entry.
 * @member {String} remark
 */
HosLogsResponseLogs.prototype['remark'] = undefined;

/**
 * State in which the log was recorded.
 * @member {String} locState
 */
HosLogsResponseLogs.prototype['locState'] = undefined;

/**
 * ID of the vehicle.
 * @member {Number} vehicleId
 */
HosLogsResponseLogs.prototype['vehicleId'] = undefined;

/**
 * @member {Array.<Number>} codriverIds
 */
HosLogsResponseLogs.prototype['codriverIds'] = undefined;
...
export default HosLogsResponseLogs;
