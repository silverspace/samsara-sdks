...
class InlineObject16 {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('harsh_accel_setting')) {
                obj['harsh_accel_setting'] = ApiClient.convertToType(data['harsh_accel_setting'], 'Number');
            }
 ...
 */
InlineObject16.prototype['externalIds'] = undefined;

/**
 * Harsh Event Detection Setting * 0: Passenger * 1: Light Truck * 2: Heavy * 3: Off * 4: Automatic
 * @member {Number} harsh_accel_setting
 */
InlineObject16.prototype['harsh_accel_setting'] = undefined;
