...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.AddressesAddresses();
  });
  ...
  describe('AddressesAddresses', function() {
    it('should create an instance of AddressesAddresses', function() {
      // uncomment below and update the code to test AddressesAddresses
      //var instane = new SamsaraApi.AddressesAddresses();
      //expect(instance).to.be.a(SamsaraApi.AddressesAddresses);
    });
