...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.TagModifyAdd();
  });
  ...
  describe('TagModifyAdd', function() {
    it('should create an instance of TagModifyAdd', function() {
      // uncomment below and update the code to test TagModifyAdd
      //var instane = new SamsaraApi.TagModifyAdd();
      //expect(instance).to.be.a(SamsaraApi.TagModifyAdd);
    });
