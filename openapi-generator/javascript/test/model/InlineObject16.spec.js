...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.InlineObject16();
  });
  ...
  describe('InlineObject16', function() {
    it('should create an instance of InlineObject16', function() {
      ...
      //var instane = new SamsaraApi.InlineObject16();
      //expect(instance).to.be.a(SamsaraApi.InlineObject16);
    });
    ...
    it('should have the property harshAccelSetting (base name: "harsh_accel_setting")', function() {
