...
(function(root, factory) {
  ...
  describe('InlineResponse2005', function() {
    it('should create an instance of InlineResponse2005', function() {
      ...
      //var instane = new SamsaraApi.InlineResponse2005();
    ...
    it('should have the property vehicleStats (base name: "vehicleStats")', function() {
      // uncomment below and update the code to test the property vehicleStats
      //var instane = new SamsaraApi.InlineResponse2005();
      //expect(instance).to.be();
    });
