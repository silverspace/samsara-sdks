...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.AddressGeofence();
  });
  ...
  describe('AddressGeofence', function() {
    it('should create an instance of AddressGeofence', function() {
      // uncomment below and update the code to test AddressGeofence
      //var instane = new SamsaraApi.AddressGeofence();
      //expect(instance).to.be.a(SamsaraApi.AddressGeofence);
    });
