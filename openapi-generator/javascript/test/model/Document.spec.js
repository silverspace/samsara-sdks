...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.Document();
  });
  ...
  describe('Document', function() {
    it('should create an instance of Document', function() {
      ...
      //var instane = new SamsaraApi.Document();
      //expect(instance).to.be.a(SamsaraApi.Document);
    });
    ...
    it('should have the property driverCreatedAtMs (base name: "driverCreatedAtMs")', function() {
      // uncomment below and update the code to test the property driverCreatedAtMs
      //var instane = new SamsaraApi.Document();
      //expect(instance).to.be();
    });
