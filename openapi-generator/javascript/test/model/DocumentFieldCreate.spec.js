...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.DocumentFieldCreate();
  });
  ...
  describe('DocumentFieldCreate', function() {
    it('should create an instance of DocumentFieldCreate', function() {
      // uncomment below and update the code to test DocumentFieldCreate
      //var instane = new SamsaraApi.DocumentFieldCreate();
      //expect(instance).to.be.a(SamsaraApi.DocumentFieldCreate);
    });
    ...
    it('should have the property photoValue (base name: "photoValue")', function() {
      // uncomment below and update the code to test the property photoValue
      //var instane = new SamsaraApi.DocumentFieldCreate();
      //expect(instance).to.be();
    });
