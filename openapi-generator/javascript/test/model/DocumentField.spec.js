...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.DocumentField();
  });
  ...
  describe('DocumentField', function() {
    it('should create an instance of DocumentField', function() {
      // uncomment below and update the code to test DocumentField
      //var instane = new SamsaraApi.DocumentField();
      //expect(instance).to.be.a(SamsaraApi.DocumentField);
    });
