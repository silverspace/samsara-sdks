...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.TagModifyDelete();
  });
  ...
  describe('TagModifyDelete', function() {
    it('should create an instance of TagModifyDelete', function() {
      // uncomment below and update the code to test TagModifyDelete
      //var instane = new SamsaraApi.TagModifyDelete();
      //expect(instance).to.be.a(SamsaraApi.TagModifyDelete);
    });
