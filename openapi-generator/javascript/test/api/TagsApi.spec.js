...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.TagsApi();
  });
  ...
  describe('TagsApi', function() {
    ...
    describe('modifyTagById', function() {
      it('should call modifyTagById successfully', function(done) {
        //uncomment below and update the code to test modifyTagById
        //instance.modifyTagById(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
