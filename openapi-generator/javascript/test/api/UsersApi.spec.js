...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.UsersApi();
  });
  ...
  describe('UsersApi', function() {
    ...
    describe('listUserRoles', function() {
      it('should call listUserRoles successfully', function(done) {
        //uncomment below and update the code to test listUserRoles
        //instance.listUserRoles(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
