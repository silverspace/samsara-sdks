...
void
Inline_object_7::fromJson(char* jsonStr)
{
...
Inline_object_7::Inline_object_7(char* json)
{
	this->fromJson(json);
}

char*
Inline_object_7::toJson()
{
...
long long
Inline_object_7::getDriverId()
{
	return driverId;
}

void
Inline_object_7::setDriverId(long long  driverId)
{
	this->driverId = driverId;
}

int
Inline_object_7::getEndMs()
{
	return endMs;
}

void
Inline_object_7::setEndMs(int  endMs)
{
	this->endMs = endMs;
}

long long
Inline_object_7::getGroupId()
{
	return groupId;
}

void
Inline_object_7::setGroupId(long long  groupId)
{
	this->groupId = groupId;
}

int
Inline_object_7::getStartMs()
{
	return startMs;
}

void
Inline_object_7::setStartMs(int  startMs)
{
