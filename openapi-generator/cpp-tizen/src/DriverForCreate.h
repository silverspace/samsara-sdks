...
#ifndef _DriverForCreate_H_
#define _DriverForCreate_H_
...
class DriverForCreate : public Object {
public:
	/*! \brief Constructor.
	 */
	DriverForCreate();
	DriverForCreate(char* str);
	...
	/*! \brief Get Driver's password for the driver app.
	 */
	std::string getPassword();

	/*! \brief Set Driver's password for the driver app.
	 */
