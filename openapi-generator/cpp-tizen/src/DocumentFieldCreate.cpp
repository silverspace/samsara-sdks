...
void
DocumentFieldCreate::fromJson(char* jsonStr)
{
...
DocumentFieldCreate::DocumentFieldCreate(char* json)
{
	this->fromJson(json);
}

char*
DocumentFieldCreate::toJson()
{
...
double
DocumentFieldCreate::getNumberValue()
{
	return numberValue;
}

void
DocumentFieldCreate::setNumberValue(double  numberValue)
{
	this->numberValue = numberValue;
}

std::list<DocumentFieldCreate_photoValue>
DocumentFieldCreate::getPhotoValue()
{
	return photoValue;
}

void
DocumentFieldCreate::setPhotoValue(std::list <DocumentFieldCreate_photoValue> photoValue)
{
	this->photoValue = photoValue;
}

std::string
DocumentFieldCreate::getStringValue()
{
	return stringValue;
}

void
DocumentFieldCreate::setStringValue(std::string  stringValue)
{
	this->stringValue = stringValue;
}

std::string
DocumentFieldCreate::getValueType()
{
	return valueType;
}

void
DocumentFieldCreate::setValueType(std::string  valueType)
{
