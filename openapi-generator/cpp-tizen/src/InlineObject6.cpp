...
void
Inline_object_6::fromJson(char* jsonStr)
{
...
Inline_object_6::Inline_object_6(char* json)
{
	this->fromJson(json);
}

char*
Inline_object_6::toJson()
{
...
long long
Inline_object_6::getDriverId()
{
	return driverId;
}

void
Inline_object_6::setDriverId(long long  driverId)
{
	this->driverId = driverId;
}

int
Inline_object_6::getEndMs()
{
	return endMs;
}

void
Inline_object_6::setEndMs(int  endMs)
{
	this->endMs = endMs;
}

long long
Inline_object_6::getGroupId()
{
	return groupId;
}

void
Inline_object_6::setGroupId(long long  groupId)
{
	this->groupId = groupId;
}

int
Inline_object_6::getStartMs()
{
	return startMs;
}

void
Inline_object_6::setStartMs(int  startMs)
{
