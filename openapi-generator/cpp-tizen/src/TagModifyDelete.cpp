...
void
TagModify_delete::fromJson(char* jsonStr)
{
...
TagModify_delete::TagModify_delete(char* json)
{
	this->fromJson(json);
}

char*
TagModify_delete::toJson()
{
...
TagModify_delete::getAssets()
{
	return assets;
}

void
TagModify_delete::setAssets(std::list <TaggedAssetBase> assets)
{
	this->assets = assets;
}

std::list<TaggedSensorBase>
TagModify_delete::getSensors()
{
	return sensors;
}

void
TagModify_delete::setSensors(std::list <TaggedSensorBase> sensors)
{
	this->sensors = sensors;
}

std::list<TaggedVehicleBase>
TagModify_delete::getVehicles()
{
	return vehicles;
}

void
TagModify_delete::setVehicles(std::list <TaggedVehicleBase> vehicles)
{
	this->vehicles = vehicles;
}

std::list<TaggedMachineBase>
TagModify_delete::getMachines()
{
	return machines;
}

void
TagModify_delete::setMachines(std::list <TaggedMachineBase> machines)
{
	this->machines = machines;
}

std::list<TaggedDriverBase>
TagModify_delete::getDrivers()
{
	return drivers;
}

void
TagModify_delete::setDrivers(std::list <TaggedDriverBase> drivers)
{
