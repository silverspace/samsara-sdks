...
void
AssetReeferResponse_reeferStats_setPoint::__init()
{
	//tempInMilliC = long(0);
	//changedAtMs = long(0);
}
...
void
AssetReeferResponse_reeferStats_setPoint::__cleanup()
{
...
void
AssetReeferResponse_reeferStats_setPoint::fromJson(char* jsonStr)
{
...
AssetReeferResponse_reeferStats_setPoint::AssetReeferResponse_reeferStats_setPoint(char* json)
{
	this->fromJson(json);
}

char*
AssetReeferResponse_reeferStats_setPoint::toJson()
{
...
long long
AssetReeferResponse_reeferStats_setPoint::getTempInMilliC()
{
	return tempInMilliC;
}

void
AssetReeferResponse_reeferStats_setPoint::setTempInMilliC(long long  tempInMilliC)
{
	this->tempInMilliC = tempInMilliC;
}

long long
AssetReeferResponse_reeferStats_setPoint::getChangedAtMs()
{
	return changedAtMs;
}

void
AssetReeferResponse_reeferStats_setPoint::setChangedAtMs(long long  changedAtMs)
{
