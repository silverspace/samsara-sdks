...
void
TagUpdate::fromJson(char* jsonStr)
{
...
void
TagUpdate::setAssets(std::list <TaggedAssetBase> assets)
{
	this->assets = assets;
}

std::list<TaggedDriverBase>
TagUpdate::getDrivers()
{
	return drivers;
}

void
TagUpdate::setDrivers(std::list <TaggedDriverBase> drivers)
{
	this->drivers = drivers;
}

std::list<TaggedMachineBase>
TagUpdate::getMachines()
{
	return machines;
}

void
TagUpdate::setMachines(std::list <TaggedMachineBase> machines)
{
...
void
TagUpdate::setName(std::string  name)
{
	this->name = name;
}

long long
TagUpdate::getParentTagId()
{
	return parentTagId;
}

void
TagUpdate::setParentTagId(long long  parentTagId)
{
	this->parentTagId = parentTagId;
}

std::list<TaggedSensorBase>
TagUpdate::getSensors()
{
	return sensors;
}

void
TagUpdate::setSensors(std::list <TaggedSensorBase> sensors)
{
	this->sensors = sensors;
}

std::list<TaggedVehicleBase>
TagUpdate::getVehicles()
{
	return vehicles;
}

void
TagUpdate::setVehicles(std::list <TaggedVehicleBase> vehicles)
{
