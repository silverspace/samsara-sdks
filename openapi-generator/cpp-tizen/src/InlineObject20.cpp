...
void
Inline_object_20::fromJson(char* jsonStr)
{
...
Inline_object_20::Inline_object_20(char* json)
{
	this->fromJson(json);
}

char*
Inline_object_20::toJson()
{
...
long long
Inline_object_20::getGroupId()
{
	return groupId;
}

void
Inline_object_20::setGroupId(long long  groupId)
{
	this->groupId = groupId;
}

std::list<long long>
Inline_object_20::getSensors()
{
	return sensors;
}

void
Inline_object_20::setSensors(std::list <long long> sensors)
{
