...
void
Inline_object_19::fromJson(char* jsonStr)
{
...
Inline_object_19::Inline_object_19(char* json)
{
	this->fromJson(json);
}

char*
Inline_object_19::toJson()
{
...
long long
Inline_object_19::getGroupId()
{
	return groupId;
}

void
Inline_object_19::setGroupId(long long  groupId)
{
	this->groupId = groupId;
}

std::list<long long>
Inline_object_19::getSensors()
{
	return sensors;
}

void
Inline_object_19::setSensors(std::list <long long> sensors)
{
