...
void
_addresses_addresses::__cleanup()
{
	//if(notes != NULL) {
	//
	//delete notes;
...
void
_addresses_addresses::fromJson(char* jsonStr)
{
...
_addresses_addresses::_addresses_addresses(char* json)
{
	this->fromJson(json);
}

char*
_addresses_addresses::toJson()
{
...
std::string
_addresses_addresses::getNotes()
{
	return notes;
}

void
_addresses_addresses::setNotes(std::string  notes)
{
	this->notes = notes;
}

std::string
_addresses_addresses::getFormattedAddress()
{
	return formattedAddress;
}

void
_addresses_addresses::setFormattedAddress(std::string  formattedAddress)
{
	this->formattedAddress = formattedAddress;
}

AddressGeofence
_addresses_addresses::getGeofence()
{
	return geofence;
}

void
_addresses_addresses::setGeofence(AddressGeofence  geofence)
{
	this->geofence = geofence;
}

std::list<long long>
_addresses_addresses::getTagIds()
{
	return tagIds;
}

void
_addresses_addresses::setTagIds(std::list <long long> tagIds)
{
	this->tagIds = tagIds;
}

std::string
_addresses_addresses::getName()
{
	return name;
}

void
_addresses_addresses::setName(std::string  name)
{
	this->name = name;
}

std::list<long long>
_addresses_addresses::getContactIds()
{
	return contactIds;
}

void
_addresses_addresses::setContactIds(std::list <long long> contactIds)
{
