...
OAISafetyApi::OAISafetyApi(QString host, QString basePath) {
    this->host = host;
    this->basePath = basePath;
}

void
OAISafetyApi::getDriverSafetyScore(const qint64& driver_id, const QString& access_token, const qint64& start_ms, const qint64& end_ms) {
    QString fullPath;
    ...
    connect(worker,
            ...
            this,
            &OAISafetyApi::getDriverSafetyScoreCallback);

    worker->execute(&input);
}

void
OAISafetyApi::getDriverSafetyScoreCallback(OAIHttpRequestWorker * worker) {
    QString msg;
...
void
OAISafetyApi::getVehicleHarshEvent(const qint64& vehicle_id, const QString& access_token, const qint64& timestamp) {
    QString fullPath;
    ...
    connect(worker,
            &OAIHttpRequestWorker::on_execution_finished,
            this,
            &OAISafetyApi::getVehicleHarshEventCallback);

    worker->execute(&input);
}

void
OAISafetyApi::getVehicleHarshEventCallback(OAIHttpRequestWorker * worker) {
    QString msg;
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void
OAISafetyApi::getVehicleSafetyScore(const qint64& vehicle_id, const QString& access_token, const qint64& start_ms, const qint64& end_ms) {
    QString fullPath;
    ...
    connect(worker,
            &OAIHttpRequestWorker::on_execution_finished,
            this,
            &OAISafetyApi::getVehicleSafetyScoreCallback);

    worker->execute(&input);
}

void
OAISafetyApi::getVehicleSafetyScoreCallback(OAIHttpRequestWorker * worker) {
    QString msg;
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
