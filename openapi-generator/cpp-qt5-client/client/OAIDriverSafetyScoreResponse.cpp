...
OAIDriverSafetyScoreResponse::OAIDriverSafetyScoreResponse(QString json) {
    this->init();
    this->fromJson(json);
}

OAIDriverSafetyScoreResponse::OAIDriverSafetyScoreResponse() {
    this->init();
}
...
void
OAIDriverSafetyScoreResponse::init() {
...
void
OAIDriverSafetyScoreResponse::fromJson(QString jsonString) {
...
void
OAIDriverSafetyScoreResponse::fromJsonObject(QJsonObject json) {
...
QString
OAIDriverSafetyScoreResponse::asJson () const {
...
QJsonObject
OAIDriverSafetyScoreResponse::asJsonObject() const {
    QJsonObject obj;
...
qint32
OAIDriverSafetyScoreResponse::getCrashCount() const {
    return crash_count;
}
void
OAIDriverSafetyScoreResponse::setCrashCount(const qint32 &crash_count) {
    this->crash_count = crash_count;
    this->m_crash_count_isSet = true;
}

qint32
OAIDriverSafetyScoreResponse::getDriverId() const {
    return driver_id;
}
void
OAIDriverSafetyScoreResponse::setDriverId(const qint32 &driver_id) {
    this->driver_id = driver_id;
    this->m_driver_id_isSet = true;
}

qint32
OAIDriverSafetyScoreResponse::getHarshAccelCount() const {
    return harsh_accel_count;
}
void
OAIDriverSafetyScoreResponse::setHarshAccelCount(const qint32 &harsh_accel_count) {
    this->harsh_accel_count = harsh_accel_count;
    this->m_harsh_accel_count_isSet = true;
}

qint32
OAIDriverSafetyScoreResponse::getHarshBrakingCount() const {
    return harsh_braking_count;
}
void
OAIDriverSafetyScoreResponse::setHarshBrakingCount(const qint32 &harsh_braking_count) {
    this->harsh_braking_count = harsh_braking_count;
    this->m_harsh_braking_count_isSet = true;
}

QList<OAISafetyReportHarshEvent>
OAIDriverSafetyScoreResponse::getHarshEvents() const {
    return harsh_events;
}
void
OAIDriverSafetyScoreResponse::setHarshEvents(const QList<OAISafetyReportHarshEvent> &harsh_events) {
    this->harsh_events = harsh_events;
    this->m_harsh_events_isSet = true;
}

qint32
OAIDriverSafetyScoreResponse::getHarshTurningCount() const {
    return harsh_turning_count;
}
void
OAIDriverSafetyScoreResponse::setHarshTurningCount(const qint32 &harsh_turning_count) {
    this->harsh_turning_count = harsh_turning_count;
    this->m_harsh_turning_count_isSet = true;
}

qint32
OAIDriverSafetyScoreResponse::getSafetyScore() const {
    return safety_score;
}
void
OAIDriverSafetyScoreResponse::setSafetyScore(const qint32 &safety_score) {
    this->safety_score = safety_score;
    this->m_safety_score_isSet = true;
}

QString
OAIDriverSafetyScoreResponse::getSafetyScoreRank() const {
    return safety_score_rank;
}
void
OAIDriverSafetyScoreResponse::setSafetyScoreRank(const QString &safety_score_rank) {
    this->safety_score_rank = safety_score_rank;
    this->m_safety_score_rank_isSet = true;
}

qint32
OAIDriverSafetyScoreResponse::getTimeOverSpeedLimitMs() const {
    return time_over_speed_limit_ms;
}
void
OAIDriverSafetyScoreResponse::setTimeOverSpeedLimitMs(const qint32 &time_over_speed_limit_ms) {
    this->time_over_speed_limit_ms = time_over_speed_limit_ms;
    this->m_time_over_speed_limit_ms_isSet = true;
}

qint32
OAIDriverSafetyScoreResponse::getTotalDistanceDrivenMeters() const {
    return total_distance_driven_meters;
}
void
OAIDriverSafetyScoreResponse::setTotalDistanceDrivenMeters(const qint32 &total_distance_driven_meters) {
    this->total_distance_driven_meters = total_distance_driven_meters;
    this->m_total_distance_driven_meters_isSet = true;
}

qint32
OAIDriverSafetyScoreResponse::getTotalHarshEventCount() const {
    return total_harsh_event_count;
}
void
OAIDriverSafetyScoreResponse::setTotalHarshEventCount(const qint32 &total_harsh_event_count) {
    this->total_harsh_event_count = total_harsh_event_count;
    this->m_total_harsh_event_count_isSet = true;
}

qint32
OAIDriverSafetyScoreResponse::getTotalTimeDrivenMs() const {
    return total_time_driven_ms;
}
void
OAIDriverSafetyScoreResponse::setTotalTimeDrivenMs(const qint32 &total_time_driven_ms) {
    this->total_time_driven_ms = total_time_driven_ms;
    this->m_total_time_driven_ms_isSet = true;
}

bool
OAIDriverSafetyScoreResponse::isSet() const {
...
bool
OAIDriverSafetyScoreResponse::isValid() const {
