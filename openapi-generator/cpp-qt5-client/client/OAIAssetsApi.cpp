...
OAIAssetsApi::OAIAssetsApi(QString host, QString basePath) {
    this->host = host;
    this->basePath = basePath;
}

void
OAIAssetsApi::getAllAssetCurrentLocations(const QString& access_token, const qint64& group_id) {
    QString fullPath;
    ...
    connect(worker,
            ...
            this,
            &OAIAssetsApi::getAllAssetCurrentLocationsCallback);

    worker->execute(&input);
}

void
OAIAssetsApi::getAllAssetCurrentLocationsCallback(OAIHttpRequestWorker * worker) {
    QString msg;
...
void
OAIAssetsApi::getAllAssets(const QString& access_token, const qint64& group_id) {
    QString fullPath;
    ...
    connect(worker,
            &OAIHttpRequestWorker::on_execution_finished,
            this,
            &OAIAssetsApi::getAllAssetsCallback);

    worker->execute(&input);
}

void
OAIAssetsApi::getAllAssetsCallback(OAIHttpRequestWorker * worker) {
    QString msg;
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void
OAIAssetsApi::getAssetLocation(const QString& access_token, const qint64& asset_id, const qint64& start_ms, const qint64& end_ms) {
    QString fullPath;
    ...
    connect(worker,
            &OAIHttpRequestWorker::on_execution_finished,
            this,
            &OAIAssetsApi::getAssetLocationCallback);

    worker->execute(&input);
}

void
OAIAssetsApi::getAssetLocationCallback(OAIHttpRequestWorker * worker) {
    QString msg;
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void
OAIAssetsApi::getAssetReefer(const QString& access_token, const qint64& asset_id, const qint64& start_ms, const qint64& end_ms) {
    QString fullPath;
    ...
    connect(worker,
            &OAIHttpRequestWorker::on_execution_finished,
            this,
            &OAIAssetsApi::getAssetReeferCallback);

    worker->execute(&input);
}

void
OAIAssetsApi::getAssetReeferCallback(OAIHttpRequestWorker * worker) {
    QString msg;
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
