...
public:
    ...
    QList<OAI_addresses_addresses> getAddresses() const;
    void setAddresses(const QList<OAI_addresses_addresses> &addresses);
...
private:
    void init();
    QList<OAI_addresses_addresses> addresses;
