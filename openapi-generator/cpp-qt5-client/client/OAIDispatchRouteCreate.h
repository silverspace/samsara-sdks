...
/*
 * OAIDispatchRouteCreate.h
 *
 * 
 */

#ifndef OAIDispatchRouteCreate_H
#define OAIDispatchRouteCreate_H
...
class OAIDispatchRouteCreate: public OAIObject {
public:
    OAIDispatchRouteCreate();
    OAIDispatchRouteCreate(QString json);
    ~OAIDispatchRouteCreate() override;
    ...
    QList<OAIDispatchJobCreate> getDispatchJobs() const;
    void setDispatchJobs(const QList<OAIDispatchJobCreate> &dispatch_jobs);
...
private:
    ...
    QList<OAIDispatchJobCreate> dispatch_jobs;
    bool m_dispatch_jobs_isSet;
    bool m_dispatch_jobs_isValid;
};

}

#endif // OAIDispatchRouteCreate_H
