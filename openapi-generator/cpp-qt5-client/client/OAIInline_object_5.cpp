...
qint64
OAIInline_object_5::getEndMs() const {
    return end_ms;
}
void
OAIInline_object_5::setEndMs(const qint64 &end_ms) {
    this->end_ms = end_ms;
    this->m_end_ms_isSet = true;
}

qint64
OAIInline_object_5::getOrgId() const {
    return org_id;
}
void
OAIInline_object_5::setOrgId(const qint64 &org_id) {
    this->org_id = org_id;
    this->m_org_id_isSet = true;
}

qint64
OAIInline_object_5::getStartMs() const {
    return start_ms;
}
void
OAIInline_object_5::setStartMs(const qint64 &start_ms) {
...
OAIInline_object_5::isValid() const {
    ...
    return m_end_ms_isValid && m_org_id_isValid && m_start_ms_isValid && true;
}
