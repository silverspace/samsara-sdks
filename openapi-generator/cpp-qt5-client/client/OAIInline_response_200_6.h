...
public:
    ...
    QList<OAIDataInputHistoryResponse> getDataInputs() const;
    void setDataInputs(const QList<OAIDataInputHistoryResponse> &data_inputs);
...
private:
    void init();
    QList<OAIDataInputHistoryResponse> data_inputs;
    bool m_data_inputs_isSet;
    bool m_data_inputs_isValid;
};
