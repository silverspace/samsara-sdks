...
/*
 * OAIDispatchJobCreate.h
 *
 * 
 */

#ifndef OAIDispatchJobCreate_H
#define OAIDispatchJobCreate_H
...
class OAIDispatchJobCreate: public OAIObject {
public:
    OAIDispatchJobCreate();
    OAIDispatchJobCreate(QString json);
    ~OAIDispatchJobCreate() override;
