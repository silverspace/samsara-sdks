...
void
OAIContact::fromJson(QString jsonString) {
...
void
OAIContact::fromJsonObject(QJsonObject json) {
...
QString
OAIContact::getEmail() const {
    return email;
}
void
OAIContact::setEmail(const QString &email) {
    this->email = email;
    this->m_email_isSet = true;
}

QString
OAIContact::getFirstName() const {
    return first_name;
}
void
OAIContact::setFirstName(const QString &first_name) {
    this->first_name = first_name;
    this->m_first_name_isSet = true;
}

qint64
OAIContact::getId() const {
    return id;
}
void
OAIContact::setId(const qint64 &id) {
    this->id = id;
    this->m_id_isSet = true;
}

QString
OAIContact::getLastName() const {
    return last_name;
}
void
OAIContact::setLastName(const QString &last_name) {
    this->last_name = last_name;
    this->m_last_name_isSet = true;
}

QString
OAIContact::getPhone() const {
    return phone;
}
void
OAIContact::setPhone(const QString &phone) {
    this->phone = phone;
    this->m_phone_isSet = true;
}

bool
OAIContact::isSet() const {
