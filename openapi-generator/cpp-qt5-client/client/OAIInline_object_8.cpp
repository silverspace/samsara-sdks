...
qint64
OAIInline_object_8::getDriverId() const {
    return driver_id;
}
void
OAIInline_object_8::setDriverId(const qint64 &driver_id) {
    this->driver_id = driver_id;
    this->m_driver_id_isSet = true;
}

qint32
OAIInline_object_8::getEndMs() const {
    return end_ms;
}
void
OAIInline_object_8::setEndMs(const qint32 &end_ms) {
    this->end_ms = end_ms;
    this->m_end_ms_isSet = true;
}

qint64
OAIInline_object_8::getGroupId() const {
    return group_id;
}
void
OAIInline_object_8::setGroupId(const qint64 &group_id) {
    this->group_id = group_id;
    this->m_group_id_isSet = true;
}

qint32
OAIInline_object_8::getStartMs() const {
    return start_ms;
}
void
OAIInline_object_8::setStartMs(const qint32 &start_ms) {
