...
OAIDispatchRouteCreate::OAIDispatchRouteCreate(QString json) {
    this->init();
    this->fromJson(json);
}

OAIDispatchRouteCreate::OAIDispatchRouteCreate() {
    this->init();
}
...
void
OAIDispatchRouteCreate::fromJson(QString jsonString) {
...
void
OAIDispatchRouteCreate::fromJsonObject(QJsonObject json) {
...
QString
OAIDispatchRouteCreate::asJson () const {
...
QJsonObject
OAIDispatchRouteCreate::asJsonObject() const {
    QJsonObject obj;
...
qint64
OAIDispatchRouteCreate::getActualEndMs() const {
    return actual_end_ms;
}
void
OAIDispatchRouteCreate::setActualEndMs(const qint64 &actual_end_ms) {
    this->actual_end_ms = actual_end_ms;
    this->m_actual_end_ms_isSet = true;
}

qint64
OAIDispatchRouteCreate::getActualStartMs() const {
    return actual_start_ms;
}
void
OAIDispatchRouteCreate::setActualStartMs(const qint64 &actual_start_ms) {
    this->actual_start_ms = actual_start_ms;
    this->m_actual_start_ms_isSet = true;
}

qint64
OAIDispatchRouteCreate::getDriverId() const {
    return driver_id;
}
void
OAIDispatchRouteCreate::setDriverId(const qint64 &driver_id) {
    this->driver_id = driver_id;
    this->m_driver_id_isSet = true;
}

qint64
OAIDispatchRouteCreate::getGroupId() const {
    return group_id;
}
void
OAIDispatchRouteCreate::setGroupId(const qint64 &group_id) {
    this->group_id = group_id;
    this->m_group_id_isSet = true;
}

QString
OAIDispatchRouteCreate::getName() const {
    return name;
}
void
OAIDispatchRouteCreate::setName(const QString &name) {
    this->name = name;
    this->m_name_isSet = true;
}

qint64
OAIDispatchRouteCreate::getScheduledEndMs() const {
    return scheduled_end_ms;
}
void
OAIDispatchRouteCreate::setScheduledEndMs(const qint64 &scheduled_end_ms) {
    this->scheduled_end_ms = scheduled_end_ms;
    this->m_scheduled_end_ms_isSet = true;
}

qint64
OAIDispatchRouteCreate::getScheduledMeters() const {
    return scheduled_meters;
}
void
OAIDispatchRouteCreate::setScheduledMeters(const qint64 &scheduled_meters) {
    this->scheduled_meters = scheduled_meters;
    this->m_scheduled_meters_isSet = true;
}

qint64
OAIDispatchRouteCreate::getScheduledStartMs() const {
    return scheduled_start_ms;
}
void
OAIDispatchRouteCreate::setScheduledStartMs(const qint64 &scheduled_start_ms) {
    this->scheduled_start_ms = scheduled_start_ms;
    this->m_scheduled_start_ms_isSet = true;
}

QString
OAIDispatchRouteCreate::getStartLocationAddress() const {
    return start_location_address;
}
void
OAIDispatchRouteCreate::setStartLocationAddress(const QString &start_location_address) {
    this->start_location_address = start_location_address;
    this->m_start_location_address_isSet = true;
}

qint64
OAIDispatchRouteCreate::getStartLocationAddressId() const {
    return start_location_address_id;
}
void
OAIDispatchRouteCreate::setStartLocationAddressId(const qint64 &start_location_address_id) {
    this->start_location_address_id = start_location_address_id;
    this->m_start_location_address_id_isSet = true;
}

double
OAIDispatchRouteCreate::getStartLocationLat() const {
    return start_location_lat;
}
void
OAIDispatchRouteCreate::setStartLocationLat(const double &start_location_lat) {
    this->start_location_lat = start_location_lat;
    this->m_start_location_lat_isSet = true;
}

double
OAIDispatchRouteCreate::getStartLocationLng() const {
    return start_location_lng;
}
void
OAIDispatchRouteCreate::setStartLocationLng(const double &start_location_lng) {
    this->start_location_lng = start_location_lng;
    this->m_start_location_lng_isSet = true;
}

QString
OAIDispatchRouteCreate::getStartLocationName() const {
    return start_location_name;
}
void
OAIDispatchRouteCreate::setStartLocationName(const QString &start_location_name) {
    this->start_location_name = start_location_name;
    this->m_start_location_name_isSet = true;
}

qint64
OAIDispatchRouteCreate::getTrailerId() const {
    return trailer_id;
}
void
OAIDispatchRouteCreate::setTrailerId(const qint64 &trailer_id) {
    this->trailer_id = trailer_id;
    this->m_trailer_id_isSet = true;
}

qint64
OAIDispatchRouteCreate::getVehicleId() const {
    return vehicle_id;
}
void
OAIDispatchRouteCreate::setVehicleId(const qint64 &vehicle_id) {
    this->vehicle_id = vehicle_id;
    this->m_vehicle_id_isSet = true;
}

QList<OAIDispatchJobCreate>
OAIDispatchRouteCreate::getDispatchJobs() const {
    return dispatch_jobs;
}
void
OAIDispatchRouteCreate::setDispatchJobs(const QList<OAIDispatchJobCreate> &dispatch_jobs) {
    this->dispatch_jobs = dispatch_jobs;
    this->m_dispatch_jobs_isSet = true;
}

bool
OAIDispatchRouteCreate::isSet() const {
...
bool
OAIDispatchRouteCreate::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_name_isValid && m_scheduled_end_ms_isValid && m_scheduled_start_ms_isValid && m_dispatch_jobs_isValid && true;
}
