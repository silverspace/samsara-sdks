...
#include "OAIAssetCurrentLocation.h"
...
OAIAssetCurrentLocation::OAIAssetCurrentLocation(QString json) {
    this->init();
    this->fromJson(json);
}

OAIAssetCurrentLocation::OAIAssetCurrentLocation() {
    this->init();
}
...
void
OAIAssetCurrentLocation::fromJson(QString jsonString) {
...
void
OAIAssetCurrentLocation::fromJsonObject(QJsonObject json) {
...
QString
OAIAssetCurrentLocation::asJson () const {
...
QJsonObject
OAIAssetCurrentLocation::asJsonObject() const {
    QJsonObject obj;
	if(m_latitude_isSet){
...
double
OAIAssetCurrentLocation::getLatitude() const {
    return latitude;
}
void
OAIAssetCurrentLocation::setLatitude(const double &latitude) {
    this->latitude = latitude;
    this->m_latitude_isSet = true;
}

QString
OAIAssetCurrentLocation::getLocation() const {
    return location;
}
void
OAIAssetCurrentLocation::setLocation(const QString &location) {
    this->location = location;
    this->m_location_isSet = true;
}

double
OAIAssetCurrentLocation::getLongitude() const {
    return longitude;
}
void
OAIAssetCurrentLocation::setLongitude(const double &longitude) {
    this->longitude = longitude;
    this->m_longitude_isSet = true;
}

double
OAIAssetCurrentLocation::getSpeedMilesPerHour() const {
    return speed_miles_per_hour;
}
void
OAIAssetCurrentLocation::setSpeedMilesPerHour(const double &speed_miles_per_hour) {
    this->speed_miles_per_hour = speed_miles_per_hour;
    this->m_speed_miles_per_hour_isSet = true;
}

qint64
OAIAssetCurrentLocation::getTimeMs() const {
    return time_ms;
}
void
OAIAssetCurrentLocation::setTimeMs(const qint64 &time_ms) {
    this->time_ms = time_ms;
    this->m_time_ms_isSet = true;
}

bool
OAIAssetCurrentLocation::isSet() const {
...
bool
OAIAssetCurrentLocation::isValid() const {
