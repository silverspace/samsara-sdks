...
OAITagCreate::OAITagCreate(QString json) {
    this->init();
    this->fromJson(json);
}

OAITagCreate::OAITagCreate() {
    this->init();
}
...
void
OAITagCreate::fromJson(QString jsonString) {
...
void
OAITagCreate::fromJsonObject(QJsonObject json) {
...
QJsonObject
OAITagCreate::asJsonObject() const {
    QJsonObject obj;
...
OAITagCreate::getAssets() const {
    return assets;
}
void
OAITagCreate::setAssets(const QList<OAITaggedAssetBase> &assets) {
    this->assets = assets;
    this->m_assets_isSet = true;
}

QList<OAITaggedDriverBase>
OAITagCreate::getDrivers() const {
    return drivers;
}
void
OAITagCreate::setDrivers(const QList<OAITaggedDriverBase> &drivers) {
    this->drivers = drivers;
    this->m_drivers_isSet = true;
}

QList<OAITaggedMachineBase>
OAITagCreate::getMachines() const {
    return machines;
}
void
OAITagCreate::setMachines(const QList<OAITaggedMachineBase> &machines) {
    this->machines = machines;
    this->m_machines_isSet = true;
}

QString
OAITagCreate::getName() const {
    return name;
}
void
OAITagCreate::setName(const QString &name) {
    this->name = name;
    this->m_name_isSet = true;
}

qint64
OAITagCreate::getParentTagId() const {
    return parent_tag_id;
}
void
OAITagCreate::setParentTagId(const qint64 &parent_tag_id) {
    this->parent_tag_id = parent_tag_id;
    this->m_parent_tag_id_isSet = true;
}

QList<OAITaggedSensorBase>
OAITagCreate::getSensors() const {
    return sensors;
}
void
OAITagCreate::setSensors(const QList<OAITaggedSensorBase> &sensors) {
    this->sensors = sensors;
    this->m_sensors_isSet = true;
}

QList<OAITaggedVehicleBase>
OAITagCreate::getVehicles() const {
    return vehicles;
}
void
OAITagCreate::setVehicles(const QList<OAITaggedVehicleBase> &vehicles) {
    this->vehicles = vehicles;
    this->m_vehicles_isSet = true;
}

bool
OAITagCreate::isSet() const {
