...
QList<OAI_addresses_addresses>
OAIInline_object::getAddresses() const {
    return addresses;
}
void
OAIInline_object::setAddresses(const QList<OAI_addresses_addresses> &addresses) {
...
OAIInline_object::isValid() const {
    ...
    return m_addresses_isValid && true;
}
