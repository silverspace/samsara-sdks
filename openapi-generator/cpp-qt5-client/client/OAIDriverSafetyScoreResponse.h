...
/*
 * OAIDriverSafetyScoreResponse.h
 *
 * Safety score details for a driver
 */

#ifndef OAIDriverSafetyScoreResponse_H
#define OAIDriverSafetyScoreResponse_H
...
class OAIDriverSafetyScoreResponse: public OAIObject {
public:
    OAIDriverSafetyScoreResponse();
    OAIDriverSafetyScoreResponse(QString json);
    ~OAIDriverSafetyScoreResponse() override;
...
#endif // OAIDriverSafetyScoreResponse_H
