...
OAIDriversApi::OAIDriversApi(QString host, QString basePath) {
    this->host = host;
    this->basePath = basePath;
}

void
OAIDriversApi::createDriver(const QString& access_token, const OAIDriverForCreate& create_driver_param) {
    QString fullPath;
    ...
    connect(worker,
            ...
            this,
            &OAIDriversApi::createDriverCallback);

    worker->execute(&input);
}

void
OAIDriversApi::createDriverCallback(OAIHttpRequestWorker * worker) {
    QString msg;
...
void
OAIDriversApi::deactivateDriver(const QString& access_token, const QString& driver_id_or_external_id) {
    QString fullPath;
    ...
    connect(worker,
            &OAIHttpRequestWorker::on_execution_finished,
            this,
            &OAIDriversApi::deactivateDriverCallback);

    worker->execute(&input);
}

void
OAIDriversApi::deactivateDriverCallback(OAIHttpRequestWorker * worker) {
    QString msg;
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void
OAIDriversApi::getAllDeactivatedDrivers(const QString& access_token, const qint64& group_id) {
    QString fullPath;
    ...
    connect(worker,
            &OAIHttpRequestWorker::on_execution_finished,
            this,
            &OAIDriversApi::getAllDeactivatedDriversCallback);

    worker->execute(&input);
}

void
OAIDriversApi::getAllDeactivatedDriversCallback(OAIHttpRequestWorker * worker) {
    QString msg;
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void
OAIDriversApi::getDeactivatedDriverById(const QString& access_token, const QString& driver_id_or_external_id) {
    QString fullPath;
    ...
    connect(worker,
            &OAIHttpRequestWorker::on_execution_finished,
            this,
            &OAIDriversApi::getDeactivatedDriverByIdCallback);

    worker->execute(&input);
}

void
OAIDriversApi::getDeactivatedDriverByIdCallback(OAIHttpRequestWorker * worker) {
    QString msg;
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void
OAIDriversApi::getDriverById(const QString& access_token, const QString& driver_id_or_external_id) {
    QString fullPath;
    fullPath.append(this->host).append(this->basePath).append("/fleet/drivers/{driver_id_or_external_id}");
    QString driver_id_or_external_idPathParam("{"); 
    driver_id_or_external_idPathParam.append("driver_id_or_external_id").append("}");
    ...
    connect(worker,
            &OAIHttpRequestWorker::on_execution_finished,
            this,
            &OAIDriversApi::getDriverByIdCallback);

    worker->execute(&input);
}

void
OAIDriversApi::getDriverByIdCallback(OAIHttpRequestWorker * worker) {
    QString msg;
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void
OAIDriversApi::reactivateDriverById(const QString& access_token, const QString& driver_id_or_external_id, const OAIInline_object_4& reactivate_driver_param) {
    QString fullPath;
    fullPath.append(this->host).append(this->basePath).append("/fleet/drivers/inactive/{driver_id_or_external_id}");
    QString driver_id_or_external_idPathParam("{"); 
    driver_id_or_external_idPathParam.append("driver_id_or_external_id").append("}");
    ...
    connect(worker,
            &OAIHttpRequestWorker::on_execution_finished,
            this,
            &OAIDriversApi::reactivateDriverByIdCallback);

    worker->execute(&input);
}

void
OAIDriversApi::reactivateDriverByIdCallback(OAIHttpRequestWorker * worker) {
    QString msg;
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
