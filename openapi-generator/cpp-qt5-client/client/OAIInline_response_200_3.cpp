...
qint64
OAIInline_response_200_3::getGroupId() const {
    return group_id;
}
void
OAIInline_response_200_3::setGroupId(const qint64 &group_id) {
    this->group_id = group_id;
    this->m_group_id_isSet = true;
}

QList<OAIVehicleLocation>
OAIInline_response_200_3::getVehicles() const {
    return vehicles;
}
void
OAIInline_response_200_3::setVehicles(const QList<OAIVehicleLocation> &vehicles) {
