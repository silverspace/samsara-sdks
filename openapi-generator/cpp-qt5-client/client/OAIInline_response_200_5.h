...
public:
    ...
    QList<OAIInline_response_200_5_vehicleStats> getVehicleStats() const;
    void setVehicleStats(const QList<OAIInline_response_200_5_vehicleStats> &vehicle_stats);
...
private:
    void init();
    OAIPagination pagination;
    bool m_pagination_isSet;
    bool m_pagination_isValid;
    QList<OAIInline_response_200_5_vehicleStats> vehicle_stats;
    bool m_vehicle_stats_isSet;
    bool m_vehicle_stats_isValid;
};
