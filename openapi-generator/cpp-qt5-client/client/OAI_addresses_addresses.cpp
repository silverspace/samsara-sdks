...
#include "OAI_addresses_addresses.h"
...
OAI_addresses_addresses::OAI_addresses_addresses(QString json) {
    this->init();
    this->fromJson(json);
}

OAI_addresses_addresses::OAI_addresses_addresses() {
    this->init();
}
...
void
OAI_addresses_addresses::fromJson(QString jsonString) {
...
void
OAI_addresses_addresses::fromJsonObject(QJsonObject json) {
...
QString
OAI_addresses_addresses::asJson () const {
...
QJsonObject
OAI_addresses_addresses::asJsonObject() const {
    QJsonObject obj;
	if(m_notes_isSet){
...
QString
OAI_addresses_addresses::getNotes() const {
    return notes;
}
void
OAI_addresses_addresses::setNotes(const QString &notes) {
    this->notes = notes;
    this->m_notes_isSet = true;
}

QString
OAI_addresses_addresses::getFormattedAddress() const {
    return formatted_address;
}
void
OAI_addresses_addresses::setFormattedAddress(const QString &formatted_address) {
    this->formatted_address = formatted_address;
    this->m_formatted_address_isSet = true;
}

OAIAddressGeofence
OAI_addresses_addresses::getGeofence() const {
    return geofence;
}
void
OAI_addresses_addresses::setGeofence(const OAIAddressGeofence &geofence) {
    this->geofence = geofence;
    this->m_geofence_isSet = true;
}

QList<qint64>
OAI_addresses_addresses::getTagIds() const {
    return tag_ids;
}
void
OAI_addresses_addresses::setTagIds(const QList<qint64> &tag_ids) {
    this->tag_ids = tag_ids;
    this->m_tag_ids_isSet = true;
}

QString
OAI_addresses_addresses::getName() const {
    return name;
}
void
OAI_addresses_addresses::setName(const QString &name) {
    this->name = name;
    this->m_name_isSet = true;
}

QList<qint64>
OAI_addresses_addresses::getContactIds() const {
    return contact_ids;
}
void
OAI_addresses_addresses::setContactIds(const QList<qint64> &contact_ids) {
    this->contact_ids = contact_ids;
    this->m_contact_ids_isSet = true;
}

bool
OAI_addresses_addresses::isSet() const {
...
bool
OAI_addresses_addresses::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_formatted_address_isValid && m_geofence_isValid && m_name_isValid && true;
}
