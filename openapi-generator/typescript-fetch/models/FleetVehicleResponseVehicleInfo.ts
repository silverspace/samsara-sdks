...
export function FleetVehicleResponseVehicleInfoFromJSON(json: any): FleetVehicleResponseVehicleInfo {
    return {
...
export function FleetVehicleResponseVehicleInfoToJSON(value?: FleetVehicleResponseVehicleInfo): any {
    if (value === undefined) {
        return undefined;
    }
    return {
