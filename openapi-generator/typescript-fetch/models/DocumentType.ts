...
import {
    DocumentFieldType,
    DocumentFieldTypeFromJSON,
    DocumentFieldTypeToJSON,
} from './';
...
export function DocumentTypeFromJSON(json: any): DocumentType {
    return {
        'fieldTypes': !exists(json, 'fieldTypes') ? undefined : json['fieldTypes'],
        'name': json['name'],
        'orgId': json['orgId'],
        'uuid': json['uuid'],
    };
...
export function DocumentTypeToJSON(value?: DocumentType): any {
    if (value === undefined) {
        return undefined;
    }
    return {
