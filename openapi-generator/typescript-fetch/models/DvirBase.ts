...
import {
    ...
    DvirBaseAuthorSignatureFromJSON,
    DvirBaseAuthorSignatureToJSON,
    DvirBaseMechanicOrAgentSignature,
    DvirBaseMechanicOrAgentSignatureFromJSON,
    DvirBaseMechanicOrAgentSignatureToJSON,
    DvirBaseNextDriverSignature,
    DvirBaseNextDriverSignatureFromJSON,
    DvirBaseNextDriverSignatureToJSON,
    DvirBaseTrailerDefects,
    DvirBaseTrailerDefectsFromJSON,
    DvirBaseTrailerDefectsToJSON,
    DvirBaseVehicle,
    DvirBaseVehicleFromJSON,
    DvirBaseVehicleToJSON,
} from './';
...
export function DvirBaseFromJSON(json: any): DvirBase {
    return {
        'authorSignature': !exists(json, 'authorSignature') ? undefined : DvirBaseAuthorSignatureFromJSON(json['authorSignature']),
        ...
        'mechanicOrAgentSignature': !exists(json, 'mechanicOrAgentSignature') ? undefined : DvirBaseMechanicOrAgentSignatureFromJSON(json['mechanicOrAgentSignature']),
        'nextDriverSignature': !exists(json, 'nextDriverSignature') ? undefined : DvirBaseNextDriverSignatureFromJSON(json['nextDriverSignature']),
        'odometerMiles': !exists(json, 'odometerMiles') ? undefined : json['odometerMiles'],
        'timeMs': !exists(json, 'timeMs') ? undefined : json['timeMs'],
        'trailerDefects': !exists(json, 'trailerDefects') ? undefined : (json['trailerDefects'] as Array<any>).map(DvirBaseTrailerDefectsFromJSON),
        'trailerId': !exists(json, 'trailerId') ? undefined : json['trailerId'],
        'trailerName': !exists(json, 'trailerName') ? undefined : json['trailerName'],
        'vehicle': !exists(json, 'vehicle') ? undefined : DvirBaseVehicleFromJSON(json['vehicle']),
        'vehicleCondition': !exists(json, 'vehicleCondition') ? undefined : json['vehicleCondition'],
        'vehicleDefects': !exists(json, 'vehicleDefects') ? undefined : (json['vehicleDefects'] as Array<any>).map(DvirBaseTrailerDefectsFromJSON),
    };
}

export function DvirBaseToJSON(value?: DvirBase): any {
    if (value === undefined) {
        return undefined;
    }
    return {
        'authorSignature': DvirBaseAuthorSignatureToJSON(value.authorSignature),
        ...
        'mechanicOrAgentSignature': DvirBaseMechanicOrAgentSignatureToJSON(value.mechanicOrAgentSignature),
        'nextDriverSignature': DvirBaseNextDriverSignatureToJSON(value.nextDriverSignature),
        'odometerMiles': value.odometerMiles,
        'timeMs': value.timeMs,
        'trailerDefects': (value.trailerDefects as Array<any>).map(DvirBaseTrailerDefectsToJSON),
        'trailerId': value.trailerId,
        'trailerName': value.trailerName,
        'vehicle': DvirBaseVehicleToJSON(value.vehicle),
        'vehicleCondition': value.vehicleCondition,
        'vehicleDefects': (value.vehicleDefects as Array<any>).map(DvirBaseTrailerDefectsToJSON),
    };
}
