...
import {
    ...
    SafetyReportHarshEventFromJSON,
    SafetyReportHarshEventToJSON,
} from './';
...
export function VehicleSafetyScoreResponseFromJSON(json: any): VehicleSafetyScoreResponse {
    return {
        ...
        'harshEvents': !exists(json, 'harshEvents') ? undefined : (json['harshEvents'] as Array<any>).map(SafetyReportHarshEventFromJSON),
...
export function VehicleSafetyScoreResponseToJSON(value?: VehicleSafetyScoreResponse): any {
    if (value === undefined) {
        return undefined;
    }
    return {
        ...
        'harshEvents': (value.harshEvents as Array<any>).map(SafetyReportHarshEventToJSON),
