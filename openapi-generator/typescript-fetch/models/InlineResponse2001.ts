...
import {
    ...
    AssetCurrentLocationsResponseFromJSON,
    AssetCurrentLocationsResponseToJSON,
} from './';
...
export function InlineResponse2001FromJSON(json: any): InlineResponse2001 {
    return {
        'assets': !exists(json, 'assets') ? undefined : (json['assets'] as Array<any>).map(AssetCurrentLocationsResponseFromJSON),
    };
}
...
export function InlineResponse2001ToJSON(value?: InlineResponse2001): any {
    ...
    return {
        'assets': (value.assets as Array<any>).map(AssetCurrentLocationsResponseToJSON),
    };
}
