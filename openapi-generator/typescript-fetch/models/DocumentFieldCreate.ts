...
import {
    ...
    DocumentFieldCreatePhotoValueFromJSON,
    DocumentFieldCreatePhotoValueToJSON,
} from './';
...
export function DocumentFieldCreateFromJSON(json: any): DocumentFieldCreate {
    return {
        'numberValue': !exists(json, 'numberValue') ? undefined : json['numberValue'],
        'photoValue': !exists(json, 'photoValue') ? undefined : (json['photoValue'] as Array<any>).map(DocumentFieldCreatePhotoValueFromJSON),
        'stringValue': !exists(json, 'stringValue') ? undefined : json['stringValue'],
        'valueType': json['valueType'],
    };
}

export function DocumentFieldCreateToJSON(value?: DocumentFieldCreate): any {
    if (value === undefined) {
        return undefined;
    }
    return {
        'numberValue': value.numberValue,
        'photoValue': (value.photoValue as Array<any>).map(DocumentFieldCreatePhotoValueToJSON),
