...
export function DvirBaseTrailerDefectsFromJSON(json: any): DvirBaseTrailerDefects {
    return {
...
export function DvirBaseTrailerDefectsToJSON(value?: DvirBaseTrailerDefects): any {
    if (value === undefined) {
        return undefined;
    }
    return {
