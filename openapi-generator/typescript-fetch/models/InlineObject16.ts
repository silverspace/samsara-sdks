...
export function InlineObject16FromJSON(json: any): InlineObject16 {
    return {
        ...
        'harshAccelSetting': !exists(json, 'harsh_accel_setting') ? undefined : json['harsh_accel_setting'],
        'name': !exists(json, 'name') ? undefined : json['name'],
    };
}

export function InlineObject16ToJSON(value?: InlineObject16): any {
    if (value === undefined) {
        return undefined;
    }
    return {
        'externalIds': value.externalIds,
        'harsh_accel_setting': value.harshAccelSetting,
        'name': value.name,
    };
}
