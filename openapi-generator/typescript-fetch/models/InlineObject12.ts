...
export function InlineObject12FromJSON(json: any): InlineObject12 {
    return {
        ...
        'previousDefectsCorrected': !exists(json, 'previousDefectsCorrected') ? undefined : json['previousDefectsCorrected'],
        'previousDefectsIgnored': !exists(json, 'previousDefectsIgnored') ? undefined : json['previousDefectsIgnored'],
        'safe': json['safe'],
...
export function InlineObject12ToJSON(value?: InlineObject12): any {
    if (value === undefined) {
        return undefined;
    }
    return {
        ...
        'previousDefectsCorrected': value.previousDefectsCorrected,
        'previousDefectsIgnored': value.previousDefectsIgnored,
        'safe': value.safe,
