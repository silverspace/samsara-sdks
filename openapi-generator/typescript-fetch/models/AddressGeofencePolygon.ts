...
import {
    ...
    AddressGeofencePolygonVerticesFromJSON,
    AddressGeofencePolygonVerticesToJSON,
} from './';
...
export function AddressGeofencePolygonFromJSON(json: any): AddressGeofencePolygon {
    return {
        'vertices': !exists(json, 'vertices') ? undefined : (json['vertices'] as Array<any>).map(AddressGeofencePolygonVerticesFromJSON),
    };
}

export function AddressGeofencePolygonToJSON(value?: AddressGeofencePolygon): any {
    if (value === undefined) {
        return undefined;
    }
    return {
        'vertices': (value.vertices as Array<any>).map(AddressGeofencePolygonVerticesToJSON),
    };
}
