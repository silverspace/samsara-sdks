...
export function DriverSafetyScoreResponseFromJSON(json: any): DriverSafetyScoreResponse {
    return {
...
export function DriverSafetyScoreResponseToJSON(value?: DriverSafetyScoreResponse): any {
    if (value === undefined) {
        return undefined;
    }
    return {
