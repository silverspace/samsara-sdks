...
export function UserFromJSON(json: any): User {
    return {
        ...
        'organizationRole': !exists(json, 'organizationRole') ? undefined : json['organizationRole'],
        'tagRoles': !exists(json, 'tagRoles') ? undefined : (json['tagRoles'] as Array<any>).map(UserTagRoleFromJSON),
    };
}
...
export function UserToJSON(value?: User): any {
    ...
    return {
        ...
        'tagRoles': (value.tagRoles as Array<any>).map(UserTagRoleToJSON),
    };
}
