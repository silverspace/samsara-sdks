...
export function SensorHistoryResponseResultsFromJSON(json: any): SensorHistoryResponseResults {
    return {
...
export function SensorHistoryResponseResultsToJSON(value?: SensorHistoryResponseResults): any {
    if (value === undefined) {
        return undefined;
    }
    return {
