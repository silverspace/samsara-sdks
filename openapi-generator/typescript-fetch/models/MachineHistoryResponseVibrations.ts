...
export function MachineHistoryResponseVibrationsFromJSON(json: any): MachineHistoryResponseVibrations {
    return {
...
export function MachineHistoryResponseVibrationsToJSON(value?: MachineHistoryResponseVibrations): any {
    if (value === undefined) {
        return undefined;
    }
    return {
