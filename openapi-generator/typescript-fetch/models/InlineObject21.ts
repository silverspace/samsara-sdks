...
import {
    ...
    SensorsHistorySeriesFromJSON,
    SensorsHistorySeriesToJSON,
} from './';
...
export function InlineObject21FromJSON(json: any): InlineObject21 {
    return {
        'endMs': json['endMs'],
        'fillMissing': !exists(json, 'fillMissing') ? undefined : json['fillMissing'],
        'groupId': json['groupId'],
        'series': (json['series'] as Array<any>).map(SensorsHistorySeriesFromJSON),
        'startMs': json['startMs'],
        'stepMs': json['stepMs'],
    };
}

export function InlineObject21ToJSON(value?: InlineObject21): any {
    if (value === undefined) {
        return undefined;
    }
    return {
        'endMs': value.endMs,
        'fillMissing': value.fillMissing,
        'groupId': value.groupId,
        'series': (value.series as Array<any>).map(SensorsHistorySeriesToJSON),
