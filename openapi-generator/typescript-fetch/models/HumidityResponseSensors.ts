...
export function HumidityResponseSensorsFromJSON(json: any): HumidityResponseSensors {
    return {
...
export function HumidityResponseSensorsToJSON(value?: HumidityResponseSensors): any {
    if (value === undefined) {
        return undefined;
    }
    return {
