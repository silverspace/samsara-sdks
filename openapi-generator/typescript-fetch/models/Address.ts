...
export function AddressFromJSON(json: any): Address {
    return {
        ...
        'geofence': !exists(json, 'geofence') ? undefined : AddressGeofenceFromJSON(json['geofence']),
        'id': !exists(json, 'id') ? undefined : json['id'],
        'name': !exists(json, 'name') ? undefined : json['name'],
        'notes': !exists(json, 'notes') ? undefined : json['notes'],
        'tags': !exists(json, 'tags') ? undefined : (json['tags'] as Array<any>).map(TagMetadataFromJSON),
    };
}
...
export function AddressToJSON(value?: Address): any {
    ...
    return {
        ...
        'name': value.name,
        'notes': value.notes,
        'tags': (value.tags as Array<any>).map(TagMetadataToJSON),
    };
}
