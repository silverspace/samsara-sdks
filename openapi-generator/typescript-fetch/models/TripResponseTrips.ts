...
import {
    ...
    TripResponseEndCoordinatesFromJSON,
    TripResponseEndCoordinatesToJSON,
    TripResponseStartCoordinates,
    TripResponseStartCoordinatesFromJSON,
    TripResponseStartCoordinatesToJSON,
} from './';
...
export function TripResponseTripsFromJSON(json: any): TripResponseTrips {
    return {
        ...
        'startCoordinates': !exists(json, 'startCoordinates') ? undefined : TripResponseStartCoordinatesFromJSON(json['startCoordinates']),
        'endCoordinates': !exists(json, 'endCoordinates') ? undefined : TripResponseEndCoordinatesFromJSON(json['endCoordinates']),
...
export function TripResponseTripsToJSON(value?: TripResponseTrips): any {
    if (value === undefined) {
        return undefined;
    }
    return {
        ...
        'startCoordinates': TripResponseStartCoordinatesToJSON(value.startCoordinates),
        'endCoordinates': TripResponseEndCoordinatesToJSON(value.endCoordinates),
