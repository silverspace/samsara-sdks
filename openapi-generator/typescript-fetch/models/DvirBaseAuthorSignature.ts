...
export function DvirBaseAuthorSignatureFromJSON(json: any): DvirBaseAuthorSignature {
    return {
...
export function DvirBaseAuthorSignatureToJSON(value?: DvirBaseAuthorSignature): any {
    if (value === undefined) {
        return undefined;
    }
    return {
