...
export function AddressGeofenceCircleFromJSON(json: any): AddressGeofenceCircle {
    return {
        'latitude': !exists(json, 'latitude') ? undefined : json['latitude'],
        'radiusMeters': !exists(json, 'radiusMeters') ? undefined : json['radiusMeters'],
        'longitude': !exists(json, 'longitude') ? undefined : json['longitude'],
    };
}

export function AddressGeofenceCircleToJSON(value?: AddressGeofenceCircle): any {
    if (value === undefined) {
        return undefined;
    }
    return {
