...
export function DvirBaseMechanicOrAgentSignatureFromJSON(json: any): DvirBaseMechanicOrAgentSignature {
    return {
...
export function DvirBaseMechanicOrAgentSignatureToJSON(value?: DvirBaseMechanicOrAgentSignature): any {
    if (value === undefined) {
        return undefined;
    }
    return {
