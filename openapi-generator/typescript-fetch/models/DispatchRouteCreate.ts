...
import {
    ...
    DispatchRouteBase,
    DispatchRouteBaseFromJSON,
    DispatchRouteBaseToJSON,
} from './';
...
export function DispatchRouteCreateFromJSON(json: any): DispatchRouteCreate {
    return {
        'dispatchJobs': (json['dispatch_jobs'] as Array<any>).map(DispatchJobCreateFromJSON),
    };
}

export function DispatchRouteCreateToJSON(value?: DispatchRouteCreate): any {
    if (value === undefined) {
        return undefined;
    }
    return {
        'dispatch_jobs': (value.dispatchJobs as Array<any>).map(DispatchJobCreateToJSON),
    };
}
