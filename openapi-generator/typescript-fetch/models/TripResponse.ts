...
import {
    TripResponseTrips,
    TripResponseTripsFromJSON,
    TripResponseTripsToJSON,
} from './';
...
export function TripResponseFromJSON(json: any): TripResponse {
    return {
        'trips': !exists(json, 'trips') ? undefined : (json['trips'] as Array<any>).map(TripResponseTripsFromJSON),
    };
}

export function TripResponseToJSON(value?: TripResponse): any {
    if (value === undefined) {
        return undefined;
    }
    return {
        'trips': (value.trips as Array<any>).map(TripResponseTripsToJSON),
    };
}
