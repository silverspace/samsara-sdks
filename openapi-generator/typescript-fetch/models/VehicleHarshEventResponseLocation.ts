...
export function VehicleHarshEventResponseLocationFromJSON(json: any): VehicleHarshEventResponseLocation {
    return {
...
export function VehicleHarshEventResponseLocationToJSON(value?: VehicleHarshEventResponseLocation): any {
    if (value === undefined) {
        return undefined;
    }
    return {
