...
export function DvirBaseNextDriverSignatureFromJSON(json: any): DvirBaseNextDriverSignature {
    return {
...
export function DvirBaseNextDriverSignatureToJSON(value?: DvirBaseNextDriverSignature): any {
    if (value === undefined) {
        return undefined;
    }
    return {
