...
export function DocumentCreateFromJSON(json: any): DocumentCreate {
    return {
        ...
        'fields': (json['fields'] as Array<any>).map(DocumentFieldFromJSON),
    };
}

export function DocumentCreateToJSON(value?: DocumentCreate): any {
    if (value === undefined) {
        return undefined;
    }
    return {
        'documentTypeUuid': value.documentTypeUuid,
        'fields': (value.fields as Array<any>).map(DocumentFieldToJSON),
    };
}
