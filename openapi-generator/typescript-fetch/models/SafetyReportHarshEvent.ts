...
export function SafetyReportHarshEventFromJSON(json: any): SafetyReportHarshEvent {
    return {
        'harshEventType': !exists(json, 'harshEventType') ? undefined : json['harshEventType'],
        'timestampMs': !exists(json, 'timestampMs') ? undefined : json['timestampMs'],
        'vehicleId': !exists(json, 'vehicleId') ? undefined : json['vehicleId'],
    };
}

export function SafetyReportHarshEventToJSON(value?: SafetyReportHarshEvent): any {
    if (value === undefined) {
        return undefined;
    }
    return {
