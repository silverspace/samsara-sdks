...
export function TemperatureResponseSensorsFromJSON(json: any): TemperatureResponseSensors {
    return {
        'probeTemperature': !exists(json, 'probeTemperature') ? undefined : json['probeTemperature'],
        'name': !exists(json, 'name') ? undefined : json['name'],
        'id': !exists(json, 'id') ? undefined : json['id'],
        'ambientTemperature': !exists(json, 'ambientTemperature') ? undefined : json['ambientTemperature'],
    };
}

export function TemperatureResponseSensorsToJSON(value?: TemperatureResponseSensors): any {
    if (value === undefined) {
        return undefined;
    }
    return {
