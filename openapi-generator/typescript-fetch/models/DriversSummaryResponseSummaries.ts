...
export function DriversSummaryResponseSummariesFromJSON(json: any): DriversSummaryResponseSummaries {
    return {
        ...
        'driveMs': !exists(json, 'driveMs') ? undefined : json['driveMs'],
        'activeMs': !exists(json, 'activeMs') ? undefined : json['activeMs'],
        'driverUsername': !exists(json, 'driverUsername') ? undefined : json['driverUsername'],
        'groupId': !exists(json, 'groupId') ? undefined : json['groupId'],
        'driverName': !exists(json, 'driverName') ? undefined : json['driverName'],
        'onDutyMs': !exists(json, 'onDutyMs') ? undefined : json['onDutyMs'],
    };
}

export function DriversSummaryResponseSummariesToJSON(value?: DriversSummaryResponseSummaries): any {
    if (value === undefined) {
        return undefined;
    }
    return {
        ...
        'driveMs': value.driveMs,
        'activeMs': value.activeMs,
        'driverUsername': value.driverUsername,
        'groupId': value.groupId,
        'driverName': value.driverName,
        'onDutyMs': value.onDutyMs,
    };
}
