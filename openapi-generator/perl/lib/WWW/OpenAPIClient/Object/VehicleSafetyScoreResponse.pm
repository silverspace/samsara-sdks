...
#
package WWW::OpenAPIClient::Object::VehicleSafetyScoreResponse;
...
__PACKAGE__->class_documentation({description => 'Safety score details for a vehicle',
...
__PACKAGE__->method_documentation({
    ...
    'harsh_braking_count' => {
        datatype => 'int',
        base_name => 'harshBrakingCount',
        description => 'Harsh braking event count',
        format => '',
        read_only => '',
            },
    'harsh_events' => {
        datatype => 'ARRAY[SafetyReportHarshEvent]',
        base_name => 'harshEvents',
        description => '',
        format => '',
        read_only => '',
            },
    ...
    'time_over_speed_limit_ms' => {
        datatype => 'int',
        base_name => 'timeOverSpeedLimitMs',
    ...
    'total_distance_driven_meters' => {
        datatype => 'int',
        base_name => 'totalDistanceDrivenMeters',
    ...
    'total_harsh_event_count' => {
        datatype => 'int',
        base_name => 'totalHarshEventCount',
