...
#
package WWW::OpenAPIClient::Object::VehicleMaintenance;
...
__PACKAGE__->class_documentation({description => 'Contains any J1939/Passenger engine light warnings and engine faults.',
...
__PACKAGE__->method_documentation({
    ...
    'j1939' => {
        datatype => 'VehicleMaintenanceJ1939',
        base_name => 'j1939',
        description => '',
        format => '',
        read_only => '',
    ...
    'passenger' => {
        datatype => 'VehicleMaintenancePassenger',
        base_name => 'passenger',
        description => '',
        format => '',
        read_only => '',
