...
#
package WWW::OpenAPIClient::Object::VehicleMaintenancePassenger;
...
__PACKAGE__->class_documentation({description => 'Passenger vehicle data. Null if no data is available.',
...
__PACKAGE__->method_documentation({
    'check_engine_light' => {
        datatype => 'VehicleMaintenancePassengerCheckEngineLight',
        base_name => 'checkEngineLight',
        description => '',
        format => '',
        read_only => '',
            },
    'diagnostic_trouble_codes' => {
        datatype => 'ARRAY[VehicleMaintenancePassengerDiagnosticTroubleCodes]',
        base_name => 'diagnosticTroubleCodes',
