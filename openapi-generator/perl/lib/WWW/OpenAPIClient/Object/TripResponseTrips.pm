...
#
package WWW::OpenAPIClient::Object::TripResponseTrips;
...
__PACKAGE__->method_documentation({
    ...
    'start_address' => {
        datatype => 'string',
        base_name => 'startAddress',
        description => 'Text representation of nearest identifiable location to the start (latitude, longitude) coordinates.',
        format => '',
        read_only => '',
            },
    'start_coordinates' => {
        datatype => 'TripResponseStartCoordinates',
        base_name => 'startCoordinates',
        description => '',
        format => '',
        read_only => '',
            },
    'end_coordinates' => {
        datatype => 'TripResponseEndCoordinates',
        base_name => 'endCoordinates',
        description => '',
        format => '',
        read_only => '',
            },
