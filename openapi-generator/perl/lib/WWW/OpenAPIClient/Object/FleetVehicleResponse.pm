...
#
package WWW::OpenAPIClient::Object::FleetVehicleResponse;
...
__PACKAGE__->class_documentation({description => 'A vehicle object as returned for fleet/vehicle',
...
__PACKAGE__->method_documentation({
    ...
    'vehicle_info' => {
        datatype => 'FleetVehicleResponseVehicleInfo',
        base_name => 'vehicleInfo',
        description => '',
        format => '',
        read_only => '',
            },
