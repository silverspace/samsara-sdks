...
#
package WWW::OpenAPIClient::Object::AddressGeofenceCircle;
...
__PACKAGE__->class_documentation({description => 'Information about a circular geofence. This field is only populated if the geofence is a circle.',
