...
#
package WWW::OpenAPIClient::Object::AddressGeofence;
...
__PACKAGE__->class_documentation({description => 'The geofence that defines this address and its bounds. This can either be a circle, or a polygon - only one key should be provided, depending on the geofence type.',
...
__PACKAGE__->method_documentation({
    'circle' => {
        datatype => 'AddressGeofenceCircle',
        base_name => 'circle',
        description => '',
        format => '',
        read_only => '',
    ...
    'polygon' => {
        datatype => 'AddressGeofencePolygon',
        base_name => 'polygon',
        description => '',
        format => '',
        read_only => '',
