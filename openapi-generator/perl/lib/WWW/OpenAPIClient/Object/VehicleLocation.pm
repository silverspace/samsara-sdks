...
#
package WWW::OpenAPIClient::Object::VehicleLocation;
...
__PACKAGE__->class_documentation({description => 'Contains the location, in latitude and longitude, of a vehicle.',
