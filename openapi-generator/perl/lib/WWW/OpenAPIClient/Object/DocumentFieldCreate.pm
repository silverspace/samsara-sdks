...
#
package WWW::OpenAPIClient::Object::DocumentFieldCreate;
...
__PACKAGE__->method_documentation({
    'number_value' => {
        datatype => 'double',
        base_name => 'numberValue',
        description => 'Value of this field if this document field has valueType: ValueType_Number.',
        format => '',
        read_only => '',
            },
    'photo_value' => {
        datatype => 'ARRAY[DocumentFieldCreatePhotoValue]',
        base_name => 'photoValue',
