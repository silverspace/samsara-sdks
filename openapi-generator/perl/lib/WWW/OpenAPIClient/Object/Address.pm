...
__PACKAGE__->class_documentation({description => 'Information about an address/geofence. Geofences are either a circle or a polygon.',
                                  class => 'Address',
                                  required => [], # TODO
}                                 );
