...
#
package WWW::OpenAPIClient::Object::DocumentFieldTypeNumberValueTypeMetadata;
...
__PACKAGE__->class_documentation({description => 'Additional metadata information for a number field type. Only defined when a field type has valueType: ValueType_Number.',
