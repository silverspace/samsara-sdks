...
use_ok('WWW::OpenAPIClient::FleetApi');

my $api = WWW::OpenAPIClient::FleetApi->new();
isa_ok($api, 'WWW::OpenAPIClient::FleetApi');
...
#
{
    ...
    my $result = $api->update_organization_address(access_token => $access_token, address_id => $address_id, address => $address);
}
