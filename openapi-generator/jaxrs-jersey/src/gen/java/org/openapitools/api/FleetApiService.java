...
public abstract class FleetApiService {
    public abstract Response addFleetAddress( @NotNull String accessToken,InlineObject2 addressParam,SecurityContext securityContext) throws NotFoundException;
    ...
    public abstract Response createDvir( @NotNull String accessToken,InlineObject12 createDvirParam,SecurityContext securityContext) throws NotFoundException;
    ...
    public abstract Response getFleetDrivers( @NotNull String accessToken,InlineObject3 groupDriversParam,SecurityContext securityContext) throws NotFoundException;
    public abstract Response getFleetDriversHosDailyLogs( @NotNull String accessToken,Long driverId,InlineObject6 hosLogsParam,SecurityContext securityContext) throws NotFoundException;
    public abstract Response getFleetDriversSummary( @NotNull String accessToken,InlineObject5 driversSummaryParam,Boolean snapToDayBounds,SecurityContext securityContext) throws NotFoundException;
    public abstract Response getFleetHosAuthenticationLogs( @NotNull String accessToken,InlineObject7 hosAuthenticationLogsParam,SecurityContext securityContext) throws NotFoundException;
    public abstract Response getFleetHosLogs( @NotNull String accessToken,InlineObject8 hosLogsParam,SecurityContext securityContext) throws NotFoundException;
    public abstract Response getFleetHosLogsSummary( @NotNull String accessToken,InlineObject9 hosLogsParam,SecurityContext securityContext) throws NotFoundException;
    public abstract Response getFleetLocations( @NotNull String accessToken,InlineObject11 groupParam,SecurityContext securityContext) throws NotFoundException;
    public abstract Response getFleetMaintenanceList( @NotNull String accessToken,InlineObject13 groupParam,SecurityContext securityContext) throws NotFoundException;
    public abstract Response getFleetTrips( @NotNull String accessToken,InlineObject15 tripsParam,SecurityContext securityContext) throws NotFoundException;
    ...
    public abstract Response listFleet( @NotNull String accessToken,InlineObject10 groupParam,String startingAfter,String endingBefore,Long limit,SecurityContext securityContext) throws NotFoundException;
    public abstract Response patchFleetVehicle( @NotNull String accessToken,String vehicleIdOrExternalId,InlineObject16 data,SecurityContext securityContext) throws NotFoundException;
    public abstract Response reactivateDriverById( @NotNull String accessToken,String driverIdOrExternalId,InlineObject4 reactivateDriverParam,SecurityContext securityContext) throws NotFoundException;
    ...
    public abstract Response updateVehicles( @NotNull String accessToken,InlineObject14 vehicleUpdateParam,SecurityContext securityContext) throws NotFoundException;
}
