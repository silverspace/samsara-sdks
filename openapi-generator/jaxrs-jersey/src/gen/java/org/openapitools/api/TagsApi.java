...
,@ApiParam(value = "" ,required=true) @NotNull @Valid TagCreate tagCreateParams
...
,@ApiParam(value = "ID of the tag.",required=true) @PathParam("tag_id") Long tagId
,@ApiParam(value = "" ,required=true) @NotNull @Valid TagModify tagModifyParams
,@Context SecurityContext securityContext)
    throws NotFoundException {
...
,@ApiParam(value = "ID of the tag.",required=true) @PathParam("tag_id") Long tagId
,@ApiParam(value = "" ,required=true) @NotNull @Valid TagUpdate updateTagParams
,@Context SecurityContext securityContext)
    throws NotFoundException {
