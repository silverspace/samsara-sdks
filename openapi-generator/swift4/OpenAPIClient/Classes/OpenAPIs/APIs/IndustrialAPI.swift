...
open class IndustrialAPI {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getMachines(accessToken: String, groupParam: InlineObject18, completion: @escaping ((_ data: InlineResponse2007?,_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getMachinesHistory(accessToken: String, historyParam: InlineObject17, completion: @escaping ((_ data: MachineHistoryResponse?,_ error: Error?) -> Void)) {
