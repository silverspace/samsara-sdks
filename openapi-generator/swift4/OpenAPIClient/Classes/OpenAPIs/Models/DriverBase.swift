...
public struct DriverBase: Codable {
    ...
    public var eldPcEnabled: Bool? = false
    /** Flag indicating this driver may select the Yard Move duty status in ELD logs. */
    public var eldYmEnabled: Bool? = false
    ...
    public init(eldAdverseWeatherExemptionEnabled: Bool?, eldBigDayExemptionEnabled: Bool?, eldDayStartHour: Int?, eldExempt: Bool?, eldExemptReason: String?, eldPcEnabled: Bool?, eldYmEnabled: Bool?, externalIds: [String:String]?, groupId: Int64?, licenseNumber: String?, licenseState: String?, name: String, notes: String?, phone: String?, username: String?, vehicleId: Int64?) {
