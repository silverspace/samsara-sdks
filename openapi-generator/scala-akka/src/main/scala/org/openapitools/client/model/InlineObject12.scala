...
case class InlineObject12 (
  ...
  previousDefectsCorrected: Option[Boolean] = None,
  ...
  previousDefectsIgnored: Option[Boolean] = None,
  /* Whether or not this vehicle or trailer is safe to drive. */
  safe: InlineObject12Enums.Safe,
...
object InlineObject12Enums {

  type InspectionType = InspectionType.Value
  type Safe = Safe.Value
  object InspectionType extends Enumeration {
    val Mechanic = Value("mechanic")
  }

  object Safe extends Enumeration {
    val Safe = Value("safe")
    val Unsafe = Value("unsafe")
  }
