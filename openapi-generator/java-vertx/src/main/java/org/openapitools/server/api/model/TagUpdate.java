...
public class TagUpdate   {
  ...
  public TagUpdate (List<TaggedAssetBase> assets, List<TaggedDriverBase> drivers, List<TaggedMachineBase> machines, String name, Long parentTagId, List<TaggedSensorBase> sensors, List<TaggedVehicleBase> vehicles) {
    this.assets = assets;
