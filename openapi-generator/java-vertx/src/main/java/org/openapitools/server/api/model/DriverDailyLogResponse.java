...
import org.openapitools.server.api.model.DriverDailyLogResponseDays;

@JsonInclude(JsonInclude.Include.NON_NULL) 
public class DriverDailyLogResponse   {
  
  private List<DriverDailyLogResponseDays> days = new ArrayList<>();

  public DriverDailyLogResponse () {

  }

  public DriverDailyLogResponse (List<DriverDailyLogResponseDays> days) {
    this.days = days;
  }
