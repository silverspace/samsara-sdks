...
public class TagModifyAdd   {
  ...
  public TagModifyAdd (List<TaggedAssetBase> assets, List<TaggedSensorBase> sensors, List<TaggedVehicleBase> vehicles, List<TaggedMachineBase> machines, List<TaggedDriverBase> drivers) {
    this.assets = assets;
