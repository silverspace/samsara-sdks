...
import org.openapitools.server.api.model.HumidityResponseSensors;
...
public class HumidityResponse   {
  ...
  private List<HumidityResponseSensors> sensors = new ArrayList<>();

  public HumidityResponse () {

  }

  public HumidityResponse (Long groupId, List<HumidityResponseSensors> sensors) {
