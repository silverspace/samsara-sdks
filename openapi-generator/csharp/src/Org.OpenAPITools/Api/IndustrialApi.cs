...
namespace Org.OpenAPITools.Api
{
    ...
    public partial class IndustrialApi : IIndustrialApi
    {
        ...
        /// <returns></returns>
        public IndustrialApi(Org.OpenAPITools.Client.Configuration configuration = null)
        {
        ...
        /// <param name="groupParam"></param>
        /// <returns>ApiResponse of InlineResponse2007</returns>
        public ApiResponse< InlineResponse2007 > GetMachinesWithHttpInfo (string accessToken, InlineObject18 groupParam)
        {
            // verify the required parameter 'accessToken' is set
            if (accessToken == null)
        ...
        /// <param name="groupParam"></param>
        /// <returns>Task of ApiResponse (InlineResponse2007)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<InlineResponse2007>> GetMachinesAsyncWithHttpInfo (string accessToken, InlineObject18 groupParam)
        {
            // verify the required parameter 'accessToken' is set
            if (accessToken == null)
                throw new ApiException(400, "Missing required parameter 'accessToken' when calling IndustrialApi->GetMachines");
        ...
        /// <param name="historyParam"></param>
        /// <returns>ApiResponse of MachineHistoryResponse</returns>
        public ApiResponse< MachineHistoryResponse > GetMachinesHistoryWithHttpInfo (string accessToken, InlineObject17 historyParam)
        {
            // verify the required parameter 'accessToken' is set
            if (accessToken == null)
        ...
        /// <param name="historyParam"></param>
        /// <returns>Task of ApiResponse (MachineHistoryResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<MachineHistoryResponse>> GetMachinesHistoryAsyncWithHttpInfo (string accessToken, InlineObject17 historyParam)
        {
            // verify the required parameter 'accessToken' is set
            if (accessToken == null)
                throw new ApiException(400, "Missing required parameter 'accessToken' when calling IndustrialApi->GetMachinesHistory");
