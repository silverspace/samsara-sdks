...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class InlineObject15 :  IEquatable<InlineObject15>, IValidatableObject
    {
        ...
        public InlineObject15(int? endMs = default(int?), long? groupId = default(long?), int? startMs = default(int?), long? vehicleId = default(long?))
        {
            // to ensure "endMs" is required (not null)
            if (endMs == null)
            {
                throw new InvalidDataException("endMs is a required property for InlineObject15 and cannot be null");
            }
            else
            {
                this.EndMs = endMs;
            ...
            if (groupId == null)
            {
                throw new InvalidDataException("groupId is a required property for InlineObject15 and cannot be null");
            }
            else
            {
            ...
            if (startMs == null)
            {
                throw new InvalidDataException("startMs is a required property for InlineObject15 and cannot be null");
            }
            else
            {
            ...
            if (vehicleId == null)
            {
                throw new InvalidDataException("vehicleId is a required property for InlineObject15 and cannot be null");
            }
            else
            {
