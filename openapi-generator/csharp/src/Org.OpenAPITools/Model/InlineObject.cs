...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class InlineObject :  IEquatable<InlineObject>, IValidatableObject
    {
        ...
        public InlineObject(List<AddressesAddresses> addresses = default(List<AddressesAddresses>))
        {
            // to ensure "addresses" is required (not null)
            if (addresses == null)
            {
                throw new InvalidDataException("addresses is a required property for InlineObject and cannot be null");
            }
            else
            {
        ...
        public List<AddressesAddresses> Addresses { get; set; }
