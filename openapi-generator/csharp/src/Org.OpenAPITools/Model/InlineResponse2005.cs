...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class InlineResponse2005 :  IEquatable<InlineResponse2005>, IValidatableObject
    {
        ...
        /// <param name="vehicleStats">vehicleStats (required).</param>
        public InlineResponse2005(Pagination pagination = default(Pagination), List<InlineResponse2005VehicleStats> vehicleStats = default(List<InlineResponse2005VehicleStats>))
        {
            // to ensure "vehicleStats" is required (not null)
            if (vehicleStats == null)
            {
                throw new InvalidDataException("vehicleStats is a required property for InlineResponse2005 and cannot be null");
            }
            else
            {
        ...
        public bool Equals(InlineResponse2005 input)
        {
            ...
            return 
                ...
                (
                    this.VehicleStats == input.VehicleStats ||
                    this.VehicleStats != null &&
                    this.VehicleStats.SequenceEqual(input.VehicleStats)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.VehicleStats != null)
                    hashCode = hashCode * 59 + this.VehicleStats.GetHashCode();
                return hashCode;
            }
        }
