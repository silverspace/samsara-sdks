...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class UserBase :  IEquatable<UserBase>, IValidatableObject
    {
        ...
        public UserBase(AuthTypeEnum authType = default(AuthTypeEnum), string email = default(string), string name = default(string), string organizationRoleId = default(string))
        {
            // to ensure "authType" is required (not null)
            if (authType == null)
            {
                throw new InvalidDataException("authType is a required property for UserBase and cannot be null");
            }
            else
            {
