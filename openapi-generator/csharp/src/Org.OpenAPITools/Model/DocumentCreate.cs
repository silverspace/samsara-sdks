...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DocumentCreate :  IEquatable<DocumentCreate>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="documentTypeUuid">Universally unique identifier for the document type this document is being created for. (required).</param>
        /// <param name="fields">List of fields should match the document type’s list of field types in the correct order. In other words, a field&#39;s valueType and value (i.e. only one of: stringValue, numberValue, or photoValue) at index _i_ should match with the document field type’s valueType at index _i_. (required).</param>
        public DocumentCreate(long? dispatchJobId = default(long?), string notes = default(string), string documentTypeUuid = default(string), List<DocumentField> fields = default(List<DocumentField>))
        {
            // to ensure "documentTypeUuid" is required (not null)
            if (documentTypeUuid == null)
            {
                throw new InvalidDataException("documentTypeUuid is a required property for DocumentCreate and cannot be null");
            }
            else
            {
            ...
            if (fields == null)
            {
                throw new InvalidDataException("fields is a required property for DocumentCreate and cannot be null");
            }
            else
            {
                this.Fields = fields;
        ...
        public bool Equals(DocumentCreate input)
        {
            ...
            return 
                ...
                (
                    this.DocumentTypeUuid == input.DocumentTypeUuid ||
                    (this.DocumentTypeUuid != null &&
                    this.DocumentTypeUuid.Equals(input.DocumentTypeUuid))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.DocumentTypeUuid != null)
                    hashCode = hashCode * 59 + this.DocumentTypeUuid.GetHashCode();
                if (this.Fields != null)
