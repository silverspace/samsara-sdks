...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Sensor :  IEquatable<Sensor>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="Sensor" /> class.
        /// </summary>
        /// <param name="id">ID of the sensor. (required).</param>
        /// <param name="macAddress">MAC address of the sensor..</param>
        /// <param name="name">Name of the sensor..</param>
        public Sensor(long? id = default(long?), string macAddress = default(string), string name = default(string))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for Sensor and cannot be null");
            }
            else
            {
                this.Id = id;
