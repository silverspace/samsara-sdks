...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FleetVehicleLocation :  IEquatable<FleetVehicleLocation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FleetVehicleLocation" /> class.
        /// </summary>
        ...
        public FleetVehicleLocation(double? latitude = default(double?), string location = default(string), double? longitude = default(double?), double? speedMilesPerHour = default(double?), long? timeMs = default(long?))
        {
        ...
        {
            return this.Equals(input as FleetVehicleLocation);
        }

        /// <summary>
        /// Returns true if FleetVehicleLocation instances are equal
        /// </summary>
        /// <param name="input">Instance of FleetVehicleLocation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FleetVehicleLocation input)
        {
            if (input == null)
                return false;
