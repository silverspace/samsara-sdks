...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class InlineObject5 :  IEquatable<InlineObject5>, IValidatableObject
    {
        ...
        public InlineObject5(long? endMs = default(long?), long? orgId = default(long?), long? startMs = default(long?))
        {
            // to ensure "endMs" is required (not null)
            if (endMs == null)
            {
                throw new InvalidDataException("endMs is a required property for InlineObject5 and cannot be null");
            }
            else
            {
                this.EndMs = endMs;
            ...
            if (orgId == null)
            {
                throw new InvalidDataException("orgId is a required property for InlineObject5 and cannot be null");
            }
            else
            {
                this.OrgId = orgId;
            ...
            if (startMs == null)
            {
                throw new InvalidDataException("startMs is a required property for InlineObject5 and cannot be null");
            }
            else
            {
