...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DispatchRouteBase :  IEquatable<DispatchRouteBase>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DispatchRouteBase" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DispatchRouteBase() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DispatchRouteBase" /> class.
        /// </summary>
        ...
        public DispatchRouteBase(long? actualEndMs = default(long?), long? actualStartMs = default(long?), long? driverId = default(long?), long? groupId = default(long?), string name = default(string), long? scheduledEndMs = default(long?), long? scheduledMeters = default(long?), long? scheduledStartMs = default(long?), string startLocationAddress = default(string), long? startLocationAddressId = default(long?), double? startLocationLat = default(double?), double? startLocationLng = default(double?), string startLocationName = default(string), long? trailerId = default(long?), long? vehicleId = default(long?))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for DispatchRouteBase and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            {
                throw new InvalidDataException("scheduledEndMs is a required property for DispatchRouteBase and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("scheduledStartMs is a required property for DispatchRouteBase and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as DispatchRouteBase);
        }

        /// <summary>
        /// Returns true if DispatchRouteBase instances are equal
        /// </summary>
        /// <param name="input">Instance of DispatchRouteBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DispatchRouteBase input)
        {
            if (input == null)
                return false;
