...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class TagMetadata :  IEquatable<TagMetadata>, IValidatableObject
    {
        ...
        public TagMetadata(long? id = default(long?), string name = default(string))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for TagMetadata and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for TagMetadata and cannot be null");
            }
            else
            {
                this.Name = name;
