...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class InlineObject21 :  IEquatable<InlineObject21>, IValidatableObject
    {
        ...
        public InlineObject21(int? endMs = default(int?), FillMissingEnum? fillMissing = FillMissingEnum.WithNull, long? groupId = default(long?), List<SensorsHistorySeries> series = default(List<SensorsHistorySeries>), int? startMs = default(int?), int? stepMs = default(int?))
        {
            // to ensure "endMs" is required (not null)
            if (endMs == null)
            {
                throw new InvalidDataException("endMs is a required property for InlineObject21 and cannot be null");
            }
            else
            {
                this.EndMs = endMs;
            ...
            if (groupId == null)
            {
                throw new InvalidDataException("groupId is a required property for InlineObject21 and cannot be null");
            }
            else
            {
            ...
            if (series == null)
            {
                throw new InvalidDataException("series is a required property for InlineObject21 and cannot be null");
            }
            else
            {
                this.Series = series;
            ...
            if (startMs == null)
            {
                throw new InvalidDataException("startMs is a required property for InlineObject21 and cannot be null");
            }
            else
            {
            ...
            if (stepMs == null)
            {
                throw new InvalidDataException("stepMs is a required property for InlineObject21 and cannot be null");
            }
            else
            {
                this.StepMs = stepMs;
