...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class InlineObject1 :  IEquatable<InlineObject1>, IValidatableObject
    {
        ...
        public InlineObject1(List<long?> contactIds = default(List<long?>), string formattedAddress = default(string), AddressGeofence geofence = default(AddressGeofence), string name = default(string), string notes = default(string), List<long?> tagIds = default(List<long?>))
        {
