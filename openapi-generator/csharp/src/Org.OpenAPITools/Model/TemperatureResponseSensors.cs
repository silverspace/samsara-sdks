...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TemperatureResponseSensors :  IEquatable<TemperatureResponseSensors>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TemperatureResponseSensors" /> class.
        /// </summary>
        /// <param name="probeTemperature">Currently reported probe temperature in millidegrees celsius. If no probe is connected, this parameter will not be reported..</param>
        /// <param name="name">Name of the sensor..</param>
        /// <param name="id">ID of the sensor..</param>
        /// <param name="ambientTemperature">Currently reported ambient temperature in millidegrees celsius..</param>
        public TemperatureResponseSensors(int? probeTemperature = default(int?), string name = default(string), long? id = default(long?), int? ambientTemperature = default(int?))
        {
        ...
        {
            return this.Equals(input as TemperatureResponseSensors);
        }

        /// <summary>
        /// Returns true if TemperatureResponseSensors instances are equal
        /// </summary>
        /// <param name="input">Instance of TemperatureResponseSensors to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TemperatureResponseSensors input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.ProbeTemperature == input.ProbeTemperature ||
                    (this.ProbeTemperature != null &&
                    this.ProbeTemperature.Equals(input.ProbeTemperature))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.ProbeTemperature != null)
                    hashCode = hashCode * 59 + this.ProbeTemperature.GetHashCode();
                if (this.Name != null)
