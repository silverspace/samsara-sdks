...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AssetCurrentLocation :  IEquatable<AssetCurrentLocation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AssetCurrentLocation" /> class.
        /// </summary>
        ...
        /// <param name="timeMs">Time in Unix milliseconds since epoch when the asset was at the location..</param>
        public AssetCurrentLocation(double? latitude = default(double?), string location = default(string), double? longitude = default(double?), double? speedMilesPerHour = default(double?), long? timeMs = default(long?))
        {
        ...
        {
            return this.Equals(input as AssetCurrentLocation);
        }

        /// <summary>
        /// Returns true if AssetCurrentLocation instances are equal
        /// </summary>
        /// <param name="input">Instance of AssetCurrentLocation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AssetCurrentLocation input)
        {
            if (input == null)
                return false;
