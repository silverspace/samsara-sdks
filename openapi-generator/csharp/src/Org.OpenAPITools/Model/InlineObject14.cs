...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class InlineObject14 :  IEquatable<InlineObject14>, IValidatableObject
    {
        ...
        public InlineObject14(long? groupId = default(long?), List<Vehicle> vehicles = default(List<Vehicle>))
        {
            // to ensure "groupId" is required (not null)
            if (groupId == null)
            {
                throw new InvalidDataException("groupId is a required property for InlineObject14 and cannot be null");
            }
            else
            {
            ...
            if (vehicles == null)
            {
                throw new InvalidDataException("vehicles is a required property for InlineObject14 and cannot be null");
            }
            else
            {
