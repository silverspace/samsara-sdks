...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class TagModifyDelete :  IEquatable<TagModifyDelete>, IValidatableObject
    {
        ...
        public TagModifyDelete(List<TaggedAssetBase> assets = default(List<TaggedAssetBase>), List<TaggedSensorBase> sensors = default(List<TaggedSensorBase>), List<TaggedVehicleBase> vehicles = default(List<TaggedVehicleBase>), List<TaggedMachineBase> machines = default(List<TaggedMachineBase>), List<TaggedDriverBase> drivers = default(List<TaggedDriverBase>))
        {
            this.Assets = assets;
