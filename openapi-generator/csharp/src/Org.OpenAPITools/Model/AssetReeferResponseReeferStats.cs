...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class AssetReeferResponseReeferStats :  IEquatable<AssetReeferResponseReeferStats>, IValidatableObject
    {
        ...
        public AssetReeferResponseReeferStats(List<AssetReeferResponseReeferStatsFuelPercentage> fuelPercentage = default(List<AssetReeferResponseReeferStatsFuelPercentage>), List<AssetReeferResponseReeferStatsPowerStatus> powerStatus = default(List<AssetReeferResponseReeferStatsPowerStatus>), List<AssetReeferResponseReeferStatsEngineHours> engineHours = default(List<AssetReeferResponseReeferStatsEngineHours>), List<AssetReeferResponseReeferStatsSetPoint> setPoint = default(List<AssetReeferResponseReeferStatsSetPoint>), List<AssetReeferResponseReeferStatsReturnAirTemp> returnAirTemp = default(List<AssetReeferResponseReeferStatsReturnAirTemp>), List<AssetReeferResponseReeferStatsAlarms1> alarms = default(List<AssetReeferResponseReeferStatsAlarms1>))
        {
