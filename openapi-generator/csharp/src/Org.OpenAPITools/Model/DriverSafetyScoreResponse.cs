...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DriverSafetyScoreResponse :  IEquatable<DriverSafetyScoreResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DriverSafetyScoreResponse" /> class.
        /// </summary>
        ...
        public DriverSafetyScoreResponse(int? crashCount = default(int?), int? driverId = default(int?), int? harshAccelCount = default(int?), int? harshBrakingCount = default(int?), List<SafetyReportHarshEvent> harshEvents = default(List<SafetyReportHarshEvent>), int? harshTurningCount = default(int?), int? safetyScore = default(int?), string safetyScoreRank = default(string), int? timeOverSpeedLimitMs = default(int?), int? totalDistanceDrivenMeters = default(int?), int? totalHarshEventCount = default(int?), int? totalTimeDrivenMs = default(int?))
        {
        ...
        {
            return this.Equals(input as DriverSafetyScoreResponse);
        }

        /// <summary>
        /// Returns true if DriverSafetyScoreResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of DriverSafetyScoreResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DriverSafetyScoreResponse input)
        {
            if (input == null)
                return false;
