...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class DvirBaseNextDriverSignature :  IEquatable<DvirBaseNextDriverSignature>, IValidatableObject
    {
        ...
        public DvirBaseNextDriverSignature(long? driverId = default(long?), string name = default(string), long? signedAt = default(long?), string type = default(string), string email = default(string), string username = default(string))
        {
