...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class JobUpdateObject :  IEquatable<JobUpdateObject>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="JobUpdateObject" /> class.
        /// </summary>
        /// <param name="changedAtMs">Timestamp that this event was updated, represented as Unix milliseconds since epoch..</param>
        /// <param name="jobId">ID of the Samsara job..</param>
        /// <param name="jobState">jobState.</param>
        /// <param name="prevJobState">prevJobState.</param>
        /// <param name="route">route.</param>
        /// <param name="routeId">ID of the Samsara dispatch route..</param>
        public JobUpdateObject(long? changedAtMs = default(long?), long? jobId = default(long?), JobStatus jobState = default(JobStatus), PrevJobStatus prevJobState = default(PrevJobStatus), DispatchRoute route = default(DispatchRoute), long? routeId = default(long?))
        {
        ...
        {
            return this.Equals(input as JobUpdateObject);
        }

        /// <summary>
        /// Returns true if JobUpdateObject instances are equal
        /// </summary>
        /// <param name="input">Instance of JobUpdateObject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JobUpdateObject input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.ChangedAtMs == input.ChangedAtMs ||
                    (this.ChangedAtMs != null &&
                    this.ChangedAtMs.Equals(input.ChangedAtMs))
                ) && 
                (
                ...
                (
                    this.PrevJobState == input.PrevJobState ||
                    (this.PrevJobState != null &&
                    this.PrevJobState.Equals(input.PrevJobState))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.ChangedAtMs != null)
                    hashCode = hashCode * 59 + this.ChangedAtMs.GetHashCode();
                if (this.JobId != null)
                    hashCode = hashCode * 59 + this.JobId.GetHashCode();
                if (this.JobState != null)
                    hashCode = hashCode * 59 + this.JobState.GetHashCode();
                if (this.PrevJobState != null)
                    hashCode = hashCode * 59 + this.PrevJobState.GetHashCode();
                if (this.Route != null)
