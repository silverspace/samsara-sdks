...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SafetyReportHarshEvent :  IEquatable<SafetyReportHarshEvent>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SafetyReportHarshEvent" /> class.
        /// </summary>
        /// <param name="harshEventType">Type of the harsh event.</param>
        /// <param name="timestampMs">Timestamp that the harsh event occurred in Unix milliseconds since epoch.</param>
        /// <param name="vehicleId">Vehicle associated with the harsh event.</param>
        ...
        {
            return this.Equals(input as SafetyReportHarshEvent);
        }

        /// <summary>
        /// Returns true if SafetyReportHarshEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of SafetyReportHarshEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SafetyReportHarshEvent input)
        {
            if (input == null)
                return false;
