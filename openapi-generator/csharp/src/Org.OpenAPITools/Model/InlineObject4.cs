...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class InlineObject4 :  IEquatable<InlineObject4>, IValidatableObject
    {
        ...
        public InlineObject4(bool? reactivate = default(bool?))
        {
            // to ensure "reactivate" is required (not null)
            if (reactivate == null)
            {
                throw new InvalidDataException("reactivate is a required property for InlineObject4 and cannot be null");
            }
            else
            {
