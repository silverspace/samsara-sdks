...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DispatchRouteCreate :  IEquatable<DispatchRouteCreate>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DispatchRouteCreate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DispatchRouteCreate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DispatchRouteCreate" /> class.
        /// </summary>
        ...
        /// <param name="dispatchJobs">The dispatch jobs to create for this route. (required).</param>
        public DispatchRouteCreate(long? actualEndMs = default(long?), long? actualStartMs = default(long?), long? driverId = default(long?), long? groupId = default(long?), string name = default(string), long? scheduledEndMs = default(long?), long? scheduledMeters = default(long?), long? scheduledStartMs = default(long?), string startLocationAddress = default(string), long? startLocationAddressId = default(long?), double? startLocationLat = default(double?), double? startLocationLng = default(double?), string startLocationName = default(string), long? trailerId = default(long?), long? vehicleId = default(long?), List<DispatchJobCreate> dispatchJobs = default(List<DispatchJobCreate>))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for DispatchRouteCreate and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            {
                throw new InvalidDataException("scheduledEndMs is a required property for DispatchRouteCreate and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("scheduledStartMs is a required property for DispatchRouteCreate and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("dispatchJobs is a required property for DispatchRouteCreate and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as DispatchRouteCreate);
        }

        /// <summary>
        /// Returns true if DispatchRouteCreate instances are equal
        /// </summary>
        /// <param name="input">Instance of DispatchRouteCreate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DispatchRouteCreate input)
        {
            if (input == null)
                return false;
