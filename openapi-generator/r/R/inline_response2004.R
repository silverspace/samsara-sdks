...
InlineResponse2004 <- R6::R6Class(
  ...
  public = list(
    `vehicles` = NULL,
    initialize = function(`vehicles`=NULL, ...){
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`vehicles`)) {
        InlineResponse2004Object[['vehicles']] <-
    ...
    fromJSON = function(InlineResponse2004Json) {
      ...
      if (!is.null(InlineResponse2004Object$`vehicles`)) {
        self$`vehicles` <- sapply(InlineResponse2004Object$`vehicles`, function(x) {
          vehiclesObject <- VehicleMaintenance$new()
    ...
    fromJSONString = function(InlineResponse2004Json) {
      InlineResponse2004Object <- jsonlite::fromJSON(InlineResponse2004Json)
      data.frame <- InlineResponse2004Object$`vehicles`
      self$`vehicles` <- vector("list", length = nrow(data.frame))
      for (row in 1:nrow(data.frame)) {
          vehicles.node <- VehicleMaintenance$new()
