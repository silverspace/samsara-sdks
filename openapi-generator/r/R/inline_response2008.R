...
InlineResponse2008 <- R6::R6Class(
  ...
  public = list(
    `sensors` = NULL,
    initialize = function(`sensors`=NULL, ...){
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`sensors`)) {
        InlineResponse2008Object[['sensors']] <-
    ...
    fromJSON = function(InlineResponse2008Json) {
      ...
      if (!is.null(InlineResponse2008Object$`sensors`)) {
        self$`sensors` <- sapply(InlineResponse2008Object$`sensors`, function(x) {
          sensorsObject <- Sensor$new()
