...
DispatchRouteBase <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      DispatchRouteBaseObject <- list()
      if (!is.null(self$`actual_end_ms`)) {
        DispatchRouteBaseObject[['actual_end_ms']] <-
          self$`actual_end_ms`
      }
      if (!is.null(self$`actual_start_ms`)) {
        DispatchRouteBaseObject[['actual_start_ms']] <-
          self$`actual_start_ms`
      }
      if (!is.null(self$`driver_id`)) {
        DispatchRouteBaseObject[['driver_id']] <-
          self$`driver_id`
      }
      if (!is.null(self$`group_id`)) {
        DispatchRouteBaseObject[['group_id']] <-
          self$`group_id`
      }
      if (!is.null(self$`name`)) {
        DispatchRouteBaseObject[['name']] <-
          self$`name`
      }
      if (!is.null(self$`scheduled_end_ms`)) {
        DispatchRouteBaseObject[['scheduled_end_ms']] <-
          self$`scheduled_end_ms`
      }
      if (!is.null(self$`scheduled_meters`)) {
        DispatchRouteBaseObject[['scheduled_meters']] <-
          self$`scheduled_meters`
      }
      if (!is.null(self$`scheduled_start_ms`)) {
        DispatchRouteBaseObject[['scheduled_start_ms']] <-
          self$`scheduled_start_ms`
      }
      if (!is.null(self$`start_location_address`)) {
        DispatchRouteBaseObject[['start_location_address']] <-
          self$`start_location_address`
      }
      if (!is.null(self$`start_location_address_id`)) {
        DispatchRouteBaseObject[['start_location_address_id']] <-
          self$`start_location_address_id`
      }
      if (!is.null(self$`start_location_lat`)) {
        DispatchRouteBaseObject[['start_location_lat']] <-
          self$`start_location_lat`
      }
      if (!is.null(self$`start_location_lng`)) {
        DispatchRouteBaseObject[['start_location_lng']] <-
          self$`start_location_lng`
      }
      if (!is.null(self$`start_location_name`)) {
        DispatchRouteBaseObject[['start_location_name']] <-
          self$`start_location_name`
      }
      if (!is.null(self$`trailer_id`)) {
        DispatchRouteBaseObject[['trailer_id']] <-
          self$`trailer_id`
      }
      if (!is.null(self$`vehicle_id`)) {
        DispatchRouteBaseObject[['vehicle_id']] <-
          self$`vehicle_id`
      }

      DispatchRouteBaseObject
    },
    fromJSON = function(DispatchRouteBaseJson) {
      DispatchRouteBaseObject <- jsonlite::fromJSON(DispatchRouteBaseJson)
      if (!is.null(DispatchRouteBaseObject$`actual_end_ms`)) {
        self$`actual_end_ms` <- DispatchRouteBaseObject$`actual_end_ms`
      }
      if (!is.null(DispatchRouteBaseObject$`actual_start_ms`)) {
        self$`actual_start_ms` <- DispatchRouteBaseObject$`actual_start_ms`
      }
      if (!is.null(DispatchRouteBaseObject$`driver_id`)) {
        self$`driver_id` <- DispatchRouteBaseObject$`driver_id`
      }
      if (!is.null(DispatchRouteBaseObject$`group_id`)) {
        self$`group_id` <- DispatchRouteBaseObject$`group_id`
      }
      if (!is.null(DispatchRouteBaseObject$`name`)) {
        self$`name` <- DispatchRouteBaseObject$`name`
      }
      if (!is.null(DispatchRouteBaseObject$`scheduled_end_ms`)) {
        self$`scheduled_end_ms` <- DispatchRouteBaseObject$`scheduled_end_ms`
      }
      if (!is.null(DispatchRouteBaseObject$`scheduled_meters`)) {
        self$`scheduled_meters` <- DispatchRouteBaseObject$`scheduled_meters`
      }
      if (!is.null(DispatchRouteBaseObject$`scheduled_start_ms`)) {
        self$`scheduled_start_ms` <- DispatchRouteBaseObject$`scheduled_start_ms`
      }
      if (!is.null(DispatchRouteBaseObject$`start_location_address`)) {
        self$`start_location_address` <- DispatchRouteBaseObject$`start_location_address`
      }
      if (!is.null(DispatchRouteBaseObject$`start_location_address_id`)) {
        self$`start_location_address_id` <- DispatchRouteBaseObject$`start_location_address_id`
      }
      if (!is.null(DispatchRouteBaseObject$`start_location_lat`)) {
        self$`start_location_lat` <- DispatchRouteBaseObject$`start_location_lat`
      }
      if (!is.null(DispatchRouteBaseObject$`start_location_lng`)) {
        self$`start_location_lng` <- DispatchRouteBaseObject$`start_location_lng`
      }
      if (!is.null(DispatchRouteBaseObject$`start_location_name`)) {
        self$`start_location_name` <- DispatchRouteBaseObject$`start_location_name`
      }
      if (!is.null(DispatchRouteBaseObject$`trailer_id`)) {
        self$`trailer_id` <- DispatchRouteBaseObject$`trailer_id`
      }
      if (!is.null(DispatchRouteBaseObject$`vehicle_id`)) {
        self$`vehicle_id` <- DispatchRouteBaseObject$`vehicle_id`
      }
    },
    ...
    fromJSONString = function(DispatchRouteBaseJson) {
      DispatchRouteBaseObject <- jsonlite::fromJSON(DispatchRouteBaseJson)
      self$`actual_end_ms` <- DispatchRouteBaseObject$`actual_end_ms`
      self$`actual_start_ms` <- DispatchRouteBaseObject$`actual_start_ms`
      self$`driver_id` <- DispatchRouteBaseObject$`driver_id`
