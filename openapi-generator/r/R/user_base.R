...
UserBase <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`authType`, `email`, `name`=NULL, `organizationRoleId`=NULL, ...){
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`organizationRoleId`)) {
        UserBaseObject[['organizationRoleId']] <-
    ...
    fromJSON = function(UserBaseJson) {
      ...
      if (!is.null(UserBaseObject$`authType`)) {
        self$`authType` <- UserBaseObject$`authType`
      }
      if (!is.null(UserBaseObject$`email`)) {
        self$`email` <- UserBaseObject$`email`
      }
      if (!is.null(UserBaseObject$`name`)) {
        self$`name` <- UserBaseObject$`name`
      }
      if (!is.null(UserBaseObject$`organizationRoleId`)) {
        self$`organizationRoleId` <- UserBaseObject$`organizationRoleId`
      }
    },
