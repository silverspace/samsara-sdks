...
TagModifyAdd <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      TagModifyAddObject <- list()
      if (!is.null(self$`assets`)) {
        TagModifyAddObject[['assets']] <-
          sapply(self$`assets`, function(x) x$toJSON())
      }
      if (!is.null(self$`sensors`)) {
        TagModifyAddObject[['sensors']] <-
          sapply(self$`sensors`, function(x) x$toJSON())
      }
      if (!is.null(self$`vehicles`)) {
        TagModifyAddObject[['vehicles']] <-
          sapply(self$`vehicles`, function(x) x$toJSON())
      }
      if (!is.null(self$`machines`)) {
        TagModifyAddObject[['machines']] <-
          sapply(self$`machines`, function(x) x$toJSON())
      }
      if (!is.null(self$`drivers`)) {
        TagModifyAddObject[['drivers']] <-
          sapply(self$`drivers`, function(x) x$toJSON())
      }

      TagModifyAddObject
    },
    fromJSON = function(TagModifyAddJson) {
      TagModifyAddObject <- jsonlite::fromJSON(TagModifyAddJson)
      if (!is.null(TagModifyAddObject$`assets`)) {
        self$`assets` <- sapply(TagModifyAddObject$`assets`, function(x) {
          assetsObject <- TaggedAssetBase$new()
          assetsObject$fromJSON(jsonlite::toJSON(x, auto_unbox = TRUE))
          assetsObject
        })
      }
      if (!is.null(TagModifyAddObject$`sensors`)) {
        self$`sensors` <- sapply(TagModifyAddObject$`sensors`, function(x) {
          sensorsObject <- TaggedSensorBase$new()
          sensorsObject$fromJSON(jsonlite::toJSON(x, auto_unbox = TRUE))
          sensorsObject
        })
      }
      if (!is.null(TagModifyAddObject$`vehicles`)) {
        self$`vehicles` <- sapply(TagModifyAddObject$`vehicles`, function(x) {
          vehiclesObject <- TaggedVehicleBase$new()
          vehiclesObject$fromJSON(jsonlite::toJSON(x, auto_unbox = TRUE))
          vehiclesObject
        })
      }
      if (!is.null(TagModifyAddObject$`machines`)) {
        self$`machines` <- sapply(TagModifyAddObject$`machines`, function(x) {
          machinesObject <- TaggedMachineBase$new()
          machinesObject$fromJSON(jsonlite::toJSON(x, auto_unbox = TRUE))
          machinesObject
        })
      }
      if (!is.null(TagModifyAddObject$`drivers`)) {
        self$`drivers` <- sapply(TagModifyAddObject$`drivers`, function(x) {
    ...
    fromJSONString = function(TagModifyAddJson) {
      TagModifyAddObject <- jsonlite::fromJSON(TagModifyAddJson)
      data.frame <- TagModifyAddObject$`assets`
      ...
      data.frame <- TagModifyAddObject$`sensors`
      ...
      data.frame <- TagModifyAddObject$`vehicles`
      ...
      data.frame <- TagModifyAddObject$`machines`
      ...
      data.frame <- TagModifyAddObject$`drivers`
