...
TagModifyDelete <- R6::R6Class(
  ...
  public = list(
    ...
    `machines` = NULL,
    `drivers` = NULL,
    initialize = function(`assets`=NULL, `sensors`=NULL, `vehicles`=NULL, `machines`=NULL, `drivers`=NULL, ...){
    ...
    toJSON = function() {
      TagModifyDeleteObject <- list()
      if (!is.null(self$`assets`)) {
        TagModifyDeleteObject[['assets']] <-
          sapply(self$`assets`, function(x) x$toJSON())
      }
      if (!is.null(self$`sensors`)) {
        TagModifyDeleteObject[['sensors']] <-
          sapply(self$`sensors`, function(x) x$toJSON())
      }
      if (!is.null(self$`vehicles`)) {
        TagModifyDeleteObject[['vehicles']] <-
          sapply(self$`vehicles`, function(x) x$toJSON())
      }
      if (!is.null(self$`machines`)) {
        TagModifyDeleteObject[['machines']] <-
          sapply(self$`machines`, function(x) x$toJSON())
      }
      if (!is.null(self$`drivers`)) {
        TagModifyDeleteObject[['drivers']] <-
          sapply(self$`drivers`, function(x) x$toJSON())
      }

      TagModifyDeleteObject
    },
    fromJSON = function(TagModifyDeleteJson) {
      TagModifyDeleteObject <- jsonlite::fromJSON(TagModifyDeleteJson)
      if (!is.null(TagModifyDeleteObject$`assets`)) {
        self$`assets` <- sapply(TagModifyDeleteObject$`assets`, function(x) {
          assetsObject <- TaggedAssetBase$new()
          assetsObject$fromJSON(jsonlite::toJSON(x, auto_unbox = TRUE))
          assetsObject
        })
      }
      if (!is.null(TagModifyDeleteObject$`sensors`)) {
        self$`sensors` <- sapply(TagModifyDeleteObject$`sensors`, function(x) {
          sensorsObject <- TaggedSensorBase$new()
          sensorsObject$fromJSON(jsonlite::toJSON(x, auto_unbox = TRUE))
          sensorsObject
        })
      }
      if (!is.null(TagModifyDeleteObject$`vehicles`)) {
        self$`vehicles` <- sapply(TagModifyDeleteObject$`vehicles`, function(x) {
          vehiclesObject <- TaggedVehicleBase$new()
          vehiclesObject$fromJSON(jsonlite::toJSON(x, auto_unbox = TRUE))
          vehiclesObject
        })
      }
      if (!is.null(TagModifyDeleteObject$`machines`)) {
        self$`machines` <- sapply(TagModifyDeleteObject$`machines`, function(x) {
          machinesObject <- TaggedMachineBase$new()
          machinesObject$fromJSON(jsonlite::toJSON(x, auto_unbox = TRUE))
          machinesObject
        })
      }
      if (!is.null(TagModifyDeleteObject$`drivers`)) {
        self$`drivers` <- sapply(TagModifyDeleteObject$`drivers`, function(x) {
    ...
    fromJSONString = function(TagModifyDeleteJson) {
      TagModifyDeleteObject <- jsonlite::fromJSON(TagModifyDeleteJson)
      data.frame <- TagModifyDeleteObject$`assets`
      ...
      data.frame <- TagModifyDeleteObject$`sensors`
      ...
      data.frame <- TagModifyDeleteObject$`vehicles`
      ...
      data.frame <- TagModifyDeleteObject$`machines`
      ...
      data.frame <- TagModifyDeleteObject$`drivers`
