...
Sensor <- R6::R6Class(
  ...
  public = list(
    ...
    `macAddress` = NULL,
    `name` = NULL,
    initialize = function(`id`, `macAddress`=NULL, `name`=NULL, ...){
      ...
      if (!is.null(`macAddress`)) {
        stopifnot(is.character(`macAddress`), length(`macAddress`) == 1)
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`macAddress`)) {
        SensorObject[['macAddress']] <-
          self$`macAddress`
      }
    ...
    fromJSON = function(SensorJson) {
      ...
      if (!is.null(SensorObject$`macAddress`)) {
        self$`macAddress` <- SensorObject$`macAddress`
      }
