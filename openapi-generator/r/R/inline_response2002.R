...
InlineResponse2002 <- R6::R6Class(
  ...
  public = list(
    ...
    `groupId` = NULL,
    `vehicles` = NULL,
    initialize = function(`pagination`=NULL, `groupId`=NULL, `vehicles`=NULL, ...){
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`pagination`)) {
        InlineResponse2002Object[['pagination']] <-
          self$`pagination`$toJSON()
      }
      if (!is.null(self$`groupId`)) {
        InlineResponse2002Object[['groupId']] <-
          self$`groupId`
      }
      if (!is.null(self$`vehicles`)) {
        InlineResponse2002Object[['vehicles']] <-
    ...
    fromJSON = function(InlineResponse2002Json) {
      ...
      if (!is.null(InlineResponse2002Object$`pagination`)) {
        paginationObject <- Pagination$new()
        paginationObject$fromJSON(jsonlite::toJSON(InlineResponse2002Object$pagination, auto_unbox = TRUE))
        self$`pagination` <- paginationObject
      }
      if (!is.null(InlineResponse2002Object$`groupId`)) {
        self$`groupId` <- InlineResponse2002Object$`groupId`
      }
      if (!is.null(InlineResponse2002Object$`vehicles`)) {
        self$`vehicles` <- sapply(InlineResponse2002Object$`vehicles`, function(x) {
    ...
    fromJSONString = function(InlineResponse2002Json) {
      InlineResponse2002Object <- jsonlite::fromJSON(InlineResponse2002Json)
      self$`pagination` <- Pagination$new()$fromJSON(jsonlite::toJSON(InlineResponse2002Object$pagination, auto_unbox = TRUE))
      self$`groupId` <- InlineResponse2002Object$`groupId`
      data.frame <- InlineResponse2002Object$`vehicles`
      self$`vehicles` <- vector("list", length = nrow(data.frame))
      for (row in 1:nrow(data.frame)) {
          vehicles.node <- Vehicle$new()
