...
#' @export
InlineObject14 <- R6::R6Class(
  'InlineObject14',
  public = list(
    `groupId` = NULL,
    `vehicles` = NULL,
    initialize = function(`groupId`, `vehicles`, ...){
    ...
    toJSON = function() {
      InlineObject14Object <- list()
      if (!is.null(self$`groupId`)) {
        InlineObject14Object[['groupId']] <-
          self$`groupId`
      }
      if (!is.null(self$`vehicles`)) {
        InlineObject14Object[['vehicles']] <-
          sapply(self$`vehicles`, function(x) x$toJSON())
      }

      InlineObject14Object
    },
    fromJSON = function(InlineObject14Json) {
      InlineObject14Object <- jsonlite::fromJSON(InlineObject14Json)
      if (!is.null(InlineObject14Object$`groupId`)) {
        self$`groupId` <- InlineObject14Object$`groupId`
      }
      if (!is.null(InlineObject14Object$`vehicles`)) {
        self$`vehicles` <- sapply(InlineObject14Object$`vehicles`, function(x) {
    ...
    fromJSONString = function(InlineObject14Json) {
      InlineObject14Object <- jsonlite::fromJSON(InlineObject14Json)
      self$`groupId` <- InlineObject14Object$`groupId`
      data.frame <- InlineObject14Object$`vehicles`
