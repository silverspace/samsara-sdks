...
TagUpdate <- R6::R6Class(
  ...
  public = list(
    ...
    `sensors` = NULL,
    `vehicles` = NULL,
    initialize = function(`assets`=NULL, `drivers`=NULL, `machines`=NULL, `name`=NULL, `parentTagId`=NULL, `sensors`=NULL, `vehicles`=NULL, ...){
    ...
    toJSON = function() {
      TagUpdateObject <- list()
      if (!is.null(self$`assets`)) {
        TagUpdateObject[['assets']] <-
          sapply(self$`assets`, function(x) x$toJSON())
      }
      if (!is.null(self$`drivers`)) {
        TagUpdateObject[['drivers']] <-
          sapply(self$`drivers`, function(x) x$toJSON())
      }
      if (!is.null(self$`machines`)) {
        TagUpdateObject[['machines']] <-
          sapply(self$`machines`, function(x) x$toJSON())
      }
      if (!is.null(self$`name`)) {
        TagUpdateObject[['name']] <-
          self$`name`
      }
      if (!is.null(self$`parentTagId`)) {
        TagUpdateObject[['parentTagId']] <-
          self$`parentTagId`
      }
      if (!is.null(self$`sensors`)) {
        TagUpdateObject[['sensors']] <-
          sapply(self$`sensors`, function(x) x$toJSON())
      }
      if (!is.null(self$`vehicles`)) {
        TagUpdateObject[['vehicles']] <-
          sapply(self$`vehicles`, function(x) x$toJSON())
      }

      TagUpdateObject
    },
    fromJSON = function(TagUpdateJson) {
      TagUpdateObject <- jsonlite::fromJSON(TagUpdateJson)
      if (!is.null(TagUpdateObject$`assets`)) {
        self$`assets` <- sapply(TagUpdateObject$`assets`, function(x) {
          assetsObject <- TaggedAssetBase$new()
          assetsObject$fromJSON(jsonlite::toJSON(x, auto_unbox = TRUE))
          assetsObject
        })
      }
      if (!is.null(TagUpdateObject$`drivers`)) {
        self$`drivers` <- sapply(TagUpdateObject$`drivers`, function(x) {
          driversObject <- TaggedDriverBase$new()
          driversObject$fromJSON(jsonlite::toJSON(x, auto_unbox = TRUE))
          driversObject
        })
      }
      if (!is.null(TagUpdateObject$`machines`)) {
        self$`machines` <- sapply(TagUpdateObject$`machines`, function(x) {
          machinesObject <- TaggedMachineBase$new()
          machinesObject$fromJSON(jsonlite::toJSON(x, auto_unbox = TRUE))
          machinesObject
        })
      }
      if (!is.null(TagUpdateObject$`name`)) {
        self$`name` <- TagUpdateObject$`name`
      }
      if (!is.null(TagUpdateObject$`parentTagId`)) {
        self$`parentTagId` <- TagUpdateObject$`parentTagId`
      }
      if (!is.null(TagUpdateObject$`sensors`)) {
        self$`sensors` <- sapply(TagUpdateObject$`sensors`, function(x) {
          sensorsObject <- TaggedSensorBase$new()
          sensorsObject$fromJSON(jsonlite::toJSON(x, auto_unbox = TRUE))
          sensorsObject
        })
      }
      if (!is.null(TagUpdateObject$`vehicles`)) {
        self$`vehicles` <- sapply(TagUpdateObject$`vehicles`, function(x) {
    ...
    fromJSONString = function(TagUpdateJson) {
      TagUpdateObject <- jsonlite::fromJSON(TagUpdateJson)
      data.frame <- TagUpdateObject$`assets`
      ...
      data.frame <- TagUpdateObject$`drivers`
      ...
      data.frame <- TagUpdateObject$`machines`
      ...
      self$`name` <- TagUpdateObject$`name`
      self$`parentTagId` <- TagUpdateObject$`parentTagId`
      data.frame <- TagUpdateObject$`sensors`
      ...
      data.frame <- TagUpdateObject$`vehicles`
