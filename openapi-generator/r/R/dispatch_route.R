...
DispatchRoute <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      DispatchRouteObject <- list()
      if (!is.null(self$`actual_end_ms`)) {
        DispatchRouteObject[['actual_end_ms']] <-
          self$`actual_end_ms`
      }
      if (!is.null(self$`actual_start_ms`)) {
        DispatchRouteObject[['actual_start_ms']] <-
          self$`actual_start_ms`
      }
      if (!is.null(self$`driver_id`)) {
        DispatchRouteObject[['driver_id']] <-
          self$`driver_id`
      }
      if (!is.null(self$`group_id`)) {
        DispatchRouteObject[['group_id']] <-
          self$`group_id`
      }
      if (!is.null(self$`name`)) {
        DispatchRouteObject[['name']] <-
          self$`name`
      }
      if (!is.null(self$`scheduled_end_ms`)) {
        DispatchRouteObject[['scheduled_end_ms']] <-
          self$`scheduled_end_ms`
      }
      if (!is.null(self$`scheduled_meters`)) {
        DispatchRouteObject[['scheduled_meters']] <-
          self$`scheduled_meters`
      }
      if (!is.null(self$`scheduled_start_ms`)) {
        DispatchRouteObject[['scheduled_start_ms']] <-
          self$`scheduled_start_ms`
      }
      if (!is.null(self$`start_location_address`)) {
        DispatchRouteObject[['start_location_address']] <-
          self$`start_location_address`
      }
      if (!is.null(self$`start_location_address_id`)) {
        DispatchRouteObject[['start_location_address_id']] <-
          self$`start_location_address_id`
      }
      if (!is.null(self$`start_location_lat`)) {
        DispatchRouteObject[['start_location_lat']] <-
          self$`start_location_lat`
      }
      if (!is.null(self$`start_location_lng`)) {
        DispatchRouteObject[['start_location_lng']] <-
          self$`start_location_lng`
      }
      if (!is.null(self$`start_location_name`)) {
        DispatchRouteObject[['start_location_name']] <-
          self$`start_location_name`
      }
      if (!is.null(self$`trailer_id`)) {
        DispatchRouteObject[['trailer_id']] <-
          self$`trailer_id`
      }
      if (!is.null(self$`vehicle_id`)) {
        DispatchRouteObject[['vehicle_id']] <-
          self$`vehicle_id`
      }
      if (!is.null(self$`dispatch_jobs`)) {
        DispatchRouteObject[['dispatch_jobs']] <-
          sapply(self$`dispatch_jobs`, function(x) x$toJSON())
      }
      if (!is.null(self$`id`)) {
        DispatchRouteObject[['id']] <-
          self$`id`
      }

      DispatchRouteObject
    },
    fromJSON = function(DispatchRouteJson) {
      DispatchRouteObject <- jsonlite::fromJSON(DispatchRouteJson)
      if (!is.null(DispatchRouteObject$`actual_end_ms`)) {
        self$`actual_end_ms` <- DispatchRouteObject$`actual_end_ms`
      }
      if (!is.null(DispatchRouteObject$`actual_start_ms`)) {
        self$`actual_start_ms` <- DispatchRouteObject$`actual_start_ms`
      }
      if (!is.null(DispatchRouteObject$`driver_id`)) {
        self$`driver_id` <- DispatchRouteObject$`driver_id`
      }
      if (!is.null(DispatchRouteObject$`group_id`)) {
        self$`group_id` <- DispatchRouteObject$`group_id`
      }
      if (!is.null(DispatchRouteObject$`name`)) {
        self$`name` <- DispatchRouteObject$`name`
      }
      if (!is.null(DispatchRouteObject$`scheduled_end_ms`)) {
        self$`scheduled_end_ms` <- DispatchRouteObject$`scheduled_end_ms`
      }
      if (!is.null(DispatchRouteObject$`scheduled_meters`)) {
        self$`scheduled_meters` <- DispatchRouteObject$`scheduled_meters`
      }
      if (!is.null(DispatchRouteObject$`scheduled_start_ms`)) {
        self$`scheduled_start_ms` <- DispatchRouteObject$`scheduled_start_ms`
      }
      if (!is.null(DispatchRouteObject$`start_location_address`)) {
        self$`start_location_address` <- DispatchRouteObject$`start_location_address`
      }
      if (!is.null(DispatchRouteObject$`start_location_address_id`)) {
        self$`start_location_address_id` <- DispatchRouteObject$`start_location_address_id`
      }
      if (!is.null(DispatchRouteObject$`start_location_lat`)) {
        self$`start_location_lat` <- DispatchRouteObject$`start_location_lat`
      }
      if (!is.null(DispatchRouteObject$`start_location_lng`)) {
        self$`start_location_lng` <- DispatchRouteObject$`start_location_lng`
      }
      if (!is.null(DispatchRouteObject$`start_location_name`)) {
        self$`start_location_name` <- DispatchRouteObject$`start_location_name`
      }
      if (!is.null(DispatchRouteObject$`trailer_id`)) {
        self$`trailer_id` <- DispatchRouteObject$`trailer_id`
      }
      if (!is.null(DispatchRouteObject$`vehicle_id`)) {
        self$`vehicle_id` <- DispatchRouteObject$`vehicle_id`
      }
      if (!is.null(DispatchRouteObject$`dispatch_jobs`)) {
        self$`dispatch_jobs` <- sapply(DispatchRouteObject$`dispatch_jobs`, function(x) {
          dispatch_jobsObject <- DispatchJob$new()
          dispatch_jobsObject$fromJSON(jsonlite::toJSON(x, auto_unbox = TRUE))
          dispatch_jobsObject
        })
      }
      if (!is.null(DispatchRouteObject$`id`)) {
        self$`id` <- DispatchRouteObject$`id`
      }
    },
    ...
    fromJSONString = function(DispatchRouteJson) {
      DispatchRouteObject <- jsonlite::fromJSON(DispatchRouteJson)
      self$`actual_end_ms` <- DispatchRouteObject$`actual_end_ms`
      self$`actual_start_ms` <- DispatchRouteObject$`actual_start_ms`
      self$`driver_id` <- DispatchRouteObject$`driver_id`
