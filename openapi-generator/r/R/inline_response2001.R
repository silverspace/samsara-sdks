...
InlineResponse2001 <- R6::R6Class(
  ...
  public = list(
    `assets` = NULL,
    initialize = function(`assets`=NULL, ...){
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`assets`)) {
        InlineResponse2001Object[['assets']] <-
    ...
    fromJSON = function(InlineResponse2001Json) {
      ...
      if (!is.null(InlineResponse2001Object$`assets`)) {
        self$`assets` <- sapply(InlineResponse2001Object$`assets`, function(x) {
          assetsObject <- AssetCurrentLocationsResponse$new()
    ...
    fromJSONString = function(InlineResponse2001Json) {
      InlineResponse2001Object <- jsonlite::fromJSON(InlineResponse2001Json)
      data.frame <- InlineResponse2001Object$`assets`
      self$`assets` <- vector("list", length = nrow(data.frame))
      for (row in 1:nrow(data.frame)) {
          assets.node <- AssetCurrentLocationsResponse$new()
