  ...
  public = list(
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`assets`)) {
        InlineResponse200Object[['assets']] <-
    ...
    fromJSON = function(InlineResponse200Json) {
      ...
      if (!is.null(InlineResponse200Object$`assets`)) {
        self$`assets` <- sapply(InlineResponse200Object$`assets`, function(x) {
          assetsObject <- Asset$new()
