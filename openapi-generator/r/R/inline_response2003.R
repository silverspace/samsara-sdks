...
InlineResponse2003 <- R6::R6Class(
  ...
  public = list(
    `groupId` = NULL,
    `vehicles` = NULL,
    initialize = function(`groupId`=NULL, `vehicles`=NULL, ...){
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`groupId`)) {
        InlineResponse2003Object[['groupId']] <-
          self$`groupId`
      }
      if (!is.null(self$`vehicles`)) {
        InlineResponse2003Object[['vehicles']] <-
    ...
    fromJSON = function(InlineResponse2003Json) {
      ...
      if (!is.null(InlineResponse2003Object$`groupId`)) {
        self$`groupId` <- InlineResponse2003Object$`groupId`
      }
      if (!is.null(InlineResponse2003Object$`vehicles`)) {
        self$`vehicles` <- sapply(InlineResponse2003Object$`vehicles`, function(x) {
          vehiclesObject <- VehicleLocation$new()
    ...
    fromJSONString = function(InlineResponse2003Json) {
      InlineResponse2003Object <- jsonlite::fromJSON(InlineResponse2003Json)
      self$`groupId` <- InlineResponse2003Object$`groupId`
      data.frame <- InlineResponse2003Object$`vehicles`
      self$`vehicles` <- vector("list", length = nrow(data.frame))
      for (row in 1:nrow(data.frame)) {
          vehicles.node <- VehicleLocation$new()
