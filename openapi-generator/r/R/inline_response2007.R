  ...
  public = list(
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`machines`)) {
        InlineResponse2007Object[['machines']] <-
    ...
    fromJSON = function(InlineResponse2007Json) {
      ...
      if (!is.null(InlineResponse2007Object$`machines`)) {
        self$`machines` <- sapply(InlineResponse2007Object$`machines`, function(x) {
          machinesObject <- Machine$new()
