...
class DispatchRouteBase {
  ...
  static List<DispatchRouteBase> listFromJson(List<dynamic> json) {
    return json == null ? new List<DispatchRouteBase>() : json.map((value) => new DispatchRouteBase.fromJson(value)).toList();
  }

  static Map<String, DispatchRouteBase> mapFromJson(Map<String, dynamic> json) {
    var map = new Map<String, DispatchRouteBase>();
    if (json != null && json.length > 0) {
      json.forEach((String key, dynamic value) => map[key] = new DispatchRouteBase.fromJson(value));
    }
    return map;
  }
}
