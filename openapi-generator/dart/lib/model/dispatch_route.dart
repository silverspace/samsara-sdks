...
class DispatchRoute {
  ...
  DispatchRoute.fromJson(Map<String, dynamic> json) {
    if (json == null) return;
    ...
    if (json['dispatch_jobs'] == null) {
      ...
      dispatchJobs = DispatchJob.listFromJson(json['dispatch_jobs']);
    }
    if (json['id'] == null) {
      id = null;
    } else {
  ...
  static List<DispatchRoute> listFromJson(List<dynamic> json) {
    return json == null ? new List<DispatchRoute>() : json.map((value) => new DispatchRoute.fromJson(value)).toList();
  }

  static Map<String, DispatchRoute> mapFromJson(Map<String, dynamic> json) {
    var map = new Map<String, DispatchRoute>();
    if (json != null && json.length > 0) {
      json.forEach((String key, dynamic value) => map[key] = new DispatchRoute.fromJson(value));
    }
    return map;
  }
}
