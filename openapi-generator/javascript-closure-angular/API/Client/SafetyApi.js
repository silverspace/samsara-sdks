/**
 * @fileoverview AUTOMATICALLY GENERATED service for API.Client.SafetyApi.
 ...
 */
goog.provide('API.Client.SafetyApi');
 ...
 * @struct
 */
API.Client.SafetyApi = function($http, $httpParamSerializer, $injector) {
  /** @private {!string} */
  this.basePath_ = $injector.has('SafetyApiBasePath') ?
                   /** @type {!string} */ ($injector.get('SafetyApiBasePath')) :
                   'https://api.samsara.com/v1';

  /** @private {!Object<string, string>} */
  this.defaultHeaders_ = $injector.has('SafetyApiDefaultHeaders') ?
                   /** @type {!Object<string, string>} */ (
                       $injector.get('SafetyApiDefaultHeaders')) :
                   {};
...
API.Client.SafetyApi.$inject = ['$http', '$httpParamSerializer', '$injector'];
 ...
 */
API.Client.SafetyApi.prototype.getDriverSafetyScore = function(driverId, accessToken, startMs, endMs, opt_extraHttpRequestParams) {
  /** @const {string} */
 ...
 */
API.Client.SafetyApi.prototype.getVehicleHarshEvent = function(vehicleId, accessToken, timestamp, opt_extraHttpRequestParams) {
  /** @const {string} */
 ...
 */
API.Client.SafetyApi.prototype.getVehicleSafetyScore = function(vehicleId, accessToken, startMs, endMs, opt_extraHttpRequestParams) {
  /** @const {string} */
