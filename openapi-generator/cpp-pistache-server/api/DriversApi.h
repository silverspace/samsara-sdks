...
class  DriversApi {
public:
    DriversApi(std::shared_ptr<Pistache::Rest::Router>);
    virtual ~DriversApi() {}
    void init();
...
private:
    ...
    void drivers_api_default_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response);
