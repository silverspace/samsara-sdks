...
class  SafetyApi {
public:
    SafetyApi(std::shared_ptr<Pistache::Rest::Router>);
    virtual ~SafetyApi() {}
    void init();
...
private:
    ...
    void safety_api_default_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response);
