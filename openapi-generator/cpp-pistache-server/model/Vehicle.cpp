...
nlohmann::json Vehicle::toJson() const
{
    ...
    {
        val["fuelLevelPercent"] = m_FuelLevelPercent;
    }
    val["id"] = m_Id;
    if(m_NameIsSet)
    {
    ...
    if(m_NoteIsSet)
    {
        val["note"] = ModelBase::toJson(m_Note);
    }
...
void Vehicle::fromJson(const nlohmann::json& val)
{
    if(val.find("engineHours") != val.end())
    {
        setEngineHours(val.at("engineHours"));
    }
    if(val.find("fuelLevelPercent") != val.end())
    {
        setFuelLevelPercent(val.at("fuelLevelPercent"));
    }
    setId(val.at("id"));
...
void Vehicle::setEngineHours(int64_t const value)
{
    m_EngineHours = value;
...
void Vehicle::setFuelLevelPercent(double const value)
{
...
void Vehicle::setNote(std::string const& value)
{
    m_Note = value;
    m_NoteIsSet = true;
}
...
void Vehicle::setOdometerMeters(int64_t const value)
{
