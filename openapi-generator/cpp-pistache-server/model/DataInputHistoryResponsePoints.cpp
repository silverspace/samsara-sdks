...
nlohmann::json DataInputHistoryResponse_points::toJson() const
{
...
void DataInputHistoryResponse_points::fromJson(const nlohmann::json& val)
{
...
void DataInputHistoryResponse_points::setValue(double const value)
{
    m_Value = value;
    m_ValueIsSet = true;
}
...
void DataInputHistoryResponse_points::setTimeMs(int64_t const value)
{
    m_TimeMs = value;
    m_TimeMsIsSet = true;
}
