...
nlohmann::json UserBase::toJson() const
{
...
void UserBase::fromJson(const nlohmann::json& val)
{
...
std::string UserBase::getAuthType() const
{
    return m_AuthType;
}
void UserBase::setAuthType(std::string const& value)
{
    m_AuthType = value;
...
void UserBase::setName(std::string const& value)
{
    m_Name = value;
    m_NameIsSet = true;
}
...
std::string UserBase::getOrganizationRoleId() const
{
    return m_OrganizationRoleId;
}
void UserBase::setOrganizationRoleId(std::string const& value)
{
