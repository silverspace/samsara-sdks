...
nlohmann::json TagModify_delete::toJson() const
{
...
void TagModify_delete::fromJson(const nlohmann::json& val)
{
    {
        m_Assets.clear();
...
std::vector<TaggedAssetBase>& TagModify_delete::getAssets()
{
    return m_Assets;
}
...
std::vector<TaggedSensorBase>& TagModify_delete::getSensors()
{
    return m_Sensors;
}
...
std::vector<TaggedVehicleBase>& TagModify_delete::getVehicles()
{
    return m_Vehicles;
}
...
std::vector<TaggedMachineBase>& TagModify_delete::getMachines()
{
    return m_Machines;
}
...
std::vector<TaggedDriverBase>& TagModify_delete::getDrivers()
{
    return m_Drivers;
}
