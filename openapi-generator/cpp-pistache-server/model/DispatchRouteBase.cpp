...
nlohmann::json DispatchRouteBase::toJson() const
{
...
void DispatchRouteBase::fromJson(const nlohmann::json& val)
{
...
void DispatchRouteBase::setActualEndMs(int64_t const value)
{
...
void DispatchRouteBase::setActualStartMs(int64_t const value)
{
...
void DispatchRouteBase::setDriverId(int64_t const value)
{
    m_Driver_id = value;
...
void DispatchRouteBase::setGroupId(int64_t const value)
{
    m_Group_id = value;
...
std::string DispatchRouteBase::getName() const
{
    return m_Name;
}
void DispatchRouteBase::setName(std::string const& value)
{
    m_Name = value;
...
void DispatchRouteBase::setScheduledEndMs(int64_t const value)
{
...
void DispatchRouteBase::setScheduledMeters(int64_t const value)
{
...
void DispatchRouteBase::setScheduledStartMs(int64_t const value)
{
    m_Scheduled_start_ms = value;
    
}
std::string DispatchRouteBase::getStartLocationAddress() const
{
    return m_Start_location_address;
}
void DispatchRouteBase::setStartLocationAddress(std::string const& value)
{
...
void DispatchRouteBase::setStartLocationAddressId(int64_t const value)
{
...
void DispatchRouteBase::setStartLocationLat(double const value)
{
...
void DispatchRouteBase::setStartLocationLng(double const value)
{
...
std::string DispatchRouteBase::getStartLocationName() const
{
    return m_Start_location_name;
}
void DispatchRouteBase::setStartLocationName(std::string const& value)
{
...
void DispatchRouteBase::setTrailerId(int64_t const value)
{
    m_Trailer_id = value;
...
void DispatchRouteBase::setVehicleId(int64_t const value)
{
    m_Vehicle_id = value;
