...
nlohmann::json SafetyReportHarshEvent::toJson() const
{
...
void SafetyReportHarshEvent::fromJson(const nlohmann::json& val)
{
    if(val.find("harshEventType") != val.end())
    {
        setHarshEventType(val.at("harshEventType"));
    }
    if(val.find("timestampMs") != val.end())
    {
        setTimestampMs(val.at("timestampMs"));
    }
...
std::string SafetyReportHarshEvent::getHarshEventType() const
{
    return m_HarshEventType;
}
void SafetyReportHarshEvent::setHarshEventType(std::string const& value)
{
...
void SafetyReportHarshEvent::setTimestampMs(int32_t const value)
{
    m_TimestampMs = value;
...
void SafetyReportHarshEvent::setVehicleId(int32_t const value)
{
    m_VehicleId = value;
