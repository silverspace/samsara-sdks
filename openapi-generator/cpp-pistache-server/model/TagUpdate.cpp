...
nlohmann::json TagUpdate::toJson() const
{
...
void TagUpdate::fromJson(const nlohmann::json& val)
{
    {
        m_Assets.clear();
...
std::vector<TaggedAssetBase>& TagUpdate::getAssets()
{
    return m_Assets;
}
...
std::vector<TaggedDriverBase>& TagUpdate::getDrivers()
{
    return m_Drivers;
}
...
std::vector<TaggedMachineBase>& TagUpdate::getMachines()
{
    return m_Machines;
}
...
void TagUpdate::setName(std::string const& value)
{
    m_Name = value;
    m_NameIsSet = true;
}
...
void TagUpdate::setParentTagId(int64_t const value)
{
    m_ParentTagId = value;
...
std::vector<TaggedSensorBase>& TagUpdate::getSensors()
{
    return m_Sensors;
}
...
std::vector<TaggedVehicleBase>& TagUpdate::getVehicles()
{
    return m_Vehicles;
}
