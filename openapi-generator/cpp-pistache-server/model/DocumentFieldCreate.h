...
#ifndef DocumentFieldCreate_H_
#define DocumentFieldCreate_H_
...
public:
    ...
    void setNumberValue(double const value);
    ...
    /// </summary>
    std::vector<DocumentFieldCreate_photoValue>& getPhotoValue();
...
protected:
    ...
    std::vector<DocumentFieldCreate_photoValue> m_PhotoValue;
