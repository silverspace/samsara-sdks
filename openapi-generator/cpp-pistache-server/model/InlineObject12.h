...
public:
    ...
    void setOdometerMiles(int32_t const value);
    ...
    void setPreviousDefectsCorrected(bool const value);
    ...
    void setPreviousDefectsIgnored(bool const value);
    bool previousDefectsIgnoredIsSet() const;
    void unsetPreviousDefectsIgnored();
    /// <summary>
    /// Whether or not this vehicle or trailer is safe to drive.
    /// </summary>
    std::string getSafe() const;
    void setSafe(std::string const& value);
        /// <summary>
