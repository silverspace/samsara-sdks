...
nlohmann::json DocumentCreate::toJson() const
{
    ...
    val["documentTypeUuid"] = ModelBase::toJson(m_DocumentTypeUuid);
    {
...
void DocumentCreate::fromJson(const nlohmann::json& val)
{
    ...
    setDocumentTypeUuid(val.at("documentTypeUuid"));
    {
        m_Fields.clear();
...
void DocumentCreate::setDispatchJobId(int64_t const value)
{
...
void DocumentCreate::setNotes(std::string const& value)
{
    m_Notes = value;
    m_NotesIsSet = true;
}
...
void DocumentCreate::setDocumentTypeUuid(std::string const& value)
{
    m_DocumentTypeUuid = value;
    
}
std::vector<DocumentField>& DocumentCreate::getFields()
{
    return m_Fields;
}
