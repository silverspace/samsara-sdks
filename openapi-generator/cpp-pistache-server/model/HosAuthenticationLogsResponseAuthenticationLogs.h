...
#ifndef HosAuthenticationLogsResponse_authenticationLogs_H_
#define HosAuthenticationLogsResponse_authenticationLogs_H_
...
public:
    ...
    void setHappenedAtMs(int64_t const value);
    ...
    void setAddressName(std::string const& value);
...
#endif /* HosAuthenticationLogsResponse_authenticationLogs_H_ */
