...
nlohmann::json CargoResponse_sensors::toJson() const
{
    nlohmann::json val = nlohmann::json::object();

    if(m_CargoEmptyIsSet)
    {
        val["cargoEmpty"] = m_CargoEmpty;
    }
    if(m_NameIsSet)
    {
...
void CargoResponse_sensors::fromJson(const nlohmann::json& val)
{
    if(val.find("cargoEmpty") != val.end())
    {
        setCargoEmpty(val.at("cargoEmpty"));
    }
...
void CargoResponse_sensors::setCargoEmpty(bool const value)
{
    m_CargoEmpty = value;
...
std::string CargoResponse_sensors::getName() const
{
    return m_Name;
}
void CargoResponse_sensors::setName(std::string const& value)
{
    m_Name = value;
    m_NameIsSet = true;
}
...
void CargoResponse_sensors::setId(int64_t const value)
{
    m_Id = value;
    m_IdIsSet = true;
}
