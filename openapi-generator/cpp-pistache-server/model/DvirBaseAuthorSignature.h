...
#ifndef DvirBase_authorSignature_H_
#define DvirBase_authorSignature_H_
...
public:
    ...
    void setMechanicUserId(int64_t const value);
    ...
    void setSignedAt(int64_t const value);
...
#endif /* DvirBase_authorSignature_H_ */
