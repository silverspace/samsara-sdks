...
void Inline_object_1::setFormattedAddress(std::string const& value)
{
...
AddressGeofence Inline_object_1::getGeofence() const
{
    return m_Geofence;
}
void Inline_object_1::setGeofence(AddressGeofence const& value)
{
    m_Geofence = value;
...
void Inline_object_1::setName(std::string const& value)
{
    m_Name = value;
    m_NameIsSet = true;
}
...
void Inline_object_1::setNotes(std::string const& value)
{
    m_Notes = value;
    m_NotesIsSet = true;
}
