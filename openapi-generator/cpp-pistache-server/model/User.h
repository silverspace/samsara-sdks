...
public:
    ...
    /// </summary>
    std::string getOrganizationRoleId() const;
    void setOrganizationRoleId(std::string const& value);
    ...
    /// </summary>
    std::string getOrganizationRole() const;
    void setOrganizationRole(std::string const& value);
    ...
    /// </summary>
    std::vector<UserTagRole>& getTagRoles();
...
protected:
    ...
    std::string m_Name;
    bool m_NameIsSet;
    std::string m_OrganizationRoleId;
    bool m_OrganizationRoleIdIsSet;
    int64_t m_Id;
    bool m_IdIsSet;
    std::string m_OrganizationRole;
    bool m_OrganizationRoleIsSet;
    std::vector<UserTagRole> m_TagRoles;
