...
public:
    ...
    void setFormattedAddress(std::string const& value);
        /// <summary>
    /// 
    /// </summary>
    AddressGeofence getGeofence() const;
    void setGeofence(AddressGeofence const& value);
        /// <summary>
    /// A list of tag IDs.
    /// </summary>
