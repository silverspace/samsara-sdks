...
nlohmann::json FleetVehicleResponse::toJson() const
{
    ...
    {
        val["harshAccelSetting"] = ModelBase::toJson(m_HarshAccelSetting);
    }
    val["id"] = m_Id;
    val["name"] = ModelBase::toJson(m_Name);
    if(m_VehicleInfoIsSet)
    {
        val["vehicleInfo"] = ModelBase::toJson(m_VehicleInfo);
    }
...
void FleetVehicleResponse::fromJson(const nlohmann::json& val)
{
    {
        m_ExternalIds.clear();
    ...
    if(val.find("harshAccelSetting") != val.end())
    {
        setHarshAccelSetting(val.at("harshAccelSetting"));
    }
    setId(val.at("id"));
    setName(val.at("name"));
    if(val.find("vehicleInfo") != val.end())
    {
        if(!val["vehicleInfo"].is_null())
        {
            FleetVehicleResponse_vehicleInfo newItem;
            newItem.fromJson(val["vehicleInfo"]);
...
std::map<std::string, std::string>& FleetVehicleResponse::getExternalIds()
{
...
std::string FleetVehicleResponse::getHarshAccelSetting() const
{
    return m_HarshAccelSetting;
}
void FleetVehicleResponse::setHarshAccelSetting(std::string const& value)
{
...
void FleetVehicleResponse::setId(int64_t const value)
{
    m_Id = value;
    
}
std::string FleetVehicleResponse::getName() const
{
    return m_Name;
}
void FleetVehicleResponse::setName(std::string const& value)
{
    m_Name = value;
    
}
FleetVehicleResponse_vehicleInfo FleetVehicleResponse::getVehicleInfo() const
{
    return m_VehicleInfo;
}
void FleetVehicleResponse::setVehicleInfo(FleetVehicleResponse_vehicleInfo const& value)
{
    m_VehicleInfo = value;
