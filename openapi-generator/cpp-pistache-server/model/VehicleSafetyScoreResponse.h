...
#ifndef VehicleSafetyScoreResponse_H_
#define VehicleSafetyScoreResponse_H_
...
public:
    ...
    void setCrashCount(int32_t const value);
    ...
    void setHarshAccelCount(int32_t const value);
    ...
    void setHarshBrakingCount(int32_t const value);
    bool harshBrakingCountIsSet() const;
    void unsetHarshBrakingCount();
    /// <summary>
    /// 
    /// </summary>
    std::vector<SafetyReportHarshEvent>& getHarshEvents();
    ...
    void setHarshTurningCount(int32_t const value);
    ...
    void setSafetyScore(int32_t const value);
    bool safetyScoreIsSet() const;
    void unsetSafetyScore();
    /// <summary>
    /// Safety Score Rank
    /// </summary>
    std::string getSafetyScoreRank() const;
    void setSafetyScoreRank(std::string const& value);
    ...
    void setTimeOverSpeedLimitMs(int32_t const value);
    ...
    void setTotalDistanceDrivenMeters(int32_t const value);
    ...
    void setTotalHarshEventCount(int32_t const value);
    ...
    void setTotalTimeDrivenMs(int32_t const value);
    ...
    void setVehicleId(int32_t const value);
...
protected:
    ...
    std::vector<SafetyReportHarshEvent> m_HarshEvents;
...
#endif /* VehicleSafetyScoreResponse_H_ */
