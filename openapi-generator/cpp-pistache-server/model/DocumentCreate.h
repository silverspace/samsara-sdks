...
public:
    ...
    void setDispatchJobId(int64_t const value);
    ...
    void setDocumentTypeUuid(std::string const& value);
        /// <summary>
    ...
    /// </summary>
    std::vector<DocumentField>& getFields();
...
protected:
    ...
    std::vector<DocumentField> m_Fields;
