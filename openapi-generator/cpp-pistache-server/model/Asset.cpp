...
nlohmann::json Asset::toJson() const
{
    ...
    {
        val["assetSerialNumber"] = ModelBase::toJson(m_AssetSerialNumber);
    }
    {
...
void Asset::fromJson(const nlohmann::json& val)
{
    if(val.find("assetSerialNumber") != val.end())
    {
        setAssetSerialNumber(val.at("assetSerialNumber"));
    }
    {
        m_Cable.clear();
...
std::string Asset::getAssetSerialNumber() const
{
    return m_AssetSerialNumber;
}
void Asset::setAssetSerialNumber(std::string const& value)
{
...
std::vector<Asset_cable>& Asset::getCable()
{
    return m_Cable;
}
...
void Asset::setEngineHours(int32_t const value)
{
    m_EngineHours = value;
