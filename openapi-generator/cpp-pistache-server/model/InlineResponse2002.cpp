...
Pagination Inline_response_200_2::getPagination() const
{
    return m_Pagination;
}
void Inline_response_200_2::setPagination(Pagination const& value)
{
    m_Pagination = value;
...
void Inline_response_200_2::setGroupId(int64_t const value)
{
    m_GroupId = value;
    m_GroupIdIsSet = true;
}
...
std::vector<Vehicle>& Inline_response_200_2::getVehicles()
{
    return m_Vehicles;
}
