...
#ifndef DriverDailyLogResponse_days_H_
#define DriverDailyLogResponse_days_H_
...
public:
    ...
    void setCertifiedAtMs(int64_t const value);
    ...
    /// </summary>
    Object getTrailerIds() const;
    void setTrailerIds(Object const& value);
    ...
    void setActiveHours(double const value);
    ...
    void setCertified(bool const value);
    bool certifiedIsSet() const;
    void unsetCertified();
    /// <summary>
    /// List of vehicle ID&#39;s associated with the driver for the day.
    /// </summary>
    Object getVehicleIds() const;
    void setVehicleIds(Object const& value);
...
#endif /* DriverDailyLogResponse_days_H_ */
