...
#ifndef DriversSummaryResponse_Summaries_H_
#define DriversSummaryResponse_Summaries_H_
...
public:
    ...
    void setDistanceMiles(double const value);
    ...
    void setDriveMs(int64_t const value);
    ...
    void setActiveMs(int64_t const value);
    ...
    void setDriverUsername(std::string const& value);
    ...
    void setOnDutyMs(int64_t const value);
...
#endif /* DriversSummaryResponse_Summaries_H_ */
