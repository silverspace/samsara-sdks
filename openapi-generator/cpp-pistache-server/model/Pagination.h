...
public:
    ...
    /// </summary>
    std::string getStartCursor() const;
    void setStartCursor(std::string const& value);
    
protected:
    std::string m_EndCursor;

    bool m_HasNextPage;

    bool m_HasPrevPage;

    std::string m_StartCursor;
