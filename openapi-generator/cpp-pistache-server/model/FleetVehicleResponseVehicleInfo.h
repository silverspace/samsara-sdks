...
#ifndef FleetVehicleResponse_vehicleInfo_H_
#define FleetVehicleResponse_vehicleInfo_H_
...
public:
    ...
    void setYear(int64_t const value);
...
#endif /* FleetVehicleResponse_vehicleInfo_H_ */
