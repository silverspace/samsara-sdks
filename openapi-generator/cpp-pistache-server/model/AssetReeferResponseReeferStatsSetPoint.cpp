...
nlohmann::json AssetReeferResponse_reeferStats_setPoint::toJson() const
{
...
void AssetReeferResponse_reeferStats_setPoint::fromJson(const nlohmann::json& val)
{
...
void AssetReeferResponse_reeferStats_setPoint::setTempInMilliC(int64_t const value)
{
...
void AssetReeferResponse_reeferStats_setPoint::setChangedAtMs(int64_t const value)
{
    m_ChangedAtMs = value;
