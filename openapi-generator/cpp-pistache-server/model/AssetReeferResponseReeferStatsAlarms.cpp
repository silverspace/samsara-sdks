...
nlohmann::json AssetReeferResponse_reeferStats_alarms::toJson() const
{
    ...
    {
        val["operatorAction"] = ModelBase::toJson(m_OperatorAction);
    }
...
void AssetReeferResponse_reeferStats_alarms::fromJson(const nlohmann::json& val)
{
    if(val.find("severity") != val.end())
    {
        setSeverity(val.at("severity"));
    }
    if(val.find("operatorAction") != val.end())
    {
        setOperatorAction(val.at("operatorAction"));
    }
    if(val.find("description") != val.end())
    {
        setDescription(val.at("description"));
    }
    if(val.find("alarmCode") != val.end())
    {
        setAlarmCode(val.at("alarmCode"));
    }
...
void AssetReeferResponse_reeferStats_alarms::setSeverity(int64_t const value)
{
    m_Severity = value;
...
std::string AssetReeferResponse_reeferStats_alarms::getOperatorAction() const
{
    return m_OperatorAction;
}
void AssetReeferResponse_reeferStats_alarms::setOperatorAction(std::string const& value)
{
...
std::string AssetReeferResponse_reeferStats_alarms::getDescription() const
{
    return m_Description;
}
void AssetReeferResponse_reeferStats_alarms::setDescription(std::string const& value)
{
    m_Description = value;
...
void AssetReeferResponse_reeferStats_alarms::setAlarmCode(int64_t const value)
{
    m_AlarmCode = value;
