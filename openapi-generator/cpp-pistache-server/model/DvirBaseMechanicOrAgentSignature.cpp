...
nlohmann::json DvirBase_mechanicOrAgentSignature::toJson() const
{
...
void DvirBase_mechanicOrAgentSignature::fromJson(const nlohmann::json& val)
{
...
void DvirBase_mechanicOrAgentSignature::setMechanicUserId(int64_t const value)
{
...
void DvirBase_mechanicOrAgentSignature::setDriverId(int64_t const value)
{
    m_DriverId = value;
...
std::string DvirBase_mechanicOrAgentSignature::getName() const
{
    return m_Name;
}
void DvirBase_mechanicOrAgentSignature::setName(std::string const& value)
{
    m_Name = value;
    m_NameIsSet = true;
}
...
void DvirBase_mechanicOrAgentSignature::setSignedAt(int64_t const value)
{
    m_SignedAt = value;
...
std::string DvirBase_mechanicOrAgentSignature::getType() const
{
    return m_Type;
}
void DvirBase_mechanicOrAgentSignature::setType(std::string const& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}
...
std::string DvirBase_mechanicOrAgentSignature::getEmail() const
{
    return m_Email;
}
void DvirBase_mechanicOrAgentSignature::setEmail(std::string const& value)
{
    m_Email = value;
    m_EmailIsSet = true;
}
...
std::string DvirBase_mechanicOrAgentSignature::getUsername() const
{
    return m_Username;
}
void DvirBase_mechanicOrAgentSignature::setUsername(std::string const& value)
{
    m_Username = value;
