...
nlohmann::json DriversSummaryResponse_Summaries::toJson() const
{
    ...
    {
        val["driverUsername"] = ModelBase::toJson(m_DriverUsername);
    }
    if(m_GroupIdIsSet)
    {
...
void DriversSummaryResponse_Summaries::fromJson(const nlohmann::json& val)
{
    ...
    if(val.find("driveMs") != val.end())
    {
        setDriveMs(val.at("driveMs"));
    }
    if(val.find("activeMs") != val.end())
    {
        setActiveMs(val.at("activeMs"));
    }
    if(val.find("driverUsername") != val.end())
    {
        setDriverUsername(val.at("driverUsername"));
    }
    ...
    if(val.find("onDutyMs") != val.end())
    {
        setOnDutyMs(val.at("onDutyMs"));
    }
...
void DriversSummaryResponse_Summaries::setDriverId(int64_t const value)
{
    m_DriverId = value;
...
void DriversSummaryResponse_Summaries::setDistanceMiles(double const value)
{
...
void DriversSummaryResponse_Summaries::setDriveMs(int64_t const value)
{
    m_DriveMs = value;
    m_DriveMsIsSet = true;
}
...
void DriversSummaryResponse_Summaries::setActiveMs(int64_t const value)
{
    m_ActiveMs = value;
...
std::string DriversSummaryResponse_Summaries::getDriverUsername() const
{
    return m_DriverUsername;
}
void DriversSummaryResponse_Summaries::setDriverUsername(std::string const& value)
{
...
void DriversSummaryResponse_Summaries::setGroupId(int64_t const value)
{
    m_GroupId = value;
    m_GroupIdIsSet = true;
}
...
std::string DriversSummaryResponse_Summaries::getDriverName() const
{
    return m_DriverName;
}
void DriversSummaryResponse_Summaries::setDriverName(std::string const& value)
{
    m_DriverName = value;
...
void DriversSummaryResponse_Summaries::setOnDutyMs(int64_t const value)
{
    m_OnDutyMs = value;
