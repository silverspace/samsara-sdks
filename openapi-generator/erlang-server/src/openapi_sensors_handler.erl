%% basic handler
-module(openapi_sensors_handler).
...
allowed_methods(
    Req,
    State = #state{
        operation_id = 'GetSensorsHistory'
    }
) ->
    {[<<"POST">>], Req, State};
...
allowed_methods(
    Req,
    State = #state{
        operation_id = 'GetSensorsHumidity'
    }
) ->
    {[<<"POST">>], Req, State};
...
allowed_methods(
    Req,
    State = #state{
        operation_id = 'GetSensorsTemperature'
    }
) ->
    {[<<"POST">>], Req, State};
