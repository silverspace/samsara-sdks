...
class AssetsApi(
  ...
  val helper = new AssetsApiAsyncHelper(client, config)
...
class AssetsApiAsyncHelper(client: TransportClient, config: SwaggerConfig) extends ApiClient(client, config) {
  ...
  def getAllAssetCurrentLocations(accessToken: String,
    ...
    if (accessToken == null) throw new Exception("Missing required parameter 'accessToken' when calling AssetsApi->getAllAssetCurrentLocations")
  ...
  def getAllAssets(accessToken: String,
    ...
    if (accessToken == null) throw new Exception("Missing required parameter 'accessToken' when calling AssetsApi->getAllAssets")
  ...
  def getAssetLocation(accessToken: String,
    ...
    if (accessToken == null) throw new Exception("Missing required parameter 'accessToken' when calling AssetsApi->getAssetLocation")
  ...
  def getAssetReefer(accessToken: String,
    ...
    if (accessToken == null) throw new Exception("Missing required parameter 'accessToken' when calling AssetsApi->getAssetReefer")
