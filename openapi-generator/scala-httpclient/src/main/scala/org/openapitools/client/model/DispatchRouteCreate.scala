...
case class DispatchRouteCreate (
  ...
  actualEndMs: Option[Long] = None,
  // The time in Unix epoch milliseconds that the route actually started.
  actualStartMs: Option[Long] = None,
  ...
  scheduledMeters: Option[Long] = None,
  ...
  startLocationAddress: Option[String] = None,
