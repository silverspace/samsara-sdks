...
class FleetApi(
   ...
   * @return void
   */
  def addFleetAddress(accessToken: String, addressParam: InlineObject2) = {
   ...
   * @return Future(void)
   */
  def addFleetAddressAsync(accessToken: String, addressParam: InlineObject2) = {
   ...
   * @return List[Address]
   */
  def addOrganizationAddresses(accessToken: String, addresses: InlineObject): Option[List[Address]] = {
   ...
   */
  def addOrganizationAddressesAsync(accessToken: String, addresses: InlineObject): Future[List[Address]] = {
   ...
   * @return DvirBase
   */
  def createDvir(accessToken: String, createDvirParam: InlineObject12): Option[DvirBase] = {
   ...
   */
  def createDvirAsync(accessToken: String, createDvirParam: InlineObject12): Future[DvirBase] = {
   ...
   */
  def fetchAllDispatchRoutes(accessToken: String, groupId: Option[Long] = None, endTime: Option[Long] = None, duration: Option[Long] = None): Option[List[DispatchRoute]] = {
   ...
   * @param endTime Time in unix milliseconds that represents the oldest routes to return. Used in combination with duration. Defaults to now. (optional)
   * @param duration Time in milliseconds that represents the duration before end_time to query. Defaults to 24 hours. (optional)
   * @return Future(List[DispatchRoute])
   */
  def fetchAllDispatchRoutesAsync(accessToken: String, groupId: Option[Long] = None, endTime: Option[Long] = None, duration: Option[Long] = None): Future[List[DispatchRoute]] = {
   ...
   * @return List[Any]
   */
  def getAssetLocation(accessToken: String, assetId: Long, startMs: Long, endMs: Long): Option[List[Any]] = {
   ...
   */
  def getAssetLocationAsync(accessToken: String, assetId: Long, startMs: Long, endMs: Long): Future[List[Any]] = {
   ...
   * @return List[DispatchRoute]
   */
  def getDispatchRoutesByDriverId(accessToken: String, driverId: Long, endTime: Option[Long] = None, duration: Option[Long] = None): Option[List[DispatchRoute]] = {
   ...
   * @return Future(List[DispatchRoute])
   */
  def getDispatchRoutesByDriverIdAsync(accessToken: String, driverId: Long, endTime: Option[Long] = None, duration: Option[Long] = None): Future[List[DispatchRoute]] = {
   ...
   * @return List[DispatchRoute]
   */
  def getDispatchRoutesByVehicleId(accessToken: String, vehicleId: Long, endTime: Option[Long] = None, duration: Option[Long] = None): Option[List[DispatchRoute]] = {
   ...
   * @return Future(List[DispatchRoute])
   */
  def getDispatchRoutesByVehicleIdAsync(accessToken: String, vehicleId: Long, endTime: Option[Long] = None, duration: Option[Long] = None): Future[List[DispatchRoute]] = {
   ...
   * @return Driver
   */
  def getDriverById(accessToken: String, driverIdOrExternalId: String): Option[Driver] = {
   ...
   * @return Future(Driver)
   */
  def getDriverByIdAsync(accessToken: String, driverIdOrExternalId: String): Future[Driver] = {
   ...
   */
  def getDriverDocumentTypesByOrgId(): Option[List[DocumentType]] = {
   ...
   * Fetch all of the document types.
   *
   * @return Future(List[DocumentType])
   */
  def getDriverDocumentTypesByOrgIdAsync(): Future[List[DocumentType]] = {
   ...
   */
  def getDriverDocumentsByOrgId(accessToken: String, endMs: Option[Long] = None, durationMs: Option[Long] = None): Option[List[Document]] = {
   ...
   */
  def getDriverDocumentsByOrgIdAsync(accessToken: String, endMs: Option[Long] = None, durationMs: Option[Long] = None): Future[List[Document]] = {
   ...
   */
  def getFleetDrivers(accessToken: String, groupDriversParam: InlineObject3): Option[DriversResponse] = {
   ...
   */
  def getFleetDriversAsync(accessToken: String, groupDriversParam: InlineObject3): Future[DriversResponse] = {
   ...
   */
  def getFleetDriversHosDailyLogs(accessToken: String, driverId: Long, hosLogsParam: InlineObject6): Option[DriverDailyLogResponse] = {
   ...
   */
  def getFleetDriversHosDailyLogsAsync(accessToken: String, driverId: Long, hosLogsParam: InlineObject6): Future[DriverDailyLogResponse] = {
   ...
   */
  def getFleetDriversSummary(accessToken: String, driversSummaryParam: InlineObject5, snapToDayBounds: Option[Boolean] = None): Option[DriversSummaryResponse] = {
   ...
   */
  def getFleetDriversSummaryAsync(accessToken: String, driversSummaryParam: InlineObject5, snapToDayBounds: Option[Boolean] = None): Future[DriversSummaryResponse] = {
   ...
   */
  def getFleetHosAuthenticationLogs(accessToken: String, hosAuthenticationLogsParam: InlineObject7): Option[HosAuthenticationLogsResponse] = {
   ...
   */
  def getFleetHosAuthenticationLogsAsync(accessToken: String, hosAuthenticationLogsParam: InlineObject7): Future[HosAuthenticationLogsResponse] = {
   ...
   */
  def getFleetHosLogs(accessToken: String, hosLogsParam: InlineObject8): Option[HosLogsResponse] = {
   ...
   */
  def getFleetHosLogsAsync(accessToken: String, hosLogsParam: InlineObject8): Future[HosLogsResponse] = {
   ...
   */
  def getFleetHosLogsSummary(accessToken: String, hosLogsParam: InlineObject9): Option[HosLogsSummaryResponse] = {
   ...
   */
  def getFleetHosLogsSummaryAsync(accessToken: String, hosLogsParam: InlineObject9): Future[HosLogsSummaryResponse] = {
   ...
   */
  def getFleetLocations(accessToken: String, groupParam: InlineObject11): Option[InlineResponse2003] = {
   ...
   */
  def getFleetLocationsAsync(accessToken: String, groupParam: InlineObject11): Future[InlineResponse2003] = {
   ...
   */
  def getFleetMaintenanceList(accessToken: String, groupParam: InlineObject13): Option[InlineResponse2004] = {
   ...
   */
  def getFleetMaintenanceListAsync(accessToken: String, groupParam: InlineObject13): Future[InlineResponse2004] = {
   ...
   * @return TripResponse
   */
  def getFleetTrips(accessToken: String, tripsParam: InlineObject15): Option[TripResponse] = {
   ...
   */
  def getFleetTripsAsync(accessToken: String, tripsParam: InlineObject15): Future[TripResponse] = {
   ...
   */
  def getVehicleLocations(accessToken: String, vehicleId: Long, startMs: Long, endMs: Long): Option[List[FleetVehicleLocation]] = {
   ...
   * @param startMs Time in Unix epoch milliseconds for the start of the query (cannot exceed 1 hour) 
   * @param endMs Time in Unix epoch milliseconds for the end of the query (cannot exceed 1 hour) 
   * @return Future(List[FleetVehicleLocation])
   */
  def getVehicleLocationsAsync(accessToken: String, vehicleId: Long, startMs: Long, endMs: Long): Future[List[FleetVehicleLocation]] = {
   ...
   * @return List[Any]
   */
  def getVehiclesLocations(accessToken: String, startMs: Integer, endMs: Integer): Option[List[Any]] = {
   ...
   * @return Future(List[Any])
   */
  def getVehiclesLocationsAsync(accessToken: String, startMs: Integer, endMs: Integer): Future[List[Any]] = {
   ...
   */
  def listFleet(accessToken: String, groupParam: InlineObject10, startingAfter: Option[String] = None, endingBefore: Option[String] = None, limit: Option[Long] = None): Option[InlineResponse2002] = {
   ...
   */
  def listFleetAsync(accessToken: String, groupParam: InlineObject10, startingAfter: Option[String] = None, endingBefore: Option[String] = None, limit: Option[Long] = None): Future[InlineResponse2002] = {
   ...
   * @return FleetVehicleResponse
   */
  def patchFleetVehicle(accessToken: String, vehicleIdOrExternalId: String, data: InlineObject16): Option[FleetVehicleResponse] = {
   ...
   * @return Future(FleetVehicleResponse)
   */
  def patchFleetVehicleAsync(accessToken: String, vehicleIdOrExternalId: String, data: InlineObject16): Future[FleetVehicleResponse] = {
   ...
   * @return Driver
   */
  def reactivateDriverById(accessToken: String, driverIdOrExternalId: String, reactivateDriverParam: InlineObject4): Option[Driver] = {
   ...
   * @return Future(Driver)
   */
  def reactivateDriverByIdAsync(accessToken: String, driverIdOrExternalId: String, reactivateDriverParam: InlineObject4): Future[Driver] = {
   ...
   * @return void
   */
  def updateOrganizationAddress(accessToken: String, addressId: Long, address: InlineObject1) = {
    val await = Try(Await.result(updateOrganizationAddressAsync(accessToken, addressId, address), Duration.Inf))
    await match {
      case Success(i) => Some(await.get)
      case Failure(t) => None
    }
   ...
   * @return Future(void)
   */
  def updateOrganizationAddressAsync(accessToken: String, addressId: Long, address: InlineObject1) = {
      helper.updateOrganizationAddress(accessToken, addressId, address)
  }
   ...
   * @return void
   */
  def updateVehicles(accessToken: String, vehicleUpdateParam: InlineObject14) = {
   ...
   * @return Future(void)
   */
  def updateVehiclesAsync(accessToken: String, vehicleUpdateParam: InlineObject14) = {
...
class FleetApiAsyncHelper(client: TransportClient, config: SwaggerConfig) extends ApiClient(client, config) {
  ...
  def addFleetAddress(accessToken: String,
    addressParam: InlineObject2)(implicit reader: ClientResponseReader[Unit], writer: RequestWriter[InlineObject2]): Future[Unit] = {
  ...
  def addOrganizationAddresses(accessToken: String,
    addresses: InlineObject)(implicit reader: ClientResponseReader[List[Address]], writer: RequestWriter[InlineObject]): Future[List[Address]] = {
    // create path and map variables
  ...
  def createDvir(accessToken: String,
    createDvirParam: InlineObject12)(implicit reader: ClientResponseReader[DvirBase], writer: RequestWriter[InlineObject12]): Future[DvirBase] = {
    // create path and map variables
  ...
  def fetchAllDispatchRoutes(accessToken: String,
    ...
    )(implicit reader: ClientResponseReader[List[DispatchRoute]]): Future[List[DispatchRoute]] = {
    // create path and map variables
    val path = (addFmt("/fleet/dispatch/routes"))
  ...
  def getAssetLocation(accessToken: String,
    assetId: Long,
    startMs: Long,
    endMs: Long)(implicit reader: ClientResponseReader[List[Any]]): Future[List[Any]] = {
    // create path and map variables
  ...
  def getDriverDocumentTypesByOrgId()(implicit reader: ClientResponseReader[List[DocumentType]]): Future[List[DocumentType]] = {
    // create path and map variables
  ...
  def getDriverDocumentsByOrgId(accessToken: String,
    ...
    )(implicit reader: ClientResponseReader[List[Document]]): Future[List[Document]] = {
    // create path and map variables
  ...
  def getFleetDrivers(accessToken: String,
    groupDriversParam: InlineObject3)(implicit reader: ClientResponseReader[DriversResponse], writer: RequestWriter[InlineObject3]): Future[DriversResponse] = {
    // create path and map variables
  ...
  def getFleetDriversHosDailyLogs(accessToken: String,
    driverId: Long,
    hosLogsParam: InlineObject6)(implicit reader: ClientResponseReader[DriverDailyLogResponse], writer: RequestWriter[InlineObject6]): Future[DriverDailyLogResponse] = {
    // create path and map variables
  ...
  def getFleetDriversSummary(accessToken: String,
    ...
    )(implicit reader: ClientResponseReader[DriversSummaryResponse], writer: RequestWriter[InlineObject5]): Future[DriversSummaryResponse] = {
    // create path and map variables
  ...
  def getFleetHosAuthenticationLogs(accessToken: String,
    hosAuthenticationLogsParam: InlineObject7)(implicit reader: ClientResponseReader[HosAuthenticationLogsResponse], writer: RequestWriter[InlineObject7]): Future[HosAuthenticationLogsResponse] = {
    // create path and map variables
  ...
  def getFleetHosLogs(accessToken: String,
    hosLogsParam: InlineObject8)(implicit reader: ClientResponseReader[HosLogsResponse], writer: RequestWriter[InlineObject8]): Future[HosLogsResponse] = {
    // create path and map variables
  ...
  def getFleetHosLogsSummary(accessToken: String,
    hosLogsParam: InlineObject9)(implicit reader: ClientResponseReader[HosLogsSummaryResponse], writer: RequestWriter[InlineObject9]): Future[HosLogsSummaryResponse] = {
    // create path and map variables
  ...
  def getFleetLocations(accessToken: String,
    groupParam: InlineObject11)(implicit reader: ClientResponseReader[InlineResponse2003], writer: RequestWriter[InlineObject11]): Future[InlineResponse2003] = {
    // create path and map variables
  ...
  def getFleetMaintenanceList(accessToken: String,
    groupParam: InlineObject13)(implicit reader: ClientResponseReader[InlineResponse2004], writer: RequestWriter[InlineObject13]): Future[InlineResponse2004] = {
    // create path and map variables
  ...
  def getFleetTrips(accessToken: String,
    tripsParam: InlineObject15)(implicit reader: ClientResponseReader[TripResponse], writer: RequestWriter[InlineObject15]): Future[TripResponse] = {
    // create path and map variables
  ...
  def getVehicleLocations(accessToken: String,
    vehicleId: Long,
    startMs: Long,
    endMs: Long)(implicit reader: ClientResponseReader[List[FleetVehicleLocation]]): Future[List[FleetVehicleLocation]] = {
    // create path and map variables
  ...
  def getVehiclesLocations(accessToken: String,
    startMs: Integer,
    endMs: Integer)(implicit reader: ClientResponseReader[List[Any]]): Future[List[Any]] = {
    // create path and map variables
  ...
  def listFleet(accessToken: String,
    ...
    endingBefore: Option[String] = None,
    limit: Option[Long] = None
    )(implicit reader: ClientResponseReader[InlineResponse2002], writer: RequestWriter[InlineObject10]): Future[InlineResponse2002] = {
    // create path and map variables
  ...
  def patchFleetVehicle(accessToken: String,
    ...
    data: InlineObject16)(implicit reader: ClientResponseReader[FleetVehicleResponse], writer: RequestWriter[InlineObject16]): Future[FleetVehicleResponse] = {
    // create path and map variables
    val path = (addFmt("/fleet/vehicles/{vehicle_id_or_external_id}")
      replaceAll("\\{" + "vehicle_id_or_external_id" + "\\}", vehicleIdOrExternalId.toString))
  ...
  def reactivateDriverById(accessToken: String,
    ...
    reactivateDriverParam: InlineObject4)(implicit reader: ClientResponseReader[Driver], writer: RequestWriter[InlineObject4]): Future[Driver] = {
    // create path and map variables
    val path = (addFmt("/fleet/drivers/inactive/{driver_id_or_external_id}")
      replaceAll("\\{" + "driver_id_or_external_id" + "\\}", driverIdOrExternalId.toString))
  ...
  def updateOrganizationAddress(accessToken: String,
    addressId: Long,
    address: InlineObject1)(implicit reader: ClientResponseReader[Unit], writer: RequestWriter[InlineObject1]): Future[Unit] = {
    // create path and map variables
    val path = (addFmt("/addresses/{addressId}")
      replaceAll("\\{" + "addressId" + "\\}", addressId.toString))
  ...
  def updateVehicles(accessToken: String,
    vehicleUpdateParam: InlineObject14)(implicit reader: ClientResponseReader[Unit], writer: RequestWriter[InlineObject14]): Future[Unit] = {
    // create path and map variables
