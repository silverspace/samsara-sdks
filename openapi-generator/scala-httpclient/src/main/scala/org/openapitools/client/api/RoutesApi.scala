...
class RoutesApi(
  ...
  val helper = new RoutesApiAsyncHelper(client, config)
...
class RoutesApiAsyncHelper(client: TransportClient, config: SwaggerConfig) extends ApiClient(client, config) {
  ...
  def createDispatchRoute(accessToken: String,
    ...
    if (accessToken == null) throw new Exception("Missing required parameter 'accessToken' when calling RoutesApi->createDispatchRoute")

    if (createDispatchRouteParams == null) throw new Exception("Missing required parameter 'createDispatchRouteParams' when calling RoutesApi->createDispatchRoute")
  ...
  def createDriverDispatchRoute(accessToken: String,
    ...
    if (accessToken == null) throw new Exception("Missing required parameter 'accessToken' when calling RoutesApi->createDriverDispatchRoute")

    if (createDispatchRouteParams == null) throw new Exception("Missing required parameter 'createDispatchRouteParams' when calling RoutesApi->createDriverDispatchRoute")
    queryParams += "access_token" -> accessToken.toString
  ...
  def createVehicleDispatchRoute(accessToken: String,
    ...
    if (accessToken == null) throw new Exception("Missing required parameter 'accessToken' when calling RoutesApi->createVehicleDispatchRoute")

    if (createDispatchRouteParams == null) throw new Exception("Missing required parameter 'createDispatchRouteParams' when calling RoutesApi->createVehicleDispatchRoute")
    queryParams += "access_token" -> accessToken.toString
  ...
  def deleteDispatchRouteById(accessToken: String,
    ...
    if (accessToken == null) throw new Exception("Missing required parameter 'accessToken' when calling RoutesApi->deleteDispatchRouteById")
  ...
  def fetchAllDispatchRoutes(accessToken: String,
    ...
    if (accessToken == null) throw new Exception("Missing required parameter 'accessToken' when calling RoutesApi->fetchAllDispatchRoutes")
  ...
  def fetchAllRouteJobUpdates(accessToken: String,
    ...
    if (accessToken == null) throw new Exception("Missing required parameter 'accessToken' when calling RoutesApi->fetchAllRouteJobUpdates")
  ...
  def getDispatchRouteById(accessToken: String,
    ...
    if (accessToken == null) throw new Exception("Missing required parameter 'accessToken' when calling RoutesApi->getDispatchRouteById")
  ...
  def getDispatchRouteHistory(accessToken: String,
    ...
    if (accessToken == null) throw new Exception("Missing required parameter 'accessToken' when calling RoutesApi->getDispatchRouteHistory")
  ...
  def getDispatchRoutesByDriverId(accessToken: String,
    ...
    if (accessToken == null) throw new Exception("Missing required parameter 'accessToken' when calling RoutesApi->getDispatchRoutesByDriverId")
  ...
  def getDispatchRoutesByVehicleId(accessToken: String,
    ...
    if (accessToken == null) throw new Exception("Missing required parameter 'accessToken' when calling RoutesApi->getDispatchRoutesByVehicleId")
  ...
  def updateDispatchRouteById(accessToken: String,
    ...
    if (accessToken == null) throw new Exception("Missing required parameter 'accessToken' when calling RoutesApi->updateDispatchRouteById")

    if (updateDispatchRouteParams == null) throw new Exception("Missing required parameter 'updateDispatchRouteParams' when calling RoutesApi->updateDispatchRouteById")
    queryParams += "access_token" -> accessToken.toString
