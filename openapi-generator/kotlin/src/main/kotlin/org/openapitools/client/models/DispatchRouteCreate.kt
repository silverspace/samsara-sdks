...
import org.openapitools.client.models.DispatchJobCreate
import org.openapitools.client.models.DispatchRouteBase
 ...
 * @param dispatchJobs The dispatch jobs to create for this route.
 */
data class DispatchRouteCreate (
    /* Descriptive name of this route. */
    val name: kotlin.String,
    /* The time in Unix epoch milliseconds that the last job in the route is scheduled to end. */
    val scheduledEndMs: kotlin.Long,
    /* The time in Unix epoch milliseconds that the route is scheduled to start. */
    val scheduledStartMs: kotlin.Long,
    /* The dispatch jobs to create for this route. */
    val dispatchJobs: kotlin.Array<DispatchJobCreate>,
    /* The time in Unix epoch milliseconds that the route actually ended. */
    val actualEndMs: kotlin.Long? = null,
    /* The time in Unix epoch milliseconds that the route actually started. */
    val actualStartMs: kotlin.Long? = null,
    /* ID of the driver assigned to the dispatch route. Note that driver_id and vehicle_id are mutually exclusive. If neither is specified, then the route is unassigned. */
    val driverId: kotlin.Long? = null,
    /* ID of the group if the organization has multiple groups (optional). */
    val groupId: kotlin.Long? = null,
    /* The distance expected to be traveled for this route in meters. */
    val scheduledMeters: kotlin.Long? = null,
    ...
    val startLocationAddress: kotlin.String? = null,
    ...
    val trailerId: kotlin.Long? = null,
