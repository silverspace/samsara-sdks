...
import org.openapitools.client.models.SensorsHistorySeries
...
data class InlineObject21 (
    ...
    val endMs: kotlin.Int,
    /* Group ID to query. */
    val groupId: kotlin.Long,
    val series: kotlin.Array<SensorsHistorySeries>,
    /* Beginning of the time range, specified in milliseconds UNIX time. */
    val startMs: kotlin.Int,
    /* Time resolution for which data should be returned, in milliseconds. Specifying 3600000 will return data at hour intervals. */
    val stepMs: kotlin.Int,
    val fillMissing: InlineObject21.FillMissing? = null
) {
    ...
    */
    enum class FillMissing(val value: kotlin.String){
    
        @Json(name = "withNull") withNull("withNull"),
    
        @Json(name = "withPrevious") withPrevious("withPrevious");
