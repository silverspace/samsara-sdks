...
data class InlineObject12 (
    ...
    val inspectionType: InlineObject12.InspectionType,
    /* Whether or not this vehicle or trailer is safe to drive. */
    val safe: InlineObject12.Safe,
    ...
    val odometerMiles: kotlin.Int? = null,
    ...
    val previousDefectsCorrected: kotlin.Boolean? = null,
    ...
    val previousDefectsIgnored: kotlin.Boolean? = null,
    ...
    * Values: mechanic
    */
    enum class InspectionType(val value: kotlin.String){
    
        @Json(name = "mechanic") mechanic("mechanic");
    ...
    * Values: safe,unsafe
    */
    enum class Safe(val value: kotlin.String){
