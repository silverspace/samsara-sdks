...
pub struct DriversApiClient<C: hyper::client::Connect> {
    configuration: Rc<configuration::Configuration<C>>,
}

impl<C: hyper::client::Connect> DriversApiClient<C> {
    pub fn new(configuration: Rc<configuration::Configuration<C>>) -> DriversApiClient<C> {
        DriversApiClient {
...
impl<C: hyper::client::Connect>DriversApi for DriversApiClient<C> {
    fn create_driver(&self, access_token: &str, create_driver_param: ::models::DriverForCreate) -> Box<Future<Item = ::models::Driver, Error = Error<serde_json::Value>>> {
