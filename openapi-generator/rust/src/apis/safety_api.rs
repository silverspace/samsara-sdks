...
pub struct SafetyApiClient<C: hyper::client::Connect> {
    configuration: Rc<configuration::Configuration<C>>,
}

impl<C: hyper::client::Connect> SafetyApiClient<C> {
    pub fn new(configuration: Rc<configuration::Configuration<C>>) -> SafetyApiClient<C> {
        SafetyApiClient {
...
impl<C: hyper::client::Connect>SafetyApi for SafetyApiClient<C> {
    fn get_driver_safety_score(&self, driver_id: i64, access_token: &str, start_ms: i64, end_ms: i64) -> Box<Future<Item = ::models::DriverSafetyScoreResponse, Error = Error<serde_json::Value>>> {
