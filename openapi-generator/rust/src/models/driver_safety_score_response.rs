...
pub struct DriverSafetyScoreResponse {
    ...
    pub harsh_accel_count: Option<i32>,
    ...
    pub harsh_turning_count: Option<i32>,
    /// Safety Score
    ...
    pub time_over_speed_limit_ms: Option<i32>,
    /// Total distance driven in meters
    #[serde(rename = "totalDistanceDrivenMeters")]
    pub total_distance_driven_meters: Option<i32>,
    /// Total harsh event count
    #[serde(rename = "totalHarshEventCount")]
    pub total_harsh_event_count: Option<i32>,
    /// Amount of time driven in milliseconds
    #[serde(rename = "totalTimeDrivenMs")]
    pub total_time_driven_ms: Option<i32>,
}
