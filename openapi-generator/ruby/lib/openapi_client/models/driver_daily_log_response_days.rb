  ...
  class DriverDailyLogResponseDays
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::DriverDailyLogResponseDays` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::DriverDailyLogResponseDays`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'certified_at_ms')
        self.certified_at_ms = attributes[:'certified_at_ms']
      end
      ...
      if attributes.key?(:'trailer_ids')
        self.trailer_ids = attributes[:'trailer_ids']
      end

      if attributes.key?(:'active_hours')
        self.active_hours = attributes[:'active_hours']
      end
      ...
      if attributes.key?(:'active_ms')
        self.active_ms = attributes[:'active_ms']
      end
      ...
      if attributes.key?(:'vehicle_ids')
        self.vehicle_ids = attributes[:'vehicle_ids']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          certified_at_ms == o.certified_at_ms &&
          end_ms == o.end_ms &&
          start_ms == o.start_ms &&
          trailer_ids == o.trailer_ids &&
          active_hours == o.active_hours &&
          distance_miles == o.distance_miles &&
          active_ms == o.active_ms &&
    ...
    def hash
      [certified_at_ms, end_ms, start_ms, trailer_ids, active_hours, distance_miles, active_ms, certified, vehicle_ids].hash
    end
