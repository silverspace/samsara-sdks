...
module OpenapiClient
  class User
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'organization_role_id')
        self.organization_role_id = attributes[:'organization_role_id']
      end
      ...
      if attributes.key?(:'tag_roles')
        if (value = attributes[:'tag_roles']).is_a?(Array)
