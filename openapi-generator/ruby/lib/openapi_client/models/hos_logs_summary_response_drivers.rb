  ...
  class HosLogsSummaryResponseDrivers
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::HosLogsSummaryResponseDrivers` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::HosLogsSummaryResponseDrivers`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'time_until_break')
        self.time_until_break = attributes[:'time_until_break']
      end
      ...
      if attributes.key?(:'driving_in_violation_today')
        self.driving_in_violation_today = attributes[:'driving_in_violation_today']
      end
      ...
      if attributes.key?(:'cycle_remaining')
        self.cycle_remaining = attributes[:'cycle_remaining']
      end
      ...
      if attributes.key?(:'duty_status')
        self.duty_status = attributes[:'duty_status']
      end

      if attributes.key?(:'cycle_tomorrow')
        self.cycle_tomorrow = attributes[:'cycle_tomorrow']
      end

      if attributes.key?(:'shift_drive_remaining')
        self.shift_drive_remaining = attributes[:'shift_drive_remaining']
      end

      if attributes.key?(:'time_in_current_status')
        self.time_in_current_status = attributes[:'time_in_current_status']
      end

      if attributes.key?(:'driving_in_violation_cycle')
        self.driving_in_violation_cycle = attributes[:'driving_in_violation_cycle']
      end

      if attributes.key?(:'shift_remaining')
        self.shift_remaining = attributes[:'shift_remaining']
      end
    end
    ...
    def hash
      [time_until_break, vehicle_name, driving_in_violation_today, driver_id, cycle_remaining, driver_name, duty_status, cycle_tomorrow, shift_drive_remaining, time_in_current_status, driving_in_violation_cycle, shift_remaining].hash
    end
