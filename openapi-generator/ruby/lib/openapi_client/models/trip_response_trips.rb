  ...
  class TripResponseTrips
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::TripResponseTrips` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::TripResponseTrips`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'end_odometer')
        self.end_odometer = attributes[:'end_odometer']
      end
      ...
      if attributes.key?(:'fuel_consumed_ml')
        self.fuel_consumed_ml = attributes[:'fuel_consumed_ml']
      end
      ...
      if attributes.key?(:'start_coordinates')
        self.start_coordinates = attributes[:'start_coordinates']
      end

      if attributes.key?(:'end_coordinates')
        self.end_coordinates = attributes[:'end_coordinates']
      end

      if attributes.key?(:'start_odometer')
        self.start_odometer = attributes[:'start_odometer']
      end
      ...
      if attributes.key?(:'start_location')
        self.start_location = attributes[:'start_location']
      end

      if attributes.key?(:'toll_meters')
        self.toll_meters = attributes[:'toll_meters']
      end
      ...
      if attributes.key?(:'end_location')
        self.end_location = attributes[:'end_location']
      end
    end
    ...
    def hash
      [end_odometer, distance_meters, end_ms, start_ms, fuel_consumed_ml, start_address, start_coordinates, end_coordinates, start_odometer, driver_id, start_location, toll_meters, end_address, end_location].hash
    end
