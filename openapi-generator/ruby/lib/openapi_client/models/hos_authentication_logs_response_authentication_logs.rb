  ...
  class HosAuthenticationLogsResponseAuthenticationLogs
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::HosAuthenticationLogsResponseAuthenticationLogs` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::HosAuthenticationLogsResponseAuthenticationLogs`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'happened_at_ms')
        self.happened_at_ms = attributes[:'happened_at_ms']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          address == o.address &&
          city == o.city &&
          happened_at_ms == o.happened_at_ms &&
    ...
    def hash
      [action_type, address, city, happened_at_ms, address_name, state].hash
    end
