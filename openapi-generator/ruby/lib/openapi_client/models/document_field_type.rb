  ...
  class DocumentFieldType
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::DocumentFieldType` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::DocumentFieldType`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'number_value_type_metadata')
        self.number_value_type_metadata = attributes[:'number_value_type_metadata']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          label == o.label &&
          number_value_type_metadata == o.number_value_type_metadata &&
    ...
    def hash
      [label, number_value_type_metadata, value_type].hash
    end
