...
module OpenapiClient
  class DocumentFieldCreate
    ...
    def self.openapi_types
      {
        :'number_value' => :'Float',
        :'photo_value' => :'Array<DocumentFieldCreatePhotoValue>',
        :'string_value' => :'String',
        :'value_type' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::DocumentFieldCreate` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::DocumentFieldCreate`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'photo_value')
        if (value = attributes[:'photo_value']).is_a?(Array)
          self.photo_value = value
        end
      end
    ...
    def hash
      [number_value, photo_value, string_value, value_type].hash
    end
