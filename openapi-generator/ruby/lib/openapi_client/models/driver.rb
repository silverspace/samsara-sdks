  ...
  class Driver
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::Driver` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::Driver`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'eld_adverse_weather_exemption_enabled')
        self.eld_adverse_weather_exemption_enabled = attributes[:'eld_adverse_weather_exemption_enabled']
      end

      if attributes.key?(:'eld_big_day_exemption_enabled')
        self.eld_big_day_exemption_enabled = attributes[:'eld_big_day_exemption_enabled']
      end

      if attributes.key?(:'eld_day_start_hour')
        self.eld_day_start_hour = attributes[:'eld_day_start_hour']
      end

      if attributes.key?(:'eld_exempt')
        self.eld_exempt = attributes[:'eld_exempt']
      end

      if attributes.key?(:'eld_exempt_reason')
        self.eld_exempt_reason = attributes[:'eld_exempt_reason']
      end

      if attributes.key?(:'eld_pc_enabled')
        self.eld_pc_enabled = attributes[:'eld_pc_enabled']
      else
        self.eld_pc_enabled = false
      end

      if attributes.key?(:'eld_ym_enabled')
        self.eld_ym_enabled = attributes[:'eld_ym_enabled']
      else
        self.eld_ym_enabled = false
      end

      if attributes.key?(:'external_ids')
        if (value = attributes[:'external_ids']).is_a?(Hash)
      ...
      if attributes.key?(:'is_deactivated')
        self.is_deactivated = attributes[:'is_deactivated']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          id == o.id &&
          is_deactivated == o.is_deactivated &&
          tags == o.tags
    end
    ...
    def hash
      [eld_adverse_weather_exemption_enabled, eld_big_day_exemption_enabled, eld_day_start_hour, eld_exempt, eld_exempt_reason, eld_pc_enabled, eld_ym_enabled, external_ids, group_id, license_number, license_state, name, notes, phone, username, vehicle_id, id, is_deactivated, tags].hash
    end
