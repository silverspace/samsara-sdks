...
open class FleetAPI: APIBase {
     ...
     */
    open class func addFleetAddress(accessToken: String, addressParam: InlineObject2, completion: @escaping ((_ error: ErrorResponse?) -> Void)) {
    ...
    open class func addFleetAddressWithRequestBuilder(accessToken: String, addressParam: InlineObject2) -> RequestBuilder<Void> {
        ...
        let parameters = addressParam.encodeToJSON()
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func addOrganizationAddresses(accessToken: String, addresses: InlineObject, completion: @escaping ((_ data: [Address]?, _ error: ErrorResponse?) -> Void)) {
    ...
    open class func addOrganizationAddressesWithRequestBuilder(accessToken: String, addresses: InlineObject) -> RequestBuilder<[Address]> {
        let path = "/addresses"
        let URLString = OpenAPIClientAPI.basePath + path
        let parameters = addresses.encodeToJSON()
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func createDriver(accessToken: String, createDriverParam: DriverForCreate, completion: @escaping ((_ data: Driver?, _ error: ErrorResponse?) -> Void)) {
    ...
    open class func createDriverWithRequestBuilder(accessToken: String, createDriverParam: DriverForCreate) -> RequestBuilder<Driver> {
        ...
        let URLString = OpenAPIClientAPI.basePath + path
        let parameters = createDriverParam.encodeToJSON()
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func createDriverDocument(accessToken: String, driverId: Int64, createDocumentParams: DocumentCreate, completion: @escaping ((_ data: Document?, _ error: ErrorResponse?) -> Void)) {
    ...
    open class func createDriverDocumentWithRequestBuilder(accessToken: String, driverId: Int64, createDocumentParams: DocumentCreate) -> RequestBuilder<Document> {
        ...
        path = path.replacingOccurrences(of: "{driver_id}", with: driverIdPostEscape, options: .literal, range: nil)
        let URLString = OpenAPIClientAPI.basePath + path
        let parameters = createDocumentParams.encodeToJSON()
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func createDvir(accessToken: String, createDvirParam: InlineObject12, completion: @escaping ((_ data: DvirBase?, _ error: ErrorResponse?) -> Void)) {
    ...
    open class func createDvirWithRequestBuilder(accessToken: String, createDvirParam: InlineObject12) -> RequestBuilder<DvirBase> {
        ...
        let URLString = OpenAPIClientAPI.basePath + path
        let parameters = createDvirParam.encodeToJSON()
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func deactivateDriver(accessToken: String, driverIdOrExternalId: String, completion: @escaping ((_ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func deleteOrganizationAddress(accessToken: String, addressId: Int64, completion: @escaping ((_ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getAllDeactivatedDrivers(accessToken: String, groupId: Int64? = nil, completion: @escaping ((_ data: [Driver]?, _ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getDeactivatedDriverById(accessToken: String, driverIdOrExternalId: String, completion: @escaping ((_ data: Driver?, _ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getDriverById(accessToken: String, driverIdOrExternalId: String, completion: @escaping ((_ data: Driver?, _ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getDriverDocumentTypesByOrgId(completion: @escaping ((_ data: [DocumentType]?, _ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getDriverDocumentsByOrgId(accessToken: String, endMs: Int64? = nil, durationMs: Int64? = nil, completion: @escaping ((_ data: [Document]?, _ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getDvirs(accessToken: String, endMs: Int32, durationMs: Int32, groupId: Int32? = nil, completion: @escaping ((_ data: DvirListResponse?, _ error: ErrorResponse?) -> Void)) {
     ...
     */
    open class func getDvirsWithRequestBuilder(accessToken: String, endMs: Int32, durationMs: Int32, groupId: Int32? = nil) -> RequestBuilder<DvirListResponse> {
        let path = "/fleet/maintenance/dvirs"
        let URLString = OpenAPIClientAPI.basePath + path
        let parameters: [String:Any]? = nil
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getFleetDrivers(accessToken: String, groupDriversParam: InlineObject3, completion: @escaping ((_ data: DriversResponse?, _ error: ErrorResponse?) -> Void)) {
    ...
    open class func getFleetDriversWithRequestBuilder(accessToken: String, groupDriversParam: InlineObject3) -> RequestBuilder<DriversResponse> {
        ...
        let URLString = OpenAPIClientAPI.basePath + path
        let parameters = groupDriversParam.encodeToJSON()
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getFleetDriversHosDailyLogs(accessToken: String, driverId: Int64, hosLogsParam: InlineObject6, completion: @escaping ((_ data: DriverDailyLogResponse?, _ error: ErrorResponse?) -> Void)) {
    ...
    open class func getFleetDriversHosDailyLogsWithRequestBuilder(accessToken: String, driverId: Int64, hosLogsParam: InlineObject6) -> RequestBuilder<DriverDailyLogResponse> {
        ...
        path = path.replacingOccurrences(of: "{driver_id}", with: driverIdPostEscape, options: .literal, range: nil)
        let URLString = OpenAPIClientAPI.basePath + path
        let parameters = hosLogsParam.encodeToJSON()
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getFleetDriversSummary(accessToken: String, driversSummaryParam: InlineObject5, snapToDayBounds: Bool? = nil, completion: @escaping ((_ data: DriversSummaryResponse?, _ error: ErrorResponse?) -> Void)) {
    ...
    open class func getFleetDriversSummaryWithRequestBuilder(accessToken: String, driversSummaryParam: InlineObject5, snapToDayBounds: Bool? = nil) -> RequestBuilder<DriversSummaryResponse> {
        ...
        let URLString = OpenAPIClientAPI.basePath + path
        let parameters = driversSummaryParam.encodeToJSON()
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getFleetHosAuthenticationLogs(accessToken: String, hosAuthenticationLogsParam: InlineObject7, completion: @escaping ((_ data: HosAuthenticationLogsResponse?, _ error: ErrorResponse?) -> Void)) {
    ...
    open class func getFleetHosAuthenticationLogsWithRequestBuilder(accessToken: String, hosAuthenticationLogsParam: InlineObject7) -> RequestBuilder<HosAuthenticationLogsResponse> {
        ...
        let URLString = OpenAPIClientAPI.basePath + path
        let parameters = hosAuthenticationLogsParam.encodeToJSON()
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getFleetHosLogs(accessToken: String, hosLogsParam: InlineObject8, completion: @escaping ((_ data: HosLogsResponse?, _ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getFleetHosLogsSummary(accessToken: String, hosLogsParam: InlineObject9, completion: @escaping ((_ data: HosLogsSummaryResponse?, _ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getFleetLocations(accessToken: String, groupParam: InlineObject11, completion: @escaping ((_ data: InlineResponse2003?, _ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getFleetMaintenanceList(accessToken: String, groupParam: InlineObject13, completion: @escaping ((_ data: InlineResponse2004?, _ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getFleetTrips(accessToken: String, tripsParam: InlineObject15, completion: @escaping ((_ data: TripResponse?, _ error: ErrorResponse?) -> Void)) {
    ...
    open class func getFleetTripsWithRequestBuilder(accessToken: String, tripsParam: InlineObject15) -> RequestBuilder<TripResponse> {
        ...
        let URLString = OpenAPIClientAPI.basePath + path
        let parameters = tripsParam.encodeToJSON()
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getFleetVehicle(accessToken: String, vehicleIdOrExternalId: String, completion: @escaping ((_ data: FleetVehicleResponse?, _ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getOrganizationAddress(accessToken: String, addressId: Int64, completion: @escaping ((_ data: Address?, _ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getOrganizationAddresses(accessToken: String, completion: @escaping ((_ data: [Address]?, _ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getOrganizationContact(accessToken: String, contactId: Int64, completion: @escaping ((_ data: Contact?, _ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getVehicleLocations(accessToken: String, vehicleId: Int64, startMs: Int64, endMs: Int64, completion: @escaping ((_ data: [FleetVehicleLocation]?, _ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getVehicleStats(accessToken: String, startMs: Int32, endMs: Int32, series: Series_getVehicleStats? = nil, tagIds: String? = nil, startingAfter: String? = nil, endingBefore: String? = nil, limit: Int64? = nil, completion: @escaping ((_ data: InlineResponse2005?, _ error: ErrorResponse?) -> Void)) {
     ...
     */
    open class func getVehicleStatsWithRequestBuilder(accessToken: String, startMs: Int32, endMs: Int32, series: Series_getVehicleStats? = nil, tagIds: String? = nil, startingAfter: String? = nil, endingBefore: String? = nil, limit: Int64? = nil) -> RequestBuilder<InlineResponse2005> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getVehiclesLocations(accessToken: String, startMs: Int32, endMs: Int32, completion: @escaping ((_ data: [Any]?, _ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<[Any]> 
     */
    open class func getVehiclesLocationsWithRequestBuilder(accessToken: String, startMs: Int32, endMs: Int32) -> RequestBuilder<[Any]> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func listContacts(accessToken: String, completion: @escaping ((_ data: [Contact]?, _ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func listFleet(accessToken: String, groupParam: InlineObject10, startingAfter: String? = nil, endingBefore: String? = nil, limit: Int64? = nil, completion: @escaping ((_ data: InlineResponse2002?, _ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func patchFleetVehicle(accessToken: String, vehicleIdOrExternalId: String, data: InlineObject16, completion: @escaping ((_ data: FleetVehicleResponse?, _ error: ErrorResponse?) -> Void)) {
    ...
    open class func patchFleetVehicleWithRequestBuilder(accessToken: String, vehicleIdOrExternalId: String, data: InlineObject16) -> RequestBuilder<FleetVehicleResponse> {
        ...
        path = path.replacingOccurrences(of: "{vehicle_id_or_external_id}", with: vehicleIdOrExternalIdPostEscape, options: .literal, range: nil)
        let URLString = OpenAPIClientAPI.basePath + path
        let parameters = data.encodeToJSON()
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func reactivateDriverById(accessToken: String, driverIdOrExternalId: String, reactivateDriverParam: InlineObject4, completion: @escaping ((_ data: Driver?, _ error: ErrorResponse?) -> Void)) {
    ...
    open class func reactivateDriverByIdWithRequestBuilder(accessToken: String, driverIdOrExternalId: String, reactivateDriverParam: InlineObject4) -> RequestBuilder<Driver> {
        ...
        path = path.replacingOccurrences(of: "{driver_id_or_external_id}", with: driverIdOrExternalIdPostEscape, options: .literal, range: nil)
        let URLString = OpenAPIClientAPI.basePath + path
        let parameters = reactivateDriverParam.encodeToJSON()
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func updateOrganizationAddress(accessToken: String, addressId: Int64, address: InlineObject1, completion: @escaping ((_ error: ErrorResponse?) -> Void)) {
    ...
    open class func updateOrganizationAddressWithRequestBuilder(accessToken: String, addressId: Int64, address: InlineObject1) -> RequestBuilder<Void> {
        ...
        path = path.replacingOccurrences(of: "{addressId}", with: addressIdPostEscape, options: .literal, range: nil)
        let URLString = OpenAPIClientAPI.basePath + path
        let parameters = address.encodeToJSON()
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func updateVehicles(accessToken: String, vehicleUpdateParam: InlineObject14, completion: @escaping ((_ error: ErrorResponse?) -> Void)) {
    ...
    open class func updateVehiclesWithRequestBuilder(accessToken: String, vehicleUpdateParam: InlineObject14) -> RequestBuilder<Void> {
        ...
        let URLString = OpenAPIClientAPI.basePath + path
        let parameters = vehicleUpdateParam.encodeToJSON()
