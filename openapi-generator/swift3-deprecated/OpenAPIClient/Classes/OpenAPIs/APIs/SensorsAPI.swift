...
open class SensorsAPI: APIBase {
     ...
     */
    open class func getSensors(accessToken: String, groupParam: InlineObject23, completion: @escaping ((_ data: InlineResponse2008?, _ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getSensorsCargo(accessToken: String, sensorParam: InlineObject19, completion: @escaping ((_ data: CargoResponse?, _ error: ErrorResponse?) -> Void)) {
    ...
    open class func getSensorsCargoWithRequestBuilder(accessToken: String, sensorParam: InlineObject19) -> RequestBuilder<CargoResponse> {
        ...
        let URLString = OpenAPIClientAPI.basePath + path
        let parameters = sensorParam.encodeToJSON()
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getSensorsDoor(accessToken: String, sensorParam: InlineObject20, completion: @escaping ((_ data: DoorResponse?, _ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getSensorsHistory(accessToken: String, historyParam: InlineObject21, completion: @escaping ((_ data: SensorHistoryResponse?, _ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getSensorsHumidity(accessToken: String, sensorParam: InlineObject22, completion: @escaping ((_ data: HumidityResponse?, _ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getSensorsTemperature(accessToken: String, sensorParam: InlineObject24, completion: @escaping ((_ data: TemperatureResponse?, _ error: ErrorResponse?) -> Void)) {
