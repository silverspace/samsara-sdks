...
open class TagsAPI: APIBase {
     ...
     */
    open class func createTag(accessToken: String, tagCreateParams: TagCreate, completion: @escaping ((_ data: Tag?, _ error: ErrorResponse?) -> Void)) {
    ...
    open class func createTagWithRequestBuilder(accessToken: String, tagCreateParams: TagCreate) -> RequestBuilder<Tag> {
        ...
        let parameters = tagCreateParams.encodeToJSON()
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func deleteTagById(accessToken: String, tagId: Int64, completion: @escaping ((_ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getAllTags(accessToken: String, groupId: Int64? = nil, completion: @escaping ((_ data: InlineResponse2009?, _ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getTagById(accessToken: String, tagId: Int64, completion: @escaping ((_ data: Tag?, _ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func modifyTagById(accessToken: String, tagId: Int64, tagModifyParams: TagModify, completion: @escaping ((_ data: Tag?, _ error: ErrorResponse?) -> Void)) {
    ...
    open class func modifyTagByIdWithRequestBuilder(accessToken: String, tagId: Int64, tagModifyParams: TagModify) -> RequestBuilder<Tag> {
        ...
        path = path.replacingOccurrences(of: "{tag_id}", with: tagIdPostEscape, options: .literal, range: nil)
        let URLString = OpenAPIClientAPI.basePath + path
        let parameters = tagModifyParams.encodeToJSON()
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func updateTagById(accessToken: String, tagId: Int64, updateTagParams: TagUpdate, completion: @escaping ((_ data: Tag?, _ error: ErrorResponse?) -> Void)) {
    ...
    open class func updateTagByIdWithRequestBuilder(accessToken: String, tagId: Int64, updateTagParams: TagUpdate) -> RequestBuilder<Tag> {
        ...
        path = path.replacingOccurrences(of: "{tag_id}", with: tagIdPostEscape, options: .literal, range: nil)
        let URLString = OpenAPIClientAPI.basePath + path
        let parameters = updateTagParams.encodeToJSON()
