...
class HosAuthenticationLogsResponseAuthenticationLogs(object):
    ...
    def __init__(self, action_type=None, address=None, city=None, happened_at_ms=None, address_name=None, state=None):  # noqa: E501
        """HosAuthenticationLogsResponseAuthenticationLogs - a model defined in OpenAPI"""  # noqa: E501
