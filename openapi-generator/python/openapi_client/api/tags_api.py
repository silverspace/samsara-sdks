...
class TagsApi(object):
    ...
    def create_tag_with_http_info(self, access_token, tag_create_params, **kwargs):  # noqa: E501
        ...
        if ('tag_create_params' not in local_var_params or
                local_var_params['tag_create_params'] is None):
        ...
        body_params = None
        if 'tag_create_params' in local_var_params:
            body_params = local_var_params['tag_create_params']
        # HTTP header `Accept`
    ...
    def delete_tag_by_id_with_http_info(self, access_token, tag_id, **kwargs):  # noqa: E501
        ...
        if ('tag_id' not in local_var_params or
                local_var_params['tag_id'] is None):
    ...
    def modify_tag_by_id_with_http_info(self, access_token, tag_id, tag_modify_params, **kwargs):  # noqa: E501
        ...
        if ('tag_modify_params' not in local_var_params or
                local_var_params['tag_modify_params'] is None):
        ...
        body_params = None
        if 'tag_modify_params' in local_var_params:
            body_params = local_var_params['tag_modify_params']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
    ...
    def update_tag_by_id_with_http_info(self, access_token, tag_id, update_tag_params, **kwargs):  # noqa: E501
        ...
        if ('update_tag_params' not in local_var_params or
                local_var_params['update_tag_params'] is None):
        ...
        body_params = None
        if 'update_tag_params' in local_var_params:
            body_params = local_var_params['update_tag_params']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
