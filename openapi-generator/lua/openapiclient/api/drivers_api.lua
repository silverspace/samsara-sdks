...
local drivers_api = {}
local drivers_api_mt = {
	__name = "drivers_api";
	__index = drivers_api;
}

local function new_drivers_api(authority, basePath, schemes)
	local schemes_map = {}
...
function drivers_api:create_driver(access_token, create_driver_param)
...
function drivers_api:deactivate_driver(access_token, driver_id_or_external_id)
	local req = http_request.new_from_uri({
		scheme = self.default_scheme;
		host = self.host;
		port = self.port;
...
function drivers_api:get_all_deactivated_drivers(access_token, group_id)
	local req = http_request.new_from_uri({
		scheme = self.default_scheme;
		host = self.host;
		port = self.port;
...
function drivers_api:get_deactivated_driver_by_id(access_token, driver_id_or_external_id)
	local req = http_request.new_from_uri({
		scheme = self.default_scheme;
		host = self.host;
		port = self.port;
...
function drivers_api:get_driver_by_id(access_token, driver_id_or_external_id)
	local req = http_request.new_from_uri({
		scheme = self.default_scheme;
		host = self.host;
		port = self.port;
...
function drivers_api:reactivate_driver_by_id(access_token, driver_id_or_external_id, reactivate_driver_param)
	local req = http_request.new_from_uri({
		scheme = self.default_scheme;
		host = self.host;
		port = self.port;
