...
function assets_api:get_all_asset_current_locations(access_token, group_id)
...
function assets_api:get_all_assets(access_token, group_id)
	local req = http_request.new_from_uri({
		scheme = self.default_scheme;
		host = self.host;
		port = self.port;
...
function assets_api:get_asset_location(access_token, asset_id, start_ms, end_ms)
	local req = http_request.new_from_uri({
		scheme = self.default_scheme;
		host = self.host;
		port = self.port;
...
function assets_api:get_asset_reefer(access_token, asset_id, start_ms, end_ms)
	local req = http_request.new_from_uri({
		scheme = self.default_scheme;
		host = self.host;
		port = self.port;
