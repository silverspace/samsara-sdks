...
public class AddressesApi {
    ...
    public Response addOrganizationAddresses(@QueryParam("access_token") @NotNull   @ApiParam("Samsara API access token.")  String accessToken,@Valid InlineObject addresses) {
    ...
    public Response updateOrganizationAddress(@QueryParam("access_token") @NotNull   @ApiParam("Samsara API access token.")  String accessToken,@PathParam("addressId") @ApiParam("ID of the address/geofence") Long addressId,@Valid InlineObject1 address) {
        return Response.ok().entity("magic!").build();
    }
}
