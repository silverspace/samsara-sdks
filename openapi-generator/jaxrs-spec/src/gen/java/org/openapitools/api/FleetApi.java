...
public class FleetApi {
    ...
    public Response addFleetAddress(@QueryParam("access_token") @NotNull   @ApiParam("Samsara API access token.")  String accessToken,@Valid InlineObject2 addressParam) {
    ...
    public Response createDvir(@QueryParam("access_token") @NotNull   @ApiParam("Samsara API access token.")  String accessToken,@Valid InlineObject12 createDvirParam) {
        return Response.ok().entity("magic!").build();
    }
    ...
    public Response getFleetDrivers(@QueryParam("access_token") @NotNull   @ApiParam("Samsara API access token.")  String accessToken,@Valid InlineObject3 groupDriversParam) {
        return Response.ok().entity("magic!").build();
    }
    ...
    public Response getFleetDriversHosDailyLogs(@QueryParam("access_token") @NotNull   @ApiParam("Samsara API access token.")  String accessToken,@PathParam("driver_id") @ApiParam("ID of the driver with HOS logs.") Long driverId,@Valid InlineObject6 hosLogsParam) {
        return Response.ok().entity("magic!").build();
    }
    ...
    public Response getFleetDriversSummary(@QueryParam("access_token") @NotNull   @ApiParam("Samsara API access token.")  String accessToken,@Valid InlineObject5 driversSummaryParam,@QueryParam("snap_to_day_bounds")   @ApiParam("Snap query result to HOS day boundaries.")  Boolean snapToDayBounds) {
        return Response.ok().entity("magic!").build();
    }
    ...
    public Response getFleetHosAuthenticationLogs(@QueryParam("access_token") @NotNull   @ApiParam("Samsara API access token.")  String accessToken,@Valid InlineObject7 hosAuthenticationLogsParam) {
        return Response.ok().entity("magic!").build();
    }
    ...
    public Response getFleetHosLogs(@QueryParam("access_token") @NotNull   @ApiParam("Samsara API access token.")  String accessToken,@Valid InlineObject8 hosLogsParam) {
        return Response.ok().entity("magic!").build();
    }
    ...
    public Response getFleetHosLogsSummary(@QueryParam("access_token") @NotNull   @ApiParam("Samsara API access token.")  String accessToken,@Valid InlineObject9 hosLogsParam) {
        return Response.ok().entity("magic!").build();
    }
    ...
    public Response getFleetLocations(@QueryParam("access_token") @NotNull   @ApiParam("Samsara API access token.")  String accessToken,@Valid InlineObject11 groupParam) {
        return Response.ok().entity("magic!").build();
    }
    ...
    public Response getFleetMaintenanceList(@QueryParam("access_token") @NotNull   @ApiParam("Samsara API access token.")  String accessToken,@Valid InlineObject13 groupParam) {
        return Response.ok().entity("magic!").build();
    }
    ...
    public Response getFleetTrips(@QueryParam("access_token") @NotNull   @ApiParam("Samsara API access token.")  String accessToken,@Valid InlineObject15 tripsParam) {
        return Response.ok().entity("magic!").build();
    }
    ...
    public Response listFleet(@QueryParam("access_token") @NotNull   @ApiParam("Samsara API access token.")  String accessToken,@Valid InlineObject10 groupParam,@QueryParam("startingAfter")   @ApiParam("Pagination parameter indicating the cursor position to continue returning results after. Used in conjunction with the &#39;limit&#39; parameter. Mutually exclusive with &#39;endingBefore&#39; parameter.")  String startingAfter,@QueryParam("endingBefore")   @ApiParam("Pagination parameter indicating the cursor position to return results before. Used in conjunction with the &#39;limit&#39; parameter. Mutually exclusive with &#39;startingAfter&#39; parameter.")  String endingBefore,@QueryParam("limit")   @ApiParam("Pagination parameter indicating the number of results to return in this request. Used in conjunction with either &#39;startingAfter&#39; or &#39;endingBefore&#39;.")  Long limit) {
        return Response.ok().entity("magic!").build();
    }
    ...
    public Response patchFleetVehicle(@QueryParam("access_token") @NotNull   @ApiParam("Samsara API access token.")  String accessToken,@PathParam("vehicle_id_or_external_id") @ApiParam("ID of the vehicle.  This must be either the numeric ID generated by Samsara or the external ID of the vehicle.  External IDs are customer specified key-value pairs.") String vehicleIdOrExternalId,@Valid InlineObject16 data) {
        return Response.ok().entity("magic!").build();
    }
    ...
    public Response reactivateDriverById(@QueryParam("access_token") @NotNull   @ApiParam("Samsara API access token.")  String accessToken,@PathParam("driver_id_or_external_id") @ApiParam("ID of the driver.  This must be either the numeric ID generated by Samsara or the external ID of the driver.  External IDs are customer specified key-value pairs.") String driverIdOrExternalId,@Valid InlineObject4 reactivateDriverParam) {
        return Response.ok().entity("magic!").build();
    }
    ...
    public Response updateVehicles(@QueryParam("access_token") @NotNull   @ApiParam("Samsara API access token.")  String accessToken,@Valid InlineObject14 vehicleUpdateParam) {
        return Response.ok().entity("magic!").build();
    }
}
