...
public class MachinesApi {
    ...
    public Response getMachines(@QueryParam("access_token") @NotNull   @ApiParam("Samsara API access token.")  String accessToken,@Valid InlineObject18 groupParam) {
    ...
    public Response getMachinesHistory(@QueryParam("access_token") @NotNull   @ApiParam("Samsara API access token.")  String accessToken,@Valid InlineObject17 historyParam) {
        return Response.ok().entity("magic!").build();
    }
}
