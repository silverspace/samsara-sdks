...
public class DriverForCreate   {
  ...
  private @Valid Boolean eldAdverseWeatherExemptionEnabled;
  private @Valid Boolean eldBigDayExemptionEnabled;
  private @Valid Integer eldDayStartHour;
  private @Valid Boolean eldExempt;
  private @Valid String eldExemptReason;
  ...
  private @Valid String licenseNumber;
  private @Valid String licenseState;
  ...
  private @Valid List<Long> tagIds = new ArrayList<Long>();
