...
public class DriverDailyLogResponseDays   {
  ...
  private @Valid Long certifiedAtMs;
  private @Valid Integer endMs;
  private @Valid Integer startMs;
  private @Valid Object trailerIds = null;
  private @Valid Double activeHours;
  private @Valid Double distanceMiles;
  private @Valid Long activeMs;
  private @Valid Boolean certified;
