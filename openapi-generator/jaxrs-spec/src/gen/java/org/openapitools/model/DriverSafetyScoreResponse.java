...
public class DriverSafetyScoreResponse   {
  ...
  private @Valid Integer crashCount;
  private @Valid Integer driverId;
  private @Valid Integer harshAccelCount;
  private @Valid Integer harshBrakingCount;
  private @Valid List<SafetyReportHarshEvent> harshEvents = new ArrayList<SafetyReportHarshEvent>();
  private @Valid Integer harshTurningCount;
  private @Valid Integer safetyScore;
  private @Valid String safetyScoreRank;
  private @Valid Integer timeOverSpeedLimitMs;
  private @Valid Integer totalDistanceDrivenMeters;
  private @Valid Integer totalHarshEventCount;
  private @Valid Integer totalTimeDrivenMs;
