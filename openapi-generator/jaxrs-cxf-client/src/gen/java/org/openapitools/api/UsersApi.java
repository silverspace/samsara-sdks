...
public interface UsersApi  {
    ...
    @ApiOperation(value = "/users/{userId:[0-9]+}", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "The user was successfully removed."),
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public void deleteUserById(@QueryParam("access_token") String accessToken, @PathParam("userId") Long userId);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public User getUserById(@QueryParam("access_token") String accessToken, @PathParam("userId") Long userId);
    ...
    @Path("/user_roles")
    @Produces({ "application/json" })
    @ApiOperation(value = "/user_roles", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "List of user roles.", response = UserRole.class, responseContainer = "List"),
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public List<UserRole> listUserRoles(@QueryParam("access_token") String accessToken);
    ...
    @Path("/users")
    @Produces({ "application/json" })
    @ApiOperation(value = "/users", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "List of users.", response = User.class, responseContainer = "List"),
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public List<User> listUsers(@QueryParam("access_token") String accessToken);
}
