...
public interface FleetApi  {
    ...
    @ApiOperation(value = "/fleet/add_address", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Address was successfully added. No response body is returned."),
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public void addFleetAddress(@QueryParam("access_token") String accessToken, InlineObject2 addressParam);
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "/addresses", tags={  })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public List<Address> addOrganizationAddresses(@QueryParam("access_token") String accessToken, InlineObject addresses);
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "/fleet/drivers/create", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Returns the successfully created the driver.", response = Driver.class),
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public Driver createDriver(@QueryParam("access_token") String accessToken, DriverForCreate createDriverParam);
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "/fleet/drivers/{driver_id:[0-9]+}/documents", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Returns the created document.", response = Document.class),
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public Document createDriverDocument(@QueryParam("access_token") String accessToken, @PathParam("driver_id") Long driverId, DocumentCreate createDocumentParams);
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "/fleet/maintenance/dvirs", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Newly created DVIR.", response = DvirBase.class),
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public DvirBase createDvir(@QueryParam("access_token") String accessToken, InlineObject12 createDvirParam);
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "/fleet/drivers/{driver_id:[0-9]+ | external_id:[a-zA-Z0-9]+}", tags={  })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public void deactivateDriver(@QueryParam("access_token") String accessToken, @PathParam("driver_id_or_external_id") String driverIdOrExternalId);
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "/addresses/{addressId}", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Address was successfully deleted. No response body is returned."),
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public void deleteOrganizationAddress(@QueryParam("access_token") String accessToken, @PathParam("addressId") Long addressId);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public List<DispatchRoute> fetchAllDispatchRoutes(@QueryParam("access_token") String accessToken, @QueryParam("group_id") Long groupId, @QueryParam("end_time") Long endTime, @QueryParam("duration") Long duration);
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "/fleet/assets/locations", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "List of assets and their current locations.", response = InlineResponse2001.class),
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public InlineResponse2001 getAllAssetCurrentLocations(@QueryParam("access_token") String accessToken, @QueryParam("group_id") Long groupId);
    ...
    @Path("/fleet/assets")
    @Produces({ "application/json" })
    @ApiOperation(value = "/fleet/assets", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "List of assets.", response = InlineResponse200.class),
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public InlineResponse200 getAllAssets(@QueryParam("access_token") String accessToken, @QueryParam("group_id") Long groupId);
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "/fleet/drivers/inactive", tags={  })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public List<Driver> getAllDeactivatedDrivers(@QueryParam("access_token") String accessToken, @QueryParam("group_id") Long groupId);
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "/fleet/assets/{assetId:[0-9]+}/locations", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Asset location details.", response = Object.class, responseContainer = "List"),
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public List<Object> getAssetLocation(@QueryParam("access_token") String accessToken, @PathParam("asset_id") Long assetId, @QueryParam("startMs") Long startMs, @QueryParam("endMs") Long endMs);
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "/fleet/assets/{assetId:[0-9]+}/reefer", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Reefer-specific asset details.", response = AssetReeferResponse.class),
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public AssetReeferResponse getAssetReefer(@QueryParam("access_token") String accessToken, @PathParam("asset_id") Long assetId, @QueryParam("startMs") Long startMs, @QueryParam("endMs") Long endMs);
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "/fleet/drivers/inactive/{driver_id:[0-9]+ | external_id:[a-zA-Z0-9]+}", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Returns the deactivated driver with the given driver_id.", response = Driver.class),
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public Driver getDeactivatedDriverById(@QueryParam("access_token") String accessToken, @PathParam("driver_id_or_external_id") String driverIdOrExternalId);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public List<DispatchRoute> getDispatchRoutesByDriverId(@QueryParam("access_token") String accessToken, @PathParam("driver_id") Long driverId, @QueryParam("end_time") Long endTime, @QueryParam("duration") Long duration);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public List<DispatchRoute> getDispatchRoutesByVehicleId(@QueryParam("access_token") String accessToken, @PathParam("vehicle_id") Long vehicleId, @QueryParam("end_time") Long endTime, @QueryParam("duration") Long duration);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public Driver getDriverById(@QueryParam("access_token") String accessToken, @PathParam("driver_id_or_external_id") String driverIdOrExternalId);
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "/fleet/drivers/document_types", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "/fleet/drivers/documents", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Returns all of the documents.", response = Document.class, responseContainer = "List"),
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public List<Document> getDriverDocumentsByOrgId(@QueryParam("access_token") String accessToken, @QueryParam("endMs") Long endMs, @QueryParam("durationMs") Long durationMs);
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "/fleet/drivers/{driverId:[0-9]+}/safety/score", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Safety score details.", response = DriverSafetyScoreResponse.class),
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public DriverSafetyScoreResponse getDriverSafetyScore(@PathParam("driverId") Long driverId, @QueryParam("access_token") String accessToken, @QueryParam("startMs") Long startMs, @QueryParam("endMs") Long endMs);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public DvirListResponse getDvirs(@QueryParam("access_token") String accessToken, @QueryParam("end_ms") Integer endMs, @QueryParam("duration_ms") Integer durationMs, @QueryParam("group_id") Integer groupId);
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "/fleet/drivers", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "All drivers in the group.", response = DriversResponse.class),
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public DriversResponse getFleetDrivers(@QueryParam("access_token") String accessToken, InlineObject3 groupDriversParam);
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "/fleet/drivers/{driver_id:[0-9]+}/hos_daily_logs", tags={  })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public DriverDailyLogResponse getFleetDriversHosDailyLogs(@QueryParam("access_token") String accessToken, @PathParam("driver_id") Long driverId, InlineObject6 hosLogsParam);
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "/fleet/drivers/summary", tags={  })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public DriversSummaryResponse getFleetDriversSummary(@QueryParam("access_token") String accessToken, InlineObject5 driversSummaryParam, @QueryParam("snap_to_day_bounds") Boolean snapToDayBounds);
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "/fleet/hos_authentication_logs", tags={  })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public HosAuthenticationLogsResponse getFleetHosAuthenticationLogs(@QueryParam("access_token") String accessToken, InlineObject7 hosAuthenticationLogsParam);
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "/fleet/hos_logs", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "HOS logs for the specified driver.", response = HosLogsResponse.class),
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public HosLogsResponse getFleetHosLogs(@QueryParam("access_token") String accessToken, InlineObject8 hosLogsParam);
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "/fleet/hos_logs_summary", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "HOS logs for the specified driver.", response = HosLogsSummaryResponse.class),
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public HosLogsSummaryResponse getFleetHosLogsSummary(@QueryParam("access_token") String accessToken, InlineObject9 hosLogsParam);
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "/fleet/locations", tags={  })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public InlineResponse2003 getFleetLocations(@QueryParam("access_token") String accessToken, InlineObject11 groupParam);
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "/fleet/maintenance/list", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "List of vehicles and maintenance information about each.", response = InlineResponse2004.class),
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public InlineResponse2004 getFleetMaintenanceList(@QueryParam("access_token") String accessToken, InlineObject13 groupParam);
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "/fleet/trips", tags={  })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public TripResponse getFleetTrips(@QueryParam("access_token") String accessToken, InlineObject15 tripsParam);
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "/fleet/vehicles/{vehicle_id:[0-9]+ | external_id:[a-zA-Z0-9]+}", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "The specified vehicle.", response = FleetVehicleResponse.class),
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public FleetVehicleResponse getFleetVehicle(@QueryParam("access_token") String accessToken, @PathParam("vehicle_id_or_external_id") String vehicleIdOrExternalId);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public Address getOrganizationAddress(@QueryParam("access_token") String accessToken, @PathParam("addressId") Long addressId);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public List<Address> getOrganizationAddresses(@QueryParam("access_token") String accessToken);
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "/contacts/{contact_id}", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "The contact.", response = Contact.class),
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public Contact getOrganizationContact(@QueryParam("access_token") String accessToken, @PathParam("contact_id") Long contactId);
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "/fleet/vehicles/{vehicleId:[0-9]+}/safety/harsh_event", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Harsh event details.", response = VehicleHarshEventResponse.class),
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public VehicleHarshEventResponse getVehicleHarshEvent(@PathParam("vehicleId") Long vehicleId, @QueryParam("access_token") String accessToken, @QueryParam("timestamp") Long timestamp);
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "/fleet/vehicles/{vehicle_id:[0-9]+}/locations", tags={  })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public List<FleetVehicleLocation> getVehicleLocations(@QueryParam("access_token") String accessToken, @PathParam("vehicle_id") Long vehicleId, @QueryParam("startMs") Long startMs, @QueryParam("endMs") Long endMs);
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "/fleet/vehicles/{vehicleId:[0-9]+}/safety/score", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Safety score details.", response = VehicleSafetyScoreResponse.class),
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public VehicleSafetyScoreResponse getVehicleSafetyScore(@PathParam("vehicleId") Long vehicleId, @QueryParam("access_token") String accessToken, @QueryParam("startMs") Long startMs, @QueryParam("endMs") Long endMs);
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "/fleet/vehicles/stats", tags={  })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public InlineResponse2005 getVehicleStats(@QueryParam("access_token") String accessToken, @QueryParam("startMs") Integer startMs, @QueryParam("endMs") Integer endMs, @QueryParam("series") String series, @QueryParam("tagIds") String tagIds, @QueryParam("startingAfter") String startingAfter, @QueryParam("endingBefore") String endingBefore, @QueryParam("limit") Long limit);
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "/fleet/vehicles/locations", tags={  })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public List<Object> getVehiclesLocations(@QueryParam("access_token") String accessToken, @QueryParam("startMs") Integer startMs, @QueryParam("endMs") Integer endMs);
    ...
    @Path("/contacts")
    @Produces({ "application/json" })
    @ApiOperation(value = "/contacts", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "List of contacts.", response = Contact.class, responseContainer = "List"),
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public List<Contact> listContacts(@QueryParam("access_token") String accessToken);
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "/fleet/list", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "List of vehicles and information about each.", response = InlineResponse2002.class),
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public InlineResponse2002 listFleet(@QueryParam("access_token") String accessToken, InlineObject10 groupParam, @QueryParam("startingAfter") String startingAfter, @QueryParam("endingBefore") String endingBefore, @QueryParam("limit") Long limit);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public FleetVehicleResponse patchFleetVehicle(@QueryParam("access_token") String accessToken, @PathParam("vehicle_id_or_external_id") String vehicleIdOrExternalId, InlineObject16 data);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public Driver reactivateDriverById(@QueryParam("access_token") String accessToken, @PathParam("driver_id_or_external_id") String driverIdOrExternalId, InlineObject4 reactivateDriverParam);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public void updateOrganizationAddress(@QueryParam("access_token") String accessToken, @PathParam("addressId") Long addressId, InlineObject1 address);
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "/fleet/set_data", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Vehicles were successfully updated. No response body is returned."),
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public void updateVehicles(@QueryParam("access_token") String accessToken, InlineObject14 vehicleUpdateParam);
}
