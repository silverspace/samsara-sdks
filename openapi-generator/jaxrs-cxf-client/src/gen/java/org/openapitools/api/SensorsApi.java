...
public interface SensorsApi  {
    ...
    @ApiOperation(value = "/sensors/list", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "List of sensor objects.", response = InlineResponse2008.class),
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public InlineResponse2008 getSensors(@QueryParam("access_token") String accessToken, InlineObject23 groupParam);
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "/sensors/cargo", tags={  })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public CargoResponse getSensorsCargo(@QueryParam("access_token") String accessToken, InlineObject19 sensorParam);
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "/sensors/door", tags={  })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public DoorResponse getSensorsDoor(@QueryParam("access_token") String accessToken, InlineObject20 sensorParam);
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "/sensors/history", tags={  })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public SensorHistoryResponse getSensorsHistory(@QueryParam("access_token") String accessToken, InlineObject21 historyParam);
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "/sensors/humidity", tags={  })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public HumidityResponse getSensorsHumidity(@QueryParam("access_token") String accessToken, InlineObject22 sensorParam);
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "/sensors/temperature", tags={  })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error.", response = String.class) })
    public TemperatureResponse getSensorsTemperature(@QueryParam("access_token") String accessToken, InlineObject24 sensorParam);
}
