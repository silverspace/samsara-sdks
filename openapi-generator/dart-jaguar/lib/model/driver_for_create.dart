...
part 'driver_for_create.jser.dart';
...

{
     ...
     this.password = null,   this.tagIds = const [] 
...
class DriverForCreateSerializer extends Serializer<DriverForCreate> with _$DriverForCreateSerializer {
