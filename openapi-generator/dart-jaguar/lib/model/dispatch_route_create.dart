...
part 'dispatch_route_create.jser.dart';
...
class DispatchRouteCreate {
  ...
  @Alias('dispatch_jobs')
  final List<DispatchJobCreate> dispatchJobs;
...
class DispatchRouteCreateSerializer extends Serializer<DispatchRouteCreate> with _$DispatchRouteCreateSerializer {
