...
#ifndef OAI_OAIAssetsApiHandler_H
#define OAI_OAIAssetsApiHandler_H
...
class OAIAssetsApiHandler : public QObject
{
    Q_OBJECT
    
public:
    OAIAssetsApiHandler();
    virtual ~OAIAssetsApiHandler();
...
#endif // OAI_OAIAssetsApiHandler_H
