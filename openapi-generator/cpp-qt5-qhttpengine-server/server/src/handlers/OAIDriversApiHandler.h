...
#ifndef OAI_OAIDriversApiHandler_H
#define OAI_OAIDriversApiHandler_H
...
class OAIDriversApiHandler : public QObject
{
    Q_OBJECT
    
public:
    OAIDriversApiHandler();
    virtual ~OAIDriversApiHandler();
...
#endif // OAI_OAIDriversApiHandler_H
