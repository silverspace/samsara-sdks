...
#ifndef OAI_OAISafetyApiHandler_H
#define OAI_OAISafetyApiHandler_H
...
class OAISafetyApiHandler : public QObject
{
    Q_OBJECT
    
public:
    OAISafetyApiHandler();
    virtual ~OAISafetyApiHandler();
...
#endif // OAI_OAISafetyApiHandler_H
