...
#ifndef OAI_OAIRoutesApiHandler_H
#define OAI_OAIRoutesApiHandler_H
...
class OAIRoutesApiHandler : public QObject
{
    Q_OBJECT
    
public:
    OAIRoutesApiHandler();
    virtual ~OAIRoutesApiHandler();
...
#endif // OAI_OAIRoutesApiHandler_H
