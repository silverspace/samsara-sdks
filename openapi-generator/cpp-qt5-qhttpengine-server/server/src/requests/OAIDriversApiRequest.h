...
#ifndef OAI_OAIDriversApiRequest_H
#define OAI_OAIDriversApiRequest_H
...
class OAIDriversApiRequest : public QObject
{
    Q_OBJECT

public:
    OAIDriversApiRequest(QHttpEngine::Socket *s, OAIDriversApiHandler* handler);
    virtual ~OAIDriversApiRequest();
...
#endif // OAI_OAIDriversApiRequest_H
