...
#ifndef OAI_OAIAssetsApiRequest_H
#define OAI_OAIAssetsApiRequest_H
...
class OAIAssetsApiRequest : public QObject
{
    Q_OBJECT

public:
    OAIAssetsApiRequest(QHttpEngine::Socket *s, OAIAssetsApiHandler* handler);
    virtual ~OAIAssetsApiRequest();
...
#endif // OAI_OAIAssetsApiRequest_H
