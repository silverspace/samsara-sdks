...
public:
    ...
    qint64 getDispatchJobId() const;
    void setDispatchJobId(const qint64 &dispatch_job_id);
    ...
    qint64 getDriverCreatedAtMs() const;
    void setDriverCreatedAtMs(const qint64 &driver_created_at_ms);

    qint64 getDriverId() const;
    void setDriverId(const qint64 &driver_id);

    QList<OAIDocumentField> getFields() const;
    void setFields(const QList<OAIDocumentField> &fields);
...
private:
    void init();
    qint64 dispatch_job_id;
    bool m_dispatch_job_id_isSet;
    bool m_dispatch_job_id_isValid;
    QString notes;
    bool m_notes_isSet;
    ...
    qint64 driver_created_at_ms;
    bool m_driver_created_at_ms_isSet;
    bool m_driver_created_at_ms_isValid;
    qint64 driver_id;
    bool m_driver_id_isSet;
    bool m_driver_id_isValid;
    QList<OAIDocumentField> fields;
    bool m_fields_isSet;
