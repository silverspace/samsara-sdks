...
OAITagUpdate::OAITagUpdate(QString json) {
    this->init();
    this->fromJson(json);
}

OAITagUpdate::OAITagUpdate() {
    this->init();
}
...
void
OAITagUpdate::fromJson(QString jsonString) {
...
void
OAITagUpdate::fromJsonObject(QJsonObject json) {
...
QJsonObject
OAITagUpdate::asJsonObject() const {
    QJsonObject obj;
...
OAITagUpdate::getAssets() const {
    return assets;
}
void
OAITagUpdate::setAssets(const QList<OAITaggedAssetBase> &assets) {
    this->assets = assets;
    this->m_assets_isSet = true;
}

QList<OAITaggedDriverBase>
OAITagUpdate::getDrivers() const {
    return drivers;
}
void
OAITagUpdate::setDrivers(const QList<OAITaggedDriverBase> &drivers) {
    this->drivers = drivers;
    this->m_drivers_isSet = true;
}

QList<OAITaggedMachineBase>
OAITagUpdate::getMachines() const {
    return machines;
}
void
OAITagUpdate::setMachines(const QList<OAITaggedMachineBase> &machines) {
    this->machines = machines;
    this->m_machines_isSet = true;
}

QString
OAITagUpdate::getName() const {
    return name;
}
void
OAITagUpdate::setName(const QString &name) {
    this->name = name;
    this->m_name_isSet = true;
}

qint64
OAITagUpdate::getParentTagId() const {
    return parent_tag_id;
}
void
OAITagUpdate::setParentTagId(const qint64 &parent_tag_id) {
    this->parent_tag_id = parent_tag_id;
    this->m_parent_tag_id_isSet = true;
}

QList<OAITaggedSensorBase>
OAITagUpdate::getSensors() const {
    return sensors;
}
void
OAITagUpdate::setSensors(const QList<OAITaggedSensorBase> &sensors) {
    this->sensors = sensors;
    this->m_sensors_isSet = true;
}

QList<OAITaggedVehicleBase>
OAITagUpdate::getVehicles() const {
    return vehicles;
}
void
OAITagUpdate::setVehicles(const QList<OAITaggedVehicleBase> &vehicles) {
    this->vehicles = vehicles;
    this->m_vehicles_isSet = true;
}

bool
OAITagUpdate::isSet() const {
