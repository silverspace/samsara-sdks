...
void
OAIAddress::fromJson(QString jsonString) {
...
void
OAIAddress::fromJsonObject(QJsonObject json) {
    
    m_contacts_isValid = ::OpenAPI::fromJsonValue(contacts, json[QString("contacts")]);
...
QJsonObject
OAIAddress::asJsonObject() const {
    QJsonObject obj;
	
    if(contacts.size() > 0){
        obj.insert(QString("contacts"), ::OpenAPI::toJsonValue(contacts));
    } 
...
QList<OAIContact>
OAIAddress::getContacts() const {
    return contacts;
}
void
OAIAddress::setContacts(const QList<OAIContact> &contacts) {
    this->contacts = contacts;
    this->m_contacts_isSet = true;
}

QString
OAIAddress::getFormattedAddress() const {
    return formatted_address;
}
void
OAIAddress::setFormattedAddress(const QString &formatted_address) {
    this->formatted_address = formatted_address;
    this->m_formatted_address_isSet = true;
}

OAIAddressGeofence
OAIAddress::getGeofence() const {
    return geofence;
}
void
OAIAddress::setGeofence(const OAIAddressGeofence &geofence) {
    this->geofence = geofence;
    this->m_geofence_isSet = true;
}

qint64
OAIAddress::getId() const {
    return id;
}
void
OAIAddress::setId(const qint64 &id) {
    this->id = id;
    this->m_id_isSet = true;
}

QString
OAIAddress::getName() const {
    return name;
}
void
OAIAddress::setName(const QString &name) {
    this->name = name;
    this->m_name_isSet = true;
}

QString
OAIAddress::getNotes() const {
    return notes;
}
void
OAIAddress::setNotes(const QString &notes) {
    this->notes = notes;
    this->m_notes_isSet = true;
}

QList<OAITagMetadata>
OAIAddress::getTags() const {
    return tags;
}
void
OAIAddress::setTags(const QList<OAITagMetadata> &tags) {
    this->tags = tags;
    this->m_tags_isSet = true;
}

bool
OAIAddress::isSet() const {
    bool isObjectUpdated = false;
    do{ 
        if(contacts.size() > 0){ isObjectUpdated = true; break;}
