...
void
OAIUserBase::fromJson(QString jsonString) {
...
void
OAIUserBase::fromJsonObject(QJsonObject json) {
...
QJsonObject
OAIUserBase::asJsonObject() const {
    QJsonObject obj;
...
QString
OAIUserBase::getAuthType() const {
    return auth_type;
}
void
OAIUserBase::setAuthType(const QString &auth_type) {
    this->auth_type = auth_type;
    this->m_auth_type_isSet = true;
}

QString
OAIUserBase::getEmail() const {
    return email;
}
void
OAIUserBase::setEmail(const QString &email) {
    this->email = email;
    this->m_email_isSet = true;
}

QString
OAIUserBase::getName() const {
    return name;
}
void
OAIUserBase::setName(const QString &name) {
    this->name = name;
    this->m_name_isSet = true;
}

QString
OAIUserBase::getOrganizationRoleId() const {
    return organization_role_id;
}
void
OAIUserBase::setOrganizationRoleId(const QString &organization_role_id) {
    this->organization_role_id = organization_role_id;
    this->m_organization_role_id_isSet = true;
}

bool
OAIUserBase::isSet() const {
