...
OAITagModify_delete::OAITagModify_delete(QString json) {
    this->init();
    this->fromJson(json);
}

OAITagModify_delete::OAITagModify_delete() {
    this->init();
}
...
void
OAITagModify_delete::fromJson(QString jsonString) {
...
void
OAITagModify_delete::fromJsonObject(QJsonObject json) {
...
QString
OAITagModify_delete::asJson () const {
...
QJsonObject
OAITagModify_delete::asJsonObject() const {
    QJsonObject obj;
...
QList<OAITaggedAssetBase>
OAITagModify_delete::getAssets() const {
    return assets;
}
void
OAITagModify_delete::setAssets(const QList<OAITaggedAssetBase> &assets) {
    this->assets = assets;
    this->m_assets_isSet = true;
}

QList<OAITaggedSensorBase>
OAITagModify_delete::getSensors() const {
    return sensors;
}
void
OAITagModify_delete::setSensors(const QList<OAITaggedSensorBase> &sensors) {
    this->sensors = sensors;
    this->m_sensors_isSet = true;
}

QList<OAITaggedVehicleBase>
OAITagModify_delete::getVehicles() const {
    return vehicles;
}
void
OAITagModify_delete::setVehicles(const QList<OAITaggedVehicleBase> &vehicles) {
    this->vehicles = vehicles;
    this->m_vehicles_isSet = true;
}

QList<OAITaggedMachineBase>
OAITagModify_delete::getMachines() const {
    return machines;
}
void
OAITagModify_delete::setMachines(const QList<OAITaggedMachineBase> &machines) {
    this->machines = machines;
    this->m_machines_isSet = true;
}

QList<OAITaggedDriverBase>
OAITagModify_delete::getDrivers() const {
    return drivers;
}
void
OAITagModify_delete::setDrivers(const QList<OAITaggedDriverBase> &drivers) {
    this->drivers = drivers;
    this->m_drivers_isSet = true;
}

bool
OAITagModify_delete::isSet() const {
...
bool
OAITagModify_delete::isValid() const {
