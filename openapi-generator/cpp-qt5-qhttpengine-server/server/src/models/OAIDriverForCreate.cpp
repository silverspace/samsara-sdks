...
OAIDriverForCreate::OAIDriverForCreate(QString json) {
    this->init();
    this->fromJson(json);
}

OAIDriverForCreate::OAIDriverForCreate() {
    this->init();
}
...
void
OAIDriverForCreate::fromJson(QString jsonString) {
...
void
OAIDriverForCreate::fromJsonObject(QJsonObject json) {
...
QString
OAIDriverForCreate::asJson () const {
...
QJsonObject
OAIDriverForCreate::asJsonObject() const {
    QJsonObject obj;
...
bool
OAIDriverForCreate::isEldAdverseWeatherExemptionEnabled() const {
    return eld_adverse_weather_exemption_enabled;
}
void
OAIDriverForCreate::setEldAdverseWeatherExemptionEnabled(const bool &eld_adverse_weather_exemption_enabled) {
...
bool
OAIDriverForCreate::isEldBigDayExemptionEnabled() const {
    return eld_big_day_exemption_enabled;
}
void
OAIDriverForCreate::setEldBigDayExemptionEnabled(const bool &eld_big_day_exemption_enabled) {
    this->eld_big_day_exemption_enabled = eld_big_day_exemption_enabled;
    this->m_eld_big_day_exemption_enabled_isSet = true;
}

qint32
OAIDriverForCreate::getEldDayStartHour() const {
    return eld_day_start_hour;
}
void
OAIDriverForCreate::setEldDayStartHour(const qint32 &eld_day_start_hour) {
    this->eld_day_start_hour = eld_day_start_hour;
    this->m_eld_day_start_hour_isSet = true;
}

bool
OAIDriverForCreate::isEldExempt() const {
    return eld_exempt;
}
void
OAIDriverForCreate::setEldExempt(const bool &eld_exempt) {
    this->eld_exempt = eld_exempt;
    this->m_eld_exempt_isSet = true;
}

QString
OAIDriverForCreate::getEldExemptReason() const {
    return eld_exempt_reason;
}
void
OAIDriverForCreate::setEldExemptReason(const QString &eld_exempt_reason) {
    this->eld_exempt_reason = eld_exempt_reason;
    this->m_eld_exempt_reason_isSet = true;
}

bool
OAIDriverForCreate::isEldPcEnabled() const {
    return eld_pc_enabled;
}
void
OAIDriverForCreate::setEldPcEnabled(const bool &eld_pc_enabled) {
    this->eld_pc_enabled = eld_pc_enabled;
    this->m_eld_pc_enabled_isSet = true;
}

bool
OAIDriverForCreate::isEldYmEnabled() const {
    return eld_ym_enabled;
}
void
OAIDriverForCreate::setEldYmEnabled(const bool &eld_ym_enabled) {
    this->eld_ym_enabled = eld_ym_enabled;
    this->m_eld_ym_enabled_isSet = true;
}

QMap<QString, QString>
OAIDriverForCreate::getExternalIds() const {
    return external_ids;
}
void
OAIDriverForCreate::setExternalIds(const QMap<QString, QString> &external_ids) {
    this->external_ids = external_ids;
    this->m_external_ids_isSet = true;
}

qint64
OAIDriverForCreate::getGroupId() const {
    return group_id;
}
void
OAIDriverForCreate::setGroupId(const qint64 &group_id) {
    this->group_id = group_id;
    this->m_group_id_isSet = true;
}

QString
OAIDriverForCreate::getLicenseNumber() const {
    return license_number;
}
void
OAIDriverForCreate::setLicenseNumber(const QString &license_number) {
    this->license_number = license_number;
    this->m_license_number_isSet = true;
}

QString
OAIDriverForCreate::getLicenseState() const {
    return license_state;
}
void
OAIDriverForCreate::setLicenseState(const QString &license_state) {
    this->license_state = license_state;
    this->m_license_state_isSet = true;
}

QString
OAIDriverForCreate::getName() const {
    return name;
}
void
OAIDriverForCreate::setName(const QString &name) {
    this->name = name;
    this->m_name_isSet = true;
}

QString
OAIDriverForCreate::getNotes() const {
    return notes;
}
void
OAIDriverForCreate::setNotes(const QString &notes) {
    this->notes = notes;
    this->m_notes_isSet = true;
}

QString
OAIDriverForCreate::getPhone() const {
    return phone;
}
void
OAIDriverForCreate::setPhone(const QString &phone) {
    this->phone = phone;
    this->m_phone_isSet = true;
}

QString
OAIDriverForCreate::getUsername() const {
    return username;
}
void
OAIDriverForCreate::setUsername(const QString &username) {
    this->username = username;
    this->m_username_isSet = true;
}

qint64
OAIDriverForCreate::getVehicleId() const {
    return vehicle_id;
}
void
OAIDriverForCreate::setVehicleId(const qint64 &vehicle_id) {
    this->vehicle_id = vehicle_id;
    this->m_vehicle_id_isSet = true;
}

QString
OAIDriverForCreate::getPassword() const {
    return password;
}
void
OAIDriverForCreate::setPassword(const QString &password) {
    this->password = password;
    this->m_password_isSet = true;
}

QList<qint64>
OAIDriverForCreate::getTagIds() const {
    return tag_ids;
}
void
OAIDriverForCreate::setTagIds(const QList<qint64> &tag_ids) {
    this->tag_ids = tag_ids;
    this->m_tag_ids_isSet = true;
}

bool
OAIDriverForCreate::isSet() const {
...
bool
OAIDriverForCreate::isValid() const {
