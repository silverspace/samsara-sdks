...
/*
 * OAIInline_object_6.h
 *
 * 
 */

#ifndef OAIInline_object_6_H
#define OAIInline_object_6_H
...
class OAIInline_object_6: public OAIObject {
public:
    OAIInline_object_6();
    OAIInline_object_6(QString json);
    ~OAIInline_object_6() override;
