...
OAIInline_object_15::OAIInline_object_15(QString json) {
    this->init();
    this->fromJson(json);
}

OAIInline_object_15::OAIInline_object_15() {
    this->init();
}
...
void
OAIInline_object_15::fromJson(QString jsonString) {
...
void
OAIInline_object_15::fromJsonObject(QJsonObject json) {
...
QString
OAIInline_object_15::asJson () const {
...
QJsonObject
OAIInline_object_15::asJsonObject() const {
    QJsonObject obj;
	if(m_end_ms_isSet){
...
qint32
OAIInline_object_15::getEndMs() const {
    return end_ms;
}
void
OAIInline_object_15::setEndMs(const qint32 &end_ms) {
    this->end_ms = end_ms;
    this->m_end_ms_isSet = true;
}

qint64
OAIInline_object_15::getGroupId() const {
    return group_id;
}
void
OAIInline_object_15::setGroupId(const qint64 &group_id) {
    this->group_id = group_id;
    this->m_group_id_isSet = true;
}

qint32
OAIInline_object_15::getStartMs() const {
    return start_ms;
}
void
OAIInline_object_15::setStartMs(const qint32 &start_ms) {
    this->start_ms = start_ms;
    this->m_start_ms_isSet = true;
}

qint64
OAIInline_object_15::getVehicleId() const {
    return vehicle_id;
}
void
OAIInline_object_15::setVehicleId(const qint64 &vehicle_id) {
    this->vehicle_id = vehicle_id;
    this->m_vehicle_id_isSet = true;
}

bool
OAIInline_object_15::isSet() const {
...
bool
OAIInline_object_15::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_end_ms_isValid && m_group_id_isValid && m_start_ms_isValid && m_vehicle_id_isValid && true;
}
