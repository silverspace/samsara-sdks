...
#ifndef OAIDispatchRoute_H
#define OAIDispatchRoute_H
...
class OAIDispatchRoute: public OAIObject {
public:
    OAIDispatchRoute();
    OAIDispatchRoute(QString json);
    ~OAIDispatchRoute() override;
    ...
    QList<OAIDispatchJob> getDispatchJobs() const;
    void setDispatchJobs(const QList<OAIDispatchJob> &dispatch_jobs);
...
private:
    ...
    QList<OAIDispatchJob> dispatch_jobs;
