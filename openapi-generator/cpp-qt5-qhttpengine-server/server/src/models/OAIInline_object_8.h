...
/*
 * OAIInline_object_8.h
 *
 * 
 */

#ifndef OAIInline_object_8_H
#define OAIInline_object_8_H
...
class OAIInline_object_8: public OAIObject {
public:
    OAIInline_object_8();
    OAIInline_object_8(QString json);
    ~OAIInline_object_8() override;
