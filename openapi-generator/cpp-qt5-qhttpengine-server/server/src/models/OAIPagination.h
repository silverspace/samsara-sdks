...
public:
    ...
    QString getEndCursor() const;
    void setEndCursor(const QString &end_cursor);

    bool isHasNextPage() const;
    void setHasNextPage(const bool &has_next_page);

    bool isHasPrevPage() const;
    void setHasPrevPage(const bool &has_prev_page);

    QString getStartCursor() const;
    void setStartCursor(const QString &start_cursor);
...
private:
    ...
    bool has_prev_page;
    bool m_has_prev_page_isSet;
    bool m_has_prev_page_isValid;
    QString start_cursor;
