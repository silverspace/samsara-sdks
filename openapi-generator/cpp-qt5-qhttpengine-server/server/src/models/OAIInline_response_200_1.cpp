...
QList<OAIAssetCurrentLocationsResponse>
OAIInline_response_200_1::getAssets() const {
    return assets;
}
void
OAIInline_response_200_1::setAssets(const QList<OAIAssetCurrentLocationsResponse> &assets) {
    this->assets = assets;
