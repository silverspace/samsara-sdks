...
public:
    ...
    QList<OAIAssetCurrentLocationsResponse> getAssets() const;
    void setAssets(const QList<OAIAssetCurrentLocationsResponse> &assets);
...
private:
    void init();
    QList<OAIAssetCurrentLocationsResponse> assets;
    bool m_assets_isSet;
