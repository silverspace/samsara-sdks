...
#include "OAIDispatchRouteBase.h"
...
OAIDispatchRouteBase::OAIDispatchRouteBase(QString json) {
    this->init();
    this->fromJson(json);
}

OAIDispatchRouteBase::OAIDispatchRouteBase() {
    this->init();
}
...
void
OAIDispatchRouteBase::fromJson(QString jsonString) {
...
void
OAIDispatchRouteBase::fromJsonObject(QJsonObject json) {
...
QString
OAIDispatchRouteBase::asJson () const {
...
QJsonObject
OAIDispatchRouteBase::asJsonObject() const {
    QJsonObject obj;
...
qint64
OAIDispatchRouteBase::getActualEndMs() const {
    return actual_end_ms;
}
void
OAIDispatchRouteBase::setActualEndMs(const qint64 &actual_end_ms) {
    this->actual_end_ms = actual_end_ms;
    this->m_actual_end_ms_isSet = true;
}

qint64
OAIDispatchRouteBase::getActualStartMs() const {
    return actual_start_ms;
}
void
OAIDispatchRouteBase::setActualStartMs(const qint64 &actual_start_ms) {
    this->actual_start_ms = actual_start_ms;
    this->m_actual_start_ms_isSet = true;
}

qint64
OAIDispatchRouteBase::getDriverId() const {
    return driver_id;
}
void
OAIDispatchRouteBase::setDriverId(const qint64 &driver_id) {
    this->driver_id = driver_id;
    this->m_driver_id_isSet = true;
}

qint64
OAIDispatchRouteBase::getGroupId() const {
    return group_id;
}
void
OAIDispatchRouteBase::setGroupId(const qint64 &group_id) {
    this->group_id = group_id;
    this->m_group_id_isSet = true;
}

QString
OAIDispatchRouteBase::getName() const {
    return name;
}
void
OAIDispatchRouteBase::setName(const QString &name) {
    this->name = name;
    this->m_name_isSet = true;
}

qint64
OAIDispatchRouteBase::getScheduledEndMs() const {
    return scheduled_end_ms;
}
void
OAIDispatchRouteBase::setScheduledEndMs(const qint64 &scheduled_end_ms) {
    this->scheduled_end_ms = scheduled_end_ms;
    this->m_scheduled_end_ms_isSet = true;
}

qint64
OAIDispatchRouteBase::getScheduledMeters() const {
    return scheduled_meters;
}
void
OAIDispatchRouteBase::setScheduledMeters(const qint64 &scheduled_meters) {
    this->scheduled_meters = scheduled_meters;
    this->m_scheduled_meters_isSet = true;
}

qint64
OAIDispatchRouteBase::getScheduledStartMs() const {
    return scheduled_start_ms;
}
void
OAIDispatchRouteBase::setScheduledStartMs(const qint64 &scheduled_start_ms) {
    this->scheduled_start_ms = scheduled_start_ms;
    this->m_scheduled_start_ms_isSet = true;
}

QString
OAIDispatchRouteBase::getStartLocationAddress() const {
    return start_location_address;
}
void
OAIDispatchRouteBase::setStartLocationAddress(const QString &start_location_address) {
    this->start_location_address = start_location_address;
    this->m_start_location_address_isSet = true;
}

qint64
OAIDispatchRouteBase::getStartLocationAddressId() const {
    return start_location_address_id;
}
void
OAIDispatchRouteBase::setStartLocationAddressId(const qint64 &start_location_address_id) {
    this->start_location_address_id = start_location_address_id;
    this->m_start_location_address_id_isSet = true;
}

double
OAIDispatchRouteBase::getStartLocationLat() const {
    return start_location_lat;
}
void
OAIDispatchRouteBase::setStartLocationLat(const double &start_location_lat) {
    this->start_location_lat = start_location_lat;
    this->m_start_location_lat_isSet = true;
}

double
OAIDispatchRouteBase::getStartLocationLng() const {
    return start_location_lng;
}
void
OAIDispatchRouteBase::setStartLocationLng(const double &start_location_lng) {
    this->start_location_lng = start_location_lng;
    this->m_start_location_lng_isSet = true;
}

QString
OAIDispatchRouteBase::getStartLocationName() const {
    return start_location_name;
}
void
OAIDispatchRouteBase::setStartLocationName(const QString &start_location_name) {
    this->start_location_name = start_location_name;
    this->m_start_location_name_isSet = true;
}

qint64
OAIDispatchRouteBase::getTrailerId() const {
    return trailer_id;
}
void
OAIDispatchRouteBase::setTrailerId(const qint64 &trailer_id) {
    this->trailer_id = trailer_id;
    this->m_trailer_id_isSet = true;
}

qint64
OAIDispatchRouteBase::getVehicleId() const {
    return vehicle_id;
}
void
OAIDispatchRouteBase::setVehicleId(const qint64 &vehicle_id) {
    this->vehicle_id = vehicle_id;
    this->m_vehicle_id_isSet = true;
}

bool
OAIDispatchRouteBase::isSet() const {
...
bool
OAIDispatchRouteBase::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_name_isValid && m_scheduled_end_ms_isValid && m_scheduled_start_ms_isValid && true;
}
