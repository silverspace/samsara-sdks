...
OAIPagination
OAIInline_response_200_2::getPagination() const {
    return pagination;
}
void
OAIInline_response_200_2::setPagination(const OAIPagination &pagination) {
    this->pagination = pagination;
    this->m_pagination_isSet = true;
}

qint64
OAIInline_response_200_2::getGroupId() const {
    return group_id;
}
void
OAIInline_response_200_2::setGroupId(const qint64 &group_id) {
    this->group_id = group_id;
    this->m_group_id_isSet = true;
}

QList<OAIVehicle>
OAIInline_response_200_2::getVehicles() const {
    return vehicles;
}
void
OAIInline_response_200_2::setVehicles(const QList<OAIVehicle> &vehicles) {
