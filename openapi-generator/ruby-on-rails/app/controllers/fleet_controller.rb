...
class FleetController < ApplicationController
  ...
  def get_fleet_drivers_hos_daily_logs
    # Your code here
  ...
  def get_fleet_hos_authentication_logs
    # Your code here

    render json: {"message" => "yes, it worked"}
  end

  def get_fleet_hos_logs
    # Your code here

    render json: {"message" => "yes, it worked"}
  end

  def get_fleet_hos_logs_summary
    # Your code here
  ...
  def get_fleet_maintenance_list
    # Your code here
