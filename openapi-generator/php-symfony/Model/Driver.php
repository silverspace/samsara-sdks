...
/**
 * Class representing the Driver model.
 *
 * @package OpenAPI\Server\Model
 * @author  OpenAPI Generator team
 */
class Driver 
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->isDeactivated = isset($data['isDeactivated']) ? $data['isDeactivated'] : null;
     ...
     * @return bool|null
     */
    public function isIsDeactivated()
    {
     ...
     * Sets isDeactivated.
     *
     * @param bool|null $isDeactivated  True if the driver account has been deactivated.
     *
     * @return $this
     */
    public function setIsDeactivated($isDeactivated = null)
    {
