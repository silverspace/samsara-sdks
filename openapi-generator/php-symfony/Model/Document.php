...
class Document 
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->driverCreatedAtMs = isset($data['driverCreatedAtMs']) ? $data['driverCreatedAtMs'] : null;
     ...
     * Sets documentType.
     *
     * @param string $documentType  Descriptive name of this type of document.
     *
     * @return $this
     */
    ...
    /**
     * Sets driverCreatedAtMs.
     *
     * @param int $driverCreatedAtMs  The time in Unix epoch milliseconds that the document is created.
     *
     * @return $this
     */
    public function setDriverCreatedAtMs($driverCreatedAtMs)
    {
     ...
     * Sets driverId.
     *
     * @param int $driverId  ID of the driver for whom the document is submitted
     *
     * @return $this
     */
     ...
     * Sets fields.
     *
     * @param OpenAPI\Server\Model\DocumentField[] $fields  The fields associated with this document.
     *
     * @return $this
     */
     ...
     * Sets vehicleId.
     *
     * @param int|null $vehicleId  VehicleID of the driver at document creation.
     *
     * @return $this
     */
