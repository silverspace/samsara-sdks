...
/**
 * Class representing the DispatchRouteCreate model.
 *
 * @package OpenAPI\Server\Model
 * @author  OpenAPI Generator team
 */
class DispatchRouteCreate 
{
     ...
     *
     * @var OpenAPI\Server\Model\DispatchJobCreate[]
     * @SerializedName("dispatch_jobs")
     * @Assert\NotNull()
     * @Assert\All({
     *   @Assert\Type("OpenAPI\Server\Model\DispatchJobCreate")
     * })
     * @Type("array<OpenAPI\Server\Model\DispatchJobCreate>")
     */
     ...
     * Gets dispatchJobs.
     *
     * @return OpenAPI\Server\Model\DispatchJobCreate[]
     */
     ...
     * Sets dispatchJobs.
     *
     * @param OpenAPI\Server\Model\DispatchJobCreate[] $dispatchJobs  The dispatch jobs to create for this route.
     *
     * @return $this
     */
