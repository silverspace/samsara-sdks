...
/**
 * Class representing the AddressesAddresses model.
 *
 * @package OpenAPI\Server\Model
 * @author  OpenAPI Generator team
 */
class AddressesAddresses 
{
    ...
    /**
     * @var OpenAPI\Server\Model\AddressGeofence
     ...
     *
     * @param string $formattedAddress  The full address associated with this address/geofence, as it might be recognized by maps.google.com
     *
     * @return $this
     */
     ...
     * Gets geofence.
     *
     * @return OpenAPI\Server\Model\AddressGeofence
     */
     ...
     * Sets geofence.
     *
     * @param OpenAPI\Server\Model\AddressGeofence $geofence
     *
     * @return $this
     */
    public function setGeofence(AddressGeofence $geofence)
    {
