...
class Asset 
{
    ...
    {
        $this->assetSerialNumber = isset($data['assetSerialNumber']) ? $data['assetSerialNumber'] : null;
    ...
    /**
     * Sets assetSerialNumber.
     *
     * @param string|null $assetSerialNumber  Serial number of the host asset
     *
     * @return $this
     */
