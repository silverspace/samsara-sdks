...
/**
 * Class representing the SafetyReportHarshEvent model.
 *
...
class SafetyReportHarshEvent 
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->timestampMs = isset($data['timestampMs']) ? $data['timestampMs'] : null;
     ...
     * Sets harshEventType.
     *
     * @param string|null $harshEventType  Type of the harsh event
     *
     * @return $this
     */
    public function setHarshEventType($harshEventType = null)
    {
     ...
     * Sets timestampMs.
     *
     * @param int|null $timestampMs  Timestamp that the harsh event occurred in Unix milliseconds since epoch
     *
     * @return $this
     */
    public function setTimestampMs($timestampMs = null)
    {
     ...
     * Sets vehicleId.
     *
     * @param int|null $vehicleId  Vehicle associated with the harsh event
     *
     * @return $this
     */
