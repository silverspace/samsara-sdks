...
/**
 * Class representing the InlineObject21 model.
 *
 * @package OpenAPI\Server\Model
 * @author  OpenAPI Generator team
 */
class InlineObject21 
{
     ...
     * @Assert\Choice({ "withNull", "withPrevious" })
     * @Assert\Type("string")
     * @Type("string")
     */
    protected $fillMissing;
    ...
    /**
     * @var OpenAPI\Server\Model\SensorsHistorySeries[]
     * @SerializedName("series")
     * @Assert\NotNull()
     * @Assert\All({
     *   @Assert\Type("OpenAPI\Server\Model\SensorsHistorySeries")
     * })
     * @Type("array<OpenAPI\Server\Model\SensorsHistorySeries>")
     */
    protected $series;
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->fillMissing = isset($data['fillMissing']) ? $data['fillMissing'] : 'withNull';
        ...
        $this->stepMs = isset($data['stepMs']) ? $data['stepMs'] : null;
    }
     ...
     * Sets fillMissing.
     *
     * @param string|null $fillMissing
     *
     * @return $this
     */
    public function setFillMissing($fillMissing = null)
    {
     ...
     * Gets series.
     *
     * @return OpenAPI\Server\Model\SensorsHistorySeries[]
     */
     ...
     * Sets series.
     *
     * @param OpenAPI\Server\Model\SensorsHistorySeries[] $series
     *
     * @return $this
     */
     ...
     * Sets stepMs.
     *
     * @param int $stepMs  Time resolution for which data should be returned, in milliseconds. Specifying 3600000 will return data at hour intervals.
     *
     * @return $this
     */
    public function setStepMs($stepMs)
    {
        $this->stepMs = $stepMs;
