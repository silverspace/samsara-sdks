...
module Request.Users exposing (deleteUserById, getUserById, listUserRoles, listUsers)
...
deleteUserById params =
    Http.request
        ...
        , url = Url.crossOrigin basePath
            ["users",  String.fromInt params.userId]
...
-}
listUserRoles :
    { onSend : Result Http.Error (List UserRole) -> msg
...
listUserRoles params =
    Http.request
        ...
        , url = Url.crossOrigin basePath
            ...
            (List.filterMap identity [Just (Url.string "access_token"  params.accessToken)])
        , body = Http.emptyBody
        , expect = Http.expectJson params.onSend (Decode.list UserRole.decoder)
        , timeout = Just 30000
        , tracker = Nothing
        }
