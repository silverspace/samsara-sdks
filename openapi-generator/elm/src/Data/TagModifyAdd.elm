...
module Data.TagModifyAdd exposing (TagModifyAdd, decoder, encode)
...
decoder : Decoder TagModifyAdd
decoder =
    Decode.succeed TagModifyAdd
...
encode : TagModifyAdd -> Encode.Value
encode model =
    Encode.object
