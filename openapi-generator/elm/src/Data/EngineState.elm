...
module Data.EngineState exposing (EngineState, Value(..), decoder, encode)
...
decoder : Decoder EngineState
decoder =
    Decode.succeed EngineState
        |> required "timeMs" Object.decoder
        |> required "value" valueDecoder



encode : EngineState -> Encode.Value
encode model =
    Encode.object
        [ ( "timeMs", Object.encode model.timeMs )
