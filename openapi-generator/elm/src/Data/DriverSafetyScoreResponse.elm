...
module Data.DriverSafetyScoreResponse exposing (DriverSafetyScoreResponse, decoder, encode)
...
-}
type alias DriverSafetyScoreResponse =
...
decoder : Decoder DriverSafetyScoreResponse
decoder =
    Decode.succeed DriverSafetyScoreResponse
...
encode : DriverSafetyScoreResponse -> Encode.Value
encode model =
    Encode.object
