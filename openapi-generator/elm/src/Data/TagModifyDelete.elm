...
module Data.TagModifyDelete exposing (TagModifyDelete, decoder, encode)
...
decoder : Decoder TagModifyDelete
decoder =
    Decode.succeed TagModifyDelete
...
encode : TagModifyDelete -> Encode.Value
encode model =
    Encode.object
