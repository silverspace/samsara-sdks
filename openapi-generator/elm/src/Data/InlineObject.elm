...
import Data.AddressesAddresses as AddressesAddresses exposing (AddressesAddresses)
...
decoder =
    Decode.succeed InlineObject
        |> required "addresses" (Decode.list AddressesAddresses.decoder)
...
encode model =
    Encode.object
        [ ( "addresses", (Encode.list AddressesAddresses.encode) model.addresses )
