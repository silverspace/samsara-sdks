...
export class TagsApi {
     ...
     */
    public createTag(accessToken: string, tagCreateParams: models.TagCreate, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: models.Tag;  },
     ...
     */
    public deleteTagById(accessToken: string, tagId: number, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
     ...
     */
    public getAllTags(accessToken: string, groupId?: number, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: models.InlineResponse2009;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/tags';
     ...
     * @param tagId ID of the tag.
     */
    public getTagById(accessToken: string, tagId: number, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: models.Tag;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/tags/{tag_id}'.replace('{' + 'tag_id' + '}', encodeURIComponent(String(tagId)));
     ...
     */
    public modifyTagById(accessToken: string, tagId: number, tagModifyParams: models.TagModify, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: models.Tag;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/tags/{tag_id}'.replace('{' + 'tag_id' + '}', encodeURIComponent(String(tagId)));
     ...
     */
    public updateTagById(accessToken: string, tagId: number, updateTagParams: models.TagUpdate, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: models.Tag;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/tags/{tag_id}'.replace('{' + 'tag_id' + '}', encodeURIComponent(String(tagId)));
