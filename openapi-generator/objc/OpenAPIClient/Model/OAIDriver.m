...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"eldAdverseWeatherExemptionEnabled", @"eldBigDayExemptionEnabled", @"eldDayStartHour", @"eldExempt", @"eldExemptReason", @"eldPcEnabled", @"eldYmEnabled", @"externalIds", @"groupId", @"licenseNumber", @"licenseState", @"notes", @"phone", @"username", @"vehicleId", @"isDeactivated", @"tags"];
