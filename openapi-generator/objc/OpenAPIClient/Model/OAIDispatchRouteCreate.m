...
@implementation OAIDispatchRouteCreate
...
+ (JSONKeyMapper *)keyMapper {
  return [[JSONKeyMapper alloc] initWithModelToJSONDictionary:@{ @"actualEndMs": @"actual_end_ms", @"actualStartMs": @"actual_start_ms", @"driverId": @"driver_id", @"groupId": @"group_id", @"name": @"name", @"scheduledEndMs": @"scheduled_end_ms", @"scheduledMeters": @"scheduled_meters", @"scheduledStartMs": @"scheduled_start_ms", @"startLocationAddress": @"start_location_address", @"startLocationAddressId": @"start_location_address_id", @"startLocationLat": @"start_location_lat", @"startLocationLng": @"start_location_lng", @"startLocationName": @"start_location_name", @"trailerId": @"trailer_id", @"vehicleId": @"vehicle_id", @"dispatchJobs": @"dispatch_jobs" }];
}
