...
@interface OAISensorsApi: NSObject <OAIApi>

extern NSString* kOAISensorsApiErrorDomain;
extern NSInteger kOAISensorsApiMissingParamErrorCode;
...
///  code:0 message:"Unexpected error."
///
/// @return OAISensorHistoryResponse*
