...
@interface OAITagsApi: NSObject <OAIApi>

extern NSString* kOAITagsApiErrorDomain;
extern NSInteger kOAITagsApiMissingParamErrorCode;
...
/// 
///  code:200 message:"Newly created tag object, including the new tag ID.",
...
/// 
///  code:200 message:"Successfully deleted the tag. No response body is returned.",
///  code:0 message:"Unexpected error."
///
/// @return void
...
/// @param tagId ID of the tag.
/// 
///  code:200 message:"The tag corresponding to tag_id.",
///  code:0 message:"Unexpected error."
///
/// @return OAITag*
...
/// 
///  code:200 message:"The updated tag data.",
///  code:0 message:"Unexpected error."
///
/// @return OAITag*
