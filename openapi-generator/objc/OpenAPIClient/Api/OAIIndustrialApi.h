...
@interface OAIIndustrialApi: NSObject <OAIApi>

extern NSString* kOAIIndustrialApiErrorDomain;
extern NSInteger kOAIIndustrialApiMissingParamErrorCode;
...
///  code:0 message:"Unexpected error."
///
/// @return OAIDataInputHistoryResponse*
...
///  code:0 message:"Unexpected error."
///
/// @return OAIMachineHistoryResponse*
