...
namespace Org.OpenAPITools.Api
{
 ...
 if (duration != null) queryParams.Add("duration", ApiClient.ParameterToString(duration)); // query parameter
        ...
        public List<DocumentType> GetDriverDocumentTypesByOrgId ()
        {
            ...
            return (List<DocumentType>) ApiClient.Deserialize(response.Content, typeof(List<DocumentType>), response.Headers);
        }
 ...
 if (groupId != null) queryParams.Add("group_id", ApiClient.ParameterToString(groupId)); // query parameter
        ...
        /// <param name="snapToDayBounds">Snap query result to HOS day boundaries.</param> 
        /// <returns>DriversSummaryResponse</returns>            
        public DriversSummaryResponse GetFleetDriversSummary (string accessToken, InlineObject5 driversSummaryParam, bool? snapToDayBounds)
        {
 ...
 if (endMs != null) queryParams.Add("endMs", ApiClient.ParameterToString(endMs)); // query parameter
            ...
            return (List<FleetVehicleLocation>) ApiClient.Deserialize(response.Content, typeof(List<FleetVehicleLocation>), response.Headers);
        }
