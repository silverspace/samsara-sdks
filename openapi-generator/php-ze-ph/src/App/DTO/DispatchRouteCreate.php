...
class DispatchRouteCreate
{
     ...
     * @DTA\Data(field="dispatch_jobs")
     * TODO check validator and strategy are correct and can handle container item type
     * @DTA\Strategy(name="ObjectArray", options={"type":\App\DTO\DispatchJobCreate::class})
     * @DTA\Validator(name="Collection", options={"validators":{
     *     {"name":"Dictionary", "options":{"type":\App\DTO\DispatchJobCreate::class}}
     * }})
     * @var \App\DTO\DispatchJobCreate[]
     */
    public $dispatch_jobs;
}
