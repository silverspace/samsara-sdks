...
{ 
    ...
    { 
        ...
        /// </summary>
        [DataMember(Name="dataInputs")]
        public List<DataInputHistoryResponse> DataInputs { get; set; }
        ...
        public bool Equals(InlineResponse2006 other)
        {
            ...
            return 
                (
                    DataInputs == other.DataInputs ||
                    DataInputs != null &&
                    DataInputs.SequenceEqual(other.DataInputs)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    if (DataInputs != null)
                    hashCode = hashCode * 59 + DataInputs.GetHashCode();
                return hashCode;
            }
        }
