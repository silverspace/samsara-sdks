...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class DoorResponseSensors : IEquatable<DoorResponseSensors>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((DoorResponseSensors)obj);
        }

        /// <summary>
        /// Returns true if DoorResponseSensors instances are equal
        /// </summary>
        /// <param name="other">Instance of DoorResponseSensors to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DoorResponseSensors other)
        {
            ...
            return 
                (
                    ...
                    DoorClosed != null &&
                    DoorClosed.Equals(other.DoorClosed)
                ) && 
                (
                    Name == other.Name ||
                    Name != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    if (DoorClosed != null)
                    hashCode = hashCode * 59 + DoorClosed.GetHashCode();
                    if (Name != null)
