...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class JobUpdateObject : IEquatable<JobUpdateObject>
    { 
        /// <summary>
        ...
        /// </summary>
        [DataMember(Name="prev_job_state")]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((JobUpdateObject)obj);
        }

        /// <summary>
        /// Returns true if JobUpdateObject instances are equal
        /// </summary>
        /// <param name="other">Instance of JobUpdateObject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JobUpdateObject other)
        {
            ...
            return 
                ...
                (
                    PrevJobState == other.PrevJobState ||
                    PrevJobState != null &&
                    PrevJobState.Equals(other.PrevJobState)
                ) && 
                (
                    Route == other.Route ||
                    Route != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (PrevJobState != null)
                    hashCode = hashCode * 59 + PrevJobState.GetHashCode();
                    if (Route != null)
