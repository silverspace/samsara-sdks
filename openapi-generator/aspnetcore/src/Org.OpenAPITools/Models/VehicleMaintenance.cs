...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class VehicleMaintenance : IEquatable<VehicleMaintenance>
    { 
        /// <summary>
        /// ID of the vehicle.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((VehicleMaintenance)obj);
        }

        /// <summary>
        /// Returns true if VehicleMaintenance instances are equal
        /// </summary>
        /// <param name="other">Instance of VehicleMaintenance to be compared</param>
        /// <returns>Boolean</returns>
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (J1939 != null)
                    hashCode = hashCode * 59 + J1939.GetHashCode();
                    if (Passenger != null)
