...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class DvirBaseTrailerDefects : IEquatable<DvirBaseTrailerDefects>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((DvirBaseTrailerDefects)obj);
        }

        /// <summary>
        /// Returns true if DvirBaseTrailerDefects instances are equal
        /// </summary>
        /// <param name="other">Instance of DvirBaseTrailerDefects to be compared</param>
        /// <returns>Boolean</returns>
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (DefectType != null)
                    hashCode = hashCode * 59 + DefectType.GetHashCode();
                return hashCode;
            }
        }
