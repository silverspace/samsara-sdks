...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class DocumentFieldType : IEquatable<DocumentFieldType>
    { 
        /// <summary>
        ...
        /// </summary>
        [DataMember(Name="numberValueTypeMetadata")]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((DocumentFieldType)obj);
        }

        /// <summary>
        /// Returns true if DocumentFieldType instances are equal
        /// </summary>
        /// <param name="other">Instance of DocumentFieldType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DocumentFieldType other)
        {
            ...
            return 
                ...
                (
                    NumberValueTypeMetadata == other.NumberValueTypeMetadata ||
                    NumberValueTypeMetadata != null &&
                    NumberValueTypeMetadata.Equals(other.NumberValueTypeMetadata)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + NumberValueTypeMetadata.GetHashCode();
                    if (ValueType != null)
