...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class DvirBaseMechanicOrAgentSignature : IEquatable<DvirBaseMechanicOrAgentSignature>
    { 
        /// <summary>
        ...
        [DataMember(Name="mechanicUserId")]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((DvirBaseMechanicOrAgentSignature)obj);
        }

        /// <summary>
        /// Returns true if DvirBaseMechanicOrAgentSignature instances are equal
        /// </summary>
        /// <param name="other">Instance of DvirBaseMechanicOrAgentSignature to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DvirBaseMechanicOrAgentSignature other)
        {
            ...
            return 
                (
                    MechanicUserId == other.MechanicUserId ||
                    MechanicUserId != null &&
                    MechanicUserId.Equals(other.MechanicUserId)
                ) && 
                (
                ...
                (
                    ...
                    SignedAt != null &&
                    SignedAt.Equals(other.SignedAt)
                ) && 
                (
                    Type == other.Type ||
                    Type != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + MechanicUserId.GetHashCode();
                    if (DriverId != null)
                    hashCode = hashCode * 59 + DriverId.GetHashCode();
                    if (Name != null)
                    hashCode = hashCode * 59 + Name.GetHashCode();
                    if (SignedAt != null)
                    hashCode = hashCode * 59 + SignedAt.GetHashCode();
                    if (Type != null)
