...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class FleetVehicleResponse : IEquatable<FleetVehicleResponse>
    { 
        /// <summary>
        ...
        [DataMember(Name="harshAccelSetting")]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((FleetVehicleResponse)obj);
        }

        /// <summary>
        /// Returns true if FleetVehicleResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of FleetVehicleResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FleetVehicleResponse other)
        {
            ...
            return 
                ...
                (
                    HarshAccelSetting == other.HarshAccelSetting ||
                    HarshAccelSetting != null &&
                    HarshAccelSetting.Equals(other.HarshAccelSetting)
                ) && 
                (
                    Id == other.Id ||
                    Id != null &&
                ...
                (
                    ...
                    VehicleInfo != null &&
                    VehicleInfo.Equals(other.VehicleInfo)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + HarshAccelSetting.GetHashCode();
                    if (Id != null)
                    hashCode = hashCode * 59 + Id.GetHashCode();
                    if (Name != null)
                    hashCode = hashCode * 59 + Name.GetHashCode();
                    if (VehicleInfo != null)
                    hashCode = hashCode * 59 + VehicleInfo.GetHashCode();
                return hashCode;
            }
        }
