...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class MachineHistoryResponse : IEquatable<MachineHistoryResponse>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((MachineHistoryResponse)obj);
        }

        /// <summary>
        /// Returns true if MachineHistoryResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of MachineHistoryResponse to be compared</param>
        /// <returns>Boolean</returns>
