...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class HosLogsSummaryResponse : IEquatable<HosLogsSummaryResponse>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((HosLogsSummaryResponse)obj);
        }

        /// <summary>
        /// Returns true if HosLogsSummaryResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of HosLogsSummaryResponse to be compared</param>
        /// <returns>Boolean</returns>
