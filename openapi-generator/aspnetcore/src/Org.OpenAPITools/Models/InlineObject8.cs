...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class InlineObject8 : IEquatable<InlineObject8>
    { 
        /// <summary>
        /// Driver ID to query.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((InlineObject8)obj);
        }

        /// <summary>
        /// Returns true if InlineObject8 instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineObject8 to be compared</param>
        /// <returns>Boolean</returns>
