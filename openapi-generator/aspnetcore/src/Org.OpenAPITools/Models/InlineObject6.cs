...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class InlineObject6 : IEquatable<InlineObject6>
    { 
        /// <summary>
        /// Driver ID to query.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((InlineObject6)obj);
        }

        /// <summary>
        /// Returns true if InlineObject6 instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineObject6 to be compared</param>
        /// <returns>Boolean</returns>
