...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class AddressesAddresses : IEquatable<AddressesAddresses>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((AddressesAddresses)obj);
        }

        /// <summary>
        /// Returns true if AddressesAddresses instances are equal
        /// </summary>
        /// <param name="other">Instance of AddressesAddresses to be compared</param>
        /// <returns>Boolean</returns>
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (Geofence != null)
                    hashCode = hashCode * 59 + Geofence.GetHashCode();
                    if (TagIds != null)
