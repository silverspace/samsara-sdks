...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class DvirBaseAuthorSignature : IEquatable<DvirBaseAuthorSignature>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((DvirBaseAuthorSignature)obj);
        }

        /// <summary>
        /// Returns true if DvirBaseAuthorSignature instances are equal
        /// </summary>
        /// <param name="other">Instance of DvirBaseAuthorSignature to be compared</param>
        /// <returns>Boolean</returns>
