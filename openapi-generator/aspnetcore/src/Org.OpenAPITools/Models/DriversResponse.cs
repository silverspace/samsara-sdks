...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class DriversResponse : IEquatable<DriversResponse>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((DriversResponse)obj);
        }

        /// <summary>
        /// Returns true if DriversResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of DriversResponse to be compared</param>
        /// <returns>Boolean</returns>
