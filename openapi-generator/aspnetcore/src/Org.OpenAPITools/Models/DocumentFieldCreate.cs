...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class DocumentFieldCreate : IEquatable<DocumentFieldCreate>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((DocumentFieldCreate)obj);
        }

        /// <summary>
        /// Returns true if DocumentFieldCreate instances are equal
        /// </summary>
        /// <param name="other">Instance of DocumentFieldCreate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DocumentFieldCreate other)
        {
            ...
            return 
                ...
                (
                    PhotoValue == other.PhotoValue ||
                    PhotoValue != null &&
                    PhotoValue.SequenceEqual(other.PhotoValue)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (PhotoValue != null)
                    hashCode = hashCode * 59 + PhotoValue.GetHashCode();
                    if (StringValue != null)
