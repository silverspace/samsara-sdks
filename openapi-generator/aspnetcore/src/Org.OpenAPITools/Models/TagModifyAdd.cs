...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class TagModifyAdd : IEquatable<TagModifyAdd>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((TagModifyAdd)obj);
        }

        /// <summary>
        /// Returns true if TagModifyAdd instances are equal
        /// </summary>
        /// <param name="other">Instance of TagModifyAdd to be compared</param>
        /// <returns>Boolean</returns>
