...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class AssetReeferResponseReeferStats : IEquatable<AssetReeferResponseReeferStats>
    { 
        /// <summary>
        /// Fuel percentage of the reefer
        /// </summary>
        /// <value>Fuel percentage of the reefer</value>
        [DataMember(Name="fuelPercentage")]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((AssetReeferResponseReeferStats)obj);
        }

        /// <summary>
        /// Returns true if AssetReeferResponseReeferStats instances are equal
        /// </summary>
        /// <param name="other">Instance of AssetReeferResponseReeferStats to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AssetReeferResponseReeferStats other)
        {
            ...
            return 
                (
                    FuelPercentage == other.FuelPercentage ||
                    FuelPercentage != null &&
                    FuelPercentage.SequenceEqual(other.FuelPercentage)
                ) && 
                (
                    PowerStatus == other.PowerStatus ||
                    PowerStatus != null &&
                    PowerStatus.SequenceEqual(other.PowerStatus)
                ) && 
                (
                    EngineHours == other.EngineHours ||
                    EngineHours != null &&
                    EngineHours.SequenceEqual(other.EngineHours)
                ) && 
                (
                    SetPoint == other.SetPoint ||
                    SetPoint != null &&
                    SetPoint.SequenceEqual(other.SetPoint)
                ) && 
                (
                    ReturnAirTemp == other.ReturnAirTemp ||
                    ReturnAirTemp != null &&
                    ReturnAirTemp.SequenceEqual(other.ReturnAirTemp)
                ) && 
                (
                    Alarms == other.Alarms ||
                    Alarms != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + FuelPercentage.GetHashCode();
                    if (PowerStatus != null)
                    hashCode = hashCode * 59 + PowerStatus.GetHashCode();
                    if (EngineHours != null)
                    hashCode = hashCode * 59 + EngineHours.GetHashCode();
                    if (SetPoint != null)
                    hashCode = hashCode * 59 + SetPoint.GetHashCode();
                    if (ReturnAirTemp != null)
                    hashCode = hashCode * 59 + ReturnAirTemp.GetHashCode();
                    if (Alarms != null)
                    hashCode = hashCode * 59 + Alarms.GetHashCode();
                return hashCode;
            }
        }
