...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class InlineObject7 : IEquatable<InlineObject7>
    { 
        /// <summary>
        /// Driver ID to query.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((InlineObject7)obj);
        }

        /// <summary>
        /// Returns true if InlineObject7 instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineObject7 to be compared</param>
        /// <returns>Boolean</returns>
