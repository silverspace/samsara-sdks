...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class EngineState : IEquatable<EngineState>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((EngineState)obj);
        }

        /// <summary>
        /// Returns true if EngineState instances are equal
        /// </summary>
        /// <param name="other">Instance of EngineState to be compared</param>
        /// <returns>Boolean</returns>
