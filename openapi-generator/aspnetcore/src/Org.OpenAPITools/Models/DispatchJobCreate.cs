...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class DispatchJobCreate : IEquatable<DispatchJobCreate>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((DispatchJobCreate)obj);
        }

        /// <summary>
        /// Returns true if DispatchJobCreate instances are equal
        /// </summary>
        /// <param name="other">Instance of DispatchJobCreate to be compared</param>
        /// <returns>Boolean</returns>
