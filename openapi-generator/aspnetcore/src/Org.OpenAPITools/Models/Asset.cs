...
{ 
    ...
    { 
        ...
        [DataMember(Name="assetSerialNumber")]
        ...
        public bool Equals(Asset other)
        {
            ...
            return 
                (
                    AssetSerialNumber == other.AssetSerialNumber ||
                    AssetSerialNumber != null &&
                    AssetSerialNumber.Equals(other.AssetSerialNumber)
                ) && 
                (
                    Cable == other.Cable ||
                    Cable != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + AssetSerialNumber.GetHashCode();
                    if (Cable != null)
