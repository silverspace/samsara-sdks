        ...
        public bool Equals(Pagination other)
        {
            ...
            return 
                ...
                (
                    ...
                    HasPrevPage != null &&
                    HasPrevPage.Equals(other.HasPrevPage)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    if (EndCursor != null)
                    hashCode = hashCode * 59 + EndCursor.GetHashCode();
                    if (HasNextPage != null)
                    hashCode = hashCode * 59 + HasNextPage.GetHashCode();
                    if (HasPrevPage != null)
                    hashCode = hashCode * 59 + HasPrevPage.GetHashCode();
                    if (StartCursor != null)
                    hashCode = hashCode * 59 + StartCursor.GetHashCode();
                return hashCode;
            }
        }
