...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class InlineObject12 : IEquatable<InlineObject12>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((InlineObject12)obj);
        }

        /// <summary>
        /// Returns true if InlineObject12 instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineObject12 to be compared</param>
        /// <returns>Boolean</returns>
