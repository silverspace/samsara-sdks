...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class CargoResponseSensors : IEquatable<CargoResponseSensors>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((CargoResponseSensors)obj);
        }

        /// <summary>
        /// Returns true if CargoResponseSensors instances are equal
        /// </summary>
        /// <param name="other">Instance of CargoResponseSensors to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CargoResponseSensors other)
        {
            ...
            return 
                (
                    CargoEmpty == other.CargoEmpty ||
                    CargoEmpty != null &&
                    CargoEmpty.Equals(other.CargoEmpty)
                ) && 
                (
                    Name == other.Name ||
                    Name != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    if (CargoEmpty != null)
                    hashCode = hashCode * 59 + CargoEmpty.GetHashCode();
                    if (Name != null)
