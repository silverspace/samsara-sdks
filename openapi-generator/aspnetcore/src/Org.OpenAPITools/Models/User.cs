...
{ 
    ...
    { 
        ...
        [DataMember(Name="organizationRoleId")]
        ...
        [DataMember(Name="organizationRole")]
        ...
        public bool Equals(User other)
        {
            ...
            return 
                ...
                (
                    ...
                    OrganizationRoleId.Equals(other.OrganizationRoleId)
                ) && 
                (
                    Id == other.Id ||
                    Id != null &&
                ...
                (
                    ...
                    OrganizationRole.Equals(other.OrganizationRole)
                ) && 
                (
                    TagRoles == other.TagRoles ||
                    TagRoles != null &&
                    TagRoles.SequenceEqual(other.TagRoles)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + OrganizationRoleId.GetHashCode();
                    if (Id != null)
                    hashCode = hashCode * 59 + Id.GetHashCode();
                    if (OrganizationRole != null)
                    hashCode = hashCode * 59 + OrganizationRole.GetHashCode();
                    if (TagRoles != null)
                    hashCode = hashCode * 59 + TagRoles.GetHashCode();
                return hashCode;
            }
        }
