...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class TaggedDriver : IEquatable<TaggedDriver>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((TaggedDriver)obj);
        }

        /// <summary>
        /// Returns true if TaggedDriver instances are equal
        /// </summary>
        /// <param name="other">Instance of TaggedDriver to be compared</param>
        /// <returns>Boolean</returns>
