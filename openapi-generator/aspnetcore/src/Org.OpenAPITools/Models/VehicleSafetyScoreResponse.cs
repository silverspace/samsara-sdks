...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class VehicleSafetyScoreResponse : IEquatable<VehicleSafetyScoreResponse>
    { 
        /// <summary>
        /// Crash event count
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((VehicleSafetyScoreResponse)obj);
        }

        /// <summary>
        /// Returns true if VehicleSafetyScoreResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of VehicleSafetyScoreResponse to be compared</param>
        /// <returns>Boolean</returns>
