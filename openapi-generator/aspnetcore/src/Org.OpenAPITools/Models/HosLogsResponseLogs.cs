...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class HosLogsResponseLogs : IEquatable<HosLogsResponseLogs>
    { 
        /// <summary>
        /// Longitude at which the log was recorded.
        /// </summary>
        /// <value>Longitude at which the log was recorded.</value>
        [DataMember(Name="locLng")]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((HosLogsResponseLogs)obj);
        }

        /// <summary>
        /// Returns true if HosLogsResponseLogs instances are equal
        /// </summary>
        /// <param name="other">Instance of HosLogsResponseLogs to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HosLogsResponseLogs other)
        {
            ...
            return 
                (
                    LocLng == other.LocLng ||
                    LocLng != null &&
                    LocLng.Equals(other.LocLng)
                ) && 
                (
                    LogStartMs == other.LogStartMs ||
                    LogStartMs != null &&
                    LogStartMs.Equals(other.LogStartMs)
                ) && 
                (
                ...
                (
                    LocCity == other.LocCity ||
                    LocCity != null &&
                    LocCity.Equals(other.LocCity)
                ) && 
                (
                ...
                (
                    ...
                    LocState != null &&
                    LocState.Equals(other.LocState)
                ) && 
                (
                ...
                (
                    CodriverIds == other.CodriverIds ||
                    CodriverIds != null &&
                    CodriverIds.SequenceEqual(other.CodriverIds)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    if (LocLng != null)
                    hashCode = hashCode * 59 + LocLng.GetHashCode();
                    if (LogStartMs != null)
                    hashCode = hashCode * 59 + LogStartMs.GetHashCode();
                    if (DriverId != null)
                    hashCode = hashCode * 59 + DriverId.GetHashCode();
                    if (StatusType != null)
                    hashCode = hashCode * 59 + StatusType.GetHashCode();
                    if (LocCity != null)
                    hashCode = hashCode * 59 + LocCity.GetHashCode();
                    if (GroupId != null)
                    hashCode = hashCode * 59 + GroupId.GetHashCode();
                    if (LocName != null)
                    hashCode = hashCode * 59 + LocName.GetHashCode();
                    if (LocLat != null)
                    hashCode = hashCode * 59 + LocLat.GetHashCode();
                    if (Remark != null)
                    hashCode = hashCode * 59 + Remark.GetHashCode();
                    if (LocState != null)
                    hashCode = hashCode * 59 + LocState.GetHashCode();
                    if (VehicleId != null)
                    hashCode = hashCode * 59 + VehicleId.GetHashCode();
                    if (CodriverIds != null)
                    hashCode = hashCode * 59 + CodriverIds.GetHashCode();
                return hashCode;
            }
        }
