...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class DocumentFieldTypeNumberValueTypeMetadata : IEquatable<DocumentFieldTypeNumberValueTypeMetadata>
    { 
        /// <summary>
        ...
        [DataMember(Name="numDecimalPlaces")]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((DocumentFieldTypeNumberValueTypeMetadata)obj);
        }

        /// <summary>
        /// Returns true if DocumentFieldTypeNumberValueTypeMetadata instances are equal
        /// </summary>
        /// <param name="other">Instance of DocumentFieldTypeNumberValueTypeMetadata to be compared</param>
        /// <returns>Boolean</returns>
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + NumDecimalPlaces.GetHashCode();
                return hashCode;
            }
        }
