...
{ 
    ...
    { 
        ...
        [Required]
        [DataMember(Name="driverCreatedAtMs")]
        ...
        public bool Equals(Document other)
        {
            ...
            return 
                ...
                (
                    DriverCreatedAtMs == other.DriverCreatedAtMs ||
                    DriverCreatedAtMs != null &&
                    DriverCreatedAtMs.Equals(other.DriverCreatedAtMs)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + DriverCreatedAtMs.GetHashCode();
                    if (DriverId != null)
