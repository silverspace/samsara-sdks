...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class DispatchRouteHistory : IEquatable<DispatchRouteHistory>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((DispatchRouteHistory)obj);
        }

        /// <summary>
        /// Returns true if DispatchRouteHistory instances are equal
        /// </summary>
        /// <param name="other">Instance of DispatchRouteHistory to be compared</param>
        /// <returns>Boolean</returns>
