...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class DriversSummaryResponse : IEquatable<DriversSummaryResponse>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((DriversSummaryResponse)obj);
        }

        /// <summary>
        /// Returns true if DriversSummaryResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of DriversSummaryResponse to be compared</param>
        /// <returns>Boolean</returns>
