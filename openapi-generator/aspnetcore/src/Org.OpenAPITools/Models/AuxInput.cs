...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class AuxInput : IEquatable<AuxInput>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((AuxInput)obj);
        }

        /// <summary>
        /// Returns true if AuxInput instances are equal
        /// </summary>
        /// <param name="other">Instance of AuxInput to be compared</param>
        /// <returns>Boolean</returns>
