...
{ 
    ...
    { 
        ...
        [DataMember(Name="fuelLevelPercent")]
        ...
        [DataMember(Name="odometerMeters")]
        ...
        public bool Equals(Vehicle other)
        {
            ...
            return 
                ...
                (
                    ...
                    FuelLevelPercent.Equals(other.FuelLevelPercent)
                ) && 
                (
                    Id == other.Id ||
                    Id != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + FuelLevelPercent.GetHashCode();
                    if (Id != null)
                    ...
                    hashCode = hashCode * 59 + OdometerMeters.GetHashCode();
                    if (Vin != null)
