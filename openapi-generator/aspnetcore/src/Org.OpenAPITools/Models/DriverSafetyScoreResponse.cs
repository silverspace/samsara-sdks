...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class DriverSafetyScoreResponse : IEquatable<DriverSafetyScoreResponse>
    { 
        /// <summary>
        /// Crash event count
        /// </summary>
        /// <value>Crash event count</value>
        [DataMember(Name="crashCount")]
        ...
        [DataMember(Name="harshAccelCount")]
        ...
        [DataMember(Name="harshBrakingCount")]
        public int? HarshBrakingCount { get; set; }

        /// <summary>
        /// Gets or Sets HarshEvents
        /// </summary>
        [DataMember(Name="harshEvents")]
        ...
        [DataMember(Name="harshTurningCount")]
        ...
        [DataMember(Name="safetyScoreRank")]
        ...
        [DataMember(Name="timeOverSpeedLimitMs")]
        ...
        [DataMember(Name="totalDistanceDrivenMeters")]
        ...
        [DataMember(Name="totalHarshEventCount")]
        ...
        [DataMember(Name="totalTimeDrivenMs")]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((DriverSafetyScoreResponse)obj);
        }

        /// <summary>
        /// Returns true if DriverSafetyScoreResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of DriverSafetyScoreResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DriverSafetyScoreResponse other)
        {
            ...
            return 
                (
                    ...
                    CrashCount != null &&
                    CrashCount.Equals(other.CrashCount)
                ) && 
                (
                ...
                (
                    HarshAccelCount == other.HarshAccelCount ||
                    HarshAccelCount != null &&
                    HarshAccelCount.Equals(other.HarshAccelCount)
                ) && 
                (
                    HarshBrakingCount == other.HarshBrakingCount ||
                    HarshBrakingCount != null &&
                    HarshBrakingCount.Equals(other.HarshBrakingCount)
                ) && 
                (
                    HarshEvents == other.HarshEvents ||
                    HarshEvents != null &&
                    HarshEvents.SequenceEqual(other.HarshEvents)
                ) && 
                (
                    HarshTurningCount == other.HarshTurningCount ||
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    if (CrashCount != null)
                    hashCode = hashCode * 59 + CrashCount.GetHashCode();
                    if (DriverId != null)
                    hashCode = hashCode * 59 + DriverId.GetHashCode();
                    if (HarshAccelCount != null)
                    hashCode = hashCode * 59 + HarshAccelCount.GetHashCode();
                    if (HarshBrakingCount != null)
                    hashCode = hashCode * 59 + HarshBrakingCount.GetHashCode();
                    if (HarshEvents != null)
                    hashCode = hashCode * 59 + HarshEvents.GetHashCode();
                    if (HarshTurningCount != null)
                    hashCode = hashCode * 59 + HarshTurningCount.GetHashCode();
                    if (SafetyScore != null)
                    hashCode = hashCode * 59 + SafetyScore.GetHashCode();
                    if (SafetyScoreRank != null)
                    hashCode = hashCode * 59 + SafetyScoreRank.GetHashCode();
                    if (TimeOverSpeedLimitMs != null)
                    hashCode = hashCode * 59 + TimeOverSpeedLimitMs.GetHashCode();
                    if (TotalDistanceDrivenMeters != null)
                    hashCode = hashCode * 59 + TotalDistanceDrivenMeters.GetHashCode();
                    if (TotalHarshEventCount != null)
                    hashCode = hashCode * 59 + TotalHarshEventCount.GetHashCode();
                    if (TotalTimeDrivenMs != null)
                    hashCode = hashCode * 59 + TotalTimeDrivenMs.GetHashCode();
                return hashCode;
            }
        }
