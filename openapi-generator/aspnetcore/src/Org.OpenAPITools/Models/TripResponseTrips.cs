...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class TripResponseTrips : IEquatable<TripResponseTrips>
    { 
        /// <summary>
        /// Odometer reading at the end of the trip.
        /// </summary>
        /// <value>Odometer reading at the end of the trip.</value>
        [DataMember(Name="endOdometer")]
        ...
        [DataMember(Name="fuelConsumedMl")]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((TripResponseTrips)obj);
        }

        /// <summary>
        /// Returns true if TripResponseTrips instances are equal
        /// </summary>
        /// <param name="other">Instance of TripResponseTrips to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TripResponseTrips other)
        {
            ...
            return 
                ...
                (
                    FuelConsumedMl == other.FuelConsumedMl ||
                    FuelConsumedMl != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    if (EndOdometer != null)
                    hashCode = hashCode * 59 + EndOdometer.GetHashCode();
                    if (DistanceMeters != null)
                    hashCode = hashCode * 59 + DistanceMeters.GetHashCode();
                    if (EndMs != null)
                    hashCode = hashCode * 59 + EndMs.GetHashCode();
                    if (StartMs != null)
                    hashCode = hashCode * 59 + StartMs.GetHashCode();
                    if (FuelConsumedMl != null)
                    hashCode = hashCode * 59 + FuelConsumedMl.GetHashCode();
                    if (StartAddress != null)
                    hashCode = hashCode * 59 + StartAddress.GetHashCode();
                    if (StartCoordinates != null)
                    hashCode = hashCode * 59 + StartCoordinates.GetHashCode();
                    if (EndCoordinates != null)
                    hashCode = hashCode * 59 + EndCoordinates.GetHashCode();
                    if (StartOdometer != null)
                    hashCode = hashCode * 59 + StartOdometer.GetHashCode();
                    if (DriverId != null)
                    hashCode = hashCode * 59 + DriverId.GetHashCode();
                    if (StartLocation != null)
                    hashCode = hashCode * 59 + StartLocation.GetHashCode();
                    if (TollMeters != null)
                    hashCode = hashCode * 59 + TollMeters.GetHashCode();
                    if (EndAddress != null)
