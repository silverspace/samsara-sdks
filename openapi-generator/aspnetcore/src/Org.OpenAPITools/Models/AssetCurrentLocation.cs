...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class AssetCurrentLocation : IEquatable<AssetCurrentLocation>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((AssetCurrentLocation)obj);
        }

        /// <summary>
        /// Returns true if AssetCurrentLocation instances are equal
        /// </summary>
        /// <param name="other">Instance of AssetCurrentLocation to be compared</param>
        /// <returns>Boolean</returns>
