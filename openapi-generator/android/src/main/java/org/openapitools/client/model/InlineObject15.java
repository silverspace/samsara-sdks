...
public class InlineObject15 {
   ...
   **/
  @ApiModelProperty(required = true, value = "Beginning of the time range, specified in milliseconds UNIX time. Limited to a 90 day window with respect to startMs and endMs")
   ...
   * Vehicle ID to query.
   **/
  @ApiModelProperty(required = true, value = "Vehicle ID to query.")
  ...
  public boolean equals(Object o) {
    ...
    return (this.endMs == null ? inlineObject15.endMs == null : this.endMs.equals(inlineObject15.endMs)) &&
        (this.groupId == null ? inlineObject15.groupId == null : this.groupId.equals(inlineObject15.groupId)) &&
        (this.startMs == null ? inlineObject15.startMs == null : this.startMs.equals(inlineObject15.startMs)) &&
        (this.vehicleId == null ? inlineObject15.vehicleId == null : this.vehicleId.equals(inlineObject15.vehicleId));
  }
