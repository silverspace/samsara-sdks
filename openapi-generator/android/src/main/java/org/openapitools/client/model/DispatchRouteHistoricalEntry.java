...
public class DispatchRouteHistoricalEntry {
   ...
   **/
  @ApiModelProperty(value = "Timestamp that the route was updated, represented as Unix milliseconds since epoch.")
  ...
  public boolean equals(Object o) {
    ...
    return (this.changedAtMs == null ? dispatchRouteHistoricalEntry.changedAtMs == null : this.changedAtMs.equals(dispatchRouteHistoricalEntry.changedAtMs)) &&
        (this.route == null ? dispatchRouteHistoricalEntry.route == null : this.route.equals(dispatchRouteHistoricalEntry.route));
  }
