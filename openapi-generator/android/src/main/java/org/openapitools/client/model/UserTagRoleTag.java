...
public class UserTagRoleTag {
  ...
  public boolean equals(Object o) {
    ...
    return (this.parentTagId == null ? userTagRoleTag.parentTagId == null : this.parentTagId.equals(userTagRoleTag.parentTagId)) &&
        (this.name == null ? userTagRoleTag.name == null : this.name.equals(userTagRoleTag.name)) &&
        (this.id == null ? userTagRoleTag.id == null : this.id.equals(userTagRoleTag.id));
  }
