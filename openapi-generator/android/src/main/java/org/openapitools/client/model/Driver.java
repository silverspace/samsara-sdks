...
public class Driver {
   ...
   * ID of the driver.
   **/
  @ApiModelProperty(required = true, value = "ID of the driver.")
  public Long getId() {
    return id;
  }
  ...
  public boolean equals(Object o) {
    ...
    return (this.eldAdverseWeatherExemptionEnabled == null ? driver.eldAdverseWeatherExemptionEnabled == null : this.eldAdverseWeatherExemptionEnabled.equals(driver.eldAdverseWeatherExemptionEnabled)) &&
        ...
        (this.id == null ? driver.id == null : this.id.equals(driver.id)) &&
        (this.isDeactivated == null ? driver.isDeactivated == null : this.isDeactivated.equals(driver.isDeactivated)) &&
        (this.tags == null ? driver.tags == null : this.tags.equals(driver.tags));
  }
  ...
  public int hashCode() {
    ...
    result = 31 * result + (this.isDeactivated == null ? 0: this.isDeactivated.hashCode());
