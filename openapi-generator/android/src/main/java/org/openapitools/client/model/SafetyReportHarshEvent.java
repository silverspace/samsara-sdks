...
public class SafetyReportHarshEvent {
   ...
   **/
  @ApiModelProperty(value = "Type of the harsh event")
   ...
   **/
  @ApiModelProperty(value = "Timestamp that the harsh event occurred in Unix milliseconds since epoch")
   ...
   **/
  @ApiModelProperty(value = "Vehicle associated with the harsh event")
  ...
  public boolean equals(Object o) {
    ...
    return (this.harshEventType == null ? safetyReportHarshEvent.harshEventType == null : this.harshEventType.equals(safetyReportHarshEvent.harshEventType)) &&
        (this.timestampMs == null ? safetyReportHarshEvent.timestampMs == null : this.timestampMs.equals(safetyReportHarshEvent.timestampMs)) &&
        (this.vehicleId == null ? safetyReportHarshEvent.vehicleId == null : this.vehicleId.equals(safetyReportHarshEvent.vehicleId));
  }
