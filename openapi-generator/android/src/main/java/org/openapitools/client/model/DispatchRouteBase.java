...
public class DispatchRouteBase {
  ...
  public boolean equals(Object o) {
    ...
    return (this.actualEndMs == null ? dispatchRouteBase.actualEndMs == null : this.actualEndMs.equals(dispatchRouteBase.actualEndMs)) &&
        (this.actualStartMs == null ? dispatchRouteBase.actualStartMs == null : this.actualStartMs.equals(dispatchRouteBase.actualStartMs)) &&
        (this.driverId == null ? dispatchRouteBase.driverId == null : this.driverId.equals(dispatchRouteBase.driverId)) &&
        (this.groupId == null ? dispatchRouteBase.groupId == null : this.groupId.equals(dispatchRouteBase.groupId)) &&
        (this.name == null ? dispatchRouteBase.name == null : this.name.equals(dispatchRouteBase.name)) &&
        (this.scheduledEndMs == null ? dispatchRouteBase.scheduledEndMs == null : this.scheduledEndMs.equals(dispatchRouteBase.scheduledEndMs)) &&
        (this.scheduledMeters == null ? dispatchRouteBase.scheduledMeters == null : this.scheduledMeters.equals(dispatchRouteBase.scheduledMeters)) &&
        (this.scheduledStartMs == null ? dispatchRouteBase.scheduledStartMs == null : this.scheduledStartMs.equals(dispatchRouteBase.scheduledStartMs)) &&
        (this.startLocationAddress == null ? dispatchRouteBase.startLocationAddress == null : this.startLocationAddress.equals(dispatchRouteBase.startLocationAddress)) &&
        (this.startLocationAddressId == null ? dispatchRouteBase.startLocationAddressId == null : this.startLocationAddressId.equals(dispatchRouteBase.startLocationAddressId)) &&
        (this.startLocationLat == null ? dispatchRouteBase.startLocationLat == null : this.startLocationLat.equals(dispatchRouteBase.startLocationLat)) &&
        (this.startLocationLng == null ? dispatchRouteBase.startLocationLng == null : this.startLocationLng.equals(dispatchRouteBase.startLocationLng)) &&
        (this.startLocationName == null ? dispatchRouteBase.startLocationName == null : this.startLocationName.equals(dispatchRouteBase.startLocationName)) &&
        (this.trailerId == null ? dispatchRouteBase.trailerId == null : this.trailerId.equals(dispatchRouteBase.trailerId)) &&
        (this.vehicleId == null ? dispatchRouteBase.vehicleId == null : this.vehicleId.equals(dispatchRouteBase.vehicleId));
  }
