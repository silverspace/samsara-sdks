...
public class MachineHistoryResponseMachines {
  ...
  public boolean equals(Object o) {
    ...
    return (this.name == null ? machineHistoryResponseMachines.name == null : this.name.equals(machineHistoryResponseMachines.name)) &&
        (this.id == null ? machineHistoryResponseMachines.id == null : this.id.equals(machineHistoryResponseMachines.id)) &&
