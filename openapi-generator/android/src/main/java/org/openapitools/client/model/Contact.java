...
public class Contact {
  ...
  public boolean equals(Object o) {
    ...
    return (this.email == null ? contact.email == null : this.email.equals(contact.email)) &&
        (this.firstName == null ? contact.firstName == null : this.firstName.equals(contact.firstName)) &&
        (this.id == null ? contact.id == null : this.id.equals(contact.id)) &&
        (this.lastName == null ? contact.lastName == null : this.lastName.equals(contact.lastName)) &&
        (this.phone == null ? contact.phone == null : this.phone.equals(contact.phone));
  }
