...
public class SensorsApi {
  ...
  */
  public InlineResponse2008 getSensors (String accessToken, InlineObject23 groupParam) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
  ...
  */
  public void getSensors (String accessToken, InlineObject23 groupParam, final Response.Listener<InlineResponse2008> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = groupParam;
  ...
  */
  public CargoResponse getSensorsCargo (String accessToken, InlineObject19 sensorParam) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
   ...
   * /sensors/cargo
   * Get cargo monitor status (empty / full) for requested sensors.
   * @param accessToken Samsara API access token.   * @param sensorParam 
  */
  public void getSensorsCargo (String accessToken, InlineObject19 sensorParam, final Response.Listener<CargoResponse> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = sensorParam;
  ...
  * Get door monitor status (closed / open) for requested sensors.
   ...
   * @return DoorResponse
  */
  public DoorResponse getSensorsDoor (String accessToken, InlineObject20 sensorParam) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = sensorParam;
    // verify the required parameter 'accessToken' is set
    if (accessToken == null) {
   ...
   * @param accessToken Samsara API access token.   * @param sensorParam 
  */
  public void getSensorsDoor (String accessToken, InlineObject20 sensorParam, final Response.Listener<DoorResponse> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = sensorParam;
  ...
  */
  public SensorHistoryResponse getSensorsHistory (String accessToken, InlineObject21 historyParam) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
  ...
  */
  public void getSensorsHistory (String accessToken, InlineObject21 historyParam, final Response.Listener<SensorHistoryResponse> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = historyParam;
  ...
  */
  public HumidityResponse getSensorsHumidity (String accessToken, InlineObject22 sensorParam) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = sensorParam;
    // verify the required parameter 'accessToken' is set
    if (accessToken == null) {
   ...
   * @param accessToken Samsara API access token.   * @param sensorParam 
  */
  public void getSensorsHumidity (String accessToken, InlineObject22 sensorParam, final Response.Listener<HumidityResponse> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = sensorParam;
  ...
  */
  public TemperatureResponse getSensorsTemperature (String accessToken, InlineObject24 sensorParam) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = sensorParam;
    // verify the required parameter 'accessToken' is set
    if (accessToken == null) {
   ...
   * @param accessToken Samsara API access token.   * @param sensorParam 
  */
  public void getSensorsTemperature (String accessToken, InlineObject24 sensorParam, final Response.Listener<TemperatureResponse> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = sensorParam;
