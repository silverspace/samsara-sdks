...
public class AuxInput {
   ...
   **/
  @ApiModelProperty(required = true, value = "Boolean representing the digital value of the aux input.")
  ...
  public boolean equals(Object o) {
    ...
    return (this.timeMs == null ? auxInput.timeMs == null : this.timeMs.equals(auxInput.timeMs)) &&
        (this.value == null ? auxInput.value == null : this.value.equals(auxInput.value));
  }
