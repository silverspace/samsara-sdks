...
public class InlineResponse2005VehicleStats {
  public static final String SERIALIZED_NAME_ENGINE_STATE = "engineState";
  @SerializedName(SERIALIZED_NAME_ENGINE_STATE)
  private List<EngineState> engineState = new ArrayList<EngineState>();

  public static final String SERIALIZED_NAME_AUX_INPUT2 = "auxInput2";
  @SerializedName(SERIALIZED_NAME_AUX_INPUT2)
  ...
  public static final String SERIALIZED_NAME_AUX_INPUT1 = "auxInput1";
  @SerializedName(SERIALIZED_NAME_AUX_INPUT1)
