...
public class VehicleMaintenanceJ1939DiagnosticTroubleCodes {
  public static final String SERIALIZED_NAME_SPN_DESCRIPTION = "spnDescription";
  @SerializedName(SERIALIZED_NAME_SPN_DESCRIPTION)
  private String spnDescription;

  public static final String SERIALIZED_NAME_FMI_TEXT = "fmiText";
  @SerializedName(SERIALIZED_NAME_FMI_TEXT)
  private String fmiText;

  public static final String SERIALIZED_NAME_SPN_ID = "spnId";
  @SerializedName(SERIALIZED_NAME_SPN_ID)
  ...
  public static final String SERIALIZED_NAME_FMI_ID = "fmiId";
  @SerializedName(SERIALIZED_NAME_FMI_ID)
