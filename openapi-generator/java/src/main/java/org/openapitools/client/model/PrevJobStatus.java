 ...
 */
@JsonAdapter(PrevJobStatus.Adapter.class)
public enum PrevJobStatus {
  ...
  public static class Adapter extends TypeAdapter<PrevJobStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final PrevJobStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public PrevJobStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return PrevJobStatus.fromValue(String.valueOf(value));
    }
  }
}
