...
public class VehicleMaintenancePassengerDiagnosticTroubleCodes {
  public static final String SERIALIZED_NAME_DTC_SHORT_CODE = "dtcShortCode";
  @SerializedName(SERIALIZED_NAME_DTC_SHORT_CODE)
  private String dtcShortCode;

  public static final String SERIALIZED_NAME_DTC_ID = "dtcId";
  @SerializedName(SERIALIZED_NAME_DTC_ID)
  private Integer dtcId;

  public static final String SERIALIZED_NAME_DTC_DESCRIPTION = "dtcDescription";
  @SerializedName(SERIALIZED_NAME_DTC_DESCRIPTION)
