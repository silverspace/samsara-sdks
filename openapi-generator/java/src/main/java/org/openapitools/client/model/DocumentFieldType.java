...
public class DocumentFieldType {
  ...
  public static final String SERIALIZED_NAME_NUMBER_VALUE_TYPE_METADATA = "numberValueTypeMetadata";
  @SerializedName(SERIALIZED_NAME_NUMBER_VALUE_TYPE_METADATA)
