...
public class AssetReeferResponseReeferStatsReturnAirTemp {
  public static final String SERIALIZED_NAME_TEMP_IN_MILLI_C = "tempInMilliC";
  @SerializedName(SERIALIZED_NAME_TEMP_IN_MILLI_C)
  private Long tempInMilliC;

  public static final String SERIALIZED_NAME_CHANGED_AT_MS = "changedAtMs";
