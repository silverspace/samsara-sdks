...
public class JobUpdateObject {
  public static final String SERIALIZED_NAME_CHANGED_AT_MS = "changed_at_ms";
  @SerializedName(SERIALIZED_NAME_CHANGED_AT_MS)
  ...
  public static final String SERIALIZED_NAME_PREV_JOB_STATE = "prev_job_state";
  @SerializedName(SERIALIZED_NAME_PREV_JOB_STATE)
