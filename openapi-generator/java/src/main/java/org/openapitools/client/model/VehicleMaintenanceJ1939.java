...
public class VehicleMaintenanceJ1939 {
  public static final String SERIALIZED_NAME_CHECK_ENGINE_LIGHT = "checkEngineLight";
  @SerializedName(SERIALIZED_NAME_CHECK_ENGINE_LIGHT)
  private VehicleMaintenanceJ1939CheckEngineLight checkEngineLight = null;

  public static final String SERIALIZED_NAME_DIAGNOSTIC_TROUBLE_CODES = "diagnosticTroubleCodes";
  @SerializedName(SERIALIZED_NAME_DIAGNOSTIC_TROUBLE_CODES)
  ...
  **/
  ...
  public VehicleMaintenanceJ1939 addDiagnosticTroubleCodesItem(VehicleMaintenanceJ1939DiagnosticTroubleCodes diagnosticTroubleCodesItem) {
    if (this.diagnosticTroubleCodes == null) {
      this.diagnosticTroubleCodes = new ArrayList<VehicleMaintenanceJ1939DiagnosticTroubleCodes>();
    }
