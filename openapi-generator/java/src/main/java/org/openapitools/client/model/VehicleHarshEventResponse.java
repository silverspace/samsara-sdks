...
public class VehicleHarshEventResponse {
  public static final String SERIALIZED_NAME_DOWNLOAD_FORWARD_VIDEO_URL = "downloadForwardVideoUrl";
  @SerializedName(SERIALIZED_NAME_DOWNLOAD_FORWARD_VIDEO_URL)
  private String downloadForwardVideoUrl;

  public static final String SERIALIZED_NAME_DOWNLOAD_INWARD_VIDEO_URL = "downloadInwardVideoUrl";
  @SerializedName(SERIALIZED_NAME_DOWNLOAD_INWARD_VIDEO_URL)
  private String downloadInwardVideoUrl;

  public static final String SERIALIZED_NAME_DOWNLOAD_TRACKED_INWARD_VIDEO_URL = "downloadTrackedInwardVideoUrl";
  @SerializedName(SERIALIZED_NAME_DOWNLOAD_TRACKED_INWARD_VIDEO_URL)
  private String downloadTrackedInwardVideoUrl;

  public static final String SERIALIZED_NAME_HARSH_EVENT_TYPE = "harshEventType";
  @SerializedName(SERIALIZED_NAME_HARSH_EVENT_TYPE)
  private String harshEventType;

  public static final String SERIALIZED_NAME_INCIDENT_REPORT_URL = "incidentReportUrl";
  @SerializedName(SERIALIZED_NAME_INCIDENT_REPORT_URL)
  private String incidentReportUrl;

  public static final String SERIALIZED_NAME_IS_DISTRACTED = "isDistracted";
  @SerializedName(SERIALIZED_NAME_IS_DISTRACTED)
