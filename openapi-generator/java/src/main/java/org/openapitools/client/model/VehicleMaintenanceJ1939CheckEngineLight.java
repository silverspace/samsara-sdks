...
public class VehicleMaintenanceJ1939CheckEngineLight {
  public static final String SERIALIZED_NAME_PROTECT_IS_ON = "protectIsOn";
  @SerializedName(SERIALIZED_NAME_PROTECT_IS_ON)
  private Boolean protectIsOn;

  public static final String SERIALIZED_NAME_STOP_IS_ON = "stopIsOn";
  @SerializedName(SERIALIZED_NAME_STOP_IS_ON)
  private Boolean stopIsOn;

  public static final String SERIALIZED_NAME_WARNING_IS_ON = "warningIsOn";
  @SerializedName(SERIALIZED_NAME_WARNING_IS_ON)
  private Boolean warningIsOn;

  public static final String SERIALIZED_NAME_EMISSIONS_IS_ON = "emissionsIsOn";
  @SerializedName(SERIALIZED_NAME_EMISSIONS_IS_ON)
