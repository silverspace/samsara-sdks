...
import org.openapitools.server.models.UserRole

fun Route.UsersApi() {
    val gson = Gson()
    val empty = mutableMapOf<String, Any?>()

    delete<Paths.deleteUserById> {  it: Paths.deleteUserById ->
        call.respond(HttpStatusCode.NotImplemented)
    }
    

    get<Paths.getUserById> {  it: Paths.getUserById ->
    ...
    get<Paths.listUserRoles> {  it: Paths.listUserRoles ->
        val exampleContentType = "application/json"
    ...
    get<Paths.listUsers> {  it: Paths.listUsers ->
        val exampleContentType = "application/json"
        val exampleContentString = """null"""
