...
class User implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'tag_roles' => '\OpenAPI\Client\Model\UserTagRole[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['tag_roles'] = isset($data['tag_roles']) ? $data['tag_roles'] : null;
    }
     ...
     *
     * @param string|null $organization_role_id The id of the role the user is assigned to at the organization level. This will be blank for users that only have access to specific tags.
     *
     * @return $this
     */
     ...
     *
     * @param string|null $organization_role The name of the role the user is assigned to at the organization level. This will be blank for users that only have access to specific tags.
     *
     * @return $this
     */
     ...
     * Gets tag_roles
     *
     * @return \OpenAPI\Client\Model\UserTagRole[]|null
     */
    public function getTagRoles()
    {
        return $this->container['tag_roles'];
    }

    /**
     * Sets tag_roles
     *
     * @param \OpenAPI\Client\Model\UserTagRole[]|null $tag_roles The specific tags this user has access to. This will be blank for users that have full access to the organization.
     *
     * @return $this
     */
    public function setTagRoles($tag_roles)
    {
        $this->container['tag_roles'] = $tag_roles;
