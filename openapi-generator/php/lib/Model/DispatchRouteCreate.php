...
/**
 * DispatchRouteCreate Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class DispatchRouteCreate implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DispatchRouteCreate';
    ...
    protected static $openAPITypes = [
        ...
        'trailer_id' => 'int',
        'vehicle_id' => 'int',
        'dispatch_jobs' => '\OpenAPI\Client\Model\DispatchJobCreate[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['dispatch_jobs'] = isset($data['dispatch_jobs']) ? $data['dispatch_jobs'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['dispatch_jobs'] === null) {
            $invalidProperties[] = "'dispatch_jobs' can't be null";
        }
     ...
     * Sets actual_end_ms
     *
     * @param int|null $actual_end_ms The time in Unix epoch milliseconds that the route actually ended.
     *
     * @return $this
     */
     ...
     *
     * @param int|null $actual_start_ms The time in Unix epoch milliseconds that the route actually started.
     *
     * @return $this
     */
     ...
     * Sets driver_id
     *
     * @param int|null $driver_id ID of the driver assigned to the dispatch route. Note that driver_id and vehicle_id are mutually exclusive. If neither is specified, then the route is unassigned.
     *
     * @return $this
     */
     ...
     * Sets group_id
     *
     * @param int|null $group_id ID of the group if the organization has multiple groups (optional).
     *
     * @return $this
     */
     ...
     *
     * @param int|null $scheduled_meters The distance expected to be traveled for this route in meters.
     *
     * @return $this
     */
     ...
     *
     * @param string|null $start_location_address The address of the route's starting location, as it would be recognized if provided to maps.google.com. Optional if a valid start location address ID is provided.
     *
     * @return $this
     */
     ...
     *
     * @param int|null $start_location_address_id ID of the start location associated with an address book entry. Optional if valid values are provided for start location address or latitude/longitude. If a valid start location address ID is provided, address/latitude/longitude will be used from the address book entry. Name of the address book entry will only be used if the start location name is not provided.
     *
     * @return $this
     */
     ...
     *
     * @param double|null $start_location_lat Latitude of the start location in decimal degrees. Optional if a valid start location address ID is provided.
     *
     * @return $this
     */
     ...
     *
     * @param double|null $start_location_lng Longitude of the start location in decimal degrees. Optional if a valid start location address ID is provided.
     *
     * @return $this
     */
     ...
     *
     * @param string|null $start_location_name The name of the route's starting location. If provided, it will take precedence over the name of the address book entry.
     *
     * @return $this
     */
     ...
     * Sets trailer_id
     *
     * @param int|null $trailer_id ID of the trailer assigned to the dispatch route. Note that trailers can only be assigned to routes that have a Vehicle or Driver assigned to them.
     *
     * @return $this
     */
     ...
     * Sets vehicle_id
     *
     * @param int|null $vehicle_id ID of the vehicle assigned to the dispatch route. Note that vehicle_id and driver_id are mutually exclusive. If neither is specified, then the route is unassigned.
     *
     * @return $this
     */
     ...
     * Gets dispatch_jobs
     *
     * @return \OpenAPI\Client\Model\DispatchJobCreate[]
     */
    public function getDispatchJobs()
    {
        return $this->container['dispatch_jobs'];
    }

    /**
     * Sets dispatch_jobs
     *
     * @param \OpenAPI\Client\Model\DispatchJobCreate[] $dispatch_jobs The dispatch jobs to create for this route.
     *
     * @return $this
     */
    public function setDispatchJobs($dispatch_jobs)
    {
        $this->container['dispatch_jobs'] = $dispatch_jobs;
