...
/**
 * SafetyReportHarshEvent Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class SafetyReportHarshEvent implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SafetyReportHarshEvent';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['timestamp_ms'] = isset($data['timestamp_ms']) ? $data['timestamp_ms'] : null;
     ...
     *
     * @param string|null $harsh_event_type Type of the harsh event
     *
     * @return $this
     */
     ...
     * Sets timestamp_ms
     *
     * @param int|null $timestamp_ms Timestamp that the harsh event occurred in Unix milliseconds since epoch
     *
     * @return $this
     */
     ...
     * Sets vehicle_id
     *
     * @param int|null $vehicle_id Vehicle associated with the harsh event
     *
     * @return $this
     */
