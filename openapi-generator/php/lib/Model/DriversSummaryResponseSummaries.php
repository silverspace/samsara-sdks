...
class DriversSummaryResponseSummaries implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DriversSummaryResponse_Summaries';
     ...
     * Sets drive_ms
     *
     * @param int|null $drive_ms Duration in milliseconds that driver was driving during the requested time range
     *
     * @return $this
     */
     ...
     * Sets active_ms
     *
     * @param int|null $active_ms Duration in milliseconds that driver was on duty or driving during the requested time range
     *
     * @return $this
     */
     ...
     *
     * @param string|null $driver_username Username of the driver.
     *
     * @return $this
     */
     ...
     * Sets group_id
     *
     * @param int|null $group_id Group of the driver.
     *
     * @return $this
     */
     ...
     * Sets on_duty_ms
     *
     * @param int|null $on_duty_ms Duration in milliseconds that driver was on duty during the requested time range
     *
     * @return $this
     */
