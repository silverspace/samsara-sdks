...
class VehicleMaintenanceJ1939DiagnosticTroubleCodes implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VehicleMaintenance_j1939_diagnosticTroubleCodes';
     ...
     *
     * @param string|null $spn_description spn_description
     *
     * @return $this
     */
     ...
     * Sets fmi_text
     *
     * @param string|null $fmi_text fmi_text
     *
     * @return $this
     */
     ...
     *
     * @param int|null $occurrence_count occurrence_count
     *
     * @return $this
     */
