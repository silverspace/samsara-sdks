...
class VehicleLocation implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VehicleLocation';
     ...
     * Sets on_trip
     *
     * @param bool|null $on_trip Whether or not a trip is currently in progress for this vehicle. More information available via /fleet/trips endpoint.
     *
     * @return $this
     */
