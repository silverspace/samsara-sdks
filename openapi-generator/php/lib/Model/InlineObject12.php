...
class InlineObject12 implements ModelInterface, ArrayAccess
{
     ...
     * Sets mechanic_notes
     *
     * @param string|null $mechanic_notes Any notes from the mechanic.
     *
     * @return $this
     */
     ...
     * Sets odometer_miles
     *
     * @param int|null $odometer_miles The current odometer of the vehicle.
     *
     * @return $this
     */
     ...
     *
     * @param bool|null $previous_defects_corrected Whether any previous defects were corrected. If this vehicle or trailer was previously marked unsafe, and this DVIR marks it as safe, either previousDefectsCorrected or previousDefectsIgnored must be true.
     *
     * @return $this
     */
     ...
     *
     * @param bool|null $previous_defects_ignored Whether any previous defects were ignored. If this vehicle or trailer was previously marked unsafe, and this DVIR marks it as safe, either previousDefectsCorrected or previousDefectsIgnored must be true.
     *
     * @return $this
     */
     ...
     * Sets trailer_id
     *
     * @param int|null $trailer_id Id of trailer being inspected. Either vehicleId or trailerId must be provided.
     *
     * @return $this
     */
     ...
     * Sets vehicle_id
     *
     * @param int|null $vehicle_id Id of vehicle being inspected. Either vehicleId or trailerId must be provided.
     *
     * @return $this
     */
