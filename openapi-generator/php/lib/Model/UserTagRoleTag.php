...
/**
 * UserTagRoleTag Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class UserTagRoleTag implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserTagRole_tag';
     ...
     * Sets parent_tag_id
     *
     * @param int|null $parent_tag_id The ID of this tag.
     *
     * @return $this
     */
