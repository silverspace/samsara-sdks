...
------------ | ------------- | ------------- | -------------
**field_types** | [**\OpenAPI\Client\Model\array[]**](array.md) | The field types determine the names of fields for this document type. They also determine the types of values a document submitted for this document type can have. | [optional] 
