...
import DispatchRouteBase._

case class DispatchRouteBase (
...
object DispatchRouteBase {
  ...
  implicit val DispatchRouteBaseCodecJson: CodecJson[DispatchRouteBase] = CodecJson.derive[DispatchRouteBase]
  implicit val DispatchRouteBaseDecoder: EntityDecoder[DispatchRouteBase] = jsonOf[DispatchRouteBase]
  implicit val DispatchRouteBaseEncoder: EntityEncoder[DispatchRouteBase] = jsonEncoderOf[DispatchRouteBase]
}
