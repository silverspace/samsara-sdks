...
object DriverForCreate {
  ...
  implicit val DriverForCreateCodecJson: CodecJson[DriverForCreate] = CodecJson.derive[DriverForCreate]
  implicit val DriverForCreateDecoder: EntityDecoder[DriverForCreate] = jsonOf[DriverForCreate]
  implicit val DriverForCreateEncoder: EntityEncoder[DriverForCreate] = jsonEncoderOf[DriverForCreate]
}
