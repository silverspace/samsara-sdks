...
import DispatchRouteCreate._

case class DispatchRouteCreate (
...
object DispatchRouteCreate {
  import DateTimeCodecs._

  implicit val DispatchRouteCreateCodecJson: CodecJson[DispatchRouteCreate] = CodecJson.derive[DispatchRouteCreate]
  implicit val DispatchRouteCreateDecoder: EntityDecoder[DispatchRouteCreate] = jsonOf[DispatchRouteCreate]
  implicit val DispatchRouteCreateEncoder: EntityEncoder[DispatchRouteCreate] = jsonEncoderOf[DispatchRouteCreate]
}
