...
object Driver {
  ...
  implicit val DriverCodecJson: CodecJson[Driver] = CodecJson.derive[Driver]
  implicit val DriverDecoder: EntityDecoder[Driver] = jsonOf[Driver]
  implicit val DriverEncoder: EntityEncoder[Driver] = jsonEncoderOf[Driver]
}
