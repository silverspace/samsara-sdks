...
$Manifest = @{
    ...
    Description = 'Org.OpenAPITools - the PowerShell module for Samsara API'

    RootModule = 'Org.OpenAPITools.psm1'
    Guid = '{FFF2FED4-9A24-4F1D-92ED-3307125DD8FC}' # Has to be static, otherwise each new build will be considered different module
