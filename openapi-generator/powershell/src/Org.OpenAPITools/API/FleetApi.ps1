...
function Invoke-FleetApiCreateDispatchRoute {
    ...
    Param (
        ...
        ${accessToken},
        [Parameter(Position = 1, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $true)]
        [Org.OpenAPITools.Model.DispatchRouteCreate]
...
function Invoke-FleetApiCreateDriverDocument {
    ...
    Param (
        ...
        ${driverId},
        [Parameter(Position = 2, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $true)]
        [Org.OpenAPITools.Model.DocumentCreate]
...
function Invoke-FleetApiCreateDvir {
    ...
    Param (
        ...
        ${accessToken},
        [Parameter(Position = 1, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $true)]
        [Org.OpenAPITools.Model.InlineObject12]
        ${createDvirParam}
    )
...
function Invoke-FleetApiGetFleetLocations {
    ...
    Param (
        ...
        ${accessToken},
        [Parameter(Position = 1, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $true)]
        [Org.OpenAPITools.Model.InlineObject11]
        ${groupParam}
    )
...
function Invoke-FleetApiGetFleetMaintenanceList {
    ...
    Param (
        ...
        ${accessToken},
        [Parameter(Position = 1, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $true)]
        [Org.OpenAPITools.Model.InlineObject13]
        ${groupParam}
    )
...
function Invoke-FleetApiGetFleetTrips {
    ...
    Param (
        ...
        ${accessToken},
        [Parameter(Position = 1, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $true)]
        [Org.OpenAPITools.Model.InlineObject15]
        ${tripsParam}
    )
...
function Invoke-FleetApiPatchFleetVehicle {
    ...
    Param (
        ...
        ${vehicleIdOrExternalId},
        [Parameter(Position = 2, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $true)]
        [Org.OpenAPITools.Model.InlineObject16]
        ${data}
    )
...
function Invoke-FleetApiUpdateVehicles {
    ...
    Param (
        ...
        ${accessToken},
        [Parameter(Position = 1, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $true)]
        [Org.OpenAPITools.Model.InlineObject14]
        ${vehicleUpdateParam}
    )
