...
export namespace InlineObject21 {
    export type FillMissingEnum = 'withNull' | 'withPrevious';
    export const FillMissingEnum = {
        WithNull: 'withNull' as FillMissingEnum,
        WithPrevious: 'withPrevious' as FillMissingEnum
    };
}
