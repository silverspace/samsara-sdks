...
export class IndustrialService {
    ...
    public getAllDataInputs(accessToken: string, groupId?: number, startMs?: number, endMs?: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<InlineResponse2006>(`${this.configuration.basePath}/industrial/data`,
            {
    ...
    public getDataInput(accessToken: string, dataInputId: number, startMs?: number, endMs?: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<DataInputHistoryResponse>(`${this.configuration.basePath}/industrial/data/${encodeURIComponent(String(dataInputId))}`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getMachines(accessToken: string, groupParam: InlineObject18, observe?: 'body', reportProgress?: boolean): Observable<InlineResponse2007>;
    public getMachines(accessToken: string, groupParam: InlineObject18, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<InlineResponse2007>>;
    public getMachines(accessToken: string, groupParam: InlineObject18, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<InlineResponse2007>>;
    public getMachines(accessToken: string, groupParam: InlineObject18, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (accessToken === null || accessToken === undefined) {
        ...
        return this.httpClient.post<InlineResponse2007>(`${this.configuration.basePath}/machines/list`,
            groupParam,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getMachinesHistory(accessToken: string, historyParam: InlineObject17, observe?: 'body', reportProgress?: boolean): Observable<MachineHistoryResponse>;
    public getMachinesHistory(accessToken: string, historyParam: InlineObject17, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<MachineHistoryResponse>>;
    public getMachinesHistory(accessToken: string, historyParam: InlineObject17, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<MachineHistoryResponse>>;
    public getMachinesHistory(accessToken: string, historyParam: InlineObject17, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (accessToken === null || accessToken === undefined) {
        ...
        return this.httpClient.post<MachineHistoryResponse>(`${this.configuration.basePath}/machines/history`,
            historyParam,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
