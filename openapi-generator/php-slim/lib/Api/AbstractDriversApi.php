...
/**
 * AbstractDriversApi Class Doc Comment
 *
 * @package OpenAPIServer\Api
 * @author  OpenAPI Generator team
 * @link    https://github.com/openapitools/openapi-generator
 */
abstract class AbstractDriversApi
{
    ...
    public function createDriver(ServerRequestInterface $request, ResponseInterface $response, array $args)
    {
        ...
        $message = "How about implementing createDriver as a POST method in OpenAPIServer\Api\DriversApi class?";
    ...
    public function deactivateDriver(ServerRequestInterface $request, ResponseInterface $response, array $args)
    {
        ...
        $queryParams = $request->getQueryParams();
        $accessToken = $request->getQueryParam('access_token');
        $message = "How about implementing deactivateDriver as a DELETE method in OpenAPIServer\Api\DriversApi class?";
        throw new Exception($message);
    ...
    public function getAllDeactivatedDrivers(ServerRequestInterface $request, ResponseInterface $response, array $args)
    {
        ...
        $message = "How about implementing getAllDeactivatedDrivers as a GET method in OpenAPIServer\Api\DriversApi class?";
        throw new Exception($message);
    ...
    public function getDeactivatedDriverById(ServerRequestInterface $request, ResponseInterface $response, array $args)
    {
        ...
        $queryParams = $request->getQueryParams();
        $accessToken = $request->getQueryParam('access_token');
        $message = "How about implementing getDeactivatedDriverById as a GET method in OpenAPIServer\Api\DriversApi class?";
        throw new Exception($message);
    ...
    public function getDriverById(ServerRequestInterface $request, ResponseInterface $response, array $args)
    {
        ...
        $queryParams = $request->getQueryParams();
        $accessToken = $request->getQueryParam('access_token');
        $message = "How about implementing getDriverById as a GET method in OpenAPIServer\Api\DriversApi class?";
        throw new Exception($message);
    ...
    public function reactivateDriverById(ServerRequestInterface $request, ResponseInterface $response, array $args)
    {
        ...
        $accessToken = $request->getQueryParam('access_token');
        $body = $request->getParsedBody();
        $message = "How about implementing reactivateDriverById as a PUT method in OpenAPIServer\Api\DriversApi class?";
        throw new Exception($message);
