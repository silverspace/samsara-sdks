...
export namespace InlineObject12 {
    export type InspectionTypeEnum = 'mechanic';
    export const InspectionTypeEnum = {
        Mechanic: 'mechanic' as InspectionTypeEnum
    }
    export type SafeEnum = 'safe' | 'unsafe';
    export const SafeEnum = {
        Safe: 'safe' as SafeEnum,
        Unsafe: 'unsafe' as SafeEnum
    }
}
