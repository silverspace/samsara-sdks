...
feature --Access
    ...
    number_value_type_metadata: detachable DOCUMENT_FIELD_TYPE_NUMBER_VALUE_TYPE_METADATA 
...
feature -- Change Element  
    ...
    set_number_value_type_metadata (a_name: like number_value_type_metadata)
        -- Set 'number_value_type_metadata' with 'a_name'.
      do
        number_value_type_metadata := a_name
      ensure
        number_value_type_metadata_set: number_value_type_metadata = a_name		
      end
 ...
 feature -- Status Report
    ...
    out: STRING
      ...
      do
        ...
        Result.append("%Nclass DOCUMENT_FIELD_TYPE%N")
        if attached label as l_label then
          Result.append ("%Nlabel:")
          Result.append (l_label.out)
          Result.append ("%N")    
        end  
        if attached number_value_type_metadata as l_number_value_type_metadata then
          Result.append ("%Nnumber_value_type_metadata:")
          Result.append (l_number_value_type_metadata.out)
          Result.append ("%N")    
        end  
