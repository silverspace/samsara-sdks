...
feature --Access
    ...
    field_types: detachable LIST [LIST] 
...
feature -- Change Element  
    ...
    set_field_types (a_name: like field_types)
        -- Set 'field_types' with 'a_name'.
      do
        field_types := a_name
      ensure
        field_types_set: field_types = a_name		
      end
    ...
    set_org_id (a_name: like org_id)
        -- Set 'org_id' with 'a_name'.
      do
        org_id := a_name
      ensure
        org_id_set: org_id = a_name		
      end
 ...
 feature -- Status Report
    ...
    out: STRING
      ...
      do
        ...
        Result.append("%Nclass DOCUMENT_TYPE%N")
        if attached field_types as l_field_types then
          across l_field_types as ic loop
            Result.append ("%N field_types:")
        ...
        if attached org_id as l_org_id then
          Result.append ("%Norg_id:")
          Result.append (l_org_id.out)
          Result.append ("%N")    
        end  
