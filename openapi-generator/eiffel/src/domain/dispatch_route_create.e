...
feature --Access
    ...
    dispatch_jobs: detachable LIST [DISPATCH_JOB_CREATE] 
...
feature -- Change Element  
    ...
    set_dispatch_jobs (a_name: like dispatch_jobs)
        -- Set 'dispatch_jobs' with 'a_name'.
      do
        dispatch_jobs := a_name
      ensure
        dispatch_jobs_set: dispatch_jobs = a_name		
      end
 ...
 feature -- Status Report
    ...
    out: STRING
      ...
      do
        ...
        Result.append("%Nclass DISPATCH_ROUTE_CREATE%N")
        ...
        if attached dispatch_jobs as l_dispatch_jobs then
          across l_dispatch_jobs as ic loop
            Result.append ("%N dispatch_jobs:")
