...
feature -- Change Element  
    ...
    set_is_deactivated (a_name: like is_deactivated)
        -- Set 'is_deactivated' with 'a_name'.
      do
        is_deactivated := a_name
      ensure
        is_deactivated_set: is_deactivated = a_name		
      end
 ...
 feature -- Status Report
    ...
    out: STRING
      ...
      do
        ...
        if attached is_deactivated as l_is_deactivated then
          Result.append ("%Nis_deactivated:")
          Result.append (l_is_deactivated.out)
          Result.append ("%N")    
        end  
