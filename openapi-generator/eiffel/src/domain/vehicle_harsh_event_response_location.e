...
class VEHICLE_HARSH_EVENT_RESPONSE_LOCATION 
...
feature --Access
    ...
    latitude: detachable STRING_32 
      -- Latitude of location where the harsh event occurred
    longitude: detachable STRING_32 
 ...
 feature -- Status Report
    ...
    out: STRING
      ...
      do
        ...
        Result.append("%Nclass VEHICLE_HARSH_EVENT_RESPONSE_LOCATION%N")
