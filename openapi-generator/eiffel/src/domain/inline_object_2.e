...
feature -- Change Element  
    ...
    set_radius (a_name: like radius)
        -- Set 'radius' with 'a_name'.
      do
        radius := a_name
      ensure
        radius_set: radius = a_name		
      end
 ...
 feature -- Status Report
    ...
    out: STRING
      ...
      do
        ...
        if attached radius as l_radius then
          Result.append ("%Nradius:")
          Result.append (l_radius.out)
          Result.append ("%N")    
        end  
      end
end
