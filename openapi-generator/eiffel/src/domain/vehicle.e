...
feature --Access
    ...
    engine_hours: INTEGER_64 
      -- Total engine hours for the vehicle.
    fuel_level_percent: REAL_64 
...
feature -- Change Element  
    ...
    set_fuel_level_percent (a_name: like fuel_level_percent)
        -- Set 'fuel_level_percent' with 'a_name'.
      do
        fuel_level_percent := a_name
      ensure
        fuel_level_percent_set: fuel_level_percent = a_name		
      end
 ...
 feature -- Status Report
    ...
    out: STRING
      ...
      do
        ...
        Result.append("%Nclass VEHICLE%N")
        if attached engine_hours as l_engine_hours then
          Result.append ("%Nengine_hours:")
          Result.append (l_engine_hours.out)
          Result.append ("%N")    
        end  
        if attached fuel_level_percent as l_fuel_level_percent then
          Result.append ("%Nfuel_level_percent:")
          Result.append (l_fuel_level_percent.out)
          Result.append ("%N")    
        end  
