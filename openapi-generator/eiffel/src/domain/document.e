...
feature --Access
    ...
    driver_created_at_ms: INTEGER_64 
...
feature -- Change Element  
    ...
    set_driver_created_at_ms (a_name: like driver_created_at_ms)
        -- Set 'driver_created_at_ms' with 'a_name'.
      do
        driver_created_at_ms := a_name
      ensure
        driver_created_at_ms_set: driver_created_at_ms = a_name		
      end
 ...
 feature -- Status Report
    ...
    out: STRING
      ...
      do
        ...
        Result.append("%Nclass DOCUMENT%N")
        ...
        if attached driver_created_at_ms as l_driver_created_at_ms then
          Result.append ("%Ndriver_created_at_ms:")
          Result.append (l_driver_created_at_ms.out)
          Result.append ("%N")    
        end  
