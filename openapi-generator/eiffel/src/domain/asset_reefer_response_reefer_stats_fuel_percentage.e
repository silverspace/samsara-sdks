...
class ASSET_REEFER_RESPONSE_REEFER_STATS_FUEL_PERCENTAGE 
 ...
 feature -- Status Report
    ...
    out: STRING
      ...
      do
        ...
        Result.append("%Nclass ASSET_REEFER_RESPONSE_REEFER_STATS_FUEL_PERCENTAGE%N")
        if attached fuel_percentage as l_fuel_percentage then
          Result.append ("%Nfuel_percentage:")
          Result.append (l_fuel_percentage.out)
          Result.append ("%N")    
        end  
