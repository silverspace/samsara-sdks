...
feature --Access
    ...
    fill_missing: detachable STRING_32 
      
    group_id: INTEGER_64 
      -- Group ID to query.
    series: detachable LIST [_SENSORS_HISTORY_SERIES] 
...
feature -- Change Element  
    ...
    set_fill_missing (a_name: like fill_missing)
        -- Set 'fill_missing' with 'a_name'.
      do
        fill_missing := a_name
      ensure
        fill_missing_set: fill_missing = a_name		
      end
    ...
    set_step_ms (a_name: like step_ms)
        -- Set 'step_ms' with 'a_name'.
      do
        step_ms := a_name
      ensure
        step_ms_set: step_ms = a_name		
      end
 ...
 feature -- Status Report
    ...
    out: STRING
      ...
      do
        ...
        Result.append("%Nclass INLINE_OBJECT_21%N")
        if attached end_ms as l_end_ms then
          Result.append ("%Nend_ms:")
          Result.append (l_end_ms.out)
          Result.append ("%N")    
        end  
        if attached fill_missing as l_fill_missing then
          Result.append ("%Nfill_missing:")
          Result.append (l_fill_missing.out)
          Result.append ("%N")    
        end  
        ...
        if attached series as l_series then
          across l_series as ic loop
            Result.append ("%N series:")
        ...
        if attached step_ms as l_step_ms then
          Result.append ("%Nstep_ms:")
          Result.append (l_step_ms.out)
          Result.append ("%N")    
        end  
      end
end
