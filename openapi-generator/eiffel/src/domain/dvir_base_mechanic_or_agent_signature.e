...
class DVIR_BASE_MECHANIC_OR_AGENT_SIGNATURE 
...
feature -- Change Element  
    ...
    set_mechanic_user_id (a_name: like mechanic_user_id)
        -- Set 'mechanic_user_id' with 'a_name'.
      do
        mechanic_user_id := a_name
      ensure
        mechanic_user_id_set: mechanic_user_id = a_name		
      end
 ...
 feature -- Status Report
    ...
    out: STRING
      ...
      do
        ...
        Result.append("%Nclass DVIR_BASE_MECHANIC_OR_AGENT_SIGNATURE%N")
        if attached mechanic_user_id as l_mechanic_user_id then
          Result.append ("%Nmechanic_user_id:")
          Result.append (l_mechanic_user_id.out)
          Result.append ("%N")    
        end  
