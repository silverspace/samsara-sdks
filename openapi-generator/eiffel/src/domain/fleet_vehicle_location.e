...
feature -- Change Element  
    ...
    set_speed_miles_per_hour (a_name: like speed_miles_per_hour)
        -- Set 'speed_miles_per_hour' with 'a_name'.
      do
        speed_miles_per_hour := a_name
      ensure
        speed_miles_per_hour_set: speed_miles_per_hour = a_name		
      end
 ...
 feature -- Status Report
    ...
    out: STRING
      ...
      do
        ...
        Result.append("%Nclass FLEET_VEHICLE_LOCATION%N")
        ...
        if attached speed_miles_per_hour as l_speed_miles_per_hour then
          Result.append ("%Nspeed_miles_per_hour:")
          Result.append (l_speed_miles_per_hour.out)
          Result.append ("%N")    
        end  
