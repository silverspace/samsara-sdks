...
feature -- Change Element  
    ...
    set_radius_meters (a_name: like radius_meters)
        -- Set 'radius_meters' with 'a_name'.
      do
        radius_meters := a_name
      ensure
        radius_meters_set: radius_meters = a_name		
      end
 ...
 feature -- Status Report
    ...
    out: STRING
      ...
      do
        ...
        Result.append("%Nclass ADDRESS_GEOFENCE_CIRCLE%N")
        if attached latitude as l_latitude then
          Result.append ("%Nlatitude:")
          Result.append (l_latitude.out)
          Result.append ("%N")    
        end  
        if attached radius_meters as l_radius_meters then
          Result.append ("%Nradius_meters:")
          Result.append (l_radius_meters.out)
          Result.append ("%N")    
        end  
