...
feature --Access
    ...
    assets: detachable LIST [TAGGED_ASSET_BASE] 
      -- The assets to be removed from this tag.
    sensors: detachable LIST [TAGGED_SENSOR_BASE] 
      -- The sensors to be removed from this tag.
    vehicles: detachable LIST [TAGGED_VEHICLE_BASE] 
      -- The vehicles to be removed from this tag.
    machines: detachable LIST [TAGGED_MACHINE_BASE] 
      -- The machines to be removed from this tag.
    drivers: detachable LIST [TAGGED_DRIVER_BASE] 
 ...
 feature -- Status Report
    ...
    out: STRING
      ...
      do
        ...
        Result.append("%Nclass TAG_MODIFY_DELETE%N")
