...
export class UsersApi {
     ...
     */
    public deleteUserById (accessToken: string, userId: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
     ...
     * @param userId ID of the user.
     */
    public getUserById (accessToken: string, userId: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.User> {
        const localVarPath = this.basePath + '/users/{userId}'
            .replace('{' + 'userId' + '}', encodeURIComponent(String(userId)));
     ...
     * @param accessToken Samsara API access token.
     */
    public listUserRoles (accessToken: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.UserRole>> {
     ...
     * @param accessToken Samsara API access token.
     */
    public listUsers (accessToken: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.User>> {
