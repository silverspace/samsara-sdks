...
export class TagsApi {
     ...
     */
    public createTag (accessToken: string, tagCreateParams: models.models.TagCreate, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.Tag> {
     ...
     */
    public deleteTagById (accessToken: string, tagId: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
     ...
     */
    public getAllTags (accessToken: string, groupId?: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.InlineResponse2009> {
        const localVarPath = this.basePath + '/tags';
     ...
     * @param tagId ID of the tag.
     */
    public getTagById (accessToken: string, tagId: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.Tag> {
        const localVarPath = this.basePath + '/tags/{tag_id}'
            .replace('{' + 'tag_id' + '}', encodeURIComponent(String(tagId)));
     ...
     */
    public modifyTagById (accessToken: string, tagId: number, tagModifyParams: models.models.TagModify, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.Tag> {
        const localVarPath = this.basePath + '/tags/{tag_id}'
            .replace('{' + 'tag_id' + '}', encodeURIComponent(String(tagId)));
     ...
     */
    public updateTagById (accessToken: string, tagId: number, updateTagParams: models.models.TagUpdate, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.Tag> {
        const localVarPath = this.basePath + '/tags/{tag_id}'
            .replace('{' + 'tag_id' + '}', encodeURIComponent(String(tagId)));
