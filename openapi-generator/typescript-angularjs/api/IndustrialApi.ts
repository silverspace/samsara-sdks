...
export class IndustrialApi {
     ...
     */
    public getAllDataInputs (accessToken: string, groupId?: number, startMs?: number, endMs?: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.InlineResponse2006> {
     ...
     * @param endMs Timestamp in unix milliseconds representing the end of the period to fetch, inclusive. Used in combination with startMs. Defaults to nowMs.
     */
    public getDataInput (accessToken: string, dataInputId: number, startMs?: number, endMs?: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.DataInputHistoryResponse> {
     ...
     * @param groupParam 
     */
    public getMachines (accessToken: string, groupParam: models.models.InlineObject18, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.InlineResponse2007> {
     ...
     * @param historyParam 
     */
    public getMachinesHistory (accessToken: string, historyParam: models.models.InlineObject17, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.MachineHistoryResponse> {
