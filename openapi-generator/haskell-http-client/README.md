## OpenAPI Auto-Generated [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) Bindings to `Samsara API`

The library in `lib` provides auto-generated-from-OpenAPI [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) bindings to the Samsara API API.
...
| baseModule                      | Set the base module namespace                                                                                                 |          | Samsara                      |
| cabalPackage                    | Set the cabal package name, which consists of one or more alphanumeric words separated by hyphens                             |          | samsara                    |
...
| configType                      | Set the name of the type used for configuration                                                                               |          | SamsaraConfig                      |
...
| requestType                     | Set the name of the type used to generate requests                                                                            |          | SamsaraRequest                     |
...
| MODULE              | NOTES                                               |
| ------------------- | --------------------------------------------------- |
| Samsara.Client    | use the "dispatch" functions to send requests       |
| Samsara.Core      | core funcions, config and request types             |
| Samsara.API       | construct api requests                              |
| Samsara.Model     | describes api models                                |
| Samsara.MimeTypes | encoding/decoding MIME types (content-types/accept) |
| Samsara.ModelLens | lenses for model fields                             |
| Samsara.Logging   | logging functions and utils                         |
