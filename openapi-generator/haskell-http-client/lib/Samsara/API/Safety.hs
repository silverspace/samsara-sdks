...
module Samsara.API.Safety where
...
getDriverSafetyScore0 
  ...
  -> SamsaraRequest GetDriverSafetyScore0 MimeNoContent DriverSafetyScoreResponse MimeJSON
getDriverSafetyScore0 (DriverId driverId) (AccessToken accessToken) (StartMs startMs) (EndMs endMs) =
...
data GetDriverSafetyScore0  
-- | @application/json@
instance Produces GetDriverSafetyScore0 MimeJSON


-- *** getVehicleHarshEvent0
...
getVehicleHarshEvent0 
  ...
  -> SamsaraRequest GetVehicleHarshEvent0 MimeNoContent VehicleHarshEventResponse MimeJSON
getVehicleHarshEvent0 (VehicleId vehicleId) (AccessToken accessToken) (Timestamp timestamp) =
  _mkRequest "GET" ["/fleet/vehicles/",toPath vehicleId,"/safety/harsh_event"]
    `setQuery` toQuery ("access_token", Just accessToken)
    `setQuery` toQuery ("timestamp", Just timestamp)

data GetVehicleHarshEvent0  
-- | @application/json@
instance Produces GetVehicleHarshEvent0 MimeJSON


-- *** getVehicleSafetyScore0
...
getVehicleSafetyScore0 
  ...
  -> StartMs -- ^ "startMs" -  Timestamp in milliseconds representing the start of the period to fetch, inclusive. Used in combination with endMs.
  -> EndMs -- ^ "endMs" -  Timestamp in milliseconds representing the end of the period to fetch, inclusive. Used in combination with startMs.
  -> SamsaraRequest GetVehicleSafetyScore0 MimeNoContent VehicleSafetyScoreResponse MimeJSON
getVehicleSafetyScore0 (VehicleId vehicleId) (AccessToken accessToken) (StartMs startMs) (EndMs endMs) =
  _mkRequest "GET" ["/fleet/vehicles/",toPath vehicleId,"/safety/score"]
    `setQuery` toQuery ("access_token", Just accessToken)
    `setQuery` toQuery ("startMs", Just startMs)
    `setQuery` toQuery ("endMs", Just endMs)

data GetVehicleSafetyScore0  
-- | @application/json@
instance Produces GetVehicleSafetyScore0 MimeJSON
