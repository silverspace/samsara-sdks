...
namespace Swagger.Models
{
    ...
    public partial class DispatchRoute : DispatchRouteBase
    {
        /// <summary>
        /// Initializes a new instance of the DispatchRoute class.
        /// </summary>
        ...
        /// <param name="dispatchJobs">The dispatch jobs associated with this
        /// route.</param>
        /// <param name="id">ID of the Samsara dispatch route.</param>
        ...
        /// If neither is specified, then the route is unassigned.</param>
        public DispatchRoute(string name, long scheduledEndMs, long scheduledStartMs, IList<DispatchJob> dispatchJobs, long id, long? actualEndMs = default(long?), long? actualStartMs = default(long?), long? driverId = default(long?), long? groupId = default(long?), long? scheduledMeters = default(long?), string startLocationAddress = default(string), long? startLocationAddressId = default(long?), double? startLocationLat = default(double?), double? startLocationLng = default(double?), string startLocationName = default(string), long? trailerId = default(long?), long? vehicleId = default(long?))
        ...
        /// <summary>
        /// Gets or sets the dispatch jobs associated with this route.
        /// </summary>
        [JsonProperty(PropertyName = "dispatch_jobs")]
        public IList<DispatchJob> DispatchJobs { get; set; }
