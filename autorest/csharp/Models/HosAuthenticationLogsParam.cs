...
namespace Swagger.Models
{
    ...
    public partial class HosAuthenticationLogsParam
    {
        /// <summary>
        /// Initializes a new instance of the HosAuthenticationLogsParam class.
        /// </summary>
        public HosAuthenticationLogsParam()
        {
            CustomInit();
        }
        ...
        /// milliseconds UNIX time.</param>
        public HosAuthenticationLogsParam(long driverId, int endMs, long groupId, int startMs)
        {
            DriverId = driverId;
            EndMs = endMs;
            GroupId = groupId;
