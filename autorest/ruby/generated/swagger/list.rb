...
module Swagger
  ...
  class List
    ...
    #
    # @return [FleetOKResponse] operation results.
    #
    def fleet(custom_headers:nil)
      response = fleet_async(custom_headers:custom_headers).value!
    ...
    #
    def fleet_with_http_info(custom_headers:nil)
      fleet_async(custom_headers:custom_headers).value!
    end
    ...
    #
    def fleet_async(custom_headers:nil)
      ...
      path_template = 'fleet/list'

      request_url = @base_url || @client.base_url

      options = {
          middlewares: [[MsRest::RetryPolicyMiddleware, times: 3, retry: 0.02], [:cookie_jar]],
          query_params: {'access_token' => @client.access_token,'startingAfter' => @client.starting_after,'endingBefore' => @client.ending_before,'limit' => @client.limit},
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Swagger::Models::FleetOKResponse.mapper()
    ...
    #
    def users(custom_headers:nil)
      response = users_async(custom_headers:custom_headers).value!
      response.body unless response.nil?
    end
    ...
    # @return [MsRest::HttpOperationResponse] HTTP response information.
    #
    def users_with_http_info(custom_headers:nil)
      users_async(custom_headers:custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def users_async(custom_headers:nil)
      fail ArgumentError, '@client.access_token is nil' if @client.access_token.nil?
