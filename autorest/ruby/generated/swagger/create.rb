...
module Swagger
  ...
  class Create
    ...
    #
    # Creates and initializes a new instance of the Create class.
    ...
    #
    # @return [DvirBase] operation results.
    #
    def dvir(custom_headers:nil)
      response = dvir_async(custom_headers:custom_headers).value!
    ...
    #
    def dvir_with_http_info(custom_headers:nil)
      dvir_async(custom_headers:custom_headers).value!
    end
    ...
    #
    def dvir_async(custom_headers:nil)
      fail ArgumentError, '@client.access_token is nil' if @client.access_token.nil?
      fail ArgumentError, '@client.create_dvir_param is nil' if @client.create_dvir_param.nil?
      ...
      # Serialize Request
      request_mapper = Swagger::Models::CreateDvirParam.mapper()
      request_content = @client.serialize(request_mapper,  @client.create_dvir_param)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Swagger::Models::DvirBase.mapper()
