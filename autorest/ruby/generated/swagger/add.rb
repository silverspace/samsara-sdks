...
module Swagger
  ...
  class Add
    ...
    #
    # Creates and initializes a new instance of the Add class.
    ...
    #
    # @param address_param [AddressParam]
    # @param custom_headers [Hash{String => String}] A hash of custom headers that
    # will be added to the HTTP request.
    #
    #
    def address_method(address_param, custom_headers:nil)
      response = address_method_async(address_param, custom_headers:custom_headers).value!
      nil
    end
    ...
    #
    def address_method_with_http_info(address_param, custom_headers:nil)
      address_method_async(address_param, custom_headers:custom_headers).value!
    end
    ...
    #
    def address_method_async(address_param, custom_headers:nil)
      fail ArgumentError, '@client.access_token is nil' if @client.access_token.nil?
      fail ArgumentError, 'address_param is nil' if address_param.nil?
      ...
      # Serialize Request
      request_mapper = Swagger::Models::AddressParam.mapper()
      request_content = @client.serialize(request_mapper,  address_param)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil

      path_template = 'fleet/add_address'
