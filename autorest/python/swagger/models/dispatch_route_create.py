...
class DispatchRouteCreate(DispatchRouteBase):
    ...
    :param dispatch_jobs: The dispatch jobs to create for this route.
    :type dispatch_jobs: list[~swagger.models.DispatchJobCreate]
    """
    ...
    _attribute_map = {
        ...
        'dispatch_jobs': {'key': 'dispatch_jobs', 'type': '[DispatchJobCreate]'},
    }

    def __init__(self, name, scheduled_end_ms, scheduled_start_ms, dispatch_jobs, actual_end_ms=None, actual_start_ms=None, driver_id=None, group_id=None, scheduled_meters=None, start_location_address=None, start_location_address_id=None, start_location_lat=None, start_location_lng=None, start_location_name=None, trailer_id=None, vehicle_id=None):
        super(DispatchRouteCreate, self).__init__(actual_end_ms=actual_end_ms, actual_start_ms=actual_start_ms, driver_id=driver_id, group_id=group_id, name=name, scheduled_end_ms=scheduled_end_ms, scheduled_meters=scheduled_meters, scheduled_start_ms=scheduled_start_ms, start_location_address=start_location_address, start_location_address_id=start_location_address_id, start_location_lat=start_location_lat, start_location_lng=start_location_lng, start_location_name=start_location_name, trailer_id=trailer_id, vehicle_id=vehicle_id)
