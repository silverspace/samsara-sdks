...
class DispatchRouteBase(Model):
    ...
    def __init__(self, name, scheduled_end_ms, scheduled_start_ms, actual_end_ms=None, actual_start_ms=None, driver_id=None, group_id=None, scheduled_meters=None, start_location_address=None, start_location_address_id=None, start_location_lat=None, start_location_lng=None, start_location_name=None, trailer_id=None, vehicle_id=None):
        super(DispatchRouteBase, self).__init__()
