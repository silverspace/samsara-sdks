...
// UpdateClient is the # Introduction
//
...
func NewUpdateClient(accessToken string, endMs int64, startMs int64, assetID int64, endMs1 *int64, dataInputID int64, startMs1 *int64, durationMs *int64, endMs2 *int64, driverIDOrExternalID string, groupID *int64, timestamp int64, include string, sequenceID string, endingBefore string, limit *float64, startingAfter string, duration *int64, endTime *int64, endTime1 *int64, startTime *int64, endMs3 int64, startMs2 int64, tagID int64, vehicleIDOrExternalID string) UpdateClient {
    return NewUpdateClientWithBaseURI(DefaultBaseURI, accessToken, endMs, startMs, assetID, endMs1, dataInputID, startMs1, durationMs, endMs2, driverIDOrExternalID, groupID, timestamp, include, sequenceID, endingBefore, limit, startingAfter, duration, endTime, endTime1, startTime, endMs3, startMs2, tagID, vehicleIDOrExternalID)
}

// NewUpdateClientWithBaseURI creates an instance of the UpdateClient client.
    func NewUpdateClientWithBaseURI(baseURI string, accessToken string, endMs int64, startMs int64, assetID int64, endMs1 *int64, dataInputID int64, startMs1 *int64, durationMs *int64, endMs2 *int64, driverIDOrExternalID string, groupID *int64, timestamp int64, include string, sequenceID string, endingBefore string, limit *float64, startingAfter string, duration *int64, endTime *int64, endTime1 *int64, startTime *int64, endMs3 int64, startMs2 int64, tagID int64, vehicleIDOrExternalID string) UpdateClient {
        return UpdateClient{ NewWithBaseURI(baseURI, accessToken, endMs, startMs, assetID, endMs1, dataInputID, startMs1, durationMs, endMs2, driverIDOrExternalID, groupID, timestamp, include, sequenceID, endingBefore, limit, startingAfter, duration, endTime, endTime1, startTime, endMs3, startMs2, tagID, vehicleIDOrExternalID)}
    }

// VehiclesMethod this method enables the mutation of metadata for vehicles in the Samsara Cloud.
func (client UpdateClient) VehiclesMethod(ctx context.Context, vehicleUpdateParam VehicleUpdateParamType) (result autorest.Response, err error) {
    if tracing.IsEnabled() {
        ctx = tracing.StartSpan(ctx, fqdn + "/UpdateClient.VehiclesMethod")
        defer func() {
            sc := -1
            ...
            { TargetValue: vehicleUpdateParam,
             Constraints: []validation.Constraint{	{Target: "vehicleUpdateParam.GroupID", Name: validation.Null, Rule: true, Chain: nil },
            	{Target: "vehicleUpdateParam.Vehicles", Name: validation.Null, Rule: true, Chain: nil }}}}); err != nil {
            return result, validation.NewError(".UpdateClient", "VehiclesMethod", err.Error())
            }

                req, err := client.VehiclesMethodPreparer(ctx, vehicleUpdateParam)
    if err != nil {
    err = autorest.NewErrorWithError(err, ".UpdateClient", "VehiclesMethod", nil , "Failure preparing request")
    return
    }

            resp, err := client.VehiclesMethodSender(req)
            if err != nil {
            result.Response = resp
            err = autorest.NewErrorWithError(err, ".UpdateClient", "VehiclesMethod", resp, "Failure sending request")
            return
            }

            result, err = client.VehiclesMethodResponder(resp)
            if err != nil {
            err = autorest.NewErrorWithError(err, ".UpdateClient", "VehiclesMethod", resp, "Failure responding to request")
            }

    return
    }

    // VehiclesMethodPreparer prepares the VehiclesMethod request.
    func (client UpdateClient) VehiclesMethodPreparer(ctx context.Context, vehicleUpdateParam VehicleUpdateParamType) (*http.Request, error) {
    ...
    autorest.WithPath("/fleet/set_data"),
    autorest.WithJSON(vehicleUpdateParam),
    autorest.WithQueryParameters(queryParameters))
    return preparer.Prepare((&http.Request{}).WithContext(ctx))
    }

    // VehiclesMethodSender sends the VehiclesMethod request. The method will close the
    // http.Response Body if it receives an error.
    func (client UpdateClient) VehiclesMethodSender(req *http.Request) (*http.Response, error) {
            return autorest.SendWithSender(client, req,
            autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
            }

// VehiclesMethodResponder handles the response to the VehiclesMethod request. The method always
// closes the http.Response Body.
func (client UpdateClient) VehiclesMethodResponder(resp *http.Response) (result autorest.Response, err error) {
